 ...
 */
public class TestRouterHDFSContractRenameSecure_RestartInjected extends AbstractContractRenameTest {
  ...
  public void testRenameNewFileSameDir() throws Throwable {
    RestartFramework.at("before_rename_file_same_dir")
    ...
    RestartFramework.at("after_rename_file_same_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameFileOverExistingFile() throws Throwable {
    RestartFramework.at("before_rename_over_existing")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameDirIntoExistingDir() throws Throwable {
    RestartFramework.at("before_rename_dir_into_existing")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_dir_into_existing")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameWithNonEmptySubDir() throws Throwable {
    RestartFramework.at("before_rename_nonempty_subdir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_nonempty_subdir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenamePopulatesDirectoryAncestors() throws Throwable {
    RestartFramework.at("before_rename_dir_ancestors")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenamePopulatesFileAncestors() throws Throwable {
    RestartFramework.at("before_rename_file_ancestors")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
