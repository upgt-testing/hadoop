 ...
 */
public class TestRouterWebHDFSContractOpen_RestartInjected extends AbstractContractOpenTest {
  ...
  public void testOpenFile() throws Throwable {
    ...
    RestartFramework.at("after_open_file")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_read_file")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testOpenReadClose() throws Throwable {
    ...
    RestartFramework.at("before_create_for_read")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_before_open")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_read_before_close")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
