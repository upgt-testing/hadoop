 ...
 */
public class RouterHDFSContract_RestartInjected extends HDFSContract {
  ...
  public static void createCluster(
    ...
    try {
      ...
      RestartFramework.at("after_routers_start")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_active_namespaces")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
