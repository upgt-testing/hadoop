 ...
 */
public class TestRouterRPCClientRetries_RestartInjected_Randomized_456 {
    ...
    public void testRetryWhenAllNameServiceDown() throws Exception {
        ...
        RestartFramework.at("after_invalid_report").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
        ...
        RestartFramework.at("after_mkdir_attempt").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_cluster_shutdown").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRetryWhenOneNameServiceDown() throws Exception {
        ...
        RestartFramework.at("after_namenode_shutdown").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_renew_lease").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testNamenodeMetricsSlow() throws Exception {
        ...
        RestartFramework.at("after_nn0_slow").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Check that the cached value gets updated eventually
        waitUpdateLiveNodes(jsonString0, metrics);
        RestartFramework.at("after_nn1_slow").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_initial_check").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_cache_update").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
