 ...
 */
public class TestRouterRpcMultiDestination_RestartInjected_Randomized_123 extends TestRouterRpc_RestartInjected {
    ...
    public void testProxyOpWithRemoteException() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_file_creation").on(getCluster().getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_get_block_locations").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
    ...
    public void testPreviousBlockNotNull() throws IOException, URISyntaxException {
        ...
        try {
            ...
            RestartFramework.at("after_create").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_first_add_block").on(getCluster().getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_second_add_block").on(getCluster().getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_get_additional_datanode").on(getCluster().getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_complete").on(getCluster().getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
    ...
    public void testRecoverLease() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_hflush").on(getCluster().getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            boolean result = routerFs.recoverLease(testPath);
            assertFalse(result);
            RestartFramework.at("after_recover_lease").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
    ...
    public void testIsFileClosed() throws Exception {
        ...
        try {
            ...
            assertFalse(result);
            RestartFramework.at("after_is_file_closed").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            IOUtils.closeStream(fsDataOutputStream);
            routerFs.delete(testPath, true);
        }
    ...
    public void testGetContentSummaryEc() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_set_ec_policy").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            assertEquals(expectedECPolicy, routerDFS.getContentSummary(dir).getErasureCodingPolicy());
            RestartFramework.at("after_get_content_summary").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
    ...
    public void testCallerContextWithMultiDestinations() throws IOException {
        ...
        RestartFramework.at("after_get_file_status").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // assert the initial caller context as expected
        assertEquals("clientContext", CallerContext.getCurrent().getContext());
        DistributedFileSystem routerFs = (DistributedFileSystem) getRouterFileSystem();
        RestartFramework.at("after_list_status").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_mkdir").on(getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
