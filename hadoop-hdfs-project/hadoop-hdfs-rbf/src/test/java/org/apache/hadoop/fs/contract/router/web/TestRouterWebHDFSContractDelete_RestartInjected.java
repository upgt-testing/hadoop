 ...
 */
public class TestRouterWebHDFSContractDelete_RestartInjected
  ...
  public void testDeleteSingleFile() throws Throwable {
    ...
    RestartFramework.at("before_delete_single_file")
    ...
    RestartFramework.at("after_delete_single_file")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteNonEmptyDirRecursive() throws Throwable {
    ...
    RestartFramework.at("before_delete_directory")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_delete_directory")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
