 ...
 */
public class TestRouterClientRejectOverload_RestartInjected {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestRouterClientRejectOverload_RestartInjected.class);
  ...
  public void testWithoutOverloadControl() throws Exception {
    ...
    RestartFramework.at("after_simulate_slow_namenode")
  ...
  public void testOverloadControl() throws Exception {
    ...
    NameNode nn0 = dfsCluster.getNameNode(0);
    simulateSlowNamenode(nn0, 1);
    RestartFramework.at("after_simulate_slow_overload")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
