 ...
 */
public class TestRouterAdminCLI_RestartInjected {
  ...
  public void testAddMountTable() throws Exception {
    ...
    RestartFramework.at("after_add_mount_table_cli")
    ...
    assertEquals(0, ToolRunner.run(admin, argv));
    RestartFramework.at("after_update_mount_table_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRemoveMountTable() throws Exception {
    ...
    assertEquals(0, ToolRunner.run(admin, argv));
    RestartFramework.at("after_remove_mount_table_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetAndClearQuota() throws Exception {
    ...
    assertEquals(0, ToolRunner.run(admin, argv));
    RestartFramework.at("after_set_quota_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertEquals(0, ToolRunner.run(admin, argv));
    RestartFramework.at("after_clear_quota_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testManageSafeMode() throws Exception {
    ...
    RestartFramework.at("after_enter_safemode_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_leave_safemode_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNameserviceManager() throws Exception {
    ...
    RestartFramework.at("after_disable_nameservice_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_enable_nameservice_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshMountTableCache() throws Exception {
    ...
    assertEquals(0, ToolRunner.run(admin, argv));
    RestartFramework.at("after_refresh_cache_cli")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
