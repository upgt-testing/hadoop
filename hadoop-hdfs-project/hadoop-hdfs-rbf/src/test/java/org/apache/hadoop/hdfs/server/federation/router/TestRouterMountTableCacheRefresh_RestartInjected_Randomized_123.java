 ...
 * entries.
 */
public class TestRouterMountTableCacheRefresh_RestartInjected_Randomized_123 {
    ...
    public void testMountTableEntriesCacheUpdatedAfterAddAPICall() throws IOException {
        RestartFramework.at("after_add_mount_table_entry").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMountTableEntriesCacheUpdatedAfterRemoveAPICall() throws IOException {
        RestartFramework.at("after_add_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // add
        ...
        assertTrue(removeMountTableEntry.getStatus());
        RestartFramework.at("after_remove_mount_table_entry").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMountTableEntriesCacheUpdatedAfterUpdateAPICall() throws IOException {
        RestartFramework.at("after_add_entry_for_update").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // add
        ...
        RestartFramework.at("after_update_mount_table_entry").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCachedRouterClientBehaviourAfterRouterStoped() throws IOException {
        ...
        RestartFramework.at("after_first_add_entry").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_second_add_entry").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_router_stop").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        addMountTableEntry(mountTableManager, newEntry);
    ...
    public void testRefreshMountTableEntriesAPI() throws IOException {
        RestartFramework.at("after_refresh_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RefreshMountTableEntriesRequest request = RefreshMountTableEntriesRequest.newInstance();
        RestartFramework.at("before_refresh_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMountTableEntriesCacheUpdateTimeout() throws IOException {
        ...
        RestartFramework.at("after_refresher_init").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRouterClientConnectionExpiration() throws Exception {
        ...
        RestartFramework.at("after_first_refresh").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        mountTableRefresherService.init(config);
        RestartFramework.at("after_client_expiration_init").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
