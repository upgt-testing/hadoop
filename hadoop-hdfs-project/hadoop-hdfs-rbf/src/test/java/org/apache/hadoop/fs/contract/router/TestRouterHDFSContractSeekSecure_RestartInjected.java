...
public class TestRouterHDFSContractSeekSecure_RestartInjected extends AbstractContractSeekTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestRouterHDFSContractSeekSecure_RestartInjected.class);
  ...
  public void testSeekZeroByteFile() throws Throwable {
    ...
    RestartFramework.at("after_open_zero_byte_file")
  ...
  public void testBlockReadZeroByteFile() throws Throwable {
    ...
    RestartFramework.at("after_open_for_block_read")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSeekReadClosedFile() throws Throwable {
    ...
    RestartFramework.at("after_open_before_close")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNegativeSeek() throws Throwable {
    ...
    RestartFramework.at("after_open_for_negative_seek")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSeekFile() throws Throwable {
    ...
    RestartFramework.at("after_open_for_seek")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("mid_seek_operations")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSeekAndReadPastEndOfFile() throws Throwable {
    ...
    RestartFramework.at("after_open_before_seek_to_end")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSeekPastEndOfFileThenReseekAndRead() throws Throwable {
    ...
    RestartFramework.at("before_seek_past_eof")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSeekBigFile() throws Throwable {
    ...
    RestartFramework.at("after_big_file_creation")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("mid_big_file_seeks")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPositionedBulkReadDoesntChangePosition() throws Throwable {
    ...
    RestartFramework.at("after_file_creation_for_positioned_read")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRandomSeeks() throws Throwable {
    ...
    RestartFramework.at("after_file_creation_for_random_seeks")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try (FSDataInputStream stm = getFileSystem().open(randomSeekFile)) {
      for (int i = 0; i < limit; i++) {
        ...
        if (i == limit / 2) {
          RestartFramework.at("mid_random_seeks")
              .on(RouterHDFSContract.getCluster())
              .restart("datanode")
              .withIndex(0)
              .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadFullyZeroByteFile() throws Throwable {
    ...
    RestartFramework.at("after_open_zero_byte_for_readfully")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadFullyPastEOFZeroByteFile() throws Throwable {
    ...
    RestartFramework.at("before_readfully_past_eof_zero")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadFullySmallFile() throws Throwable {
    ...
    RestartFramework.at("after_open_for_readfully")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadFullyPastEOF() throws Throwable {
    ...
    RestartFramework.at("before_readfully_past_eof")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadFullyZeroBytebufferPastEOF() throws Throwable {
    ...
    RestartFramework.at("before_zero_byte_readfully_past_eof")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadNullBuffer() throws Throwable {
    ...
    RestartFramework.at("before_null_buffer_read")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadSmallFile() throws Throwable {
    ...
    RestartFramework.at("after_open_for_positioned_read")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadAtExactEOF() throws Throwable {
    ...
    RestartFramework.at("before_seek_to_exact_eof")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_read_at_eof")
        .on(RouterHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
