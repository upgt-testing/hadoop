 ...
 */
public class TestRouterRefreshSuperUserGroupsConfiguration_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestRouterRefreshSuperUserGroupsConfiguration_RestartInjected.class);
    ...
    public void testRefreshSuperUserGroupsConfiguration() throws Exception {
        ...
        RestartFramework.at("after_config_init").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    private void testRefreshSuperUserGroupsConfigurationInternal(Configuration conf) throws Exception {
        ...
        RestartFramework.at("after_auth_check").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_refresh").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Mimic CLI Access
        RestartFramework.at("before_refresh").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
