 ...
 */
public class TestRouterAdmin_RestartInjected {
  ...
  public void testAddDuplicateMountTable() throws IOException {
    ...
    RestartFramework.at("after_add_duplicate_check")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAddReadOnlyMountTable() throws IOException {
    ...
    RestartFramework.at("after_add_readonly")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_remove_readonly")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void testAddOrderMountTable(final DestinationOrder order)
    ...
    RestartFramework.at("after_add_order_" + order)
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRemoveMountTable() throws IOException {
    ...
    RestartFramework.at("after_remove_mount_table")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testEditMountTable() throws IOException {
    ...
    RestartFramework.at("after_update_mount_table")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetMountTable() throws IOException {
    ...
    RestartFramework.at("before_get_mount_table")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetSingleMountTableEntry() throws IOException {
    RestartFramework.at("before_get_single_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNameserviceManager() throws IOException {
    ...
    RestartFramework.at("after_disable_ns")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_enable_ns")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
