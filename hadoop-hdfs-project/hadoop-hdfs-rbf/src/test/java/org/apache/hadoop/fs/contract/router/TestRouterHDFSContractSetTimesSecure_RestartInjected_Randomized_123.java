 ...
 */
public class TestRouterHDFSContractSetTimesSecure_RestartInjected_Randomized_123 extends AbstractContractSetTimesTest {
    ...
    public void testSetTimesNonexistentFile() throws Throwable {
        RestartFramework.at("before_set_times_on_nonexistent").on(RouterHDFSContract.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
