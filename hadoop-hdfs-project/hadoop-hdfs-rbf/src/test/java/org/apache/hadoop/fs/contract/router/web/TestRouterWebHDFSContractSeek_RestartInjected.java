 ...
 */
public class TestRouterWebHDFSContractSeek_RestartInjected extends AbstractContractSeekTest {
  ...
  public void testSeekFile() throws Throwable {
    ...
    RestartFramework.at("after_open_seek_file")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_seek_operations")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
