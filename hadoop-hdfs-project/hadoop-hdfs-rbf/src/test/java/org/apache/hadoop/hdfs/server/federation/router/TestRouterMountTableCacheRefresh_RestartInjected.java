 ...
 * entries.
 */
public class TestRouterMountTableCacheRefresh_RestartInjected {
  ...
  public void testMountTableEntriesCacheUpdatedAfterAddAPICall()
    ...
    RestartFramework.at("after_add_mount_table_entry")
  ...
  public void testMountTableEntriesCacheUpdatedAfterRemoveAPICall()
    ...
    RestartFramework.at("after_add_mount_table")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertTrue(removeMountTableEntry.getStatus());
    RestartFramework.at("after_remove_mount_table_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountTableEntriesCacheUpdatedAfterUpdateAPICall()
    ...
    int addCount = getNumMountTableEntries();
    assertEquals(1, addCount);
    RestartFramework.at("after_add_entry_for_update")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_update_mount_table_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCachedRouterClientBehaviourAfterRouterStoped()
    ...
    MountTable newEntry = MountTable.newInstance(srcPath,
        ...
        Time.now());
    addMountTableEntry(mountTableManager, newEntry);
    RestartFramework.at("after_first_add_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_router_stop")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    newEntry = MountTable.newInstance(srcPath,
        ...
        Time.now());
    addMountTableEntry(mountTableManager, newEntry);
    RestartFramework.at("after_second_add_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshMountTableEntriesAPI() throws IOException {
    RestartFramework.at("before_refresh_mount_table")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_refresh_mount_table")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountTableEntriesCacheUpdateTimeout() throws IOException {
    ...
    RestartFramework.at("after_refresher_init")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRouterClientConnectionExpiration() throws Exception {
    ...
    mountTableRefresherService.init(config);
    RestartFramework.at("after_client_expiration_init")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_first_refresh")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
