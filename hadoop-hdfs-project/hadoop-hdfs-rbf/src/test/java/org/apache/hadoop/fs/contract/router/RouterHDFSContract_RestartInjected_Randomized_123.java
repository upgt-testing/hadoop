 ...
 */
public class RouterHDFSContract_RestartInjected_Randomized_123 extends HDFSContract {

    public static final int BLOCK_SIZE = AbstractFSContractTestBase.TEST_FILE_LEN;

    private static MiniRouterDFSCluster cluster;

    public RouterHDFSContract_RestartInjected_Randomized_123(Configuration conf) {
        super(conf);
    }
