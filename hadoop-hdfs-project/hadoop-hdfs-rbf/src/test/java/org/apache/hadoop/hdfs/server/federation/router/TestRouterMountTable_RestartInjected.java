 ...
 */
public class TestRouterMountTable_RestartInjected {
  ...
  public void testReadOnly() throws Exception {
    ...
    RestartFramework.at("after_mount_entries")
  ...
  public void testListFilesTime() throws Exception {
    try {
      ...
      RestartFramework.at("after_mount_entries_setup")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_nn_mkdir")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetMountPointStatusWithIOException()
    ...
    try {
      ...
      RestartFramework.at("after_mount_entries_with_permissions")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_permission_setup")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetMountPointStatus() throws IOException {
    ...
    RestartFramework.at("after_nested_mount_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListWhenDisableDefaultMountTable() throws IOException {
    ...
    RestartFramework.at("after_mount_entries_disable_default")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountTablePermissionsNoDest() throws IOException {
    ...
    RestartFramework.at("after_mount_entry_no_dest")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountTablePermissionsWithDest() throws IOException {
    try {
      ...
      RestartFramework.at("after_mount_entry_with_dest")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_dest_permissions_set")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountTablePermissionsMultiDest() throws IOException {
    try {
      ...
      RestartFramework.at("after_multi_dest_mount_entry")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ns0_dest_setup")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ns1_dest_setup")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountTablePermissionsMultiDestDifferentPerm()
    ...
    try {
      ...
      RestartFramework.at("after_multi_dest_diff_perm_mount")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ns0_dest_diff_perm_setup")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ns1_dest_diff_perm_setup")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountPointResolved() throws IOException {
    ...
    RestartFramework.at("after_mount_entry_with_owner_group")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountPointChildren() throws IOException {
    try {
      ...
      RestartFramework.at("after_mount_entry_for_children")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_children_creation")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMountPointChildrenMultiDest() throws IOException {
    try {
      ...
      RestartFramework.at("after_multi_dest_children_mount")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_multi_dest_children_creation")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testPathInException() throws Exception {
    ...
    RestartFramework.at("after_hash_all_mount_entry")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetListingWithTrailingSlash() throws IOException {
    try {
      ...
      RestartFramework.at("after_trailing_slash_mount_entries")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_trailing_slash_dirs_creation")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteMountPoint() throws Exception {
    try {
      ...
      RestartFramework.at("after_delete_mount_entry")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_delete_dir_creation")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameMountPoint() throws Exception {
    try {
      ...
      RestartFramework.at("after_rename_mount_entries")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_rename_dirs_creation")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusMountPoint() throws Exception {
    try {
      ...
      RestartFramework.at("after_ec_mount_entry")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ec_dest_creation")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ec_policy_set")
          .on(cluster.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
