 ...
 */
public class TestRouterRPCClientRetries_RestartInjected {
  ...
  public void testRetryWhenAllNameServiceDown() throws Exception {
    ...
    dfsCluster.shutdown();
    RestartFramework.at("after_cluster_shutdown")
    ...
    RestartFramework.at("after_invalid_report")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_attempt")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRetryWhenOneNameServiceDown() throws Exception {
    ...
    RestartFramework.at("after_namenode_shutdown")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_renew_lease")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNamenodeMetricsSlow() throws Exception {
    ...
    RestartFramework.at("after_cache_update")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_nn0_slow")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_nn1_slow")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
