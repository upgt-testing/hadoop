 ...
 */
public class TestRouterHDFSContractDelegationToken_RestartInjected_Randomized_456 extends AbstractFSContractTestBase {
    ...
    public void testRouterDelegationToken() throws Exception {
        RestartFramework.at("after_token_cancellation").on(RouterHDFSContract.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_token_generation").on(RouterHDFSContract.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_token_renewal").on(RouterHDFSContract.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
