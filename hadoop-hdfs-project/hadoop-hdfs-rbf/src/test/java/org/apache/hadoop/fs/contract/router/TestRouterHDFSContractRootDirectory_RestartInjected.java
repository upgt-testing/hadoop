 ...
 */
public class TestRouterHDFSContractRootDirectory_RestartInjected extends
    AbstractContractRootDirectoryTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestRouterHDFSContractRootDirectory_RestartInjected.class);
