 ...
 */
public class TestRouterWebHDFSContractConcat_RestartInjected extends AbstractContractConcatTest {
  ...
  public void testConcatFileOnFile() throws Throwable {
    ...
    RestartFramework.at("before_concat_operation")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_concat_operation")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    ContractTestUtils.validateFileContent(
        ContractTestUtils.readDataset(getFileSystem(), target, TEST_FILE_LEN * 2),
