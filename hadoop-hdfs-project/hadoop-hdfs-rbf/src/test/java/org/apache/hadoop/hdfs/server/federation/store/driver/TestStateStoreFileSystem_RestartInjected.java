 ...
 */
public class TestStateStoreFileSystem_RestartInjected extends TestStateStoreDriverBase {
  ...
  public void testInsert()
    ...
    RestartFramework.at("before_insert")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_insert")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testUpdate() throws IllegalArgumentException, IOException,
    ...
    RestartFramework.at("before_update")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_update")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFetchErrors()
      throws IllegalArgumentException, IllegalAccessException, IOException {
    RestartFramework.at("before_fetch_errors")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_fetch_errors")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMetrics()
      throws IllegalArgumentException, IllegalAccessException, IOException {
    RestartFramework.at("before_metrics")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_metrics")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testInsertWithErrorDuringWrite()
      throws IllegalArgumentException, IllegalAccessException, IOException {
    RestartFramework.at("before_error_test")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_error_test")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
