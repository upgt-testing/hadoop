 ...
 */
public class TestRouterMultiRack_RestartInjected {
  ...
  public void testGetECTopologyResultForPolicies() throws IOException {
    ...
    RestartFramework.at("after_enable_ec_policy")
    ...
    RestartFramework.at("after_enable_large_ec_policy")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_cross_namespace_ec_policy_update")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_reverse_ec_policy_update")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
