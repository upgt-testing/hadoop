 ...
 * multi nameServices.
 */
public class TestRouterRpc_RestartInjected_Randomized_456 {

    private static final Logger LOG = LoggerFactory.getLogger(TestRouterRpc_RestartInjected.class);
    ...
    public void testRpcService() throws IOException {
        ...
        RestartFramework.at("after_server_start").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        server.start();
        RestartFramework.at("after_server_init").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    protected MiniRouterDFSCluster getCluster() {
        return TestRouterRpc_RestartInjected.cluster;
    }
    ...
    public void testProxyListFiles() throws IOException, InterruptedException, URISyntaxException, NoSuchMethodException, SecurityException {
        ...
        RestartFramework.at("after_get_listing").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_collect_paths").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testProxyRenameFiles() throws IOException, InterruptedException {
        Thread.sleep(5000);
        RestartFramework.at("after_cross_ns_rename_attempt").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        List<String> nss = cluster.getNameservices();
        String ns0 = nss.get(0);
        ...
        RestartFramework.at("after_ns_setup").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_same_ns_rename").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testManageSnapshot() throws Exception {
        ...
        RestartFramework.at("after_snapshot_rename").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        String ns0 = cluster.getNameservices().get(0);
        ...
        RestartFramework.at("after_folder_creation").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_create").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testProxyAppend() throws Exception {
        ...
        RestartFramework.at("after_append_close").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_append_open").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        String badPath = "/unknownlocation/unknowndir";
    ...
    public void testErasureCoding() throws Exception {
        ...
        RestartFramework.at("after_dir_and_file_creation").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
   ...
   */
    ...
    public void testCacheAdmin() throws Exception {
        ...
        RestartFramework.at("after_cache_pool_add").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_cache_pool_modify").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
