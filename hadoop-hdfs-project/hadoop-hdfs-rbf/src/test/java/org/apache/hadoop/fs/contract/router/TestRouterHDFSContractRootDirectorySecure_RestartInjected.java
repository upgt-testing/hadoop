 ...
 */
public class TestRouterHDFSContractRootDirectorySecure_RestartInjected
    extends AbstractContractRootDirectoryTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestRouterHDFSContractRootDirectorySecure_RestartInjected.class);
