 ...
 */
public class TestRouterWebHDFSContractRename_RestartInjected
  ...
  public void testRenameFileOverExistingFile() throws Throwable {
    ...
    RestartFramework.at("before_create_src_dst")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_both_files")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_over_existing")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameDirectory() throws Throwable {
    ...
    RestartFramework.at("after_mkdir_before_rename")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_directory")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
