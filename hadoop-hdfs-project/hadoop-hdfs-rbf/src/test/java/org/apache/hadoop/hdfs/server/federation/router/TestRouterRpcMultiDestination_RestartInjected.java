 ...
 */
public class TestRouterRpcMultiDestination_RestartInjected extends TestRouterRpc_RestartInjected {
  ...
  public void testPreviousBlockNotNull()
    ...
    try {
      ...
      RestartFramework.at("after_first_add_block")
          .on(getCluster().getCluster())
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_add_block")
          .on(getCluster().getCluster())
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testIsFileClosed() throws Exception {
    ...
    try {
      ...
      assertFalse(result);
      RestartFramework.at("after_is_file_closed")
          .on(getCluster().getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetContentSummaryEc() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_get_content_summary")
          .on(getCluster().getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
