...
public class TestRouterHDFSContractSeek_RestartInjected extends AbstractContractSeekTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestRouterHDFSContractSeek_RestartInjected.class);
