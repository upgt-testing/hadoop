 ...
 */
public class TestRouterFsck_RestartInjected_Randomized_123 {

    public static final Logger LOG = LoggerFactory.getLogger(TestRouterFsck_RestartInjected.class);
    ...
    public void testFsck() throws Exception {
        ...
        RestartFramework.at("after_add_mount_tables").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_files_fsck").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
