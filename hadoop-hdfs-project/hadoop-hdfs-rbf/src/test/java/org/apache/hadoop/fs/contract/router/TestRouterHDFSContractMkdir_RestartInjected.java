...
public class TestRouterHDFSContractMkdir_RestartInjected extends AbstractContractMkdirTest {
  ...
  public void testMkDirRmDir() throws Throwable {
    ...
    RestartFramework.at("after_mkdir_rmdir")
  ...
  public void testMkDirRmRfDir() throws Throwable {
    ...
    RestartFramework.at("after_mkdir_recursive_delete")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNoMkdirOverFile() throws Throwable {
    ...
    RestartFramework.at("after_mkdir_over_file_test")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirOverParentFile() throws Throwable {
    ...
    RestartFramework.at("after_mkdir_over_parent_file_test")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirSlashHandling() throws Throwable {
    ...
    RestartFramework.at("after_mkdir_slash_handling")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirsPopulatingAllNonexistentAncestors() throws IOException {
    ...
    RestartFramework.at("after_mkdir_nested_ancestors")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirsDoesNotRemoveParentDirectories() throws IOException {
    ...
    RestartFramework.at("after_mkdir_preserve_parents")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateDirWithExistingDir() throws Exception {
    ...
    RestartFramework.at("after_mkdir_existing_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
