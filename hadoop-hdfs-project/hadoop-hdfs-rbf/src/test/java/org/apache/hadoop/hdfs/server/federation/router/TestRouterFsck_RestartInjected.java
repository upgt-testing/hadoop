 ...
 */
public class TestRouterFsck_RestartInjected {

  public static final Logger LOG =
      LoggerFactory.getLogger(TestRouterFsck_RestartInjected.class);
  ...
  public void testFsck() throws Exception {
    ...
    assertTrue(addMountTable(addEntry));
    RestartFramework.at("after_add_mount_tables")
    ...
    RestartFramework.at("after_create_files_fsck")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
