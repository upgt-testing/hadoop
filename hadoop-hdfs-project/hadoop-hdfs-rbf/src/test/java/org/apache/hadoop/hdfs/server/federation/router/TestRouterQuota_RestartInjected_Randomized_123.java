 ...
 */
public class TestRouterQuota_RestartInjected_Randomized_123 {
    ...
    public void testNamespaceQuotaExceed() throws Exception {
        ...
        RestartFramework.at("after_add_nsquota_subdir_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_nsquota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testStorageSpaceQuotaExceed() throws Exception {
        ...
        addMountTable(mountTable1);
        RestartFramework.at("after_add_ssquota_subdir_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_ssquota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        routerClient.create("/ssquota/subdir/file", true).close();
        RestartFramework.at("after_create_ssquota_files").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testStorageTypeQuotaExceed() throws Exception {
        ...
        RestartFramework.at("after_prepare_storage_type_quota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetQuotaToMountTableEntry() throws Exception {
        ...
        RestartFramework.at("after_add_setquota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetQuota() throws Exception {
        ...
        final FileSystem nnFs1 = nnContext1.getFileSystem();
        final FileSystem nnFs2 = nnContext2.getFileSystem();
        RestartFramework.at("after_add_setquota_testdir6_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Add two mount tables:
        ...
        RestartFramework.at("after_add_setquota_testdir5_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        addMountTable(mountTable1);
    ...
    public void testStorageTypeQuota() throws Exception {
        ...
        verifyTypeQuotaAndConsume(new long[] { -1, -1, ssQuota * 2, -1, -1 }, null, usage);
        // Verify /type1 quota on NN1.
        usage = client.getQuotaUsage("/type1");
        assertEquals(HdfsConstants.QUOTA_RESET, usage.getQuota());
        assertEquals(HdfsConstants.QUOTA_RESET, usage.getSpaceQuota());
        verifyTypeQuotaAndConsume(new long[] { -1, -1, ssQuota, -1, -1 }, null, usage);
        RestartFramework.at("after_prepare_storage_type_quota_test").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        verifyTypeQuotaAndConsume(new long[] { -1, -1, ssQuota, -1, -1 }, new long[] { 0, 0, fileSize * 3, 0, 0 }, u1);
        ...
        verifyTypeQuotaAndConsume(new long[] { -1, -1, ssQuota * 2, -1, -1 }, new long[] { 0, 0, fileSize * 3 * 2, 0, 0 }, u0);
    }
    ...
    public void testGetQuota() throws Exception {
        ...
        mountTable1.setQuota(new RouterQuotaUsage.Builder().quota(nsQuota).spaceQuota(ssQuota).build());
        addMountTable(mountTable1);
        RestartFramework.at("after_create_getquota_files").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_add_getquota_mount_tables").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testStaleQuotaRemoving() throws Exception {
        long nsQuota = 20;
        RestartFramework.at("after_add_stalequota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        long ssQuota = 200;
    ...
    public void testQuotaUpdating() throws Exception {
        ...
        RestartFramework.at("after_add_updatequota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testQuotaSynchronization() throws IOException {
        ...
        RestartFramework.at("after_add_quotasync_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testQuotaRefreshAfterQuotaExceed() throws Exception {
        ...
        RestartFramework.at("after_add_setquota1_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        assertEquals(4, quota1.getFileAndDirectoryCount());
        RestartFramework.at("after_add_setquota2_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(4, cacheQuota1.getFileAndDirectoryCount());
    ...
    public void testQuotaRefreshWhenDestinationNotPresent() throws Exception {
        ...
        RestartFramework.at("after_add_setdir_mount_tables").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        mountTable.setQuota(new RouterQuotaUsage.Builder().quota(nsQuota).spaceQuota(ssQuota).build());
        addMountTable(mountTable);
        ...
        RestartFramework.at("after_create_setdir_files").on(cluster.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testClearQuotaDefAfterRemovingMountTable() throws Exception {
        ...
        updateService.periodicInvoke();
        RestartFramework.at("after_add_setdir_mount_table_for_removal").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetQuotaNotMountTable() throws Exception {
        RestartFramework.at("after_add_setquotanmt_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        long nsQuota = 5;
        long ssQuota = 100;
        final FileSystem nnFs1 = nnContext1.getFileSystem();
    ...
    public void testNoQuotaaExceptionForUnrelatedOperations() throws Exception {
        ...
        addMountTable(mountTable1);
        RestartFramework.at("after_add_quota_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetGlobalQuota() throws Exception {
        ...
        RestartFramework.at("after_prepare_global_quota_test_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(nsQuota, qu.getQuota());
        assertEquals(ssQuota * 2, qu.getSpaceQuota());
    ...
    public void testFixGlobalQuota() throws Exception {
        long nsQuota = 5;
        RestartFramework.at("after_prepare_global_quota_for_fix").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        long ssQuota = 3 * BLOCK_SIZE;
        final FileSystem nnFs = nnContext1.getFileSystem();
        prepareGlobalQuotaTestMountTable(nsQuota, ssQuota);
    ...
    public void testGetQuotaUsageOnMountPoint() throws Exception {
        ...
        assertEquals(nsQuota, quotaUsage.getQuota());
        RestartFramework.at("after_prepare_global_quota_for_mount_point").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRouterQuotaUpdateService() throws Exception {
        ...
        RestartFramework.at("after_add_mount_table_for_update_service").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testQuotaUpdateWhenDestinationNotPresent() throws Exception {
        ...
        addMountTable(mountTable);
        Router router = routerContext.getRouter();
        RestartFramework.at("after_add_dst_not_present_mount_table").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RouterQuotaManager quotaManager = router.getQuotaManager();
        RouterQuotaUpdateService updateService = router.getQuotaCacheUpdateService();
