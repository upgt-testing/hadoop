 ...
 */
public class TestRouterWebHDFSContractAppend_RestartInjected extends AbstractContractAppendTest {
  ...
  public void testAppendToEmptyFile() throws Throwable {
    ...
    RestartFramework.at("after_create_empty_file")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
  ...
  public void testAppendToExistingFile() throws Throwable {
    ...
    RestartFramework.at("after_append_open_existing")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_close_appended")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameFileBeingAppended() throws Throwable {
    ...
    RestartFramework.at("after_append_before_write")
        .on(RouterWebHDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_rename_during_append")
        .on(RouterWebHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
