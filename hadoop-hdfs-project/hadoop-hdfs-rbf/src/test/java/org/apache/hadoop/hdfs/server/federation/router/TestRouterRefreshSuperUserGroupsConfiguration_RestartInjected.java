 ...
 */
public class TestRouterRefreshSuperUserGroupsConfiguration_RestartInjected {
  private static final Logger LOG = LoggerFactory.getLogger(
      TestRouterRefreshSuperUserGroupsConfiguration_RestartInjected.class);
  ...
  public void testRefreshSuperUserGroupsConfiguration()
    ...
    RestartFramework.at("after_config_init")
  ...
  private void testRefreshSuperUserGroupsConfigurationInternal(
    ...
    RestartFramework.at("after_auth_check")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    // Mimic CLI Access
    RestartFramework.at("before_refresh")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_refresh")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
