...
public class TestRouterHDFSContractSeek_RestartInjected_Randomized_456 extends AbstractContractSeekTest {

    private static final Logger LOG = LoggerFactory.getLogger(TestRouterHDFSContractSeek_RestartInjected.class);
