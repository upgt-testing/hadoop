 ...
 */
public class TestRouterClientRejectOverload_RestartInjected_Randomized_456 {

    private static final Logger LOG = LoggerFactory.getLogger(TestRouterClientRejectOverload_RestartInjected.class);
    ...
    public void testWithoutOverloadControl() throws Exception {
        ...
        RestartFramework.at("after_simulate_slow_namenode").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testOverloadControl() throws Exception {
        ...
        RestartFramework.at("after_simulate_slow_overload").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testNoNamenodesAvailable() throws Exception {
        ...
        RestartFramework.at("after_transition_to_active").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_transition_to_standby").on(cluster.getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
