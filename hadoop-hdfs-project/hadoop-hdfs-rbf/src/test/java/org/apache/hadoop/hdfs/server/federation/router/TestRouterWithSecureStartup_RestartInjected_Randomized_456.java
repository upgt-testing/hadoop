 ...
 */
public class TestRouterWithSecureStartup_RestartInjected_Randomized_456 {
   ...
   */
    ...
    public void testStartupWithoutSpnegoPrincipal() throws Exception {
        ...
        RestartFramework.at("after_cluster_creation").on(RouterWebHDFSContract.getCluster().getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
