 ...
 */
public class TestDisableNameservices_RestartInjected {
  ...
  public void testWithoutDisabling() throws IOException {
    RestartFramework.at("before_renew_lease")
    ...
    RestartFramework.at("before_list_status")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDisabling() throws Exception {
    ...
    RestartFramework.at("after_disable_nameservice")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_renew_lease_disabled")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_list_status_disabled")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMetrics() throws Exception {
    ...
    RestartFramework.at("after_disable_nameservice_metrics")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_get_metrics")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
