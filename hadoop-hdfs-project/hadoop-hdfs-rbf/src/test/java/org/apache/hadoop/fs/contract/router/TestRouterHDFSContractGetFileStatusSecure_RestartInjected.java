...
public class TestRouterHDFSContractGetFileStatusSecure_RestartInjected
  ...
  public void testGetFileStatusRoot() throws Throwable {
    RestartFramework.at("before_get_root_status")
  ...
  public void testListStatusEmptyDirectory() throws IOException {
    ...
    RestartFramework.at("after_list_empty_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListFilesEmptyDirectoryNonrecursive() throws IOException {
    ...
    RestartFramework.at("after_list_files_nonrecursive")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListFilesEmptyDirectoryRecursive() throws IOException {
    ...
    RestartFramework.at("after_list_files_recursive")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListLocatedStatusEmptyDirectory() throws IOException {
    ...
    RestartFramework.at("after_list_located_status_empty")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testComplexDirActions() throws Throwable {
    RestartFramework.at("before_complex_dir_operations")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_complex_dir_operations")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListFilesNoDir() throws Throwable {
    RestartFramework.at("before_list_files_missing_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusIteratorNoDir() throws Throwable {
    RestartFramework.at("before_list_status_iterator_missing_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testLocatedStatusNoDir() throws Throwable {
    RestartFramework.at("before_located_status_missing_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusNoDir() throws Throwable {
    RestartFramework.at("before_list_status_missing_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusFilteredNoDir() throws Throwable {
    RestartFramework.at("before_list_status_filtered_missing_dir")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusFilteredFile() throws Throwable {
    ...
    RestartFramework.at("after_list_status_filtered_file")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusFile() throws Throwable {
    ...
    RestartFramework.at("after_list_status_file")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusIteratorFile() throws Throwable {
    ...
    RestartFramework.at("after_list_status_iterator_file")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListFilesFile() throws Throwable {
    ...
    RestartFramework.at("after_list_files_file")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListFilesFileRecursive() throws Throwable {
    ...
    RestartFramework.at("after_list_files_file_recursive")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListLocatedStatusFile() throws Throwable {
    ...
    RestartFramework.at("after_list_located_status_file")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListStatusFiltering() throws Throwable {
    ...
    RestartFramework.at("after_list_status_filtering")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListLocatedStatusFiltering() throws Throwable {
    ...
    RestartFramework.at("after_list_located_status_filtering")
        .on(RouterHDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
