...
public class TestRouterNetworkTopologyServlet_RestartInjected {
  ...
  public void testPrintTopologyTextFormat() throws Exception {
    ...
    RestartFramework.at("after_first_topology_query_text")
        .on(clusterWithDatanodes.getCluster())
        .restart("datanode")
        .withIndex(0)
  ...
  public void testPrintTopologyJsonFormat() throws Exception {
    ...
    ByteArrayOutputStream out = new ByteArrayOutputStream();
    IOUtils.copyBytes(conn.getInputStream(), out, 4096, true);
    RestartFramework.at("after_first_topology_query_json")
        .on(clusterWithDatanodes.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPrintTopologyNoDatanodesTextFormat() throws Exception {
    ...
    ByteArrayOutputStream out = new ByteArrayOutputStream();
    IOUtils.copyBytes(conn.getInputStream(), out, 4096, true);
    RestartFramework.at("after_topology_query_no_datanodes_text")
        .on(clusterNoDatanodes.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
  ...
  public void testPrintTopologyNoDatanodesJsonFormat() throws Exception {
    ...
    ByteArrayOutputStream out = new ByteArrayOutputStream();
    IOUtils.copyBytes(conn.getInputStream(), out, 4096, true);
    RestartFramework.at("after_topology_query_no_datanodes_json")
        .on(clusterNoDatanodes.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
