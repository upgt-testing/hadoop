 ...
 * multi nameServices.
 */
public class TestRouterRpc_RestartInjected {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestRouterRpc_RestartInjected.class);
  ...
  public void testRpcService() throws IOException {
    ...
    RestartFramework.at("after_server_init")
    ...
    RestartFramework.at("after_server_start")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testProxyListFiles() throws IOException, InterruptedException,
    ...
    RestartFramework.at("after_collect_paths")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_get_listing")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testProxyRenameFiles() throws IOException, InterruptedException {
    ...
    RestartFramework.at("after_ns_setup")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_same_ns_rename")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_cross_ns_rename_attempt")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testManageSnapshot() throws Exception {
    ...
    RestartFramework.at("after_folder_creation")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_snapshot_rename")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testErasureCoding() throws Exception {
    ...
    RestartFramework.at("after_dir_and_file_creation")
        .on(cluster.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCacheAdmin() throws Exception {
    ...
    RestartFramework.at("after_cache_pool_add")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_cache_pool_modify")
        .on(cluster.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
