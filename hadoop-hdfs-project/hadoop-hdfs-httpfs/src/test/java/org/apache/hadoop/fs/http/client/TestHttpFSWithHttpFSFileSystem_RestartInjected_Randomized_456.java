...
public class TestHttpFSWithHttpFSFileSystem_RestartInjected_Randomized_456 extends BaseTestHttpFSWith_RestartInjected {

    public TestHttpFSWithHttpFSFileSystem_RestartInjected_Randomized_456(Operation operation) {
        super(operation);
    }
