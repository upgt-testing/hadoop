...
public class TestHttpFSWithHttpFSFileSystem_RestartInjected_Randomized_42 extends BaseTestHttpFSWith_RestartInjected {

    public TestHttpFSWithHttpFSFileSystem_RestartInjected_Randomized_42(Operation operation) {
        super(operation);
    }
