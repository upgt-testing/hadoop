...
public class TestHttpFSWithHttpFSFileSystem_RestartInjected_Randomized_123 extends BaseTestHttpFSWith_RestartInjected {

    public TestHttpFSWithHttpFSFileSystem_RestartInjected_Randomized_123(Operation operation) {
        super(operation);
    }
