 ...
 */
public class TestHttpFSAccessControlled_RestartInjected_Randomized_456 extends HTestCase {
     ...
     * @throws Exception
     */
    private void getCmd(String filename, String message, String command, boolean expectOK) throws Exception {
     ...
     * @param expectOK Is this operation expected to succeed?
     */
    private void putCmd(String filename, String message, String command, String params, boolean expectOK) throws Exception {
        String user = HadoopUsersConfTestHelper.getHadoopUsers()[0];
        String outMsg = message + " (" + command + ")";
        // Remove leading / from filename
        if (filename.charAt(0) == '/') {
     ...
     * @param expectOK Is this operation expected to succeed?
     */
    private void deleteCmd(String filename, String message, String command, String params, boolean expectOK) throws Exception {
        String user = HadoopUsersConfTestHelper.getHadoopUsers()[0];
        String outMsg = message + " (" + command + ")";
        // Remove leading / from filename
        if (filename.charAt(0) == '/') {
     ...
     * @param expectOK Is this operation expected to succeed?
     */
    private void postCmd(String filename, String message, String command, String params, boolean expectOK) throws Exception {
        String user = HadoopUsersConfTestHelper.getHadoopUsers()[0];
        String outMsg = message + " (" + command + ")";
        // Remove leading / from filename
        if (filename.charAt(0) == '/') {
    ...
    public void testAcessControlledFS() throws Exception {
        ...
        RestartFramework.at("after_test_files_creation").on(miniDfs).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        os.write(1);
        os.close();
        ...
        RestartFramework.at("after_read_write_mode_tests").on(miniDfs).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_write_only_mode_tests").on(miniDfs).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
