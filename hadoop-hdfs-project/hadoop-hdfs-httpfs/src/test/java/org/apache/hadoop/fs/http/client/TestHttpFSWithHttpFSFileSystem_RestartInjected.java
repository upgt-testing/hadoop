...
public class TestHttpFSWithHttpFSFileSystem_RestartInjected extends BaseTestHttpFSWith_RestartInjected {

  public TestHttpFSWithHttpFSFileSystem_RestartInjected(Operation operation) {
    super(operation);
  }
