 ...
 */
public class TestHttpFSServerNoXAttrs_RestartInjected_Randomized_456 extends HTestCase {
    ...
    public void testWithXAttrs() throws Exception {
        ...
        RestartFramework.at("after_test_file_creation").on(miniDfs).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
