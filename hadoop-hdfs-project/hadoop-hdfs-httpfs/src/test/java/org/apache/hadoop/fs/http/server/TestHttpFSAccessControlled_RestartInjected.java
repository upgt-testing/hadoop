 ...
 */
public class TestHttpFSAccessControlled_RestartInjected extends HTestCase {
  ...
  public void testAcessControlledFS() throws Exception {
    ...
    os.write(1);
    os.close();
    RestartFramework.at("after_test_files_creation")
        .on(miniDfs)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_read_write_mode_tests")
        .on(miniDfs)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_write_only_mode_tests")
        .on(miniDfs)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
