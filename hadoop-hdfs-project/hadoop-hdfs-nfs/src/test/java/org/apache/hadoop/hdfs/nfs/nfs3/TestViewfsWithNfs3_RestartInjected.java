 ...
 */
public class TestViewfsWithNfs3_RestartInjected {
  ...
  public void testFileStatus() throws Exception {
    RestartFramework.at("before_nn1_getfileinfo")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_nn1_getfileinfo")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_nn2_getfileinfo")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_nn2_getfileinfo")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsAccessNN1() throws Exception {
    RestartFramework.at("before_nn1_access")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_nn1_access")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsAccessNN2() throws Exception {
    RestartFramework.at("before_nn2_access")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    testNfsGetAttrResponse(status.getFileId(), namenodeId, Nfs3Status.NFS3_OK);
    RestartFramework.at("after_nn2_access")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsWriteNN1() throws Exception {
    ...
    int namenodeId = Nfs3Utils.getNamenodeId(config, hdfs1.getUri());
    RestartFramework.at("before_write_nn1")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_write_nn1")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsWriteNN2() throws Exception {
    ...
    int namenodeId = Nfs3Utils.getNamenodeId(config, hdfs2.getUri());
    RestartFramework.at("before_write_nn2")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    testNfsWriteResponse(status.getFileId(), namenodeId);
    RestartFramework.at("after_write_nn2")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsRenameMultiNN() throws Exception {
    ...
    RestartFramework.at("before_rename_multi_nn")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_multi_nn")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsRenameSingleNN() throws Exception {
    ...
    RestartFramework.at("before_rename_single_nn")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_single_nn")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
