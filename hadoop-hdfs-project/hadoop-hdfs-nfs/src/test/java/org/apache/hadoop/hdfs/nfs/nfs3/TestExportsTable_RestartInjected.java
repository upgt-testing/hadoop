...
public class TestExportsTable_RestartInjected {
  ...
  public void testHdfsExportPoint() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_nfs_start")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testViewFsMultipleExportPoint() throws IOException {
    ...
    try {
      ...
      hdfs1.mkdirs(base1);
      hdfs2.mkdirs(base2);
      RestartFramework.at("after_dir_operations")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testHdfsInternalExportPoint() throws IOException {
    ...
    try {
      ...
      hdfs.mkdirs(base);
      RestartFramework.at("after_export_dir_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
