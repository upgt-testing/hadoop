...
public class TestNfs3HttpServer_RestartInjected_Randomized_123 {

    private static final String BASEDIR = GenericTestUtils.getTempPath(TestNfs3HttpServer_RestartInjected.class.getSimpleName());
    ...
    public void testHttpServer() throws Exception {
        ...
        RestartFramework.at("after_http_access").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
