 ...
 */
public class TestRpcProgramNfs3_RestartInjected_Randomized_123 {
    ...
    public void testGetattr() throws Exception {
        ...
        RestartFramework.at("before_getattr").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        FileHandle handle = new FileHandle(dirId, namenodeId);
        RestartFramework.at("after_getattr").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
    ...
    public void testSetattr() throws Exception {
        ...
        RestartFramework.at("after_setattr").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_setattr").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testLookup() throws Exception {
        ...
        XDR xdr_req = new XDR();
        RestartFramework.at("after_lookup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_lookup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAccess() throws Exception {
        ...
        req.serialize(xdr_req);
        RestartFramework.at("before_access").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Attempt by an unpriviledged user should fail.
        ...
        RestartFramework.at("after_access").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code", Nfs3Status.NFS3_OK, response2.getStatus());
    }
    ...
    public void testReadlink() throws Exception {
        ...
        RestartFramework.at("after_readlink").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        READLINK3Request req2 = new READLINK3Request(handle2);
        req2.serialize(xdr_req2);
        RestartFramework.at("after_symlink_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Attempt by an unpriviledged user should fail.
    ...
    public void testRead() throws Exception {
        ...
        RestartFramework.at("before_read").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code:", Nfs3Status.NFS3ERR_ACCES, response1.getStatus());
        // Attempt by a priviledged user should pass.
    ...
    public void testEncryptedReadWrite() throws Exception {
        final int len = 8192;
        RestartFramework.at("after_dfs_file_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final Path zone = new Path("/zone");
        hdfs.mkdirs(zone);
        dfsAdmin.createEncryptionZone(zone, TEST_KEY, NO_TRASH);
        RestartFramework.at("after_nfs_file_write").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final byte[] buffer = new byte[len];
        for (int i = 0; i < len; i++) {
            buffer[i] = (byte) i;
        }
        RestartFramework.at("after_encrypted_file_read").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final String encFile1 = "/zone/myfile";
        createFileUsingNfs(encFile1, buffer);
        RestartFramework.at("after_commit").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        commit(encFile1, len);
     ...
     */
        ...
        RestartFramework.at("after_encryption_zone_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testWrite() throws Exception {
        ...
        XDR xdr_req = new XDR();
        RestartFramework.at("before_write").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        writeReq.serialize(xdr_req);
        // Attempt by an unpriviledged user should fail.
    ...
    public void testCreate() throws Exception {
        ...
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        RestartFramework.at("after_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        ...
        RestartFramework.at("before_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code:", Nfs3Status.NFS3ERR_ACCES, response1.getStatus());
        // Attempt by a priviledged user should pass.
    ...
    public void testMkdir() throws Exception {
        ...
        HdfsFileStatus status = nn.getRpcServer().getFileInfo(testdir);
        long dirId = status.getFileId();
        RestartFramework.at("before_mkdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        XDR xdr_req = new XDR();
        FileHandle handle = new FileHandle(dirId, namenodeId);
    ...
    public void testSymlink() throws Exception {
        ...
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        XDR xdr_req = new XDR();
        RestartFramework.at("before_symlink").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        SYMLINK3Request req = new SYMLINK3Request(handle, "fubar", new SetAttr3(), "bar");
        req.serialize(xdr_req);
        // Attempt by an unprivileged user should fail.
        ...
        RestartFramework.at("after_symlink").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code:", Nfs3Status.NFS3_OK, response2.getStatus());
    }
    ...
    public void testRemove() throws Exception {
        ...
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        RestartFramework.at("after_remove").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        REMOVE3Request req = new REMOVE3Request(handle, "bar");
        RestartFramework.at("before_remove").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        req.serialize(xdr_req);
        // Attempt by an unpriviledged user should fail.
    ...
    public void testRmdir() throws Exception {
        ...
        XDR xdr_req = new XDR();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        RestartFramework.at("before_rmdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rmdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRename() throws Exception {
        ...
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        RestartFramework.at("before_rename").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        ...
        RestartFramework.at("after_rename").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code:", Nfs3Status.NFS3ERR_ACCES, response1.getStatus());
        // Attempt by a privileged user should pass.
    ...
    public void testReaddir() throws Exception {
        ...
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        FileHandle handle = new FileHandle(dirId, namenodeId);
        RestartFramework.at("before_readdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
        ...
        assertEquals("Incorrect return code:", Nfs3Status.NFS3ERR_ACCES, response1.getStatus());
        RestartFramework.at("after_readdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Attempt by a priviledged user should pass.
    ...
    public void testReaddirplus() throws Exception {
        ...
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        RestartFramework.at("before_readdirplus").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        XDR xdr_req = new XDR();
        ...
        RestartFramework.at("after_readdirplus").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code:", Nfs3Status.NFS3_OK, response2.getStatus());
    }
    ...
    public void testFsstat() throws Exception {
        HdfsFileStatus status = nn.getRpcServer().getFileInfo("/tmp/bar");
        RestartFramework.at("after_fsstat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        FileHandle handle = new FileHandle(dirId, namenodeId);
        XDR xdr_req = new XDR();
        ...
        RestartFramework.at("before_fsstat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect return code:", Nfs3Status.NFS3ERR_ACCES, response1.getStatus());
        // Attempt by a priviledged user should pass.
    ...
    public void testFsinfo() throws Exception {
        ...
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        FileHandle handle = new FileHandle(dirId, namenodeId);
        RestartFramework.at("after_fsinfo").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
        RestartFramework.at("before_fsinfo").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testPathconf() throws Exception {
        ...
        long dirId = status.getFileId();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        RestartFramework.at("before_pathconf").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        FileHandle handle = new FileHandle(dirId, namenodeId);
        RestartFramework.at("after_pathconf").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        XDR xdr_req = new XDR();
    ...
    public void testCommit() throws Exception {
        HdfsFileStatus status = nn.getRpcServer().getFileInfo("/tmp/bar");
        long dirId = status.getFileId();
        RestartFramework.at("after_commit_test").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        int namenodeId = Nfs3Utils.getNamenodeId(config);
        FileHandle handle = new FileHandle(dirId, namenodeId);
        XDR xdr_req = new XDR();
        ...
        // Attempt by a priviledged user should pass.
        COMMIT3Response response2 = nfsd.commit(xdr_req.asReadOnlyWrap(), ch, 1, securityHandler, new InetSocketAddress("localhost", 1234));
        RestartFramework.at("before_commit").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Incorrect COMMIT3Response:", null, response2);
    }
