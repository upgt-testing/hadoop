...
public class TestMountd_RestartInjected_Randomized_456 {

    public static final Logger LOG = LoggerFactory.getLogger(TestMountd_RestartInjected.class);
    ...
    public void testStart() throws IOException {
        ...
        RestartFramework.at("after_mountd_operation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
