...
public class TestClientAccessPrivilege_RestartInjected_Randomized_123 {
    ...
    public void testClientAccessPrivilegeForRemove() throws Exception {
        ...
        RestartFramework.at("after_remove_operation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("before_remove_operation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
