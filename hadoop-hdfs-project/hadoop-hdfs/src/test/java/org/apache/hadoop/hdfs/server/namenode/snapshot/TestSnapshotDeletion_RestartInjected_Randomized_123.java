 ...
 */
public class TestSnapshotDeletion_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestSnapshotDeletion_RestartInjected.class);
    ...
    public void testApplyEditLogForDeletion() throws Exception {
        ...
        RestartFramework.at("after_delete_foo").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDeleteCurrentFileDirectory() throws Exception {
        ...
        RestartFramework.at("after_initial_file_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_delete_sub").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_delete_deletedir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_delete_nochangedirparent").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        assertEquals(2, children.size());
        RestartFramework.at("after_replication_changes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDeleteEarliestSnapshot1() throws Exception {
        ...
        DFSTestUtil.createFile(hdfs, file0, BLOCKSIZE, REPLICATION, seed);
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        RestartFramework.at("after_snapshot_s1_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_s2_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        Path newFile = new Path(sub, "newFile");
        DFSTestUtil.createFile(hdfs, newFile, BLOCKSIZE, REPLICATION, seed);
        RestartFramework.at("after_snapshot_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDeleteEarliestSnapshot2() throws Exception {
        ...
        checkQuotaUsageComputation(dir, 7, 3 * BLOCKSIZE * REPLICATION);
        RestartFramework.at("after_snapshot_s0_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_metadata_changes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDeleteSnapshot1() throws Exception {
        ...
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        RestartFramework.at("after_file1_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_s2_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // delete directory
        ...
        RestartFramework.at("after_directory_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // restart NN
    ...
    public void testCombineSnapshotDiff3() throws Exception {
        ...
        RestartFramework.at("after_directory_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    private void testCombineSnapshotDiffImpl(Path snapshotRoot, String modDirStr, int dirNodeNum) throws Exception {
        ...
        RestartFramework.at("after_file14_file15_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_file11_recreation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_initial_files_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_file10_modification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_file_modifications_2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        checkQuotaUsageComputation(snapshotRoot, dirNodeNum + 7, 19 * BLOCKSIZE);
        // modify file15
        ...
        RestartFramework.at("after_file_modifications").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDeleteSnapshotWithDirModification() throws Exception {
        ...
        RestartFramework.at("after_file_creation_and_owner_change").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        checkQuotaUsageComputation(sub, 2, BLOCKSIZE * 3);
        RestartFramework.at("after_snapshot_s3_and_owner_change").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        checkQuotaUsageComputation(sub, 2, BLOCKSIZE * 3);
        RestartFramework.at("after_snapshot_s3_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // delete snapshot s3
        hdfs.deleteSnapshot(sub, "s3");
        RestartFramework.at("after_snapshot_s1_and_owner_change").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        checkQuotaUsageComputation(sub, 2, BLOCKSIZE * 3);
    ...
    public void testRenameSnapshotDiff() throws Exception {
        ...
        RestartFramework.at("after_delete_subfile1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        checkQuotaUsageComputation(new Path("/"), 8, BLOCKSIZE * 11);
        checkQuotaUsageComputation(dir, 7, BLOCKSIZE * 11);
        RestartFramework.at("after_new_file_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        checkQuotaUsageComputation(sub, 6, BLOCKSIZE * 11);
   ...
   */
    ...
    public void testHANNRestartAfterSnapshotDeletion() throws Exception {
        ...
        snn.stop();
        RestartFramework.at("after_subdir_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCorrectNumberOfBlocksAfterRestart() throws IOException, InterruptedException {
        ...
        hdfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
        RestartFramework.at("after_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.saveNamespace();
        hdfs.setSafeMode(SafeModeAction.SAFEMODE_LEAVE);
        hdfs.deleteSnapshot(foo, snapshotName);
        hdfs.delete(bar, true);
        RestartFramework.at("after_file_and_dir_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.delete(foo, true);
        cluster.restartNameNode(0);
   ...
   */
    ...
    public void testFsImageCorruption() throws Exception {
        ...
        RestartFramework.at("after_snapshot_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_and_delete").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
   ...
   */
    ...
    public void testRenameAndDelete() throws IOException {
        final Path foo = new Path("/foo");
        RestartFramework.at("after_delete_trash_y").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_rename_to_trash").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_rename_to_y").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_s1_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSnapshotWithConcatException() throws Exception {
        ...
        RestartFramework.at("after_snapshot_ss").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSnapshotDeleteWithConcat() throws Exception {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            RestartFramework.at("after_file_creation_iteration_" + i).on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            hdfs.concat(dest, files);
            hdfs.createSnapshot(st, "s" + i);
            RestartFramework.at("after_snapshot_s" + i).on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
        hdfs.deleteSnapshot(st, "s1");
        hdfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
        RestartFramework.at("after_snapshot_s1_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
