...
/**
 * Restart-injection variant of TestFailureOfSharedDir.
 */
public class TestFailureOfSharedDir_RestartInjected {
  ...
  @Test(timeout = 180000) public void testFailureOfSharedDir_NN_Graceful() throws Exception { testFailureOfSharedDirWithRestart(RestartTarget.NAMENODE, RestartMode.GRACEFUL); }
  @Test(timeout = 180000) public void testFailureOfSharedDir_NN_Crash() throws Exception { testFailureOfSharedDirWithRestart(RestartTarget.NAMENODE, RestartMode.CRASH); }
  ...
  @Test(timeout = 180000) public void testFailureOfSharedDir_NNDN_Graceful() throws Exception { testFailureOfSharedDirWithRestart(RestartTarget.NAMENODE_AND_DATANODES, RestartMode.GRACEFUL); }
  @Test(timeout = 180000) public void testFailureOfSharedDir_NNDN_Crash() throws Exception { testFailureOfSharedDirWithRestart(RestartTarget.NAMENODE_AND_DATANODES, RestartMode.CRASH); }
}
