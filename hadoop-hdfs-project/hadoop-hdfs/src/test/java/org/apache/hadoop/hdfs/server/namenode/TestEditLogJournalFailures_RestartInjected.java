...
public class TestEditLogJournalFailures_RestartInjected {
  ...
  public TestEditLogJournalFailures_RestartInjected(boolean useAsyncEdits) {
  ...
  public void testSingleFailedEditsDirOnFlush() throws IOException {
    assertTrue(doAnEdit());
    RestartFramework.at("after_first_edit")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_invalidation")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    assertTrue(doAnEdit());
    RestartFramework.at("after_second_edit")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAllEditsDirsFailOnFlush() throws IOException {
    assertTrue(doAnEdit());
    RestartFramework.at("after_initial_edit")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_invalidate_all_journals")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAllEditsDirFailOnWrite() throws IOException {
    ...
    RestartFramework.at("after_invalidate_journals_on_write")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSingleFailedEditsDirOnSetReadyToFlush() throws IOException {
    ...
    RestartFramework.at("after_invalidate_single_journal")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSingleRequiredFailedEditsDirOnSetReadyToFlush()
    ...
    RestartFramework.at("after_invalidate_required_journal")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleRedundantFailedEditsDirOnSetReadyToFlush()
    ...
    invalidateEditsDirAtIndex(0, false, false);
    assertTrue(doAnEdit());
    RestartFramework.at("after_invalidate_first_journal")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertTrue(doAnEdit());
    RestartFramework.at("after_invalidate_second_journal")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_invalidate_third_journal")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleRedundantFailedEditsDirOnStartLogSegment()
    ...
    RestartFramework.at("after_initial_edit")
        ...
        .execute();
    spyOnJASjournal(3);
    RestartFramework.at("after_spy_journal")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
