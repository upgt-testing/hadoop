...
public class TestNameNodeReconfigure {
    ...
    void verifyReconfigureCallerContextEnabled(final NameNodeJVMInterface nameNode, final FSNamesystemJVMInterface nameSystem, boolean expected) {
    ...
    void verifyReconfigureIPCBackoff(final NameNodeJVMInterface nameNode, final NameNodeRpcServer nnrs, String property, boolean expected) {
    ...
    public void testReconfigureHearbeatCheck() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // change properties
   ...
   */
    ...
    public void testEnableSlowNodesParametersAfterReconfigured() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final BlockManagerJVMInterface blockManager = nameNode.getNamesystem().getBlockManager();
        final DatanodeManagerJVMInterface datanodeManager = blockManager.getDatanodeManager();
   ...
   */
    ...
    @Test
    public void testReconfigureCallerContextEnabled_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final FSNamesystemJVMInterface nameSystem = nameNode.getNamesystem();
        // try invalid values
        nameNode.reconfigureProperty(HADOOP_CALLER_CONTEXT_ENABLED_KEY, "text");
    ...
    @Test
    public void testReconfigureCallerContextEnabled_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final FSNamesystemJVMInterface nameSystem = nameNode.getNamesystem();
        // try invalid values
        nameNode.reconfigureProperty(HADOOP_CALLER_CONTEXT_ENABLED_KEY, "text");
    ...
    @Test
    public void testReconfigureCallerContextEnabled_withUpgrade60() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final FSNamesystemJVMInterface nameSystem = nameNode.getNamesystem();
        // try invalid values
        nameNode.reconfigureProperty(HADOOP_CALLER_CONTEXT_ENABLED_KEY, "text");
    ...
    @Test
    public void testReconfigureCallerContextEnabled_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final FSNamesystemJVMInterface nameSystem = nameNode.getNamesystem();
        // try invalid values
        nameNode.reconfigureProperty(HADOOP_CALLER_CONTEXT_ENABLED_KEY, "text");
    ...
    @Test
    public void testReconfigureIPCBackoff_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        NameNodeRpcServer nnrs = (NameNodeRpcServer) nameNode.getRpcServer();
        String ipcClientRPCBackoffEnable = NameNode.buildBackoffEnableKey(nnrs.getClientRpcServer().getPort());
        // try invalid values
    ...
    @Test
    public void testReconfigureIPCBackoff_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        NameNodeRpcServer nnrs = (NameNodeRpcServer) nameNode.getRpcServer();
        String ipcClientRPCBackoffEnable = NameNode.buildBackoffEnableKey(nnrs.getClientRpcServer().getPort());
        // try invalid values
    ...
    @Test
    public void testReconfigureIPCBackoff_withUpgrade60() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        NameNodeRpcServer nnrs = (NameNodeRpcServer) nameNode.getRpcServer();
        String ipcClientRPCBackoffEnable = NameNode.buildBackoffEnableKey(nnrs.getClientRpcServer().getPort());
        // try invalid values
    ...
    @Test
    public void testReconfigureIPCBackoff_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        NameNodeRpcServer nnrs = (NameNodeRpcServer) nameNode.getRpcServer();
        String ipcClientRPCBackoffEnable = NameNode.buildBackoffEnableKey(nnrs.getClientRpcServer().getPort());
        // try invalid values
    ...
    @Test
    public void testReconfigureHearbeatCheck_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // change properties
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, "" + 6);
    ...
    @Test
    public void testReconfigureHearbeatCheck_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // change properties
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, "" + 6);
    ...
    @Test
    public void testReconfigureHearbeatCheck_withUpgrade60() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // change properties
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, "" + 6);
    ...
    @Test
    public void testReconfigureHearbeatCheck_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // change properties
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, "" + 6);
    ...
    @Test(timeout = 30000)
    public void testReconfigureSPSWithStoragePolicyDisabled_withUpgrade20() throws ReconfigurationException, IOException {
        // shutdown cluster
        cluster.shutdown();
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
    ...
    @Test(timeout = 30000)
    public void testReconfigureSPSWithStoragePolicyDisabled_withUpgrade60() throws ReconfigurationException, IOException {
        // shutdown cluster
        cluster.shutdown();
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
    ...
    @Test
    public void testBlockInvalidateLimitAfterReconfigured_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        assertEquals(DFS_BLOCK_INVALIDATE_LIMIT_KEY + " is not correctly set", customizedBlockInvalidateLimit, datanodeManager.getBlockInvalidateLimit());
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testBlockInvalidateLimitAfterReconfigured_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        assertEquals(DFS_BLOCK_INVALIDATE_LIMIT_KEY + " is not correctly set", customizedBlockInvalidateLimit, datanodeManager.getBlockInvalidateLimit());
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, Integer.toString(6));
    ...
    @Test
    public void testBlockInvalidateLimitAfterReconfigured_withUpgrade60() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        assertEquals(DFS_BLOCK_INVALIDATE_LIMIT_KEY + " is not correctly set", customizedBlockInvalidateLimit, datanodeManager.getBlockInvalidateLimit());
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, Integer.toString(6));
    ...
    @Test
    public void testBlockInvalidateLimitAfterReconfigured_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        assertEquals(DFS_BLOCK_INVALIDATE_LIMIT_KEY + " is not correctly set", customizedBlockInvalidateLimit, datanodeManager.getBlockInvalidateLimit());
        nameNode.reconfigureProperty(DFS_HEARTBEAT_INTERVAL_KEY, Integer.toString(6));
    ...
    @Test
    public void testEnableParallelLoadAfterReconfigured_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        // By default, enableParallelLoad is false
        assertEquals(false, FSImageFormatProtobuf.getEnableParallelLoad());
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testEnableParallelLoadAfterReconfigured_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        // By default, enableParallelLoad is false
        assertEquals(false, FSImageFormatProtobuf.getEnableParallelLoad());
        nameNode.reconfigureProperty(DFS_IMAGE_PARALLEL_LOAD_KEY, Boolean.toString(true));
    ...
    @Test
    public void testEnableParallelLoadAfterReconfigured_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        // By default, enableParallelLoad is false
        assertEquals(false, FSImageFormatProtobuf.getEnableParallelLoad());
        nameNode.reconfigureProperty(DFS_IMAGE_PARALLEL_LOAD_KEY, Boolean.toString(true));
    ...
    @Test
    public void testEnableSlowNodesParametersAfterReconfigured_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final BlockManagerJVMInterface blockManager = nameNode.getNamesystem().getBlockManager();
        final DatanodeManagerJVMInterface datanodeManager = blockManager.getDatanodeManager();
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testEnableSlowNodesParametersAfterReconfigured_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final BlockManagerJVMInterface blockManager = nameNode.getNamesystem().getBlockManager();
        final DatanodeManagerJVMInterface datanodeManager = blockManager.getDatanodeManager();
        // By default, avoidSlowDataNodesForRead is false.
    ...
    @Test
    public void testEnableSlowNodesParametersAfterReconfigured_withUpgrade60() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final BlockManagerJVMInterface blockManager = nameNode.getNamesystem().getBlockManager();
        final DatanodeManagerJVMInterface datanodeManager = blockManager.getDatanodeManager();
        // By default, avoidSlowDataNodesForRead is false.
    ...
    @Test
    public void testEnableSlowNodesParametersAfterReconfigured_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final BlockManagerJVMInterface blockManager = nameNode.getNamesystem().getBlockManager();
        final DatanodeManagerJVMInterface datanodeManager = blockManager.getDatanodeManager();
        // By default, avoidSlowDataNodesForRead is false.
    ...
    @Test
    public void testReconfigureMaxSlowpeerCollectNodes_withUpgrade20() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testReconfigureMaxSlowpeerCollectNodes_withUpgrade40() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // By default, DFS_NAMENODE_MAX_SLOWPEER_COLLECT_NODES_KEY is 5.
        assertEquals(5, datanodeManager.getMaxSlowpeerCollectNodes());
    ...
    @Test
    public void testReconfigureMaxSlowpeerCollectNodes_withUpgrade60() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // By default, DFS_NAMENODE_MAX_SLOWPEER_COLLECT_NODES_KEY is 5.
        assertEquals(5, datanodeManager.getMaxSlowpeerCollectNodes());
    ...
    @Test
    public void testReconfigureMaxSlowpeerCollectNodes_withUpgrade80() throws ReconfigurationException {
        final NameNodeJVMInterface nameNode = cluster.getNameNode();
        final DatanodeManagerJVMInterface datanodeManager = nameNode.getNamesystem().getBlockManager().getDatanodeManager();
        // By default, DFS_NAMENODE_MAX_SLOWPEER_COLLECT_NODES_KEY is 5.
        assertEquals(5, datanodeManager.getMaxSlowpeerCollectNodes());
