...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestJournalNode}.
 *
 * Note: This test doesn't actually use MiniDFSCluster for cluster creation.
 * It's a standalone JournalNode unit test. The original only used
 * MiniDFSCluster.getBaseDirectory() as a utility for test paths.
 * This transformation replaces that with TEST_BUILD_DATA for consistency.
 *
 * @see TestJournalNode Original test
 */
@RunWith(Parameterized.class)
public class TestJournalNode_ProcessBased {
  ...
  public static Collection<String> checkpoints() {
    return Arrays.asList(
      ...
      // Note: JournalNode tests don't support upgrades as they test
      // standalone JournalNode functionality without cluster
    );
  }
  ...
  private static final File TEST_BUILD_DATA = PathUtils.getTestDir(TestJournalNode_ProcessBased.class);
  ...
  public void setup() throws Exception {
    File editsDir = new File(TEST_BUILD_DATA +
