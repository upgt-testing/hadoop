...
public class TestNetworkTopologyServlet_RestartInjected {
  ...
  public void testPrintTopologyTextFormat() throws IOException {
    ...
    RestartFramework.at("after_http_request")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPrintTopologyJsonFormat() throws IOException {
      ...
      MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
              ...
              .build();
      cluster.waitActive();
      RestartFramework.at("after_cluster_active_json")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_http_request_json")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testPrintTopologyNoDatanodesTextFormat() throws IOException {
    ...
    MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
            ...
            .build();
    cluster.waitActive();
    RestartFramework.at("after_cluster_active_no_dn")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    sb.append("\n-- Network Topology -- ");
    String topology = sb.toString();
    RestartFramework.at("after_http_request_no_dn")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    public void testPrintTopologyNoDatanodesJsonFormat() throws IOException {
        ...
        MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
                ...
                .build();
        cluster.waitActive();
        RestartFramework.at("after_cluster_active_no_dn_json")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        sb.append("\n-- Network Topology -- ");
        String topology = sb.toString();
        RestartFramework.at("after_http_request_no_dn_json")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
