...
public class TestCrcCorruption {
    ...
    private void thistest(Configuration conf, DFSTestUtil util) throws Exception {
        ...
        try {
            ...
            List<ReplicaInfoJVMInterface> replicas = (List<ReplicaInfoJVMInterface>) dn.getFSDataset().getFinalizedBlocks(bpid);
    ...
    @Test(timeout = 50000)
    public void testCorruptionDuringWrt_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 50000)
    public void testCorruptionDuringWrt_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 50000)
    public void testCorruptionDuringWrt_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 50000)
    public void testCorruptionDuringWrt_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        MiniDFSClusterInJVM cluster = null;
