...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestLargeBlock}.
 *
 ...
 *
 * @see TestLargeBlock Original test using MiniDFSCluster
 */
@RunWith(Parameterized.class)
public class TestLargeBlock_ProcessBased extends ProcessBasedUpgradeTestBase {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestLargeBlock_ProcessBased.class);
  ...
  public void testLargeBlockSize() throws Exception {
   ...
   * @throws IOException in case of errors
   */
  public void runTest(final long blockSize) throws Exception {
