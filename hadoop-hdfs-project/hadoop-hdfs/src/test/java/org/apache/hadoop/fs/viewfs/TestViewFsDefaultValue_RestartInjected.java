 ...
 */
public class TestViewFsDefaultValue_RestartInjected {
  ...
  public void testGetQuotaUsage() throws IOException {
    ...
    final DistributedFileSystem dfs = (DistributedFileSystem)hFs;
    dfs.setQuota(testFileDirPath, 100, 500);
    RestartFramework.at("after_set_quota_usage")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetQuotaUsageWithStorageTypes() throws IOException {
    ...
    RestartFramework.at("after_set_storage_quotas")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetQuotaUsageWithQuotaDefined() throws IOException {
    ...
    RestartFramework.at("after_unset_quotas")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
