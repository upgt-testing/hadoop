...
public class TestViewFsFileStatusHdfs {
    ...
    @Test
    public void testFileStatusSerialziation_withUpgrade20() throws IOException, URISyntaxException {
        long len = fileSystemTestHelper.createFile(fHdfs, testfilename);
        FileStatus stat = vfs.getFileStatus(new Path(testfilename));
        assertEquals(len, stat.getLen());
    ...
    @Test
    public void testFileStatusSerialziation_withUpgrade40() throws IOException, URISyntaxException {
        long len = fileSystemTestHelper.createFile(fHdfs, testfilename);
        FileStatus stat = vfs.getFileStatus(new Path(testfilename));
        assertEquals(len, stat.getLen());
        // check serialization/deserialization
    ...
    @Test
    public void testFileStatusSerialziation_withUpgrade60() throws IOException, URISyntaxException {
        long len = fileSystemTestHelper.createFile(fHdfs, testfilename);
        FileStatus stat = vfs.getFileStatus(new Path(testfilename));
        assertEquals(len, stat.getLen());
        // check serialization/deserialization
    ...
    @Test
    public void testFileStatusSerialziation_withUpgrade80() throws IOException, URISyntaxException {
        long len = fileSystemTestHelper.createFile(fHdfs, testfilename);
        FileStatus stat = vfs.getFileStatus(new Path(testfilename));
        assertEquals(len, stat.getLen());
        // check serialization/deserialization
    ...
    @Test
    public void testGetFileChecksum_withUpgrade20() throws IOException, URISyntaxException {
        // Create two different files in HDFS
        fileSystemTestHelper.createFile(fHdfs, someFile);
        fileSystemTestHelper.createFile(fHdfs, fileSystemTestHelper.getTestRootPath(fHdfs, someFile + "other"), 1, 512);
        // Get checksum through ViewFS
    ...
    @Test
    public void testGetFileChecksum_withUpgrade40() throws IOException, URISyntaxException {
        // Create two different files in HDFS
        fileSystemTestHelper.createFile(fHdfs, someFile);
        fileSystemTestHelper.createFile(fHdfs, fileSystemTestHelper.getTestRootPath(fHdfs, someFile + "other"), 1, 512);
        // Get checksum through ViewFS
    ...
    @Test
    public void testGetFileChecksum_withUpgrade60() throws IOException, URISyntaxException {
        // Create two different files in HDFS
        fileSystemTestHelper.createFile(fHdfs, someFile);
        fileSystemTestHelper.createFile(fHdfs, fileSystemTestHelper.getTestRootPath(fHdfs, someFile + "other"), 1, 512);
        // Get checksum through ViewFS
    ...
    @Test
    public void testGetFileChecksum_withUpgrade80() throws IOException, URISyntaxException {
        // Create two different files in HDFS
        fileSystemTestHelper.createFile(fHdfs, someFile);
        fileSystemTestHelper.createFile(fHdfs, fileSystemTestHelper.getTestRootPath(fHdfs, someFile + "other"), 1, 512);
        // Get checksum through ViewFS
