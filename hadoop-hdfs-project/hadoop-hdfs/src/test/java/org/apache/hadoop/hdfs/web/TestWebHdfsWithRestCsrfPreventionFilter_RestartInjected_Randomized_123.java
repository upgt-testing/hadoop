...
public class TestWebHdfsWithRestCsrfPreventionFilter_RestartInjected_Randomized_123 {
    ...
    public TestWebHdfsWithRestCsrfPreventionFilter_RestartInjected_Randomized_123(boolean nnRestCsrf, boolean dnRestCsrf, boolean clientRestCsrf) {
    ...
    public void before() throws Exception {
        ...
        dnConf.set(DFS_DATANODE_HTTPSERVER_FILTER_HANDLERS, "org.apache.hadoop.hdfs.server.datanode.web.RestCsrfPreventionFilterHandler");
    ...
    public void testGetFileStatus() throws Exception {
        RestartFramework.at("after_get_file_status").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
