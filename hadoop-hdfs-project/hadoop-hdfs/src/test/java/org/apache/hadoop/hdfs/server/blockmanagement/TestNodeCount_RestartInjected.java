...
public class TestNodeCount_RestartInjected {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestNodeCount_RestartInjected.class);
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_NN_Graceful() throws Exception {
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_DN_Graceful() throws Exception {
    final Configuration conf = new HdfsConfiguration();
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_DN_Crash() throws Exception {
    final Configuration conf = new HdfsConfiguration();
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_AllDN_Graceful() throws Exception {
    final Configuration conf = new HdfsConfiguration();
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_AllDN_Crash() throws Exception {
    final Configuration conf = new HdfsConfiguration();
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_NNAndDN_Graceful() throws Exception {
    final Configuration conf = new HdfsConfiguration();
  ...
  @Test(timeout = 120000)
  public void testNodeCount_AfterFileCreate_NNAndDN_Crash() throws Exception {
    final Configuration conf = new HdfsConfiguration();
