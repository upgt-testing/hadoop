...
public class TestUnderReplicatedBlocks_RestartInjected {
  ...
  public void testSetRepIncWithUnderReplicatedBlocks() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_blocksmap_removal")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_setrep")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNumberOfBlocksToBeReplicated() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_datanode_removal")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_compute_replication_work")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
