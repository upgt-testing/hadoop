...
public class TestSeekBug {
   ...
   */
    ...
    @Test
    public void testSeekBugDFS_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSeekBugDFS_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSeekBugDFS_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSeekBugDFS_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testNegativeSeek_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testNegativeSeek_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testNegativeSeek_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testNegativeSeek_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testSeekPastFileSize_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testSeekPastFileSize_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testSeekPastFileSize_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(expected = IOException.class)
    public void testSeekPastFileSize_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        try {
