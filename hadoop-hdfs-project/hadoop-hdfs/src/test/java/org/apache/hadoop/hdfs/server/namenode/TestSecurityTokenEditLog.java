...
public class TestSecurityTokenEditLog {
    ...
    @Test
    public void testEditLog_withUpgrade20() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testEditLog_withUpgrade40() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testEditLog_withUpgrade60() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
