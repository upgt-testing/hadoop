...
public class TestStickyBit_RestartInjected {
  ...
  private static void initCluster(boolean format) throws Exception {
    ...
    if (format) {
      RestartFramework.at("after_cluster_init")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
  ...
  public void testGeneralSBBehavior() throws Exception {
    ...
    RestartFramework.at("after_sticky_bit_set")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAclGeneralSBBehavior() throws Exception {
    ...
    RestartFramework.at("after_acl_sticky_bit_set")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void testMovingFiles(boolean useAcl) throws Exception {
    ...
    RestartFramework.at("after_file_write_before_rename")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStickyBitPersistence() throws Exception {
    ...
    RestartFramework.at("before_shutdown_for_persistence_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_restart_for_persistence_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAclStickyBitPersistence() throws Exception {
    ...
    RestartFramework.at("before_shutdown_for_acl_persistence_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_restart_for_acl_persistence_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStickyBitRecursiveDeleteFile() throws Exception {
    ...
    RestartFramework.at("after_file_creation_before_recursive_delete")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStickyBitRecursiveDeleteDir() throws Exception {
    ...
    RestartFramework.at("after_dir_creation_before_recursive_delete")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
