...
public class TestDataNodeVolumeMetrics {
    ...
    private MiniDFSClusterInJVM setupClusterForVolumeMetrics() throws IOException {
        ...
        return new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).storageTypes(new StorageType[] { StorageType.RAM_DISK, StorageType.DISK }).storagesPerDatanode(2).build();
    }

    private void verifyDataNodeVolumeMetrics(final FileSystem fs, final MiniDFSClusterInJVM cluster, final Path fileName) throws IOException {
    ...
    public void testWriteIoVolumeMetrics() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).storageTypes(new StorageType[] { StorageType.RAM_DISK, StorageType.DISK }).storagesPerDatanode(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
            final long fileLen = Integer.MAX_VALUE + 1L;
    ...
    @Test
    public void testVolumeMetrics_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetrics_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetrics_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetrics_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetricsWithVolumeDepartureArrival_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetricsWithVolumeDepartureArrival_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetricsWithVolumeDepartureArrival_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testVolumeMetricsWithVolumeDepartureArrival_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = setupClusterForVolumeMetrics();
        try {
            FileSystem fs = cluster.getFileSystem();
            final Path fileName = new Path("/test.dat");
    ...
    @Test
    public void testWriteIoVolumeMetrics_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).storageTypes(new StorageType[] { StorageType.RAM_DISK, StorageType.DISK }).storagesPerDatanode(2).build();
        try {
    ...
    @Test
    public void testWriteIoVolumeMetrics_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).storageTypes(new StorageType[] { StorageType.RAM_DISK, StorageType.DISK }).storagesPerDatanode(2).build();
        try {
    ...
    @Test
    public void testWriteIoVolumeMetrics_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).storageTypes(new StorageType[] { StorageType.RAM_DISK, StorageType.DISK }).storagesPerDatanode(2).build();
        try {
    ...
    @Test
    public void testWriteIoVolumeMetrics_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).storageTypes(new StorageType[] { StorageType.RAM_DISK, StorageType.DISK }).storagesPerDatanode(2).build();
        try {
