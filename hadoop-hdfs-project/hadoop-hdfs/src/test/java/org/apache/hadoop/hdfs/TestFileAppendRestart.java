...
public class TestFileAppendRestart {
    ...
    public void testLoadLogsFromBuggyEarlierVersions() throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(false).manageDataDfsDirs(false).manageNameDfsDirs(false).numDataNodes(0).waitSafeMode(false).startupOption(StartupOption.UPGRADE).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    public void testAppendWithPipelineRecovery() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).manageDataDfsDirs(true).manageNameDfsDirs(true).numDataNodes(4).racks(new String[] { "/rack1", "/rack1", "/rack2", "/rack2" }).build();
            cluster.waitActive();
    ...
    @Test
    public void testAppendRestart_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // Turn off persistent IPC, so that the DFSClient can survive NN restart
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testAppendRestart_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // Turn off persistent IPC, so that the DFSClient can survive NN restart
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testAppendRestart_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // Turn off persistent IPC, so that the DFSClient can survive NN restart
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testAppendRestart_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // Turn off persistent IPC, so that the DFSClient can survive NN restart
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testLoadLogsFromBuggyEarlierVersions_withUpgrade20() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        String tarFile = System.getProperty("test.cache.data", "build/test/cache") + "/" + HADOOP_23_BROKEN_APPEND_TGZ;
        String testDir = PathUtils.getTestDirName(getClass());
        File dfsDir = new File(testDir, "image-with-buggy-append");
    ...
    @Test
    public void testLoadLogsFromBuggyEarlierVersions_withUpgrade60() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        String tarFile = System.getProperty("test.cache.data", "build/test/cache") + "/" + HADOOP_23_BROKEN_APPEND_TGZ;
        String testDir = PathUtils.getTestDirName(getClass());
        File dfsDir = new File(testDir, "image-with-buggy-append");
    ...
    @Test
    public void testLoadLogsFromBuggyEarlierVersions_withUpgrade80() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        String tarFile = System.getProperty("test.cache.data", "build/test/cache") + "/" + HADOOP_23_BROKEN_APPEND_TGZ;
        String testDir = PathUtils.getTestDirName(getClass());
        File dfsDir = new File(testDir, "image-with-buggy-append");
    ...
    @Test
    public void testAppendWithPipelineRecovery_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSDataOutputStream out = null;
        try {
    ...
    @Test
    public void testAppendWithPipelineRecovery_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSDataOutputStream out = null;
        try {
    ...
    @Test
    public void testAppendWithPipelineRecovery_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSDataOutputStream out = null;
        try {
    ...
    @Test
    public void testAppendWithPipelineRecovery_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSDataOutputStream out = null;
        try {
