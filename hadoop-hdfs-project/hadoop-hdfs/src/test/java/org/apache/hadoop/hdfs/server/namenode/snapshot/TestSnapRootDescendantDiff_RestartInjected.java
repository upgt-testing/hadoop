 ...
 */
public class TestSnapRootDescendantDiff_RestartInjected extends TestSnapshotDiffReport {
  @Before
  ...
  public void testNonSnapRootDiffReport() throws Exception {
    ...
    RestartFramework.at("after_first_snapshot_modification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_snapshot_modification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
