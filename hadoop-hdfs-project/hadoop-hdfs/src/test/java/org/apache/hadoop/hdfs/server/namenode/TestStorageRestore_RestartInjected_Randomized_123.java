 ...
 */
public class TestStorageRestore_RestartInjected_Randomized_123 {
    ...
    public void testStorageRestore() throws Exception {
        ...
        RestartFramework.at("after_third_dir_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        path = new Path("/", "test1");
        assertTrue(fs.mkdirs(path));
        RestartFramework.at("after_first_dir_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_second_dir_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ///should enable storage..
        secondary.doCheckpoint();
        RestartFramework.at("after_storage_invalidation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snn_start").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDfsAdminCmd() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_restore_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_restore_false").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_restore_true").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testStorageRestoreFailure() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_permission_restore").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
