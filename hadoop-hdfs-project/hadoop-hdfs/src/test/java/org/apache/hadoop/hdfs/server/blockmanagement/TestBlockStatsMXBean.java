...
public class TestBlockStatsMXBean {
    ...
    public void setup() throws IOException {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(6).storageTypes(types).storagesPerDatanode(3).build();
        cluster.waitActive();
    }
    ...
    public void testStorageTypeLoad() throws Exception {
        HeartbeatManagerInterface heartbeatManager = cluster.getNamesystem().getBlockManager().getDatanodeManager().getHeartbeatManager();
