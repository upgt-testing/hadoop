...
public class TestNameNodeRpcServer {
    ...
    @Test
    public void testNamenodeRpcBindAny_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // to all interfaces.
        conf.set(DFS_NAMENODE_RPC_BIND_HOST_KEY, "0.0.0.0");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNamenodeRpcBindAny_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // to all interfaces.
        conf.set(DFS_NAMENODE_RPC_BIND_HOST_KEY, "0.0.0.0");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNamenodeRpcBindAny_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // to all interfaces.
        conf.set(DFS_NAMENODE_RPC_BIND_HOST_KEY, "0.0.0.0");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNamenodeRpcClientIpProxy_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFS_NAMENODE_IP_PROXY_USERS, "fake_joe");
        // our change overrides the random choice of datanode.
        final String[] racks = new String[] { "/rack1", "/rack2", "/rack3" };
    ...
    @Test
    public void testNamenodeRpcClientIpProxy_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFS_NAMENODE_IP_PROXY_USERS, "fake_joe");
        // our change overrides the random choice of datanode.
        final String[] racks = new String[] { "/rack1", "/rack2", "/rack3" };
    ...
    @Test
    public void testNamenodeRpcClientIpProxy_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFS_NAMENODE_IP_PROXY_USERS, "fake_joe");
        // our change overrides the random choice of datanode.
        final String[] racks = new String[] { "/rack1", "/rack2", "/rack3" };
