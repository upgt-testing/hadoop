...
public class TestTracingShortCircuitLocalRead {
    ...
    public void testShortCircuitTraceHooks() throws IOException {
        ...
        conf.set(TraceUtils.DEFAULT_HADOOP_PREFIX + Tracer.SPAN_RECEIVER_CLASSES_KEY, SetSpanReceiver.class.getName());
        conf.set(TraceUtils.DEFAULT_HADOOP_PREFIX + Tracer.SAMPLER_CLASSES_KEY, "AlwaysSampler");
