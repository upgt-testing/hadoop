...
public class TestRestartDFS {
    ...
    public void testLoadEverything() throws IOException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        urls, getClass().getClassLoader().getParent());
        ...
        Class<?> builderClass = child.loadClass("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder");
        ...
        System.out.println("Load class org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder from: " + builderClass.getProtectionDomain().getCodeSource().getLocation());
        ...
        System.out.println("MiniDFSClusterInJVM instance created successfully: " + cluster);
        // There are two constructors
        // public org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder(org.apache.hadoop.conf.Configuration)
        //public org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder(org.apache.hadoop.conf.Configuration,java.io.File)
        /**
         ...
         *
         *    // Build the MiniDFSClusterInJVM instance using the build method
         *    Method buildMethod = builderClass.getMethod("build");
         */
        /**
         ...
         *      if (c.getName().contains("MiniDFSClusterInJVM")) {
    ...
    public void testClassLoad() throws IOException, ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException {
        ...
        // cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).format(false).build();
    ...
    public void createCluster(ClassLoader child, int numNode, boolean format) throws ClassNotFoundException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, IOException {
        Class<?> configClass = child.loadClass("org.apache.hadoop.conf.Configuration");
        Class<?> builderClass = child.loadClass("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder");
        Class<?> miniClusterClass = child.loadClass("org.apache.hadoop.hdfs.MiniDFSClusterInJVM");
        // location of the configuration class
        System.out.println("Load class org.apache.hadoop.conf.Configuration from: " + configClass.getProtectionDomain().getCodeSource().getLocation());
        System.out.println("Load class org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder from: " + builderClass.getProtectionDomain().getCodeSource().getLocation());
        Constructor<?>[] configConstructors = configClass.getConstructors();
    ...
    /**
     * Create a MiniDFSClusterInJVM instance.
     */
    private Object createMiniDFSClusterInJVM(Configuration conf, int numDataNodes, boolean format, ClassLoader cl) throws Exception {
        ...
        Class<?> builderClass = cl.loadClass("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder");
        // Obtain the constructor that takes a Configuration object
        Constructor<?> builderConstructor = builderClass.getConstructor(Configuration.class);
        // Create an instance of the Builder with the provided configuration
        Object builder = builderConstructor.newInstance(conf);
        ...
        Method formatMethod = builderClass.getMethod("format", boolean.class);
        // or false depending on your test setup
        formatMethod.invoke(builder, format);
        // Build the MiniDFSClusterInJVM instance using the build method
        Method buildMethod = builderClass.getMethod("build");
    ...
    public void testCreateDifferentMiniCluster() {
         ...
         *      // check whether class loader has org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder
         *      try {
         *          assert cl != null;
         *          cl.loadClass("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder");
         *      } catch (ClassNotFoundException e) {
         *          System.out.println("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder not found in class loader");
         *          return;
         *      }
         *
         *      // Load different version of Hadoop classes
         ...
         *      try {
         *          assert cl2 != null;
         *          cl2.loadClass("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder");
         *      } catch (ClassNotFoundException e) {
         *          System.out.println("org.apache.hadoop.hdfs.MiniDFSClusterInJVM$Builder not found in class loader");
         *          return;
         *      }
         ...
         *      // Create a MiniDFSClusterInJVM instance
         *      Configuration conf = new Configuration();
         *      Object cluster = createMiniDFSClusterInJVM(conf, 1, true, cl);
         *      System.out.println("MiniDFSClusterInJVM instance with version 3.3.1 created.");
         *      Object cluster2 = createMiniDFSClusterInJVM(conf, 2, false, cl2);
         *      System.out.println("MiniDFSClusterInJVM instance with version 3.3.3 created.");
         *
         *    } catch (Exception e) {
         *      e.printStackTrace();
         *    }*
    ...
    public void runTests_withUpgrade20(Configuration conf, boolean serviceTest) throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DFSTestUtil files = new DFSTestUtil.Builder().setName("TestRestartDFS").setNumFiles(20).build();
        final String dir = "/srcdat";
        final Path rootpath = new Path("/");
    ...
    public void runTests_withUpgrade40(Configuration conf, boolean serviceTest) throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DFSTestUtil files = new DFSTestUtil.Builder().setName("TestRestartDFS").setNumFiles(20).build();
        final String dir = "/srcdat";
        final Path rootpath = new Path("/");
    ...
    public void runTests_withUpgrade60(Configuration conf, boolean serviceTest) throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DFSTestUtil files = new DFSTestUtil.Builder().setName("TestRestartDFS").setNumFiles(20).build();
        final String dir = "/srcdat";
        final Path rootpath = new Path("/");
    ...
    public void runTests_withUpgrade80(Configuration conf, boolean serviceTest) throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DFSTestUtil files = new DFSTestUtil.Builder().setName("TestRestartDFS").setNumFiles(20).build();
        final String dir = "/srcdat";
        final Path rootpath = new Path("/");
    ...
    @Test
    public void testRestartDFS_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade20(conf, false);
    }

    @Test
    public void testRestartDFS_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade40(conf, false);
    }

    @Test
    public void testRestartDFS_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade60(conf, false);
    }

    @Test
    public void testRestartDFS_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade80(conf, false);
    }

    @Test
    public void testRestartDualPortDFS_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade20(conf, true);
    }

    @Test
    public void testRestartDualPortDFS_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade40(conf, true);
    }

    @Test
    public void testRestartDualPortDFS_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade60(conf, true);
    }

    @Test
    public void testRestartDualPortDFS_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        runTests_withUpgrade80(conf, true);
    }
}
