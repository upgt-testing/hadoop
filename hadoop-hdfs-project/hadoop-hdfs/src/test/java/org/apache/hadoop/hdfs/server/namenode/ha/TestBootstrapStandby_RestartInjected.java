...
public class TestBootstrapStandby_RestartInjected {
  ...
  public void testSuccessfulBaseCase() throws Exception {
    ...
    RestartFramework.at("after_remove_standby_dirs")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_bootstrap_all_standbys")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDownloadingLaterCheckpoint() throws Exception {
    ...
    RestartFramework.at("after_make_checkpoint")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_bootstrap_nns")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSharedEditsMissingLogs() throws Exception {
    ...
    RestartFramework.at("after_delete_segment")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStandbyDirsAlreadyExist() throws Exception {
    ...
    RestartFramework.at("after_bootstrap_check")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_force_bootstrap")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testOtherNodeNotActive() throws Exception {
    ...
    RestartFramework.at("after_transition_standby")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRateThrottling() throws Exception {
    ...
    RestartFramework.at("after_first_setup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_large_image")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_setup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
