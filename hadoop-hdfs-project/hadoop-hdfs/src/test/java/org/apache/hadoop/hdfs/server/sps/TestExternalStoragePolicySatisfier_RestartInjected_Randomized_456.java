 ...
 */
public class TestExternalStoragePolicySatisfier_RestartInjected_Randomized_456 {
    ...
    public void testOutstandingQueueLimitExceeds() throws Exception {
        try {
            ...
            createCluster();
            RestartFramework.at("after_cluster_creation").on(getCluster()).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
