...
public class TestDatanodeDeath {
    ...
    class Modify extends Thread {
        ...
        private void simpleTest_withUpgrade20(int datanodeToKill) throws IOException {
        ...
        private void simpleTest_withUpgrade40(int datanodeToKill) throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
            conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_PENDING_TIMEOUT_SEC_KEY, 2);
        ...
        private void simpleTest_withUpgrade60(int datanodeToKill) throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
            conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_PENDING_TIMEOUT_SEC_KEY, 2);
        ...
        private void simpleTest_withUpgrade80(int datanodeToKill) throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
            conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_PENDING_TIMEOUT_SEC_KEY, 2);
        ...
        private void complexTest_withUpgrade20() throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
        ...
        private void complexTest_withUpgrade40() throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
            conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 2);
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_PENDING_TIMEOUT_SEC_KEY, 2);
        ...
        private void complexTest_withUpgrade60() throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
            conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 2);
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_PENDING_TIMEOUT_SEC_KEY, 2);
        ...
        private void complexTest_withUpgrade80() throws IOException {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 2000);
            conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 2);
            conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_PENDING_TIMEOUT_SEC_KEY, 2);
        ...
        @Test
        public void testSimple0_withUpgrade20() throws IOException {
            simpleTest_withUpgrade20(0);
        }

        @Test
        public void testSimple0_withUpgrade40() throws IOException {
            simpleTest_withUpgrade40(0);
        }

        @Test
        public void testSimple0_withUpgrade60() throws IOException {
            simpleTest_withUpgrade60(0);
        }

        @Test
        public void testSimple0_withUpgrade80() throws IOException {
            simpleTest_withUpgrade80(0);
        }

        @Test
        public void testSimple1_withUpgrade20() throws IOException {
            simpleTest_withUpgrade20(1);
        }

        @Test
        public void testSimple1_withUpgrade40() throws IOException {
            simpleTest_withUpgrade40(1);
        }

        @Test
        public void testSimple1_withUpgrade60() throws IOException {
            simpleTest_withUpgrade60(1);
        }

        @Test
        public void testSimple1_withUpgrade80() throws IOException {
            simpleTest_withUpgrade80(1);
        }

        @Test
        public void testSimple2_withUpgrade20() throws IOException {
            simpleTest_withUpgrade20(2);
        }

        @Test
        public void testSimple2_withUpgrade40() throws IOException {
            simpleTest_withUpgrade40(2);
        }

        @Test
        public void testSimple2_withUpgrade60() throws IOException {
            simpleTest_withUpgrade60(2);
        }

        @Test
        public void testSimple2_withUpgrade80() throws IOException {
            simpleTest_withUpgrade80(2);
        }

        @Test
        public void testComplex_withUpgrade20() throws IOException {
            complexTest_withUpgrade20();
        }

        @Test
        public void testComplex_withUpgrade40() throws IOException {
            complexTest_withUpgrade40();
        }

        @Test
        public void testComplex_withUpgrade60() throws IOException {
            complexTest_withUpgrade60();
        }

        @Test
        public void testComplex_withUpgrade80() throws IOException {
            complexTest_withUpgrade80();
        }
    }
