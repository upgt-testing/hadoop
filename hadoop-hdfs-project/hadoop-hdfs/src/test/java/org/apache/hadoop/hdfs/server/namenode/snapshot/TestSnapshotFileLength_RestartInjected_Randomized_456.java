...
public class TestSnapshotFileLength_RestartInjected_Randomized_456 {
    ...
    public void testSnapshotfileLength() throws Exception {
        ...
        RestartFramework.at("after_open_for_append").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_close_append_stream").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fis = hdfs.open(file1);
    ...
    public void testSnapshotFileLengthWithCatCommand() throws Exception {
        ...
        RestartFramework.at("after_create_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.allowSnapshot(sub);
        RestartFramework.at("after_append_file").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.createSnapshot(sub, snapshot1);
