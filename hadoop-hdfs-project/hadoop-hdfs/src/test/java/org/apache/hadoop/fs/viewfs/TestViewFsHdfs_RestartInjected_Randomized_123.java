...
public class TestViewFsHdfs_RestartInjected_Randomized_123 extends ViewFsBaseTest {
    ...
    public void testTargetFileSystemLazyInitialization() throws Exception {
        ...
        RestartFramework.at("before_final_delete").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_first_delete").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
