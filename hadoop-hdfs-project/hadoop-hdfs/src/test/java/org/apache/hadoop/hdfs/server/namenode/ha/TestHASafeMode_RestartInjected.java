...
public class TestHASafeMode_RestartInjected {
  ...
  public void testClientRetrySafeMode() throws Exception {
    ...
    RestartFramework.at("after_mkdir_check")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_leave_safemode")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testEnterSafeModeInANNShouldNotThrowNPE() throws Exception {
    ...
    RestartFramework.at("after_restart_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testBlocksAddedBeforeStandbyRestart() throws Exception {
    ...
    RestartFramework.at("after_restart_standby")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
