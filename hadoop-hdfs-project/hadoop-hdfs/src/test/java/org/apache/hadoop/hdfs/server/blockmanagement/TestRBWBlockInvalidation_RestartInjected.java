...
public class TestRBWBlockInvalidation_RestartInjected {
  ...
  public void testBlockInvalidationWhenRBWReplicaMissedInDN()
    ...
    try {
      ...
      RestartFramework.at("after_initial_hsync")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
      ...
      RestartFramework.at("after_start_additional_datanode")
          .on(cluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_corruption_detected")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_rereplication_complete")
          .on(cluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRWRInvalidation() throws Exception {
    ...
    try {
      ...
      try {
        ...
        RestartFramework.at("after_initial_write_flush")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_initial_replication")
            .on(cluster)
            .restart("datanode")
            .withIndex(1)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_new_genstamp_write")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_replication_to_one")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_datanodes_restart")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_invalidation_computation")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testRWRShouldNotAddedOnDNRestart() throws Exception {
    ...
    try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
      ...
      RestartFramework.at("after_initial_hflush")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_write_post_dn_stop")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_dn_restart")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
