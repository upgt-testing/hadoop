...
public class TestUnsetAndChangeDirectoryEcPolicy {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(TestUnsetAndChangeDirectoryEcPolicy.class);
    ...
    public void setup() throws IOException {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(dataBlocks + parityBlocks).build();
        cluster.waitActive();
  ...
  */
   ...
   */
    ...
    @Test
    public void testUnsetEcPolicyInEditLog_withUpgrade20() throws IOException {
        fs.getClient().setErasureCodingPolicy("/", ecPolicy.getName());
        Assert.assertEquals(ecPolicy, fs.getErasureCodingPolicy(new Path("/")));
    ...
    @Test
    public void testUnsetEcPolicyInEditLog_withUpgrade40() throws IOException {
        fs.getClient().setErasureCodingPolicy("/", ecPolicy.getName());
        Assert.assertEquals(ecPolicy, fs.getErasureCodingPolicy(new Path("/")));
        fs.getClient().unsetErasureCodingPolicy("/");
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testUnsetEcPolicyInEditLog_withUpgrade60() throws IOException {
        fs.getClient().setErasureCodingPolicy("/", ecPolicy.getName());
        Assert.assertEquals(ecPolicy, fs.getErasureCodingPolicy(new Path("/")));
        fs.getClient().unsetErasureCodingPolicy("/");
        cluster.restartNameNode(true);
    ...
    @Test
    public void testUnsetEcPolicyInEditLog_withUpgrade80() throws IOException {
        fs.getClient().setErasureCodingPolicy("/", ecPolicy.getName());
        Assert.assertEquals(ecPolicy, fs.getErasureCodingPolicy(new Path("/")));
        fs.getClient().unsetErasureCodingPolicy("/");
        cluster.restartNameNode(true);
