...
public class TestHdfsTextCommand {
    ...
    @Test
    public void testDisplayForAvroFiles_withUpgrade20() throws Exception {
        // Create a small Avro data file on the HDFS.
        createAvroFile(generateWeatherAvroBinaryData());
        // using reflection.
        Configuration conf = fs.getConf();
    ...
    @Test
    public void testDisplayForAvroFiles_withUpgrade40() throws Exception {
        // Create a small Avro data file on the HDFS.
        createAvroFile(generateWeatherAvroBinaryData());
        // using reflection.
        Configuration conf = fs.getConf();
    ...
    @Test
    public void testDisplayForAvroFiles_withUpgrade60() throws Exception {
        // Create a small Avro data file on the HDFS.
        createAvroFile(generateWeatherAvroBinaryData());
        // using reflection.
        Configuration conf = fs.getConf();
    ...
    @Test
    public void testDisplayForAvroFiles_withUpgrade80() throws Exception {
        // Create a small Avro data file on the HDFS.
        createAvroFile(generateWeatherAvroBinaryData());
        // using reflection.
        Configuration conf = fs.getConf();
