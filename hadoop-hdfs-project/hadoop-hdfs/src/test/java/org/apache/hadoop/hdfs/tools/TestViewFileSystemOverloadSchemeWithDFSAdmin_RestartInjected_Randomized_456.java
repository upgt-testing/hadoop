 ...
 */
public class TestViewFileSystemOverloadSchemeWithDFSAdmin_RestartInjected_Randomized_456 {
    ...
    public void testSaveNameSpace() throws Exception {
        ...
        RestartFramework.at("after_mount_links_configured").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        redirectStream();
    ...
    public void testGetSafemodeWithoutMountLinksConfigured() throws Exception {
        RestartFramework.at("before_safemode_get").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        try {
            redirectStream();
    ...
    public void testSetBalancerBandwidth() throws Exception {
        ...
        RestartFramework.at("after_set_balancer_bandwidth").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(0, ret);
    }
}
