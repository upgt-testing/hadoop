...
public class TestBPOfferService {
   ...
   */
    ...
    */
    ...
    @Test(timeout = 15000)
    public void testCommandProcessingThread_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 15000)
    public void testCommandProcessingThread_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 15000)
    public void testCommandProcessingThread_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 15000)
    public void testCommandProcessingThread_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 5000)
    public void testCommandProcessingThreadExit_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 5000)
    public void testCommandProcessingThreadExit_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 5000)
    public void testCommandProcessingThreadExit_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
    ...
    @Test(timeout = 5000)
    public void testCommandProcessingThreadExit_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
            List<DataNodeJVMInterface> datanodes = cluster.getDataNodes();
