 ...
 */
public class TestFSNamesystemMBean_RestartInjected_Randomized_123 {
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_snapshot_stats").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testWithFSNamesystemWriteLock() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("before_write_lock").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            fsn.writeLock();
    ...
    public void testWithFSEditLogLock() throws Exception {
        ...
        try {
            ...
            cluster.waitActive();
            RestartFramework.at("after_cluster_start").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            RestartFramework.at("before_editlog_lock").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testFsEditLogMetrics() throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < NUM_OPS; i++) {
                ...
                fs.mkdirs(path);
                if (i == 4) {
                    RestartFramework.at("during_mkdirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
                }
            }
