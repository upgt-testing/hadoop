...
public class TestFailureToReadEdits_RestartInjected {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestFailureToReadEdits_RestartInjected.class);
  ...
  public TestFailureToReadEdits_RestartInjected(TestType clusterType, Boolean
      useAsyncEditLogging) {
  ...
  public void testFailuretoReadEdits() throws Exception {
    ...
    RestartFramework.at("after_first_mkdirs_and_catchup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_setowner_delete")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdirs_test_dir2")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdirs_test_dir3")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_cause_failure_on_editlog")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_allow_editlog_read")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckpointStartingMidEditsFile() throws Exception {
    ...
    RestartFramework.at("after_mkdirs_test_dir2_dir3")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
