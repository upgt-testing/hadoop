...
public class TestFcHdfsSetUMask_RestartInjected {

  private static final FileContextTestHelper fileContextTestHelper =
      new FileContextTestHelper("/tmp/TestFcHdfsSetUMask_RestartInjected");
  ...
  public void testMkdirWithExistingDirClear() throws IOException {
    RestartFramework.at("before_mkdir_existing_clear")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_mkdir_existing_clear")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirWithExistingDirOpen() throws IOException {
    RestartFramework.at("before_mkdir_existing_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_existing_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirWithExistingDirMiddle() throws IOException {
    RestartFramework.at("before_mkdir_existing_middle")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_existing_middle")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirRecursiveWithNonExistingDirClear() throws IOException {
    RestartFramework.at("before_mkdir_recursive_clear")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_recursive_clear")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirRecursiveWithNonExistingDirOpen() throws IOException {
    RestartFramework.at("before_mkdir_recursive_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_recursive_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirRecursiveWithNonExistingDirMiddle() throws IOException {
    RestartFramework.at("before_mkdir_recursive_middle")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_recursive_middle")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithExistingDirClear() throws IOException {
    RestartFramework.at("before_create_existing_clear")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_existing_clear")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithExistingDirOpen() throws IOException {
    RestartFramework.at("before_create_existing_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_existing_open")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithExistingDirMiddle() throws IOException {
    RestartFramework.at("before_create_existing_middle")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_existing_middle")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithNonExistingDirClear() throws IOException {
    RestartFramework.at("before_create_nonexisting_clear")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_nonexisting_clear")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithNonExistingDirOpen() throws IOException {
    RestartFramework.at("before_create_nonexisting_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_nonexisting_open")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithNonExistingDirMiddle() throws IOException {
    RestartFramework.at("before_create_nonexisting_middle")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_nonexisting_middle")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
