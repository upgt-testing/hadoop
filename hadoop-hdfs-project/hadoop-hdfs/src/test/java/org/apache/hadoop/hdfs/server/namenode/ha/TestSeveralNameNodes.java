...
public class TestSeveralNameNodes {
    ...
    @Test
    public void testCircularLinkedListWrites_withUpgrade20() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        // setup the harness
        harness.setNumberOfNameNodes(NUM_NAMENODES);
        harness.addFailoverThread(TIME_BETWEEN_FAILOVERS);
    ...
    @Test
    public void testCircularLinkedListWrites_withUpgrade40() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        // setup the harness
        harness.setNumberOfNameNodes(NUM_NAMENODES);
        harness.addFailoverThread(TIME_BETWEEN_FAILOVERS);
    ...
    @Test
    public void testCircularLinkedListWrites_withUpgrade60() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        // setup the harness
        harness.setNumberOfNameNodes(NUM_NAMENODES);
        harness.addFailoverThread(TIME_BETWEEN_FAILOVERS);
