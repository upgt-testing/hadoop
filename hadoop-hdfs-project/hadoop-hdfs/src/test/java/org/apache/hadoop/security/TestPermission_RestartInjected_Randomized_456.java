 ...
 */
public class TestPermission_RestartInjected_Randomized_456 {
    ...
    public void testCreate() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_mkdir_a1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_mkdir_aa").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_file_create_b1").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            conf.set(FsPermission.UMASK_LABEL, "022");
            ...
            RestartFramework.at("after_mkdir_c1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            try {
                if (fs != null)
                    fs.close();
    ...
    public void testFilePermission() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_file_create_with_permission").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_dir_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            assertThat("Expect 755 = 777 (default dir) - 022 (default umask)", status.getPermission().toString(), is("rwxr-xr-x"));
            RestartFramework.at("after_dir_create_null_perm").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_file_open_read").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            nnfs.setPermission(CHILD_FILE1, new FsPermission("700"));
            RestartFramework.at("after_execution_bit_test").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ////////////////////////////////////////////////////////////////
            ...
            RestartFramework.at("after_user_switch").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_permission_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    private void testSuperCanChangeOwnerGroup() throws Exception {
        ...
        assertThat("A super user can change owner", status.getOwner(), is(NOUSER));
        assertThat("A super user can change group", status.getGroup(), is(NOGROUP));
    }
    ...
    private void testNonSuperCanChangeToOwnGroup() throws Exception {
        ...
        assertThat("A non-super user can change a file to own group", nnfs.getFileStatus(file).getGroup(), is(GROUP_NAMES[1]));
    }
    ...
    private void testNonSuperCannotChangeToOtherGroup() throws Exception {
        ...
        try {
            ...
            fail("Expect ACE when a non-super user tries to change a file to a " + "group where the user does not belong.");
        } catch (AccessControlException e) {
            assertThat(e.getMessage(), startsWith("User " + userfs.getFileStatus(file).getOwner() + " does not belong to"));
        }
    }
    ...
    private void testNonSuperCannotChangeOwner() throws Exception {
        ...
        try {
            ...
            assertThat(e.getMessage(), startsWith("User " + userfs.getFileStatus(file).getOwner() + " is not a super user (non-super user cannot change owner)"));
        }
    }
