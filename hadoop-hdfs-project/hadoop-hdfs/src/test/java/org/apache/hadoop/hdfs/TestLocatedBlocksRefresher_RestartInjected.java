...
public class TestLocatedBlocksRefresher_RestartInjected {
  ...
  public void testRefreshOnDeadNodes() throws Exception {
    ...
    try (DFSInputStream fin = client.open(fileName)) {
      RestartFramework.at("after_stream_open")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_stream_tracking")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_node_stop")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_node_stop")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      assertRefreshes(refresher, 1);
      RestartFramework.at("after_second_refresh")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
