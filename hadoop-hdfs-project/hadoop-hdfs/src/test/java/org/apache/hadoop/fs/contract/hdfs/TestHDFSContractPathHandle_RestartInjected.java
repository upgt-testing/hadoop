...
public class TestHDFSContractPathHandle_RestartInjected
    extends AbstractContractPathHandleTest {

  public TestHDFSContractPathHandle_RestartInjected(String testname, Options.HandleOpt[] opts,
      boolean serialized) {
  ...
  public void testGetPathHandle() throws Exception {
    ...
    RestartFramework.at("after_get_path_handle")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testOpenWithPathHandle() throws Exception {
    ...
    RestartFramework.at("before_create_for_handle")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_get_handle")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_open_with_handle")
        .on(HDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
