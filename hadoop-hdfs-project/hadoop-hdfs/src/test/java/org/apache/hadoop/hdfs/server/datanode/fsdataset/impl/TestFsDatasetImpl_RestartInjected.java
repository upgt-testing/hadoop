...
public class TestFsDatasetImpl_RestartInjected {
  ...
  public void testAddVolumeWithSameStorageUuid() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("before_datanode_restart")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeletingBlocks() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_replica_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_block_invalidation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReportBadBlocks() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("before_report_bad_blocks")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMoveBlockFailure() {
    ...
    try {
      ...
      RestartFramework.at("after_append_hflush")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMoveBlockSuccess() {
    ...
    try {
      ...
      RestartFramework.at("before_finalize_new_replica")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testBlockReadOpWhileMovingBlock() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_partial_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReleaseVolumeRefIfExceptionThrown() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_replica_setup")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
