...
public class TestHttpsFileSystem {
    ...
    @Test
    public void testHsftpFileSystem_withUpgrade20() throws Exception {
        FileSystem fs = FileSystem.get(new URI("hsftp://" + nnAddr), conf);
        Assert.assertTrue(fs.exists(new Path("/test")));
        InputStream is = fs.open(new Path("/test"));
    ...
    @Test
    public void testHsftpFileSystem_withUpgrade40() throws Exception {
        FileSystem fs = FileSystem.get(new URI("hsftp://" + nnAddr), conf);
        Assert.assertTrue(fs.exists(new Path("/test")));
        InputStream is = fs.open(new Path("/test"));
        Assert.assertEquals(23, is.read());
    ...
    @Test
    public void testHsftpFileSystem_withUpgrade60() throws Exception {
        FileSystem fs = FileSystem.get(new URI("hsftp://" + nnAddr), conf);
        Assert.assertTrue(fs.exists(new Path("/test")));
        InputStream is = fs.open(new Path("/test"));
        Assert.assertEquals(23, is.read());
    ...
    @Test
    public void testHsftpFileSystem_withUpgrade80() throws Exception {
        FileSystem fs = FileSystem.get(new URI("hsftp://" + nnAddr), conf);
        Assert.assertTrue(fs.exists(new Path("/test")));
        InputStream is = fs.open(new Path("/test"));
        Assert.assertEquals(23, is.read());
    ...
    @Test
    public void testSWebHdfsFileSystem_withUpgrade20() throws Exception {
        FileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, "swebhdfs");
        final Path f = new Path("/testswebhdfs");
        FSDataOutputStream os = fs.create(f);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testSWebHdfsFileSystem_withUpgrade40() throws Exception {
        FileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, "swebhdfs");
        final Path f = new Path("/testswebhdfs");
        FSDataOutputStream os = fs.create(f);
        os.write(23);
    ...
    @Test
    public void testSWebHdfsFileSystem_withUpgrade60() throws Exception {
        FileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, "swebhdfs");
        final Path f = new Path("/testswebhdfs");
        FSDataOutputStream os = fs.create(f);
        os.write(23);
    ...
    @Test
    public void testSWebHdfsFileSystem_withUpgrade80() throws Exception {
        FileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, "swebhdfs");
        final Path f = new Path("/testswebhdfs");
        FSDataOutputStream os = fs.create(f);
        os.write(23);
