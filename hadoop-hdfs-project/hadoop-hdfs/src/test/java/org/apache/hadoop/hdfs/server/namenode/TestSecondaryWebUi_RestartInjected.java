...
public class TestSecondaryWebUi_RestartInjected {
  ...
  public void testSecondaryWebUi()
    ...
    RestartFramework.at("after_mbean_server_obtained")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_checkpoint_directories_validated")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_checkpoint_editlog_directories_validated")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
