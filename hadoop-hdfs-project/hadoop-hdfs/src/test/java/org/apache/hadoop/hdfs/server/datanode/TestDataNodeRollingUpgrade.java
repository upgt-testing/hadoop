...
import org.apache.hadoop.hdfs.MiniDockerDFSCluster.Builder;
...
public class TestDataNodeRollingUpgrade {
    ...
    private boolean isTrashRootPresent() {
        ...
        BlockPoolSliceStorageInterface bps = dn0.getStorage().getBPStorage(blockPoolId);
    ...
    private void rollbackRollingUpgrade() throws Exception {
        ...
        MiniDockerDFSCluster.DataNodeProperties dnprop = cluster.stopDataNode(0);
