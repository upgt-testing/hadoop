 ...
 * etc.
 */
public class TestNNStorageRetentionFunctional_RestartInjected {
  ...
  */
  ...
  public void testPurgingWithNameEditsDirAfterFailure()
    ...
    try {
      ...
      doSaveNamespace(nn);
      RestartFramework.at("after_second_savenamespace")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_chmod_fail")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      doSaveNamespace(nn);
      RestartFramework.at("after_fourth_savenamespace")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
