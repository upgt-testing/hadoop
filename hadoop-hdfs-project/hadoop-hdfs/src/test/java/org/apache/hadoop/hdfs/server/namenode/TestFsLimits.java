...
public class TestFsLimits {
    ...
    public void setUp() throws IOException {
        ...
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, fileAsURI(new File(MiniDockerDFSCluster.getBaseDirectory(), "namenode")).toString());
     ...
     */
    void testParentDirectoryNameIsCorrect() throws Exception {
