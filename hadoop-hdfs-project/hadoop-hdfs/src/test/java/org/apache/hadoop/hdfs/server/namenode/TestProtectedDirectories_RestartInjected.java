 ...
 */
public class TestProtectedDirectories_RestartInjected {
  ...
  public void testReconfigureProtectedPaths() throws Throwable {
    ...
    RestartFramework.at("after_reconfigure")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_revert")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDelete() throws Throwable {
    for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
      ...
      try {
        ...
        RestartFramework.at("after_delete_operations")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testMoveToTrash() throws Throwable {
    for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
      ...
      try {
        ...
        RestartFramework.at("after_trash_operations")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testRename() throws Throwable {
    for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
      ...
      try {
        ...
        RestartFramework.at("after_rename_operations")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
