...
public class TestMiniDFSCluster_RestartInjected {
  ...
  public void testClusterSetStorageCapacity() throws Throwable {
    ...
    try {
      ...
      cluster.waitActive();
      verifyStorageCapacity(cluster, capacities);
      RestartFramework.at("after_datanode_restart_verification")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      cluster.waitActive();
      verifyStorageCapacity(cluster, capacities);
      RestartFramework.at("after_namenode_restart_verification")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      cluster.waitActive();
      verifyStorageCapacity(cluster, capacities);
      RestartFramework.at("after_namenode_datanode_restart_verification")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      cluster.waitActive();
      verifyStorageCapacity(cluster, capacities);
      RestartFramework.at("after_datanode_namenode_restart_verification")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testIsClusterUpAfterShutdown() throws Throwable {
    ...
    try {
      ...
      RestartFramework.at("after_safemode_entry")
          .on(cluster4)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetUpFederatedCluster() throws Exception {
    ...
    try (MiniDFSCluster cluster =
      ...
      RestartFramework.at("after_configuration_verification")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_namenode_shutdown")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_namenode_shutdown")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testStartStopWithPorts() throws Exception {
    ...
    try (MiniDFSCluster miniDfsCluster = new MiniDFSCluster.Builder(conf)
      ...
      RestartFramework.at("after_port_verification")
          .on(miniDfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
