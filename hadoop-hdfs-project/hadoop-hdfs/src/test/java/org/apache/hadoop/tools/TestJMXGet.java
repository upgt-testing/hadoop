...
public class TestJMXGet {
    ...
    @Test
    public void testNameNode_withUpgrade20() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test1"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testNameNode_withUpgrade40() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test1"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testNameNode_withUpgrade60() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test1"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testNameNode_withUpgrade80() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test1"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testDataNode_withUpgrade20() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testDataNode_withUpgrade40() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testDataNode_withUpgrade60() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test"), fileSize, fileSize, blockSize, (short) 2, seed);
    ...
    @Test
    public void testDataNode_withUpgrade80() throws Exception {
        int numDatanodes = 2;
        cluster = new MiniDFSClusterInJVM.Builder(config).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        DFSTestUtil.createFile(cluster.getFileSystem(), new Path("/test"), fileSize, fileSize, blockSize, (short) 2, seed);
