...
public class TestXAttrWithSnapshot_RestartInjected {
  ...
  public void testModifyReadsCurrentState() throws Exception {
    ...
    RestartFramework.at("after_modify_xattr1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_modify_xattr2")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_remove_xattrs")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testXattrWithSnapshotAndNNRestart() throws Exception {
    ...
    FileSystem.mkdirs(hdfs, path, FsPermission.createImmutable((short) 0700));
    hdfs.setXAttr(path, name1, value1);
    RestartFramework.at("after_set_xattr")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRemoveReadsCurrentState() throws Exception {
    ...
    hdfs.removeXAttr(path, name2);
    RestartFramework.at("after_remove_xattr_name2")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    hdfs.removeXAttr(path, name1);
    RestartFramework.at("after_remove_xattr_name1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testXAttrForSnapshotRootAfterChange() throws Exception {
    ...
    RestartFramework.at("after_change_xattr")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSuccessiveSnapshotXAttrChanges() throws Exception {
    ...
    hdfs.setXAttr(path, name1, value1);
    SnapshotTestHelper.createSnapshot(hdfs, path, snapshotName);
    RestartFramework.at("after_create_snapshot1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_snapshot2")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_snapshot3")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_delete_snapshot2")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
