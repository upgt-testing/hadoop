...
public class TestCacheAdminCLI_RestartInjected extends CLITestHelper {

  public static final Logger LOG =
      LoggerFactory.getLogger(TestCacheAdminCLI_RestartInjected.class);
  ...
  public void testAll () {
    ...
    RestartFramework.at("after_cache_operations")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
