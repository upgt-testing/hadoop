 ...
 */
public class TestProvidedImpl_RestartInjected_Randomized_456 {
    ...
    public void testProvidedReplicaWithPathHandle() throws Exception {
        ...
        RestartFramework.at("after_file_rename").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_path_handle_retrieval").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
