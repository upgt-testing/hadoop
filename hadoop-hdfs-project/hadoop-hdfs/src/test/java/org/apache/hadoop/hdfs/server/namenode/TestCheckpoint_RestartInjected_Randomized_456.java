 ...
 */
public class TestCheckpoint_RestartInjected_Randomized_456 {

    static {
        GenericTestUtils.setLogLevel(FSImage.LOG, Level.TRACE);
    }

    static final Logger LOG = LoggerFactory.getLogger(TestCheckpoint_RestartInjected.class);
   ...
   */
    ...
    public void testReloadOnEditReplayFailure() throws IOException {
        ...
        try {
            ...
            fos.write(new byte[] { 0, 1, 2, 3 });
            fos.hsync();
            RestartFramework.at("after_hsync").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
   ...
   */
    ...
    public void testSecondaryNamenodeError3() throws IOException {
        ...
        try {
            ...
            secondary = startSecondaryNameNode(conf);
            secondary.doCheckpoint();
            RestartFramework.at("after_final_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            secondary.shutdown();
        } finally {
            fileSys.close();
            cleanup(secondary);
    ...
    public void testImportCheckpoint() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_import_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCheckpoint() throws IOException {
        ...
        try {
            ...
            //
            DFSTestUtil.createFile(fileSys, file1, fileSize, fileSize, blockSize, replication, seed);
            RestartFramework.at("after_file1_create").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            checkFile(fileSys, file1, replication);
            for (int i = 0; i < 1000; i++) {
                fileSys.mkdirs(tmpDir);
                fileSys.delete(tmpDir, true);
            }
            RestartFramework.at("after_mkdir_delete_loop").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            //
            // Take a checkpoint
            //
            secondary = startSecondaryNameNode(conf);
        ...
        try {
            ...
            RestartFramework.at("after_file2_create").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            fileSys.mkdirs(tmpDir);
            secondary.doCheckpoint();
            RestartFramework.at("after_third_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            fileSys.close();
            cleanup(secondary);
            secondary = null;
        ...
        RestartFramework.at("after_final_cluster_restart").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testSaveNamespace() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_symlink_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCheckpointAfterTwoFailedUploads() throws IOException {
        ...
        try {
            ...
            secondary.doCheckpoint();
            RestartFramework.at("after_successful_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            cleanup(secondary);
            secondary = null;
            cleanup(cluster);
    ...
    public void testMultipleSecondaryNamenodes() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_second_checkpoint").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        } finally {
            cleanup(secondary1);
            secondary1 = null;
            cleanup(secondary2);
    ...
    public void testFailureBeforeRename() throws IOException {
        ...
        try {
            ...
            fos = fs.create(new Path("tmpfile0"));
            fos.write(new byte[] { 0, 1, 2, 3 });
            RestartFramework.at("after_file_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            secondary.doCheckpoint();
            RestartFramework.at("after_first_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            fos.write(new byte[] { 0, 1, 2, 3 });
            fos.hsync();
            RestartFramework.at("after_hsync").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // Cause merge to fail in next checkpoint.
    ...
    public void testEditFailureBeforeRename() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_first_file_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            secondary.doCheckpoint();
            RestartFramework.at("after_first_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_second_file_create").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            try {
                secondary.doCheckpoint();
                fail("Fault injection failed.");
            } catch (IOException ioe) {
    ...
    public void testDeleteTemporaryEditsOnStartup() throws IOException {
        ...
        try {
            ...
            secondary.shutdown();
            secondary = startSecondaryNameNode(conf);
            RestartFramework.at("after_secondary_restart").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMultipleSecondaryNNsAgainstSameNN() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_secondary_start").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testReformatNNBetweenCheckpoints() throws IOException {
        ...
        try {
            cluster = new MiniDFSCluster.Builder(conf).numDataNodes(0).format(true).build();
            RestartFramework.at("after_first_cluster_start").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_second_cluster_start").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            try {
                secondary.doCheckpoint();
    ...
    public void testSecondaryPurgesEditLogs() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_checkpoints").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testLegacyOivImage() throws Exception {
        ...
        try {
            ...
            secondary.doCheckpoint();
            secondary.doCheckpoint();
            RestartFramework.at("after_more_checkpoints").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testActiveRejectSmallerTxidDeltaImage() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_first_mkdirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            active = cluster.getNameNode();
            // Checkpoint 1st
            secondary.doCheckpoint();
            RestartFramework.at("after_first_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_second_mkdirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            active = cluster.getNameNode();
            // Checkpoint 2nd
            secondary.doCheckpoint();
            RestartFramework.at("after_second_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
