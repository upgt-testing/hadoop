...
public class TestFileChecksum {
    ...
    public void testStripedFileChecksumWithReconstructFail() throws Exception {
        ...
        doThrow(new IOException()).doNothing().when(newInjector).stripedBlockChecksumReconstruction();
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum1_withUpgrade20() throws Exception {
        int length = 0;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum1_withUpgrade60() throws Exception {
        int length = 0;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, length + 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum2_withUpgrade20() throws Exception {
        int length = stripSize - 1;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum2_withUpgrade60() throws Exception {
        int length = stripSize - 1;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, length - 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum3_withUpgrade20() throws Exception {
        int length = stripSize;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum3_withUpgrade60() throws Exception {
        int length = stripSize;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, length - 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum4_withUpgrade20() throws Exception {
        int length = stripSize + cellSize * 2;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum4_withUpgrade60() throws Exception {
        int length = stripSize + cellSize * 2;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, length - 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum5_withUpgrade20() throws Exception {
        int length = blockGroupSize;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum5_withUpgrade60() throws Exception {
        int length = blockGroupSize;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, length - 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum6_withUpgrade20() throws Exception {
        int length = blockGroupSize + blockSize;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum6_withUpgrade60() throws Exception {
        int length = blockGroupSize + blockSize;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, length - 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum7_withUpgrade20() throws Exception {
        // whole file
        int length = -1;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksum7_withUpgrade60() throws Exception {
        // whole file
        int length = -1;
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        testStripedFileChecksum(length, fileSize);
    ...
    @Test(timeout = 90000)
    public void testStripedAndReplicatedFileChecksum_withUpgrade20() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, replicatedFile });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, 10, false);
        FileChecksum replicatedFileChecksum = getFileChecksum(replicatedFile, 10, false);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedAndReplicatedFileChecksum_withUpgrade40() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, replicatedFile });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, 10, false);
        FileChecksum replicatedFileChecksum = getFileChecksum(replicatedFile, 10, false);
        if (expectComparableStripedAndReplicatedFiles()) {
    ...
    @Test(timeout = 90000)
    public void testStripedAndReplicatedFileChecksum_withUpgrade80() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, replicatedFile });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, 10, false);
        FileChecksum replicatedFileChecksum = getFileChecksum(replicatedFile, 10, false);
        if (expectComparableStripedAndReplicatedFiles()) {
    ...
    @Test(timeout = 90000)
    public void testDifferentBlockSizeReplicatedFileChecksum_withUpgrade20() throws Exception {
        byte[] fileData = StripedFileTestUtil.generateBytes(fileSize);
        String replicatedFile1 = "/replicatedFile1";
        String replicatedFile2 = "/replicatedFile2";
        DFSTestUtil.writeFile(fs, new Path(replicatedFile1), fileData, blockSize);
    ...
    @Test(timeout = 90000)
    public void testDifferentBlockSizeReplicatedFileChecksum_withUpgrade40() throws Exception {
        byte[] fileData = StripedFileTestUtil.generateBytes(fileSize);
        String replicatedFile1 = "/replicatedFile1";
        String replicatedFile2 = "/replicatedFile2";
        DFSTestUtil.writeFile(fs, new Path(replicatedFile1), fileData, blockSize);
    ...
    @Test(timeout = 90000)
    public void testDifferentBlockSizeReplicatedFileChecksum_withUpgrade60() throws Exception {
        byte[] fileData = StripedFileTestUtil.generateBytes(fileSize);
        String replicatedFile1 = "/replicatedFile1";
        String replicatedFile2 = "/replicatedFile2";
        DFSTestUtil.writeFile(fs, new Path(replicatedFile1), fileData, blockSize);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks1_withUpgrade20() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, fileSize, false);
        FileChecksum stripedFileChecksumRecon = getFileChecksum(stripedFile1, fileSize, true);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks1_withUpgrade40() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, fileSize, false);
        FileChecksum stripedFileChecksumRecon = getFileChecksum(stripedFile1, fileSize, true);
        LOG.info("stripedFileChecksum1:" + stripedFileChecksum1);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks1_withUpgrade60() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, fileSize, false);
        FileChecksum stripedFileChecksumRecon = getFileChecksum(stripedFile1, fileSize, true);
        LOG.info("stripedFileChecksum1:" + stripedFileChecksum1);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks1_withUpgrade80() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, fileSize, false);
        FileChecksum stripedFileChecksumRecon = getFileChecksum(stripedFile1, fileSize, true);
        LOG.info("stripedFileChecksum1:" + stripedFileChecksum1);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks2_withUpgrade20() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, -1, false);
        FileChecksum stripedFileChecksum2 = getFileChecksum(stripedFile2, -1, false);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks2_withUpgrade40() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, -1, false);
        FileChecksum stripedFileChecksum2 = getFileChecksum(stripedFile2, -1, false);
        FileChecksum stripedFileChecksum2Recon = getFileChecksum(stripedFile2, -1, true);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks2_withUpgrade60() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, -1, false);
        FileChecksum stripedFileChecksum2 = getFileChecksum(stripedFile2, -1, false);
        FileChecksum stripedFileChecksum2Recon = getFileChecksum(stripedFile2, -1, true);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocks2_withUpgrade80() throws Exception {
        prepareTestFiles(fileSize, new String[] { stripedFile1, stripedFile2 });
        FileChecksum stripedFileChecksum1 = getFileChecksum(stripedFile1, -1, false);
        FileChecksum stripedFileChecksum2 = getFileChecksum(stripedFile2, -1, false);
        FileChecksum stripedFileChecksum2Recon = getFileChecksum(stripedFile2, -1, true);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery1_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery2_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, 10);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery3_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, bytesPerCRC);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery4_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, cellSize);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery5_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, cellSize - 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery6_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, cellSize + 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery7_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, cellSize * 2);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery8_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, stripSize);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery9_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, stripSize - 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery10_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, stripSize + 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery11_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, blockGroupSize - 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery12_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, blockGroupSize + 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery13_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, blockGroupSize * numBlockGroups / 2);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery14_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, fileSize - 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery15_withUpgrade20() throws Exception {
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile1, fileSize * 2);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery16_withUpgrade20() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery16_withUpgrade40() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery16_withUpgrade80() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile3, fileLength - 1);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery17_withUpgrade20() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery17_withUpgrade40() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery17_withUpgrade80() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile3, 1);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery18_withUpgrade20() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery18_withUpgrade40() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery18_withUpgrade80() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile3, 10);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery19_withUpgrade20() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery19_withUpgrade40() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery19_withUpgrade80() throws Exception {
        int fileLength = 100;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile3, fileLength * 2);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery20_withUpgrade20() throws Exception {
        int fileLength = bytesPerCRC;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery20_withUpgrade40() throws Exception {
        int fileLength = bytesPerCRC;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithMissedDataBlocksRangeQuery20_withUpgrade80() throws Exception {
        int fileLength = bytesPerCRC;
        String stripedFile3 = ecDir + "/stripedFileChecksum3";
        prepareTestFiles(fileLength, new String[] { stripedFile3 });
        testStripedFileChecksumWithMissedDataBlocksRangeQuery(stripedFile3, bytesPerCRC - 1);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithReconstructFail_withUpgrade20() throws Exception {
        String stripedFile4 = ecDir + "/stripedFileChecksum4";
        prepareTestFiles(fileSize, new String[] { stripedFile4 });
        // get checksum
        FileChecksum fileChecksum = getFileChecksum(stripedFile4, -1, false);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithReconstructFail_withUpgrade40() throws Exception {
        String stripedFile4 = ecDir + "/stripedFileChecksum4";
        prepareTestFiles(fileSize, new String[] { stripedFile4 });
        // get checksum
        FileChecksum fileChecksum = getFileChecksum(stripedFile4, -1, false);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithReconstructFail_withUpgrade60() throws Exception {
        String stripedFile4 = ecDir + "/stripedFileChecksum4";
        prepareTestFiles(fileSize, new String[] { stripedFile4 });
        // get checksum
        FileChecksum fileChecksum = getFileChecksum(stripedFile4, -1, false);
    ...
    @Test(timeout = 90000)
    public void testStripedFileChecksumWithReconstructFail_withUpgrade80() throws Exception {
        String stripedFile4 = ecDir + "/stripedFileChecksum4";
        prepareTestFiles(fileSize, new String[] { stripedFile4 });
        // get checksum
        FileChecksum fileChecksum = getFileChecksum(stripedFile4, -1, false);
    ...
    @Test(timeout = 90000)
    public void testMixedBytesPerChecksum_withUpgrade20() throws Exception {
        int fileLength = bytesPerCRC * 3;
        byte[] fileData = StripedFileTestUtil.generateBytes(fileLength);
        String replicatedFile1 = "/replicatedFile1";
        // Split file into two parts.
    ...
    @Test(timeout = 90000)
    public void testMixedBytesPerChecksum_withUpgrade40() throws Exception {
        int fileLength = bytesPerCRC * 3;
        byte[] fileData = StripedFileTestUtil.generateBytes(fileLength);
        String replicatedFile1 = "/replicatedFile1";
        // Split file into two parts.
    ...
    @Test(timeout = 90000)
    public void testMixedBytesPerChecksum_withUpgrade60() throws Exception {
        int fileLength = bytesPerCRC * 3;
        byte[] fileData = StripedFileTestUtil.generateBytes(fileLength);
        String replicatedFile1 = "/replicatedFile1";
        // Split file into two parts.
    ...
    @Test(timeout = 90000)
    public void testMixedBytesPerChecksum_withUpgrade80() throws Exception {
        int fileLength = bytesPerCRC * 3;
        byte[] fileData = StripedFileTestUtil.generateBytes(fileLength);
        String replicatedFile1 = "/replicatedFile1";
        // Split file into two parts.
