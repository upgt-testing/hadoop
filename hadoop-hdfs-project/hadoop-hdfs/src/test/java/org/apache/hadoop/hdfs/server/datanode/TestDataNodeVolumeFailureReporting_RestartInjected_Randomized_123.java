 ...
 */
public class TestDataNodeVolumeFailureReporting_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestDataNodeVolumeFailureReporting_RestartInjected.class);

    {
        GenericTestUtils.setLogLevel(TestDataNodeVolumeFailureReporting_RestartInjected.LOG, Level.TRACE);
    }
     ...
     */
        ...
        RestartFramework.at("after_all_volumes_fail").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
     ...
     */
        ...
        RestartFramework.at("after_datanode_restart").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        /*
     ...
     */
        ...
        RestartFramework.at("after_additional_datanodes_start").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
     ...
     */
        ...
        checkFailuresAtNameNode(dm, dns.get(0), true, dn1Vol1.getAbsolutePath());
        RestartFramework.at("after_final_file_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        checkFailuresAtNameNode(dm, dns.get(1), true, dn2Vol1.getAbsolutePath());
        checkFailuresAtNameNode(dm, dns.get(2), true, dn3Vol1.getAbsolutePath());
        /*
     ...
     */
        ...
        RestartFramework.at("after_third_volume_failure").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
     ...
     */
        ...
        RestartFramework.at("after_first_volume_failures").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testVolFailureStatsPreservedOnNNRestart() throws Exception {
        ...
        RestartFramework.at("after_nn_restart").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ArrayList<DataNode> dns = cluster.getDataNodes();
    ...
    public void testDataNodeReconfigureWithVolumeFailures() throws Exception {
        ...
        File dn1Vol2 = cluster.getInstanceStorageDir(0, 1);
        File dn2Vol1 = cluster.getInstanceStorageDir(1, 0);
        RestartFramework.at("after_volume_restore").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_volume_failures").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        File dn2Vol2 = cluster.getInstanceStorageDir(1, 1);
        ...
        RestartFramework.at("after_second_reconfigure").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        DFSTestUtil.waitForDatanodeStatus(dm, 3, 0, 0, origCapacity, WAIT_FOR_HEARTBEATS);
        checkAggregateFailuresAtNameNode(true, 0);
        checkFailuresAtNameNode(dm, dns.get(0), true);
        checkFailuresAtNameNode(dm, dns.get(1), true);
    ...
    public void testAutoFormatEmptyDirectory() throws Exception {
        ...
        RestartFramework.at("after_version_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testHotSwapOutFailedVolumeAndReporting() throws Exception {
        ...
        RestartFramework.at("after_initial_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_failed_reconfigure").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        Assert.assertEquals(dn0.getFSDataset().getNumFailedVolumes(), numFailedVolumes);
        checkFailuresAtDataNode(dn0, 1, true, new String[] { dn0Vol1.getAbsolutePath() });
        RestartFramework.at("after_first_volume_failure").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_second_volume_failure").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        numFailedVolumes = (int) mbs.getAttribute(mxbeanName, "NumFailedVolumes");
        ...
        Assert.assertEquals(dn0.getFSDataset().getNumFailedVolumes(), numFailedVolumes);
        checkFailuresAtDataNode(dn0, 0, true, new String[] {});
        RestartFramework.at("after_hot_swap_out").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Fail dn0Vol2.
