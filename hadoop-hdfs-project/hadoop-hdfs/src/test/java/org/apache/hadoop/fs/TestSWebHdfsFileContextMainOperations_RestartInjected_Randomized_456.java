 ...
 */
public class TestSWebHdfsFileContextMainOperations_RestartInjected_Randomized_456 extends TestWebHdfsFileContextMainOperations {
    ...
    private static final String BASEDIR = GenericTestUtils.getTempPath(TestSWebHdfsFileContextMainOperations_RestartInjected.class.getSimpleName());
    ...
    public static void clusterSetupAtBeginning() throws IOException, LoginException, URISyntaxException {
        ...
        try {
            sslConfDir = KeyStoreTestUtil.getClasspathDir(TestSWebHdfsFileContextMainOperations_RestartInjected.class);
    ...
    protected FileContextTestHelper createFileContextHelper() {
        return new FileContextTestHelper("/tmp/TestSWebHdfsFileContextMainOperations_RestartInjected");
    }
