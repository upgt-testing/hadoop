...
public class FSXAttrBaseTest {
    ...
    protected static MiniDockerDFSCluster dfsCluster;
    ...
    protected static void initCluster(boolean format) throws Exception {
        dfsCluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(1).format(format).build();
    ...
    protected static void restart(boolean checkpoint) throws Exception {
        NameNodeInterface nameNode = dfsCluster.getNameNode();
        if (checkpoint) {
