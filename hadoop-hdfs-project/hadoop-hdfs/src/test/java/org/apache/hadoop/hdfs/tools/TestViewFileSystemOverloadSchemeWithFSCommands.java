...
public class TestViewFileSystemOverloadSchemeWithFSCommands {
    ...
    @Test
    public void testDFWithViewFsOverloadScheme_withUpgrade20() throws Exception {
        final Path hdfsTargetPath = new Path(defaultFSURI + HDFS_USER_FOLDER);
        List<String> mounts = Lists.newArrayList();
        mounts.add(HDFS_USER_FOLDER);
        mounts.add(LOCAL_FOLDER);
    ...
    @Test
    public void testDFWithViewFsOverloadScheme_withUpgrade40() throws Exception {
        final Path hdfsTargetPath = new Path(defaultFSURI + HDFS_USER_FOLDER);
        List<String> mounts = Lists.newArrayList();
        mounts.add(HDFS_USER_FOLDER);
        mounts.add(LOCAL_FOLDER);
    ...
    @Test
    public void testDFWithViewFsOverloadScheme_withUpgrade60() throws Exception {
        final Path hdfsTargetPath = new Path(defaultFSURI + HDFS_USER_FOLDER);
        List<String> mounts = Lists.newArrayList();
        mounts.add(HDFS_USER_FOLDER);
        mounts.add(LOCAL_FOLDER);
