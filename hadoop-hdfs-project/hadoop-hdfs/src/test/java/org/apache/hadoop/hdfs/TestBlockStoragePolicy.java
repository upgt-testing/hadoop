...
public class TestBlockStoragePolicy {
    ...
    static final EnumSet<StorageType> all = EnumSet.of(StorageType.SSD, StorageType.DISK, StorageType.ARCHIVE);
    ...
    static void assertCreationFallback(BlockStoragePolicy policy, StorageType noneExpected, StorageType archiveExpected, StorageType diskExpected, StorageType ssdExpected, StorageType disk_archiveExpected) {
    ...
    static void assertReplicationFallback(BlockStoragePolicy policy, StorageType noneExpected, StorageType archiveExpected, StorageType diskExpected, StorageType ssdExpected) {
    ...
    @Test(timeout = 300000)
    public void testConfigKeyEnabled_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testConfigKeyEnabled_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testConfigKeyEnabled_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test(timeout = 300000, expected = IOException.class)
    public void testConfigKeyDisabled_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test(timeout = 300000, expected = IOException.class)
    public void testConfigKeyDisabled_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test(timeout = 300000, expected = IOException.class)
    public void testConfigKeyDisabled_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test
    public void testSetStoragePolicy_withUpgrade20() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicy_withUpgrade40() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicy_withUpgrade60() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicy_withUpgrade80() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testGetStoragePolicy_withUpgrade20() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testGetStoragePolicy_withUpgrade40() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testGetStoragePolicy_withUpgrade60() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testGetStoragePolicy_withUpgrade80() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicyWithSnapshot_withUpgrade20() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicyWithSnapshot_withUpgrade40() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicyWithSnapshot_withUpgrade60() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testSetStoragePolicyWithSnapshot_withUpgrade80() throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testGetFileStoragePolicyAfterRestartNN_withUpgrade20() throws Exception {
        //HDFS8219
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testGetFileStoragePolicyAfterRestartNN_withUpgrade40() throws Exception {
        //HDFS8219
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testGetFileStoragePolicyAfterRestartNN_withUpgrade60() throws Exception {
        //HDFS8219
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testGetFileStoragePolicyAfterRestartNN_withUpgrade80() throws Exception {
        //HDFS8219
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testGetAllStoragePoliciesFromFs_withUpgrade20() throws IOException {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
            cluster.waitActive();
            // Get policies via {@link FileSystem#getAllStoragePolicies}
    ...
    @Test
    public void testGetAllStoragePoliciesFromFs_withUpgrade40() throws IOException {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
            cluster.waitActive();
            // Get policies via {@link FileSystem#getAllStoragePolicies}
    ...
    @Test
    public void testGetAllStoragePoliciesFromFs_withUpgrade60() throws IOException {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
            cluster.waitActive();
            // Get policies via {@link FileSystem#getAllStoragePolicies}
    ...
    @Test
    public void testGetAllStoragePoliciesFromFs_withUpgrade80() throws IOException {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
            cluster.waitActive();
            // Get policies via {@link FileSystem#getAllStoragePolicies}
