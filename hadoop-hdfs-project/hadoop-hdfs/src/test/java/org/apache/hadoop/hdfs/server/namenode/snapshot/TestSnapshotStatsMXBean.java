...
public class TestSnapshotStatsMXBean {
    ...
    @Test
    public void testSnapshotStatsMXBeanInfo_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        String pathName = "/snapshot";
        Path path = new Path(pathName);
    ...
    @Test
    public void testSnapshotStatsMXBeanInfo_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        String pathName = "/snapshot";
        Path path = new Path(pathName);
    ...
    @Test
    public void testSnapshotStatsMXBeanInfo_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        String pathName = "/snapshot";
        Path path = new Path(pathName);
    ...
    @Test
    public void testSnapshotStatsMXBeanInfo_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        String pathName = "/snapshot";
        Path path = new Path(pathName);
