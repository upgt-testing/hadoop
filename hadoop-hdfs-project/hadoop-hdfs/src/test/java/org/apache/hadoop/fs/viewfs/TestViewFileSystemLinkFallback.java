...
public class TestViewFileSystemLinkFallback extends ViewFileSystemBaseTest {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(TestViewFileSystemLinkFallback.class);
    ...
    public static void clusterSetupAtBeginning() throws IOException, LoginException, URISyntaxException {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(CONF).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(NAME_SPACES_COUNT)).numDataNodes(DATA_NODES_COUNT).build();
    ...
    @Test
    public void testMkdirsShouldReturnFalseWhenFallbackFSNotAvailable_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(Constants.CONFIG_VIEWFS_MOUNT_LINKS_AS_SYMLINKS, false);
        ConfigUtil.addLink(conf, "/user1/test", new Path(targetTestRoot.toString()).toUri());
        Path fallbackTarget = new Path(targetTestRoot, "fallbackDir");
    ...
    @Test
    public void testMkdirsShouldReturnFalseWhenFallbackFSNotAvailable_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(Constants.CONFIG_VIEWFS_MOUNT_LINKS_AS_SYMLINKS, false);
        ConfigUtil.addLink(conf, "/user1/test", new Path(targetTestRoot.toString()).toUri());
        Path fallbackTarget = new Path(targetTestRoot, "fallbackDir");
    ...
    @Test
    public void testMkdirsShouldReturnFalseWhenFallbackFSNotAvailable_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(Constants.CONFIG_VIEWFS_MOUNT_LINKS_AS_SYMLINKS, false);
        ConfigUtil.addLink(conf, "/user1/test", new Path(targetTestRoot.toString()).toUri());
        Path fallbackTarget = new Path(targetTestRoot, "fallbackDir");
    ...
    @Test
    public void testMkdirsShouldReturnFalseWhenFallbackFSNotAvailable_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(Constants.CONFIG_VIEWFS_MOUNT_LINKS_AS_SYMLINKS, false);
        ConfigUtil.addLink(conf, "/user1/test", new Path(targetTestRoot.toString()).toUri());
        Path fallbackTarget = new Path(targetTestRoot, "fallbackDir");
