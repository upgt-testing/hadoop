...
public class TestPipelinesFailover_RestartInjected {
  ...
  private void doWriteOverFailoverTest(TestScenario scenario,
    ...
    try {
      ...
      RestartFramework.at("before_file_close")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  private void doTestWriteOverFailoverWithDnFail(TestScenario scenario)
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_dnfail")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file_creation_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_write_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_hflush_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_failover_dnfail")
          .on(cluster)
          .restart("namenode")
          .withIndex(nextActive)
          .withMode(RestartMode.GRACEFUL)
          .execute();
      ...
      RestartFramework.at("after_dn_stop_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_hflush_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_failback_dnfail")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_dn_stop_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_third_hflush_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("before_close_dnfail")
          .on(cluster)
          .restart("datanode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testLeaseRecoveryAfterFailover() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_lease")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file_creation_lease")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_write_lease")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_hflush_lease")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_failover_lease")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_lease_recovery")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_failback_lease")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFailoverRightBeforeCommitSynchronization() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_commit_sync")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file_creation_commit_sync")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_write_commit_sync")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_hflush_commit_sync")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_spy_setup_commit_sync")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_failover_commit_sync")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_lease_recovery_commit_sync")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testPipelineRecoveryStress() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_stress")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_fs_creation_stress")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_thread_setup_stress")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_threads_started_stress")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
