...
public class TestDebugAdmin {
    ...
    static private final String TEST_ROOT_DIR = new File(System.getProperty("test.build.data", "/tmp"), TestDebugAdmin.class.getSimpleName()).getAbsolutePath();
    ...
    @Test(timeout = 60000)
    public void testRecoverLease_withUpgrade20() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        assertEquals("ret: 1, You must supply a -path argument to recoverLease.", runCmd(new String[] { "recoverLease", "-retries", "1" }));
    ...
    @Test(timeout = 60000)
    public void testRecoverLease_withUpgrade40() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        assertEquals("ret: 1, You must supply a -path argument to recoverLease.", runCmd(new String[] { "recoverLease", "-retries", "1" }));
        DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testRecoverLease_withUpgrade60() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        assertEquals("ret: 1, You must supply a -path argument to recoverLease.", runCmd(new String[] { "recoverLease", "-retries", "1" }));
        DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testRecoverLease_withUpgrade80() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        assertEquals("ret: 1, You must supply a -path argument to recoverLease.", runCmd(new String[] { "recoverLease", "-retries", "1" }));
        DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testVerifyMetaCommand_withUpgrade20() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testVerifyMetaCommand_withUpgrade40() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testVerifyMetaCommand_withUpgrade60() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testVerifyMetaCommand_withUpgrade80() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testComputeMetaCommand_withUpgrade20() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testComputeMetaCommand_withUpgrade40() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testComputeMetaCommand_withUpgrade60() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testComputeMetaCommand_withUpgrade80() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
        DataNodeJVMInterface datanode = cluster.getDataNodes().get(0);
    ...
    @Test(timeout = 60000)
    public void testRecoverLeaseforFileNotFound_withUpgrade20() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 60000)
    public void testRecoverLeaseforFileNotFound_withUpgrade60() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        assertTrue(runCmd(new String[] { "recoverLease", "-path", "/foo", "-retries", "2" }).contains("Giving up on recoverLease for /foo after 1 try"));
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 60000)
    public void testVerifyECCommand_withUpgrade20() throws Exception {
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        cluster = DFSTestUtil.setupJVMCluster(conf, 6, 5, 0);
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testVerifyECCommand_withUpgrade40() throws Exception {
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        cluster = DFSTestUtil.setupJVMCluster(conf, 6, 5, 0);
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testVerifyECCommand_withUpgrade60() throws Exception {
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        cluster = DFSTestUtil.setupJVMCluster(conf, 6, 5, 0);
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testVerifyECCommand_withUpgrade80() throws Exception {
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        cluster = DFSTestUtil.setupJVMCluster(conf, 6, 5, 0);
        cluster.waitActive();
        DistributedFileSystem fs = cluster.getFileSystem();
