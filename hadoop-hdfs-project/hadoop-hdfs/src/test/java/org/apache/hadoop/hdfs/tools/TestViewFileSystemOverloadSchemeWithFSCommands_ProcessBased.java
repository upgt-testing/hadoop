...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestViewFileSystemOverloadSchemeWithFSCommands}.
 *
 ...
 * links.
 *
 * @see TestViewFileSystemOverloadSchemeWithFSCommands Original test using MiniDFSCluster
 */
@RunWith(Parameterized.class)
public class TestViewFileSystemOverloadSchemeWithFSCommands_ProcessBased extends ProcessBasedUpgradeTestBase {
  ...
  private static final String TEST_ROOT_DIR = PathUtils
      .getTestDirName(TestViewFileSystemOverloadSchemeWithFSCommands_ProcessBased.class);
