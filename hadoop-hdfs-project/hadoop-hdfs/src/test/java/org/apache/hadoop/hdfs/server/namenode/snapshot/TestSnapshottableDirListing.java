...
public class TestSnapshottableDirListing {
    ...
    @Test(timeout = 60000)
    public void testListSnapshottableDir_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // Initially there is no snapshottable directories in the system
        SnapshottableDirectoryStatus[] dirs = hdfs.getSnapshottableDirListing();
        assertNull(dirs);
    ...
    @Test(timeout = 60000)
    public void testListSnapshottableDir_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // Initially there is no snapshottable directories in the system
        SnapshottableDirectoryStatus[] dirs = hdfs.getSnapshottableDirListing();
        assertNull(dirs);
    ...
    @Test(timeout = 60000)
    public void testListSnapshottableDir_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // Initially there is no snapshottable directories in the system
        SnapshottableDirectoryStatus[] dirs = hdfs.getSnapshottableDirListing();
        assertNull(dirs);
    ...
    @Test(timeout = 60000)
    public void testListSnapshottableDir_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // Initially there is no snapshottable directories in the system
        SnapshottableDirectoryStatus[] dirs = hdfs.getSnapshottableDirListing();
        assertNull(dirs);
    ...
    @Test(timeout = 60000)
    public void testListWithDifferentUser_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // first make dir1 and dir2 snapshottable
        hdfs.allowSnapshot(dir1);
        hdfs.allowSnapshot(dir2);
    ...
    @Test(timeout = 60000)
    public void testListWithDifferentUser_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // first make dir1 and dir2 snapshottable
        hdfs.allowSnapshot(dir1);
        hdfs.allowSnapshot(dir2);
    ...
    @Test(timeout = 60000)
    public void testListWithDifferentUser_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // first make dir1 and dir2 snapshottable
        hdfs.allowSnapshot(dir1);
        hdfs.allowSnapshot(dir2);
    ...
    @Test(timeout = 60000)
    public void testListWithDifferentUser_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        // first make dir1 and dir2 snapshottable
        hdfs.allowSnapshot(dir1);
        hdfs.allowSnapshot(dir2);
