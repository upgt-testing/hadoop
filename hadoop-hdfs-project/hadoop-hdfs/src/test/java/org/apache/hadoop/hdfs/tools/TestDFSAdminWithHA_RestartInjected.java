...
//
  ...
  public void testRestoreFailedStorage() throws Exception {
    ...
    assertOutputMatches(message + newLine + message + newLine);
    RestartFramework.at("after_restore_failed_storage")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetBalancerBandwidth() throws Exception {
    ...
    RestartFramework.at("after_set_balancer_bandwidth")
        .on(cluster.getDfsCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshServiceAcl() throws Exception {
    ...
    assertOutputMatches(message + newLine + message + newLine);
    RestartFramework.at("after_refresh_service_acl")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshUserToGroupsMappings() throws Exception {
    ...
    assertOutputMatches(message + newLine + message + newLine);
    RestartFramework.at("after_refresh_user_to_groups_mappings")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshSuperUserGroupsConfiguration() throws Exception {
    ...
    assertOutputMatches(message + newLine + message + newLine);
    RestartFramework.at("after_refresh_super_user_groups_configuration")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshCallQueue() throws Exception {
    ...
    assertOutputMatches(message + newLine + message + newLine);
    RestartFramework.at("after_refresh_call_queue")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFinalizeUpgrade() throws Exception {
    ...
    assertOutputMatches(message + newLine + message + newLine);
    RestartFramework.at("after_finalize_upgrade")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testUpgradeCommand() throws Exception {
    ...
    RestartFramework.at("after_upgrade_query_before_upgrade")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_nn1_upgrade_start")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_standby_bootstrap")
        .on(cluster.getDfsCluster())
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
