 ...
 */
public class TestRollingFileSystemSinkWithHdfs_RestartInjected
  ...
  public void testWrite() throws Exception {
    ...
    RestartFramework.at("after_metrics_init")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_write_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppend() throws Exception {
    ...
    RestartFramework.at("after_append_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSilentAppend() throws Exception {
    ...
    RestartFramework.at("after_silent_append_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNoAppend() throws Exception {
    ...
    RestartFramework.at("after_no_append_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSilentOverwrite() throws Exception {
    ...
    RestartFramework.at("after_silent_overwrite_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFlushThread() throws Exception {
    ...
    RestartFramework.at("after_flush_metrics_init")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_first_publish")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    // regardless.
    ms.publishMetricsNow();
    RestartFramework.at("after_second_publish")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
