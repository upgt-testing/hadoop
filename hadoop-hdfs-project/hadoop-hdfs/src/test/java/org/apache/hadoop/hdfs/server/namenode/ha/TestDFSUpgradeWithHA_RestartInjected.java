...
public class TestDFSUpgradeWithHA_RestartInjected {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(TestDFSUpgradeWithHA_RestartInjected.class);
  ...
  public void testCannotFinalizeIfNoActive() throws IOException,
    ...
    try {
      ...
      RestartFramework.at("after_mkdir_foo1")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_upgrade_restart_finalize")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_bootstrap_standby")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_foo4")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNfsUpgrade() throws IOException, URISyntaxException {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_nfs")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_nfs_upgrade")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_upgrade_restart_nfs")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_bootstrap_nfs")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testUpgradeWithJournalNodes() throws IOException,
    ...
    try {
      ...
      RestartFramework.at("after_qjm_cluster_setup")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_qjm")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_upgrade_restart_qjm")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFinalizeWithJournalNodes() throws IOException,
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_finalize")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFinalizeFromSecondNameNodeWithJournalNodes()
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_second_nn")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testStartingWithUpgradeInProgressSucceeds() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_upgrade_progress")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollbackWithNfs() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_rollback_nfs")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollbackWithJournalNodes() throws IOException,
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_rollback_jn")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCannotUpgradeSecondNameNode() throws IOException,
    ...
    try {
      ...
      RestartFramework.at("after_cluster_setup_second_upgrade")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
