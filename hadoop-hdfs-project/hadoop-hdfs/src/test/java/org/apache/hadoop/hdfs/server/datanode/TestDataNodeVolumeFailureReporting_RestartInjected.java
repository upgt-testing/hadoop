...
public class TestDataNodeVolumeFailureReporting_RestartInjected {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(TestDataNodeVolumeFailureReporting_RestartInjected.class);
  {
    GenericTestUtils.setLogLevel(TestDataNodeVolumeFailureReporting_RestartInjected.LOG,
        Level.TRACE);
  }
  ...
  public void testSuccessiveVolumeFailures() throws Exception {
    ...
    RestartFramework.at("after_additional_datanodes_start")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_first_volume_failures")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_third_volume_failure")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_all_volumes_fail")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_final_file_creation")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVolFailureStatsPreservedOnNNRestart() throws Exception {
    ...
    RestartFramework.at("after_volume_failures")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_nn_restart")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataNodeReconfigureWithVolumeFailures() throws Exception {
    ...
    RestartFramework.at("after_volume_restore")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAutoFormatEmptyDirectory() throws Exception {
    ...
    RestartFramework.at("after_version_deletion")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testHotSwapOutFailedVolumeAndReporting()
    ...
    RestartFramework.at("after_initial_check")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_first_volume_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failed_reconfigure")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_hot_swap_out")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_volume_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
