 ...
 * by the Text command.
 */
public class TestHdfsTextCommand_RestartInjected_Randomized_123 {
    ...
    public void testDisplayForAvroFiles() throws Exception {
        ...
        RestartFramework.at("before_text_command_read").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_avro_file_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
