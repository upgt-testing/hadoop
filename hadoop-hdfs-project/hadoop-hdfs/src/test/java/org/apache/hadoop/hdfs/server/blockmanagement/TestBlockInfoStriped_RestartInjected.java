...
public class TestBlockInfoStriped_RestartInjected {
  ...
  public TestBlockInfoStriped_RestartInjected(ErasureCodingPolicy policy) {
    testECPolicy = policy;
  ...
  public void testGetBlockInfo() throws IllegalArgumentException, Exception {
    ...
    try (MiniDFSCluster cluster =
      ...
      RestartFramework.at("after_remove_storage")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
