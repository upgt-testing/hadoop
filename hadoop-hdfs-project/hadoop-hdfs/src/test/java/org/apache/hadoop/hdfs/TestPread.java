...
public class TestPread {
    ...
    private void datanodeRestartTest(MiniDFSClusterInJVM cluster, FileSystem fileSys, Path name) throws IOException {
    ...
    public void testHedgedReadLoopTooManyTimes() throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).format(true).build();
    ...
    public void testMaxOutHedgedReadPool() throws IOException, InterruptedException, ExecutionException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).format(true).build();
        DistributedFileSystem fileSys = cluster.getFileSystem();
        DFSClient dfsClient = fileSys.getClient();
    ...
    private void doPreadTestWithChangedLocations(int maxFailures) throws IOException, TimeoutException, InterruptedException {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
            ...
            Mockito.doAnswer(new Answer<LocatedBlocks>() {
                ...
                @Override
                public LocatedBlocks answer(InvocationOnMock invocation) throws Throwable {
            ...
            DatanodeInfoJVMInterface[] nodes = cluster.getNameNodeRpc().getDatanodeReport(DatanodeReportType.LIVE);
    ...
    @Test
    public void testHedgedReadLoopTooManyTimes_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test
    public void testHedgedReadLoopTooManyTimes_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test
    public void testHedgedReadLoopTooManyTimes_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test
    public void testHedgedReadLoopTooManyTimes_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test
    public void testMaxOutHedgedReadPool_withUpgrade20() throws IOException, InterruptedException, ExecutionException {
        isHedgedRead = true;
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int initialHedgedReadTimeoutMillis = 50000;
    ...
    @Test
    public void testMaxOutHedgedReadPool_withUpgrade40() throws IOException, InterruptedException, ExecutionException {
        isHedgedRead = true;
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int initialHedgedReadTimeoutMillis = 50000;
    ...
    @Test
    public void testMaxOutHedgedReadPool_withUpgrade60() throws IOException, InterruptedException, ExecutionException {
        isHedgedRead = true;
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int initialHedgedReadTimeoutMillis = 50000;
    ...
    @Test
    public void testMaxOutHedgedReadPool_withUpgrade80() throws IOException, InterruptedException, ExecutionException {
        isHedgedRead = true;
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int initialHedgedReadTimeoutMillis = 50000;
    ...
    @Test
    public void testTruncateWhileReading_withUpgrade20() throws Exception {
        Path path = new Path("/testfile");
        final int blockSize = 512;
        // prevent initial pre-fetch of multiple block locations
        Configuration conf = new Configuration();
    ...
    @Test
    public void testTruncateWhileReading_withUpgrade40() throws Exception {
        Path path = new Path("/testfile");
        final int blockSize = 512;
        // prevent initial pre-fetch of multiple block locations
        Configuration conf = new Configuration();
    ...
    @Test
    public void testTruncateWhileReading_withUpgrade60() throws Exception {
        Path path = new Path("/testfile");
        final int blockSize = 512;
        // prevent initial pre-fetch of multiple block locations
        Configuration conf = new Configuration();
    ...
    @Test
    public void testTruncateWhileReading_withUpgrade80() throws Exception {
        Path path = new Path("/testfile");
        final int blockSize = 512;
        // prevent initial pre-fetch of multiple block locations
        Configuration conf = new Configuration();
    ...
    @Test(timeout = 30000)
    public void testHedgedReadFromAllDNFailed_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test(timeout = 30000)
    public void testHedgedReadFromAllDNFailed_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test(timeout = 30000)
    public void testHedgedReadFromAllDNFailed_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
    ...
    @Test(timeout = 30000)
    public void testHedgedReadFromAllDNFailed_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        int numHedgedReadPoolThreads = 5;
        final int hedgedReadTimeoutMillis = 50;
        conf.setInt(HdfsClientConfigKeys.HedgedRead.THREADPOOL_SIZE_KEY, numHedgedReadPoolThreads);
