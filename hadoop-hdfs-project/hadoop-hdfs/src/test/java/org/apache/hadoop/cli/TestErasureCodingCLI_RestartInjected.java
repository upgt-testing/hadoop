...
public class TestErasureCodingCLI_RestartInjected extends CLITestHelper {
  ...
  @Override
  public void testAll() {
    RestartFramework.at("before_ec_operations")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_ec_operations")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
