...
public class TestFSMainOperationsWebHdfs_RestartInjected_Randomized_123 extends FSMainOperationsBaseTest {
    ...
    public TestFSMainOperationsWebHdfs_RestartInjected_Randomized_123() {
    ...
    public void testConcat() throws Exception {
        ...
        RestartFramework.at("after_source_files_created").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
