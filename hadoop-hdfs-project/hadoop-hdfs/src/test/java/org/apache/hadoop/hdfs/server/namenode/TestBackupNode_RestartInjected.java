...
public class TestBackupNode_RestartInjected {
  public static final Logger LOG =
      LoggerFactory.getLogger(TestBackupNode_RestartInjected.class);
  ...
  public void testBackupNodeTailsEdits() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_backup_start")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_sync")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_sync")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      // BN checkpoint
      backup.doCheckpoint();
      RestartFramework.at("after_bn_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_third_sync")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      backup.stop();
      backup = null;
      RestartFramework.at("after_bn_stop")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_bn_down")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      backup = startBackupNode(conf, StartupOption.BACKUP, 1);
      RestartFramework.at("after_backup_restart")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      backup.stop(false);
      RestartFramework.at("after_bn_unclean_stop")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_bn_down_2")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  void testCheckpoint(StartupOption op) throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_mkdir_file1")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_file1_delete")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_file2")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdirs_loop")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      backup.doCheckpoint();
      waitCheckpointDone(cluster, txid);
      RestartFramework.at("after_fourth_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      DFSTestUtil.createFile(fileSys, file3, fileSize, fileSize, blockSize,
          replication, seed);
      RestartFramework.at("after_file3_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCanReadData() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_datanode_start")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
