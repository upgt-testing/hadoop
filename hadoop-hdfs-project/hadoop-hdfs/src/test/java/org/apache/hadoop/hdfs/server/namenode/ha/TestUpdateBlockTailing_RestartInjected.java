...
public class TestUpdateBlockTailing_RestartInjected {
  ...
  public void testStandbyAddBlockIBRRace() throws Exception {
    ...
    RestartFramework.at("after_initial_genstamp_check")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_editlog_tail")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_ibr_processing")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_update_block_tail")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStandbyAppendBlock() throws Exception {
    ...
    RestartFramework.at("after_editlog_tail_file_creation")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_append_operation")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_editlog_tail_append")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStandbyAppendNewBlock() throws Exception {
    ...
    RestartFramework.at("after_append_new_block")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_editlog_tail_append_new_block")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStandbyTruncateBlock() throws Exception {
    ...
    RestartFramework.at("after_truncate_operation")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_editlog_tail_truncate")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
