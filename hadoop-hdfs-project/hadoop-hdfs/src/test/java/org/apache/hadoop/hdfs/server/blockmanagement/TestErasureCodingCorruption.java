...
public class TestErasureCodingCorruption {
    ...
    @Test
    public void testCorruptionDuringFailover_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // case.
        conf.setBoolean(DFS_NAMENODE_CORRUPT_BLOCK_DELETE_IMMEDIATELY_ENABLED, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(8).build()) {
    ...
    @Test
    public void testCorruptionDuringFailover_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // case.
        conf.setBoolean(DFS_NAMENODE_CORRUPT_BLOCK_DELETE_IMMEDIATELY_ENABLED, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(8).build()) {
    ...
    @Test
    public void testCorruptionDuringFailover_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // case.
        conf.setBoolean(DFS_NAMENODE_CORRUPT_BLOCK_DELETE_IMMEDIATELY_ENABLED, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(8).build()) {
    ...
    @Test
    public void testCorruptionDuringFailover_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // case.
        conf.setBoolean(DFS_NAMENODE_CORRUPT_BLOCK_DELETE_IMMEDIATELY_ENABLED, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(8).build()) {
