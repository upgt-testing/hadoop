...
public class TestReadStripedFileWithDecoding {
    ...
    public void testInvalidateBlock() throws IOException, InterruptedException {
        ...
        try {
            ...
            DatanodeDescriptorJVMInterface dnd = NameNodeAdapter.getDatanode(fsn, dn.getDatanodeId());
            /*
    ...
    public void testMoreThanOneCorruptedBlock() throws IOException {
        ...
        for (int count = 2; count < NUM_PARITY_UNITS; ++count) {
            ReadStripedFileWithDecodingHelper.corruptBlocks(cluster, dfs, file, count, 0, false);
            StripedFileTestUtil.verifyStatefulRead(dfs, file, length, bytes, buffer);
        }
    }
    ...
    public void testReadWithCorruptedDataBlockAndParityBlock() throws IOException {
        ...
        for (int i = 0; i < recoverBlkNum; i++) {
            delBlocks[i] = StripedBlockUtil.constructInternalBlock(lastBlock.getBlock(), CELL_SIZE, NUM_DATA_UNITS, delBlkIndices[i]);
    ...
    @Test
    public void testReportBadBlock_withUpgrade20() throws IOException {
        // create file
        final Path file = new Path("/corrupted");
        // length of "corruption"
        final int length = 10;
    ...
    @Test
    public void testReportBadBlock_withUpgrade40() throws IOException {
        // create file
        final Path file = new Path("/corrupted");
        // length of "corruption"
        final int length = 10;
    ...
    @Test
    public void testReportBadBlock_withUpgrade60() throws IOException {
        // create file
        final Path file = new Path("/corrupted");
        // length of "corruption"
        final int length = 10;
    ...
    @Test
    public void testReportBadBlock_withUpgrade80() throws IOException {
        // create file
        final Path file = new Path("/corrupted");
        // length of "corruption"
        final int length = 10;
    ...
    @Test
    public void testInvalidateBlock_withUpgrade20() throws IOException, InterruptedException {
        final Path file = new Path("/invalidate");
        final int length = 10;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testInvalidateBlock_withUpgrade40() throws IOException, InterruptedException {
        final Path file = new Path("/invalidate");
        final int length = 10;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testInvalidateBlock_withUpgrade60() throws IOException, InterruptedException {
        final Path file = new Path("/invalidate");
        final int length = 10;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testInvalidateBlock_withUpgrade80() throws IOException, InterruptedException {
        final Path file = new Path("/invalidate");
        final int length = 10;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testMoreThanOneCorruptedBlock_withUpgrade20() throws IOException {
        final Path file = new Path("/corrupted");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testMoreThanOneCorruptedBlock_withUpgrade40() throws IOException {
        final Path file = new Path("/corrupted");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testMoreThanOneCorruptedBlock_withUpgrade60() throws IOException {
        final Path file = new Path("/corrupted");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testReadWithCorruptedDataBlockAndParityBlock_withUpgrade20() throws IOException {
        final Path file = new Path("/corruptedDataBlockAndParityBlock");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testReadWithCorruptedDataBlockAndParityBlock_withUpgrade40() throws IOException {
        final Path file = new Path("/corruptedDataBlockAndParityBlock");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testReadWithCorruptedDataBlockAndParityBlock_withUpgrade60() throws IOException {
        final Path file = new Path("/corruptedDataBlockAndParityBlock");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
    ...
    @Test
    public void testReadWithCorruptedDataBlockAndParityBlock_withUpgrade80() throws IOException {
        final Path file = new Path("/corruptedDataBlockAndParityBlock");
        final int length = BLOCK_SIZE * NUM_DATA_UNITS;
        final byte[] bytes = StripedFileTestUtil.generateBytes(length);
        DFSTestUtil.writeFile(dfs, file, bytes);
