...
public class TestModTime {
    ...
    @Test
    public void testModTime_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        InetSocketAddress addr = new InetSocketAddress("localhost", cluster.getNameNodePort());
    ...
    @Test
    public void testModTime_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        InetSocketAddress addr = new InetSocketAddress("localhost", cluster.getNameNodePort());
    ...
    @Test
    public void testModTime_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        InetSocketAddress addr = new InetSocketAddress("localhost", cluster.getNameNodePort());
    ...
    @Test
    public void testModTime_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).build();
        cluster.waitActive();
        InetSocketAddress addr = new InetSocketAddress("localhost", cluster.getNameNodePort());
    ...
    @Test
    public void testModTimePersistsAfterRestart_withUpgrade20() throws IOException {
        // 10 milliseconds
        final long sleepTime = 10;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testModTimePersistsAfterRestart_withUpgrade40() throws IOException {
        // 10 milliseconds
        final long sleepTime = 10;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testModTimePersistsAfterRestart_withUpgrade60() throws IOException {
        // 10 milliseconds
        final long sleepTime = 10;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testModTimePersistsAfterRestart_withUpgrade80() throws IOException {
        // 10 milliseconds
        final long sleepTime = 10;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
