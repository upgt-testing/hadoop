...
public class TestMultiObserverNode_RestartInjected {
  ...
  public void testObserverFailover() throws Exception {
    ...
    RestartFramework.at("after_first_getfilestatus")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_transition_standby_nn2")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(3)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_all_transitions")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiObserver() throws Exception {
    ...
    RestartFramework.at("after_first_roll_editlog")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_manual_shutdown_nn2")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(3)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_manual_restart_nn2")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_both_observers_restored")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverFallBehind() throws Exception {
    ...
    RestartFramework.at("after_state_id_set")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
