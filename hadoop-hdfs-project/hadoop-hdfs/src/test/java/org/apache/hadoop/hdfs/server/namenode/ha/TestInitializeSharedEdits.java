...
public class TestInitializeSharedEdits {
    ...
    @Test
    public void testInitializeSharedEdits_withUpgrade20() throws Exception {
        assertCannotStartNameNodes();
        // Initialize the shared edits dir.
        assertFalse(NameNode.initializeSharedEdits(cluster.getConfiguration(0)));
        assertCanStartHaNameNodes("1");
    ...
    @Test
    public void testInitializeSharedEdits_withUpgrade40() throws Exception {
        assertCannotStartNameNodes();
        // Initialize the shared edits dir.
        assertFalse(NameNode.initializeSharedEdits(cluster.getConfiguration(0)));
        assertCanStartHaNameNodes("1");
    ...
    @Test
    public void testInitializeSharedEdits_withUpgrade60() throws Exception {
        assertCannotStartNameNodes();
        // Initialize the shared edits dir.
        assertFalse(NameNode.initializeSharedEdits(cluster.getConfiguration(0)));
        assertCanStartHaNameNodes("1");
    ...
    @Test
    public void testInitializeSharedEdits_withUpgrade80() throws Exception {
        assertCannotStartNameNodes();
        // Initialize the shared edits dir.
        assertFalse(NameNode.initializeSharedEdits(cluster.getConfiguration(0)));
        assertCanStartHaNameNodes("1");
