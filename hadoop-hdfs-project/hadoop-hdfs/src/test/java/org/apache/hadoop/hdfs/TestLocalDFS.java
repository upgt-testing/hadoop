...
public class TestLocalDFS {
    ...
    public void testWorkingDirectory() throws IOException {
        ...
        try {
            ...
            // test home directory
            Path home = fileSys.makeQualified(new Path(HdfsClientConfigKeys.DFS_USER_HOME_DIR_PREFIX_DEFAULT + "/" + getUserName(fileSys)));
    ...
    @Test(timeout = 20000)
    public void testWorkingDirectory_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 20000)
    public void testWorkingDirectory_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 20000)
    public void testWorkingDirectory_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 20000)
    public void testWorkingDirectory_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fileSys = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testHomeDirectory_withUpgrade20() throws IOException {
        final String[] homeBases = new String[] { "/home", "/home/user" };
        Configuration conf = new HdfsConfiguration();
        for (final String homeBase : homeBases) {
            conf.set(HdfsClientConfigKeys.DFS_USER_HOME_DIR_PREFIX_KEY, homeBase);
    ...
    @Test(timeout = 30000)
    public void testHomeDirectory_withUpgrade40() throws IOException {
        final String[] homeBases = new String[] { "/home", "/home/user" };
        Configuration conf = new HdfsConfiguration();
        for (final String homeBase : homeBases) {
            conf.set(HdfsClientConfigKeys.DFS_USER_HOME_DIR_PREFIX_KEY, homeBase);
    ...
    @Test(timeout = 30000)
    public void testHomeDirectory_withUpgrade60() throws IOException {
        final String[] homeBases = new String[] { "/home", "/home/user" };
        Configuration conf = new HdfsConfiguration();
        for (final String homeBase : homeBases) {
            conf.set(HdfsClientConfigKeys.DFS_USER_HOME_DIR_PREFIX_KEY, homeBase);
    ...
    @Test(timeout = 30000)
    public void testHomeDirectory_withUpgrade80() throws IOException {
        final String[] homeBases = new String[] { "/home", "/home/user" };
        Configuration conf = new HdfsConfiguration();
        for (final String homeBase : homeBases) {
            conf.set(HdfsClientConfigKeys.DFS_USER_HOME_DIR_PREFIX_KEY, homeBase);
