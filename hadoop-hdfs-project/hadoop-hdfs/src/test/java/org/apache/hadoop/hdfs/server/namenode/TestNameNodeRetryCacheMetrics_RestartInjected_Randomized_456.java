 ...
 */
public class TestNameNodeRetryCacheMetrics_RestartInjected_Randomized_456 {
    ...
    public void setup() throws Exception {
        ...
        RestartFramework.at("after_cluster_setup").on(cluster).restart("namenode").withIndex(namenodeId).withMode(RestartMode.GRACEFUL).execute();
