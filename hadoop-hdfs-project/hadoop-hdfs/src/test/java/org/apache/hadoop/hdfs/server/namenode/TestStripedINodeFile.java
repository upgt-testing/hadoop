...
public class TestStripedINodeFile {
    ...
    public void testDeleteOp() throws Exception {
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(GROUP_SIZE).build();
            cluster.waitActive();
    ...
    @Test(timeout = 60000)
    public void testDeleteOp_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            final int len = 1024;
            final Path parentDir = new Path("/parentDir");
    ...
    @Test(timeout = 60000)
    public void testDeleteOp_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            final int len = 1024;
            final Path parentDir = new Path("/parentDir");
    ...
    @Test(timeout = 60000)
    public void testDeleteOp_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            final int len = 1024;
            final Path parentDir = new Path("/parentDir");
    ...
    @Test(timeout = 60000)
    public void testDeleteOp_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            final int len = 1024;
            final Path parentDir = new Path("/parentDir");
    ...
    @Test(timeout = 60000)
    public void testUnsuitableStoragePoliciesWithECStripedMode_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        int defaultStripedBlockSize = testECPolicy.getCellSize() * 4;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, defaultStripedBlockSize);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
    ...
    @Test(timeout = 60000)
    public void testUnsuitableStoragePoliciesWithECStripedMode_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        int defaultStripedBlockSize = testECPolicy.getCellSize() * 4;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, defaultStripedBlockSize);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
    ...
    @Test(timeout = 60000)
    public void testUnsuitableStoragePoliciesWithECStripedMode_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        int defaultStripedBlockSize = testECPolicy.getCellSize() * 4;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, defaultStripedBlockSize);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
