 ...
 */
public class TestSecurityTokenEditLog_RestartInjected_Randomized_123 {
    ...
    public void testEditLog() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_editlog_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            namesystem = cluster.getNamesystem();
            ...
            RestartFramework.at("after_threads_start").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            namesystem = cluster.getNamesystem();
            fsimage = cluster.getNameNode().getFSImage();
            editLog = cluster.getNamesystem().getEditLog();
            ...
            RestartFramework.at("after_transactions_complete").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            namesystem = cluster.getNamesystem();
            fsimage = cluster.getNameNode().getFSImage();
            editLog = cluster.getNamesystem().getEditLog();
            editLog.close();
            ...
            2;
            RestartFramework.at("before_editlog_verification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            namesystem = cluster.getNamesystem();
            fsimage = cluster.getNameNode().getFSImage();
            editLog = cluster.getNamesystem().getEditLog();
