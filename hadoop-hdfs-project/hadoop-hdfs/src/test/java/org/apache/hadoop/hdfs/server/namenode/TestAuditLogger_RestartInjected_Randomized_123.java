 ...
 */
public class TestAuditLogger_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestAuditLogger_RestartInjected.class);
    ...
    public void testAuditLogger() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("before_settimes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testWebHdfsAuditLogger() throws IOException, URISyntaxException {
        ...
        try {
            ...
            RestartFramework.at("after_nonproxy_request").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            DummyAuditLogger.resetLogCount();
            assertEquals("127.0.0.1", DummyAuditLogger.remoteAddr);
            RestartFramework.at("after_nontrusted_proxy_request").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAuditLoggerWithSetPermission() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_settimes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAuditLoggerWithCallContext() throws IOException {
        ...
        try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).build()) {
            ...
            fs.setTimes(p, time, time);
            RestartFramework.at("after_settimes_with_context").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_mkdirs_reuse_signature").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAuditLogWithAclFailure() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_acl_operations").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAuditLogForAcls() throws Exception {
        ...
        try {
            ...
            fs.setAcl(p, acls);
            RestartFramework.at("after_setacl").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAuditLogWithRemotePort() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_cluster1_start").on(cluster1).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            ...
            RestartFramework.at("after_cluster2_start").on(cluster2).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
