...
public class TestReconstructStripedBlocks_RestartInjected {
  ...
  private void doTestMissingStripedBlock(int numOfMissed, int numOfBusy)
    ...
    try {
      ...
      RestartFramework.at("after_nodes_busy")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_datanodes_removed")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_reconstruction_triggered")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void test2RecoveryTasksForSameBlockGroup() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_ec_file_write")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_datanode_stopped")
          .on(cluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_datanode_stopped")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCountLiveReplicas() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_ec_dir_and_file_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_reconstruction")
          .on(cluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_datanode_restarted")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_namenode_restart_and_block_reports")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReconstructionWork() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_ec_striped_file_creation")
          .on(dfsCluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_datanode_removed")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_reconstruction_work_triggered")
          .on(dfsCluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
