...
public class TestRollingUpgradeRollback {
    ...
    @Test
    public void testRollbackCommand_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
        final Path bar = new Path("/bar");
    ...
    @Test
    public void testRollbackCommand_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
        final Path bar = new Path("/bar");
    ...
    @Test
    public void testRollbackCommand_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
        final Path bar = new Path("/bar");
    ...
    @Test
    public void testRollbackCommand_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
        final Path bar = new Path("/bar");
    ...
    @Test
    public void testRollbackWithQJM_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniJournalCluster mjc = null;
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
    ...
    @Test
    public void testRollbackWithQJM_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniJournalCluster mjc = null;
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
    ...
    @Test
    public void testRollbackWithQJM_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniJournalCluster mjc = null;
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
    ...
    @Test
    public void testRollbackWithQJM_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniJournalCluster mjc = null;
        MiniDFSClusterInJVM cluster = null;
        final Path foo = new Path("/foo");
