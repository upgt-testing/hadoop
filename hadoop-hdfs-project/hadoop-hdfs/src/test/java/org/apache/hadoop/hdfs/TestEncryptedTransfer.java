...
public class TestEncryptedTransfer {
    ...
    private FileChecksum writeUnencryptedAndThenRestartEncryptedCluster() throws IOException {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).manageDataDfsDirs(false).manageNameDfsDirs(false).format(false).startupOption(StartupOption.REGULAR).build();
        fs = getFileSystem(conf);
        return checksum;
    }
    ...
    public void testLongLivedClient() throws IOException, InterruptedException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        BlockTokenSecretManagerJVMInterface btsm = cluster.getNamesystem().getBlockManager().getBlockTokenSecretManager();
    ...
    public void testEncryptedAppendRequiringBlockTransfer() throws IOException {
        ...
        DataNodeJVMInterface dn = cluster.getDataNode(locatedBlocks.get(0).getLocations()[0].getIpcPort());
        dn.shutdown();
    ...
    @Test
    public void testLongLivedReadClientAfterRestart_withUpgrade20() throws IOException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        assertEquals(PLAIN_TEXT, DFSTestUtil.readFile(fs, TEST_PATH));
        assertEquals(checksum, fs.getFileChecksum(TEST_PATH));
    ...
    @Test
    public void testLongLivedReadClientAfterRestart_withUpgrade40() throws IOException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        assertEquals(PLAIN_TEXT, DFSTestUtil.readFile(fs, TEST_PATH));
        assertEquals(checksum, fs.getFileChecksum(TEST_PATH));
        // longer be valid.
    ...
    @Test
    public void testLongLivedReadClientAfterRestart_withUpgrade60() throws IOException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        assertEquals(PLAIN_TEXT, DFSTestUtil.readFile(fs, TEST_PATH));
        assertEquals(checksum, fs.getFileChecksum(TEST_PATH));
        // longer be valid.
    ...
    @Test
    public void testLongLivedReadClientAfterRestart_withUpgrade80() throws IOException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        assertEquals(PLAIN_TEXT, DFSTestUtil.readFile(fs, TEST_PATH));
        assertEquals(checksum, fs.getFileChecksum(TEST_PATH));
        // longer be valid.
    ...
    @Test
    public void testLongLivedWriteClientAfterRestart_withUpgrade20() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testLongLivedWriteClientAfterRestart_withUpgrade40() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testLongLivedWriteClientAfterRestart_withUpgrade60() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testLongLivedWriteClientAfterRestart_withUpgrade80() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testLongLivedClient_withUpgrade20() throws IOException, InterruptedException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        BlockTokenSecretManagerJVMInterface btsm = cluster.getNamesystem().getBlockManager().getBlockTokenSecretManager();
        btsm.setKeyUpdateIntervalForTesting(2 * 1000);
        btsm.setTokenLifetime(2 * 1000);
    ...
    @Test
    public void testLongLivedClient_withUpgrade40() throws IOException, InterruptedException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        BlockTokenSecretManagerJVMInterface btsm = cluster.getNamesystem().getBlockManager().getBlockTokenSecretManager();
        btsm.setKeyUpdateIntervalForTesting(2 * 1000);
        btsm.setTokenLifetime(2 * 1000);
    ...
    @Test
    public void testLongLivedClient_withUpgrade60() throws IOException, InterruptedException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        BlockTokenSecretManagerJVMInterface btsm = cluster.getNamesystem().getBlockManager().getBlockTokenSecretManager();
        btsm.setKeyUpdateIntervalForTesting(2 * 1000);
        btsm.setTokenLifetime(2 * 1000);
    ...
    @Test
    public void testLongLivedClient_withUpgrade80() throws IOException, InterruptedException {
        FileChecksum checksum = writeUnencryptedAndThenRestartEncryptedCluster();
        BlockTokenSecretManagerJVMInterface btsm = cluster.getNamesystem().getBlockManager().getBlockTokenSecretManager();
        btsm.setKeyUpdateIntervalForTesting(2 * 1000);
        btsm.setTokenLifetime(2 * 1000);
    ...
    @Test
    public void testFileChecksumWithInvalidEncryptionKey_withUpgrade20() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testFileChecksumWithInvalidEncryptionKey_withUpgrade40() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testFileChecksumWithInvalidEncryptionKey_withUpgrade60() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testFileChecksumWithInvalidEncryptionKey_withUpgrade80() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testLongLivedClientPipelineRecovery_withUpgrade20() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testLongLivedClientPipelineRecovery_withUpgrade40() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testLongLivedClientPipelineRecovery_withUpgrade60() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testLongLivedClientPipelineRecovery_withUpgrade80() throws IOException, InterruptedException, TimeoutException {
        if (resolverClazz != null) {
            // TestTrustedChannelResolver does not use encryption keys.
            return;
        }
    ...
    @Test
    public void testEncryptedAppend_withUpgrade20() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testEncryptedAppend_withUpgrade40() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testEncryptedAppend_withUpgrade60() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testEncryptedAppend_withUpgrade80() throws IOException {
        setEncryptionConfigKeys();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        fs = getFileSystem(conf);
        writeTestDataToFile(fs);
    ...
    @Test
    public void testEncryptedAppendRequiringBlockTransfer_withUpgrade20() throws IOException {
        setEncryptionConfigKeys();
        // start up 4 DNs
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        fs = getFileSystem(conf);
    ...
    @Test
    public void testEncryptedAppendRequiringBlockTransfer_withUpgrade40() throws IOException {
        setEncryptionConfigKeys();
        // start up 4 DNs
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        fs = getFileSystem(conf);
    ...
    @Test
    public void testEncryptedAppendRequiringBlockTransfer_withUpgrade60() throws IOException {
        setEncryptionConfigKeys();
        // start up 4 DNs
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        fs = getFileSystem(conf);
    ...
    @Test
    public void testEncryptedAppendRequiringBlockTransfer_withUpgrade80() throws IOException {
        setEncryptionConfigKeys();
        // start up 4 DNs
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        fs = getFileSystem(conf);
