...
public class TestSlowDiskTracker {
    ...
    public void testDataNodeHeartbeatSlowDiskReport() throws Exception {
        ...
        try {
            ...
            SlowDiskTrackerJVMInterface slowDiskTracker = datanodeManager.getSlowDiskTracker();
            ...
            Map<String, DiskLatencyJVMInterface> slowDisksReport = getSlowDisksReportForTesting(slowDiskTracker);
    ...
    private ArrayList<DiskLatency> getAndDeserializeJson(final String json) throws IOException {
        return (new ObjectMapper()).readValue(json, new TypeReference<ArrayList<DiskLatency>>() {
        });
    }
    ...
    Map<String, DiskLatencyJVMInterface> getSlowDisksReportForTesting(SlowDiskTrackerJVMInterface slowDiskTracker) {
    ...
    @Test
    public void testDataNodeHeartbeatSlowDiskReport_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            DataNodeJVMInterface dn1 = cluster.getDataNodes().get(0);
            DataNodeJVMInterface dn2 = cluster.getDataNodes().get(1);
    ...
    @Test
    public void testDataNodeHeartbeatSlowDiskReport_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            DataNodeJVMInterface dn1 = cluster.getDataNodes().get(0);
            DataNodeJVMInterface dn2 = cluster.getDataNodes().get(1);
    ...
    @Test
    public void testDataNodeHeartbeatSlowDiskReport_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            DataNodeJVMInterface dn1 = cluster.getDataNodes().get(0);
            DataNodeJVMInterface dn2 = cluster.getDataNodes().get(1);
    ...
    @Test
    public void testDataNodeHeartbeatSlowDiskReport_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            DataNodeJVMInterface dn1 = cluster.getDataNodes().get(0);
            DataNodeJVMInterface dn2 = cluster.getDataNodes().get(1);
