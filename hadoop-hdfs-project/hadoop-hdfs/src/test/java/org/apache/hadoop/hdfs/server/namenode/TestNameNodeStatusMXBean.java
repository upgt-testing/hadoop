...
public class TestNameNodeStatusMXBean {
    ...
    public void testNameNodeMXBeanSlowDisksEnabled() throws Exception {
        ...
        try {
            ...
            NameNodeJVMInterface nn = cluster.getNameNode();
            final DatanodeManagerJVMInterface datanodeManager = nn.getNamesystem().getBlockManager().getDatanodeManager();
            MBeanServer mbs = ManagementFactory.getPlatformMBeanServer();
            ObjectName mxbeanName = new ObjectName("Hadoop:service=NameNode,name=NameNodeStatus");
            /*
    ...
    @Test(timeout = 120000L)
    public void testNameNodeStatusMXBean_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeStatusMXBean_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeStatusMXBean_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeStatusMXBean_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeMXBeanSlowDisksEnabled_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        conf.setTimeDuration(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, 1000, TimeUnit.MILLISECONDS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeMXBeanSlowDisksEnabled_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        conf.setTimeDuration(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, 1000, TimeUnit.MILLISECONDS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeMXBeanSlowDisksEnabled_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        conf.setTimeDuration(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, 1000, TimeUnit.MILLISECONDS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 120000L)
    public void testNameNodeMXBeanSlowDisksEnabled_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FILEIO_PROFILING_SAMPLING_PERCENTAGE_KEY, 100);
        conf.setTimeDuration(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, 1000, TimeUnit.MILLISECONDS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
