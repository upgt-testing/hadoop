...
public class TestNameNodeRespectsBindHostKeys {
    ...
    @Test(timeout = 300000)
    public void testRpcBindHostKey_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_RPC_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testRpcBindHostKey_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_RPC_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testRpcBindHostKey_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_RPC_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testRpcBindHostKey_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_RPC_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testServiceRpcBindHostKey_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_SERVICE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_SERVICE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testServiceRpcBindHostKey_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_SERVICE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_SERVICE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testServiceRpcBindHostKey_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_SERVICE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_SERVICE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testServiceRpcBindHostKey_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_SERVICE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_SERVICE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testLifelineRpcBindHostKey_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_LIFELINE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_LIFELINE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testLifelineRpcBindHostKey_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_LIFELINE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_LIFELINE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testLifelineRpcBindHostKey_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_LIFELINE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_LIFELINE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testLifelineRpcBindHostKey_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_LIFELINE_RPC_BIND_HOST_KEY);
        conf.set(DFS_NAMENODE_LIFELINE_RPC_ADDRESS_KEY, LOCALHOST_SERVER_ADDRESS);
    ...
    @Test(timeout = 300000)
    public void testHttpBindHostKey_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_HTTP_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testHttpBindHostKey_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_HTTP_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testHttpBindHostKey_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_HTTP_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testHttpBindHostKey_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing without " + DFS_NAMENODE_HTTP_BIND_HOST_KEY);
        // NN should not bind the wildcard address by default.
    ...
    @Test(timeout = 300000)
    public void testHttpsBindHostKey_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing behavior without " + DFS_NAMENODE_HTTPS_BIND_HOST_KEY);
        setupSsl();
    ...
    @Test(timeout = 300000)
    public void testHttpsBindHostKey_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing behavior without " + DFS_NAMENODE_HTTPS_BIND_HOST_KEY);
        setupSsl();
    ...
    @Test(timeout = 300000)
    public void testHttpsBindHostKey_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing behavior without " + DFS_NAMENODE_HTTPS_BIND_HOST_KEY);
        setupSsl();
    ...
    @Test(timeout = 300000)
    public void testHttpsBindHostKey_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        LOG.info("Testing behavior without " + DFS_NAMENODE_HTTPS_BIND_HOST_KEY);
        setupSsl();
