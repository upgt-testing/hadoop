 ...
 */
public class TestFsckWithMultipleNameNodes_RestartInjected_Randomized_123 {
    ...
    private void runTest(final int nNameNodes, final int nDataNodes, Configuration conf) throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_fsck_checks").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // Test viewfs
            //
            LOG.info("RUN_TEST 3");
