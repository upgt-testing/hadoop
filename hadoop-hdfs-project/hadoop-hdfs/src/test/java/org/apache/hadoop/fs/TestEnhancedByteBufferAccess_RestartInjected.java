 ...
 */
public class TestEnhancedByteBufferAccess_RestartInjected {
  ...
  public void testZeroCopyReads() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_replication")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      fsIn.close();
      fsIn = fs.open(TEST_PATH);
      RestartFramework.at("before_zero_copy_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testShortZeroCopyReads() throws Exception {
    ...
    try {
      ...
      HdfsDataInputStream dfsIn = (HdfsDataInputStream)fsIn;
      RestartFramework.at("before_first_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testZeroCopyReadsNoFallback() throws Exception {
    ...
    try {
      ...
      HdfsDataInputStream dfsIn = (HdfsDataInputStream)fsIn;
      ByteBuffer result;
      RestartFramework.at("before_unsupported_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("before_supported_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testZeroCopyMmapCache() throws Exception {
    ...
    RestartFramework.at("before_first_mmap_read")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    // Read more blocks.
    RestartFramework.at("before_additional_reads")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testHdfsFallbackReads() throws Exception {
    ...
    try {
      ...
      fsIn.close();
      fsIn = fs.open(TEST_PATH);
      RestartFramework.at("before_fallback_test")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFallbackRead() throws Exception {
    ...
    try {
      ...
      fsIn.close();
      fsIn = fs.open(TEST_PATH);
      RestartFramework.at("before_fallback_read_direct")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testZeroCopyReadOfCachedData() throws Exception {
    ...
    RestartFramework.at("before_uncached_read_attempt")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    // Cache the file
    RestartFramework.at("before_cache_operations")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_cache_directive")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    // Uncache the replica
    RestartFramework.at("before_uncache")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testClientMmapDisable() throws Exception {
    ...
    try {
      ...
      DFSTestUtil.createFile(fs, TEST_PATH,
          TEST_FILE_LENGTH, (short)1, RANDOM_SEED);
      RestartFramework.at("after_file_creation_mmap_disabled")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
          .execute();
      DFSTestUtil.waitReplication(fs, TEST_PATH, (short)1);
      RestartFramework.at("after_replication_mmap_disabled")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      DFSTestUtil.createFile(fs, TEST_PATH,
          TEST_FILE_LENGTH, (short)1, RANDOM_SEED);
      RestartFramework.at("after_file_creation_cache_zero")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
          .execute();
      DFSTestUtil.waitReplication(fs, TEST_PATH, (short)1);
      RestartFramework.at("after_replication_cache_zero")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void test2GBMmapLimit() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_large_file_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
          .execute();
      DFSTestUtil.waitReplication(fs, TEST_PATH, (short)1);
      RestartFramework.at("after_large_file_replication")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      buf1 = null;
      RestartFramework.at("before_2gb_boundary_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("before_second_large_file")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_large_file")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
