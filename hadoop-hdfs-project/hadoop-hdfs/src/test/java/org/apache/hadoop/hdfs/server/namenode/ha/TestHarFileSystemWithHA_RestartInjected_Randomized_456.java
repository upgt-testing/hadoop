...
public class TestHarFileSystemWithHA_RestartInjected_Randomized_456 {
    ...
    public void testHarUriWithHaUriWithNoPort() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_har_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
