...
public class TestBlockReplacement {
    ...
    private static final Logger LOG = LoggerFactory.getLogger("org.apache.hadoop.hdfs.TestBlockReplacement");
    ...
    public void testBlockReplacement() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(CONF).numDataNodes(REPLICATION_FACTOR).racks(INITIAL_RACKS).build();
        try {
            cluster.waitActive();
   ...
   */
    ...
    @Test
    public void testBlockReplacement_withUpgrade20() throws Exception {
        final Configuration CONF = new HdfsConfiguration();
        final String[] INITIAL_RACKS = { "/RACK0", "/RACK1", "/RACK2" };
        final String[] NEW_RACKS = { "/RACK2" };
        final short REPLICATION_FACTOR = (short) 3;
    ...
    @Test
    public void testBlockReplacement_withUpgrade40() throws Exception {
        final Configuration CONF = new HdfsConfiguration();
        final String[] INITIAL_RACKS = { "/RACK0", "/RACK1", "/RACK2" };
        final String[] NEW_RACKS = { "/RACK2" };
        final short REPLICATION_FACTOR = (short) 3;
    ...
    @Test
    public void testBlockReplacement_withUpgrade60() throws Exception {
        final Configuration CONF = new HdfsConfiguration();
        final String[] INITIAL_RACKS = { "/RACK0", "/RACK1", "/RACK2" };
        final String[] NEW_RACKS = { "/RACK2" };
        final short REPLICATION_FACTOR = (short) 3;
    ...
    @Test
    public void testBlockReplacement_withUpgrade80() throws Exception {
        final Configuration CONF = new HdfsConfiguration();
        final String[] INITIAL_RACKS = { "/RACK0", "/RACK1", "/RACK2" };
        final String[] NEW_RACKS = { "/RACK2" };
        final short REPLICATION_FACTOR = (short) 3;
    ...
    @Test(timeout = 90000)
    public void testBlockReplacementWithPinnedBlocks_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // types.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test(timeout = 90000)
    public void testBlockReplacementWithPinnedBlocks_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // types.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test(timeout = 90000)
    public void testBlockReplacementWithPinnedBlocks_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // types.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test(timeout = 90000)
    public void testBlockReplacementWithPinnedBlocks_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // types.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test
    public void testBlockMoveAcrossStorageInSameNode_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // datanode.
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test
    public void testBlockMoveAcrossStorageInSameNode_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // datanode.
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test
    public void testBlockMoveAcrossStorageInSameNode_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // datanode.
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
    ...
    @Test
    public void testBlockMoveAcrossStorageInSameNode_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // datanode.
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
