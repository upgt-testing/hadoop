...
public class TestBlockTokenWrappingQOP extends SaslDataTransferTestCase {
    ...
    public static Collection<Object[]> qopSettings() {
        ...
        return Arrays.asList(new Object[][] { { "privacy", "auth-conf" }, { "integrity", "auth-int" }, { "authentication", "auth" } });
    }
    ...
    public void setup() throws Exception {
        ...
        conf.set(CommonConfigurationKeys.HADOOP_SECURITY_SASL_PROPS_RESOLVER_CLASS, "org.apache.hadoop.security.IngressPortBasedResolver");
    ...
    public void testAddBlockWrappingQOP() throws Exception {
        ...
        LocatedBlock lb = client.namenode.addBlock(src, clientName, null, null, HdfsConstants.GRANDFATHER_INODE_ID, null, null);
    ...
    public void testAppendWrappingQOP() throws Exception {
        ...
        DFSClient client = dfs.getClient();
        String clientName = client.getClientName();
        LastBlockWithStatus lastBlock = client.namenode.append(src, clientName, new EnumSetWritable<>(EnumSet.of(CreateFlag.APPEND)));
        byte[] secret = lastBlock.getLastBlock().getBlockToken().decodeIdentifier().getHandshakeMsg();
        assertEquals(this.qopValue, new String(secret));
    }
    ...
    @Test
    public void testAddBlockWrappingQOP_withUpgrade20() throws Exception {
        final String src = "/testAddBlockWrappingQOP";
        final Path path = new Path(src);
        dfs.create(path);
    ...
    @Test
    public void testAddBlockWrappingQOP_withUpgrade40() throws Exception {
        final String src = "/testAddBlockWrappingQOP";
        final Path path = new Path(src);
        dfs.create(path);
        DFSClient client = dfs.getClient();
    ...
    @Test
    public void testAddBlockWrappingQOP_withUpgrade60() throws Exception {
        final String src = "/testAddBlockWrappingQOP";
        final Path path = new Path(src);
        dfs.create(path);
        DFSClient client = dfs.getClient();
    ...
    @Test
    public void testAddBlockWrappingQOP_withUpgrade80() throws Exception {
        final String src = "/testAddBlockWrappingQOP";
        final Path path = new Path(src);
        dfs.create(path);
        DFSClient client = dfs.getClient();
    ...
    @Test
    public void testAppendWrappingQOP_withUpgrade20() throws Exception {
        final String src = "/testAppendWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testAppendWrappingQOP_withUpgrade40() throws Exception {
        final String src = "/testAppendWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // something
    ...
    @Test
    public void testAppendWrappingQOP_withUpgrade60() throws Exception {
        final String src = "/testAppendWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // something
    ...
    @Test
    public void testAppendWrappingQOP_withUpgrade80() throws Exception {
        final String src = "/testAppendWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // something
    ...
    @Test
    public void testGetBlockLocationWrappingQOP_withUpgrade20() throws Exception {
        final String src = "/testGetBlockLocationWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // so that getBlockLocations actually returns some block.
    ...
    @Test
    public void testGetBlockLocationWrappingQOP_withUpgrade40() throws Exception {
        final String src = "/testGetBlockLocationWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // so that getBlockLocations actually returns some block.
    ...
    @Test
    public void testGetBlockLocationWrappingQOP_withUpgrade60() throws Exception {
        final String src = "/testGetBlockLocationWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // so that getBlockLocations actually returns some block.
    ...
    @Test
    public void testGetBlockLocationWrappingQOP_withUpgrade80() throws Exception {
        final String src = "/testGetBlockLocationWrappingQOP";
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        // so that getBlockLocations actually returns some block.
