 ...
 */
public class TestStateTransitionFailure_RestartInjected_Randomized_123 {
    ...
    public void testFailureToTransitionCausesShutdown() throws IOException {
        ...
        try {
            ...
            try {
                RestartFramework.at("before_transition_attempt").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
