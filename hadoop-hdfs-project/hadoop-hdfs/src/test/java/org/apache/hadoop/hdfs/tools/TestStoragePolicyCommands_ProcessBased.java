...
public class TestStoragePolicyCommands_ProcessBased extends ProcessBasedUpgradeTestBase {
  ...
  private void setupCluster() throws IOException, URISyntaxException, TimeoutException {
    ...
    // Note: ProcessBasedMiniDFSCluster may not support fine-grained storage type
    // configuration per DataNode like MiniDFSCluster's storageTypes() method.
    // However, storage policy CLI commands operate on metadata and should work
    // regardless of actual storage types available.
