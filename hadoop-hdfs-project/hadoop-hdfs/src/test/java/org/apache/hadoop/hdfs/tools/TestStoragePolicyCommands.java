...
public class TestStoragePolicyCommands {
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade20() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade40() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade60() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade80() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
