...
public class TestRollingUpgrade_RestartInjected {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestRollingUpgrade_RestartInjected.class);
  ...
  public void testDFSAdminRollingUpgradeCommands() throws Exception {
    ...
    try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).numDataNodes(0).build()) {
      cluster.waitActive();
      RestartFramework.at("after_cluster_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
...

      {
        ...
        dfs.mkdirs(foo);
        RestartFramework.at("after_foo_creation")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_upgrade_prepare")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        dfs.mkdirs(bar);
        RestartFramework.at("after_bar_creation")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        checkMxBeanIsNull();
        RestartFramework.at("after_upgrade_finalize")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        dfs.mkdirs(baz);
        RestartFramework.at("after_baz_creation")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        dfs.saveNamespace();
        dfs.setSafeMode(SafeModeAction.SAFEMODE_LEAVE);
        RestartFramework.at("after_namespace_save")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_namenode_restart")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try (MiniJournalCluster mjc = new MiniJournalCluster.Builder(conf).build()) {
...

      {
        ...
        final MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
            ...
            .build();
        RestartFramework.at("after_first_cluster_creation")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
      ...
      try {
        ...
        final MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
            ...
            .checkExitOnShutdown(false)
            .build();
        RestartFramework.at("after_second_cluster_creation")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        cluster2 = new MiniDFSCluster.Builder(conf2)
            ...
            .manageNameDfsDirs(false)
            .build();
        RestartFramework.at("after_cluster2_creation")
            .on(cluster2)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_first_namenode_restart")
            .on(cluster2)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        cluster2.restartNameNode();
        RestartFramework.at("after_second_namenode_restart")
            .on(cluster2)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        cluster2.restartNameNode();
        RestartFramework.at("after_final_namenode_restart")
            .on(cluster2)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollback() throws Exception {
    ...
    try (MiniDFSCluster cluster  = new MiniDFSCluster.Builder(conf).numDataNodes(1).build()) {
      ...
      cluster.getFileSystem().rollEdits();
      RestartFramework.at("after_first_upgrade_rollback_cycle")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      cluster.getFileSystem().rollEdits();
      cluster.getFileSystem().rollEdits();
      RestartFramework.at("after_second_upgrade_rollback_cycle")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      startRollingUpgrade(foo, bar, file, data, cluster);
      cluster.restartNameNode();
      RestartFramework.at("after_third_upgrade_with_restart")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      startRollingUpgrade(foo, bar, file, data, cluster);
      cluster.restartNameNode();
      RestartFramework.at("after_fourth_upgrade_with_restart")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      startRollingUpgrade(foo, bar, file, data, cluster);
      RestartFramework.at("after_fifth_upgrade_rollback_cycle")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      startRollingUpgrade(foo, bar, file, data, cluster);
      RestartFramework.at("after_sixth_upgrade_rollback_cycle")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDFSAdminDatanodeUpgradeControlCommands() throws Exception {
    ...
    try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).numDataNodes(1).build()) {
      ...
      RestartFramework.at("after_datanode_info_check")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  private void testQuery(int nnCount) throws Exception{
    ...
    try (MiniQJMHACluster cluster = new MiniQJMHACluster.Builder(conf).setNumNameNodes(nnCount).build()) {
      ...
      RestartFramework.at("after_other_namenodes_shutdown")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_other_namenodes_restart")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollBackImage() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cluster_creation")
          ...
          .execute();
      dfsCluster.transitionToActive(0);
      RestartFramework.at("after_active_transition")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_edit_roll")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckpointWithSNN() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_snn_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_test_directory_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      snn.doCheckpoint();
      RestartFramework.at("after_first_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      snn.doCheckpoint();
      RestartFramework.at("after_second_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
