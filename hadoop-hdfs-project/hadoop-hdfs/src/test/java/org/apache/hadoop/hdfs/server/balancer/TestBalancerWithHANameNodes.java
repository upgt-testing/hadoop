...
public class TestBalancerWithHANameNodes {
   ...
   */
    ...
    @Test(timeout = 60000)
    public void testBalancerRequestSBNWithHA_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_HA_ALLOW_STALE_READ_KEY, true);
        conf.setLong(DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        //conf.setBoolean(DFS_HA_BALANCER_REQUEST_STANDBY_KEY, true);
    ...
    @Test(timeout = 60000)
    public void testBalancerRequestSBNWithHA_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_HA_ALLOW_STALE_READ_KEY, true);
        conf.setLong(DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        //conf.setBoolean(DFS_HA_BALANCER_REQUEST_STANDBY_KEY, true);
    ...
    @Test(timeout = 60000)
    public void testBalancerRequestSBNWithHA_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_HA_ALLOW_STALE_READ_KEY, true);
        conf.setLong(DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        //conf.setBoolean(DFS_HA_BALANCER_REQUEST_STANDBY_KEY, true);
    ...
    @Test(timeout = 60000)
    public void testBalancerRequestSBNWithHA_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_HA_ALLOW_STALE_READ_KEY, true);
        conf.setLong(DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        //conf.setBoolean(DFS_HA_BALANCER_REQUEST_STANDBY_KEY, true);
