 ...
 */
public class TestHASafeMode_RestartInjected_Randomized_456 {
    ...
    public void testClientRetrySafeMode() throws Exception {
        RestartFramework.at("after_leave_safemode").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    synchronized (TestHASafeMode_RestartInjected.this) {
                        results.put(test, mkdir);
                        TestHASafeMode_RestartInjected.this.notifyAll();
                    }
                } catch (Exception e) {
        ...
        RestartFramework.at("after_mkdir_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testEnterSafeModeInANNShouldNotThrowNPE() throws Exception {
        ...
        restartActive();
        RestartFramework.at("after_restart_active").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testBlocksAddedBeforeStandbyRestart() throws Exception {
        RestartFramework.at("after_restart_standby").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
