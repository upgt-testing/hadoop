...
public class TestHAAppend_RestartInjected {
  ...
  public void testMultipleAppendsDuringCatchupTailing() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_create_and_hflush")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_close_files")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_multiple_appends")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_fsck_check")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
