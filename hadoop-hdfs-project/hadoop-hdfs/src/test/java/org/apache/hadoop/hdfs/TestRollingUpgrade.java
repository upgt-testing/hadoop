...
public class TestRollingUpgrade {
    ...
    public void testRollingUpgradeWithQJM() throws Exception {
        ...
        try (MiniJournalCluster mjc = new MiniJournalCluster.Builder(conf).build()) {
            ...
            setConf(conf, nn1Dir, mjc);
            {
                ...
                final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).checkExitOnShutdown(false).build();
            ...
            try {
                ...
                final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(false).manageNameDfsDirs(false).checkExitOnShutdown(false).build();
                final Path foo = new Path("/foo");
                final Path bar = new Path("/bar");
                final Path baz = new Path("/baz");
                ...
                cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(0).format(false).manageNameDfsDirs(false).build();
    ...
    private static void startRollingUpgrade(Path foo, Path bar, Path file, byte[] data, MiniDFSClusterInJVM cluster) throws IOException {
        final DistributedFileSystem dfs = cluster.getFileSystem();
        //start rolling upgrade
        dfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
    ...
    private static void rollbackRollingUpgrade(Path foo, Path bar, Path file, byte[] data, MiniDFSClusterInJVM cluster) throws IOException {
    ...
    private void verifyNNCheckpoint(MiniDFSClusterInJVM dfsCluster, long txid, int nnIndex) throws InterruptedException {
        int retries = 0;
        while (++retries < 5) {
            NNStorageJVMInterface storage = dfsCluster.getNamesystem(nnIndex).getFSImage().getStorage();
    ...
    @Test
    public void testDFSAdminRollingUpgradeCommands_withUpgrade20() throws Exception {
        // start a cluster
        final Configuration conf = getHdfsConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            cluster.waitActive();
    ...
    @Test(timeout = 30000)
    public void testRollingUpgradeWithQJM_withUpgrade20() throws Exception {
        String nnDirPrefix = MiniDFSClusterInJVM.getBaseDirectory() + "/nn/";
        final File nn1Dir = new File(nnDirPrefix + "image1");
        final File nn2Dir = new File(nnDirPrefix + "image2");
        LOG.info("nn1Dir=" + nn1Dir);
    ...
    @Test(timeout = 30000)
    public void testRollingUpgradeWithQJM_withUpgrade40() throws Exception {
        String nnDirPrefix = MiniDFSClusterInJVM.getBaseDirectory() + "/nn/";
        final File nn1Dir = new File(nnDirPrefix + "image1");
        final File nn2Dir = new File(nnDirPrefix + "image2");
        LOG.info("nn1Dir=" + nn1Dir);
    ...
    @Test(timeout = 30000)
    public void testRollingUpgradeWithQJM_withUpgrade60() throws Exception {
        String nnDirPrefix = MiniDFSClusterInJVM.getBaseDirectory() + "/nn/";
        final File nn1Dir = new File(nnDirPrefix + "image1");
        final File nn2Dir = new File(nnDirPrefix + "image2");
        LOG.info("nn1Dir=" + nn1Dir);
    ...
    @Test(timeout = 30000)
    public void testRollingUpgradeWithQJM_withUpgrade80() throws Exception {
        String nnDirPrefix = MiniDFSClusterInJVM.getBaseDirectory() + "/nn/";
        final File nn1Dir = new File(nnDirPrefix + "image1");
        final File nn2Dir = new File(nnDirPrefix + "image2");
        LOG.info("nn1Dir=" + nn1Dir);
    ...
    @Test
    public void testRollback_withUpgrade20() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testRollback_withUpgrade40() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testRollback_withUpgrade60() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testRollback_withUpgrade80() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDFSAdminDatanodeUpgradeControlCommands_withUpgrade20() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDFSAdminDatanodeUpgradeControlCommands_withUpgrade40() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDFSAdminDatanodeUpgradeControlCommands_withUpgrade60() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDFSAdminDatanodeUpgradeControlCommands_withUpgrade80() throws Exception {
        // start a cluster
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 300000)
    public void testQueryAfterRestart_withUpgrade20() throws IOException, InterruptedException {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test(timeout = 300000)
    public void testQueryAfterRestart_withUpgrade40() throws IOException, InterruptedException {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test(timeout = 300000)
    public void testQueryAfterRestart_withUpgrade60() throws IOException, InterruptedException {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test(timeout = 300000)
    public void testQueryAfterRestart_withUpgrade80() throws IOException, InterruptedException {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test
    public void testCheckpointWithSNN_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem dfs = null;
        SecondaryNameNode snn = null;
        try {
    ...
    @Test
    public void testCheckpointWithSNN_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem dfs = null;
        SecondaryNameNode snn = null;
        try {
    ...
    @Test
    public void testCheckpointWithSNN_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem dfs = null;
        SecondaryNameNode snn = null;
        try {
    ...
    @Test
    public void testCheckpointWithSNN_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem dfs = null;
        SecondaryNameNode snn = null;
        try {
