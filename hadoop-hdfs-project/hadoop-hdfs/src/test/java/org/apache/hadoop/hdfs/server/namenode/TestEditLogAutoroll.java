...
public class TestEditLogAutoroll {
    ...
    @Test(timeout = 60000)
    public void testEditLogAutoroll_withUpgrade20() throws Exception {
        // Make some edits
        final long startTxId = editLog.getCurSegmentTxId();
        for (int i = 0; i < 11; i++) {
            fs.mkdirs(new Path("testEditLogAutoroll-" + i));
    ...
    @Test(timeout = 60000)
    public void testEditLogAutoroll_withUpgrade40() throws Exception {
        // Make some edits
        final long startTxId = editLog.getCurSegmentTxId();
        for (int i = 0; i < 11; i++) {
            fs.mkdirs(new Path("testEditLogAutoroll-" + i));
    ...
    @Test(timeout = 60000)
    public void testEditLogAutoroll_withUpgrade60() throws Exception {
        // Make some edits
        final long startTxId = editLog.getCurSegmentTxId();
        for (int i = 0; i < 11; i++) {
            fs.mkdirs(new Path("testEditLogAutoroll-" + i));
    ...
    @Test(timeout = 60000)
    public void testEditLogAutoroll_withUpgrade80() throws Exception {
        // Make some edits
        final long startTxId = editLog.getCurSegmentTxId();
        for (int i = 0; i < 11; i++) {
            fs.mkdirs(new Path("testEditLogAutoroll-" + i));
