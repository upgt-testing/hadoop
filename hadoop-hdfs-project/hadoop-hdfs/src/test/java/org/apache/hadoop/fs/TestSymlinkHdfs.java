...
abstract public class TestSymlinkHdfs extends SymlinkBaseTest {
     ...
     * Test create symlink to /
     */
    void testCreateLinkToSlash_withUpgrade20() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToSlash");
        Path fileViaLink = new Path(testBaseDir1() + "/linkToSlash" + testBaseDir1() + "/file");
     ...
     * Test create symlink to /
     */
    void testCreateLinkToSlash_withUpgrade40() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToSlash");
        Path fileViaLink = new Path(testBaseDir1() + "/linkToSlash" + testBaseDir1() + "/file");
     ...
     * Test create symlink to /
     */
    void testCreateLinkToSlash_withUpgrade60() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToSlash");
        Path fileViaLink = new Path(testBaseDir1() + "/linkToSlash" + testBaseDir1() + "/file");
     ...
     * Test create symlink to /
     */
    void testCreateLinkToSlash_withUpgrade80() throws IOException {
        Path dir = new Path(testBaseDir1());
        Path file = new Path(testBaseDir1(), "file");
        Path link = new Path(testBaseDir1(), "linkToSlash");
        Path fileViaLink = new Path(testBaseDir1() + "/linkToSlash" + testBaseDir1() + "/file");
