...
public class TestDataNodeUUID {
    ...
    public void testUUIDRegeneration() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).manageDataDfsDirs(false).build();
            cluster.waitActive();
    ...
    @Test(timeout = 10000)
    public void testUUIDRegeneration_withUpgrade20() throws Exception {
        File baseDir = GenericTestUtils.getTestDir();
        File disk1 = new File(baseDir, "disk1");
        File disk2 = new File(baseDir, "disk2");
        // Ensure the configured disks do not pre-exist
    ...
    @Test(timeout = 10000)
    public void testUUIDRegeneration_withUpgrade40() throws Exception {
        File baseDir = GenericTestUtils.getTestDir();
        File disk1 = new File(baseDir, "disk1");
        File disk2 = new File(baseDir, "disk2");
        // Ensure the configured disks do not pre-exist
    ...
    @Test(timeout = 10000)
    public void testUUIDRegeneration_withUpgrade60() throws Exception {
        File baseDir = GenericTestUtils.getTestDir();
        File disk1 = new File(baseDir, "disk1");
        File disk2 = new File(baseDir, "disk2");
        // Ensure the configured disks do not pre-exist
    ...
    @Test(timeout = 10000)
    public void testUUIDRegeneration_withUpgrade80() throws Exception {
        File baseDir = GenericTestUtils.getTestDir();
        File disk1 = new File(baseDir, "disk1");
        File disk2 = new File(baseDir, "disk2");
        // Ensure the configured disks do not pre-exist
