...
public class TestBlockTokenWrappingQOP_RestartInjected_Randomized_456 extends SaslDataTransferTestCase {
    ...
    public TestBlockTokenWrappingQOP_RestartInjected_Randomized_456(String configKey, String qopValue) {
    ...
    public void testAddBlockWrappingQOP() throws Exception {
        RestartFramework.at("before_add_block").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAppendWrappingQOP() throws Exception {
        ...
        out.close();
        RestartFramework.at("before_append").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        DFSClient client = dfs.getClient();
        String clientName = client.getClientName();
    ...
    public void testGetBlockLocationWrappingQOP() throws Exception {
        ...
        final Path path = new Path(src);
        FSDataOutputStream out = dfs.create(path);
        RestartFramework.at("before_get_block_locations").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
