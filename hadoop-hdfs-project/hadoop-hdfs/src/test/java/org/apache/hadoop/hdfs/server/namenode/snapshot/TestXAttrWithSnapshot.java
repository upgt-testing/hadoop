...
public class TestXAttrWithSnapshot {
    ...
    @Test
    public void testXattrWithSnapshotAndNNRestart_withUpgrade20() throws Exception {
        // Init
        FileSystem.mkdirs(hdfs, path, FsPermission.createImmutable((short) 0700));
        hdfs.setXAttr(path, name1, value1);
        hdfs.allowSnapshot(path);
    ...
    @Test
    public void testXattrWithSnapshotAndNNRestart_withUpgrade40() throws Exception {
        // Init
        FileSystem.mkdirs(hdfs, path, FsPermission.createImmutable((short) 0700));
        hdfs.setXAttr(path, name1, value1);
        hdfs.allowSnapshot(path);
    ...
    @Test
    public void testXattrWithSnapshotAndNNRestart_withUpgrade60() throws Exception {
        // Init
        FileSystem.mkdirs(hdfs, path, FsPermission.createImmutable((short) 0700));
        hdfs.setXAttr(path, name1, value1);
        hdfs.allowSnapshot(path);
    ...
    @Test
    public void testXattrWithSnapshotAndNNRestart_withUpgrade80() throws Exception {
        // Init
        FileSystem.mkdirs(hdfs, path, FsPermission.createImmutable((short) 0700));
        hdfs.setXAttr(path, name1, value1);
        hdfs.allowSnapshot(path);
