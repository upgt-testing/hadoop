...
public class TestSnapshotFileLength {
    ...
    @Test(timeout = 300000)
    public void testSnapshotfileLength_withUpgrade20() throws Exception {
        hdfs.mkdirs(sub);
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
        int origLen = BLOCKSIZE + 1;
    ...
    @Test(timeout = 300000)
    public void testSnapshotfileLength_withUpgrade40() throws Exception {
        hdfs.mkdirs(sub);
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
        int origLen = BLOCKSIZE + 1;
    ...
    @Test(timeout = 300000)
    public void testSnapshotfileLength_withUpgrade60() throws Exception {
        hdfs.mkdirs(sub);
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
        int origLen = BLOCKSIZE + 1;
    ...
    @Test(timeout = 300000)
    public void testSnapshotfileLength_withUpgrade80() throws Exception {
        hdfs.mkdirs(sub);
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
        int origLen = BLOCKSIZE + 1;
    ...
    @Test(timeout = 600000)
    public void testSnapshotFileLengthWithCatCommand_withUpgrade20() throws Exception {
        FSDataInputStream fis = null;
        FileStatus fileStatus = null;
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
    ...
    @Test(timeout = 600000)
    public void testSnapshotFileLengthWithCatCommand_withUpgrade40() throws Exception {
        FSDataInputStream fis = null;
        FileStatus fileStatus = null;
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
    ...
    @Test(timeout = 600000)
    public void testSnapshotFileLengthWithCatCommand_withUpgrade60() throws Exception {
        FSDataInputStream fis = null;
        FileStatus fileStatus = null;
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
    ...
    @Test(timeout = 600000)
    public void testSnapshotFileLengthWithCatCommand_withUpgrade80() throws Exception {
        FSDataInputStream fis = null;
        FileStatus fileStatus = null;
        int bytesRead;
        byte[] buffer = new byte[BLOCKSIZE * 8];
