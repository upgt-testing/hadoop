...
/**
 * Restart-injected version of TestCacheDirectivesWithViewDFS.
 *
 * Tests cache pool and cache directive operations with ViewDistributedFileSystem
 * survive component restarts. Based on TestCacheDirectivesWithViewDFS which
 * extends TestCacheDirectives and uses ViewDistributedFileSystem.
 *
 ...
 */
public class TestCacheDirectivesWithViewDFS_RestartInjected {
  static final Logger LOG = LoggerFactory.getLogger(
      TestCacheDirectivesWithViewDFS_RestartInjected.class);
  ...
  /**
   * Get ViewDistributedFileSystem (overriding parent's method).
   * Based on TestCacheDirectivesWithViewDFS#getDFS
   */
  private DistributedFileSystem getViewDFS() throws IOException {
  ...
  public void setup() throws Exception {
    ...
    cluster.waitActive();
    dfs = getViewDFS();  // Use ViewDistributedFileSystem
  ...
  // Using ViewDistributedFileSystem
  // AfterPoolAdd x 4 targets x 2 modes = 8 variants
  // ============================================================

  /**
   * Core test: Create cache pool with ViewDFS, inject restart, verify pool persisted.
   * Based on TestCacheDirectives#testBasicPoolOperations + ViewDFS
   */
  private void testPoolOperationsWithViewDFSRestart(RestartTarget target, RestartMode mode)
      throws Exception {
    ...
    LOG.info("=== INJECTING RESTART: target={}, mode={} (ViewDFS) ===", target, mode);
    ...
    assertTrue("Pool should persist after restart with ViewDFS", poolIter.hasNext());
  ...
  public void testPoolOperations_AfterPoolAdd_NN_Graceful() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.NAMENODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_NN_Crash() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.NAMENODE, RestartMode.CRASH);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_SingleDN_Graceful() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.SINGLE_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_SingleDN_Crash() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.SINGLE_DATANODE, RestartMode.CRASH);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_AllDN_Graceful() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.ALL_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_AllDN_Crash() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.ALL_DATANODES, RestartMode.CRASH);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_NNDN_Graceful() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.NAMENODE_AND_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testPoolOperations_AfterPoolAdd_NNDN_Crash() throws Exception {
    testPoolOperationsWithViewDFSRestart(RestartTarget.NAMENODE_AND_DATANODES, RestartMode.CRASH);
  }
  ...
  /**
   * Core test: Create pool and directives with ViewDFS, inject restart, verify persisted.
   * Based on TestCacheDirectives#testAddRemoveDirectives + ViewDFS
   */
  private void testDirectiveOperationsWithViewDFSRestart(RestartTarget target, RestartMode mode)
      throws Exception {
    ...
    assertTrue("Directives should persist after restart with ViewDFS", iter.hasNext());
  ...
  public void testDirectiveOperations_AfterDirectiveAdd_NN_Graceful() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.NAMENODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_NN_Crash() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.NAMENODE, RestartMode.CRASH);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_SingleDN_Graceful() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.SINGLE_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_SingleDN_Crash() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.SINGLE_DATANODE, RestartMode.CRASH);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_AllDN_Graceful() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.ALL_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_AllDN_Crash() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.ALL_DATANODES, RestartMode.CRASH);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_NNDN_Graceful() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.NAMENODE_AND_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 180000)
  public void testDirectiveOperations_AfterDirectiveAdd_NNDN_Crash() throws Exception {
    testDirectiveOperationsWithViewDFSRestart(RestartTarget.NAMENODE_AND_DATANODES, RestartMode.CRASH);
  }
}
