...
public class TestRandomOpsWithSnapshots_RestartInjected {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(TestRandomOpsWithSnapshots_RestartInjected.class);
  ...
  public void testRandomOperationsWithSnapshots()
    ...
    RestartFramework.at("after_snapshottable_dirs_setup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void randomOperationsWithSnapshots(int numberOfIterations,
    ...
    for (int i = 0; i < numberOfIterations; i++) {
      ...
      RestartFramework.at("after_filesystem_operations")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_health_check")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
