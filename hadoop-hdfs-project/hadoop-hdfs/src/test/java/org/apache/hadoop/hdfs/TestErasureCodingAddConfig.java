...
public class TestErasureCodingAddConfig {
    ...
    @Test
    public void testECAddPolicyConfigDisable_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testECAddPolicyConfigDisable_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testECAddPolicyConfigDisable_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testECAddPolicyConfigDisable_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, false);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testECAddPolicyConfigEnable_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testECAddPolicyConfigEnable_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testECAddPolicyConfigEnable_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testECAddPolicyConfigEnable_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_EC_POLICIES_USERPOLICIES_ALLOWED_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
