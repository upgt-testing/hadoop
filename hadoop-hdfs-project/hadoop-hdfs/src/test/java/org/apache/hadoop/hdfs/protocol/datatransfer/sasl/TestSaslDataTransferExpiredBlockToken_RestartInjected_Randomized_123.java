...
public class TestSaslDataTransferExpiredBlockToken_RestartInjected_Randomized_123 extends SaslDataTransferTestCase {
    ...
    public void testBlockSeekToWithExpiredToken() throws Exception {
        ...
        try (FileSystem fs = newFileSystem();
            ...
            RestartFramework.at("after_token_expiration").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
