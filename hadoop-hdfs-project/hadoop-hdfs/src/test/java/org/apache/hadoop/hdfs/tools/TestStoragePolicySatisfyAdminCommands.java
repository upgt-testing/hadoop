...
public class TestStoragePolicySatisfyAdminCommands {
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommand_withUpgrade20() throws Exception {
        final String file = "/testStoragePolicySatisfierCommand";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommand_withUpgrade40() throws Exception {
        final String file = "/testStoragePolicySatisfierCommand";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        DFSTestUtil.toolRun(admin, "-getStoragePolicy -path " + file, 0, "The storage policy of " + file + " is unspecified");
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommand_withUpgrade60() throws Exception {
        final String file = "/testStoragePolicySatisfierCommand";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        DFSTestUtil.toolRun(admin, "-getStoragePolicy -path " + file, 0, "The storage policy of " + file + " is unspecified");
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommand_withUpgrade80() throws Exception {
        final String file = "/testStoragePolicySatisfierCommand";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        DFSTestUtil.toolRun(admin, "-getStoragePolicy -path " + file, 0, "The storage policy of " + file + " is unspecified");
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommandWithURI_withUpgrade20() throws Exception {
        final String file = "/testStoragePolicySatisfierCommandURI";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommandWithURI_withUpgrade40() throws Exception {
        final String file = "/testStoragePolicySatisfierCommandURI";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        DFSTestUtil.toolRun(admin, "-getStoragePolicy -path " + file, 0, "The storage policy of " + file + " is unspecified");
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommandWithURI_withUpgrade60() throws Exception {
        final String file = "/testStoragePolicySatisfierCommandURI";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        DFSTestUtil.toolRun(admin, "-getStoragePolicy -path " + file, 0, "The storage policy of " + file + " is unspecified");
    ...
    @Test(timeout = 30000)
    public void testStoragePolicySatisfierCommandWithURI_withUpgrade80() throws Exception {
        final String file = "/testStoragePolicySatisfierCommandURI";
        DFSTestUtil.createFile(dfs, new Path(file), SIZE, REPL, 0);
        final StoragePolicyAdmin admin = new StoragePolicyAdmin(conf);
        DFSTestUtil.toolRun(admin, "-getStoragePolicy -path " + file, 0, "The storage policy of " + file + " is unspecified");
