 ...
 * Kerberos enabled.
 */
public class TestRollingFileSystemSinkWithSecureHdfs_RestartInjected_Randomized_123 extends RollingFileSystemSinkTestBase {
    ...
    public void testWithSecureHDFS() throws Exception {
        RestartFramework.at("after_secure_metrics_init").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_secure_write_test").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMissingPropertiesWithSecureHDFS() throws Exception {
        ...
        RestartFramework.at("after_missing_properties_init").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
