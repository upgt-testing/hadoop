...
public class TestFSEditLogLoader {
   ...
   */
     ...
     * @throws IOException
     */
    static private File prepareUnfinalizedTestEditLog(File testDir, int numTx, SortedMap<Long, Long> offsetToTxId) throws IOException {
    ...
    public void testAddNewStripedBlock() throws IOException {
        ...
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(9).build();
            cluster.waitActive();
    ...
    public void setLoadFSEditLogThrottling() throws Exception {
        ...
        assertTrue(capture.getOutput().contains("Start loading edits file " + FAKE_EDIT_STREAM_NAME));
    ...
    @Test
    public void testReplicationAdjusted_withUpgrade20() throws Exception {
        // start a cluster
        Configuration conf = getConf();
        // Replicate and heartbeat fast to shave a few seconds off test
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REDUNDANCY_INTERVAL_SECONDS_KEY, 1);
    ...
    @Test
    public void testReplicationAdjusted_withUpgrade40() throws Exception {
        // start a cluster
        Configuration conf = getConf();
        // Replicate and heartbeat fast to shave a few seconds off test
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REDUNDANCY_INTERVAL_SECONDS_KEY, 1);
    ...
    @Test
    public void testReplicationAdjusted_withUpgrade60() throws Exception {
        // start a cluster
        Configuration conf = getConf();
        // Replicate and heartbeat fast to shave a few seconds off test
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REDUNDANCY_INTERVAL_SECONDS_KEY, 1);
    ...
    @Test
    public void testReplicationAdjusted_withUpgrade80() throws Exception {
        // start a cluster
        Configuration conf = getConf();
        // Replicate and heartbeat fast to shave a few seconds off test
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REDUNDANCY_INTERVAL_SECONDS_KEY, 1);
    ...
    @Test
    public void testAddNewStripedBlock_withUpgrade20() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testAddNewStripedBlock_withUpgrade40() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testAddNewStripedBlock_withUpgrade60() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testAddNewStripedBlock_withUpgrade80() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testUpdateStripedBlocks_withUpgrade20() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testUpdateStripedBlocks_withUpgrade40() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testUpdateStripedBlocks_withUpgrade60() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testUpdateStripedBlocks_withUpgrade80() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForAddBlock_withUpgrade20() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForAddBlock_withUpgrade40() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForAddBlock_withUpgrade60() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForAddBlock_withUpgrade80() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForUpdateBlocks_withUpgrade20() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForUpdateBlocks_withUpgrade40() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForUpdateBlocks_withUpgrade60() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testHasNonEcBlockUsingStripedIDForUpdateBlocks_withUpgrade80() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testErasureCodingPolicyOperations_withUpgrade20() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        final int blockSize = 16 * 1024;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test
    public void testErasureCodingPolicyOperations_withUpgrade40() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        final int blockSize = 16 * 1024;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test
    public void testErasureCodingPolicyOperations_withUpgrade60() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        final int blockSize = 16 * 1024;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test
    public void testErasureCodingPolicyOperations_withUpgrade80() throws IOException {
        // start a cluster
        Configuration conf = new HdfsConfiguration();
        final int blockSize = 16 * 1024;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
