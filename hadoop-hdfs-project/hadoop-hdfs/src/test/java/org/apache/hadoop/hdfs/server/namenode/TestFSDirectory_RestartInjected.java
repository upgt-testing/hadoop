...
public class TestFSDirectory_RestartInjected {
  ...
  public void testDumpTree() throws Exception {
    ...
    RestartFramework.at("after_tree_dump")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
  ...
  public void testSkipQuotaCheck() throws Exception {
    try {
      ...
      RestartFramework.at("after_disable_quota")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_enable_quota")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testINodeXAttrsLimit() throws Exception {
    ...
    RestartFramework.at("after_xattr_initialization")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_system_raw_xattr_set")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testXAttrMultiSetRemove() throws Exception {
    ...
    RestartFramework.at("before_xattr_operations")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    while (numExpectedXAttrs < numGeneratedXAttrs) {
      ...
      if (numExpectedXAttrs == numGeneratedXAttrs / 2) {
        RestartFramework.at("during_xattr_addition")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_all_xattrs_added")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    while (numExpectedXAttrs > 0) {
      ...
      if (numExpectedXAttrs == numGeneratedXAttrs / 2) {
        RestartFramework.at("during_xattr_removal")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_all_xattrs_removed")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testXAttrMultiAddRemoveErrors() throws Exception {
    ...
    RestartFramework.at("after_error_tests")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_replace_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVerifyParentDir() throws Exception {
    ...
    RestartFramework.at("after_path_verification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
