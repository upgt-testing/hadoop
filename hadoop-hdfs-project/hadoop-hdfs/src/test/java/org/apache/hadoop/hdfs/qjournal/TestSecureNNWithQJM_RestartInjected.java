...
public class TestSecureNNWithQJM_RestartInjected {
  ...
  public static void init() throws Exception {
    baseDir =
        GenericTestUtils.getTestDir(TestSecureNNWithQJM_RestartInjected.class.getSimpleName());
    ...
    sslConfDir = KeyStoreTestUtil.getClasspathDir(
      TestSecureNNWithQJM_RestartInjected.class);
