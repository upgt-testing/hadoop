 ...
 */
public class TestDisallowModifyROSnapshot_RestartInjected_Randomized_123 {
    ...
    public static void setUp() throws Exception {
        ...
        cluster.waitActive();
        RestartFramework.at("after_creating_directories").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_creating_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fsn = cluster.getNamesystem();
