...
public class TestFailoverWithBlockTokensEnabled_RestartInjected {
  ...
  public void ensureSerialNumbersNeverOverlap() {
    ...
    RestartFramework.at("after_get_secret_managers")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
  ...
  public void ensureInvalidBlockTokensAreRejected() throws IOException,
    ...
    RestartFramework.at("after_write_file")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_setup_spy_client")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFailoverAfterRegistration() throws IOException,
    ...
    RestartFramework.at("after_write_using_both_namenodes")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void TestFailoverAfterAccessKeyUpdate() throws IOException,
    ...
    RestartFramework.at("after_lower_key_update_interval")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
