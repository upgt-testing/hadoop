...
public class TestOverReplicatedBlocks {
    ...
    public void testProcesOverReplicateBlock() throws Exception {
        ...
        try {
            ...
            File scanCursor = new File(new File(MiniDockerDFSCluster.getFinalizedDir(cluster.getInstanceStorageDir(0, 0), cluster.getNamesystem().getBlockPoolId()).getParent()).getParent(), "scanner.cursor");
            ...
            final DatanodeIDInterface corruptDataNode = InternalDataNodeTestUtils.getDNRegistrationForBP(cluster.getDataNodes().get(2), blockPoolId);
            final FSNamesystemInterface namesystem = cluster.getNamesystem();
            final BlockManagerInterface bm = namesystem.getBlockManager();
            final HeartbeatManagerInterface hm = bm.getDatanodeManager().getHeartbeatManager();
            try {
                ...
                synchronized (hm) {
                    ...
                    for (DatanodeDescriptorInterface datanode : hm.getDatanodes()) {
    ...
    public void testChooseReplicaToDelete() throws Exception {
        ...
        try {
            ...
            DataNodeInterface lastDN = cluster.getDataNodes().get(3);
            DatanodeRegistrationInterface dnReg = InternalDataNodeTestUtils.getDNRegistrationForBP(lastDN, namesystem.getBlockPoolId());
            ...
            DatanodeDescriptorInterface nodeInfo = null;
    ...
    public void testInvalidateOverReplicatedBlock() throws Exception {
        ...
        try {
            ...
            final BlockManagerInterface bm = namesystem.getBlockManager();
            FileSystem fs = cluster.getFileSystem();
            Path p = new Path(MiniDockerDFSCluster.getBaseDirectory(), "/foo1");
