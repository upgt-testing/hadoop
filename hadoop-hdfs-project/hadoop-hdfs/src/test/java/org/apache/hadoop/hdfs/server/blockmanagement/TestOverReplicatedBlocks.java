...
public class TestOverReplicatedBlocks {
    ...
    public void testProcesOverReplicateBlock() throws Exception {
        ...
        try {
            ...
            File scanCursor = new File(new File(MiniDFSClusterInJVM.getFinalizedDir(cluster.getInstanceStorageDir(0, 0), cluster.getNamesystem().getBlockPoolId()).getParent()).getParent(), "scanner.cursor");
            ...
            final DatanodeIDJVMInterface corruptDataNode = InternalDataNodeTestUtils.getDNRegistrationForBP(cluster.getDataNodes().get(2), blockPoolId);
    ...
    public void testChooseReplicaToDelete() throws Exception {
        ...
        try {
            ...
            DatanodeRegistrationJVMInterface dnReg = InternalDataNodeTestUtils.getDNRegistrationForBP(lastDN, namesystem.getBlockPoolId());
    ...
    @Test
    public void testProcesOverReplicateBlock_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, 100L);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
        conf.set(DFSConfigKeys.DFS_NAMENODE_RECONSTRUCTION_PENDING_TIMEOUT_SEC_KEY, Integer.toString(2));
    ...
    @Test
    public void testProcesOverReplicateBlock_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, 100L);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
        conf.set(DFSConfigKeys.DFS_NAMENODE_RECONSTRUCTION_PENDING_TIMEOUT_SEC_KEY, Integer.toString(2));
    ...
    @Test
    public void testProcesOverReplicateBlock_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, 100L);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
        conf.set(DFSConfigKeys.DFS_NAMENODE_RECONSTRUCTION_PENDING_TIMEOUT_SEC_KEY, Integer.toString(2));
    ...
    @Test
    public void testProcesOverReplicateBlock_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, 100L);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
        conf.set(DFSConfigKeys.DFS_NAMENODE_RECONSTRUCTION_PENDING_TIMEOUT_SEC_KEY, Integer.toString(2));
    ...
    @Test
    public void testChooseReplicaToDelete_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testChooseReplicaToDelete_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testChooseReplicaToDelete_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testChooseReplicaToDelete_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testInvalidateOverReplicatedBlock_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final FSNamesystemJVMInterface namesystem = cluster.getNamesystem();
    ...
    @Test
    public void testInvalidateOverReplicatedBlock_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final FSNamesystemJVMInterface namesystem = cluster.getNamesystem();
    ...
    @Test
    public void testInvalidateOverReplicatedBlock_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final FSNamesystemJVMInterface namesystem = cluster.getNamesystem();
    ...
    @Test
    public void testInvalidateOverReplicatedBlock_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final FSNamesystemJVMInterface namesystem = cluster.getNamesystem();
