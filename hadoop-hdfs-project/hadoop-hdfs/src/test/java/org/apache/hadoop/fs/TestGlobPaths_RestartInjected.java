...
public class TestGlobPaths_RestartInjected {
  ...
  public void testCRInPathGlob() throws IOException {
    RestartFramework.at("before_cr_in_path_glob")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
    ...
    assertEquals("Expected both normal and CR-carrying files in result: ",
        2, statuses.length);
    cleanupDFS();
    RestartFramework.at("after_cr_in_path_glob")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiGlob() throws IOException {
    RestartFramework.at("before_test_multi_glob")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    cleanupDFS();
    RestartFramework.at("after_test_multi_glob")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPathFilter() throws IOException {
    RestartFramework.at("before_test_path_filter")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_path_filter")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPathFilterWithFixedLastComponent() throws IOException {
    RestartFramework.at("before_test_path_filter_with_fixed_last_component")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_path_filter_with_fixed_last_component")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestLiteral() throws IOException {
    RestartFramework.at("before_p_test_literal")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_literal")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestEscape() throws IOException {
    RestartFramework.at("before_p_test_escape")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_escape")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestAny() throws IOException {
    RestartFramework.at("before_p_test_any")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_any")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestClosure1() throws IOException {
    RestartFramework.at("before_p_test_closure1")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_closure1")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestClosure2() throws IOException {
    RestartFramework.at("before_p_test_closure2")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_closure2")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestClosure3() throws IOException {
    RestartFramework.at("before_p_test_closure3")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_closure3")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestClosure4() throws IOException {
    RestartFramework.at("before_p_test_closure4")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_closure4")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestClosure5() throws IOException {
    RestartFramework.at("before_p_test_closure5")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_closure5")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestSet() throws IOException {
    RestartFramework.at("before_p_test_set")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_set")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestRange() throws IOException {
    RestartFramework.at("before_p_test_range")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_range")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestSetExcl() throws IOException {
    RestartFramework.at("before_p_test_set_excl")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_set_excl")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestCombination() throws IOException {
    RestartFramework.at("before_p_test_combination")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_combination")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestCurlyBracket() throws IOException {
    RestartFramework.at("before_p_test_curly_bracket")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      // test standalone }
    RestartFramework.at("after_p_test_curly_bracket")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void pTestJavaRegexSpecialChars() throws IOException {
    RestartFramework.at("before_p_test_java_regex_special_chars")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_p_test_java_regex_special_chars")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobWithSymlinksOnFS() throws Exception {
    RestartFramework.at("before_test_glob_with_symlinks_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_with_symlinks_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobWithSymlinksOnFC() throws Exception {
    RestartFramework.at("before_test_glob_with_symlinks_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_with_symlinks_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobWithSymlinksToSymlinksOnFS() throws Exception {
    RestartFramework.at("before_test_glob_with_symlinks_to_symlinks_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_with_symlinks_to_symlinks_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobWithSymlinksToSymlinksOnFC() throws Exception {
    RestartFramework.at("before_test_glob_with_symlinks_to_symlinks_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_with_symlinks_to_symlinks_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobSymlinksWithCustomPathFilterOnFS() throws Exception {
    RestartFramework.at("before_test_glob_symlinks_with_custom_path_filter_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_symlinks_with_custom_path_filter_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobSymlinksWithCustomPathFilterOnFC() throws Exception {
    RestartFramework.at("before_test_glob_symlinks_with_custom_path_filter_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_symlinks_with_custom_path_filter_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobFillsInSchemeOnFS() throws Exception {
    RestartFramework.at("before_test_glob_fills_in_scheme_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_fills_in_scheme_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobFillsInSchemeOnFC() throws Exception {
    RestartFramework.at("before_test_glob_fills_in_scheme_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_fills_in_scheme_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRelativePathOnFS() throws Exception {
    RestartFramework.at("before_test_relative_path_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_relative_path_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRelativePathOnFC() throws Exception {
    RestartFramework.at("before_test_relative_path_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_relative_path_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobAccessDeniedOnFS() throws Exception {
    RestartFramework.at("before_test_glob_access_denied_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_access_denied_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobAccessDeniedOnFC() throws Exception {
    RestartFramework.at("before_test_glob_access_denied_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_access_denied_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReservedHdfsPathsOnFS() throws Exception {
    RestartFramework.at("before_test_reserved_hdfs_paths_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_reserved_hdfs_paths_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReservedHdfsPathsOnFC() throws Exception {
    RestartFramework.at("before_test_reserved_hdfs_paths_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_reserved_hdfs_paths_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobRootOnFS() throws Exception {
    RestartFramework.at("before_test_glob_root_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_root_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGlobRootOnFC() throws Exception {
    RestartFramework.at("before_test_glob_root_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_glob_root_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNonTerminalGlobsOnFS() throws Exception {
    RestartFramework.at("before_test_non_terminal_globs_on_fs")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_non_terminal_globs_on_fs")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNonTerminalGlobsOnFC() throws Exception {
    RestartFramework.at("before_test_non_terminal_globs_on_fc")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_non_terminal_globs_on_fc")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testLocalFilesystem() throws Exception {
    RestartFramework.at("before_test_local_filesystem")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_local_filesystem")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
