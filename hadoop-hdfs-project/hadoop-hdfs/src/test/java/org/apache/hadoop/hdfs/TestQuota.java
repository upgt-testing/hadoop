...
public class TestQuota {
    ...
    public static void setUpClass() throws Exception {
        ...
        conf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, GenericTestUtils.getTestDir("my-test-quota").getAbsolutePath());
    ...
    static void runCommand(DFSAdmin admin, boolean expectError, String... args) throws Exception {
        runCommand(admin, args, expectError);
    }

    static void runCommand(DFSAdmin admin, String[] args, boolean expectEror) throws Exception {
    ...
    public void testRenameInodeWithStorageType() throws IOException {
        ...
        assertTrue("Without storage policy, typeConsumed should be 0.", dfs.getQuotaUsage(bs1).getTypeConsumed(StorageType.SSD) == 0);
        assertTrue("With storage policy, typeConsumed should not be 0.", dfs.getQuotaUsage(bs2).getTypeConsumed(StorageType.SSD) != 0);
        // wow3 without storage policy , rename will not change typeConsumed
        dfs.rename(wow3, bs1);
        assertTrue("Rename src without storagePolicy, dst typeConsumed should not be changed.", dfs.getQuotaUsage(bs2).getTypeConsumed(StorageType.SSD) == 0);
        ...
        assertTrue("Rename with storage policy, typeConsumed should not be 0.", dstTypeQuota != srcTypeQuota);
    }
    ...
    public void testMultipleFilesSmallerThanOneBlock() throws Exception {
        ...
        MiniDFSClusterInJVM dfsCluster = new MiniDFSClusterInJVM.Builder(dfsConf).numDataNodes(3).build();
    ...
    private void checkQuotaAndCount(DistributedFileSystem fs, Path path) throws IOException {
    ...
    @Test
    public void testQuotaCommands_withUpgrade20() throws Exception {
        DFSAdmin admin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(dir));
        final int fileLen = 1024;
    ...
    @Test
    public void testQuotaCommands_withUpgrade40() throws Exception {
        DFSAdmin admin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(dir));
        final int fileLen = 1024;
    ...
    @Test
    public void testQuotaCommands_withUpgrade60() throws Exception {
        DFSAdmin admin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(dir));
        final int fileLen = 1024;
    ...
    @Test
    public void testQuotaCommands_withUpgrade80() throws Exception {
        DFSAdmin admin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(dir));
        final int fileLen = 1024;
    ...
    @Test
    public void testMaxSpaceQuotas_withUpgrade20() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        final FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test
    public void testMaxSpaceQuotas_withUpgrade40() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        final FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test
    public void testMaxSpaceQuotas_withUpgrade60() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        final FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test
    public void testMaxSpaceQuotas_withUpgrade80() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        final FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test
    public void testMultipleFilesSmallerThanOneBlock_withUpgrade20() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        Configuration dfsConf = new HdfsConfiguration();
        final int BLOCK_SIZE = 6 * 1024;
    ...
    @Test
    public void testMultipleFilesSmallerThanOneBlock_withUpgrade40() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        Configuration dfsConf = new HdfsConfiguration();
        final int BLOCK_SIZE = 6 * 1024;
    ...
    @Test
    public void testMultipleFilesSmallerThanOneBlock_withUpgrade60() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        Configuration dfsConf = new HdfsConfiguration();
        final int BLOCK_SIZE = 6 * 1024;
    ...
    @Test
    public void testMultipleFilesSmallerThanOneBlock_withUpgrade80() throws Exception {
        final Path parent = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
        assertTrue(dfs.mkdirs(parent));
        Configuration dfsConf = new HdfsConfiguration();
        final int BLOCK_SIZE = 6 * 1024;
    ...
    @Test
    public void testSpaceQuotaExceptionOnClose_withUpgrade20() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnClose_withUpgrade40() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnClose_withUpgrade60() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnClose_withUpgrade80() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnFlush_withUpgrade20() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DFSClient.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
    ...
    @Test
    public void testSpaceQuotaExceptionOnFlush_withUpgrade40() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DFSClient.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
    ...
    @Test
    public void testSpaceQuotaExceptionOnFlush_withUpgrade60() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DFSClient.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
    ...
    @Test
    public void testSpaceQuotaExceptionOnFlush_withUpgrade80() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DFSClient.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
    ...
    @Test
    public void testSpaceQuotaExceptionOnAppend_withUpgrade20() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnAppend_withUpgrade40() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnAppend_withUpgrade60() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
    ...
    @Test
    public void testSpaceQuotaExceptionOnAppend_withUpgrade80() throws Exception {
        GenericTestUtils.setLogLevel(DFSOutputStream.LOG, Level.TRACE);
        GenericTestUtils.setLogLevel(DataStreamer.LOG, Level.TRACE);
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final Path dir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
