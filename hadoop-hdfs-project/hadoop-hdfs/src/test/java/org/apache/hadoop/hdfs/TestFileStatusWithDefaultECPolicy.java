...
public class TestFileStatusWithDefaultECPolicy {
    ...
    @Test
    public void testFileStatusWithECPolicy_withUpgrade20() throws Exception {
        // test directory doesn't have an EC policy
        final Path dir = new Path("/foo");
        assertTrue(fs.mkdir(dir, FsPermission.getDirDefault()));
        ContractTestUtils.assertNotErasureCoded(fs, dir);
    ...
    @Test
    public void testFileStatusWithECPolicy_withUpgrade40() throws Exception {
        // test directory doesn't have an EC policy
        final Path dir = new Path("/foo");
        assertTrue(fs.mkdir(dir, FsPermission.getDirDefault()));
        ContractTestUtils.assertNotErasureCoded(fs, dir);
    ...
    @Test
    public void testFileStatusWithECPolicy_withUpgrade60() throws Exception {
        // test directory doesn't have an EC policy
        final Path dir = new Path("/foo");
        assertTrue(fs.mkdir(dir, FsPermission.getDirDefault()));
        ContractTestUtils.assertNotErasureCoded(fs, dir);
    ...
    @Test
    public void testFileStatusWithECPolicy_withUpgrade80() throws Exception {
        // test directory doesn't have an EC policy
        final Path dir = new Path("/foo");
        assertTrue(fs.mkdir(dir, FsPermission.getDirDefault()));
        ContractTestUtils.assertNotErasureCoded(fs, dir);
