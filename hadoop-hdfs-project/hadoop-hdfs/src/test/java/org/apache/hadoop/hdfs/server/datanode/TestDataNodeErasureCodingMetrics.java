...
public class TestDataNodeErasureCodingMetrics {
    ...
    private void doTest(String fileName, int fileLen, int deadNodeIndex) throws Exception {
        ...
        final DataNodeJVMInterface toCorruptDn = cluster.getDataNode(lastBlock.getLocations()[deadNodeIndex].getIpcPort());
    ...
    private void setDataNodeDead(DatanodeID dnID) throws IOException {
        DatanodeDescriptorJVMInterface dnd = NameNodeAdapter.getDatanode(cluster.getNamesystem(), dnID);
    ...
    @Test(timeout = 120000)
    public void testFullBlock_withUpgrade20() throws Exception {
        Assert.assertEquals(0, getLongMetric("EcReconstructionReadTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionDecodingTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionWriteTimeMillis"));
        doTest("/testEcMetrics", blockGroupSize, 0);
    ...
    @Test(timeout = 120000)
    public void testFullBlock_withUpgrade40() throws Exception {
        Assert.assertEquals(0, getLongMetric("EcReconstructionReadTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionDecodingTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionWriteTimeMillis"));
        doTest("/testEcMetrics", blockGroupSize, 0);
    ...
    @Test(timeout = 120000)
    public void testFullBlock_withUpgrade60() throws Exception {
        Assert.assertEquals(0, getLongMetric("EcReconstructionReadTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionDecodingTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionWriteTimeMillis"));
        doTest("/testEcMetrics", blockGroupSize, 0);
    ...
    @Test(timeout = 120000)
    public void testFullBlock_withUpgrade80() throws Exception {
        Assert.assertEquals(0, getLongMetric("EcReconstructionReadTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionDecodingTimeMillis"));
        Assert.assertEquals(0, getLongMetric("EcReconstructionWriteTimeMillis"));
        doTest("/testEcMetrics", blockGroupSize, 0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup1_withUpgrade20() throws Exception {
        final int fileLen = blockSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup1_withUpgrade40() throws Exception {
        final int fileLen = blockSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        Assert.assertEquals("EcReconstructionBytesRead should be ", fileLen, getLongMetric("EcReconstructionBytesRead"));
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup1_withUpgrade60() throws Exception {
        final int fileLen = blockSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        Assert.assertEquals("EcReconstructionBytesRead should be ", fileLen, getLongMetric("EcReconstructionBytesRead"));
        Assert.assertEquals("EcReconstructionBytesWritten should be ", fileLen, getLongMetric("EcReconstructionBytesWritten"));
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup1_withUpgrade80() throws Exception {
        final int fileLen = blockSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        Assert.assertEquals("EcReconstructionBytesRead should be ", fileLen, getLongMetric("EcReconstructionBytesRead"));
        Assert.assertEquals("EcReconstructionBytesWritten should be ", fileLen, getLongMetric("EcReconstructionBytesWritten"));
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup2_withUpgrade20() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup2_withUpgrade40() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        Assert.assertEquals("ecReconstructionBytesRead should be ", cellSize * dataBlocks + cellSize + cellSize / 10, getLongMetric("EcReconstructionBytesRead"));
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup2_withUpgrade60() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        Assert.assertEquals("ecReconstructionBytesRead should be ", cellSize * dataBlocks + cellSize + cellSize / 10, getLongMetric("EcReconstructionBytesRead"));
        Assert.assertEquals("EcReconstructionBytesWritten should be ", blockSize, getLongMetric("EcReconstructionBytesWritten"));
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup2_withUpgrade80() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 0);
        Assert.assertEquals("ecReconstructionBytesRead should be ", cellSize * dataBlocks + cellSize + cellSize / 10, getLongMetric("EcReconstructionBytesRead"));
        Assert.assertEquals("EcReconstructionBytesWritten should be ", blockSize, getLongMetric("EcReconstructionBytesWritten"));
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup3_withUpgrade20() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup3_withUpgrade40() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 1);
        Assert.assertEquals("ecReconstructionBytesRead should be ", cellSize * dataBlocks + (cellSize / 10) * 2, getLongMetric("EcReconstructionBytesRead"));
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup3_withUpgrade60() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 1);
        Assert.assertEquals("ecReconstructionBytesRead should be ", cellSize * dataBlocks + (cellSize / 10) * 2, getLongMetric("EcReconstructionBytesRead"));
        Assert.assertEquals("ecReconstructionBytesWritten should be ", cellSize + cellSize / 10, getLongMetric("EcReconstructionBytesWritten"));
    ...
    @Test(timeout = 120000)
    public void testReconstructionBytesPartialGroup3_withUpgrade80() throws Exception {
        final int fileLen = cellSize * dataBlocks + cellSize + cellSize / 10;
        doTest("/testEcBytes", fileLen, 1);
        Assert.assertEquals("ecReconstructionBytesRead should be ", cellSize * dataBlocks + (cellSize / 10) * 2, getLongMetric("EcReconstructionBytesRead"));
        Assert.assertEquals("ecReconstructionBytesWritten should be ", cellSize + cellSize / 10, getLongMetric("EcReconstructionBytesWritten"));
