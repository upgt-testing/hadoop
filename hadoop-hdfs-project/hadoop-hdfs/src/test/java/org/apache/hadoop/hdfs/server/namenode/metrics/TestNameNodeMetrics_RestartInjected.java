...
public class TestNameNodeMetrics_RestartInjected {
  ...
  public void testStaleNodes() throws Exception {
    ...
    RestartFramework.at("after_stale_setup")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_heartbeat_check")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVolumeFailures() throws Exception {
    ...
    RestartFramework.at("after_volume_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataNodeLivenessAndDecom() throws Exception {
    ...
    RestartFramework.at("after_dns_killed")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_refresh_nodes")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFileAdd() throws Exception {
    ...
    RestartFramework.at("after_normal_file_creation")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_ec_file_creation")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_normal_file_deletion")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_ec_file_deletion")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCorruptBlock() throws Exception {
    ...
    RestartFramework.at("after_file_replication")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_block_recovery")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStripedFileCorruptBlocks() throws Exception {
    ...
    RestartFramework.at("after_ec_corruption")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_ec_reconstruction")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testExcessBlocks() throws Exception {
    ...
    RestartFramework.at("after_replication_change")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testTransactionSinceLastCheckpointMetrics() throws Exception {
    ...
    while (retryCount < 5) {
      try {
        ...
        RestartFramework.at("after_ha_setup")
            .on(cluster2)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testTransactionAndCheckpointMetrics() throws Exception {
    ...
    RestartFramework.at("after_editlog_roll")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSyncAndBlockReportMetric() throws Exception {
    ...
    RestartFramework.at("after_initial_block_report")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNumActiveClientsAndFilesUnderConstructionMetrics()
    ...
    RestartFramework.at("after_first_file_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_multi_client_files")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testGenerateEDEKTime() throws IOException,
    ...
    try (MiniDFSCluster clusterEDEK = new MiniDFSCluster.Builder(conf, basedir)
      ...
      for (int i = 0; i < 3; i++) {
        ...
        RestartFramework.at("after_encrypted_file_creation_" + i)
            .on(clusterEDEK)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
