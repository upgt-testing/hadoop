...
public class TestFsDatasetCacheRevocation {
    ...
    public void testPinning() throws Exception {
        ...
        FsDatasetSpiJVMInterface<?> fsd = cluster.getDataNodes().get(0).getFSDataset();
    ...
    @Test(timeout = 120000)
    public void testPinning_withUpgrade20() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        Configuration conf = getDefaultConf();
        // this test.
    ...
    @Test(timeout = 120000)
    public void testPinning_withUpgrade40() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        Configuration conf = getDefaultConf();
        // this test.
    ...
    @Test(timeout = 120000)
    public void testPinning_withUpgrade60() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        Configuration conf = getDefaultConf();
        // this test.
    ...
    @Test(timeout = 120000)
    public void testPinning_withUpgrade80() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        Configuration conf = getDefaultConf();
        // this test.
    ...
    @Test(timeout = 120000)
    public void testRevocation_withUpgrade20() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        BlockReaderTestUtil.enableHdfsCachingTracing();
        BlockReaderTestUtil.enableShortCircuitShmTracing();
    ...
    @Test(timeout = 120000)
    public void testRevocation_withUpgrade40() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        BlockReaderTestUtil.enableHdfsCachingTracing();
        BlockReaderTestUtil.enableShortCircuitShmTracing();
    ...
    @Test(timeout = 120000)
    public void testRevocation_withUpgrade60() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        BlockReaderTestUtil.enableHdfsCachingTracing();
        BlockReaderTestUtil.enableShortCircuitShmTracing();
    ...
    @Test(timeout = 120000)
    public void testRevocation_withUpgrade80() throws Exception {
        assumeTrue(NativeCodeLoader.isNativeCodeLoaded());
        assumeNotWindows();
        BlockReaderTestUtil.enableHdfsCachingTracing();
        BlockReaderTestUtil.enableShortCircuitShmTracing();
