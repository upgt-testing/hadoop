...
public class TestFailureToReadEdits_RestartInjected_Randomized_456 {
    ...
    public TestFailureToReadEdits_RestartInjected_Randomized_456(TestType clusterType, Boolean useAsyncEditLogging) {
