...
public class TestDecommissioningStatus_RestartInjected {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(TestDecommissioningStatus_RestartInjected.class);
  ...
  public void testDecommissionStatus() throws Exception {
    ...
    RestartFramework.at("after_incomplete_file_write")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_verify_initial_state")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    for (int iteration = 0; iteration < numDatanodes; iteration++) {
      ...
      RestartFramework.at("after_decommission_refresh_nodes")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("before_close_incomplete_file")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDecommissionStatusAfterDNRestart() throws Exception {
    ...
    RestartFramework.at("after_decommission_started")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDecommissionLosingData() throws Exception {
    ...
    RestartFramework.at("after_dn1_stopped")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_dn0_stopped")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_dn0_restarted")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_dn1_restarted")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_new_datanodes_started")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
