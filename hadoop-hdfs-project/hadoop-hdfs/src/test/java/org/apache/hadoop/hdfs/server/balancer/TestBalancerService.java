...
public class TestBalancerService {
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceBalanceTwice_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        TestBalancer.initConf(conf);
        try {
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceBalanceTwice_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        TestBalancer.initConf(conf);
        try {
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceBalanceTwice_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        TestBalancer.initConf(conf);
        try {
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceBalanceTwice_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        TestBalancer.initConf(conf);
        try {
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceOnError_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // retry for every 5 seconds
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECT_MAX_RETRIES_KEY, 1);
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceOnError_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // retry for every 5 seconds
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECT_MAX_RETRIES_KEY, 1);
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceOnError_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // retry for every 5 seconds
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECT_MAX_RETRIES_KEY, 1);
    ...
    @Test(timeout = 60000)
    public void testBalancerServiceOnError_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // retry for every 5 seconds
        conf.setTimeDuration(DFSConfigKeys.DFS_BALANCER_SERVICE_INTERVAL_KEY, 5, TimeUnit.SECONDS);
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECT_MAX_RETRIES_KEY, 1);
