...
public class TestUpgtDemo {
    ...
    public void testUpgradeFinalizeHA() throws IOException {
        ...
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf).nnTopology(topology).numDataNodes(0).build();
        cluster2.waitActive();
        cluster2.transitionToActive(0);
        cluster2.upgradeAllNameNodes();
        cluster2.transitionToStandby(0);
        // NN1 will be active and upgrade the layoutVersion in VERSION file
        cluster2.transitionToActive(1);
        cluster2.transitionToStandby(1);
        // NN2 will be active and upgrade the layoutVersion in VERSION file
        cluster2.transitionToActive(2);
        cluster2.shutdown();
    }
    ...
    public void testNamenode() {
        ...
        for (String version : versions) {
            ...
            try {
                ...
                // Assuming the format method is static
    ...
    @Test
    public void testUpgradeFinalize_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        cluster.upgradeAllNameNodes();
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testUpgradeFinalize_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        cluster.upgradeAllNameNodes();
        cluster.shutdown();
    ...
    @Test
    public void testFileSystemUpgradeDNInJVM_withUpgrade20() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllDataNodes(true);
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeDNInJVM_withUpgrade40() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllDataNodes(true);
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeDNInJVM_withUpgrade60() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllDataNodes(true);
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeDNInJVM_withUpgrade80() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllDataNodes(true);
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeNNInJVM_withUpgrade20() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllNameNodes();
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeNNInJVM_withUpgrade40() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllNameNodes();
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeNNInJVM_withUpgrade60() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllNameNodes();
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testFileSystemUpgradeNNInJVM_withUpgrade80() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        cluster2.upgradeAllNameNodes();
        FileSystem fs2 = FileSystem.get(conf2);
    ...
    @Test
    public void testUpgradeFinalizeHA_withUpgrade20() throws IOException {
        int maxNNCount = 3;
        int STARTING_PORT = 20000;
        Configuration conf = new Configuration();
        MiniDFSNNTopology.NSConf nameservice = new MiniDFSNNTopology.NSConf("ns1");
    ...
    @Test
    public void testUpgradeFinalizeHA_withUpgrade40() throws IOException {
        int maxNNCount = 3;
        int STARTING_PORT = 20000;
        Configuration conf = new Configuration();
        MiniDFSNNTopology.NSConf nameservice = new MiniDFSNNTopology.NSConf("ns1");
    ...
    @Test
    public void testUpgradeFinalizeHA_withUpgrade60() throws IOException {
        int maxNNCount = 3;
        int STARTING_PORT = 20000;
        Configuration conf = new Configuration();
        MiniDFSNNTopology.NSConf nameservice = new MiniDFSNNTopology.NSConf("ns1");
    ...
    @Test
    public void testUpgradeFinalizeHA_withUpgrade80() throws IOException {
        int maxNNCount = 3;
        int STARTING_PORT = 20000;
        Configuration conf = new Configuration();
        MiniDFSNNTopology.NSConf nameservice = new MiniDFSNNTopology.NSConf("ns1");
    ...
    @Test
    public void testUpgrade_withUpgrade20() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testUpgrade_withUpgrade40() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testUpgrade_withUpgrade60() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testUpgrade_withUpgrade80() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testFileSystemInJVM_withUpgrade20() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testFileSystemInJVM_withUpgrade40() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testFileSystemInJVM_withUpgrade60() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
    ...
    @Test
    public void testFileSystemInJVM_withUpgrade80() throws IOException {
        Configuration conf2 = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(2).build();
        System.out.println("Start restarting!!");
        cluster2.restartNodeForTesting(0);
