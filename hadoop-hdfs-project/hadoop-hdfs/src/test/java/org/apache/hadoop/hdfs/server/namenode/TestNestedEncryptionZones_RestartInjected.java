...
public class TestNestedEncryptionZones_RestartInjected {
  ...
  public void testNestedEncryptionZones() throws Exception {
    ...
    fs = cluster.getFileSystem();
    verifyEncryption();
    RestartFramework.at("after_restart_verification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    fs = cluster.getFileSystem();
    verifyEncryption();
    RestartFramework.at("after_checkpoint_verification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    renameChildrenOfEZ();
    RestartFramework.at("after_rename_children")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_second_ez")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_topez")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_rename_nested_ez")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNestedEZWithRoot() throws Exception {
    ...
    RestartFramework.at("after_init_root_ez")
        ...
        .execute();
    verifyEncryption();
    RestartFramework.at("after_root_ez_verification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    // test rename file
    renameChildrenOfEZ();
    RestartFramework.at("after_root_ez_rename")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_trash_verification")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
