...
public class TestDNFencing_RestartInjected {
  ...
  public void testDnFencing() throws Exception {
    ...
    RestartFramework.at("after_failover_to_nn2")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNNClearsCommandsOnFailoverAfterStartup()
    ...
    RestartFramework.at("after_create_file_failover")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNNClearsCommandsOnFailoverWithReplChanges()
    ...
    RestartFramework.at("after_failover_repl_changes")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRBWReportArrivesAfterEdits() throws Exception {
    ...
    RestartFramework.at("after_transition_rbw")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
