...
public class TestEditLogTailer_RestartInjected_Randomized_123 {
    ...
    public TestEditLogTailer_RestartInjected_Randomized_123(Boolean async) {
    ...
    public void testTailer() throws IOException, InterruptedException, ServiceFailedException {
        ...
        try {
            ...
            RestartFramework.at("after_first_mkdirs").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
    ...
    private static void testStandbyTriggersLogRolls(int activeIndex) throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_transition_active").on(cluster).restart("namenode").withIndex(activeIndex).withMode(RestartMode.GRACEFUL).execute();
