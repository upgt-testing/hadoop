...
public class TestDataNodeVolumeFailure_RestartInjected {
  ...
  public void testVolumeFailure() throws Exception {
    ...
    RestartFramework.at("after_new_file_replication")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDnStartsAfterDiskErrorScanningBlockPool() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_local_cluster_start")
          .on(localCluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_datanode_fully_started")
          .on(localCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testUnderReplicationAfterVolFailure() throws Exception {
    ...
    RestartFramework.at("after_new_datanode_start")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file1_replication")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVolumeFailureDuringStartup() throws Exception {
    ...
    RestartFramework.at("after_volume_failure_setup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_volume_failure_detected")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVolumeFailureTwo() throws Exception {
    ...
    RestartFramework.at("after_disk_check")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
