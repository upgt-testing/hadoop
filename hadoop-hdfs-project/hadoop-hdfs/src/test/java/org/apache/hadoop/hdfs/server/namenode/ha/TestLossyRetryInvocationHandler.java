...
public class TestLossyRetryInvocationHandler {
    ...
    @Test
    public void testStartNNWithTrashEmptier_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // enable both trash emptier and dropping response
        conf.setLong("fs.trash.interval", 360);
    ...
    @Test
    public void testStartNNWithTrashEmptier_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // enable both trash emptier and dropping response
        conf.setLong("fs.trash.interval", 360);
    ...
    @Test
    public void testStartNNWithTrashEmptier_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // enable both trash emptier and dropping response
        conf.setLong("fs.trash.interval", 360);
    ...
    @Test
    public void testStartNNWithTrashEmptier_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // enable both trash emptier and dropping response
        conf.setLong("fs.trash.interval", 360);
