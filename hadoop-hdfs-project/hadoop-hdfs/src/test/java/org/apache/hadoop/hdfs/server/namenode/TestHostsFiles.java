   ...
   */
    ...
    public void testHostsExcludeInUI() throws Exception {
        ...
        try {
            ...
            ObjectName mxbeanName = new ObjectName("Hadoop:service=NameNodeInterface,name=NameNodeInfo");
    ...
    public void testHostsIncludeForDeadCount() throws Exception {
        ...
        try {
            ...
            MBeanServer mbs = ManagementFactory.getPlatformMBeanServer();
            ObjectName mxbeanName = new ObjectName("Hadoop:service=NameNodeInterface,name=FSNamesystemState");
