...
public class TestEnhancedByteBufferAccess {
    ...
    public void testZeroCopyMmapCache() throws Exception {
        ...
        fsIn.close();
        fsIn = fs.open(TEST_PATH);
        final ShortCircuitCache cache = ClientContext.get(CONTEXT, new DfsClientConf(conf)).getShortCircuitCache();
    ...
    @Test
    public void testZeroCopyReads_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReads_withUpgrade40() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReads_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReads_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testShortZeroCopyReads_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testShortZeroCopyReads_withUpgrade40() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testShortZeroCopyReads_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testShortZeroCopyReads_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReadsNoFallback_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReadsNoFallback_withUpgrade40() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReadsNoFallback_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyReadsNoFallback_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        FSDataInputStream fsIn = null;
    ...
    @Test
    public void testZeroCopyMmapCache_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 5 * BLOCK_SIZE;
    ...
    @Test
    public void testZeroCopyMmapCache_withUpgrade40() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 5 * BLOCK_SIZE;
    ...
    @Test
    public void testZeroCopyMmapCache_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 5 * BLOCK_SIZE;
    ...
    @Test
    public void testZeroCopyMmapCache_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 5 * BLOCK_SIZE;
    ...
    @Test
    public void testHdfsFallbackReads_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testHdfsFallbackReads_withUpgrade40() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testHdfsFallbackReads_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testHdfsFallbackReads_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testFallbackRead_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testFallbackRead_withUpgrade40() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testFallbackRead_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testFallbackRead_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
        final int TEST_FILE_LENGTH = 16385;
    ...
    @Test
    public void testClientMmapDisable_withUpgrade20() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        conf.setBoolean(HdfsClientConfigKeys.Mmap.ENABLED_KEY, false);
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
    ...
    @Test
    public void testClientMmapDisable_withUpgrade60() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        conf.setBoolean(HdfsClientConfigKeys.Mmap.ENABLED_KEY, false);
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
    ...
    @Test
    public void testClientMmapDisable_withUpgrade80() throws Exception {
        HdfsConfiguration conf = initZeroCopyTest();
        conf.setBoolean(HdfsClientConfigKeys.Mmap.ENABLED_KEY, false);
        MiniDFSClusterInJVM cluster = null;
        final Path TEST_PATH = new Path("/a");
    ...
    @Test
    public void test2GBMmapLimit_withUpgrade20() throws Exception {
        Assume.assumeTrue(BlockReaderTestUtil.shouldTestLargeFiles());
        HdfsConfiguration conf = initZeroCopyTest();
        final long TEST_FILE_LENGTH = 2469605888L;
        conf.set(DFSConfigKeys.DFS_CHECKSUM_TYPE_KEY, "NULL");
    ...
    @Test
    public void test2GBMmapLimit_withUpgrade40() throws Exception {
        Assume.assumeTrue(BlockReaderTestUtil.shouldTestLargeFiles());
        HdfsConfiguration conf = initZeroCopyTest();
        final long TEST_FILE_LENGTH = 2469605888L;
        conf.set(DFSConfigKeys.DFS_CHECKSUM_TYPE_KEY, "NULL");
    ...
    @Test
    public void test2GBMmapLimit_withUpgrade60() throws Exception {
        Assume.assumeTrue(BlockReaderTestUtil.shouldTestLargeFiles());
        HdfsConfiguration conf = initZeroCopyTest();
        final long TEST_FILE_LENGTH = 2469605888L;
        conf.set(DFSConfigKeys.DFS_CHECKSUM_TYPE_KEY, "NULL");
    ...
    @Test
    public void test2GBMmapLimit_withUpgrade80() throws Exception {
        Assume.assumeTrue(BlockReaderTestUtil.shouldTestLargeFiles());
        HdfsConfiguration conf = initZeroCopyTest();
        final long TEST_FILE_LENGTH = 2469605888L;
        conf.set(DFSConfigKeys.DFS_CHECKSUM_TYPE_KEY, "NULL");
