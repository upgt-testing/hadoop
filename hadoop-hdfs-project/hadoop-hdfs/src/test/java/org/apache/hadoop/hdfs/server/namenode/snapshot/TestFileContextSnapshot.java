...
public class TestFileContextSnapshot {
    ...
    @Test(timeout = 60000)
    public void testCreateAndDeleteSnapshot_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(dfs, filePath, BLOCKSIZE, REPLICATION, SEED);
        // disallow snapshot on dir
        dfs.disallowSnapshot(snapRootPath);
        try {
    ...
    @Test(timeout = 60000)
    public void testCreateAndDeleteSnapshot_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(dfs, filePath, BLOCKSIZE, REPLICATION, SEED);
        // disallow snapshot on dir
        dfs.disallowSnapshot(snapRootPath);
        try {
    ...
    @Test(timeout = 60000)
    public void testCreateAndDeleteSnapshot_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(dfs, filePath, BLOCKSIZE, REPLICATION, SEED);
        // disallow snapshot on dir
        dfs.disallowSnapshot(snapRootPath);
        try {
    ...
    @Test(timeout = 60000)
    public void testCreateAndDeleteSnapshot_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(dfs, filePath, BLOCKSIZE, REPLICATION, SEED);
        // disallow snapshot on dir
        dfs.disallowSnapshot(snapRootPath);
        try {
