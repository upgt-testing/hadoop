...
public class TestReplicationPolicy_RestartInjected extends BaseReplicationPolicyTest {
  ...
  public TestReplicationPolicy_RestartInjected(String blockPlacementPolicyClassName) {
  ...
  public void testChooseTargetWithMoreThanHalfStaleNodes() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_first_heartbeat_check")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_first_choose_target")
          .on(miniCluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_heartbeat_check")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_choose_target")
          .on(miniCluster)
          .restart("datanode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_third_heartbeat_check")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("before_final_choose_target")
          .on(miniCluster)
          .restart("datanode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReplicationWithPriority() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_add_normal_priority_blocks")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_add_high_priority_block")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
