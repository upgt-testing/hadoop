...
public class TestBlockToken {
    ...
    private static class GetLengthAnswer implements Answer<GetReplicaVisibleLengthResponseProto> {
        ...
        private void testBlockTokenInLastLocatedBlock_withUpgrade20(boolean enableProtobuf) throws IOException, InterruptedException {
       ...
       */
        ...
        private void testBlockTokenInLastLocatedBlock_withUpgrade40(boolean enableProtobuf) throws IOException, InterruptedException {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
            conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 512);
            conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_PROTOBUF_ENABLE, enableProtobuf);
       ...
       */
        ...
        private void testBlockTokenInLastLocatedBlock_withUpgrade60(boolean enableProtobuf) throws IOException, InterruptedException {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
            conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 512);
            conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_PROTOBUF_ENABLE, enableProtobuf);
       ...
       */
        ...
        @Test
        public void testBlockTokenInLastLocatedBlockLegacy_withUpgrade20() throws IOException, InterruptedException {
            testBlockTokenInLastLocatedBlock_withUpgrade20(false);
        }

        @Test
        public void testBlockTokenInLastLocatedBlockLegacy_withUpgrade40() throws IOException, InterruptedException {
            testBlockTokenInLastLocatedBlock_withUpgrade40(false);
        }

        @Test
        public void testBlockTokenInLastLocatedBlockLegacy_withUpgrade60() throws IOException, InterruptedException {
            testBlockTokenInLastLocatedBlock_withUpgrade60(false);
        }

        @Test
        public void testBlockTokenInLastLocatedBlockProtobuf_withUpgrade20() throws IOException, InterruptedException {
            testBlockTokenInLastLocatedBlock_withUpgrade20(true);
        }

        @Test
        public void testBlockTokenInLastLocatedBlockProtobuf_withUpgrade40() throws IOException, InterruptedException {
            testBlockTokenInLastLocatedBlock_withUpgrade40(true);
        }

        @Test
        public void testBlockTokenInLastLocatedBlockProtobuf_withUpgrade60() throws IOException, InterruptedException {
            testBlockTokenInLastLocatedBlock_withUpgrade60(true);
        }
    }
    ...
    private static void checkAccess(BlockTokenSecretManager m, Token<BlockTokenIdentifier> t, ExtendedBlock blk, BlockTokenIdentifier.AccessMode mode, StorageType[] storageTypes, String[] storageIds) throws SecretManager.InvalidToken {
