...
public class TestBlockToken {
    ...
    private void testBlockTokenInLastLocatedBlock(boolean enableProtobuf) throws IOException, InterruptedException {
        ...
        try {
            ...
            out.flush();
            LocatedBlocksJVMInterface locatedBlocks = cluster.getNameNodeRpc().getBlockLocations(fileName, 0, 1000);
    ...
    @Test
    public void testLastLocatedBlockTokenExpiry_withUpgrade20() throws IOException, InterruptedException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitClusterUp();
    ...
    @Test
    public void testLastLocatedBlockTokenExpiry_withUpgrade40() throws IOException, InterruptedException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitClusterUp();
    ...
    @Test
    public void testLastLocatedBlockTokenExpiry_withUpgrade60() throws IOException, InterruptedException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitClusterUp();
    ...
    @Test
    public void testLastLocatedBlockTokenExpiry_withUpgrade80() throws IOException, InterruptedException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitClusterUp();
