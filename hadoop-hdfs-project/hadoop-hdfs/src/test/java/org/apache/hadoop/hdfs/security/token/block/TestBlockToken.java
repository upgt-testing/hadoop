...
public class TestBlockToken {
    ...
    // 10 mins
    final long blockKeyUpdateInterval = 10 * 60 * 1000;
    ...
    private static class GetLengthAnswer implements Answer<GetReplicaVisibleLengthResponseProto> {
        ...
        final BlockTokenSecretManagerInterface sm;

        final BlockTokenIdentifierInterface ident;
        ...
        public GetReplicaVisibleLengthResponseProto answer(InvocationOnMock invocation) throws IOException {
            ...
            long result = 0;
            for (TokenIdentifierInterface tokenId : tokenIds) {
                BlockTokenIdentifierInterface id = (BlockTokenIdentifier) tokenId;
    ...
    private BlockTokenIdentifier generateTokenId(BlockTokenSecretManager sm, ExtendedBlock block, EnumSet<BlockTokenIdentifier.AccessMode> accessModes, StorageType[] storageTypes, String[] storageIds) throws IOException {
        TokenInterface<BlockTokenIdentifier> token = sm.generateToken(block, accessModes, storageTypes, storageIds);
        BlockTokenIdentifierInterface id = sm.createIdentifier();
    ...
    private void testWritable(boolean enableProtobuf) throws Exception {
        ...
        TestWritable.testWritable(generateTokenId(sm, block3, EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DEFAULT }, null));
        TestWritable.testWritable(generateTokenId(sm, block3, EnumSet.of(BlockTokenIdentifier.AccessMode.WRITE), new StorageType[] { StorageType.DEFAULT }, null));
        TestWritable.testWritable(generateTokenId(sm, block3, EnumSet.allOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DEFAULT }, null));
        TestWritable.testWritable(generateTokenId(sm, block1, EnumSet.allOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DEFAULT }, null));
        TestWritable.testWritable(generateTokenId(sm, block2, EnumSet.of(BlockTokenIdentifier.AccessMode.WRITE), new StorageType[] { StorageType.DEFAULT }, null));
        TestWritable.testWritable(generateTokenId(sm, block3, EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DEFAULT }, null));
        // We must be backwards compatible when adding storageType
        TestWritable.testWritable(generateTokenId(sm, block3, EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class), null, null));
        TestWritable.testWritable(generateTokenId(sm, block3, EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class), StorageType.EMPTY_ARRAY, null));
    }
    ...
    private void tokenGenerationAndVerification(BlockTokenSecretManager master, BlockTokenSecretManager slave, StorageType[] storageTypes, String[] storageIds) throws Exception {
        ...
        for (BlockTokenIdentifier.AccessMode mode : BlockTokenIdentifier.AccessMode.values()) {
            // generated by master
            TokenInterface<BlockTokenIdentifier> token1 = master.generateToken(block1, EnumSet.of(mode), storageTypes, storageIds);
            ...
            // generated by slave
            TokenInterface<BlockTokenIdentifier> token2 = slave.generateToken(block2, EnumSet.of(mode), storageTypes, storageIds);
        ...
        // multi-mode tokens
        TokenInterface<BlockTokenIdentifier> mtoken = master.generateToken(block3, EnumSet.allOf(BlockTokenIdentifier.AccessMode.class), storageTypes, storageIds);
        for (BlockTokenIdentifier.AccessMode mode : BlockTokenIdentifier.AccessMode.values()) {
    ...
    private void testBlockTokenSecretManager(boolean enableProtobuf) throws Exception {
        BlockTokenSecretManager masterHandler = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, 0, 1, "fake-pool", null, enableProtobuf);
        BlockTokenSecretManager slaveHandler = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, "fake-pool", null, enableProtobuf);
        ExportedBlockKeysInterface keys = masterHandler.exportKeys();
        slaveHandler.addKeys(keys);
        tokenGenerationAndVerification(masterHandler, slaveHandler, new StorageType[] { StorageType.DEFAULT }, null);
    ...
    private static Server createMockDatanode(BlockTokenSecretManager sm, Token<BlockTokenIdentifier> token, Configuration conf) throws IOException, ServiceException {
        ...
        BlockTokenIdentifierInterface id = sm.createIdentifier();
        id.readFields(new DataInputStream(new ByteArrayInputStream(token.getIdentifier())));
        doAnswer(new GetLengthAnswer(sm, id)).when(mockDN).getReplicaVisibleLength(any(), any());
    ...
    private void testBlockTokenRpc(boolean enableProtobuf) throws Exception {
        ...
        UserGroupInformation.setConfiguration(conf);
        BlockTokenSecretManager sm = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, 0, 1, "fake-pool", null, enableProtobuf);
        TokenInterface<BlockTokenIdentifier> token = sm.generateToken(block3, EnumSet.allOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DEFAULT }, new String[0]);
    ...
    private void testBlockPoolTokenSecretManager(boolean enableProtobuf) throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            tokenGenerationAndVerification(masterHandler, bpMgr.get(bpid), new StorageType[] { StorageType.DEFAULT }, storageIds);
            tokenGenerationAndVerification(masterHandler, bpMgr.get(bpid), null, null);
            // Test key updating
            masterHandler.updateKeys();
            tokenGenerationAndVerification(masterHandler, bpMgr.get(bpid), new StorageType[] { StorageType.DEFAULT }, storageIds);
            tokenGenerationAndVerification(masterHandler, bpMgr.get(bpid), null, null);
            keys = masterHandler.exportKeys();
            bpMgr.addKeys(bpid, keys);
            tokenGenerationAndVerification(masterHandler, bpMgr.get(bpid), new StorageType[] { StorageType.DEFAULT }, new String[] { "DS-9001" });
            tokenGenerationAndVerification(masterHandler, bpMgr.get(bpid), null, null);
        }
    }
    ...
    private void testBlockTokenInLastLocatedBlock(boolean enableProtobuf) throws IOException, InterruptedException {
        ...
        try {
            ...
            TokenInterface<BlockTokenIdentifier> token = locatedBlocks.getLastLocatedBlock().getBlockToken();
    ...
    public void testLegacyBlockTokenBytesIsLegacy() throws IOException {
        ...
        TokenInterface<BlockTokenIdentifier> token = sm.generateToken(block1, EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DEFAULT }, new String[0]);
     ...
     */
    @Test
    public void testLegacyBlockTokenWithoutStorages() throws IOException, IllegalAccessException {
        BlockTokenIdentifier identifier = new BlockTokenIdentifier("user", "blockpool", 123, EnumSet.allOf(BlockTokenIdentifier.AccessMode.class), null, null, false);
    ...
    public void testProtobufBlockTokenBytesIsProtobuf() throws IOException {
        ...
        BlockTokenSecretManager sm = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, 0, 1, "fake-pool", null, useProto);
        TokenInterface<BlockTokenIdentifier> token = sm.generateToken(block1, EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class), StorageType.EMPTY_ARRAY, new String[0]);
        final byte[] tokenBytes = token.getIdentifier();
        BlockTokenIdentifier legacyToken = new BlockTokenIdentifier();
        BlockTokenIdentifier protobufToken = new BlockTokenIdentifier();
        BlockTokenIdentifier readToken = new BlockTokenIdentifier();
    ...
    private void testCraftedBlockTokenIdentifier(BlockTokenIdentifier identifier, boolean expectIOE, boolean expectRTE, boolean isProtobuf) throws IOException {
        DataOutputBuffer dob = new DataOutputBuffer(4096);
        DataInputBuffer dib = new DataInputBuffer();
        if (isProtobuf) {
     ...
     */
        BlockTokenIdentifier identifier = new BlockTokenIdentifier("user", "blockpool", 123, EnumSet.allOf(BlockTokenIdentifier.AccessMode.class), new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }, new String[] { "fake-storage-id" }, true);
        Calendar cal = new GregorianCalendar();
        cal.set(2017, 1, 9, 0, 12, 35);
        long datetime = cal.getTimeInMillis();
        // strip milliseconds.
        datetime = ((datetime / 1000) * 1000);
        // 2017-02-09 00:12:35,071+0100
        datetime = datetime + 71;
        identifier.setExpiryDate(datetime);
        testCraftedBlockTokenIdentifier(identifier, false, true, true);
        // 2017-02-09 00:12:35,072+0100
        datetime += 1;
        identifier.setExpiryDate(datetime);
        testCraftedBlockTokenIdentifier(identifier, true, false, true);
    }
    ...
    public void testEmptyBlockTokenSerialization() throws IOException {
        ...
        BlockTokenIdentifierInterface ret = writeAndReadBlockToken(ident);
        ...
        assertEquals(ret.getAccessModes(), EnumSet.noneOf(BlockTokenIdentifier.AccessMode.class));
    ...
    private void testBlockTokenSerialization(boolean useProto) throws IOException {
        ...
        StorageType[] storageTypes = new StorageType[] { StorageType.RAM_DISK, StorageType.SSD, StorageType.DISK, StorageType.ARCHIVE };
        BlockTokenIdentifier ident = new BlockTokenIdentifier("user", "bpool", 123, accessModes, storageTypes, new String[] { "fake-storage-id" }, useProto);
        ...
        assertEquals(ret.getAccessModes(), EnumSet.allOf(BlockTokenIdentifier.AccessMode.class));
    ...
    private void testBadStorageIDCheckAccess(boolean enableProtobuf) throws IOException {
        ...
        BlockTokenIdentifierInterface id = generateTokenId(sm, block3, EnumSet.of(mode), storageTypes, storageIds);
        ...
        // writeBlock api.
        sm.checkAccess(id, null, block3, mode, storageTypes, emptyStorageIds);
        sm.checkAccess(id, null, block3, mode, storageTypes, null);
    ...
    public void testBlockTokenRanges() throws IOException {
        ...
        for (int nnIdx = 0; nnIdx < 64; nnIdx++) {
            BlockTokenSecretManager sm = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, nnIdx, numNNs, "fake-pool", null, false);
            int rangeStart = nnIdx * interval;
            for (int i = 0; i < interval * 3; i++) {
                int serialNo = sm.getSerialNoForTesting();
                assertTrue("serialNo " + serialNo + " is not in the designated range: [" + rangeStart + ", " + (rangeStart + interval) + ")", serialNo >= rangeStart && serialNo < (rangeStart + interval));
                sm.updateKeys();
            }
        }
    }
    ...
    public void testRetrievePasswordWithUnknownFields() throws IOException {
        ...
        BlockTokenIdentifierInterface spyId = Mockito.spy(id);
        ...
        BlockTokenSecretManager sm = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, 0, 1, "fake-pool", null, false);
        // master create password
        byte[] password = sm.createPassword(spyId);
        BlockTokenIdentifier slaveId = new BlockTokenIdentifier();
        slaveId.readFields(new DataInputStream(new ByteArrayInputStream(spyId.getBytes())));
        // slave retrieve password
        assertArrayEquals(password, sm.retrievePassword(slaveId));
    }

    @Test
    public void testRetrievePasswordWithRecognizableFieldsOnly() throws IOException {
        BlockTokenSecretManager sm = new BlockTokenSecretManager(blockKeyUpdateInterval, blockTokenLifetime, 0, 1, "fake-pool", null, false);
        // master create password
        ...
        BlockTokenIdentifier slaveId = new BlockTokenIdentifier();
        slaveId.readFields(new DataInputStream(new ByteArrayInputStream(masterId.getBytes())));
        assertArrayEquals(password, sm.retrievePassword(slaveId));
    }
    ...
    public void testLastLocatedBlockTokenExpiry() throws IOException, InterruptedException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
        try (MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(1).build()) {
            cluster.waitClusterUp();
            final NameNodeInterface nn = cluster.getNameNode();
            final BlockManagerInterface bm = nn.getNamesystem().getBlockManager();
            final BlockTokenSecretManagerInterface sm = bm.getBlockTokenSecretManager();
            ...
            assertTrue("Should not wait for refetch complete located blocks", 1000L > (System.currentTimeMillis() - startTime));
        }
    }
}
