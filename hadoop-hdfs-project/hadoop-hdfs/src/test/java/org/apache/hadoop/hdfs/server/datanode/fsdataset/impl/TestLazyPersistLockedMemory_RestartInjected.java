 ...
 * memory
 */
public class TestLazyPersistLockedMemory_RestartInjected extends LazyPersistTestCase {
  ...
  public void testReleaseOnEviction() throws Exception {
    ...
    RestartFramework.at("before_eviction")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testWritePipelineFailure()
    ...
    fos.hsync();
    RestartFramework.at("after_write_hsync")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
