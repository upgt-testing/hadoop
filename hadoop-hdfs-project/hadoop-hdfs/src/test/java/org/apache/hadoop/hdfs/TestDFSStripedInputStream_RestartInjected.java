...
public class TestDFSStripedInputStream_RestartInjected {
  ...
  public static final Logger LOG =
      LoggerFactory.getLogger(TestDFSStripedInputStream_RestartInjected.class);
  ...
  public void testPread() throws Exception {
    ...
    DFSTestUtil.createStripedFile(cluster, filePath, null, numBlocks,
        stripesPerBlock, false, ecPolicy);
    RestartFramework.at("after_file_creation_pread")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPreadWithDNFailure() throws Exception {
    ...
    DFSTestUtil.createStripedFile(cluster, filePath, null, numBlocks,
        stripesPerBlock, false, ecPolicy);
    RestartFramework.at("after_file_creation_with_dn_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void testStatefulRead(boolean useByteBuffer,
    ...
    DFSTestUtil.createStripedFile(cluster, filePath, null, numBlocks,
        stripesPerBlock, false, ecPolicy);
    RestartFramework.at("after_stateful_file_creation")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStatefulReadWithDNFailure() throws Exception {
    ...
    DFSTestUtil.createStripedFile(cluster, filePath, null, numBlocks,
        stripesPerBlock, false, ecPolicy);
    RestartFramework.at("after_file_creation_stateful_dn_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testIdempotentClose() throws Exception {
    ...
    DFSTestUtil.createStripedFile(cluster, filePath, null, numBlocks,
        stripesPerBlock, false, ecPolicy);
    RestartFramework.at("after_file_creation_idempotent_close")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadFailToGetCurrentBlock() throws Exception {
    ...
    RestartFramework.at("after_file_write_get_current_block")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCloseDoesNotAllocateNewBuffer() throws Exception {
    ...
    DFSTestUtil.createStripedFile(cluster, filePath, null, numBlocks,
        stripesPerBlock, false, ecPolicy);
    RestartFramework.at("after_file_creation_buffer_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadWhenLastIncompleteCellComeInToDecodeAlignedStripe()
    ...
    try {
      ...
      RestartFramework.at("after_incomplete_cell_file_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testBlockReader() throws Exception {
    ...
    RestartFramework.at("after_file_write_block_reader")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
