 ...
 * storage policy.
 */
public class TestStoragePolicySatisfierWithStripedFile_RestartInjected {

  private static final Logger LOG = LoggerFactory
      .getLogger(TestStoragePolicySatisfierWithStripedFile_RestartInjected.class);
  ...
  public void testMoverWithFullStripe() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_new_datanodes_added")
          .on(cluster)
          .restart("datanode")
          .withIndex(11)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_set_cold_policy")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_satisfy_storage_policy")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testSPSWhenFileHasLowRedundancyBlocks() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_satisfy_storage_policy_partial_cluster")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_all_datanodes_restarted")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
