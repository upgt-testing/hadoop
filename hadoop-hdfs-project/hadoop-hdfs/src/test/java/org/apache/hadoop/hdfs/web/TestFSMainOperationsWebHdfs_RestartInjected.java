...
public class TestFSMainOperationsWebHdfs_RestartInjected extends FSMainOperationsBaseTest {
  {
  ...
  public TestFSMainOperationsWebHdfs_RestartInjected() {
  ...
  public void testConcat() throws Exception {
    ...
    RestartFramework.at("after_source_files_created")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
