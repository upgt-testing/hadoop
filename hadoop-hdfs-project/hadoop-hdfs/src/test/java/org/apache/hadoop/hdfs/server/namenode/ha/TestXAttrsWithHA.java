...
public class TestXAttrsWithHA {
    ...
    @Test(timeout = 60000)
    public void testXAttrsTrackedOnStandby_withUpgrade20() throws Exception {
        fs.create(path).close();
        fs.setXAttr(path, name1, value1, EnumSet.of(XAttrSetFlag.CREATE));
        fs.setXAttr(path, name2, value2, EnumSet.of(XAttrSetFlag.CREATE));
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
    ...
    @Test(timeout = 60000)
    public void testXAttrsTrackedOnStandby_withUpgrade40() throws Exception {
        fs.create(path).close();
        fs.setXAttr(path, name1, value1, EnumSet.of(XAttrSetFlag.CREATE));
        fs.setXAttr(path, name2, value2, EnumSet.of(XAttrSetFlag.CREATE));
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
    ...
    @Test(timeout = 60000)
    public void testXAttrsTrackedOnStandby_withUpgrade60() throws Exception {
        fs.create(path).close();
        fs.setXAttr(path, name1, value1, EnumSet.of(XAttrSetFlag.CREATE));
        fs.setXAttr(path, name2, value2, EnumSet.of(XAttrSetFlag.CREATE));
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
    ...
    @Test(timeout = 60000)
    public void testXAttrsTrackedOnStandby_withUpgrade80() throws Exception {
        fs.create(path).close();
        fs.setXAttr(path, name1, value1, EnumSet.of(XAttrSetFlag.CREATE));
        fs.setXAttr(path, name2, value2, EnumSet.of(XAttrSetFlag.CREATE));
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
