...
public class TestNameNodeRpcServer_RestartInjected_Randomized_456 {
    ...
    public void testNamenodeRpcClientIpProxy() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_caller_context_set").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
