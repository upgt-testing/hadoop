...
public class TestRefreshCallQueue_RestartInjected_Randomized_123 {
    ...
    public void testRefreshCallQueueWithFairCallQueue() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_fair_queue_refresh").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        } catch (Exception e) {
