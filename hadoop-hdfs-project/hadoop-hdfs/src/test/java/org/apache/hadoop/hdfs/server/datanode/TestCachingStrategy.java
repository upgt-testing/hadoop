...
public class TestCachingStrategy {
    ...
    public void testFadviseAfterWriteThenRead() throws Exception {
        ...
        try {
            ...
            ExtendedBlockJVMInterface block = cluster.getNameNode().getRpcServer().getBlockLocations(TEST_PATH, 0, Long.MAX_VALUE).get(0).getBlock();
    ...
    @Test(timeout = 120000)
    public void testFadviseAfterWriteThenRead_withUpgrade20() throws Exception {
        // start a cluster
        LOG.info("testFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseAfterWriteThenRead_withUpgrade40() throws Exception {
        // start a cluster
        LOG.info("testFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseAfterWriteThenRead_withUpgrade60() throws Exception {
        // start a cluster
        LOG.info("testFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseAfterWriteThenRead_withUpgrade80() throws Exception {
        // start a cluster
        LOG.info("testFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testClientDefaults_withUpgrade20() throws Exception {
        // start a cluster
        LOG.info("testClientDefaults");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testClientDefaults_withUpgrade40() throws Exception {
        // start a cluster
        LOG.info("testClientDefaults");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testClientDefaults_withUpgrade60() throws Exception {
        // start a cluster
        LOG.info("testClientDefaults");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testClientDefaults_withUpgrade80() throws Exception {
        // start a cluster
        LOG.info("testClientDefaults");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseSkippedForSmallReads_withUpgrade20() throws Exception {
        // start a cluster
        LOG.info("testFadviseSkippedForSmallReads");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseSkippedForSmallReads_withUpgrade40() throws Exception {
        // start a cluster
        LOG.info("testFadviseSkippedForSmallReads");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseSkippedForSmallReads_withUpgrade60() throws Exception {
        // start a cluster
        LOG.info("testFadviseSkippedForSmallReads");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testFadviseSkippedForSmallReads_withUpgrade80() throws Exception {
        // start a cluster
        LOG.info("testFadviseSkippedForSmallReads");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testNoFadviseAfterWriteThenRead_withUpgrade20() throws Exception {
        // start a cluster
        LOG.info("testNoFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testNoFadviseAfterWriteThenRead_withUpgrade40() throws Exception {
        // start a cluster
        LOG.info("testNoFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testNoFadviseAfterWriteThenRead_withUpgrade60() throws Exception {
        // start a cluster
        LOG.info("testNoFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testNoFadviseAfterWriteThenRead_withUpgrade80() throws Exception {
        // start a cluster
        LOG.info("testNoFadviseAfterWriteThenRead");
        tracker.clear();
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 120000)
    public void testSeekAfterSetDropBehind_withUpgrade20() throws Exception {
        // start a cluster
        LOG.info("testSeekAfterSetDropBehind");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testSeekAfterSetDropBehind_withUpgrade40() throws Exception {
        // start a cluster
        LOG.info("testSeekAfterSetDropBehind");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testSeekAfterSetDropBehind_withUpgrade60() throws Exception {
        // start a cluster
        LOG.info("testSeekAfterSetDropBehind");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testSeekAfterSetDropBehind_withUpgrade80() throws Exception {
        // start a cluster
        LOG.info("testSeekAfterSetDropBehind");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
