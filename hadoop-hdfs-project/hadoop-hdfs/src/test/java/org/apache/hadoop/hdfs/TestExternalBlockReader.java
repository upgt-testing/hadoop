...
public class TestExternalBlockReader {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TestExternalBlockReader.class);
    ...
    private static final HashMap<String, LinkedList<SyntheticReplicaAccessor>> accessors = new HashMap<String, LinkedList<SyntheticReplicaAccessor>>(1);
    ...
    public void testExternalBlockReader() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).hosts(new String[] { NetUtils.getLocalHostname() }).build();
    ...
    @Test
    public void testMisconfiguredExternalBlockReader_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, "org.apache.hadoop.hdfs.NonExistentReplicaAccessorBuilderClass");
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testMisconfiguredExternalBlockReader_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, "org.apache.hadoop.hdfs.NonExistentReplicaAccessorBuilderClass");
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testMisconfiguredExternalBlockReader_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, "org.apache.hadoop.hdfs.NonExistentReplicaAccessorBuilderClass");
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testMisconfiguredExternalBlockReader_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, "org.apache.hadoop.hdfs.NonExistentReplicaAccessorBuilderClass");
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testExternalBlockReader_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, SyntheticReplicaAccessorBuilder.class.getName());
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testExternalBlockReader_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, SyntheticReplicaAccessorBuilder.class.getName());
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testExternalBlockReader_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, SyntheticReplicaAccessorBuilder.class.getName());
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
    ...
    @Test
    public void testExternalBlockReader_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.set(HdfsClientConfigKeys.REPLICA_ACCESSOR_BUILDER_CLASSES_KEY, SyntheticReplicaAccessorBuilder.class.getName());
        conf.setLong(HdfsClientConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 0);
