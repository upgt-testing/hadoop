 ...
 */
public class TestBalancerWithNodeGroup_RestartInjected_Randomized_456 {
    ...
    public void testBPPNodeGroup() throws Exception {
        ...
        MiniDFSCluster.Builder builder = new MiniDFSCluster.Builder(conf).numDataNodes(capacities.length).racks(racks).simulatedCapacities(capacities);
        MiniDFSClusterWithNodeGroup.setNodeGroups(nodeGroups);
        LambdaTestUtils.intercept(IllegalArgumentException.class, "Configured cluster topology should be " + "org.apache.hadoop.net.NetworkTopologyWithNodeGroup", () -> new MiniDFSClusterWithNodeGroup(builder));
    }
}
