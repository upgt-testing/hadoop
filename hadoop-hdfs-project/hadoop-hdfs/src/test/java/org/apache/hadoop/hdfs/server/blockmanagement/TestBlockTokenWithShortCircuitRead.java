...
public class TestBlockTokenWithShortCircuitRead {
    ...
    public void testShortCircuitReadWithInvalidToken() throws Exception {
        ...
        conf.set(DFS_DOMAIN_SOCKET_PATH_KEY, new File(sockDir.getDir(), "testShortCircuitReadWithInvalidToken").getAbsolutePath());
        ...
        try {
            ...
            try (FSDataInputStream in = fs.open(fileToRead)) {
                ...
                List<LocatedBlockJVMInterface> locatedBlocks = (List<LocatedBlockJVMInterface>) nnProto.getBlockLocations(FILE_TO_SHORT_CIRCUIT_READ, 0, FILE_SIZE).getLocatedBlocks();
                // first block
                LocatedBlockJVMInterface lblock = locatedBlocks.get(0);
                /*
    ...
    @Test
    public void testShortCircuitReadWithInvalidToken_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        short numDataNodes = 1;
        Configuration conf = new Configuration();
        conf.setBoolean(DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
    ...
    @Test
    public void testShortCircuitReadWithInvalidToken_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        short numDataNodes = 1;
        Configuration conf = new Configuration();
        conf.setBoolean(DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
    ...
    @Test
    public void testShortCircuitReadWithInvalidToken_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        short numDataNodes = 1;
        Configuration conf = new Configuration();
        conf.setBoolean(DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
    ...
    @Test
    public void testShortCircuitReadWithInvalidToken_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        short numDataNodes = 1;
        Configuration conf = new Configuration();
        conf.setBoolean(DFS_BLOCK_ACCESS_TOKEN_ENABLE_KEY, true);
