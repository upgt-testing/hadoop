 ...
 */
public class TestSetrepIncreasing_ProcessBased {
  static void setrep(int fromREP, int toREP, boolean simulatedStorage) throws Exception {
    ...
    ProcessBasedMiniDFSCluster cluster = new ProcessBasedMiniDFSCluster.Builder(conf).numDataNodes(10).build();
  ...
  public void testSetRepWithStoragePolicyOnEmptyFile() throws Exception {
    ...
    ProcessBasedMiniDFSCluster cluster =
        new ProcessBasedMiniDFSCluster.Builder(conf).numDataNodes(1).build();
    cluster.waitClusterUp();
  ...
  public void testSetRepOnECFile() throws Exception {
    ...
    Configuration conf = new HdfsConfiguration();
    ProcessBasedMiniDFSCluster cluster = new ProcessBasedMiniDFSCluster.Builder(conf).numDataNodes(1)
        .build();
    cluster.waitClusterUp();
