...
public class TestWebHdfsFileSystemContract_RestartInjected extends FileSystemContractBaseTest {
  ...
  public void testRootDir() throws IOException {
    ...
    RestartFramework.at("after_get_status")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeCreateMissingParameter() throws IOException {
    ...
    final Path testDir = new Path(MessageFormat.format("/test/{0}/{1}",
        TestWebHdfsFileSystemContract_RestartInjected.class,
