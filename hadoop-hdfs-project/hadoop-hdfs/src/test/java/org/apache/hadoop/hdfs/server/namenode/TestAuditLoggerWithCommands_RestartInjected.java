...
public class TestAuditLoggerWithCommands_RestartInjected {
  ...
  public void testGetContentSummary() throws IOException {
    ...
    RestartFramework.at("after_directory_setup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetQuota() throws Exception {
    ...
    fs.mkdirs(path);
    RestartFramework.at("after_mkdirs")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRenameSnapShot() throws Exception {
    ...
    RestartFramework.at("after_allowsnapshot")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_createsnapshot")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDisallowSnapshot() throws Exception {
    ...
    cluster.getNamesystem().allowSnapshot(srcDir.toString());
    RestartFramework.at("after_reallow_snapshot")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAddCacheDirective() throws Exception {
    ...
    RestartFramework.at("after_addcachepool")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testModifyCacheDirective() throws Exception {
    ...
    RestartFramework.at("after_addcachedirective")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetSnapshotDiffReport() throws Exception {
    ...
    RestartFramework.at("after_createsnapshots")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAddCachePool() throws Exception {
    removeExistingCachePools(null);
    RestartFramework.at("after_remove_cachepools")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListXattrs() throws Exception {
    ...
    RestartFramework.at("after_setowner")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDelegationTokens() throws Exception {
    ...
    RestartFramework.at("after_getdelegationtoken")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMetaSave() throws Exception {
    ...
    RestartFramework.at("after_metasave")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStartReconfiguration() throws Exception {
    ...
    RestartFramework.at("after_startreconfiguration")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetReconfigurationStatus() throws Exception {
    ...
    RestartFramework.at("after_getreconfigurationstatus")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListReconfigurableProperties() throws Exception {
    ...
    RestartFramework.at("after_listreconfigurableproperties")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshUserToGroupsMappings() throws Exception {
    ...
    verifyAuditLogs(auditLogString);
    RestartFramework.at("after_refreshusertogroupsmappings")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshSuperUserGroupsConfiguration() throws Exception {
    ...
    RestartFramework.at("after_refreshsuperusergroupsconfig")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshQueue() throws Exception {
    ...
    RestartFramework.at("after_refreshcallqueue")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshServiceAcl() throws Exception {
    ...
    RestartFramework.at("after_refreshserviceacl")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFinalizeRollingUpgrade() throws Exception {
    ...
    RestartFramework.at("after_setrollingupgradeinfo")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollEditLog() throws Exception {
    ...
    verifyAuditLogs(auditLogString);
    RestartFramework.at("after_rolleditlog")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetBalancerBandwidth() throws Exception {
    ...
    RestartFramework.at("after_setbalancerbandwidth")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshNodes() throws Exception {
    ...
    RestartFramework.at("after_refreshnodes")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFinalizeUpgrade() throws Exception {
    ...
    RestartFramework.at("after_finalizeupgrade")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeReport() throws Exception {
    ...
    RestartFramework.at("after_datanodereport")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRestoreFailedStorage() throws Exception {
    ...
    when(call.getRemoteUser()).thenReturn(
        UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
    Server.getCurCall().set(call);
    RestartFramework.at("before_restorefailedstorage")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetDatanodeStorageReport() throws Exception {
    ...
    verifyAuditLogs(auditLogString);
    RestartFramework.at("after_getdatanodestoragereport")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteRoot() throws Exception {
    ...
    fileSys = DFSTestUtil.getFileSystemAs(user1, conf);
    RestartFramework.at("before_delete_root")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
