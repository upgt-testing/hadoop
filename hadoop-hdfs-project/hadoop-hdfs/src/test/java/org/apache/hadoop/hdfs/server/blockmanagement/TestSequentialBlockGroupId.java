...
public class TestSequentialBlockGroupId {
    ...
    public void testTriggerBlockGroupIdCollisionWithLegacyBlockId() throws Exception {
        ...
        SequentialBlockIdGeneratorJVMInterface blockIdGenerator = spy(fsn.getBlockManager().getBlockIdManager().getBlockIdGenerator());
    ...
    @Test(timeout = 60000)
    public void testBlockGroupIdGeneration_withUpgrade20() throws IOException {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        // Create a file that is 4 blocks long.
        Path path = new Path(ecDir, "testBlockGrpIdGeneration.dat");
        DFSTestUtil.createFile(fs, path, cellSize, fileLen, blockSize, REPLICATION, SEED);
    ...
    @Test(timeout = 60000)
    public void testBlockGroupIdGeneration_withUpgrade40() throws IOException {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        // Create a file that is 4 blocks long.
        Path path = new Path(ecDir, "testBlockGrpIdGeneration.dat");
        DFSTestUtil.createFile(fs, path, cellSize, fileLen, blockSize, REPLICATION, SEED);
    ...
    @Test(timeout = 60000)
    public void testBlockGroupIdGeneration_withUpgrade60() throws IOException {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        // Create a file that is 4 blocks long.
        Path path = new Path(ecDir, "testBlockGrpIdGeneration.dat");
        DFSTestUtil.createFile(fs, path, cellSize, fileLen, blockSize, REPLICATION, SEED);
    ...
    @Test(timeout = 60000)
    public void testBlockGroupIdGeneration_withUpgrade80() throws IOException {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        // Create a file that is 4 blocks long.
        Path path = new Path(ecDir, "testBlockGrpIdGeneration.dat");
        DFSTestUtil.createFile(fs, path, cellSize, fileLen, blockSize, REPLICATION, SEED);
    ...
    @Test(timeout = 60000)
    public void testTriggerBlockGroupIdCollisionWithLegacyBlockId_withUpgrade20() throws Exception {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        blockGrpIdGenerator.skipTo((blockGrpIdGenerator.getCurrentValue() & ~BLOCK_GROUP_INDEX_MASK) + MAX_BLOCKS_IN_GROUP);
        final long curBlockGroupIdValue = blockGrpIdGenerator.getCurrentValue();
        // collision during blockGroup Id generation
    ...
    @Test(timeout = 60000)
    public void testTriggerBlockGroupIdCollisionWithLegacyBlockId_withUpgrade40() throws Exception {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        blockGrpIdGenerator.skipTo((blockGrpIdGenerator.getCurrentValue() & ~BLOCK_GROUP_INDEX_MASK) + MAX_BLOCKS_IN_GROUP);
        final long curBlockGroupIdValue = blockGrpIdGenerator.getCurrentValue();
        // collision during blockGroup Id generation
    ...
    @Test(timeout = 60000)
    public void testTriggerBlockGroupIdCollisionWithLegacyBlockId_withUpgrade60() throws Exception {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        blockGrpIdGenerator.skipTo((blockGrpIdGenerator.getCurrentValue() & ~BLOCK_GROUP_INDEX_MASK) + MAX_BLOCKS_IN_GROUP);
        final long curBlockGroupIdValue = blockGrpIdGenerator.getCurrentValue();
        // collision during blockGroup Id generation
    ...
    @Test(timeout = 60000)
    public void testTriggerBlockGroupIdCollisionWithLegacyBlockId_withUpgrade80() throws Exception {
        long blockGroupIdInitialValue = blockGrpIdGenerator.getCurrentValue();
        blockGrpIdGenerator.skipTo((blockGrpIdGenerator.getCurrentValue() & ~BLOCK_GROUP_INDEX_MASK) + MAX_BLOCKS_IN_GROUP);
        final long curBlockGroupIdValue = blockGrpIdGenerator.getCurrentValue();
        // collision during blockGroup Id generation
