...
import static org.apache.hadoop.hdfs.server.namenode.FileJournalManager.getLogFile;
...
public class TestJournalNodeSync {
    ...
    public void testJournalNodeSync() throws Exception {
        ...
        assertThat(jCluster.getJournalNode(0).getRpcServer().getRpcServer().getRpcMetrics().getTotalRequests()).isGreaterThan(20);
