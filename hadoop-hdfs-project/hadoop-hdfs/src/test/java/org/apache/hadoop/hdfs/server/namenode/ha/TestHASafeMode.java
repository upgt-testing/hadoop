...
public class TestHASafeMode {
    ...
    @Test(timeout = 300000)
    public void testClientRetrySafeMode_withUpgrade20() throws Exception {
        final Map<Path, Boolean> results = Collections.synchronizedMap(new HashMap<Path, Boolean>());
        final Path test = new Path("/test");
        // let nn0 enter safemode
        cluster.getConfiguration(0).setInt(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_MIN_DATANODES_KEY, 3);
    ...
    @Test(timeout = 300000)
    public void testClientRetrySafeMode_withUpgrade40() throws Exception {
        final Map<Path, Boolean> results = Collections.synchronizedMap(new HashMap<Path, Boolean>());
        final Path test = new Path("/test");
        // let nn0 enter safemode
        cluster.getConfiguration(0).setInt(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_MIN_DATANODES_KEY, 3);
    ...
    @Test(timeout = 300000)
    public void testClientRetrySafeMode_withUpgrade60() throws Exception {
        final Map<Path, Boolean> results = Collections.synchronizedMap(new HashMap<Path, Boolean>());
        final Path test = new Path("/test");
        // let nn0 enter safemode
        cluster.getConfiguration(0).setInt(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_MIN_DATANODES_KEY, 3);
    ...
    @Test(timeout = 60000)
    public void testSafeModeExitAfterTransition_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
