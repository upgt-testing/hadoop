...
public class TestHASafeMode {
    ...
    public void setupCluster() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(3).waitSafeMode(false).build();
        cluster.waitActive();
   ...
   */
    ...
    private static void assertSafeMode(NameNodeJVMInterface nn, int safe, int total, int numNodes, int nodeThresh) {
    ...
    public void testBlocksRemovedWhileInSafeModeEditsArriveFirst() throws Exception {
        ...
        assertTrue("Bad safemode status: '" + status + "'", status.startsWith("Safe mode is ON. The reported blocks 10 has reached the threshold " + "0.9990 of total blocks 10. The minimum number of live datanodes is " + "not required. In safe mode extension. Safe mode will be turned off " + "automatically"));
        // Delete those blocks while the SBN is in safe mode.
    ...
    public void testTransitionToActiveWhenSafeMode() throws Exception {
        ...
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(config, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build()) {
            miniCluster.waitActive();
            miniCluster.transitionToStandby(0);
            miniCluster.transitionToStandby(1);
            NameNodeJVMInterface namenode0 = miniCluster.getNameNode(0);
            NameNodeJVMInterface namenode1 = miniCluster.getNameNode(1);
            NameNodeAdapter.enterSafeMode(namenode0, false);
            NameNodeAdapter.enterSafeMode(namenode1, false);
            LambdaTestUtils.intercept(ServiceFailedException.class, "NameNode still not leave safemode", () -> miniCluster.transitionToActive(0));
        }
    }

    @Test
    public void testBlocksRemovedBeforeStandbyRestart_withUpgrade20() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedBeforeStandbyRestart_withUpgrade40() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedBeforeStandbyRestart_withUpgrade60() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedBeforeStandbyRestart_withUpgrade80() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeMode_withUpgrade20() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeMode_withUpgrade40() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeMode_withUpgrade60() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeMode_withUpgrade80() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testAppendWhileInSafeMode_withUpgrade20() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        // instead of just adding a new one
        DFSTestUtil.createFile(fs, new Path("/test"), 4 * BLOCK_SIZE + BLOCK_SIZE / 2, (short) 3, 1L);
        // the namespace during startup.
    ...
    @Test
    public void testAppendWhileInSafeMode_withUpgrade40() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        // instead of just adding a new one
        DFSTestUtil.createFile(fs, new Path("/test"), 4 * BLOCK_SIZE + BLOCK_SIZE / 2, (short) 3, 1L);
        // the namespace during startup.
    ...
    @Test
    public void testAppendWhileInSafeMode_withUpgrade60() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        // instead of just adding a new one
        DFSTestUtil.createFile(fs, new Path("/test"), 4 * BLOCK_SIZE + BLOCK_SIZE / 2, (short) 3, 1L);
        // the namespace during startup.
    ...
    @Test
    public void testAppendWhileInSafeMode_withUpgrade80() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        // instead of just adding a new one
        DFSTestUtil.createFile(fs, new Path("/test"), 4 * BLOCK_SIZE + BLOCK_SIZE / 2, (short) 3, 1L);
        // the namespace during startup.
    ...
    @Test
    public void testComplexFailoverIntoSafemode_withUpgrade20() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup and enter safemode.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testComplexFailoverIntoSafemode_withUpgrade40() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup and enter safemode.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testComplexFailoverIntoSafemode_withUpgrade60() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup and enter safemode.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testComplexFailoverIntoSafemode_withUpgrade80() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup and enter safemode.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeModeEditsArriveFirst_withUpgrade20() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeModeEditsArriveFirst_withUpgrade40() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeModeEditsArriveFirst_withUpgrade60() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksRemovedWhileInSafeModeEditsArriveFirst_withUpgrade80() throws Exception {
        banner("Starting with NN0 active and NN1 standby, creating some blocks");
        DFSTestUtil.createFile(fs, new Path("/test"), 10 * BLOCK_SIZE, (short) 3, 1L);
        // the namespace during startup.
        nn0.getRpcServer().rollEditLog();
    ...
    @Test
    public void testBlocksAddedWhileStandbyIsDown_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testBlocksAddedWhileStandbyIsDown_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
    ...
    @Test
    public void testBlocksAddedWhileStandbyIsDown_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
    ...
    @Test
    public void testBlocksAddedWhileStandbyIsDown_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 3 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenExitingSafemode_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
        // get some blocks in the SBN's image
        nn1.getRpcServer().setSafeMode(SafeModeAction.SAFEMODE_ENTER, false);
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenExitingSafemode_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
        // get some blocks in the SBN's image
        nn1.getRpcServer().setSafeMode(SafeModeAction.SAFEMODE_ENTER, false);
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenExitingSafemode_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
        // get some blocks in the SBN's image
        nn1.getRpcServer().setSafeMode(SafeModeAction.SAFEMODE_ENTER, false);
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenExitingSafemode_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        HATestUtil.waitForStandbyToCatchUp(nn0, nn1);
        // get some blocks in the SBN's image
        nn1.getRpcServer().setSafeMode(SafeModeAction.SAFEMODE_ENTER, false);
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenStartingActiveInSafeMode_withUpgrade20() throws IOException {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        // and the NN won't leave safe mode.
        cluster.stopDataNode(1);
        // one DN is deliberately shut down.)
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenStartingActiveInSafeMode_withUpgrade40() throws IOException {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        // and the NN won't leave safe mode.
        cluster.stopDataNode(1);
        // one DN is deliberately shut down.)
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenStartingActiveInSafeMode_withUpgrade60() throws IOException {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        // and the NN won't leave safe mode.
        cluster.stopDataNode(1);
        // one DN is deliberately shut down.)
    ...
    @Test
    public void testNoPopulatingReplQueuesWhenStartingActiveInSafeMode_withUpgrade80() throws IOException {
        DFSTestUtil.createFile(fs, new Path("/test"), 15 * BLOCK_SIZE, (short) 3, 1L);
        // and the NN won't leave safe mode.
        cluster.stopDataNode(1);
        // one DN is deliberately shut down.)
    ...
    @Test
    public void testIsInSafemode_withUpgrade20() throws Exception {
        // Check for the standby nn without client failover.
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        assertTrue("nn2 should be in standby state", nn2.isStandbyState());
        InetSocketAddress nameNodeAddress = nn2.getNameNodeAddress();
    ...
    @Test
    public void testIsInSafemode_withUpgrade40() throws Exception {
        // Check for the standby nn without client failover.
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        assertTrue("nn2 should be in standby state", nn2.isStandbyState());
        InetSocketAddress nameNodeAddress = nn2.getNameNodeAddress();
    ...
    @Test
    public void testIsInSafemode_withUpgrade80() throws Exception {
        // Check for the standby nn without client failover.
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        assertTrue("nn2 should be in standby state", nn2.isStandbyState());
        InetSocketAddress nameNodeAddress = nn2.getNameNodeAddress();
    ...
    @Test(timeout = 100000)
    public void testOpenFileWhenNNAndClientCrashAfterAddBlock_withUpgrade20() throws Exception {
        cluster.getConfiguration(0).set(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, "1.0f");
        String testData = "testData";
        // to make sure we write the full block before creating dummy block at NN.
        cluster.getConfiguration(0).setInt("io.bytes.per.checksum", testData.length());
    ...
    @Test(timeout = 100000)
    public void testOpenFileWhenNNAndClientCrashAfterAddBlock_withUpgrade40() throws Exception {
        cluster.getConfiguration(0).set(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, "1.0f");
        String testData = "testData";
        // to make sure we write the full block before creating dummy block at NN.
        cluster.getConfiguration(0).setInt("io.bytes.per.checksum", testData.length());
    ...
    @Test(timeout = 100000)
    public void testOpenFileWhenNNAndClientCrashAfterAddBlock_withUpgrade60() throws Exception {
        cluster.getConfiguration(0).set(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, "1.0f");
        String testData = "testData";
        // to make sure we write the full block before creating dummy block at NN.
        cluster.getConfiguration(0).setInt("io.bytes.per.checksum", testData.length());
    ...
    @Test(timeout = 100000)
    public void testOpenFileWhenNNAndClientCrashAfterAddBlock_withUpgrade80() throws Exception {
        cluster.getConfiguration(0).set(DFSConfigKeys.DFS_NAMENODE_SAFEMODE_THRESHOLD_PCT_KEY, "1.0f");
        String testData = "testData";
        // to make sure we write the full block before creating dummy block at NN.
        cluster.getConfiguration(0).setInt("io.bytes.per.checksum", testData.length());
    ...
    @Test(timeout = 60000)
    public void testSafeModeExitAfterTransition_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
    ...
    @Test(timeout = 60000)
    public void testSafeModeExitAfterTransition_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
    ...
    @Test(timeout = 60000)
    public void testSafeModeExitAfterTransition_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(fs, new Path("/test"), 5 * BLOCK_SIZE, (short) 3, 1L);
        banner("Stopping standby");
        cluster.shutdownNameNode(1);
        DFSTestUtil.createFile(fs, new Path("/test2"), 3 * BLOCK_SIZE, (short) 3, 1L);
    ...
    @Test
    public void testTransitionToActiveWhenSafeMode_withUpgrade20() throws Exception {
        Configuration config = new Configuration();
        config.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(config, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build()) {
            miniCluster.waitActive();
            miniCluster.transitionToStandby(0);
            miniCluster.restartNodeForTesting(0);
            miniCluster.upgradeNodeForTesting(0);
            miniCluster.transitionToStandby(1);
            NameNodeJVMInterface namenode0 = miniCluster.getNameNode(0);
            NameNodeJVMInterface namenode1 = miniCluster.getNameNode(1);
            NameNodeAdapter.enterSafeMode(namenode0, false);
    ...
    @Test
    public void testTransitionToActiveWhenSafeMode_withUpgrade40() throws Exception {
        Configuration config = new Configuration();
        config.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(config, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build()) {
            miniCluster.waitActive();
    ...
    @Test
    public void testTransitionToActiveWhenSafeMode_withUpgrade60() throws Exception {
        Configuration config = new Configuration();
        config.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(config, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build()) {
            miniCluster.waitActive();
    ...
    @Test
    public void testTransitionToActiveWhenSafeMode_withUpgrade80() throws Exception {
        Configuration config = new Configuration();
        config.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(config, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build()) {
            miniCluster.waitActive();
