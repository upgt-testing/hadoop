 ...
 */
public class TestXAttrConfigFlag_RestartInjected_Randomized_123 {
    ...
    public void testEditLog() throws Exception {
        RestartFramework.at("after_restart_with_xattrs_disabled").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testFsImage() throws Exception {
        ...
        fs.mkdirs(PATH);
        RestartFramework.at("after_mkdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_restart_with_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fs.setXAttr(PATH, "user.foo", null);
