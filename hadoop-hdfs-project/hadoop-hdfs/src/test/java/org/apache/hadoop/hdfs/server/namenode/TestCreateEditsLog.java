...
public class TestCreateEditsLog {
    ...
    private static final File HDFS_DIR = new File(MiniDockerDFSCluster.getBaseDirectory()).getAbsoluteFile();
    ...
    public void testCanLoadCreatedEditsLog() throws Exception {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).format(false).manageNameDfsDirs(false).waitSafeMode(false).build();
