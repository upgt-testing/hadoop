...
public class TestTransferFsImage {
    ...
    @Test
    public void testClientSideException_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPath = Collections.singletonList(new File("/xxxxx-does-not-exist/blah"));
    ...
    @Test
    public void testClientSideException_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPath = Collections.singletonList(new File("/xxxxx-does-not-exist/blah"));
    ...
    @Test
    public void testClientSideException_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPath = Collections.singletonList(new File("/xxxxx-does-not-exist/blah"));
    ...
    @Test
    public void testClientSideException_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPath = Collections.singletonList(new File("/xxxxx-does-not-exist/blah"));
    ...
    @Test
    public void testClientSideExceptionOnJustOneDir_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPaths = ImmutableList.of(new File("/xxxxx-does-not-exist/blah"), new File(TEST_DIR, "testfile"));
    ...
    @Test
    public void testClientSideExceptionOnJustOneDir_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPaths = ImmutableList.of(new File("/xxxxx-does-not-exist/blah"), new File(TEST_DIR, "testfile"));
    ...
    @Test
    public void testClientSideExceptionOnJustOneDir_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        NNStorage mockStorage = Mockito.mock(NNStorage.class);
        List<File> localPaths = ImmutableList.of(new File("/xxxxx-does-not-exist/blah"), new File(TEST_DIR, "testfile"));
