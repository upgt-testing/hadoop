...
public class TestConsistentReadsObserver_RestartInjected {
  public static final Logger LOG =
      LoggerFactory.getLogger(TestConsistentReadsObserver_RestartInjected.class.getName());
  ...
  public void testRequeueCall() throws Exception {
    ...
    RestartFramework.at("after_refresh_callqueue")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(observerIdx)
    ...
    RestartFramework.at("after_getfilestatus")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(observerIdx)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void testMsync(boolean autoMsync, long autoMsyncPeriodMs)
    ...
    RestartFramework.at("after_advance_state")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_roll_editlog_msync")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCallFromNewClient() throws Exception {
    ...
    RestartFramework.at("after_state_transitions")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_advance_observer_state")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_from_new_client")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_roll_editlog_new_client")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testUncoordinatedCall() throws Exception {
    ...
    RestartFramework.at("after_mkdir_uncoordinated")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRequestFromNonObserverProxyProvider() throws Exception {
    ...
    RestartFramework.at("after_get_filesystem_nonproxy")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_roll_editlog_nonproxy")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMsyncFileContext() throws Exception {
    ...
    RestartFramework.at("after_get_filecontext")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_msync_filecontext")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_roll_editlog_filecontext")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRpcQueueTimeNumOpsMetrics() throws Exception {
    ...
    RestartFramework.at("after_mkdir_metrics")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_roll_editlog_metrics")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
