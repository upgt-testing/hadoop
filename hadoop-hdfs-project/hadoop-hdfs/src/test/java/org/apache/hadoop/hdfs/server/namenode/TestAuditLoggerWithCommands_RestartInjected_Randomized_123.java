...
public class TestAuditLoggerWithCommands_RestartInjected_Randomized_123 {
    ...
    public void testGetContentSummary() throws IOException {
        ...
        RestartFramework.at("after_directory_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetQuota() throws Exception {
        ...
        fileSys = DFSTestUtil.getFileSystemAs(user1, conf);
        verifySetQuota(path, HdfsConstants.QUOTA_RESET, HdfsConstants.QUOTA_DONT_SET);
        verifySetQuota(path, HdfsConstants.QUOTA_DONT_SET, HdfsConstants.QUOTA_RESET);
        verifySetQuota(path, HdfsConstants.QUOTA_DONT_SET, HdfsConstants.BYTES_IN_INTEGER);
        verifySetQuota(path, HdfsConstants.BYTES_IN_INTEGER, HdfsConstants.BYTES_IN_INTEGER);
        fileSys.close();
    }
    ...
    public void testCreateRenameSnapShot() throws Exception {
        RestartFramework.at("after_allowsnapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            ...
            RestartFramework.at("after_createsnapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDisallowSnapshot() throws Exception {
        ...
        cluster.getNamesystem().allowSnapshot(srcDir.toString());
        RestartFramework.at("after_allowsnapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_reallow_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fileSys = DFSTestUtil.getFileSystemAs(user1, conf);
        try {
    ...
    public void testAddCacheDirective() throws Exception {
        ...
        RestartFramework.at("after_addcachepool").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertTrue("Unexpected log!", length == auditlog.getOutput().split("\n").length);
    }
    ...
    public void testModifyCacheDirective() throws Exception {
        ...
        RestartFramework.at("after_addcachedirective").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fileSys.close();
        try {
            ((DistributedFileSystem) fileSys).modifyCacheDirective(new CacheDirectiveInfo.Builder().setId(id).setReplication((short) 1).build());
            fail("The operation should have failed with IOException");
    ...
    public void testGetSnapshotDiffReport() throws Exception {
        ...
        RestartFramework.at("after_createsnapshots").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertTrue("Unexpected log!", length == auditlog.getOutput().split("\n").length);
    }
    ...
    public void testAddCachePool() throws Exception {
        RestartFramework.at("after_remove_cachepools").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        removeExistingCachePools(null);
    ...
    public void testListXattrs() throws Exception {
        ...
        RestartFramework.at("after_setowner").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDelegationTokens() throws Exception {
        ...
        RestartFramework.at("after_getdelegationtoken").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testMetaSave() throws Exception {
        ...
        RestartFramework.at("after_metasave").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testStartReconfiguration() throws Exception {
        ...
        RestartFramework.at("after_startreconfiguration").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            ((NameNodeRpcServer) cluster.getNameNodeRpc()).startReconfiguration();
            fail("startNameNodeReconfiguration should throw AccessControlException!");
        } catch (AccessControlException ace) {
    ...
    public void testGetReconfigurationStatus() throws Exception {
        ...
        RestartFramework.at("after_getreconfigurationstatus").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser("theDoctor"));
        try {
            ((NameNodeRpcServer) cluster.getNameNodeRpc()).getReconfigurationStatus();
    ...
    public void testListReconfigurableProperties() throws Exception {
        ...
        FSNamesystem fsNamesystem = spy(cluster.getNamesystem());
        RestartFramework.at("after_listreconfigurableproperties").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
        try {
            ...
            fail("listReconfigurableProperties " + " threw Exception!");
        }
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser("theDoctor"));
        try {
            ((NameNodeRpcServer) cluster.getNameNodeRpc()).listReconfigurableProperties();
    ...
    public void testRefreshUserToGroupsMappings() throws Exception {
        ...
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        RestartFramework.at("after_refreshusertogroupsmappings").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
    ...
    public void testRefreshSuperUserGroupsConfiguration() throws Exception {
        RestartFramework.at("after_refreshsuperusergroupsconfig").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRefreshQueue() throws Exception {
        RestartFramework.at("after_refreshcallqueue").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRefreshServiceAcl() throws Exception {
        ...
        FSNamesystem fsNamesystem = spy(cluster.getNamesystem());
        RestartFramework.at("after_refreshserviceacl").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
    ...
    public void testFinalizeRollingUpgrade() throws Exception {
        ...
        FSNamesystem fsNamesystem = spy(cluster.getNamesystem());
        RestartFramework.at("after_setrollingupgradeinfo").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
    ...
    public void testRollEditLog() throws Exception {
        ...
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        RestartFramework.at("after_rolleditlog").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Server.getCurCall().set(call);
        try {
    ...
    public void testSetSafeMode() throws Exception {
        RestartFramework.at("after_safemode_enter").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        FSNamesystem fsNamesystem = spy(cluster.getNamesystem());
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
    ...
    public void testSetBalancerBandwidth() throws Exception {
        ...
        FSNamesystem fsNamesystem = spy(cluster.getNamesystem());
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        RestartFramework.at("after_setbalancerbandwidth").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
        try {
        ...
        try {
            fsNamesystem.setBalancerBandwidth(10);
            fail("setBalancerBandwidth should have thrown AccessControlException!");
        } catch (AccessControlException ace) {
    ...
    public void testRefreshNodes() throws Exception {
        ...
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        RestartFramework.at("after_refreshnodes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
        try {
    ...
    public void testFinalizeUpgrade() throws Exception {
        ...
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        RestartFramework.at("after_finalizeupgrade").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Server.getCurCall().set(call);
        try {
    ...
    public void testDatanodeReport() throws Exception {
        ...
        RestartFramework.at("after_datanodereport").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser("theDoctor"));
        try {
            fsNamesystem.datanodeReport(HdfsConstants.DatanodeReportType.ALL);
    ...
    public void testRestoreFailedStorage() throws Exception {
        FSNamesystem fsNamesystem = spy(cluster.getNamesystem());
        RestartFramework.at("before_restorefailedstorage").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
    ...
    public void testGetDatanodeStorageReport() throws Exception {
        ...
        when(fsNamesystem.isExternalInvocation()).thenReturn(true);
        Server.Call call = spy(new Server.Call(1, 1, null, null, RPC.RpcKind.RPC_BUILTIN, new byte[] { 1, 2, 3 }));
        RestartFramework.at("after_getdatanodestoragereport").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        when(call.getRemoteUser()).thenReturn(UserGroupInformation.createRemoteUser(System.getProperty("user.name")));
        Server.getCurCall().set(call);
    ...
    public void testDeleteRoot() throws Exception {
        ...
        fileSys.close();
        assertFalse(result);
        RestartFramework.at("before_delete_root").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    private void verifyAuditRestoreFailedStorageACE(FSNamesystem fsNamesystem, String arg) throws IOException {
        ...
        try {
            ...
            fail("RestoreFailedStorage should have thrown AccessControlException!");
        } catch (IOException ace) {
            assertEquals("Unexpected Exception!", ace.getClass(), AccessControlException.class);
    ...
    private void verifySafeModeAction(FSNamesystem fsNamesystem, HdfsConstants.SafeModeAction safeModeAction) throws IOException {
        ...
        try {
            ...
            auditLogString = ".*allowed=false.*cmd=" + operationName + ".*";
            verifyAuditLogs(auditLogString);
        }
    }
    ...
    private void removeExistingCachePools(String prevPool) throws Exception {
        BatchedRemoteIterator.BatchedEntries<CachePoolEntry> entries = proto.listCachePools(prevPool);
