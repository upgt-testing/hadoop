...
public class TestDelegationTokenForProxyUser {
    ...
    final private static String[] GROUP_NAMES = new String[] { GROUP1_NAME, GROUP2_NAME };
    ...
    @Test(timeout = 20000)
    public void testDelegationTokenWithRealUser_withUpgrade20() throws IOException {
        try {
            Token<?>[] tokens = proxyUgi.doAs(new PrivilegedExceptionAction<Token<?>[]>() {
    ...
    @Test(timeout = 20000)
    public void testDelegationTokenWithRealUser_withUpgrade40() throws IOException {
        try {
            Token<?>[] tokens = proxyUgi.doAs(new PrivilegedExceptionAction<Token<?>[]>() {
    ...
    @Test(timeout = 20000)
    public void testDelegationTokenWithRealUser_withUpgrade60() throws IOException {
        try {
            Token<?>[] tokens = proxyUgi.doAs(new PrivilegedExceptionAction<Token<?>[]>() {
    ...
    @Test(timeout = 20000)
    public void testDelegationTokenWithRealUser_withUpgrade80() throws IOException {
        try {
            Token<?>[] tokens = proxyUgi.doAs(new PrivilegedExceptionAction<Token<?>[]>() {
    ...
    @Test(timeout = 5000)
    public void testWebHdfsDoAs_withUpgrade20() throws Exception {
        WebHdfsTestUtil.LOG.info("START: testWebHdfsDoAs()");
        WebHdfsTestUtil.LOG.info("ugi.getShortUserName()=" + ugi.getShortUserName());
        final WebHdfsFileSystem webhdfs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, config, WebHdfsConstants.WEBHDFS_SCHEME);
        final Path root = new Path("/");
    ...
    @Test(timeout = 5000)
    public void testWebHdfsDoAs_withUpgrade40() throws Exception {
        WebHdfsTestUtil.LOG.info("START: testWebHdfsDoAs()");
        WebHdfsTestUtil.LOG.info("ugi.getShortUserName()=" + ugi.getShortUserName());
        final WebHdfsFileSystem webhdfs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, config, WebHdfsConstants.WEBHDFS_SCHEME);
        final Path root = new Path("/");
    ...
    @Test(timeout = 5000)
    public void testWebHdfsDoAs_withUpgrade60() throws Exception {
        WebHdfsTestUtil.LOG.info("START: testWebHdfsDoAs()");
        WebHdfsTestUtil.LOG.info("ugi.getShortUserName()=" + ugi.getShortUserName());
        final WebHdfsFileSystem webhdfs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, config, WebHdfsConstants.WEBHDFS_SCHEME);
        final Path root = new Path("/");
    ...
    @Test(timeout = 5000)
    public void testWebHdfsDoAs_withUpgrade80() throws Exception {
        WebHdfsTestUtil.LOG.info("START: testWebHdfsDoAs()");
        WebHdfsTestUtil.LOG.info("ugi.getShortUserName()=" + ugi.getShortUserName());
        final WebHdfsFileSystem webhdfs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, config, WebHdfsConstants.WEBHDFS_SCHEME);
        final Path root = new Path("/");
