...
public class TestBlockReportRateLimiting {
    ...
    public void testRateLimitingDuringDataNodeStartup() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATANODES).build();
        cluster.waitActive();
    ...
    public void testLeaseExpiration() throws Exception {
        ...
        final AtomicReference<MiniDFSClusterInJVM> cluster = new AtomicReference<>();
    ...
    @Test(timeout = 180000)
    public void testRateLimitingDuringDataNodeStartup_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFS_NAMENODE_MAX_FULL_BLOCK_REPORT_LEASES, 1);
        conf.setLong(DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS, 20L * 60L * 1000L);
        final Semaphore fbrSem = new Semaphore(0);
    ...
    @Test(timeout = 180000)
    public void testRateLimitingDuringDataNodeStartup_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFS_NAMENODE_MAX_FULL_BLOCK_REPORT_LEASES, 1);
        conf.setLong(DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS, 20L * 60L * 1000L);
        final Semaphore fbrSem = new Semaphore(0);
    ...
    @Test(timeout = 180000)
    public void testRateLimitingDuringDataNodeStartup_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFS_NAMENODE_MAX_FULL_BLOCK_REPORT_LEASES, 1);
        conf.setLong(DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS, 20L * 60L * 1000L);
        final Semaphore fbrSem = new Semaphore(0);
    ...
    @Test(timeout = 180000)
    public void testRateLimitingDuringDataNodeStartup_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFS_NAMENODE_MAX_FULL_BLOCK_REPORT_LEASES, 1);
        conf.setLong(DFS_NAMENODE_FULL_BLOCK_REPORT_LEASE_LENGTH_MS, 20L * 60L * 1000L);
        final Semaphore fbrSem = new Semaphore(0);
