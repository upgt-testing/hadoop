...
public class TestReadWhileWriting {
    ...
    @Test
    public void pipeline_02_03_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
        // create cluster
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
    ...
    @Test
    public void pipeline_02_03_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
        // create cluster
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
    ...
    @Test
    public void pipeline_02_03_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
        // create cluster
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
