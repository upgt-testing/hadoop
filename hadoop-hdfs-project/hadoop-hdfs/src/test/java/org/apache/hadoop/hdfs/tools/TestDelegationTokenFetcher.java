...
public class TestDelegationTokenFetcher {
    ...
    @Test
    public void testDelegationTokenWithoutRenewerViaRPC_withUpgrade20() throws Exception {
        conf.setBoolean(DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testDelegationTokenWithoutRenewerViaRPC_withUpgrade40() throws Exception {
        conf.setBoolean(DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testDelegationTokenWithoutRenewerViaRPC_withUpgrade60() throws Exception {
        conf.setBoolean(DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testDelegationTokenWithoutRenewerViaRPC_withUpgrade80() throws Exception {
        conf.setBoolean(DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
            cluster.waitActive();
