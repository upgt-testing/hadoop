...
public class TestStateAlignmentContextWithHA_RestartInjected {
  public static final Logger LOG =
      LoggerFactory.getLogger(TestStateAlignmentContextWithHA_RestartInjected.class.getName());
  ...
  public void testStateTransferOnWrite() throws Exception {
    ...
    RestartFramework.at("after_state_check")
        .on(cluster)
        .restart("namenode")
        .withIndex(active)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiClientStatesWithRandomFailovers() throws Exception {
    ...
    RestartFramework.at("after_first_run")
        .on(cluster)
        .restart("namenode")
        .withIndex(active)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_run")
        .on(cluster)
        .restart("namenode")
        .withIndex(active)
        .withMode(RestartMode.GRACEFUL)
