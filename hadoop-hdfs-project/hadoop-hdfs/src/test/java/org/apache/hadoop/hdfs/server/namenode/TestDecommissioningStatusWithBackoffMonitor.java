...
public class TestDecommissioningStatusWithBackoffMonitor extends TestDecommissioningStatus {
    ...
    public void testDecommissionStatus() throws Exception {
        ...
        DFSTestUtil.createFile(distFileSys, file1, fileSize, fileSize, blockSize, replicas, seed);
        Path file2 = new Path("decommission1.dat");
        FSDataOutputStream st1 = AdminStatesBaseTest.writeIncompleteFile(distFileSys, file2, replicas, (short) (fileSize / blockSize));
        ...
        for (int iteration = 0; iteration < numDatanodes; iteration++) {
            ...
            if (iteration == 0) {
                ...
                checkDFSAdminDecommissionStatus(decommissioningNodes.subList(0, 2), distFileSys, admin);
            }
        }
