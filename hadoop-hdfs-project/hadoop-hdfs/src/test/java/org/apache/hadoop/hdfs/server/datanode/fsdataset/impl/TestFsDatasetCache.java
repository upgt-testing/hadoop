...
public class TestFsDatasetCache {
    ...
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(TestFsDatasetCache.class);
    ...
    private static NameNodeInterface nn;

    private static FSImageInterface fsImage;

    private static DataNodeInterface dn;
