...
public class TestViewDistributedFileSystem extends TestDistributedFileSystem {
    ...
    @Test
    public void testOpenWithPathHandle_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testOpenWithPathHandle_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testOpenWithPathHandle_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testOpenWithPathHandle_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testRenameWithOptions_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test
    public void testRenameWithOptions_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test
    public void testRenameWithOptions_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test
    public void testRenameWithOptions_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
