 ...
 */
public class TestDataNodeInitStorage_RestartInjected_Randomized_456 {

    public static final Logger LOG = LoggerFactory.getLogger(TestDataNodeInitStorage_RestartInjected.class);
