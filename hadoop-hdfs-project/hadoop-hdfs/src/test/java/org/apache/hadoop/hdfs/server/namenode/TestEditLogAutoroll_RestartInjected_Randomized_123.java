...
public class TestEditLogAutoroll_RestartInjected_Randomized_123 {
    ...
    public TestEditLogAutoroll_RestartInjected_Randomized_123(Boolean async) {
    ...
    public void testEditLogAutoroll() throws Exception {
        ...
        RestartFramework.at("after_autoroll").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
