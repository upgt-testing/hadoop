...
public class TestBlockReaderLocalLegacy_RestartInjected {
  ...
  public void testStablePositionAfterCorruptRead() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_corrupt_read")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_file_creation_corrupt_read")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testBothOldAndNewShortCircuitConfigured() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_old_new_config")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_old_new_config")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testBlockReaderLocalLegacyWithAppend() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_append")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_append")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
