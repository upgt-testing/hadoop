...
public class TestMultiThreadedHflush {
   ...
   */
    ...
    private void doTestMultipleHflushers(int repl) throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(repl).build();
    ...
    @Test
    public void testHflushWhileClosing_withUpgrade20() throws Throwable {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/hflush-and-close.dat");
    ...
    @Test
    public void testHflushWhileClosing_withUpgrade40() throws Throwable {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/hflush-and-close.dat");
    ...
    @Test
    public void testHflushWhileClosing_withUpgrade80() throws Throwable {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/hflush-and-close.dat");
