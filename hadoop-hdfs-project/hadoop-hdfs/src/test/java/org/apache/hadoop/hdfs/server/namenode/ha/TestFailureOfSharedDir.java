...
public class TestFailureOfSharedDir {
    ...
    @Test
    public void testFailureOfSharedDir_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFS_NAMENODE_RESOURCE_CHECK_INTERVAL_KEY, 2000);
        // The shared edits dir will automatically be marked required.
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testFailureOfSharedDir_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFS_NAMENODE_RESOURCE_CHECK_INTERVAL_KEY, 2000);
        // The shared edits dir will automatically be marked required.
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testFailureOfSharedDir_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFS_NAMENODE_RESOURCE_CHECK_INTERVAL_KEY, 2000);
        // The shared edits dir will automatically be marked required.
        MiniDFSClusterInJVM cluster = null;
