...
public class TestNameNodePrunesMissingStorages_RestartInjected_Randomized_123 {

    static final Logger LOG = LoggerFactory.getLogger(TestNameNodePrunesMissingStorages_RestartInjected.class);
