...
public class TestDatanodeHttpXFrame {
    ...
    private static MiniDockerDFSCluster createCluster(boolean enabled, String value) throws IOException {
        ...
        MiniDockerDFSCluster dfsCluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(1).build();
        dfsCluster.waitActive();
        return dfsCluster;
    }

    private static HttpURLConnection getConn(MiniDockerDFSCluster dfsCluster) throws IOException {
        DataNodeInterface datanode = dfsCluster.getDataNodes().get(0);
