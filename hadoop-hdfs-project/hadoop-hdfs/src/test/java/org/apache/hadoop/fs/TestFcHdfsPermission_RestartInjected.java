...
public class TestFcHdfsPermission_RestartInjected extends FileContextPermissionBase {
  ...
  private static final FileContextTestHelper fileContextTestHelper =
      new FileContextTestHelper("/tmp/TestFcHdfsPermission_RestartInjected");
  ...
  public void testCreatePermission() throws IOException {
    RestartFramework.at("before_create_permission")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_create_permission")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetPermission() throws IOException {
    RestartFramework.at("before_set_permission")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_set_permission")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSetOwner() throws IOException {
    RestartFramework.at("before_set_owner")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testUgi() throws IOException, InterruptedException {
    RestartFramework.at("before_ugi_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    super.testUgi();
    RestartFramework.at("after_ugi_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
