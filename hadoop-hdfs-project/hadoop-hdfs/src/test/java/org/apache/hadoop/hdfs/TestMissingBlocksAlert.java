...
public class TestMissingBlocksAlert {
    ...
    public void testMissReplicatedBlockwithTwoRack() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).hosts(hosts).racks(racks).build();
    ...
    @Test
    public void testMissReplicatedBlockwithTwoRack_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        //Start cluster with rack /default/rack1
        String[] hosts = new String[] { "host0", "host1", "host2", "host3" };
        String[] racks = new String[] { "/default/rack1", "/default/rack1", "/default/rack1", "/default/rack1" };
    ...
    @Test
    public void testMissReplicatedBlockwithTwoRack_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        //Start cluster with rack /default/rack1
        String[] hosts = new String[] { "host0", "host1", "host2", "host3" };
        String[] racks = new String[] { "/default/rack1", "/default/rack1", "/default/rack1", "/default/rack1" };
    ...
    @Test
    public void testMissReplicatedBlockwithTwoRack_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        //Start cluster with rack /default/rack1
        String[] hosts = new String[] { "host0", "host1", "host2", "host3" };
        String[] racks = new String[] { "/default/rack1", "/default/rack1", "/default/rack1", "/default/rack1" };
    ...
    @Test
    public void testMissReplicatedBlockwithTwoRack_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        //Start cluster with rack /default/rack1
        String[] hosts = new String[] { "host0", "host1", "host2", "host3" };
        String[] racks = new String[] { "/default/rack1", "/default/rack1", "/default/rack1", "/default/rack1" };
