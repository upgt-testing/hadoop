...
public class TestDataNodeExit {
    ...
    public void setUp() throws IOException {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(3)).build();
        for (int i = 0; i < 3; i++) {
    ...
    public void testSendOOBToPeers() throws Exception {
        DataNodeInterface dn = cluster.getDataNodes().get(0);
        DataXceiverServerInterface spyXserver = Mockito.spy(dn.getXferServer());
