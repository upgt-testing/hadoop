...
public class TestQuotaAllowOwner {
    ...
    public void testOwnerCanSetSubDirQuota() throws Exception {
        ...
        TestQuota.runCommand(admin, args, false);
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting(userName, new String[] { groupName });
        ugi.doAs((PrivilegedExceptionAction<Object>) () -> {
            ...
            assertEquals("Not same with setting space quota", 64, c.getSpaceQuota());
            ...
            assertEquals("Not clean space quota", -1, c.getSpaceQuota());
            return null;
        });
    }
    ...
    public void testOwnerCanSetSubDirQuotaWithoutAdminDone() throws Exception {
        ...
        final String subDir = parentDir + "/subdir";
        createDirssAndSetOwner(parentDir, subDir, userName, groupName);
        UserGroupInformation ugi2 = UserGroupInformation.createUserForTesting(userName, new String[] { groupName });
    ...
    public void testOtherCanNotSetSubDirQuota() throws Exception {
        ...
        final String subDir = parentDir + "/subdir";
        createDirssAndSetOwner(parentDir, subDir, userName, groupName);
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting(userOther, new String[] { groupOther });
        ugi.doAs((PrivilegedExceptionAction<Object>) () -> {
            assertEquals("Not running as new user", userOther, UserGroupInformation.getCurrentUser().getShortUserName());
            DFSAdmin userAdmin = new DFSAdmin(conf);
    ...
    public void testOtherInSameGroupCanNotSetSubDirQuota() throws Exception {
        ...
        final String subDir = parentDir + "/subdir";
        createDirssAndSetOwner(parentDir, subDir, userName, groupName);
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting(userOther, new String[] { groupName });
        ugi.doAs((PrivilegedExceptionAction<Object>) () -> {
            assertEquals("Not running as new user", userOther, UserGroupInformation.getCurrentUser().getShortUserName());
            DFSAdmin userAdmin = new DFSAdmin(conf);
            String[] args2 = new String[] { "-setQuota", "5", subDir.toString() };
    ...
    @Test
    public void testOwnerCanSetSubDirQuota_withUpgrade20() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuota_withUpgrade40() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuota_withUpgrade60() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuota_withUpgrade80() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuotaWithoutAdminDone_withUpgrade20() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuotaWithoutAdminDone_withUpgrade40() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuotaWithoutAdminDone_withUpgrade60() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanSetSubDirQuotaWithoutAdminDone_withUpgrade80() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOtherCanNotSetSubDirQuota_withUpgrade20() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String groupOther = "otherGroup";
    ...
    @Test
    public void testOtherCanNotSetSubDirQuota_withUpgrade40() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String groupOther = "otherGroup";
    ...
    @Test
    public void testOtherCanNotSetSubDirQuota_withUpgrade60() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String groupOther = "otherGroup";
    ...
    @Test
    public void testOtherCanNotSetSubDirQuota_withUpgrade80() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String groupOther = "otherGroup";
    ...
    @Test
    public void testOtherInSameGroupCanNotSetSubDirQuota_withUpgrade20() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String parentDir = "/parent_other_user_in_same_group";
    ...
    @Test
    public void testOtherInSameGroupCanNotSetSubDirQuota_withUpgrade40() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String parentDir = "/parent_other_user_in_same_group";
    ...
    @Test
    public void testOtherInSameGroupCanNotSetSubDirQuota_withUpgrade60() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String parentDir = "/parent_other_user_in_same_group";
    ...
    @Test
    public void testOtherInSameGroupCanNotSetSubDirQuota_withUpgrade80() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String userOther = "otherUser";
        final String parentDir = "/parent_other_user_in_same_group";
    ...
    @Test
    public void testOwnerCanNotSetIfNotEanbled_withUpgrade20() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanNotSetIfNotEanbled_withUpgrade40() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
    ...
    @Test
    public void testOwnerCanNotSetIfNotEanbled_withUpgrade60() throws Exception {
        final String userName = "user1";
        final String groupName = "hadoop";
        final String parentDir = "/parent_owner_without_Admin";
        final String subDir = parentDir + "/subdir";
