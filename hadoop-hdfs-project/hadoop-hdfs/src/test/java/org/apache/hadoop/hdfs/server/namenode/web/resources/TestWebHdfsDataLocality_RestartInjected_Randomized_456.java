 ...
 */
public class TestWebHdfsDataLocality_RestartInjected_Randomized_456 {

    static final Logger LOG = LoggerFactory.getLogger(TestWebHdfsDataLocality_RestartInjected.class);
