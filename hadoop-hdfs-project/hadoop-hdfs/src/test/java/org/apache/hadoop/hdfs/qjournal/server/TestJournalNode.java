...
public class TestJournalNode {
    ...
    public void setup() throws Exception {
        File editsDir = new File(MiniDockerDFSCluster.getBaseDirectory() + File.separator + "TestJournalNode");
    ...
    public void testJournalDirPerNameSpace() {
        ...
        for (String nsId : nameServiceIds) {
            ...
            File editsDir = new File(MiniDockerDFSCluster.getBaseDirectory() + File.separator + "TestJournalNode" + File.separator + nsId + File.separator + jid);
    ...
    public void testJournalCommonDirAcrossNameSpace() {
        ...
        for (String nsId : nameServiceIds) {
            ...
            Journal nsJournal = jn.getJournal(jid);
            JNStorage journalStorage = nsJournal.getStorage();
            File editsDir = new File(MiniDockerDFSCluster.getBaseDirectory() + File.separator + "TestJournalNode" + File.separator + jid);
            assertEquals(editsDir.toString(), journalStorage.getRoot().toString());
        }
    }
    ...
    public void testJournalDefaultDirForOneNameSpace() {
        ...
        Journal nsJournal = jn.getJournal(jid);
        JNStorage journalStorage = nsJournal.getStorage();
        File editsDir = new File(MiniDockerDFSCluster.getBaseDirectory() + File.separator + "TestJournalNode" + File.separator + "ns1" + File.separator + jid);
        assertEquals(editsDir.toString(), journalStorage.getRoot().toString());
