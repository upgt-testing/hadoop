...
public class TestCheckpoint_RestartInjected {
  ...
  public void testSecondaryNamenodeError3() throws IOException {
    ...
    try {
      ...
      secondary = startSecondaryNameNode(conf);
      secondary.doCheckpoint();
      RestartFramework.at("after_final_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testImportCheckpoint() throws Exception {
    ...
    try {
      cluster = new MiniDFSCluster.Builder(conf).format(false).numDataNodes(0)
          .startupOption(StartupOption.IMPORT).build();
      RestartFramework.at("after_import_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckpoint() throws IOException {
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file1, fileSize, fileSize, blockSize,
          replication, seed);
      RestartFramework.at("after_file1_create")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_delete_loop")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file2, fileSize, fileSize, blockSize,
          replication, seed);
      RestartFramework.at("after_file2_create")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      fileSys.mkdirs(tmpDir);
      secondary.doCheckpoint();
      RestartFramework.at("after_third_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    cluster.waitActive();
    RestartFramework.at("after_final_cluster_restart")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSaveNamespace() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_symlink_create")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckpointAfterTwoFailedUploads() throws IOException {
    ...
    try {
      ...
      secondary.doCheckpoint();
      RestartFramework.at("after_successful_checkpoint")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testEditFailureBeforeRename() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_first_file_create")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteTemporaryEditsOnStartup() throws IOException {
    ...
    try {
      ...
      secondary.shutdown();
      secondary = startSecondaryNameNode(conf);
      RestartFramework.at("after_secondary_restart")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleSecondaryNNsAgainstSameNN() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_secondary_start")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReformatNNBetweenCheckpoints() throws IOException {
    ...
    try {
      ...
      cluster = new MiniDFSCluster.Builder(conf)
          ...
          .format(true).build();
      RestartFramework.at("after_second_cluster_start")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testSecondaryPurgesEditLogs() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_checkpoints")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testLegacyOivImage() throws Exception {
    ...
    try {
      ...
      secondary.doCheckpoint();
      secondary.doCheckpoint();
      RestartFramework.at("after_more_checkpoints")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testActiveRejectSmallerTxidDeltaImage() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_first_mkdirs")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
