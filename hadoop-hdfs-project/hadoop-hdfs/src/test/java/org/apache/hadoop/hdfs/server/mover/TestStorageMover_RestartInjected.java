...
public class TestStorageMover_RestartInjected {
  ...
  public void testMigrateFileToArchival() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_namespace_prepare")
          .on(test.cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_migration")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMoveSpecificPaths() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_mover_run")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testMigrateOpenFileToArchival() throws Exception {
    ...
    RestartFramework.at("after_append_hsync")
        .on(test.cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      ((DFSOutputStream) out.getWrappedStream()).hsync();
      RestartFramework.at("after_continue_write_hsync")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testHotWarmColdDirs() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_set_storage_policy")
          ...
          .execute();
      test.migrate(ExitStatus.SUCCESS);
      RestartFramework.at("after_initial_migration")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_move_around")
          .on(test.cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
          .execute();
      test.migrate(ExitStatus.SUCCESS);
      RestartFramework.at("after_second_migration")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNoSpaceDisk() throws Exception {
    ...
    try {
      ...
      test.verify(true);
      test.setStoragePolicy();
      RestartFramework.at("after_initial_setup")
          .on(test.cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_hot_files_creation")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_disk_full")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_increase_replication")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_cold_file_replication")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNoSpaceArchive() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_cold_files_creation")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_archive_full")
          .on(test.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      { // test increasing replication but new replicas cannot be created
        ...
        RestartFramework.at("after_replication_attempt")
            .on(test.cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
      ...
      { // test creating a hot file
        ...
        RestartFramework.at("after_hot_file_creation")
            .on(test.cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
