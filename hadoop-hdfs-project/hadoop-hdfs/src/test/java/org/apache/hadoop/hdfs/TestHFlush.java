...
public class TestHFlush {
    ...
    public void hSyncEndBlock_01() throws IOException {
        doTheJob(new HdfsConfiguration(), fName, AppendTestUtil.BLOCK_SIZE, (short) 2, true, EnumSet.of(SyncFlag.END_BLOCK));
    }
    ...
    public void hSyncEndBlockAndUpdateLength() throws IOException {
        doTheJob(new HdfsConfiguration(), fName, AppendTestUtil.BLOCK_SIZE, (short) 2, true, EnumSet.of(SyncFlag.END_BLOCK, SyncFlag.UPDATE_LENGTH));
    }
    ...
    public static void doTheJob(Configuration conf, final String fileName, long block_size, short replicas, boolean isSync, EnumSet<SyncFlag> syncFlags) throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replicas).build();
    ...
    static void checkData(final byte[] actual, int from, int len, final byte[] expected, String message) {
        for (int idx = 0; idx < len; idx++) {
            assertEquals(message + " byte " + (from + idx) + " differs. expected " + expected[from + idx] + " actual " + actual[idx], expected[from + idx], actual[idx]);
            actual[idx] = 0;
        }
    }
    ...
    @Test
    public void hSyncUpdateLength_00_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fileSystem = cluster.getFileSystem();
        try {
    ...
    @Test
    public void hSyncUpdateLength_00_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fileSystem = cluster.getFileSystem();
        try {
    ...
    @Test
    public void hSyncUpdateLength_00_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fileSystem = cluster.getFileSystem();
        try {
    ...
    @Test
    public void hSyncUpdateLength_00_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fileSystem = cluster.getFileSystem();
        try {
    ...
    @Test
    public void hSyncEndBlock_00_withUpgrade20() throws IOException {
        final int preferredBlockSize = 1024;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, preferredBlockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void hSyncEndBlock_00_withUpgrade40() throws IOException {
        final int preferredBlockSize = 1024;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, preferredBlockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void hSyncEndBlock_00_withUpgrade60() throws IOException {
        final int preferredBlockSize = 1024;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, preferredBlockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void hSyncEndBlock_00_withUpgrade80() throws IOException {
        final int preferredBlockSize = 1024;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, preferredBlockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testPipelineHeartbeat_withUpgrade20() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        Configuration conf = new HdfsConfiguration();
        final int timeout = 2000;
    ...
    @Test
    public void testPipelineHeartbeat_withUpgrade40() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        Configuration conf = new HdfsConfiguration();
        final int timeout = 2000;
    ...
    @Test
    public void testPipelineHeartbeat_withUpgrade60() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        Configuration conf = new HdfsConfiguration();
        final int timeout = 2000;
    ...
    @Test
    public void testPipelineHeartbeat_withUpgrade80() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        Configuration conf = new HdfsConfiguration();
        final int timeout = 2000;
    ...
    @Test
    public void testHFlushInterrupted_withUpgrade20() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        byte[] fileContents = AppendTestUtil.initBuffer(fileLen);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testHFlushInterrupted_withUpgrade40() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        byte[] fileContents = AppendTestUtil.initBuffer(fileLen);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testHFlushInterrupted_withUpgrade60() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        byte[] fileContents = AppendTestUtil.initBuffer(fileLen);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testHFlushInterrupted_withUpgrade80() throws Exception {
        final int DATANODE_NUM = 2;
        final int fileLen = 6;
        byte[] fileContents = AppendTestUtil.initBuffer(fileLen);
        Configuration conf = new HdfsConfiguration();
