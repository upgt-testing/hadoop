...
public class TestSnapshotNameWithInvalidCharacters {
    ...
    @Test(timeout = 600000)
    public void TestSnapshotWithInvalidName_withUpgrade20() throws Exception {
        Path file1 = new Path(dir1, file1Name);
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, SEED);
        hdfs.allowSnapshot(dir1);
    ...
    @Test(timeout = 600000)
    public void TestSnapshotWithInvalidName_withUpgrade40() throws Exception {
        Path file1 = new Path(dir1, file1Name);
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, SEED);
        hdfs.allowSnapshot(dir1);
        try {
    ...
    @Test(timeout = 60000)
    public void TestSnapshotWithInvalidName1_withUpgrade20() throws Exception {
        Path file1 = new Path(dir1, file1Name);
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, SEED);
        hdfs.allowSnapshot(dir1);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 60000)
    public void TestSnapshotWithInvalidName1_withUpgrade40() throws Exception {
        Path file1 = new Path(dir1, file1Name);
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, SEED);
        hdfs.allowSnapshot(dir1);
        try {
