...
public class TestBlockReaderFactory {
    ...
    public void testFallbackFromShortCircuitToUnixDomainTraffic() throws Exception {
        ...
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(serverConf).numDataNodes(1).build();
        cluster.waitActive();
    ...
    private void testShortCircuitCacheUnbufferWithDisableInterval(final long interval, final boolean disabled) throws Exception {
        ...
        try (TemporarySocketDirectory sockDir = new TemporarySocketDirectory()) {
            ...
            MiniDockerDFSCluster.Builder builder = new MiniDockerDFSCluster.Builder(serverConf).numDataNodes(1);
            try (MiniDockerDFSCluster cluster = builder.build();
    ...
    public void testShortCircuitReadFromServerWithoutShm() throws Exception {
        ...
        DFSInputStream.tcpReadsDisabledForTesting = true;
        final MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(serverConf).numDataNodes(1).build();
        cluster.waitActive();
    ...
    public void testPurgingClosedReplicas() throws Exception {
        ...
        // first block
        final LocatedBlockInterface lblock = locatedBlocks.get(0);
