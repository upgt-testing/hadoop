...
public class TestBlockInfoStriped {
    ...
    public void testGetBlockInfo() throws IllegalArgumentException, Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(totalSize).build()) {
    ...
    @Test
    public void testGetBlockInfo_withUpgrade20() throws IllegalArgumentException, Exception {
        int dataBlocks = testECPolicy.getNumDataUnits();
        int parityBlocks = testECPolicy.getNumParityUnits();
        int totalSize = dataBlocks + parityBlocks;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testGetBlockInfo_withUpgrade40() throws IllegalArgumentException, Exception {
        int dataBlocks = testECPolicy.getNumDataUnits();
        int parityBlocks = testECPolicy.getNumParityUnits();
        int totalSize = dataBlocks + parityBlocks;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testGetBlockInfo_withUpgrade60() throws IllegalArgumentException, Exception {
        int dataBlocks = testECPolicy.getNumDataUnits();
        int parityBlocks = testECPolicy.getNumParityUnits();
        int totalSize = dataBlocks + parityBlocks;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testGetBlockInfo_withUpgrade80() throws IllegalArgumentException, Exception {
        int dataBlocks = testECPolicy.getNumDataUnits();
        int parityBlocks = testECPolicy.getNumParityUnits();
        int totalSize = dataBlocks + parityBlocks;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
