...
public class TestFetchImage {
    ...
    private NameNodeInterface nn0 = null;

    private NameNodeInterface nn1 = null;
     ...
     * correct.
     */
    private static void runFetchImage(DFSAdmin dfsAdmin, MiniDockerDFSCluster cluster) throws Exception {
     ...
     */
    private static File getHighestFsImageOnCluster(MiniDockerDFSCluster cluster) {
