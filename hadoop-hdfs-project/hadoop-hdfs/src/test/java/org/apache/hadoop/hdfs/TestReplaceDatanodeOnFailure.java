...
public class TestReplaceDatanodeOnFailure {
    ...
    public void testReplaceDatanodeOnFailure() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).racks(racks).numDataNodes(REPLICATION).build();
        try {
            cluster.waitActive();
            ...
            MiniDFSClusterInJVM.DataNodeProperties dnprop = cluster.stopDataNode(AppendTestUtil.nextInt(REPLICATION));
    ...
    @Test
    public void testReplaceDatanodeOnFailure_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // do not consider load factor when selecting a data node
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_REPLICATION_CONSIDERLOAD_KEY, false);
        //always replace a datanode
    ...
    @Test
    public void testReplaceDatanodeOnFailure_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // do not consider load factor when selecting a data node
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_REPLICATION_CONSIDERLOAD_KEY, false);
        //always replace a datanode
    ...
    @Test
    public void testReplaceDatanodeOnFailure_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // do not consider load factor when selecting a data node
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_REPLICATION_CONSIDERLOAD_KEY, false);
        //always replace a datanode
    ...
    @Test
    public void testReplaceDatanodeOnFailure_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        // do not consider load factor when selecting a data node
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_REPLICATION_CONSIDERLOAD_KEY, false);
        //always replace a datanode
    ...
    @Test
    public void testAppend_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final short REPLICATION = (short) 3;
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test
    public void testAppend_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final short REPLICATION = (short) 3;
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test
    public void testAppend_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final short REPLICATION = (short) 3;
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
    ...
    @Test
    public void testBestEffort_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        //always replace a datanode but do not throw exception
        ReplaceDatanodeOnFailure.write(Policy.ALWAYS, true, conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testBestEffort_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        //always replace a datanode but do not throw exception
        ReplaceDatanodeOnFailure.write(Policy.ALWAYS, true, conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testBestEffort_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        //always replace a datanode but do not throw exception
        ReplaceDatanodeOnFailure.write(Policy.ALWAYS, true, conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
