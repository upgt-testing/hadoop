...
public class TestHSync_RestartInjected {
  ...
  private void testHSyncOperation(boolean testWithAppend) throws IOException {
    ...
    RestartFramework.at("after_first_hsync")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testHSyncBlockBoundary() throws Exception {
    ...
    RestartFramework.at("after_block_write_hflush")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSequenceFileSync() throws Exception {
    ...
    RestartFramework.at("after_writer_creation")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testHSyncWithReplication() throws Exception {
    ...
    RestartFramework.at("after_write_hflush")
        .on(cluster)
        .restart("datanode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
