...
public class TestMultipleNNPortQOP extends SaslDataTransferTestCase {
    ...
    public void testAuxiliaryPortSendingQOP() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
            cluster.waitActive();
    ...
    @Test
    public void testAuxiliaryPortSendingQOP_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final String pathPrefix = "/filetestAuxiliaryPortSendingQOP";
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
    ...
    @Test
    public void testAuxiliaryPortSendingQOP_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final String pathPrefix = "/filetestAuxiliaryPortSendingQOP";
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
    ...
    @Test
    public void testAuxiliaryPortSendingQOP_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final String pathPrefix = "/filetestAuxiliaryPortSendingQOP";
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
    ...
    @Test
    public void testAuxiliaryPortSendingQOP_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final String pathPrefix = "/filetestAuxiliaryPortSendingQOP";
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
    ...
    @Test
    public void testMultipleNNPort_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
            cluster.waitActive();
    ...
    @Test
    public void testMultipleNNPort_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
            cluster.waitActive();
    ...
    @Test
    public void testMultipleNNPort_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
            cluster.waitActive();
    ...
    @Test
    public void testMultipleNNPort_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(3).build();
            cluster.waitActive();
    ...
    @Test
    public void testMultipleNNPortOverwriteDownStream_withUpgrade20() throws Exception {
        clusterConf.set(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_NEW_QOP_KEY, "auth");
        clusterConf.setBoolean(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_DERIVED_QOP_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testMultipleNNPortOverwriteDownStream_withUpgrade40() throws Exception {
        clusterConf.set(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_NEW_QOP_KEY, "auth");
        clusterConf.setBoolean(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_DERIVED_QOP_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testMultipleNNPortOverwriteDownStream_withUpgrade60() throws Exception {
        clusterConf.set(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_NEW_QOP_KEY, "auth");
        clusterConf.setBoolean(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_DERIVED_QOP_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testMultipleNNPortOverwriteDownStream_withUpgrade80() throws Exception {
        clusterConf.set(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_NEW_QOP_KEY, "auth");
        clusterConf.setBoolean(DFS_ENCRYPT_DATA_OVERWRITE_DOWNSTREAM_DERIVED_QOP_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        try {
