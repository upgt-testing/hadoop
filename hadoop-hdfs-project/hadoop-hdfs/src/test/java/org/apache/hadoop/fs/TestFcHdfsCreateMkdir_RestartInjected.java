...
public class TestFcHdfsCreateMkdir_RestartInjected extends
  ...
  public void testMkdirRecursiveWithExistingDir() throws IOException {
    ...
    RestartFramework.at("after_mkdir_existing")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirNonRecursiveWithExistingDir() throws IOException {
    ...
    RestartFramework.at("after_mkdir_nonrecursive_existing")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateRecursiveWithExistingDir() throws IOException {
    ...
    RestartFramework.at("after_create_existing_dir")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateNonRecursiveWithExistingDir() throws IOException {
    ...
    RestartFramework.at("after_create_nonrecursive_existing")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
