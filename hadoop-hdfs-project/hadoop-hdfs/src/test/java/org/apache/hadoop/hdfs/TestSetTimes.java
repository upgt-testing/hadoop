...
public class TestSetTimes {
    ...
    @Test
    public void testTimes_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testTimes_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testTimes_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testTimes_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testTimesAtClose_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        int replicas = 1;
    ...
    @Test
    public void testTimesAtClose_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        int replicas = 1;
    ...
    @Test
    public void testTimesAtClose_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        int replicas = 1;
    ...
    @Test
    public void testTimesAtClose_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        int replicas = 1;
    ...
    @Test(timeout = 60000)
    public void testGetBlockLocationsOnlyUsesReadLock_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 100 * 1000);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        ReentrantReadWriteLock spyLock = NameNodeAdapter.spyOnFsLock(cluster.getNamesystem());
    ...
    @Test(timeout = 60000)
    public void testGetBlockLocationsOnlyUsesReadLock_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 100 * 1000);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        ReentrantReadWriteLock spyLock = NameNodeAdapter.spyOnFsLock(cluster.getNamesystem());
    ...
    @Test(timeout = 60000)
    public void testGetBlockLocationsOnlyUsesReadLock_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 100 * 1000);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        ReentrantReadWriteLock spyLock = NameNodeAdapter.spyOnFsLock(cluster.getNamesystem());
    ...
    @Test
    public void testAtimeUpdate_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testAtimeUpdate_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testAtimeUpdate_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testAtimeUpdate_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, 0);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
