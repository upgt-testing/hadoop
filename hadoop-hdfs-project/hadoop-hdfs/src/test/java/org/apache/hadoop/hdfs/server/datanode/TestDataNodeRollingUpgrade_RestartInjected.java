...
public class TestDataNodeRollingUpgrade_RestartInjected {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestDataNodeRollingUpgrade_RestartInjected.class);
  ...
  public void testDatanodeRollingUpgradeWithFinalize() throws Exception {
    try {
      ...
      RestartFramework.at("after_rolling_upgrade_and_finalize")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeRUwithRegularUpgrade() throws Exception {
    try {
      ...
      cluster.waitActive();
      RestartFramework.at("after_regular_upgrade")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeRollingUpgradeWithRollback() throws Exception {
    try {
      ...
      startRollingUpgrade();
      RestartFramework.at("after_start_rolling_upgrade")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_rollback")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodePeersXceiver() throws Exception {
    try {
      ...
      RestartFramework.at("after_create_streams")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testWithLayoutChangeAndFinalize() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_delete_first_file")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      finalizeRollingUpgrade();
      RestartFramework.at("after_finalize")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
