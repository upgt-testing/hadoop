...
public class TestInterDatanodeProtocol_RestartInjected {
  private static final Logger LOG = LoggerFactory.getLogger(TestInterDatanodeProtocol_RestartInjected.class);
  ...
  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_NN_Graceful() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.NAMENODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_NN_Crash() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.NAMENODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_DN_Graceful() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.SINGLE_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_DN_Crash() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.SINGLE_DATANODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_AllDN_Graceful() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.ALL_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_AllDN_Crash() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.ALL_DATANODES, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_RandomDN_Graceful() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.RANDOM_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfo_AfterCreate_RandomDN_Crash() throws Exception {
    checkBlockMetaDataInfo_RestartInjected(false, RestartTarget.RANDOM_DATANODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_NN_Graceful() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.NAMENODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_NN_Crash() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.NAMENODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_DN_Graceful() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.SINGLE_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_DN_Crash() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.SINGLE_DATANODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_AllDN_Graceful() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.ALL_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_AllDN_Crash() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.ALL_DATANODES, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_RandomDN_Graceful() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.RANDOM_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testBlockMetaDataInfoWithHostname_AfterCreate_RandomDN_Crash() throws Exception {
    assumeTrue(System.getProperty("os.name").startsWith("Linux"));
    checkBlockMetaDataInfo_RestartInjected(true, RestartTarget.RANDOM_DATANODE, RestartMode.CRASH);
  }

  private void checkBlockMetaDataInfo_RestartInjected(boolean useDnHostname, RestartTarget target, RestartMode mode) throws Exception {
    MiniDFSCluster cluster = null;
  ...
  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_NN_Graceful() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.NAMENODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_NN_Crash() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.NAMENODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_DN_Graceful() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.SINGLE_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_DN_Crash() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.SINGLE_DATANODE, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_AllDN_Graceful() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.ALL_DATANODES, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_AllDN_Crash() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.ALL_DATANODES, RestartMode.CRASH);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_RandomDN_Graceful() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.RANDOM_DATANODE, RestartMode.GRACEFUL);
  }

  @Test(timeout = 120000)
  public void testUpdateReplicaUnderRecovery_AfterCreate_RandomDN_Crash() throws Exception {
    testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget.RANDOM_DATANODE, RestartMode.CRASH);
  }

  private void testUpdateReplicaUnderRecovery_RestartInjected(RestartTarget target, RestartMode mode) throws Exception {
    MiniDFSCluster cluster = null;
