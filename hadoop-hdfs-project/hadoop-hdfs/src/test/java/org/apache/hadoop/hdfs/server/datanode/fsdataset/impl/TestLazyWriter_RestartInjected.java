...
public class TestLazyWriter_RestartInjected extends LazyPersistTestCase {
  @Test
  ...
  public void testRamDiskEvictionIsLru()
    ...
    RestartFramework.at("after_files_read")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_lru_eviction_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDfsUsageCreateDelete()
    ...
    RestartFramework.at("after_usage_query")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
