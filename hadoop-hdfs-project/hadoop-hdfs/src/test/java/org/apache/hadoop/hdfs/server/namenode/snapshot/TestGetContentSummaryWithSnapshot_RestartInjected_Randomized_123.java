 ...
 */
public class TestGetContentSummaryWithSnapshot_RestartInjected_Randomized_123 {
    ...
    public void testGetContentSummary() throws IOException {
        ...
        RestartFramework.at("after_initial_mkdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_first_summary_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
