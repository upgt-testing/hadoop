...
public class TestSnapRootDescendantDiff {
    ...
    public void setUp() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).format(true).build();
        cluster.waitActive();
    ...
    void modifyAndCreateSnapshot(Path modifyDir, Path[] snapshotDirs) throws Exception {
        TestSnapshotDiffReport.modifyAndCreateSnapshot(modifyDir, snapshotDirs, hdfs, this::genSnapshotName);
    }
