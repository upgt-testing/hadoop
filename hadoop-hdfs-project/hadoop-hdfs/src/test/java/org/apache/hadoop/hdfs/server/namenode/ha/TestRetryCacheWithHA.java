...
public class TestRetryCacheWithHA {
    ...
    public void setup() throws Exception {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(DataNodes).build();
        cluster.waitActive();
    ...
    public void testRetryCacheOnStandbyNN() throws Exception {
        ...
        FSNamesystemInterface fsn0 = cluster.getNamesystem(0);
        ...
        FSNamesystemInterface fsn1 = cluster.getNamesystem(1);
    ...
    class AppendOp extends AtMostOnceOp {
        ...
        @Override
        boolean checkNamenodeBeforeReturn() throws Exception {
            INodeFileInterface fileNode = cluster.getNameNode(0).getNamesystem().getFSDirectory().getINode4Write(fileName).asFile();
    ...
    class UpdatePipelineOp extends AtMostOnceOp {
        ...
        void invoke() throws Exception {
            ...
            newNodes[0] = nodes[0];
            newNodes[1] = nodes[1];
            final DatanodeManagerInterface dm = cluster.getNamesystem(0).getBlockManager().getDatanodeManager();
