...
public class TestRetryCacheWithHA {
    ...
    public void setup() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(DataNodes).build();
        cluster.waitActive();
   ...
   */
    ...
    class AppendOp extends AtMostOnceOp {
        ...
        @Override
        boolean checkNamenodeBeforeReturn() throws Exception {
            INodeFileJVMInterface fileNode = cluster.getNameNode(0).getNamesystem().getFSDirectory().getINode4Write(fileName).asFile();
    ...
    class UpdatePipelineOp extends AtMostOnceOp {
        ...
        void invoke() throws Exception {
            ...
            newNodes[0] = nodes[0];
            newNodes[1] = nodes[1];
            final DatanodeManagerJVMInterface dm = cluster.getNamesystem(0).getBlockManager().getDatanodeManager();
        ...
        @Override
        boolean checkNamenodeBeforeReturn() throws Exception {
            INodeFileJVMInterface fileNode = cluster.getNamesystem(0).getFSDirectory().getINode4Write(file).asFile();
    ...
    @Test(timeout = 60000)
    public void testListCachePools_withUpgrade20() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        for (int i = 0; i < poolCount; i++) {
            String poolName = "testListCachePools-" + i;
    ...
    @Test(timeout = 60000)
    public void testListCachePools_withUpgrade40() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        for (int i = 0; i < poolCount; i++) {
            String poolName = "testListCachePools-" + i;
    ...
    @Test(timeout = 60000)
    public void testListCachePools_withUpgrade60() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        for (int i = 0; i < poolCount; i++) {
            String poolName = "testListCachePools-" + i;
    ...
    @Test(timeout = 60000)
    public void testListCachePools_withUpgrade80() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        for (int i = 0; i < poolCount; i++) {
            String poolName = "testListCachePools-" + i;
    ...
    @Test(timeout = 60000)
    public void testListCacheDirectives_withUpgrade20() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        Path path = new Path("/p");
        for (int i = 0; i < poolCount; i++) {
    ...
    @Test(timeout = 60000)
    public void testListCacheDirectives_withUpgrade40() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        Path path = new Path("/p");
        for (int i = 0; i < poolCount; i++) {
    ...
    @Test(timeout = 60000)
    public void testListCacheDirectives_withUpgrade60() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        Path path = new Path("/p");
        for (int i = 0; i < poolCount; i++) {
    ...
    @Test(timeout = 60000)
    public void testListCacheDirectives_withUpgrade80() throws Exception {
        final int poolCount = 7;
        HashSet<String> poolNames = new HashSet<String>(poolCount);
        Path path = new Path("/p");
        for (int i = 0; i < poolCount; i++) {
