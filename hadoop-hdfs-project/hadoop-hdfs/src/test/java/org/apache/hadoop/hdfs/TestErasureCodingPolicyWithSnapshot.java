...
public class TestErasureCodingPolicyWithSnapshot {
    ...
    public void testSnapshotsOnErasureCodingDirsParentDir() throws Exception {
        ...
        assertEquals("Got unexpected erasure coding policy", ecPolicy, fs.getErasureCodingPolicy(snap1ECDir));
        ...
        assertEquals("Got unexpected erasure coding policy", ecPolicy, fs.getErasureCodingPolicy(snap1ECDir));
        assertEquals("Got unexpected erasure coding policy", ecPolicy, fs.getErasureCodingPolicy(snap3ECDir));
    ...
    @Test
    public void testSnapshotsOnErasureCodingDirAfterNNRestart_withUpgrade20() throws Exception {
        final Path ecDir = new Path("/ecdir");
        fs.mkdirs(ecDir);
        fs.allowSnapshot(ecDir);
        // set erasure coding policy
    ...
    @Test
    public void testSnapshotsOnErasureCodingDirAfterNNRestart_withUpgrade40() throws Exception {
        final Path ecDir = new Path("/ecdir");
        fs.mkdirs(ecDir);
        fs.allowSnapshot(ecDir);
        // set erasure coding policy
    ...
    @Test
    public void testSnapshotsOnErasureCodingDirAfterNNRestart_withUpgrade60() throws Exception {
        final Path ecDir = new Path("/ecdir");
        fs.mkdirs(ecDir);
        fs.allowSnapshot(ecDir);
        // set erasure coding policy
    ...
    @Test
    public void testSnapshotsOnErasureCodingDirAfterNNRestart_withUpgrade80() throws Exception {
        final Path ecDir = new Path("/ecdir");
        fs.mkdirs(ecDir);
        fs.allowSnapshot(ecDir);
        // set erasure coding policy
    ...
    @Test(timeout = 300000)
    public void testFileStatusAcrossNNRestart_withUpgrade20() throws IOException {
        final int len = 1024;
        final Path normalFile = new Path("/", "normalFile");
        DFSTestUtil.createFile(fs, normalFile, len, (short) 1, 0xFEED);
        final Path ecDir = new Path("/ecdir");
    ...
    @Test(timeout = 300000)
    public void testFileStatusAcrossNNRestart_withUpgrade40() throws IOException {
        final int len = 1024;
        final Path normalFile = new Path("/", "normalFile");
        DFSTestUtil.createFile(fs, normalFile, len, (short) 1, 0xFEED);
        final Path ecDir = new Path("/ecdir");
    ...
    @Test(timeout = 300000)
    public void testFileStatusAcrossNNRestart_withUpgrade60() throws IOException {
        final int len = 1024;
        final Path normalFile = new Path("/", "normalFile");
        DFSTestUtil.createFile(fs, normalFile, len, (short) 1, 0xFEED);
        final Path ecDir = new Path("/ecdir");
    ...
    @Test(timeout = 300000)
    public void testFileStatusAcrossNNRestart_withUpgrade80() throws IOException {
        final int len = 1024;
        final Path normalFile = new Path("/", "normalFile");
        DFSTestUtil.createFile(fs, normalFile, len, (short) 1, 0xFEED);
        final Path ecDir = new Path("/ecdir");
