...
public class TestINodeFile {
    ...
    INodeFile createINodeFile(short replication, long preferredBlockSize) {
        return new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, replication, preferredBlockSize, (byte) 0);
    }

    private static INodeFile createINodeFile(byte storagePolicyID) {
        return new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, (short) 3, 1024L, storagePolicyID);
    }
    ...
    private INodeFile[] createINodeFiles(int nCount, String fileNamePrefix) {
        ...
        for (int i = 0; i < nCount; i++) {
            iNodes[i] = new INodeFile(i, null, perm, 0L, 0L, null, replication, preferredBlockSize, (byte) 0);
    ...
    public void testValueOf() throws IOException {
        ...
        }
        {
            ...
            final INode from = new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, replication, 1024L, (byte) 0);
   ...
   */
    ...
    public void testFileUnderConstruction() {
        replication = 3;
        final INodeFile file = new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, replication, 1024L, (byte) 0);
    ...
    public void testConcat() throws IOException {
        ...
        try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).build()) {
            ...
            assertEquals(cs.getFileCount() + cs.getDirectoryCount(), qu.getFileAndDirectoryCount());
        }
    }
