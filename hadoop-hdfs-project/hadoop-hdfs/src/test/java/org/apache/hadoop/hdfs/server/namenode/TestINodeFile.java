...
public class TestINodeFile {
    ...
    public void testContiguousLayoutRedundancy() {
        ...
        try {
            new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, null, /*replication*/
            null, /*ec policy*/
            preferredBlockSize, HdfsConstants.WARM_STORAGE_POLICY_ID, CONTIGUOUS);
        ...
        try {
            new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, Short.MAX_VALUE, /*replication*/
            null, /*ec policy*/
            preferredBlockSize, HdfsConstants.WARM_STORAGE_POLICY_ID, CONTIGUOUS);
        ...
        try {
            new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, replication, null, /*ec policy*/
        ...
        inodeFile = new INodeFile(HdfsConstants.GRANDFATHER_INODE_ID, null, perm, 0L, 0L, null, replication, null, /*ec policy*/
        preferredBlockSize, HdfsConstants.WARM_STORAGE_POLICY_ID, CONTIGUOUS);
    ...
    private void ensureReservedFileNamesCannotBeLoaded(MiniDFSClusterInJVM cluster) throws IOException {
    ...
    private void ensureClusterRestartSucceeds(MiniDFSClusterInJVM cluster) throws IOException {
        cluster.restartNameNode();
        cluster.waitActive();
   ...
   */
    ...
    public void testConcat() throws IOException {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            ...
            Assert.assertEquals(cs.getFileCount() + cs.getDirectoryCount(), qu.getFileAndDirectoryCount());
        }
    }

    @Test
    public void testGetFullPathNameAfterSetQuota_withUpgrade20() throws Exception {
        long fileLen = 1024;
        replication = 3;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testGetFullPathNameAfterSetQuota_withUpgrade40() throws Exception {
        long fileLen = 1024;
        replication = 3;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testGetFullPathNameAfterSetQuota_withUpgrade60() throws Exception {
        long fileLen = 1024;
        replication = 3;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testGetFullPathNameAfterSetQuota_withUpgrade80() throws Exception {
        long fileLen = 1024;
        replication = 3;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testInodeId_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testInodeId_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testInodeId_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testInodeId_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testWriteToDeletedFile_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testWriteToDeletedFile_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testWriteToDeletedFile_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testWriteToDeletedFile_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testInodeIdBasedPaths_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testInodeIdBasedPaths_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testInodeIdBasedPaths_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testInodeIdBasedPaths_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DFSConfigKeys.DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testReservedFileNames_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            // First start a cluster with reserved file names check turned off
    ...
    @Test
    public void testReservedFileNames_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            // First start a cluster with reserved file names check turned off
    ...
    @Test
    public void testReservedFileNames_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            // First start a cluster with reserved file names check turned off
    ...
    @Test
    public void testReservedFileNames_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            // First start a cluster with reserved file names check turned off
    ...
    @Test
    public void testDotdotInodePath_withUpgrade20() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        DFSClient client = null;
        try {
    ...
    @Test
    public void testDotdotInodePath_withUpgrade40() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        DFSClient client = null;
        try {
    ...
    @Test
    public void testDotdotInodePath_withUpgrade60() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        DFSClient client = null;
        try {
    ...
    @Test
    public void testDotdotInodePath_withUpgrade80() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        DFSClient client = null;
        try {
    ...
    @Test
    public void testConcat_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testConcat_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testConcat_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testConcat_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            DistributedFileSystem dfs = cluster.getFileSystem();
