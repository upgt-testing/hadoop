 ...
 */
public class TestViewFsDefaultValue_RestartInjected_Randomized_123 {
    ...
    public void testGetQuotaUsage() throws IOException {
        ...
        RestartFramework.at("after_set_quota_usage").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetQuotaUsageWithStorageTypes() throws IOException {
        ...
        RestartFramework.at("after_set_storage_quotas").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetQuotaUsageWithQuotaDefined() throws IOException {
        ...
        RestartFramework.at("after_unset_quotas").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        QuotaUsage qu = vfs.getQuotaUsage(testFileDirPath);
