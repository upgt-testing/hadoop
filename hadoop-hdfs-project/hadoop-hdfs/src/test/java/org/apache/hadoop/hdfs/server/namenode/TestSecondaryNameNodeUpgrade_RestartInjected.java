 ...
 */
public class TestSecondaryNameNodeUpgrade_RestartInjected {
  ...
  private void doIt(Map<String, String> paramsToCorrupt) throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_secondary_namenode_started")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
      ...
      RestartFramework.at("after_first_directory_created")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_version_files_corrupted")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_secondary_namenode_restarted")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_directory_created")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
