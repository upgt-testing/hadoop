...
public class TestSnapshotListing {
    ...
    @Test(timeout = 15000)
    public void testListSnapshots_withUpgrade20() throws Exception {
        final Path snapshotsPath = new Path(dir, ".snapshot");
        FileStatus[] stats = null;
        // special case: snapshots of root
        stats = hdfs.listStatus(new Path("/.snapshot"));
    ...
    @Test(timeout = 15000)
    public void testListSnapshots_withUpgrade40() throws Exception {
        final Path snapshotsPath = new Path(dir, ".snapshot");
        FileStatus[] stats = null;
        // special case: snapshots of root
        stats = hdfs.listStatus(new Path("/.snapshot"));
    ...
    @Test(timeout = 15000)
    public void testListSnapshots_withUpgrade60() throws Exception {
        final Path snapshotsPath = new Path(dir, ".snapshot");
        FileStatus[] stats = null;
        // special case: snapshots of root
        stats = hdfs.listStatus(new Path("/.snapshot"));
    ...
    @Test(timeout = 15000)
    public void testListSnapshots_withUpgrade80() throws Exception {
        final Path snapshotsPath = new Path(dir, ".snapshot");
        FileStatus[] stats = null;
        // special case: snapshots of root
        stats = hdfs.listStatus(new Path("/.snapshot"));
