...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestViewFileSystemOverloadSchemeWithDFSAdmin}.
 *
 ...
 *
 * @see TestViewFileSystemOverloadSchemeWithDFSAdmin Original test using MiniDFSCluster
 */
@RunWith(Parameterized.class)
public class TestViewFileSystemOverloadSchemeWithDFSAdmin_ProcessBased extends ProcessBasedUpgradeTestBase {
  ...
  private static final String TEST_ROOT_DIR = PathUtils
      .getTestDirName(TestViewFileSystemOverloadSchemeWithDFSAdmin_ProcessBased.class);
  ...
  public static Collection<String> checkpoints() {
    return Arrays.asList(
      ...
      "AFTER_MOUNT_LINKS_SETUP",
      "AFTER_SAFEMODE_ENTER",
      "AFTER_ADMIN_OPERATION",
      "AFTER_SAFEMODE_LEAVE",
      "BEFORE_TEST_END"
    );
  }

  /**
   * Sets up the configurations and starts the ProcessBasedMiniDFSCluster.
   */
  @Before
  ...
  public void tearDown() throws IOException {
    ...
    resetStream();
    // Note: cluster shutdown handled by ProcessBasedUpgradeTestBase.tearDownTest()
  }
  ...
  public void testSaveNameSpace() throws Exception {
    ...
    checkpoint("AFTER_MOUNT_LINKS_SETUP");
    ...
    checkpoint("AFTER_SAFEMODE_ENTER");
    ...
    checkpoint("AFTER_ADMIN_OPERATION");

    ret = ToolRunner.run(dfsAdmin,
        new String[] {"-fs", defaultFSURI.toString(), "-safemode", "leave" });
    assertEquals(0, ret);

    checkpoint("AFTER_SAFEMODE_LEAVE");
    checkpoint("BEFORE_TEST_END");
  }
