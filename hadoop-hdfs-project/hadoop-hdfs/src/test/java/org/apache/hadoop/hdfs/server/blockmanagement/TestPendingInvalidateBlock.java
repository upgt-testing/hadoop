...
public class TestPendingInvalidateBlock {
    ...
    @Test
    public void testPendingDeletion_withUpgrade20() throws Exception {
        final Path foo = new Path("/foo");
        DFSTestUtil.createFile(dfs, foo, BLOCKSIZE, REPLICATION, 0);
        DFSTestUtil.waitForReplication(dfs, foo, REPLICATION, 10000);
        // restart NN
    ...
    @Test
    public void testPendingDeletion_withUpgrade40() throws Exception {
        final Path foo = new Path("/foo");
        DFSTestUtil.createFile(dfs, foo, BLOCKSIZE, REPLICATION, 0);
        DFSTestUtil.waitForReplication(dfs, foo, REPLICATION, 10000);
        // restart NN
    ...
    @Test
    public void testPendingDeletion_withUpgrade60() throws Exception {
        final Path foo = new Path("/foo");
        DFSTestUtil.createFile(dfs, foo, BLOCKSIZE, REPLICATION, 0);
        DFSTestUtil.waitForReplication(dfs, foo, REPLICATION, 10000);
        // restart NN
    ...
    @Test
    public void testPendingDeletion_withUpgrade80() throws Exception {
        final Path foo = new Path("/foo");
        DFSTestUtil.createFile(dfs, foo, BLOCKSIZE, REPLICATION, 0);
        DFSTestUtil.waitForReplication(dfs, foo, REPLICATION, 10000);
        // restart NN
    ...
    @Test
    public void testPendingDeleteUnknownBlocks_withUpgrade20() throws Exception {
        // 5 files
        final int fileNum = 5;
        final Path[] files = new Path[fileNum];
        final DataNodeProperties[] dnprops = new DataNodeProperties[REPLICATION];
    ...
    @Test
    public void testPendingDeleteUnknownBlocks_withUpgrade40() throws Exception {
        // 5 files
        final int fileNum = 5;
        final Path[] files = new Path[fileNum];
        final DataNodeProperties[] dnprops = new DataNodeProperties[REPLICATION];
    ...
    @Test
    public void testPendingDeleteUnknownBlocks_withUpgrade60() throws Exception {
        // 5 files
        final int fileNum = 5;
        final Path[] files = new Path[fileNum];
        final DataNodeProperties[] dnprops = new DataNodeProperties[REPLICATION];
    ...
    @Test
    public void testPendingDeleteUnknownBlocks_withUpgrade80() throws Exception {
        // 5 files
        final int fileNum = 5;
        final Path[] files = new Path[fileNum];
        final DataNodeProperties[] dnprops = new DataNodeProperties[REPLICATION];
