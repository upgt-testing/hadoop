 ...
 */
public class TestDFSHAAdminMiniCluster_RestartInjected {
  static {
    GenericTestUtils.setLogLevel(LoggerFactory.getLogger(HAAdmin.class),
        Level.TRACE);
  }
  private static final Logger LOG =
      LoggerFactory.getLogger(TestDFSHAAdminMiniCluster_RestartInjected.class);
  ...
  public void testGetServiceState() throws Exception {
    ...
    RestartFramework.at("after_get_service_state")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_transition_to_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_enter_safemode")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStateTransition() throws Exception {
    ...
    RestartFramework.at("after_transition_nn1_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_transition_nn2_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverTransition() throws Exception {
    ...
    assertEquals(0, runTool("-transitionToObserver", "nn1"));
    RestartFramework.at("after_observer_noop")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverIllegalTransition() throws Exception {
    ...
    RestartFramework.at("after_failed_active_to_observer")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertEquals(0, runTool("-transitionToStandby", "nn1"));
    RestartFramework.at("after_transition_to_standby")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testTryFailoverToSafeMode() throws Exception {
    ...
    RestartFramework.at("after_failed_failover")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFencer() throws Exception {
    ...
    RestartFramework.at("after_failed_failover_no_fencer")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_fencer_config")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failover_nn1_to_nn2")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failover_with_ns")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_forcefence_failover")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_forceactive_failover")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    tool.setConf(conf);
    RestartFramework.at("after_unset_fencer")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failed_failover_no_fencer_forcefence")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    tool.setConf(conf);
    RestartFramework.at("after_bad_fencer_config")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    assertEquals(-1, runTool("-failover", "nn1", "nn2", "--forcefence"));
    RestartFramework.at("after_failed_failover_bad_fencer")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    conf.set(DFSConfigKeys.DFS_HA_FENCE_METHODS_KEY,
             TestDFSHAAdmin.getFencerTrueCommand());
    tool.setConf(conf);
    RestartFramework.at("after_good_fencer_config")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_forcefence_first_failover")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckHealth() throws Exception {
    ...
    RestartFramework.at("after_check_health_nn1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_check_health_nn2")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testTransitionToActiveWhenOtherNamenodeisActive()
    ...
    RestartFramework.at("after_ensure_standby")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_transition_both_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_shutdown_nn1")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_ensure_nn2_standby")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
