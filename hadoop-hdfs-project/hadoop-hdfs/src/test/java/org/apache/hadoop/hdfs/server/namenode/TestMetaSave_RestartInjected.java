 ...
 */
public class TestMetaSave_RestartInjected {
  ...
  public void testMetaSaveOverwrite() throws Exception {
    ...
    RestartFramework.at("after_first_metasave")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testConcurrentMetaSave() throws Exception {
    ...
    RestartFramework.at("before_concurrent_metasave")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_concurrent_metasave")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
