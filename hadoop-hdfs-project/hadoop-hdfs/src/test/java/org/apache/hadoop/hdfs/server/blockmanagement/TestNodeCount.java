...
public class TestNodeCount {
    ...
    public void testNodeCount() throws Exception {
        ...
        final MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(REPLICATION_FACTOR).build();
        try {
            ...
            DatanodeDescriptorInterface datanode = datanodes[0];
            ...
            DatanodeDescriptorInterface nonExcessDN = null;
            for (DatanodeStorageInfoInterface storage : bm.blocksMap.getStorages(block.getLocalBlock())) {
                final DatanodeDescriptorInterface dn = storage.getDatanodeDescriptor();
