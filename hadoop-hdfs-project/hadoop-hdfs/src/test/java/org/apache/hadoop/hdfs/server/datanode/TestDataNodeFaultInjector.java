...
public class TestDataNodeFaultInjector {
    ...
    private static class MetricsDataNodeFaultInjector extends DataNodeFaultInjector {
        ...
        private void verifyFaultInjectionDelayPipeline_withUpgrade20(final MetricsDataNodeFaultInjector mdnFaultInjector) throws Exception {
     ...
     */
            ...
            try {
                ...
                try (final FSDataOutputStream out = fs.create(new Path(baseDir, "test.data"), (short) 2)) {
                    out.write(0x31);
                    out.hflush();
                    out.hsync();
                }
        ...
        private void verifyFaultInjectionDelayPipeline_withUpgrade40(final MetricsDataNodeFaultInjector mdnFaultInjector) throws Exception {
            final Path baseDir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
            final DataNodeFaultInjector oldDnInjector = DataNodeFaultInjector.get();
            DataNodeFaultInjector.set(mdnFaultInjector);
            final Configuration conf = new HdfsConfiguration();
     ...
     */
        ...
        private void verifyFaultInjectionDelayPipeline_withUpgrade60(final MetricsDataNodeFaultInjector mdnFaultInjector) throws Exception {
            final Path baseDir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
            final DataNodeFaultInjector oldDnInjector = DataNodeFaultInjector.get();
            DataNodeFaultInjector.set(mdnFaultInjector);
            final Configuration conf = new HdfsConfiguration();
     ...
     */
        ...
        private void verifyFaultInjectionDelayPipeline_withUpgrade80(final MetricsDataNodeFaultInjector mdnFaultInjector) throws Exception {
            final Path baseDir = new Path(PathUtils.getTestDir(getClass()).getPath(), GenericTestUtils.getMethodName());
            final DataNodeFaultInjector oldDnInjector = DataNodeFaultInjector.get();
            DataNodeFaultInjector.set(mdnFaultInjector);
            final Configuration conf = new HdfsConfiguration();
     ...
     */
        ...
        @Test(timeout = 60000)
        public void testDelaySendingAckToUpstream_withUpgrade20() throws Exception {
            ...
            verifyFaultInjectionDelayPipeline_withUpgrade20(mdnFaultInjector);
        }

        @Test(timeout = 60000)
        public void testDelaySendingAckToUpstream_withUpgrade40() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
            ...
            verifyFaultInjectionDelayPipeline_withUpgrade40(mdnFaultInjector);
        }

        @Test(timeout = 60000)
        public void testDelaySendingAckToUpstream_withUpgrade60() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
            ...
            verifyFaultInjectionDelayPipeline_withUpgrade60(mdnFaultInjector);
        }

        @Test(timeout = 60000)
        public void testDelaySendingAckToUpstream_withUpgrade80() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
            ...
            verifyFaultInjectionDelayPipeline_withUpgrade80(mdnFaultInjector);
        }

        @Test(timeout = 60000)
        public void testDelaySendingPacketDownstream_withUpgrade20() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
        ...
        @Test(timeout = 60000)
        public void testDelaySendingPacketDownstream_withUpgrade40() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
        ...
        @Test(timeout = 60000)
        public void testDelaySendingPacketDownstream_withUpgrade60() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
        ...
        @Test(timeout = 60000)
        public void testDelaySendingPacketDownstream_withUpgrade80() throws Exception {
            final MetricsDataNodeFaultInjector mdnFaultInjector = new MetricsDataNodeFaultInjector() {
