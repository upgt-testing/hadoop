...
public class TestViewFsLinkFallback {
    ...
    private PathInterface targetTestRoot;
    ...
    public static void clusterSetupAtBeginning() throws IOException, URISyntaxException {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(nameSpacesCount)).numDataNodes(dataNodesCount).build();
