   ...
   */
    ...
    public void testHandleTruncatedBlockFile() throws IOException {
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(false).build();
            cluster.waitActive();
    ...
    @Test(timeout = 60000)
    public void testSkipWithVerifyChecksum_withUpgrade20() throws IOException {
        int size = blockSize;
        Configuration conf = new Configuration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 60000)
    public void testSkipWithVerifyChecksum_withUpgrade40() throws IOException {
        int size = blockSize;
        Configuration conf = new Configuration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 60000)
    public void testSkipWithVerifyChecksum_withUpgrade60() throws IOException {
        int size = blockSize;
        Configuration conf = new Configuration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 60000)
    public void testSkipWithVerifyChecksum_withUpgrade80() throws IOException {
        int size = blockSize;
        Configuration conf = new Configuration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 120000)
    public void testHandleTruncatedBlockFile_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        HdfsConfiguration conf = new HdfsConfiguration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 120000)
    public void testHandleTruncatedBlockFile_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        HdfsConfiguration conf = new HdfsConfiguration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 120000)
    public void testHandleTruncatedBlockFile_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        HdfsConfiguration conf = new HdfsConfiguration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
    ...
    @Test(timeout = 120000)
    public void testHandleTruncatedBlockFile_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        HdfsConfiguration conf = new HdfsConfiguration();
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.KEY, true);
        conf.setBoolean(HdfsClientConfigKeys.Read.ShortCircuit.SKIP_CHECKSUM_KEY, false);
