...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestSnapshotCommands}.
 *
 * Transformed from MiniDFSCluster to ProcessBasedMiniDFSCluster to enable
 * process-based testing and multi-version upgrade scenarios for snapshot CLI commands.
 *
 ...
 *
 * @see TestSnapshotCommands Original test using MiniDFSCluster
 * @see ProcessBasedUpgradeTestBase Base class with cleanup and checkpoint support
 */
@RunWith(Parameterized.class)
public class TestSnapshotCommands_ProcessBased extends ProcessBasedUpgradeTestBase {
  ...
  /**
   * Setup directories and enable snapshots before each test.
   *
  ...
  /**
   * Cleanup snapshots and directories after each test.
   *
