 ...
 */
public class TestObserverNode_RestartInjected {
  public static final Logger LOG =
      LoggerFactory.getLogger(TestObserverNode_RestartInjected.class.getName());
  ...
  public void testNoActiveToObserver() throws Exception {
    RestartFramework.at("before_transition_attempt")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
  ...
  public void testGetGroups() throws Exception {
    RestartFramework.at("before_get_groups")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNoObserverToActive() throws Exception {
    RestartFramework.at("before_transition_observer_to_active")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSimpleRead() throws Exception {
    ...
    RestartFramework.at("after_mkdir_testpath")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_observer_read")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFailover() throws Exception {
    ...
    RestartFramework.at("after_first_mkdir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_mkdir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failover_back")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDoubleFailover() throws Exception {
    ...
    RestartFramework.at("after_mkdir_testpath2")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_mkdir_testpath3")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverShutdown() throws Exception {
    ...
    RestartFramework.at("after_observer_shutdown")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_observer_restart")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverFailOverAndShutdown() throws Exception {
    ...
    RestartFramework.at("after_initial_read")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverNodeSafeModeWithBlockLocations() throws Exception {
    ...
    RestartFramework.at("after_observer_open")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_failover_to_active")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_safemode_leave")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverNodeBlockMissingRetry() throws Exception {
    ...
    RestartFramework.at("after_block_manager_mock")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_block_missing_retry")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFsckWithObserver() throws Exception {
    ...
    RestartFramework.at("after_fsck")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testObserverRetryActiveException() throws Exception {
    ...
    RestartFramework.at("after_retry_exception")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAccessTimeUpdateRedirectToActive() throws Exception {
    ...
    RestartFramework.at("after_set_times")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_access_time_redirect")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testStickyActive() throws Exception {
    ...
    RestartFramework.at("after_observer_to_standby")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_standby_to_observer")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_restore_topology")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFsckDelete() throws Exception {
    ...
    RestartFramework.at("after_corrupt_replica")
        .on(dfsCluster)
        .restart("datanode")
        .withIndex(dnToCorrupt)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    ...
    RestartFramework.at("after_fsck_delete")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirsRaceWithObserverRead() throws Exception {
    ...
    RestartFramework.at("after_initial_mkdir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_submit_threads")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_threads_finish")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetListingForDeletedDir() throws Exception {
    ...
    RestartFramework.at("after_delete_dir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_list_deleted_dir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSimpleReadEmptyDirOrFile() throws IOException {
    ...
    RestartFramework.at("after_mkdirs_emptydir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_read_emptydir")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_create_emptyfile")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_read_emptyfile")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(2)
        .withMode(RestartMode.GRACEFUL)
