 ...
 */
public class TestReencryption_RestartInjected {
  ...
  public void testReencryptionBasic() throws Exception {
    ...
    RestartFramework.at("after_encryption_zone_created")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_files_created_in_zone")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_first_reencryption")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_key_roll")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_reencryption")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReencryptOrdering() throws Exception {
    ...
    RestartFramework.at("after_zone_created")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
