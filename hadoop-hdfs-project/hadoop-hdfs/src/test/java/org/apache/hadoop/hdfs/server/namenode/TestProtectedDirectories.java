...
public class TestProtectedDirectories {
     ...
     * @throws IOException
     */
    public MiniDockerDFSCluster setupTestCase(Configuration conf, Collection<Path> protectedDirs, Collection<Path> unProtectedDirs) throws Throwable {
    ...
    public void testReconfigureProtectedPaths() throws Throwable {
        ...
        MiniDockerDFSCluster cluster = setupTestCase(conf, protectedPaths, unprotectedPaths);
        ...
        FSDirectoryInterface fsDirectory = nn.getNamesystem().getFSDirectory();
        // verify change
    ...
    public void testDelete() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDockerDFSCluster cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
