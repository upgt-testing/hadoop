...
public class TestProtectedDirectories {
     ...
     * @throws IOException
     */
    public MiniDFSClusterInJVM setupTestCase(Configuration conf, Collection<Path> protectedDirs, Collection<Path> unProtectedDirs) throws Throwable {
    ...
    public void testReconfigureProtectedPaths() throws Throwable {
        ...
        MiniDFSClusterInJVM cluster = setupTestCase(conf, protectedPaths, unprotectedPaths);
    ...
    public void testDelete() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
   ...
   */
    ...
    public void testRenameProtectSubDirs() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testReconfigureProtectedPaths_withUpgrade20() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        Collection<Path> protectedPaths = Arrays.asList(new Path("/a"), new Path("/b"), new Path("/c"));
        Collection<Path> unprotectedPaths = Arrays.asList();
        MiniDFSClusterInJVM cluster = setupTestCase(conf, protectedPaths, unprotectedPaths);
    ...
    @Test
    public void testReconfigureProtectedPaths_withUpgrade40() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        Collection<Path> protectedPaths = Arrays.asList(new Path("/a"), new Path("/b"), new Path("/c"));
        Collection<Path> unprotectedPaths = Arrays.asList();
        MiniDFSClusterInJVM cluster = setupTestCase(conf, protectedPaths, unprotectedPaths);
    ...
    @Test
    public void testReconfigureProtectedPaths_withUpgrade60() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        Collection<Path> protectedPaths = Arrays.asList(new Path("/a"), new Path("/b"), new Path("/c"));
        Collection<Path> unprotectedPaths = Arrays.asList();
        MiniDFSClusterInJVM cluster = setupTestCase(conf, protectedPaths, unprotectedPaths);
    ...
    @Test
    public void testReconfigureProtectedPaths_withUpgrade80() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        Collection<Path> protectedPaths = Arrays.asList(new Path("/a"), new Path("/b"), new Path("/c"));
        Collection<Path> unprotectedPaths = Arrays.asList();
        MiniDFSClusterInJVM cluster = setupTestCase(conf, protectedPaths, unprotectedPaths);
    ...
    @Test
    public void testDelete_withUpgrade20() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
    ...
    @Test
    public void testDelete_withUpgrade40() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
    ...
    @Test
    public void testDelete_withUpgrade60() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
    ...
    @Test
    public void testMoveToTrash_withUpgrade40() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.FS_TRASH_INTERVAL_KEY, 3600);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testMoveToTrash_withUpgrade60() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.FS_TRASH_INTERVAL_KEY, 3600);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testMoveToTrash_withUpgrade80() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.FS_TRASH_INTERVAL_KEY, 3600);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testRename_withUpgrade20() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testRename_withUpgrade40() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
    ...
    @Test
    public void testRename_withUpgrade60() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            Configuration conf = new HdfsConfiguration();
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
            try {
    ...
    @Test
    public void testRenameProtectSubDirs_withUpgrade40() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testRenameProtectSubDirs_withUpgrade60() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testRenameProtectSubDirs_withUpgrade80() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testMoveProtectedSubDirsToTrash_withUpgrade40() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            conf.setInt(DFSConfigKeys.FS_TRASH_INTERVAL_KEY, 3600);
    ...
    @Test
    public void testMoveProtectedSubDirsToTrash_withUpgrade60() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            conf.setInt(DFSConfigKeys.FS_TRASH_INTERVAL_KEY, 3600);
    ...
    @Test
    public void testMoveProtectedSubDirsToTrash_withUpgrade80() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            conf.setInt(DFSConfigKeys.FS_TRASH_INTERVAL_KEY, 3600);
    ...
    @Test
    public void testDeleteProtectSubDirs_withUpgrade20() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testDeleteProtectSubDirs_withUpgrade40() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
    ...
    @Test
    public void testDeleteProtectSubDirs_withUpgrade60() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrixForProtectSubDirs()) {
            Configuration conf = new HdfsConfiguration();
            conf.setBoolean(DFS_PROTECTED_SUBDIRECTORIES_ENABLE, true);
            MiniDFSClusterInJVM cluster = setupTestCase(conf, testMatrixEntry.getProtectedPaths(), testMatrixEntry.getUnprotectedPaths());
