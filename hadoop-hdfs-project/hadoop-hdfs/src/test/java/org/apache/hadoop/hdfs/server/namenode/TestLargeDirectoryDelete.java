...
public class TestLargeDirectoryDelete {
    ...
    @Test
    public void largeDelete_withUpgrade20() throws Throwable {
        mc = new MiniDFSClusterInJVM.Builder(CONF).build();
        try {
            mc.waitActive();
            mc.restartNodeForTesting(0);
            mc.upgradeNodeForTesting(0);
            Assert.assertNotNull("No Namenode in cluster", mc.getNameNode());
            createFiles();
            Assert.assertEquals(TOTAL_BLOCKS, getBlockCount());
            runThreads();
    ...
    @Test
    public void largeDelete_withUpgrade40() throws Throwable {
        mc = new MiniDFSClusterInJVM.Builder(CONF).build();
        try {
            mc.waitActive();
            Assert.assertNotNull("No Namenode in cluster", mc.getNameNode());
    ...
    @Test
    public void largeDelete_withUpgrade60() throws Throwable {
        mc = new MiniDFSClusterInJVM.Builder(CONF).build();
        try {
            mc.waitActive();
            Assert.assertNotNull("No Namenode in cluster", mc.getNameNode());
    ...
    @Test
    public void largeDelete_withUpgrade80() throws Throwable {
        mc = new MiniDFSClusterInJVM.Builder(CONF).build();
        try {
            mc.waitActive();
            Assert.assertNotNull("No Namenode in cluster", mc.getNameNode());
