 ...
 */
public class TestSnapshotMetrics_RestartInjected_Randomized_456 {
    ...
    public void testSnapshottableDirs() throws Exception {
        RestartFramework.at("after_allow_snapshot_subsub1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_allow_snapshot_sub2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertGauge("SnapshottableDirectories", 1, getMetrics(NS_METRICS));
        assertCounter("AllowSnapshotOps", 1L, getMetrics(NN_METRICS));
        Path sub2 = new Path(dir, "sub2");
        RestartFramework.at("after_allow_snapshot_sub1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSnapshots() throws Exception {
        ...
        RestartFramework.at("after_create_snapshot_s11").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
