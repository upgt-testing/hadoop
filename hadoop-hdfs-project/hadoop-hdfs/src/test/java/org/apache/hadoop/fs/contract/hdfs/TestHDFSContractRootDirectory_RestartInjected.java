...
public class TestHDFSContractRootDirectory_RestartInjected extends
    AbstractContractRootDirectoryTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestHDFSContractRootDirectory_RestartInjected.class);
  ...
  public void testRmEmptyRootDirRecursive() throws Throwable {
    ...
    RestartFramework.at("before_delete_root_recursive")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_delete_root_recursive")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRmEmptyRootDirNonRecursive() throws Throwable {
    ...
    RestartFramework.at("after_cleanup_before_delete")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRmNonEmptyRootDirNonRecursive() throws Throwable {
    ...
    RestartFramework.at("after_touch_file")
        .on(HDFSContract.getCluster())
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertIsDirectory(root);
    try {
      RestartFramework.at("before_delete_nonempty_root")
          .on(HDFSContract.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRmRootRecursive() throws Throwable {
    ...
    try {
      ...
      RestartFramework.at("before_delete_root_with_file")
          .on(HDFSContract.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_delete_root_with_file")
          .on(HDFSContract.getCluster())
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateFileOverRoot() throws Throwable {
    ...
    RestartFramework.at("before_create_file_over_root")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListEmptyRootDirectory() throws IOException {
    ...
    RestartFramework.at("after_cleanup_before_listing")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSimpleRootListing() throws IOException {
    ...
    RestartFramework.at("before_listing_operations")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRecursiveRootListing() throws IOException {
    ...
    RestartFramework.at("before_recursive_listing")
        .on(HDFSContract.getCluster())
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
