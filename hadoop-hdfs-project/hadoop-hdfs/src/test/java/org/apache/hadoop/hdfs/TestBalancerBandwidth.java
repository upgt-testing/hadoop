...
public class TestBalancerBandwidth {
    ...
    public void testBalancerBandwidth() throws Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build()) {
            cluster.waitActive();
            ...
            String dn1Address = datanodes.get(0).getRpcServer().getListenerAddress().getHostName() + ":" + datanodes.get(0).getIpcPort();
            String dn2Address = datanodes.get(1).getRpcServer().getListenerAddress().getHostName() + ":" + datanodes.get(1).getIpcPort();
            ...
            assertEquals(0, ToolRunner.run(admin, new String[] { "-setBalancerBandwidth", "1t" }));
            assertEquals(-1, ToolRunner.run(admin, new String[] { "-setBalancerBandwidth", "1e" }));
        }
    }

    private void verifyBalancerBandwidth(final ArrayList<DataNodeJVMInterface> datanodes, final long newBandwidth) throws TimeoutException, InterruptedException {
    ...
    @Test
    public void testBalancerBandwidth_withUpgrade20() throws Exception {
        /* Set bandwidthPerSec to a low value of 1M bps. */
        conf.setLong(DFSConfigKeys.DFS_DATANODE_BALANCE_BANDWIDTHPERSEC_KEY, DEFAULT_BANDWIDTH);
        /* Create and start cluster */
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build()) {
    ...
    @Test
    public void testBalancerBandwidth_withUpgrade40() throws Exception {
        /* Set bandwidthPerSec to a low value of 1M bps. */
        conf.setLong(DFSConfigKeys.DFS_DATANODE_BALANCE_BANDWIDTHPERSEC_KEY, DEFAULT_BANDWIDTH);
        /* Create and start cluster */
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build()) {
    ...
    @Test
    public void testBalancerBandwidth_withUpgrade60() throws Exception {
        /* Set bandwidthPerSec to a low value of 1M bps. */
        conf.setLong(DFSConfigKeys.DFS_DATANODE_BALANCE_BANDWIDTHPERSEC_KEY, DEFAULT_BANDWIDTH);
        /* Create and start cluster */
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build()) {
    ...
    @Test
    public void testBalancerBandwidth_withUpgrade80() throws Exception {
        /* Set bandwidthPerSec to a low value of 1M bps. */
        conf.setLong(DFSConfigKeys.DFS_DATANODE_BALANCE_BANDWIDTHPERSEC_KEY, DEFAULT_BANDWIDTH);
        /* Create and start cluster */
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build()) {
