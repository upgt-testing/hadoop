 ...
 */
public class TestListCorruptFileBlocks_RestartInjected_Randomized_123 {
    ...
    public void testListCorruptFilesCorruptedBlock() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_corrupt_detection").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testListCorruptFileBlocksInSafeMode() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_corrupt_detection_safemode").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // fetch bad file list from namenode. There should be one file.
    ...
    public void testlistCorruptFileBlocks() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_blocks_removal").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            int count = 0;
