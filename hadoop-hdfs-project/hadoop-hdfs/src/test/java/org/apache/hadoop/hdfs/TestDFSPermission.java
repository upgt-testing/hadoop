...
public class TestDFSPermission {
   ...
   */
    ...
    @Test
    public void testPermissionSetting_withUpgrade20() throws Exception {
        // test file creation
        testPermissionSetting(OpType.CREATE);
        // test directory creation
        testPermissionSetting(OpType.MKDIRS);
    ...
    @Test
    public void testImmutableFsPermission_withUpgrade20() throws IOException {
        fs = FileSystem.get(conf);
        // set the permission of the root to be world-wide rwx
        fs.setPermission(new Path("/"), FsPermission.createImmutable((short) 0777));
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 30000)
    public void testTrashPermission_withUpgrade20() throws Exception {
        //   /BSS/user1/test       user1:group1 600
        Path rootDir = new Path("/BSS");
        Path user1Dir = new Path("/BSS/user1");
        Path user1File = new Path("/BSS/user1/test");
    ...
    @Test(timeout = 30000)
    public void testTrashPermission_withUpgrade40() throws Exception {
        //   /BSS/user1/test       user1:group1 600
        Path rootDir = new Path("/BSS");
        Path user1Dir = new Path("/BSS/user1");
        Path user1File = new Path("/BSS/user1/test");
    ...
    @Test(timeout = 30000)
    public void testTrashPermission_withUpgrade60() throws Exception {
        //   /BSS/user1/test       user1:group1 600
        Path rootDir = new Path("/BSS");
        Path user1Dir = new Path("/BSS/user1");
        Path user1File = new Path("/BSS/user1/test");
    ...
    @Test(timeout = 30000)
    public void testTrashPermission_withUpgrade80() throws Exception {
        //   /BSS/user1/test       user1:group1 600
        Path rootDir = new Path("/BSS");
        Path user1Dir = new Path("/BSS/user1");
        Path user1File = new Path("/BSS/user1/test");
    ...
    @Test
    public void testOwnership_withUpgrade20() throws Exception {
        // test file creation
        testOwnership(OpType.CREATE);
        // test directory creation
        testOwnership(OpType.MKDIRS);
    ...
    @Test
    public void testPermissionChecking_withUpgrade20() throws Exception {
        try {
            fs = FileSystem.get(conf);
            // set the permission of the root to be world-wide rwx
            fs.setPermission(new Path("/"), new FsPermission((short) 0777));
    ...
    @Test
    public void testPermissionChecking_withUpgrade40() throws Exception {
        try {
            fs = FileSystem.get(conf);
            // set the permission of the root to be world-wide rwx
            fs.setPermission(new Path("/"), new FsPermission((short) 0777));
    ...
    @Test
    public void testAccessOwner_withUpgrade20() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p1 = new Path("/p1");
        rootFs.mkdirs(p1);
        rootFs.setOwner(p1, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testAccessOwner_withUpgrade40() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p1 = new Path("/p1");
        rootFs.mkdirs(p1);
        rootFs.setOwner(p1, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testAccessOwner_withUpgrade60() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p1 = new Path("/p1");
        rootFs.mkdirs(p1);
        rootFs.setOwner(p1, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testAccessOwner_withUpgrade80() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p1 = new Path("/p1");
        rootFs.mkdirs(p1);
        rootFs.setOwner(p1, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testAccessGroupMember_withUpgrade20() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p2 = new Path("/p2");
        rootFs.mkdirs(p2);
        rootFs.setOwner(p2, UserGroupInformation.getCurrentUser().getShortUserName(), GROUP1_NAME);
    ...
    @Test
    public void testAccessGroupMember_withUpgrade40() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p2 = new Path("/p2");
        rootFs.mkdirs(p2);
        rootFs.setOwner(p2, UserGroupInformation.getCurrentUser().getShortUserName(), GROUP1_NAME);
    ...
    @Test
    public void testAccessGroupMember_withUpgrade60() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p2 = new Path("/p2");
        rootFs.mkdirs(p2);
        rootFs.setOwner(p2, UserGroupInformation.getCurrentUser().getShortUserName(), GROUP1_NAME);
    ...
    @Test
    public void testAccessGroupMember_withUpgrade80() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p2 = new Path("/p2");
        rootFs.mkdirs(p2);
        rootFs.setOwner(p2, UserGroupInformation.getCurrentUser().getShortUserName(), GROUP1_NAME);
    ...
    @Test
    public void testAccessOthers_withUpgrade20() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p3 = new Path("/p3");
        rootFs.mkdirs(p3);
        rootFs.setPermission(p3, new FsPermission((short) 0774));
    ...
    @Test
    public void testAccessOthers_withUpgrade40() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p3 = new Path("/p3");
        rootFs.mkdirs(p3);
        rootFs.setPermission(p3, new FsPermission((short) 0774));
    ...
    @Test
    public void testAccessOthers_withUpgrade60() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p3 = new Path("/p3");
        rootFs.mkdirs(p3);
        rootFs.setPermission(p3, new FsPermission((short) 0774));
    ...
    @Test
    public void testAccessOthers_withUpgrade80() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p3 = new Path("/p3");
        rootFs.mkdirs(p3);
        rootFs.setPermission(p3, new FsPermission((short) 0774));
    ...
    @Test
    public void testPermissionMessageOnNonDirAncestor_withUpgrade20() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p4 = new Path("/p4");
        rootFs.mkdirs(p4);
        rootFs.setOwner(p4, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testPermissionMessageOnNonDirAncestor_withUpgrade40() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p4 = new Path("/p4");
        rootFs.mkdirs(p4);
        rootFs.setOwner(p4, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testPermissionMessageOnNonDirAncestor_withUpgrade60() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p4 = new Path("/p4");
        rootFs.mkdirs(p4);
        rootFs.setOwner(p4, USER1_NAME, GROUP1_NAME);
    ...
    @Test
    public void testPermissionMessageOnNonDirAncestor_withUpgrade80() throws IOException, InterruptedException {
        FileSystem rootFs = FileSystem.get(conf);
        Path p4 = new Path("/p4");
        rootFs.mkdirs(p4);
        rootFs.setOwner(p4, USER1_NAME, GROUP1_NAME);
