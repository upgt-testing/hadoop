...
public class TestViewFileSystemLinkMergeSlash extends ViewFileSystemBaseTest {
    ...
    private final static Logger LOG = LoggerFactory.getLogger(TestViewFileSystemLinkMergeSlash.class);
    ...
    void setupMountPoints() {
        ...
        ConfigUtil.addLinkMergeSlash(conf, LINK_MERGE_SLASH_CLUSTER_1_NAME, targetTestRoot.toUri());
        ConfigUtil.addLinkMergeSlash(conf, LINK_MERGE_SLASH_CLUSTER_2_NAME, targetTestRoot.toUri());
    }
    ...
    public void testConfLinkMergeSlashWithMountPoint() throws Exception {
        ...
        String mountTableEntry = Constants.CONFIG_VIEWFS_PREFIX + "." + clusterName + "." + Constants.CONFIG_VIEWFS_LINK_MERGE_SLASH + "." + mountPoint;
    ...
    public void testChildFileSystems() throws Exception {
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, LINK_MERGE_SLASH_CLUSTER_1_NAME, "/", null, null);
    ...
    @Test
    public void testConfLinkMergeSlash_withUpgrade20() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, clusterName, "/", null, null);
        String testFileName = "testLinkMergeSlash";
    ...
    @Test
    public void testConfLinkMergeSlash_withUpgrade40() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, clusterName, "/", null, null);
        String testFileName = "testLinkMergeSlash";
    ...
    @Test
    public void testConfLinkMergeSlash_withUpgrade60() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, clusterName, "/", null, null);
        String testFileName = "testLinkMergeSlash";
    ...
    @Test
    public void testConfLinkMergeSlash_withUpgrade80() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, clusterName, "/", null, null);
        String testFileName = "testLinkMergeSlash";
    ...
    @Test
    public void testConfLinkMergeSlashWithRegularLinks_withUpgrade20() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        String expectedErrorMsg1 = "Mount table ClusterMerge has already been " + "configured with a merge slash link";
        String expectedErrorMsg2 = "Mount table ClusterMerge has already been " + "configured with regular links";
    ...
    @Test
    public void testConfLinkMergeSlashWithRegularLinks_withUpgrade40() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        String expectedErrorMsg1 = "Mount table ClusterMerge has already been " + "configured with a merge slash link";
        String expectedErrorMsg2 = "Mount table ClusterMerge has already been " + "configured with regular links";
    ...
    @Test
    public void testConfLinkMergeSlashWithRegularLinks_withUpgrade60() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        String expectedErrorMsg1 = "Mount table ClusterMerge has already been " + "configured with a merge slash link";
        String expectedErrorMsg2 = "Mount table ClusterMerge has already been " + "configured with regular links";
    ...
    @Test
    public void testConfLinkMergeSlashWithRegularLinks_withUpgrade80() throws Exception {
        TEST_DIR.mkdirs();
        String clusterName = "ClusterMerge";
        String expectedErrorMsg1 = "Mount table ClusterMerge has already been " + "configured with a merge slash link";
        String expectedErrorMsg2 = "Mount table ClusterMerge has already been " + "configured with regular links";
    ...
    @Test
    public void testConfLinkMergeSlashWithMountPoint_withUpgrade20() throws Exception {
        TEST_DIR.mkdirs();
        Configuration conf = new Configuration();
        String clusterName = "ClusterX";
        String mountPoint = "/user";
    ...
    @Test
    public void testConfLinkMergeSlashWithMountPoint_withUpgrade40() throws Exception {
        TEST_DIR.mkdirs();
        Configuration conf = new Configuration();
        String clusterName = "ClusterX";
        String mountPoint = "/user";
    ...
    @Test
    public void testConfLinkMergeSlashWithMountPoint_withUpgrade60() throws Exception {
        TEST_DIR.mkdirs();
        Configuration conf = new Configuration();
        String clusterName = "ClusterX";
        String mountPoint = "/user";
    ...
    @Test
    public void testConfLinkMergeSlashWithMountPoint_withUpgrade80() throws Exception {
        TEST_DIR.mkdirs();
        Configuration conf = new Configuration();
        String clusterName = "ClusterX";
        String mountPoint = "/user";
    ...
    @Test
    public void testChildFileSystems_withUpgrade20() throws Exception {
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, LINK_MERGE_SLASH_CLUSTER_1_NAME, "/", null, null);
        FileSystem fs = FileSystem.get(viewFsUri, conf);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testChildFileSystems_withUpgrade40() throws Exception {
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, LINK_MERGE_SLASH_CLUSTER_1_NAME, "/", null, null);
        FileSystem fs = FileSystem.get(viewFsUri, conf);
        FileSystem[] childFs = fs.getChildFileSystems();
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testChildFileSystems_withUpgrade60() throws Exception {
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, LINK_MERGE_SLASH_CLUSTER_1_NAME, "/", null, null);
        FileSystem fs = FileSystem.get(viewFsUri, conf);
        FileSystem[] childFs = fs.getChildFileSystems();
        Assert.assertEquals("Unexpected number of child filesystems!", 1, childFs.length);
    ...
    @Test
    public void testChildFileSystems_withUpgrade80() throws Exception {
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, LINK_MERGE_SLASH_CLUSTER_1_NAME, "/", null, null);
        FileSystem fs = FileSystem.get(viewFsUri, conf);
        FileSystem[] childFs = fs.getChildFileSystems();
        Assert.assertEquals("Unexpected number of child filesystems!", 1, childFs.length);
