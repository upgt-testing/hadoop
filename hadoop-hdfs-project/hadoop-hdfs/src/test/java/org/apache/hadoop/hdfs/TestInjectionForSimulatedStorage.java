...
public class TestInjectionForSimulatedStorage {
   ...
   */
    ...
    @Test
    public void testInjection_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
        byte[] buffer = new byte[1024];
    ...
    @Test
    public void testInjection_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
        byte[] buffer = new byte[1024];
    ...
    @Test
    public void testInjection_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
        byte[] buffer = new byte[1024];
    ...
    @Test
    public void testInjection_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
        byte[] buffer = new byte[1024];
