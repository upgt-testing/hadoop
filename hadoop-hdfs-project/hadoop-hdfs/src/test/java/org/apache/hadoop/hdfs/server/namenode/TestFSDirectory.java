...
public class TestFSDirectory {
   ...
   */
    @Test
    public void testDumpTree_withUpgrade20() throws Exception {
        final INodeJVMInterface root = fsdir.getINode("/");
        LOG.info("Original tree");
        final StringBuffer b1 = root.dumpTreeRecursively();
        System.out.println("b1=" + b1);
    ...
    @Test
    public void testDumpTree_withUpgrade40() throws Exception {
        final INodeJVMInterface root = fsdir.getINode("/");
        LOG.info("Original tree");
        final StringBuffer b1 = root.dumpTreeRecursively();
        System.out.println("b1=" + b1);
    ...
    @Test
    public void testDumpTree_withUpgrade60() throws Exception {
        final INodeJVMInterface root = fsdir.getINode("/");
        LOG.info("Original tree");
        final StringBuffer b1 = root.dumpTreeRecursively();
        System.out.println("b1=" + b1);
    ...
    @Test
    public void testDumpTree_withUpgrade80() throws Exception {
        final INodeJVMInterface root = fsdir.getINode("/");
        LOG.info("Original tree");
        final StringBuffer b1 = root.dumpTreeRecursively();
        System.out.println("b1=" + b1);
    ...
    @Test
    public void testSkipQuotaCheck_withUpgrade20() throws Exception {
        try {
            // set quota. nsQuota of 1 means no files can be created
            //  under this directory.
            hdfs.setQuota(sub2, 1, Long.MAX_VALUE);
    ...
    @Test
    public void testSkipQuotaCheck_withUpgrade40() throws Exception {
        try {
            // set quota. nsQuota of 1 means no files can be created
            //  under this directory.
            hdfs.setQuota(sub2, 1, Long.MAX_VALUE);
    ...
    @Test
    public void testSkipQuotaCheck_withUpgrade60() throws Exception {
        try {
            // set quota. nsQuota of 1 means no files can be created
            //  under this directory.
            hdfs.setQuota(sub2, 1, Long.MAX_VALUE);
    ...
    @Test
    public void testINodeXAttrsLimit_withUpgrade20() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(2);
        XAttr xAttr1 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a1").setValue(new byte[] { 0x31, 0x32, 0x33 }).build();
        XAttr xAttr2 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a2").setValue(new byte[] { 0x31, 0x31, 0x31 }).build();
        existingXAttrs.add(xAttr1);
    ...
    @Test
    public void testINodeXAttrsLimit_withUpgrade40() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(2);
        XAttr xAttr1 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a1").setValue(new byte[] { 0x31, 0x32, 0x33 }).build();
        XAttr xAttr2 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a2").setValue(new byte[] { 0x31, 0x31, 0x31 }).build();
        existingXAttrs.add(xAttr1);
    ...
    @Test
    public void testINodeXAttrsLimit_withUpgrade60() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(2);
        XAttr xAttr1 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a1").setValue(new byte[] { 0x31, 0x32, 0x33 }).build();
        XAttr xAttr2 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a2").setValue(new byte[] { 0x31, 0x31, 0x31 }).build();
        existingXAttrs.add(xAttr1);
    ...
    @Test
    public void testINodeXAttrsLimit_withUpgrade80() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(2);
        XAttr xAttr1 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a1").setValue(new byte[] { 0x31, 0x32, 0x33 }).build();
        XAttr xAttr2 = (new XAttr.Builder()).setNameSpace(XAttr.NameSpace.USER).setName("a2").setValue(new byte[] { 0x31, 0x31, 0x31 }).build();
        existingXAttrs.add(xAttr1);
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiSetRemove_withUpgrade20() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(0);
        // Keep adding a random number of xattrs and verifying until exhausted
        final Random rand = new Random(0xFEEDA);
        int numExpectedXAttrs = 0;
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiSetRemove_withUpgrade40() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(0);
        // Keep adding a random number of xattrs and verifying until exhausted
        final Random rand = new Random(0xFEEDA);
        int numExpectedXAttrs = 0;
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiSetRemove_withUpgrade60() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(0);
        // Keep adding a random number of xattrs and verifying until exhausted
        final Random rand = new Random(0xFEEDA);
        int numExpectedXAttrs = 0;
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiSetRemove_withUpgrade80() throws Exception {
        List<XAttr> existingXAttrs = Lists.newArrayListWithCapacity(0);
        // Keep adding a random number of xattrs and verifying until exhausted
        final Random rand = new Random(0xFEEDA);
        int numExpectedXAttrs = 0;
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiAddRemoveErrors_withUpgrade20() throws Exception {
        // Test that the same XAttr can not be multiset twice
        List<XAttr> existingXAttrs = Lists.newArrayList();
        List<XAttr> toAdd = Lists.newArrayList();
        toAdd.add(generatedXAttrs.get(0));
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiAddRemoveErrors_withUpgrade40() throws Exception {
        // Test that the same XAttr can not be multiset twice
        List<XAttr> existingXAttrs = Lists.newArrayList();
        List<XAttr> toAdd = Lists.newArrayList();
        toAdd.add(generatedXAttrs.get(0));
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiAddRemoveErrors_withUpgrade60() throws Exception {
        // Test that the same XAttr can not be multiset twice
        List<XAttr> existingXAttrs = Lists.newArrayList();
        List<XAttr> toAdd = Lists.newArrayList();
        toAdd.add(generatedXAttrs.get(0));
    ...
    @Test(timeout = 300000)
    public void testXAttrMultiAddRemoveErrors_withUpgrade80() throws Exception {
        // Test that the same XAttr can not be multiset twice
        List<XAttr> existingXAttrs = Lists.newArrayList();
        List<XAttr> toAdd = Lists.newArrayList();
        toAdd.add(generatedXAttrs.get(0));
