...
public class TestHDFSFileContextMainOperations_RestartInjected extends
  ...
  public void testTruncate() throws Exception {
    RestartFramework.at("before_test_truncate")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_test_truncate")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testOldRenameWithQuota() throws Exception {
    RestartFramework.at("before_test_old_rename_with_quota")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_old_rename_with_quota")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameWithQuota() throws Exception {
    RestartFramework.at("before_test_rename_with_quota")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_rename_with_quota")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameRoot() throws Exception {
    RestartFramework.at("before_test_rename_root")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_rename_root")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameToRoot() throws Exception {
    RestartFramework.at("before_test_rename_to_root")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_rename_to_root")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testEditsLogOldRename() throws Exception {
    RestartFramework.at("before_test_edits_log_old_rename")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_edits_log_old_rename")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testEditsLogRename() throws Exception {
    RestartFramework.at("before_test_edits_log_rename")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    Assert.assertFalse(fs.exists(src1));   // ensure src1 is already renamed
    Assert.assertTrue(fs.exists(dst1));    // ensure rename dst exists
    RestartFramework.at("after_test_edits_log_rename")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testIsValidNameInvalidNames() {
    RestartFramework.at("before_test_is_valid_name_invalid_names")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_is_valid_name_invalid_names")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCrossFileSystemRename() throws IOException {
    RestartFramework.at("before_test_cross_file_system_rename")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_test_cross_file_system_rename")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
