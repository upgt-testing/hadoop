 ...
 * dependencies to {@link MiniDockerDFSCluster}.
 */
public class DataNodeTestUtils {

    private static final Logger LOG = LoggerFactory.getLogger(DataNodeTestUtils.class);
    ...
    public static void setHeartbeatsDisabledForTests(DataNodeInterface dn, boolean heartbeatsDisabledForTests) {
        dn.setHeartbeatsDisabledForTests(heartbeatsDisabledForTests);
    }
     ...
     */
    public static void setCacheReportsDisabledForTests(MiniDockerDFSCluster cluster, boolean disabled) {
    ...
    public static void pauseIBR(DataNodeInterface dn) {
        dn.setIBRDisabledForTest(true);
    }
    ...
    public static InterDatanodeProtocol createInterDatanodeProtocolProxy(DataNode dn, DatanodeID datanodeid, final Configuration conf, boolean connectToDnViaHostname) throws IOException {
    ...
    public static FsDatasetSpi<?> getFSDataset(DataNodeInterface dn) {
        return dn.getFSDataset();
    }
