...
public class TestSetQuotaWithSnapshot_RestartInjected_Randomized_456 {
    ...
    public void testClearQuota() throws Exception {
        ...
        RestartFramework.at("after_file_creation_in_snapshot").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_clear_quota").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
