 ...
 * memory
 */
public class TestLazyPersistLockedMemory_RestartInjected_Randomized_123 extends LazyPersistTestCase {
    ...
    public void testReleaseOnEviction() throws Exception {
        ...
        RestartFramework.at("before_eviction").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testWritePipelineFailure() throws IOException, TimeoutException, InterruptedException {
        ...
        RestartFramework.at("after_write_hsync").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fos.hsync();
