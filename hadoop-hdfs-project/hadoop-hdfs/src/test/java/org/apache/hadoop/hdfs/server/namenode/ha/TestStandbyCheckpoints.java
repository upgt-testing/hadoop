...
public class TestStandbyCheckpoints {
    ...
    public void setupCluster() throws Exception {
        ...
        while (true) {
            try {
                ...
                cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(topology).numDataNodes(1).build();
                cluster.waitActive();
                setNNs();
                ...
                LOG.info("Set up MiniDFSClusterInJVM failed due to port conflicts, retry " + retryCount + " times");
            }
        }
    }
   ...
   */
    ...
    public void testCheckpointCancellation() throws Exception {
        ...
        File tmpDir = new File(MiniDFSClusterInJVM.getBaseDirectory(), "testCheckpointCancellation-tmp");
   ...
   */
    ...
    @Test
    public void testNewDirInitAfterCheckpointing_withUpgrade20() throws Exception {
        File hdfsDir = new File(PathUtils.getTestDir(TestStandbyCheckpoints.class), "testNewDirInitAfterCheckpointing");
        File nameDir = new File(hdfsDir, "name1");
        assert nameDir.mkdirs();
        // Restart nn0 with an additional name dir.
    ...
    @Test
    public void testNewDirInitAfterCheckpointing_withUpgrade40() throws Exception {
        File hdfsDir = new File(PathUtils.getTestDir(TestStandbyCheckpoints.class), "testNewDirInitAfterCheckpointing");
        File nameDir = new File(hdfsDir, "name1");
        assert nameDir.mkdirs();
        // Restart nn0 with an additional name dir.
    ...
    @Test
    public void testNewDirInitAfterCheckpointing_withUpgrade60() throws Exception {
        File hdfsDir = new File(PathUtils.getTestDir(TestStandbyCheckpoints.class), "testNewDirInitAfterCheckpointing");
        File nameDir = new File(hdfsDir, "name1");
        assert nameDir.mkdirs();
        // Restart nn0 with an additional name dir.
    ...
    @Test
    public void testNewDirInitAfterCheckpointing_withUpgrade80() throws Exception {
        File hdfsDir = new File(PathUtils.getTestDir(TestStandbyCheckpoints.class), "testNewDirInitAfterCheckpointing");
        File nameDir = new File(hdfsDir, "name1");
        assert nameDir.mkdirs();
        // Restart nn0 with an additional name dir.
    ...
    @Test(timeout = 300000)
    public void testBothNodesInStandbyState_withUpgrade20() throws Exception {
        doEdits(0, 10);
        cluster.transitionToStandby(0);
        // will each try to take a checkpoint and upload to each other.
        HATestUtil.waitForCheckpoint(cluster, 1, ImmutableList.of(12));
    ...
    @Test(timeout = 300000)
    public void testBothNodesInStandbyState_withUpgrade40() throws Exception {
        doEdits(0, 10);
        cluster.transitionToStandby(0);
        // will each try to take a checkpoint and upload to each other.
        HATestUtil.waitForCheckpoint(cluster, 1, ImmutableList.of(12));
    ...
    @Test(timeout = 300000)
    public void testBothNodesInStandbyState_withUpgrade60() throws Exception {
        doEdits(0, 10);
        cluster.transitionToStandby(0);
        // will each try to take a checkpoint and upload to each other.
        HATestUtil.waitForCheckpoint(cluster, 1, ImmutableList.of(12));
    ...
    @Test(timeout = 300000)
    public void testBothNodesInStandbyState_withUpgrade80() throws Exception {
        doEdits(0, 10);
        cluster.transitionToStandby(0);
        // will each try to take a checkpoint and upload to each other.
        HATestUtil.waitForCheckpoint(cluster, 1, ImmutableList.of(12));
    ...
    @Test(timeout = 300000)
    public void testStandbyAndObserverState_withUpgrade20() throws Exception {
        // Transition 2 to observer
        cluster.transitionToObserver(1);
        doEdits(0, 10);
        // ahead of observer(nn2).
    ...
    @Test(timeout = 300000)
    public void testStandbyAndObserverState_withUpgrade40() throws Exception {
        // Transition 2 to observer
        cluster.transitionToObserver(1);
        doEdits(0, 10);
        // ahead of observer(nn2).
    ...
    @Test(timeout = 300000)
    public void testStandbyAndObserverState_withUpgrade60() throws Exception {
        // Transition 2 to observer
        cluster.transitionToObserver(1);
        doEdits(0, 10);
        // ahead of observer(nn2).
    ...
    @Test(timeout = 300000)
    public void testStandbyAndObserverState_withUpgrade80() throws Exception {
        // Transition 2 to observer
        cluster.transitionToObserver(1);
        doEdits(0, 10);
        // ahead of observer(nn2).
    ...
    @Test(timeout = 30000)
    public void testCheckpointBeforeNameNodeInitializationIsComplete_withUpgrade20() throws Exception {
        final LogVerificationAppender appender = new LogVerificationAppender();
        final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getRootLogger();
        logger.addAppender(appender);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 30000)
    public void testCheckpointBeforeNameNodeInitializationIsComplete_withUpgrade40() throws Exception {
        final LogVerificationAppender appender = new LogVerificationAppender();
        final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getRootLogger();
        logger.addAppender(appender);
        // Transition 2 to observer
    ...
    @Test(timeout = 30000)
    public void testCheckpointBeforeNameNodeInitializationIsComplete_withUpgrade60() throws Exception {
        final LogVerificationAppender appender = new LogVerificationAppender();
        final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getRootLogger();
        logger.addAppender(appender);
        // Transition 2 to observer
    ...
    @Test(timeout = 30000)
    public void testCheckpointBeforeNameNodeInitializationIsComplete_withUpgrade80() throws Exception {
        final LogVerificationAppender appender = new LogVerificationAppender();
        final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getRootLogger();
        logger.addAppender(appender);
        // Transition 2 to observer
    ...
    @Test(timeout = 120000)
    public void testCheckpointCancellation_withUpgrade20() throws Exception {
        cluster.transitionToStandby(0);
        // (only ~15MB)
        URI sharedUri = cluster.getSharedEditsDir(0, 1);
        File sharedDir = new File(sharedUri.getPath(), "current");
    ...
    @Test(timeout = 120000)
    public void testCheckpointCancellation_withUpgrade40() throws Exception {
        cluster.transitionToStandby(0);
        // (only ~15MB)
        URI sharedUri = cluster.getSharedEditsDir(0, 1);
        File sharedDir = new File(sharedUri.getPath(), "current");
    ...
    @Test(timeout = 120000)
    public void testCheckpointCancellation_withUpgrade60() throws Exception {
        cluster.transitionToStandby(0);
        // (only ~15MB)
        URI sharedUri = cluster.getSharedEditsDir(0, 1);
        File sharedDir = new File(sharedUri.getPath(), "current");
    ...
    @Test(timeout = 120000)
    public void testCheckpointCancellation_withUpgrade80() throws Exception {
        cluster.transitionToStandby(0);
        // (only ~15MB)
        URI sharedUri = cluster.getSharedEditsDir(0, 1);
        File sharedDir = new File(sharedUri.getPath(), "current");
    ...
    @Test(timeout = 60000)
    public void testCheckpointCancellationDuringUpload_withUpgrade20() throws Exception {
        // doing checkpoint when it becomes a standby
        cluster.getConfiguration(0).setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000);
        // don't compress, we want a big image
        for (int i = 0; i < NUM_NNS; i++) {
    ...
    @Test(timeout = 60000)
    public void testCheckpointCancellationDuringUpload_withUpgrade40() throws Exception {
        // doing checkpoint when it becomes a standby
        cluster.getConfiguration(0).setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000);
        // don't compress, we want a big image
        for (int i = 0; i < NUM_NNS; i++) {
    ...
    @Test(timeout = 60000)
    public void testCheckpointCancellationDuringUpload_withUpgrade60() throws Exception {
        // doing checkpoint when it becomes a standby
        cluster.getConfiguration(0).setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000);
        // don't compress, we want a big image
        for (int i = 0; i < NUM_NNS; i++) {
    ...
    @Test(timeout = 300000)
    public void testCheckpointSucceedsWithLegacyOIVException_withUpgrade20() throws Exception {
        // Delete the OIV image dir to cause an IOException while saving
        FileUtil.fullyDelete(tmpOivImgDir);
        doEdits(0, 10);
        cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 300000)
    public void testCheckpointSucceedsWithLegacyOIVException_withUpgrade40() throws Exception {
        // Delete the OIV image dir to cause an IOException while saving
        FileUtil.fullyDelete(tmpOivImgDir);
        doEdits(0, 10);
        HATestUtil.waitForStandbyToCatchUp(nns[0], nns[1]);
    ...
    @Test(timeout = 300000)
    public void testCheckpointSucceedsWithLegacyOIVException_withUpgrade60() throws Exception {
        // Delete the OIV image dir to cause an IOException while saving
        FileUtil.fullyDelete(tmpOivImgDir);
        doEdits(0, 10);
        HATestUtil.waitForStandbyToCatchUp(nns[0], nns[1]);
    ...
    @Test(timeout = 300000)
    public void testCheckpointSucceedsWithLegacyOIVException_withUpgrade80() throws Exception {
        // Delete the OIV image dir to cause an IOException while saving
        FileUtil.fullyDelete(tmpOivImgDir);
        doEdits(0, 10);
        HATestUtil.waitForStandbyToCatchUp(nns[0], nns[1]);
    ...
    @Test(timeout = 300000)
    public void testNonPrimarySBNUploadFSImage_withUpgrade20() throws Exception {
        // Shutdown all standby NNs.
        for (int i = 1; i < NUM_NNS; i++) {
            cluster.shutdownNameNode(i);
            // Checkpoint as fast as we can, in a tight loop.
    ...
    @Test(timeout = 300000)
    public void testNonPrimarySBNUploadFSImage_withUpgrade40() throws Exception {
        // Shutdown all standby NNs.
        for (int i = 1; i < NUM_NNS; i++) {
            cluster.shutdownNameNode(i);
            // Checkpoint as fast as we can, in a tight loop.
    ...
    @Test(timeout = 300000)
    public void testNonPrimarySBNUploadFSImage_withUpgrade60() throws Exception {
        // Shutdown all standby NNs.
        for (int i = 1; i < NUM_NNS; i++) {
            cluster.shutdownNameNode(i);
            // Checkpoint as fast as we can, in a tight loop.
    ...
    @Test(timeout = 300000)
    public void testNonPrimarySBNUploadFSImage_withUpgrade80() throws Exception {
        // Shutdown all standby NNs.
        for (int i = 1; i < NUM_NNS; i++) {
            cluster.shutdownNameNode(i);
            // Checkpoint as fast as we can, in a tight loop.
