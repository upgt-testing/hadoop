...
public class TestBlockReaderFactory_RestartInjected {
  ...
  public void testMultipleWaitersOnShortCircuitCache()
    ...
    RestartFramework.at("after_cluster_start_multiwaiter")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_multiwaiter")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testShortCircuitCacheTemporaryFailure()
    ...
    RestartFramework.at("after_cluster_start_temp_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_temp_failure")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  private void testShortCircuitCacheUnbufferWithDisableInterval(
    ...
    try (TemporarySocketDirectory sockDir = new TemporarySocketDirectory()) {
      ...
      try (MiniDFSCluster cluster = builder.build();
        ...
        RestartFramework.at("after_cluster_start_unbuffer")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_file_creation_unbuffer")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testShortCircuitReadFromServerWithoutShm() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_no_shm_server")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_no_shm_server")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testShortCircuitReadFromClientWithoutShm() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_no_shm_client")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_no_shm_client")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testShortCircuitCacheShutdown() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_cache_shutdown")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_cache_shutdown")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPurgingClosedReplicas() throws Exception {
    ...
    RestartFramework.at("after_cluster_start_purge_replicas")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file_creation_purge_replicas")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
