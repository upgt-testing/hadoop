...
public class TestSnapshotBlocksMap {
    ...
    public void testDeletionWithSnapshots() throws Exception {
        ...
        // Normal deletion
        {
            final INodeFileInterface f2 = assertBlockCollection(file2.toString(), 3, fsdir, blockmanager);
        ...
        {
            INodeFileInterface f1 = assertBlockCollection(file1.toString(), 2, fsdir, blockmanager);
   ...
   */
    ...
    public void testDeletionWithZeroSizeBlock3() throws Exception {
        ...
        INodeFileInterface bar2Node = fsdir.getINode4Write(bar2.toString()).asFile();
