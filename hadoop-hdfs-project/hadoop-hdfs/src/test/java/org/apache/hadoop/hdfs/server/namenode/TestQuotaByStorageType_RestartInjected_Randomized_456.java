...
public class TestQuotaByStorageType_RestartInjected_Randomized_456 {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(TestQuotaByStorageType_RestartInjected.class);
    ...
    public void setUp() throws Exception {
        ...
        cluster = new MiniDFSCluster.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DEFAULT }).build();
        cluster.waitActive();
        refreshClusterState();
