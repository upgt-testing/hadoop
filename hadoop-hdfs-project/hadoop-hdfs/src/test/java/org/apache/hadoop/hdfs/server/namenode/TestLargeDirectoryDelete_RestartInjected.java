 ...
 */
public class TestLargeDirectoryDelete_RestartInjected {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestLargeDirectoryDelete_RestartInjected.class);
  ...
  public void largeDelete() throws Throwable {
    ...
    try {
      ...
      RestartFramework.at("before_large_delete")
          .on(mc)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
          .execute();
      runThreads();
      RestartFramework.at("after_large_delete")
          .on(mc)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
