...
public class TestFileAppend_RestartInjected{
  ...
  public void testBreakHardlinksIfNeeded() throws IOException {
    ...
    try {
      ...
      writeFile(stm);
      stm.close();
      RestartFramework.at("after_file_write_close")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
  ...
  public void testSimpleFlush() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_file_creation_simple_flush")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testComplexFlush() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_file_creation_complex_flush")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppendTwice() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_full_block_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppend2Twice() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_full_block_creation_append2")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppendAfterSoftLimit() 
    ...
    RestartFramework.at("after_file_write_soft_limit")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppend2AfterSoftLimit() throws Exception {
    ...
    FSDataOutputStream out = fs.create(testPath);
    out.write(fileContents);
    RestartFramework.at("after_file_write_soft_limit_append2")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultiAppend2() throws Exception {
    ...
    try {
      ...
      out.writeBytes(hello);
      out.close();
      RestartFramework.at("after_initial_file_creation_multi_append2")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppendCorruptedBlock() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_file_creation_before_corruption")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testConcurrentAppendRead()
    ...
    try {
      ...
      DFSTestUtil.waitReplication(fs, fileName, (short) 1);
      Assert.assertTrue("File not created", fs.exists(fileName));
      RestartFramework.at("after_file_creation_concurrent_append")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
