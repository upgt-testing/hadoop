...
public class TestDataNodeMXBean extends SaslDataTransferTestCase {
    ...
    @Test
    public void testDataNodeMXBeanSecurityEnabled_withUpgrade20() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // get attribute "SecurityEnabled" with simple configuration
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(simpleConf).build()) {
    ...
    @Test
    public void testDataNodeMXBeanSecurityEnabled_withUpgrade40() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // get attribute "SecurityEnabled" with simple configuration
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(simpleConf).build()) {
    ...
    @Test
    public void testDataNodeMXBeanSecurityEnabled_withUpgrade60() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // get attribute "SecurityEnabled" with simple configuration
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(simpleConf).build()) {
    ...
    @Test
    public void testDataNodeMXBeanSecurityEnabled_withUpgrade80() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // get attribute "SecurityEnabled" with simple configuration
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(simpleConf).build()) {
