 ...
 * mount point.
 */
public class TestViewFsAtHdfsRoot_RestartInjected_Randomized_456 extends ViewFsBaseTest {
    ...
    void initializeTargetTestRoot() throws IOException {
        ...
        RestartFramework.at("after_cleanup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
