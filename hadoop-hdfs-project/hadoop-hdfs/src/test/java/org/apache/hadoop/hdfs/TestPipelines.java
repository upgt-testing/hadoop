...
public class TestPipelines {
    ...
    public void pipeline_01() throws IOException {
        ...
        List<LocatedBlockJVMInterface> lb = new ArrayList<>(cluster.getNameNodeRpc().getBlockLocations(filePath.toString(), FILE_SIZE - 1, FILE_SIZE).getLocatedBlocks());
        /*
    ...
    @Test
    public void pipeline_01_withUpgrade20() throws IOException {
        final String METHOD_NAME = GenericTestUtils.getMethodName();
        if (LOG.isDebugEnabled()) {
            LOG.debug("Running " + METHOD_NAME);
    ...
    @Test
    public void pipeline_01_withUpgrade40() throws IOException {
        final String METHOD_NAME = GenericTestUtils.getMethodName();
        if (LOG.isDebugEnabled()) {
            LOG.debug("Running " + METHOD_NAME);
        }
    ...
    @Test
    public void pipeline_01_withUpgrade80() throws IOException {
        final String METHOD_NAME = GenericTestUtils.getMethodName();
        if (LOG.isDebugEnabled()) {
            LOG.debug("Running " + METHOD_NAME);
        }
