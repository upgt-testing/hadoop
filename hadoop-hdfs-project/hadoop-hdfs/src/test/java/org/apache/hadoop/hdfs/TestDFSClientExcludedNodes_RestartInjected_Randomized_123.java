 ...
 */
public class TestDFSClientExcludedNodes_RestartInjected_Randomized_123 {
    ...
    public void testExcludedNodes() throws IOException {
        ...
        out.write(20);
        RestartFramework.at("after_datanode_killed").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
            out.close();
        } catch (Exception e) {
    ...
    public void testExcludedNodesForgiveness() throws IOException {
        ...
        RestartFramework.at("after_datanodes_restarted").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        out.write(bytes);
        out.hflush();
        RestartFramework.at("after_first_block_write").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
