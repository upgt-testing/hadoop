...
public class TestViewFileSystemHdfs extends ViewFileSystemBaseTest {
    ...
    @Test
    public void testTrashRootsAfterEncryptionZoneDeletion_withUpgrade20() throws Exception {
        final Path zone = new Path("/EZ");
        fsTarget.mkdirs(zone);
        final Path zone1 = new Path("/EZ/zone1");
        fsTarget.mkdirs(zone1);
    ...
    @Test
    public void testTrashRootsAfterEncryptionZoneDeletion_withUpgrade40() throws Exception {
        final Path zone = new Path("/EZ");
        fsTarget.mkdirs(zone);
        final Path zone1 = new Path("/EZ/zone1");
        fsTarget.mkdirs(zone1);
    ...
    @Test
    public void testTrashRootsAfterEncryptionZoneDeletion_withUpgrade60() throws Exception {
        final Path zone = new Path("/EZ");
        fsTarget.mkdirs(zone);
        final Path zone1 = new Path("/EZ/zone1");
        fsTarget.mkdirs(zone1);
    ...
    @Test
    public void testTrashRootsAfterEncryptionZoneDeletion_withUpgrade80() throws Exception {
        final Path zone = new Path("/EZ");
        fsTarget.mkdirs(zone);
        final Path zone1 = new Path("/EZ/zone1");
        fsTarget.mkdirs(zone1);
