...
public class TestViewFileSystemHdfs extends ViewFileSystemBaseTest {
    ...
    private void testNflyRepair(NflyFSystem.NflyKey repairKey) throws Exception {
        ...
        ConfigUtil.addLinkNfly(testConf, Constants.CONFIG_VIEWFS_DEFAULT_MOUNT_TABLE, nflyRoot.toString(), "minReplication=2," + repairKey + "=true", testUris);
    ...
    @Test
    public void testTargetFileSystemLazyInitializationWithUgi_withUpgrade20() throws Exception {
        final Map<String, FileSystem> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileSystem fs = FileSystem.get(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testTargetFileSystemLazyInitializationWithUgi_withUpgrade40() throws Exception {
        final Map<String, FileSystem> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileSystem fs = FileSystem.get(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testTargetFileSystemLazyInitializationWithUgi_withUpgrade60() throws Exception {
        final Map<String, FileSystem> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileSystem fs = FileSystem.get(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testTargetFileSystemLazyInitializationWithUgi_withUpgrade80() throws Exception {
        final Map<String, FileSystem> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileSystem fs = FileSystem.get(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testNflyMostRecentRepair_withUpgrade20() throws Exception {
        testNflyRepair(NflyFSystem.NflyKey.readMostRecent);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
