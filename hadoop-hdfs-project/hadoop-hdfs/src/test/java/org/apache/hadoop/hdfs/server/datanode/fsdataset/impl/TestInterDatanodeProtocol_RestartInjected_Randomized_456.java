 ...
 */
public class TestInterDatanodeProtocol_RestartInjected_Randomized_456 {
    ...
    private void checkBlockMetaDataInfo(boolean useDnHostname) throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_replica_recovery_init").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            //verify updateBlock
            RestartFramework.at("before_block_update").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testUpdateReplicaUnderRecovery() throws IOException {
        ...
        try {
            ...
            //update
            RestartFramework.at("before_replica_update").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
