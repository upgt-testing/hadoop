 ...
 */
public class TestViewFileSystemOverloadSchemeWithDFSAdmin_RestartInjected {
  ...
  public void testSaveNameSpace() throws Exception {
    ...
    RestartFramework.at("after_mount_links_configured")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
  ...
  public void testGetSafemodeWithoutMountLinksConfigured() throws Exception {
    RestartFramework.at("before_safemode_get")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
