...
public class TestBlockReaderLocalLegacy {
    ...
    public void testStablePositionAfterCorruptRead() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, basedir).numDataNodes(1).build();
        cluster.waitActive();
    ...
    public void testBlockReaderLocalLegacyWithAppend() throws Exception {
        ...
        conf.setBoolean(HdfsClientConfigKeys.DFS_CLIENT_USE_LEGACY_BLOCKREADERLOCAL, true);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, basedir).numDataNodes(1).build();
        cluster.waitActive();
        ...
        {
            final LocatedBlockJVMInterface lb = cluster.getNameNode().getRpcServer().getBlockLocations(path.toString(), 0, 1).get(0);
            /*
    ...
    @Test
    public void testStablePositionAfterCorruptRead_withUpgrade20() throws Exception {
        final short REPL_FACTOR = 1;
        final long FILE_LENGTH = 512L;
        HdfsConfiguration conf = getConfiguration(null);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testStablePositionAfterCorruptRead_withUpgrade40() throws Exception {
        final short REPL_FACTOR = 1;
        final long FILE_LENGTH = 512L;
        HdfsConfiguration conf = getConfiguration(null);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testStablePositionAfterCorruptRead_withUpgrade60() throws Exception {
        final short REPL_FACTOR = 1;
        final long FILE_LENGTH = 512L;
        HdfsConfiguration conf = getConfiguration(null);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testStablePositionAfterCorruptRead_withUpgrade80() throws Exception {
        final short REPL_FACTOR = 1;
        final long FILE_LENGTH = 512L;
        HdfsConfiguration conf = getConfiguration(null);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testBothOldAndNewShortCircuitConfigured_withUpgrade20() throws Exception {
        final short REPL_FACTOR = 1;
        final int FILE_LENGTH = 512;
        Assume.assumeTrue(null == DomainSocket.getLoadingFailureReason());
        TemporarySocketDirectory socketDir = new TemporarySocketDirectory();
    ...
    @Test
    public void testBothOldAndNewShortCircuitConfigured_withUpgrade40() throws Exception {
        final short REPL_FACTOR = 1;
        final int FILE_LENGTH = 512;
        Assume.assumeTrue(null == DomainSocket.getLoadingFailureReason());
        TemporarySocketDirectory socketDir = new TemporarySocketDirectory();
    ...
    @Test
    public void testBothOldAndNewShortCircuitConfigured_withUpgrade60() throws Exception {
        final short REPL_FACTOR = 1;
        final int FILE_LENGTH = 512;
        Assume.assumeTrue(null == DomainSocket.getLoadingFailureReason());
        TemporarySocketDirectory socketDir = new TemporarySocketDirectory();
    ...
    @Test
    public void testBothOldAndNewShortCircuitConfigured_withUpgrade80() throws Exception {
        final short REPL_FACTOR = 1;
        final int FILE_LENGTH = 512;
        Assume.assumeTrue(null == DomainSocket.getLoadingFailureReason());
        TemporarySocketDirectory socketDir = new TemporarySocketDirectory();
    ...
    @Test(timeout = 20000)
    public void testBlockReaderLocalLegacyWithAppend_withUpgrade20() throws Exception {
        final short REPL_FACTOR = 1;
        final HdfsConfiguration conf = getConfiguration(null);
        conf.setBoolean(HdfsClientConfigKeys.DFS_CLIENT_USE_LEGACY_BLOCKREADERLOCAL, true);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test(timeout = 20000)
    public void testBlockReaderLocalLegacyWithAppend_withUpgrade40() throws Exception {
        final short REPL_FACTOR = 1;
        final HdfsConfiguration conf = getConfiguration(null);
        conf.setBoolean(HdfsClientConfigKeys.DFS_CLIENT_USE_LEGACY_BLOCKREADERLOCAL, true);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test(timeout = 20000)
    public void testBlockReaderLocalLegacyWithAppend_withUpgrade60() throws Exception {
        final short REPL_FACTOR = 1;
        final HdfsConfiguration conf = getConfiguration(null);
        conf.setBoolean(HdfsClientConfigKeys.DFS_CLIENT_USE_LEGACY_BLOCKREADERLOCAL, true);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test(timeout = 20000)
    public void testBlockReaderLocalLegacyWithAppend_withUpgrade80() throws Exception {
        final short REPL_FACTOR = 1;
        final HdfsConfiguration conf = getConfiguration(null);
        conf.setBoolean(HdfsClientConfigKeys.DFS_CLIENT_USE_LEGACY_BLOCKREADERLOCAL, true);
        File basedir = new File(GenericTestUtils.getRandomizedTempPath());
