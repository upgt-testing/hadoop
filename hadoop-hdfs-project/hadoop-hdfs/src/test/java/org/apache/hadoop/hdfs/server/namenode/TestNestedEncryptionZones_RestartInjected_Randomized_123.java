 ...
 */
public class TestNestedEncryptionZones_RestartInjected_Randomized_123 {
    ...
    public void testNestedEncryptionZones() throws Exception {
        ...
        RestartFramework.at("after_rename_nested_ez").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_checkpoint_verification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        cluster.waitActive();
        fs = cluster.getFileSystem();
        RestartFramework.at("after_rename_children").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        verifyEncryption();
        ...
        cluster.restartNameNodes();
        cluster.waitActive();
        RestartFramework.at("after_restart_verification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        fs = cluster.getFileSystem();
        verifyEncryption();
        ...
        RestartFramework.at("after_create_nested_ez").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_topez").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_second_ez").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testNestedEZWithRoot() throws Exception {
        ...
        RestartFramework.at("after_root_ez_rename").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        verifyEncryption();
        ...
        RestartFramework.at("after_trash_verification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Top ez trash should be " + expectedTopEZTrash, expectedTopEZTrash, topEZTrash);
        RestartFramework.at("after_init_root_ez").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_root_ez_verification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
