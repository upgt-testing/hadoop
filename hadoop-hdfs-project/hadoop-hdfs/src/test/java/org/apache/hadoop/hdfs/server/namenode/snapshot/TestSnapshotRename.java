...
public class TestSnapshotRename {
    ...
    public void testQuotaAndRenameWithSnapshot() throws Exception {
        ...
        LambdaTestUtils.intercept(NSQuotaExceededException.class, "The NameSpace quota (directories and files) of " + "directory /dir2 is exceeded", () -> hdfs.create(filex));
        hdfs.createSnapshot(dir2, "snap2");
        // rename a file after exceeding namespace quota
        Path file3 = new Path(dir2, "file3");
        LambdaTestUtils.intercept(NSQuotaExceededException.class, "The NameSpace quota (directories and files) of" + " directory /dir2 is exceeded", () -> hdfs.rename(file2, file3));
    }
    ...
    public void testRenameAcrossDirWithinSnapshot() throws Exception {
        ...
        Path filex = new Path(dir2, "filex");
        // create a file after exceeding namespace quota
        LambdaTestUtils.intercept(NSQuotaExceededException.class, "The NameSpace quota (directories and files) of " + "directory /dir/dir2 is exceeded", () -> hdfs.create(filex));
    ...
    public void testRenameInSameDirWithSnapshotableRoot() throws Exception {
        ...
        Path file2 = new Path(dir2, "file2");
        // rename a file after exceeding namespace quota
        LambdaTestUtils.intercept(NSQuotaExceededException.class, "The NameSpace quota (directories and files) of" + " directory /dir is exceeded", () -> hdfs.rename(fil1, file2));
    }
    ...
    @Test(timeout = 60000)
    public void testSnapshotList_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create three snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testSnapshotList_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create three snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testSnapshotList_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create three snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testSnapshotList_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create three snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testSnapshotRename_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        Path snapshotRoot = SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        Path ssPath = new Path(snapshotRoot, file1.getName());
    ...
    @Test(timeout = 60000)
    public void testSnapshotRename_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        Path snapshotRoot = SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        Path ssPath = new Path(snapshotRoot, file1.getName());
    ...
    @Test(timeout = 60000)
    public void testSnapshotRename_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        Path snapshotRoot = SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        Path ssPath = new Path(snapshotRoot, file1.getName());
    ...
    @Test(timeout = 60000)
    public void testSnapshotRename_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        Path snapshotRoot = SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        Path ssPath = new Path(snapshotRoot, file1.getName());
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshot_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshot_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshot_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshot_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshotToItself_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshotToItself_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshotToItself_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameNonExistingSnapshotToItself_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshot for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        exception.expect(SnapshotException.class);
    ...
    @Test(timeout = 60000)
    public void testRenameToExistingSnapshot_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testRenameToExistingSnapshot_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testRenameToExistingSnapshot_withUpgrade60() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test(timeout = 60000)
    public void testRenameToExistingSnapshot_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s2");
    ...
    @Test
    public void testRenameWithIllegalName_withUpgrade20() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        final String name1 = HdfsConstants.DOT_SNAPSHOT_DIR;
    ...
    @Test
    public void testRenameWithIllegalName_withUpgrade40() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        final String name1 = HdfsConstants.DOT_SNAPSHOT_DIR;
    ...
    @Test
    public void testRenameWithIllegalName_withUpgrade80() throws Exception {
        DFSTestUtil.createFile(hdfs, file1, BLOCKSIZE, REPLICATION, seed);
        // Create snapshots for sub1
        SnapshotTestHelper.createSnapshot(hdfs, sub1, "s1");
        final String name1 = HdfsConstants.DOT_SNAPSHOT_DIR;
    ...
    @Test
    public void testRenameSnapshotCommandWithIllegalArguments_withUpgrade20() throws Exception {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        PrintStream psOut = new PrintStream(out);
        PrintStream oldOut = System.out;
        PrintStream oldErr = System.err;
    ...
    @Test
    public void testRenameSnapshotCommandWithIllegalArguments_withUpgrade40() throws Exception {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        PrintStream psOut = new PrintStream(out);
        PrintStream oldOut = System.out;
        PrintStream oldErr = System.err;
    ...
    @Test
    public void testRenameSnapshotCommandWithIllegalArguments_withUpgrade60() throws Exception {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        PrintStream psOut = new PrintStream(out);
        PrintStream oldOut = System.out;
        PrintStream oldErr = System.err;
    ...
    @Test
    public void testRenameSnapshotCommandWithIllegalArguments_withUpgrade80() throws Exception {
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        PrintStream psOut = new PrintStream(out);
        PrintStream oldOut = System.out;
        PrintStream oldErr = System.err;
    ...
    @Test
    public void testQuotaAndRenameWithSnapshot_withUpgrade20() throws Exception {
        String dirr = "/dir2";
        Path dir2 = new Path(dirr);
        Path fil1 = new Path(dir2, "file1");
        hdfs.mkdirs(dir2);
    ...
    @Test
    public void testQuotaAndRenameWithSnapshot_withUpgrade40() throws Exception {
        String dirr = "/dir2";
        Path dir2 = new Path(dirr);
        Path fil1 = new Path(dir2, "file1");
        hdfs.mkdirs(dir2);
    ...
    @Test
    public void testQuotaAndRenameWithSnapshot_withUpgrade60() throws Exception {
        String dirr = "/dir2";
        Path dir2 = new Path(dirr);
        Path fil1 = new Path(dir2, "file1");
        hdfs.mkdirs(dir2);
    ...
    @Test
    public void testQuotaAndRenameWithSnapshot_withUpgrade80() throws Exception {
        String dirr = "/dir2";
        Path dir2 = new Path(dirr);
        Path fil1 = new Path(dir2, "file1");
        hdfs.mkdirs(dir2);
    ...
    @Test
    public void testRenameAcrossDirWithinSnapshot_withUpgrade20() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithinSnapshot_withUpgrade40() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithinSnapshot_withUpgrade60() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithinSnapshot_withUpgrade80() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameInSameDirWithSnapshotableRoot_withUpgrade20() throws Exception {
        // snapshottable root directory
        String rootStr = "/dir";
        Path rootDir = new Path(rootStr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameInSameDirWithSnapshotableRoot_withUpgrade40() throws Exception {
        // snapshottable root directory
        String rootStr = "/dir";
        Path rootDir = new Path(rootStr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameInSameDirWithSnapshotableRoot_withUpgrade60() throws Exception {
        // snapshottable root directory
        String rootStr = "/dir";
        Path rootDir = new Path(rootStr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameInSameDirWithSnapshotableRoot_withUpgrade80() throws Exception {
        // snapshottable root directory
        String rootStr = "/dir";
        Path rootDir = new Path(rootStr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithSnapshotableSrc_withUpgrade20() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithSnapshotableSrc_withUpgrade40() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithSnapshotableSrc_withUpgrade60() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
    ...
    @Test
    public void testRenameAcrossDirWithSnapshotableSrc_withUpgrade80() throws Exception {
        // snapshottable directory
        String dirr = "/dir";
        Path rootDir = new Path(dirr);
        hdfs.mkdirs(rootDir);
