...
public class TestBlockMissingException {
    ...
    @Test
    public void testBlockMissingException_withUpgrade20() throws Exception {
        LOG.info("Test testBlockMissingException started.");
        long blockSize = 1024L;
        int numBlocks = 4;
        conf = new HdfsConfiguration();
    ...
    @Test
    public void testBlockMissingException_withUpgrade40() throws Exception {
        LOG.info("Test testBlockMissingException started.");
        long blockSize = 1024L;
        int numBlocks = 4;
        conf = new HdfsConfiguration();
    ...
    @Test
    public void testBlockMissingException_withUpgrade60() throws Exception {
        LOG.info("Test testBlockMissingException started.");
        long blockSize = 1024L;
        int numBlocks = 4;
        conf = new HdfsConfiguration();
