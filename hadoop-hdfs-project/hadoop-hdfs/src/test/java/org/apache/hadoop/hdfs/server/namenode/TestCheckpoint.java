...
public class TestCheckpoint {
   ...
   */
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerDeltaImage_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerDeltaImage_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerDeltaImage_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerDeltaImage_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
