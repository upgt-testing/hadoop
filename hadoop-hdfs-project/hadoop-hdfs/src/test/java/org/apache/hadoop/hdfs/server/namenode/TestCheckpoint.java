...
public class TestCheckpoint {
   ...
   */
    ...
    public void testTooManyEditReplayFailures() throws IOException {
        ...
        FileSystem fs = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).checkExitOnShutdown(false).build();
            cluster.waitActive();
            fs = cluster.getFileSystem();
            fos = fs.create(new Path("tmpfile0"));
            fos.write(new byte[] { 0, 1, 2, 3 });
   ...
   */
    ...
    public void testSecondaryNamenodeError1() throws IOException {
        ...
        //
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).format(false).build();
            cluster.waitActive();
            fileSys = cluster.getFileSystem();
            checkFile(fileSys, file1, replication);
   ...
   */
    ...
    private void checkTempImages(NNStorageJVMInterface storage) throws IOException {
        List<File> dirs = new ArrayList<File>();
        dirs.add(storage.getStorageDir(0).getCurrentDir());
        dirs.add(storage.getStorageDir(1).getCurrentDir());
        for (File dir : dirs) {
  ...
  public void testNameDirLocking() throws IOException {
    ...
    try {
      ...
      NNStorageJ storage = cluster.getNameNode().getFSImage().getStorage();
  ...
  public void testSeparateEditsDirLocking() throws IOException {
    ...
    StorageDirectory savedSd = null;
    try {
      cluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false)
   ...
   */
    ...
    private static void assertClusterStartFailsWhenDirLocked(Configuration conf, StorageDirectory sdToLock) throws IOException {
        ...
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(false).manageNameDfsDirs(false).numDataNodes(0).build();
    ...
    public void testImportCheckpoint() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(false).startupOption(StartupOption.IMPORT).build();
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(false).numDataNodes(0).startupOption(StartupOption.IMPORT).build();
    ...
    SecondaryNameNode startSecondaryNameNode(Configuration conf, int index) throws IOException {
        ...
        snnConf.set(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/2nn-" + index);
    ...
    public void testSaveNamespace() throws IOException {
        ...
        try {
            Configuration conf = new HdfsConfiguration();
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).format(true).build();
            cluster.waitActive();
            fs = (cluster.getFileSystem());
    ...
    public void testCheckpointSignature() throws IOException {
        ...
        try {
            ...
            secondary.doCheckpoint();
            CheckpointSignatureJVMInterface sig = nnRpc.rollEditLog();
    ...
    public void testMultipleSecondaryNamenodes() throws IOException {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(conf.get(DFSConfigKeys.DFS_NAMESERVICES))).build();
    ...
    public void testSecondaryImageDownload() throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).format(true).build();
        cluster.waitActive();
        FileSystem fileSys = cluster.getFileSystem();
        FSImageJVMInterface image = cluster.getNameNode().getFSImage();
        SecondaryNameNode secondary = null;
        try {
            ...
            //
            secondary = startSecondaryNameNode(conf);
            File secondaryDir = MiniDFSClusterInJVM.getCheckpointDirectory(MiniDFSClusterInJVM.getBaseDirectory(), 0, 0)[0];
    ...
    public void testEditFailureOnFirstCheckpoint() throws IOException {
        ...
        try {
            ...
            FSNamesystemJVMInterface fsns = cluster.getNamesystem();
    ...
    public void testMultipleSecondaryNNsAgainstSameNN() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(true).build();
            // Start 2NNs
            ...
            NNStorageJVMInterface storage = cluster.getNameNode().getFSImage().getStorage();
    ...
    public void testReformatNNBetweenCheckpoints() throws IOException {
        ...
        try {
            ...
            Configuration snnConf = new Configuration(conf);
            File checkpointDir = new File(MiniDFSClusterInJVM.getBaseDirectory(), "namesecondary");
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).nameNodePort(origPort).nameNodeHttpPort(origHttpPort).format(true).build();
            try {
                secondary.doCheckpoint();
   ...
   */
    ...
    public void testCheckpointWithFailedStorageDir() throws Exception {
        ...
        try {
            ...
            NNStorageJVMInterface storage = cluster.getNameNode().getFSImage().getStorage();
            StorageDirectoryJVMInterface sd0 = storage.getStorageDir(0);
            StorageDirectoryJVMInterface sd1 = storage.getStorageDir(1);
    ...
    public void testCheckpointWithSeparateDirsAfterNameFails() throws Exception {
        ...
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
        File base_dir = new File(MiniDFSClusterInJVM.getBaseDirectory());
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_RESTORE_KEY, true);
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/name-only");
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/edits-only");
        conf.set(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_DIR_KEY, fileAsURI(new File(base_dir, "namesecondary1")).toString());
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(true).manageNameDfsDirs(false).build();
            secondary = startSecondaryNameNode(conf);
            // Checkpoint once
            secondary.doCheckpoint();
   ...
   */
    ...
    public void testActiveRejectSmallerTxidDeltaImage() throws Exception {
        ...
        try {
            ...
            NameNodeJVMInterface active = cluster.getNameNode();
            active.getHttpServer().setAttribute(RECENT_IMAGE_CHECK_ENABLED, true);
            secondary = startSecondaryNameNode(conf);
            FileSystem fs = cluster.getFileSystem();
            assertEquals(0, active.getNamesystem().getFSImage().getMostRecentCheckpointTxId());
            // create 5 dir.
            for (int i = 0; i < 5; i++) {
            ...
            assertEquals(21, active.getNamesystem().getFSImage().getMostRecentCheckpointTxId());
        } finally {
            cleanup(secondary);
            cleanup(cluster);
        }
    ...
    public void testActiveImageWithTimeDeltaRelaxation() throws Exception {
        ...
        SecondaryNameNode secondary = null;
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(true).build()) {
            // enable small delta rejection
            NameNodeJVMInterface active = cluster.getNameNode();
            active.getHttpServer().setAttribute(RECENT_IMAGE_CHECK_ENABLED, true);
            secondary = startSecondaryNameNode(conf);
            ...
            // still gets accepted
            assertEquals(9, active.getNamesystem().getFSImage().getMostRecentCheckpointTxId());
        } finally {
            cleanup(secondary);
        }
    }
     ...
     */
    private void assertParallelFilesInvariant(MiniDFSClusterInJVM cluster, ImmutableList<SecondaryNameNode> secondaries) throws Exception {
    ...
    @Test
    public void testNameDirError_withUpgrade40() throws IOException {
        LOG.info("Starting testNameDirError");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        Collection<URI> nameDirs = cluster.getNameDirs(0);
    ...
    @Test
    public void testNameDirError_withUpgrade60() throws IOException {
        LOG.info("Starting testNameDirError");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        Collection<URI> nameDirs = cluster.getNameDirs(0);
    ...
    @Test
    public void testNameDirError_withUpgrade80() throws IOException {
        LOG.info("Starting testNameDirError");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        Collection<URI> nameDirs = cluster.getNameDirs(0);
    ...
    @Test(timeout = 30000)
    public void testReloadOnEditReplayFailure_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testReloadOnEditReplayFailure_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testReloadOnEditReplayFailure_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testReloadOnEditReplayFailure_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testTooManyEditReplayFailures_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_MAX_RETRIES_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_PERIOD_KEY, 1);
        FSDataOutputStream fos = null;
    ...
    @Test(timeout = 30000)
    public void testTooManyEditReplayFailures_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_MAX_RETRIES_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_PERIOD_KEY, 1);
        FSDataOutputStream fos = null;
    ...
    @Test(timeout = 30000)
    public void testTooManyEditReplayFailures_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_MAX_RETRIES_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_PERIOD_KEY, 1);
        FSDataOutputStream fos = null;
    ...
    @Test(timeout = 30000)
    public void testTooManyEditReplayFailures_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_MAX_RETRIES_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_PERIOD_KEY, 1);
        FSDataOutputStream fos = null;
    ...
    @Test
    public void testSecondaryNamenodeError1_withUpgrade20() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError1");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointxx.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError1_withUpgrade40() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError1");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointxx.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError1_withUpgrade60() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError1");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointxx.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError1_withUpgrade80() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError1");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointxx.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError2_withUpgrade20() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError2");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointyy.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError2_withUpgrade40() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError2");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointyy.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError2_withUpgrade60() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError2");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointyy.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError2_withUpgrade80() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError2");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointyy.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError3_withUpgrade20() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError3");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointzz.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError3_withUpgrade40() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError3");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointzz.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError3_withUpgrade60() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError3");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointzz.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNamenodeError3_withUpgrade80() throws IOException {
        LOG.info("Starting testSecondaryNamenodeError3");
        Configuration conf = new HdfsConfiguration();
        Path file1 = new Path("checkpointzz.dat");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testSecondaryNameNodeLocking_withUpgrade20() throws Exception {
        // Start a primary NN so that the secondary will start successfully
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
    ...
    @Test
    public void testSecondaryNameNodeLocking_withUpgrade40() throws Exception {
        // Start a primary NN so that the secondary will start successfully
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
    ...
    @Test
    public void testSecondaryNameNodeLocking_withUpgrade60() throws Exception {
        // Start a primary NN so that the secondary will start successfully
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
    ...
    @Test
    public void testSecondaryNameNodeLocking_withUpgrade80() throws Exception {
        // Start a primary NN so that the secondary will start successfully
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
    ...
    @Test
    public void testImportCheckpoint_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        Path testPath = new Path("/testfile");
        SecondaryNameNode snn = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testImportCheckpoint_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        Path testPath = new Path("/testfile");
        SecondaryNameNode snn = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testImportCheckpoint_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        Path testPath = new Path("/testfile");
        SecondaryNameNode snn = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testImportCheckpoint_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        Path testPath = new Path("/testfile");
        SecondaryNameNode snn = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testCheckpoint_withUpgrade20() throws IOException {
        Path tmpDir = new Path("/tmp_tmp");
        Path file1 = new Path("checkpoint.dat");
        Path file2 = new Path("checkpoint2.dat");
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpoint_withUpgrade40() throws IOException {
        Path tmpDir = new Path("/tmp_tmp");
        Path file1 = new Path("checkpoint.dat");
        Path file2 = new Path("checkpoint2.dat");
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpoint_withUpgrade60() throws IOException {
        Path tmpDir = new Path("/tmp_tmp");
        Path file1 = new Path("checkpoint.dat");
        Path file2 = new Path("checkpoint2.dat");
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpoint_withUpgrade80() throws IOException {
        Path tmpDir = new Path("/tmp_tmp");
        Path file1 = new Path("checkpoint.dat");
        Path file2 = new Path("checkpoint2.dat");
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testSaveNamespace_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem fs = null;
        FileContext fc;
        try {
    ...
    @Test
    public void testSaveNamespace_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem fs = null;
        FileContext fc;
        try {
    ...
    @Test
    public void testSaveNamespace_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem fs = null;
        FileContext fc;
        try {
    ...
    @Test
    public void testSaveNamespace_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        DistributedFileSystem fs = null;
        FileContext fc;
        try {
    ...
    @Test
    public void testCheckpointSignature_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        try {
    ...
    @Test
    public void testCheckpointSignature_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        try {
    ...
    @Test
    public void testCheckpointSignature_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        try {
    ...
    @Test
    public void testCheckpointSignature_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        try {
    ...
    @Test
    public void testCheckpointAfterTwoFailedUploads_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testCheckpointAfterTwoFailedUploads_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testCheckpointAfterTwoFailedUploads_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testCheckpointAfterTwoFailedUploads_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testMultipleSecondaryNamenodes_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        String nameserviceId1 = "ns1";
        String nameserviceId2 = "ns2";
        conf.set(DFSConfigKeys.DFS_NAMESERVICES, nameserviceId1 + "," + nameserviceId2);
    ...
    @Test
    public void testMultipleSecondaryNamenodes_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        String nameserviceId1 = "ns1";
        String nameserviceId2 = "ns2";
        conf.set(DFSConfigKeys.DFS_NAMESERVICES, nameserviceId1 + "," + nameserviceId2);
    ...
    @Test
    public void testMultipleSecondaryNamenodes_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        String nameserviceId1 = "ns1";
        String nameserviceId2 = "ns2";
        conf.set(DFSConfigKeys.DFS_NAMESERVICES, nameserviceId1 + "," + nameserviceId2);
    ...
    @Test
    public void testMultipleSecondaryNamenodes_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        String nameserviceId1 = "ns1";
        String nameserviceId2 = "ns2";
        conf.set(DFSConfigKeys.DFS_NAMESERVICES, nameserviceId1 + "," + nameserviceId2);
    ...
    @Test
    public void testSecondaryImageDownload_withUpgrade20() throws IOException {
        LOG.info("Starting testSecondaryImageDownload");
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_NAMENODE_SECONDARY_HTTP_ADDRESS_KEY, "0.0.0.0:0");
        Path dir = new Path("/checkpoint");
    ...
    @Test
    public void testSecondaryImageDownload_withUpgrade40() throws IOException {
        LOG.info("Starting testSecondaryImageDownload");
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_NAMENODE_SECONDARY_HTTP_ADDRESS_KEY, "0.0.0.0:0");
        Path dir = new Path("/checkpoint");
    ...
    @Test
    public void testSecondaryImageDownload_withUpgrade60() throws IOException {
        LOG.info("Starting testSecondaryImageDownload");
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_NAMENODE_SECONDARY_HTTP_ADDRESS_KEY, "0.0.0.0:0");
        Path dir = new Path("/checkpoint");
    ...
    @Test
    public void testSecondaryImageDownload_withUpgrade80() throws IOException {
        LOG.info("Starting testSecondaryImageDownload");
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_NAMENODE_SECONDARY_HTTP_ADDRESS_KEY, "0.0.0.0:0");
        Path dir = new Path("/checkpoint");
    ...
    @Test(timeout = 30000)
    public void testFailureBeforeRename_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testFailureBeforeRename_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testFailureBeforeRename_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testFailureBeforeRename_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        FSDataOutputStream fos = null;
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureBeforeRename_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureBeforeRename_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureBeforeRename_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureBeforeRename_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureOnFirstCheckpoint_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureOnFirstCheckpoint_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureOnFirstCheckpoint_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testEditFailureOnFirstCheckpoint_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 60000)
    public void testDeleteTemporaryEditsOnStartup_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 60000)
    public void testDeleteTemporaryEditsOnStartup_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 60000)
    public void testDeleteTemporaryEditsOnStartup_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 60000)
    public void testDeleteTemporaryEditsOnStartup_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        SecondaryNameNode secondary = null;
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN2_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN2_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN2_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testMultipleSecondaryNNsAgainstSameNN2_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary1 = null, secondary2 = null;
        try {
    ...
    @Test
    public void testReformatNNBetweenCheckpoints_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 1);
    ...
    @Test
    public void testReformatNNBetweenCheckpoints_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 1);
    ...
    @Test
    public void testReformatNNBetweenCheckpoints_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 1);
    ...
    @Test
    public void testReformatNNBetweenCheckpoints_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(CommonConfigurationKeysPublic.IPC_CLIENT_CONNECTION_MAXIDLETIME_KEY, 1);
    ...
    @Test
    public void testCheckpointWithFailedStorageDir_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithFailedStorageDir_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithFailedStorageDir_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithFailedStorageDir_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithSeparateDirsAfterNameFails_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithSeparateDirsAfterNameFails_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithSeparateDirsAfterNameFails_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testCheckpointWithSeparateDirsAfterNameFails_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File currentDir = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 30000)
    public void testCheckpointTriggerOnTxnCount_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 30000)
    public void testCheckpointTriggerOnTxnCount_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 30000)
    public void testCheckpointTriggerOnTxnCount_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test
    public void testSecondaryHasVeryOutOfDateImage_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testSecondaryHasVeryOutOfDateImage_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testSecondaryHasVeryOutOfDateImage_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testSecondaryHasVeryOutOfDateImage_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        try {
    ...
    @Test
    public void testSecondaryPurgesEditLogs_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
    ...
    @Test
    public void testSecondaryPurgesEditLogs_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
    ...
    @Test
    public void testSecondaryPurgesEditLogs_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
    ...
    @Test
    public void testSecondaryPurgesEditLogs_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
    ...
    @Test
    public void testSecondaryNameNodeWithSavedLeases_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        FSDataOutputStream fos = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testSecondaryNameNodeWithSavedLeases_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        FSDataOutputStream fos = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testSecondaryNameNodeWithSavedLeases_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        FSDataOutputStream fos = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testSecondaryNameNodeWithSavedLeases_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        FSDataOutputStream fos = null;
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testLegacyOivImage_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File tmpDir = GenericTestUtils.getTestDir("testLegacyOivImage");
        tmpDir.mkdirs();
    ...
    @Test
    public void testLegacyOivImage_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File tmpDir = GenericTestUtils.getTestDir("testLegacyOivImage");
        tmpDir.mkdirs();
    ...
    @Test
    public void testLegacyOivImage_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File tmpDir = GenericTestUtils.getTestDir("testLegacyOivImage");
        tmpDir.mkdirs();
    ...
    @Test
    public void testLegacyOivImage_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File tmpDir = GenericTestUtils.getTestDir("testLegacyOivImage");
        tmpDir.mkdirs();
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerTxidDeltaImage_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerTxidDeltaImage_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerTxidDeltaImage_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test(timeout = 300000)
    public void testActiveRejectSmallerTxidDeltaImage_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        // Set the delta txid threshold to 10
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 10);
    ...
    @Test
    public void testActiveImageWithTimeDeltaRelaxation_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // it does not trigger a checkpoint during this test.
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000000);
        // it does not trigger a checkpoint during this test.
    ...
    @Test
    public void testActiveImageWithTimeDeltaRelaxation_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // it does not trigger a checkpoint during this test.
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000000);
        // it does not trigger a checkpoint during this test.
    ...
    @Test
    public void testActiveImageWithTimeDeltaRelaxation_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // it does not trigger a checkpoint during this test.
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000000);
        // it does not trigger a checkpoint during this test.
    ...
    @Test
    public void testActiveImageWithTimeDeltaRelaxation_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // it does not trigger a checkpoint during this test.
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_CHECKPOINT_TXNS_KEY, 1000000);
        // it does not trigger a checkpoint during this test.
