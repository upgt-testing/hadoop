...
public class TestDatanodeReport {
    ...
    public void testDatanodeReport() throws Exception {
        ...
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
        try {
            //wait until the cluster is up
            cluster.waitActive();
    ...
    static void assertReports(int numDatanodes, DatanodeReportType type, DFSClient client, List<DataNodeJVMInterface> datanodes, String bpid) throws IOException {
    ...
    @Test
    public void testDatanodeReportWithUpgradeDomain_withUpgrade20() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setClass(DFSConfigKeys.DFS_NAMENODE_HOSTS_PROVIDER_CLASSNAME_KEY, CombinedHostFileManager.class, HostConfigManager.class);
    ...
    @Test
    public void testDatanodeReportWithUpgradeDomain_withUpgrade40() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setClass(DFSConfigKeys.DFS_NAMENODE_HOSTS_PROVIDER_CLASSNAME_KEY, CombinedHostFileManager.class, HostConfigManager.class);
    ...
    @Test
    public void testDatanodeReportWithUpgradeDomain_withUpgrade60() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setClass(DFSConfigKeys.DFS_NAMENODE_HOSTS_PROVIDER_CLASSNAME_KEY, CombinedHostFileManager.class, HostConfigManager.class);
    ...
    @Test
    public void testDatanodeReportWithUpgradeDomain_withUpgrade80() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setClass(DFSConfigKeys.DFS_NAMENODE_HOSTS_PROVIDER_CLASSNAME_KEY, CombinedHostFileManager.class, HostConfigManager.class);
    ...
    @Test
    public void testDatanodeReport_withUpgrade20() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
    ...
    @Test
    public void testDatanodeReport_withUpgrade40() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
    ...
    @Test
    public void testDatanodeReport_withUpgrade60() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
    ...
    @Test
    public void testDatanodeReport_withUpgrade80() throws Exception {
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, // 0.5s
        500);
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
    ...
    @Test
    public void testDatanodeReportMissingBlock_withUpgrade20() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
        try {
    ...
    @Test
    public void testDatanodeReportMissingBlock_withUpgrade40() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
        try {
    ...
    @Test
    public void testDatanodeReportMissingBlock_withUpgrade60() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
        try {
    ...
    @Test
    public void testDatanodeReportMissingBlock_withUpgrade80() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
        try {
