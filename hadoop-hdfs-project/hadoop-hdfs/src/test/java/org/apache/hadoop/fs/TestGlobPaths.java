...
public class TestGlobPaths {
    ...
    @Test
    public void testCRInPathGlob_withUpgrade20() throws IOException {
        FileStatus[] statuses;
        Path d1 = new Path(USER_DIR, "dir1");
        Path fNormal = new Path(d1, "f1");
    ...
    @Test
    public void testCRInPathGlob_withUpgrade40() throws IOException {
        FileStatus[] statuses;
        Path d1 = new Path(USER_DIR, "dir1");
        Path fNormal = new Path(d1, "f1");
        Path fWithCR = new Path(d1, "f1\r");
    ...
    @Test
    public void testCRInPathGlob_withUpgrade60() throws IOException {
        FileStatus[] statuses;
        Path d1 = new Path(USER_DIR, "dir1");
        Path fNormal = new Path(d1, "f1");
        Path fWithCR = new Path(d1, "f1\r");
    ...
    @Test
    public void testCRInPathGlob_withUpgrade80() throws IOException {
        FileStatus[] statuses;
        Path d1 = new Path(USER_DIR, "dir1");
        Path fNormal = new Path(d1, "f1");
        Path fWithCR = new Path(d1, "f1\r");
    ...
    @Test
    public void testMultiGlob_withUpgrade20() throws IOException {
        FileStatus[] status;
        Path d1 = new Path(USER_DIR, "dir1");
        Path d11 = new Path(d1, "subdir1");
        Path d12 = new Path(d1, "subdir2");
    ...
    @Test
    public void testMultiGlob_withUpgrade40() throws IOException {
        FileStatus[] status;
        Path d1 = new Path(USER_DIR, "dir1");
        Path d11 = new Path(d1, "subdir1");
        Path d12 = new Path(d1, "subdir2");
    ...
    @Test
    public void testMultiGlob_withUpgrade60() throws IOException {
        FileStatus[] status;
        Path d1 = new Path(USER_DIR, "dir1");
        Path d11 = new Path(d1, "subdir1");
        Path d12 = new Path(d1, "subdir2");
    ...
    @Test
    public void testMultiGlob_withUpgrade80() throws IOException {
        FileStatus[] status;
        Path d1 = new Path(USER_DIR, "dir1");
        Path d11 = new Path(d1, "subdir1");
        Path d12 = new Path(d1, "subdir2");
    ...
    @Test
    public void testPathFilter_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testPathFilter_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/*", files, new RegexPathFilter("^.*" + Pattern.quote(USER_DIR) + "/a/b"));
            dfsCluster.restartNodeForTesting(0);
    ...
    @Test
    public void testPathFilter_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/*", files, new RegexPathFilter("^.*" + Pattern.quote(USER_DIR) + "/a/b"));
            assertEquals(1, matchedPath.length);
    ...
    @Test
    public void testPathFilter_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/*", files, new RegexPathFilter("^.*" + Pattern.quote(USER_DIR) + "/a/b"));
            assertEquals(1, matchedPath.length);
    ...
    @Test
    public void testPathFilterWithFixedLastComponent_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b", USER_DIR + "/c", USER_DIR + "/c/b" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testPathFilterWithFixedLastComponent_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b", USER_DIR + "/c", USER_DIR + "/c/b" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/b", files, new RegexPathFilter("^.*" + Pattern.quote(USER_DIR) + "/a/b"));
            dfsCluster.restartNodeForTesting(0);
    ...
    @Test
    public void testPathFilterWithFixedLastComponent_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b", USER_DIR + "/c", USER_DIR + "/c/b" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/b", files, new RegexPathFilter("^.*" + Pattern.quote(USER_DIR) + "/a/b"));
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void testPathFilterWithFixedLastComponent_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/a/b", USER_DIR + "/c", USER_DIR + "/c/b" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/b", files, new RegexPathFilter("^.*" + Pattern.quote(USER_DIR) + "/a/b"));
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestLiteral_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a2c", USER_DIR + "/abc.d" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestLiteral_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a2c", USER_DIR + "/abc.d" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/abc.d", files);
            dfsCluster.restartNodeForTesting(0);
    ...
    @Test
    public void pTestLiteral_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a2c", USER_DIR + "/abc.d" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/abc.d", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestLiteral_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a2c", USER_DIR + "/abc.d" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/abc.d", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestEscape_withUpgrade20() throws IOException {
        // path separator instead of an escaping character on Windows.
        assumeNotWindows();
        try {
            String[] files = new String[] { USER_DIR + "/ab\\[c.d" };
    ...
    @Test
    public void pTestEscape_withUpgrade40() throws IOException {
        // path separator instead of an escaping character on Windows.
        assumeNotWindows();
        try {
            String[] files = new String[] { USER_DIR + "/ab\\[c.d" };
    ...
    @Test
    public void pTestEscape_withUpgrade60() throws IOException {
        // path separator instead of an escaping character on Windows.
        assumeNotWindows();
        try {
            String[] files = new String[] { USER_DIR + "/ab\\[c.d" };
    ...
    @Test
    public void pTestEscape_withUpgrade80() throws IOException {
        // path separator instead of an escaping character on Windows.
        assumeNotWindows();
        try {
            String[] files = new String[] { USER_DIR + "/ab\\[c.d" };
    ...
    @Test
    public void pTestAny_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/abc", USER_DIR + "/a2c", USER_DIR + "/a.c", USER_DIR + "/abcd" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestAny_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/abc", USER_DIR + "/a2c", USER_DIR + "/a.c", USER_DIR + "/abcd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a?c", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestAny_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/abc", USER_DIR + "/a2c", USER_DIR + "/a.c", USER_DIR + "/abcd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a?c", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestAny_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/abc", USER_DIR + "/a2c", USER_DIR + "/a.c", USER_DIR + "/abcd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a?c", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure1_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/abc", USER_DIR + "/abc.p", USER_DIR + "/bacd" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestClosure1_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/abc", USER_DIR + "/abc.p", USER_DIR + "/bacd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a*", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure1_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/abc", USER_DIR + "/abc.p", USER_DIR + "/bacd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a*", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure1_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a", USER_DIR + "/abc", USER_DIR + "/abc.p", USER_DIR + "/bacd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a*", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure2_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.", USER_DIR + "/a.txt", USER_DIR + "/a.old.java", USER_DIR + "/.java" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestClosure2_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.", USER_DIR + "/a.txt", USER_DIR + "/a.old.java", USER_DIR + "/.java" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.*", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure2_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.", USER_DIR + "/a.txt", USER_DIR + "/a.old.java", USER_DIR + "/.java" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.*", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure2_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.", USER_DIR + "/a.txt", USER_DIR + "/a.old.java", USER_DIR + "/.java" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.*", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure3_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.txt.x", USER_DIR + "/ax", USER_DIR + "/ab37x", USER_DIR + "/bacd" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestClosure3_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.txt.x", USER_DIR + "/ax", USER_DIR + "/ab37x", USER_DIR + "/bacd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a*x", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure3_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.txt.x", USER_DIR + "/ax", USER_DIR + "/ab37x", USER_DIR + "/bacd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a*x", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure3_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.txt.x", USER_DIR + "/ax", USER_DIR + "/ab37x", USER_DIR + "/bacd" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a*x", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestClosure4_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/dir2/file2", USER_DIR + "/dir3/file1" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestClosure4_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/dir2/file2", USER_DIR + "/dir3/file1" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/file1", files);
            assertEquals(matchedPath.length, 2);
    ...
    @Test
    public void pTestClosure4_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/dir2/file2", USER_DIR + "/dir3/file1" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/file1", files);
            assertEquals(matchedPath.length, 2);
    ...
    @Test
    public void pTestClosure4_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/dir2/file2", USER_DIR + "/dir3/file1" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/file1", files);
            assertEquals(matchedPath.length, 2);
    ...
    @Test
    public void pTestClosure5_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/file1" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestClosure5_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/file1" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/file1", files);
            dfsCluster.restartNodeForTesting(0);
    ...
    @Test
    public void pTestClosure5_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/file1" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/file1", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestClosure5_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/dir1/file1", USER_DIR + "/file1" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/*/file1", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestSet_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.c", USER_DIR + "/a.cpp", USER_DIR + "/a.hlp", USER_DIR + "/a.hxy" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestSet_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.c", USER_DIR + "/a.cpp", USER_DIR + "/a.hlp", USER_DIR + "/a.hxy" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[ch]??", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestSet_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.c", USER_DIR + "/a.cpp", USER_DIR + "/a.hlp", USER_DIR + "/a.hxy" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[ch]??", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestSet_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.c", USER_DIR + "/a.cpp", USER_DIR + "/a.hlp", USER_DIR + "/a.hxy" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[ch]??", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestRange_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.f", USER_DIR + "/a.h" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestRange_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.f", USER_DIR + "/a.h" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[d-fm]", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestRange_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.f", USER_DIR + "/a.h" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[d-fm]", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestRange_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.f", USER_DIR + "/a.h" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[d-fm]", files);
            assertEquals(matchedPath.length, 3);
    ...
    @Test
    public void pTestSetExcl_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.0", USER_DIR + "/a.h" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestSetExcl_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.0", USER_DIR + "/a.h" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[^a-cg-z0-9]", files);
            assertEquals(matchedPath.length, 2);
    ...
    @Test
    public void pTestSetExcl_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.0", USER_DIR + "/a.h" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[^a-cg-z0-9]", files);
            assertEquals(matchedPath.length, 2);
    ...
    @Test
    public void pTestSetExcl_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/a.d", USER_DIR + "/a.e", USER_DIR + "/a.0", USER_DIR + "/a.h" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/a.[^a-cg-z0-9]", files);
            assertEquals(matchedPath.length, 2);
    ...
    @Test
    public void pTestCombination_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { "/user/aa/a.c", "/user/bb/a.cpp", "/user1/cc/b.hlp", "/user/dd/a.hxy" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestCombination_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { "/user/aa/a.c", "/user/bb/a.cpp", "/user1/cc/b.hlp", "/user/dd/a.hxy" };
            Path[] matchedPath = prepareTesting("/use?/*/a.[ch]{lp,xy}", files);
            dfsCluster.restartNodeForTesting(0);
    ...
    @Test
    public void pTestCombination_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { "/user/aa/a.c", "/user/bb/a.cpp", "/user1/cc/b.hlp", "/user/dd/a.hxy" };
            Path[] matchedPath = prepareTesting("/use?/*/a.[ch]{lp,xy}", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestCombination_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { "/user/aa/a.c", "/user/bb/a.cpp", "/user1/cc/b.hlp", "/user/dd/a.hxy" };
            Path[] matchedPath = prepareTesting("/use?/*/a.[ch]{lp,xy}", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestCurlyBracket_withUpgrade20() throws IOException {
        Path[] matchedPath;
        String[] files;
        try {
            files = new String[] { USER_DIR + "/a.abcxx", USER_DIR + "/a.abxy", USER_DIR + "/a.hlp", USER_DIR + "/a.jhyy" };
    ...
    @Test
    public void pTestCurlyBracket_withUpgrade40() throws IOException {
        Path[] matchedPath;
        String[] files;
        try {
            files = new String[] { USER_DIR + "/a.abcxx", USER_DIR + "/a.abxy", USER_DIR + "/a.hlp", USER_DIR + "/a.jhyy" };
    ...
    @Test
    public void pTestCurlyBracket_withUpgrade60() throws IOException {
        Path[] matchedPath;
        String[] files;
        try {
            files = new String[] { USER_DIR + "/a.abcxx", USER_DIR + "/a.abxy", USER_DIR + "/a.hlp", USER_DIR + "/a.jhyy" };
    ...
    @Test
    public void pTestCurlyBracket_withUpgrade80() throws IOException {
        Path[] matchedPath;
        String[] files;
        try {
            files = new String[] { USER_DIR + "/a.abcxx", USER_DIR + "/a.abxy", USER_DIR + "/a.hlp", USER_DIR + "/a.jhyy" };
    ...
    @Test
    public void pTestJavaRegexSpecialChars_withUpgrade20() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/($.|+)bc", USER_DIR + "/abc" };
            dfsCluster.restartNodeForTesting(0);
            dfsCluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void pTestJavaRegexSpecialChars_withUpgrade40() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/($.|+)bc", USER_DIR + "/abc" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/($.|+)*", files);
            dfsCluster.restartNodeForTesting(0);
    ...
    @Test
    public void pTestJavaRegexSpecialChars_withUpgrade60() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/($.|+)bc", USER_DIR + "/abc" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/($.|+)*", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Test
    public void pTestJavaRegexSpecialChars_withUpgrade80() throws IOException {
        try {
            String[] files = new String[] { USER_DIR + "/($.|+)bc", USER_DIR + "/abc" };
            Path[] matchedPath = prepareTesting(USER_DIR + "/($.|+)*", files);
            assertEquals(matchedPath.length, 1);
    ...
    @Ignore
    @Test
    public void testGlobWithSymlinksOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestGlobWithSymlinks(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Ignore
    @Test
    public void testGlobWithSymlinksOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestGlobWithSymlinks(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Ignore
    @Test
    public void testGlobWithSymlinksToSymlinksOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestGlobWithSymlinksToSymlinks(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Ignore
    @Test
    public void testGlobWithSymlinksToSymlinksOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestGlobWithSymlinksToSymlinks(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Ignore
    @Test
    public void testGlobSymlinksWithCustomPathFilterOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestGlobSymlinksWithCustomPathFilter(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Ignore
    @Test
    public void testGlobSymlinksWithCustomPathFilterOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestGlobSymlinksWithCustomPathFilter(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testGlobFillsInSchemeOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestGlobFillsInScheme(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testGlobFillsInSchemeOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestGlobFillsInScheme(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testRelativePathOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestRelativePath(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testRelativePathOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestRelativePath(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testGlobAccessDeniedOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestGlobAccessDenied(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testGlobAccessDeniedOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestGlobAccessDenied(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testReservedHdfsPathsOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestReservedHdfsPaths(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testReservedHdfsPathsOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestReservedHdfsPaths(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testGlobRootOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestGlobRoot(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testGlobRootOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestGlobRoot(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testNonTerminalGlobsOnFS_withUpgrade20() throws Exception {
        testOnFileSystem(new TestNonTerminalGlobs(false));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testNonTerminalGlobsOnFC_withUpgrade20() throws Exception {
        testOnFileContext(new TestNonTerminalGlobs(true));
        dfsCluster.restartNodeForTesting(0);
        dfsCluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testLocalFilesystem_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        FileSystem fs = FileSystem.getLocal(conf);
        String localTmp = System.getProperty("java.io.tmpdir");
        Path base = new Path(new Path(localTmp), UUID.randomUUID().toString());
    ...
    @Test
    public void testLocalFilesystem_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        FileSystem fs = FileSystem.getLocal(conf);
        String localTmp = System.getProperty("java.io.tmpdir");
        Path base = new Path(new Path(localTmp), UUID.randomUUID().toString());
    ...
    @Test
    public void testLocalFilesystem_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        FileSystem fs = FileSystem.getLocal(conf);
        String localTmp = System.getProperty("java.io.tmpdir");
        Path base = new Path(new Path(localTmp), UUID.randomUUID().toString());
    ...
    @Test
    public void testLocalFilesystem_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        FileSystem fs = FileSystem.getLocal(conf);
        String localTmp = System.getProperty("java.io.tmpdir");
        Path base = new Path(new Path(localTmp), UUID.randomUUID().toString());
