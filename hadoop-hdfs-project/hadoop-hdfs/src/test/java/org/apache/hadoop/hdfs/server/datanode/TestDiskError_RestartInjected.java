...
public class TestDiskError_RestartInjected {
  ...
  public void testShutdown() throws Exception {
    ...
    RestartFramework.at("after_initial_cluster_setup")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_additional_datanodes")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      RestartFramework.at("after_dirs_readonly")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReplicationError() throws Exception {
    ...
    RestartFramework.at("after_second_datanode_start")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_temp_files_cleanup")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testcheckDiskError() throws Exception {
    ...
    RestartFramework.at("after_datanode_ready")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_check_disk_error")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataTransferWhenBytesPerChecksumIsZero() throws IOException {
    ...
    RestartFramework.at("after_metadata_corruption")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_block_transfer_initiation")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
