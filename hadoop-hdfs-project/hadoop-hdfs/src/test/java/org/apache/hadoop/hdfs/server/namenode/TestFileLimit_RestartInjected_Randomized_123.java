 ...
 */
public class TestFileLimit_RestartInjected_Randomized_123 {
    ...
    public void testMaxBlocksPerFileLimit() throws Exception {
        ...
        try {
            ...
            fout.hflush();
            RestartFramework.at("after_writing_max_blocks").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
