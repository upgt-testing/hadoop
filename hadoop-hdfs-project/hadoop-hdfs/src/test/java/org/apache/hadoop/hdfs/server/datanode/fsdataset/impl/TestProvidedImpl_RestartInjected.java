...
public class TestProvidedImpl_RestartInjected {
   ...
   */
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_NN_Graceful() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_NN_Graceful ===");
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_NN_Crash() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_NN_Crash ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_DN_Graceful() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_DN_Graceful ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_DN_Crash() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_DN_Crash ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_AllDN_Graceful() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_AllDN_Graceful ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_AllDN_Crash() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_AllDN_Crash ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_NNAndDN_Graceful() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_NNAndDN_Graceful ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
  ...
  @Test(timeout = 120000)
  public void testProvidedReplicaWithPathHandle_AfterCreate_NNAndDN_Crash() throws Exception {
    LOG.info("=== Starting testProvidedReplicaWithPathHandle_AfterCreate_NNAndDN_Crash ===");
    Configuration conf = new Configuration();
    MiniDFSCluster cluster = null;
    try {
      cluster = new MiniDFSCluster.Builder(conf).build();
