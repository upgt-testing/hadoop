...
public class TestSnapshot_RestartInjected {
  ...
  public void testSnapshot() throws Throwable {
    try {
      ...
      RestartFramework.at("after_snapshot_iterations")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
  ...
  public void testOfflineImageViewer() throws Exception {
    ...
    RestartFramework.at("after_snapshot_run")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_fsimage_retrieval")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAllowAndDisallowSnapshot() throws Exception {
    ...
    RestartFramework.at("after_allow_snapshot_dir")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_disallow_snapshot_dir")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
