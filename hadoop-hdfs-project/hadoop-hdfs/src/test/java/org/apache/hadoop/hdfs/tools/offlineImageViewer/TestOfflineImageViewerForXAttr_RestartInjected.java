 ...
 */
public class TestOfflineImageViewerForXAttr_RestartInjected {

  private static final Logger LOG = LoggerFactory
      .getLogger(TestOfflineImageViewerForXAttr_RestartInjected.class);
  ...
  public void testWebImageViewerForListXAttrs() throws Exception {
    RestartFramework.at("before_list_xattrs_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
  ...
  public void testWebImageViewerForGetXAttrsWithOutParameters()
      throws Exception {
    RestartFramework.at("before_get_xattrs_without_params_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testWebImageViewerForGetXAttrsWithParameters() throws Exception {
    RestartFramework.at("before_get_xattrs_with_params_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testWebImageViewerForGetXAttrsWithCodecParameters()
      throws Exception {
    RestartFramework.at("before_get_xattrs_with_codec_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testWithWebHdfsFileSystem() throws Exception {
    RestartFramework.at("before_webhdfs_filesystem_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testResponseCode() throws Exception {
    RestartFramework.at("before_response_code_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
