...
public class TestDelegationToken {
    ...
    private DelegationTokenSecretManagerInterface dtSecretManager;
    ...
    public void setUp() throws Exception {
        ...
        cluster = new MiniDockerDFSCluster.Builder(config).numDataNodes(0).build();
        cluster.waitActive();
    ...
    public void testDelegationTokenSecretManager() throws Exception {
        TokenInterface<DelegationTokenIdentifier> token = generateDelegationToken("SomeUser", "JobTracker");
    ...
    public void testDelegationTokenUgi() throws Exception {
        ...
        for (int i = 0; i < 2; i++) {
            DelegationTokenIdentifierInterface identClone = (DelegationTokenIdentifier) token1.decodeIdentifier();
        ...
        Assert.assertEquals(1, tokens.length);
        TokenInterface<?> token2 = tokens[0];
    ...
    public void testDTManagerInSafeMode() throws Exception {
        ...
        DelegationTokenSecretManagerInterface sm = NameNodeAdapter.getDtSecretManager(nn.getNamesystem());
