...
public class TestDNFencing {
    ...
    private NameNodeInterface nn1, nn2;
    ...
    public void setupCluster() throws Exception {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(3).build();
    ...
    public void testDnFencing() throws Exception {
        ...
        BlockManagerInterface nn2BM = nn2.getNamesystem().getBlockManager();
    ...
    public void testNNClearsCommandsOnFailoverWithReplChanges() throws Exception {
        ...
        BlockManagerInterface bm1 = nn1.getNamesystem().getBlockManager();
    ...
    private void waitForTrueReplication(final MiniDockerDFSCluster cluster, final ExtendedBlock block, final int waitFor) throws Exception {
    ...
    private int getTrueReplication(MiniDockerDFSCluster cluster, ExtendedBlock block) throws IOException {
        int count = 0;
