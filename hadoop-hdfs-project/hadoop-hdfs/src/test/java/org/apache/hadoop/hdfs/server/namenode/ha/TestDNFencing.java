...
public class TestDNFencing {
   ...
   */
    ...
    private void waitForTrueReplication(final MiniDFSClusterInJVM cluster, final ExtendedBlock block, final int waitFor) throws Exception {
    ...
    private int getTrueReplication(MiniDFSClusterInJVM cluster, ExtendedBlock block) throws IOException {
        int count = 0;
    ...
    @Test
    public void testDnFencing_withUpgrade20() throws Exception {
        // Create a file with replication level 3.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        ExtendedBlock block = DFSTestUtil.getFirstBlock(fs, TEST_FILE_PATH);
        // heartbeats so the invalidations are flushed to the DNs.
    ...
    @Test
    public void testDnFencing_withUpgrade40() throws Exception {
        // Create a file with replication level 3.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        ExtendedBlock block = DFSTestUtil.getFirstBlock(fs, TEST_FILE_PATH);
        // heartbeats so the invalidations are flushed to the DNs.
    ...
    @Test
    public void testDnFencing_withUpgrade60() throws Exception {
        // Create a file with replication level 3.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        ExtendedBlock block = DFSTestUtil.getFirstBlock(fs, TEST_FILE_PATH);
        // heartbeats so the invalidations are flushed to the DNs.
    ...
    @Test
    public void testDnFencing_withUpgrade80() throws Exception {
        // Create a file with replication level 3.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        ExtendedBlock block = DFSTestUtil.getFirstBlock(fs, TEST_FILE_PATH);
        // heartbeats so the invalidations are flushed to the DNs.
    ...
    @Test
    public void testNNClearsCommandsOnFailoverAfterStartup_withUpgrade20() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        banner("Shutting down NN2");
        cluster.shutdownNameNode(1);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverAfterStartup_withUpgrade40() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        banner("Shutting down NN2");
        cluster.shutdownNameNode(1);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverAfterStartup_withUpgrade60() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        banner("Shutting down NN2");
        cluster.shutdownNameNode(1);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverAfterStartup_withUpgrade80() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 3, 1L);
        banner("Shutting down NN2");
        cluster.shutdownNameNode(1);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverWithReplChanges_withUpgrade20() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 1, 1L);
        banner("rolling NN1's edit log, forcing catch-up");
        HATestUtil.waitForStandbyToCatchUp(nn1, nn2);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverWithReplChanges_withUpgrade40() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 1, 1L);
        banner("rolling NN1's edit log, forcing catch-up");
        HATestUtil.waitForStandbyToCatchUp(nn1, nn2);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverWithReplChanges_withUpgrade60() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 1, 1L);
        banner("rolling NN1's edit log, forcing catch-up");
        HATestUtil.waitForStandbyToCatchUp(nn1, nn2);
    ...
    @Test
    public void testNNClearsCommandsOnFailoverWithReplChanges_withUpgrade80() throws Exception {
        // Make lots of blocks to increase chances of triggering a bug.
        DFSTestUtil.createFile(fs, TEST_FILE_PATH, 30 * SMALL_BLOCK, (short) 1, 1L);
        banner("rolling NN1's edit log, forcing catch-up");
        HATestUtil.waitForStandbyToCatchUp(nn1, nn2);
    ...
    @Test
    public void testBlockReportsWhileFileBeingWritten_withUpgrade20() throws Exception {
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
        try {
            AppendTestUtil.write(out, 0, 10);
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testBlockReportsWhileFileBeingWritten_withUpgrade40() throws Exception {
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
        try {
            AppendTestUtil.write(out, 0, 10);
            out.hflush();
    ...
    @Test
    public void testBlockReportsWhileFileBeingWritten_withUpgrade60() throws Exception {
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
        try {
            AppendTestUtil.write(out, 0, 10);
            out.hflush();
    ...
    @Test
    public void testBlockReportsWhileFileBeingWritten_withUpgrade80() throws Exception {
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
        try {
            AppendTestUtil.write(out, 0, 10);
            out.hflush();
    ...
    @Test
    public void testQueueingWithAppend_withUpgrade20() throws Exception {
        int numQueued = 0;
        int numDN = cluster.getDataNodes().size();
        // case 1: create file and call hflush after write
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
    ...
    @Test
    public void testQueueingWithAppend_withUpgrade40() throws Exception {
        int numQueued = 0;
        int numDN = cluster.getDataNodes().size();
        // case 1: create file and call hflush after write
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
    ...
    @Test
    public void testQueueingWithAppend_withUpgrade60() throws Exception {
        int numQueued = 0;
        int numDN = cluster.getDataNodes().size();
        // case 1: create file and call hflush after write
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
    ...
    @Test
    public void testQueueingWithAppend_withUpgrade80() throws Exception {
        int numQueued = 0;
        int numDN = cluster.getDataNodes().size();
        // case 1: create file and call hflush after write
        FSDataOutputStream out = fs.create(TEST_FILE_PATH);
