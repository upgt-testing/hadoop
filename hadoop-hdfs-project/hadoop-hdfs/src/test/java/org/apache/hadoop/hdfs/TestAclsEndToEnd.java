...
public class TestAclsEndToEnd {
    ...
    private static void setBlacklistAcls(Configuration conf, UserGroupInformation hdfsUgi) {
        conf.set(KMSConfiguration.CONFIG_PREFIX + "blacklist.CREATE", hdfsUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "blacklist.DELETE", hdfsUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "blacklist.ROLLOVER", hdfsUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "blacklist.GET", "*");
        conf.set(KMSConfiguration.CONFIG_PREFIX + "blacklist.SET_KEY_MATERIAL", "*");
        conf.set(KMSConfiguration.CONFIG_PREFIX + "blacklist.DECRYPT_EEK", hdfsUgi.getUserName());
    }
    ...
    private static void setKeyAcls(Configuration conf, String prefix, UserGroupInformation hdfsUgi, UserGroupInformation keyadminUgi, UserGroupInformation userUgi) {
        ...
        conf.set(KeyAuthorizationKeyProvider.KEY_ACL + KEY1 + ".DECRYPT_EEK", userUgi.getUserName());
    }
     ...
     */
    private void doFullAclTest(final Configuration conf, final UserGroupInformation hdfsUgi, final UserGroupInformation keyadminUgi, final UserGroupInformation userUgi) throws Exception {
        try {
            setup(conf);
            // Create a test key
    ...
    @Test
    public void testGoodWithWhitelist_withUpgrade20() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
    ...
    @Test
    public void testGoodWithWhitelist_withUpgrade40() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithWhitelist_withUpgrade60() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithWhitelist_withUpgrade80() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithKeyAcls_withUpgrade20() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGoodWithKeyAcls_withUpgrade40() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithKeyAcls_withUpgrade60() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithKeyAcls_withUpgrade80() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithWhitelistWithoutBlacklist_withUpgrade20() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGoodWithWhitelistWithoutBlacklist_withUpgrade40() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithWhitelistWithoutBlacklist_withUpgrade60() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithWhitelistWithoutBlacklist_withUpgrade80() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithKeyAclsWithoutBlacklist_withUpgrade20() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGoodWithKeyAclsWithoutBlacklist_withUpgrade40() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithKeyAclsWithoutBlacklist_withUpgrade60() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testGoodWithKeyAclsWithoutBlacklist_withUpgrade80() throws Exception {
        UserGroupInformation hdfsUgi = UserGroupInformation.createProxyUserForTesting("hdfs", realUgi, new String[] { "supergroup" });
        UserGroupInformation keyadminUgi = UserGroupInformation.createProxyUserForTesting("keyadmin", realUgi, new String[] { "keyadmin" });
        UserGroupInformation userUgi = UserGroupInformation.createProxyUserForTesting("user", realUgi, new String[] { "staff" });
        Configuration conf = getBaseConf(hdfsUgi, keyadminUgi);
    ...
    @Test
    public void testCreateKey_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // Correct config with whitelist ACL
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateKey_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // Correct config with whitelist ACL
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateKey_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // Correct config with whitelist ACL
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateKey_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // Correct config with whitelist ACL
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateEncryptionZone_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateEncryptionZone_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateEncryptionZone_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateEncryptionZone_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testCreateFileInEncryptionZone_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testCreateFileInEncryptionZone_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testCreateFileInEncryptionZone_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testCreateFileInEncryptionZone_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testReadFileInEncryptionZone_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testReadFileInEncryptionZone_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testReadFileInEncryptionZone_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testReadFileInEncryptionZone_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.GET_METADATA", realUgi.getUserName());
    ...
    @Test
    public void testDeleteKey_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testDeleteKey_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testDeleteKey_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
    ...
    @Test
    public void testDeleteKey_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // Create a test key
        conf.set(KMSConfiguration.CONFIG_PREFIX + "acl.CREATE", realUgi.getUserName());
        conf.set(KMSConfiguration.WHITELIST_KEY_ACL_PREFIX + "MANAGEMENT", realUgi.getUserName());
