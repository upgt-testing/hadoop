...
public class NameNodeProxy extends ReconfigurableBase implements
    ...
    private void connectMXBean(String host, int port) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to connect to the JMX server in NameNode", e);
        }
    }
    ...
    private static Object invokeRMI(String operationName, Object[] params, String[] signature) {
        try {
            ...
            throw new RuntimeException("Failed to invoke RMI operation in NameNode", e);
        }
    }

    public NameNodeProxy(NamenodeRole role, HAContext haContext, Tracer tracer, String host, int port) {
        // do nothing.
        this.role = role;
        this.haContext = haContext;
        this.tracer = tracer;
        this.haEnabled = false;
        this.allowStaleStandbyReads = false;
        this.notBecomeActiveInSafemode = false;
        connectMXBean(host, port);
    }

    @Override
    public int fakePrintMXBean() {
        int res = (int) invokeRMI("fakePrintMXBean", new Object[]{}, new String[]{});
    ...
    public static final Logger LOG =
            LoggerFactory.getLogger(org.apache.hadoop.hdfs.server.namenode.NameNode.class.getName());
    ...
    protected org.apache.hadoop.hdfs.server.namenode.FSNamesystem namesystem;
    protected FSNamesystemProxy namesystemProxy;
    ...
    public FSNamesystemProxy getNamesystem() {
        return namesystemProxy;
        //return namesystem;
    }

    public NamenodeProtocols getRpcServer() {
        return (NamenodeProtocols) invokeRMI("getRpcServer", new Object[]{}, new String[]{});
        //return rpcServer;
    }
    ...
    private void startHttpServer(final Configuration conf) throws IOException {
        invokeRMI("startHttpServer", new Object[]{conf}, new String[]{Configuration.class.getName()});
    }
     ...
     * @throws IOException
     */
    public NameNodeProxy(Configuration conf) throws IOException {
        this(conf, NamenodeRole.NAMENODE);
    }

    protected NameNodeProxy(Configuration conf, NamenodeRole role)
            throws IOException {
        super(conf);
    ...
    public InetSocketAddress getHttpAddress() {
        return (InetSocketAddress) invokeRMI("getHttpAddress", new Object[]{}, new String[]{});
    ...
    public InetSocketAddress getHttpsAddress() {
        return (InetSocketAddress) invokeRMI("getHttpsAddress", new Object[]{}, new String[]{});
    ...
    private static boolean format(Configuration conf, boolean force,
        ...
        return (boolean) invokeRMI("format", new Object[]{conf, force, isInteractive}, new String[]{Configuration.class.getName(), "boolean", "boolean"});
    }
    ...
    private static boolean initializeSharedEdits(Configuration conf,
        ...
        return (boolean) invokeRMI("initializeSharedEdits", new Object[]{conf, force, interactive}, new String[]{Configuration.class.getName(), "boolean", "boolean"});
    }
    ...
    private static void copyEditLogSegmentsToSharedDir(FSNamesystem fsns,
        ...
        FSEditLog sourceEditLog = fsns.getFSImage().getEditLog();
    ...
    public static boolean doRollback(Configuration conf,
        ...
        return (boolean) invokeRMI("doRollback", new Object[]{conf, isConfirmationNeeded}, new String[]{Configuration.class.getName(), "boolean"});
    }
    ...
    private static void doRecovery(StartupOption startOpt, Configuration conf)
            throws IOException {
        invokeRMI("doRecovery", new Object[]{startOpt, conf}, new String[]{StartupOption.class.getName(), Configuration.class.getName()});
    }
    ...
    private static boolean printMetadataVersion(Configuration conf)
            throws IOException {
        return (boolean) invokeRMI("printMetadataVersion", new Object[]{conf}, new String[]{Configuration.class.getName()});
    }

    public static org.apache.hadoop.hdfs.server.namenode.NameNode createNameNode(String argv[], Configuration conf)
            throws IOException {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        try {
            StringUtils.startupShutdownMessage(org.apache.hadoop.hdfs.server.namenode.NameNode.class, argv, LOG);
    ...
    synchronized void monitorHealth()
        ...
        invokeRMI("monitorHealth", new Object[]{}, new String[]{});
    }

    synchronized void transitionToActive()
            throws ServiceFailedException, AccessControlException {
        invokeRMI("transitionToActive", new Object[]{}, new String[]{});
    }

    synchronized void transitionToStandby()
            throws ServiceFailedException, AccessControlException {
        invokeRMI("transitionToStandby", new Object[]{}, new String[]{});
    }

    synchronized void transitionToObserver()
            throws ServiceFailedException, AccessControlException {
        invokeRMI("transitionToObserver", new Object[]{}, new String[]{});
        /**
    ...
    synchronized HAServiceStatus getServiceStatus()
            throws ServiceFailedException, AccessControlException {
        return (HAServiceStatus) invokeRMI("getServiceStatus", new Object[]{}, new String[]{});
        /**
        if (!haEnabled) {
            throw new ServiceFailedException("HA for namenode is not enabled");
        }
    ...
    synchronized HAServiceState getServiceState() {
        return (HAServiceState) invokeRMI("getServiceState", new Object[]{}, new String[]{});
        //if (state == null) {
    ...
    public String getNNRole() {
        return (String) invokeRMI("getRole", new Object[]{}, new String[]{});
    ...
    public String getState() {
        return (String) invokeRMI("getState", new Object[]{}, new String[]{});
    ...
    public String getHostAndPort() {
        return (String) invokeRMI("getHostAndPort", new Object[]{}, new String[]{});
    }

    @Override
    public boolean fetchSecurityEnabled() {
        return (boolean) invokeRMI("fetchSecurityEnabled", new Object[]{}, new String[]{});
    }

    @Override // NameNodeStatusMXBean
    public boolean isSecurityEnabled() {
        return (Boolean) invokeRMI("isSecurityEnabled", new Object[]{}, new String[]{});
    }

    @Override // NameNodeStatusMXBean
    public long getLastHATransitionTime() {
        return (long) invokeRMI("getLastHATransitionTime", new Object[]{}, new String[]{});
        //return state.getLastHATransitionTime();
    }

    @Override //NameNodeStatusMXBean
    public long getBytesWithFutureGenerationStamps() {
        return (long) invokeRMI("getBytesWithFutureGenerationStamps", new Object[]{}, new String[]{});
        //return getNamesystem().getBytesInFuture();
    }

    @Override
    public String getSlowPeersReport() {
        return (String) invokeRMI("getSlowPeersReport", new Object[]{}, new String[]{});
    ...
    public String getSlowDisksReport() {
        return (String) invokeRMI("getSlowDisksReport", new Object[]{}, new String[]{});
        //return namesystem.getBlockManager().getDatanodeManager()
        //       .getSlowDisksReport();
    }
    ...
    /**
     * Class used to expose {@link org.apache.hadoop.hdfs.server.namenode.NameNode} as context to {@link HAState}
     */
    protected class NameNodeHAContext implements HAContext {
        ...
        public void startActiveServices() throws IOException {
            invokeRMI("startActiveServices", new Object[]{}, new String[]{});
        }

        @Override
        public void stopActiveServices() throws IOException {
            invokeRMI("stopActiveServices", new Object[]{}, new String[]{});
        }

        @Override
        public void startStandbyServices() throws IOException {
            invokeRMI("startStandbyServices", new Object[]{}, new String[]{});
        }

        @Override
        public void prepareToStopStandbyServices() throws ServiceFailedException {
            invokeRMI("prepareToStopStandbyServices", new Object[]{}, new String[]{});
        }

        @Override
        public void stopStandbyServices() throws IOException {
            invokeRMI("stopStandbyServices", new Object[]{}, new String[]{});
        }
        ...
        @Override
        public void checkOperation(final org.apache.hadoop.hdfs.server.namenode.NameNode.OperationCategory op)
    ...
    public String reconfigurePropertyImpl(String property, String newVal)
        ...
        return (String) invokeRMI("reconfigurePropertyImpl",
                new Object[]{property, newVal}, new String[]{String.class.getName(), String.class.getName()});
    }
    ...
    private void reconfBlockPlacementPolicy() {
        invokeRMI("reconfBlockPlacementPolicy", new Object[]{}, new String[]{});
    }
    ...
    private String reconfCallerContextEnabled(String newVal) {
        return (String) invokeRMI("reconfCallerContextEnabled", new Object[]{newVal}, new String[]{String.class.getName()});
    }
