...
public class TestCommitBlockWithInvalidGenStamp_RestartInjected {
  ...
  public void testCommitWithInvalidGenStamp() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_inode_get")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_block_add")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      previous = new ExtendedBlock(cluster.getNamesystem().getBlockPoolId(),
          newBlockClone);
      RestartFramework.at("after_block_clone")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_invalid_genstamp_set")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_invalid_commit_attempt")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      previous = new ExtendedBlock(cluster.getNamesystem().getBlockPoolId(),
          newBlock);
      RestartFramework.at("after_correct_block_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_successful_complete")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
