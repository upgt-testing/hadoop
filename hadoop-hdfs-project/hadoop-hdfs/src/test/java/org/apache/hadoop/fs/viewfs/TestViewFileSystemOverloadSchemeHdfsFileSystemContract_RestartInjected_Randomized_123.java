 ...
 */
public class TestViewFileSystemOverloadSchemeHdfsFileSystemContract_RestartInjected_Randomized_123 extends TestHDFSFileSystemContract {
    ...
    public void testAppend() throws IOException {
        ...
        RestartFramework.at("before_append").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRenameRootDirForbidden() throws Exception {
        RestartFramework.at("before_rename_root").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testListStatusRootDir() throws Throwable {
        ...
        RestartFramework.at("before_list_status").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
