 ...
 */
public class TestDataNodeVolumeFailureToleration_RestartInjected_Randomized_123 {
    ...
    public void testConfigureMinValidVolumes() throws Exception {
        ...
        RestartFramework.at("after_volume_restore").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testVolumeAndTolerableConfiguration() throws Exception {
        RestartFramework.at("after_test").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("before_test").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testFailedVolumeOnStartupIsCounted() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_dir_failure").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
