...
public class TestAllowFormat {
    ...
    public void testFormatShouldBeIgnoredForNonFileBasedDirs() throws Exception {
        ...
        HATestUtil.setFailoverConfigurations(conf, logicalName, null, nnAddr1, nnAddr2);
    ...
    @Test
    public void testAllowFormat_withUpgrade20() throws IOException {
        LOG.info("--starting mini cluster");
        NameNodeJVMInterface nn;
        // 1. Create a new cluster and format DFS
        config.setBoolean(DFS_NAMENODE_SUPPORT_ALLOW_FORMAT_KEY, true);
    ...
    @Test
    public void testAllowFormat_withUpgrade40() throws IOException {
        LOG.info("--starting mini cluster");
        NameNodeJVMInterface nn;
        // 1. Create a new cluster and format DFS
        config.setBoolean(DFS_NAMENODE_SUPPORT_ALLOW_FORMAT_KEY, true);
    ...
    @Test
    public void testAllowFormat_withUpgrade60() throws IOException {
        LOG.info("--starting mini cluster");
        NameNodeJVMInterface nn;
        // 1. Create a new cluster and format DFS
        config.setBoolean(DFS_NAMENODE_SUPPORT_ALLOW_FORMAT_KEY, true);
    ...
    @Test
    public void testAllowFormat_withUpgrade80() throws IOException {
        LOG.info("--starting mini cluster");
        NameNodeJVMInterface nn;
        // 1. Create a new cluster and format DFS
        config.setBoolean(DFS_NAMENODE_SUPPORT_ALLOW_FORMAT_KEY, true);
