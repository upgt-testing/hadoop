...
public class TestDFSRollback {
    ...
    public void testRollback() throws Exception {
        ...
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            ...
            UpgradeUtilities.createDataNodeVersionFile(dataCurrentDirs, storageInfo, UpgradeUtilities.getCurrentBlockPoolIDJVM(cluster));
            cluster.startDataNodes(conf, 1, false, StartupOption.ROLLBACK, null);
            ...
            UpgradeUtilities.createDataNodeVersionFile(baseDirs, storageInfo, UpgradeUtilities.getCurrentBlockPoolIDJVM(cluster));
