...
public class TestDataNodeMetrics {
    ...
    public void testRoundTripAckMetric() throws Exception {
        ...
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(datanodeCount).build();
        try {
            cluster.waitActive();
            FileSystem fs = cluster.getFileSystem();
    ...
    public void testNNRpcMetricsWithHA() throws IOException {
        ...
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        cluster.waitActive();
        DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
    ...
    public void testNNRpcMetricsWithFederation() throws IOException {
        ...
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology("ns1,ns2")).build();
        cluster.waitActive();
        DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
        MetricsRecordBuilder rb = getMetrics(dn.getMetrics().name());
    ...
    public void testNNRpcMetricsWithFederationAndHA() throws IOException {
        ...
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).build();
        cluster.waitActive();
        DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
        MetricsRecordBuilder rb = getMetrics(dn.getMetrics().name());
    ...
    @Test
    public void testDataNodeMetrics_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testDataNodeMetrics_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testDataNodeMetrics_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testDataNodeMetrics_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testSendDataPacketMetrics_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSendDataPacketMetrics_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSendDataPacketMetrics_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSendDataPacketMetrics_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testReceivePacketMetrics_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testReceivePacketMetrics_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testReceivePacketMetrics_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testReceivePacketMetrics_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        final int interval = 1;
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testRoundTripAckMetric_withUpgrade20() throws Exception {
        final int datanodeCount = 2;
        final int interval = 1;
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
    ...
    @Test
    public void testRoundTripAckMetric_withUpgrade40() throws Exception {
        final int datanodeCount = 2;
        final int interval = 1;
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
    ...
    @Test
    public void testRoundTripAckMetric_withUpgrade60() throws Exception {
        final int datanodeCount = 2;
        final int interval = 1;
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
    ...
    @Test
    public void testRoundTripAckMetric_withUpgrade80() throws Exception {
        final int datanodeCount = 2;
        final int interval = 1;
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_METRICS_PERCENTILES_INTERVALS_KEY, "" + interval);
    ...
    @Test(timeout = 60000)
    public void testTimeoutMetric_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final Path path = new Path("/test");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        final List<FSDataOutputStream> streams = Lists.newArrayList();
    ...
    @Test(timeout = 60000)
    public void testTimeoutMetric_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final Path path = new Path("/test");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        final List<FSDataOutputStream> streams = Lists.newArrayList();
    ...
    @Test(timeout = 60000)
    public void testTimeoutMetric_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final Path path = new Path("/test");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        final List<FSDataOutputStream> streams = Lists.newArrayList();
    ...
    @Test(timeout = 60000)
    public void testTimeoutMetric_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        final Path path = new Path("/test");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        final List<FSDataOutputStream> streams = Lists.newArrayList();
    ...
    @Test(timeout = 120000)
    public void testDataNodeTimeSpend_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            final FileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testDataNodeTimeSpend_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            final FileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testDataNodeTimeSpend_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            final FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeBlocksReplicatedMetric_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeBlocksReplicatedMetric_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeBlocksReplicatedMetric_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeBlocksReplicatedMetric_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeActiveXceiversCount_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeActiveXceiversCount_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeActiveXceiversCount_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDatanodeActiveXceiversCount_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDataNodeMXBeanActiveThreadCount_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/testfile");
    ...
    @Test
    public void testDataNodeMXBeanActiveThreadCount_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/testfile");
    ...
    @Test
    public void testDataNodeMXBeanActiveThreadCount_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/testfile");
    ...
    @Test
    public void testDataNodeMXBeanActiveThreadCount_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        FileSystem fs = cluster.getFileSystem();
        Path p = new Path("/testfile");
    ...
    @Test
    public void testDNShouldNotDeleteBlockONTooManyOpenFiles_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        DataNodeFaultInjector oldInjector = DataNodeFaultInjector.get();
    ...
    @Test
    public void testDNShouldNotDeleteBlockONTooManyOpenFiles_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        DataNodeFaultInjector oldInjector = DataNodeFaultInjector.get();
    ...
    @Test
    public void testDNShouldNotDeleteBlockONTooManyOpenFiles_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        DataNodeFaultInjector oldInjector = DataNodeFaultInjector.get();
    ...
    @Test
    public void testDNShouldNotDeleteBlockONTooManyOpenFiles_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1L);
        conf.setLong(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 1);
        DataNodeFaultInjector oldInjector = DataNodeFaultInjector.get();
    ...
    @Test
    public void testNNRpcMetricsWithNonHA_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testNNRpcMetricsWithNonHA_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testNNRpcMetricsWithNonHA_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testNNRpcMetricsWithNonHA_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testNNRpcMetricsWithHA_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
    ...
    @Test
    public void testNNRpcMetricsWithHA_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
    ...
    @Test
    public void testNNRpcMetricsWithHA_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
    ...
    @Test
    public void testNNRpcMetricsWithHA_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederation_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology("ns1,ns2")).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederation_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology("ns1,ns2")).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederation_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology("ns1,ns2")).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederation_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology("ns1,ns2")).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederationAndHA_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederationAndHA_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederationAndHA_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).build();
    ...
    @Test
    public void testNNRpcMetricsWithFederationAndHA_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // only sends heartbeat once after startup
        conf.setTimeDuration(DFS_HEARTBEAT_INTERVAL_KEY, 1, TimeUnit.HOURS);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).build();
