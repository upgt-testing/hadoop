...
public class TestDFSClientExcludedNodes {
    ...
    @Test(timeout = 60000)
    public void testExcludedNodes_withUpgrade20() throws IOException {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        FileSystem fs = cluster.getFileSystem();
        Path filePath = new Path("/testExcludedNodes");
        // kill a datanode
    ...
    @Test(timeout = 60000)
    public void testExcludedNodes_withUpgrade40() throws IOException {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        FileSystem fs = cluster.getFileSystem();
        Path filePath = new Path("/testExcludedNodes");
        // kill a datanode
    ...
    @Test(timeout = 60000)
    public void testExcludedNodes_withUpgrade60() throws IOException {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        FileSystem fs = cluster.getFileSystem();
        Path filePath = new Path("/testExcludedNodes");
        // kill a datanode
    ...
    @Test(timeout = 60000)
    public void testExcludedNodes_withUpgrade80() throws IOException {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        FileSystem fs = cluster.getFileSystem();
        Path filePath = new Path("/testExcludedNodes");
        // kill a datanode
    ...
    @Test(timeout = 60000)
    public void testExcludedNodesForgiveness_withUpgrade20() throws IOException {
        // Forgive nodes in under 2.5s for this test case.
        conf.setLong(HdfsClientConfigKeys.Write.EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_KEY, 2500);
        // so making sure the checksum bytes too match it.
        conf.setInt("io.bytes.per.checksum", 512);
    ...
    @Test(timeout = 60000)
    public void testExcludedNodesForgiveness_withUpgrade40() throws IOException {
        // Forgive nodes in under 2.5s for this test case.
        conf.setLong(HdfsClientConfigKeys.Write.EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_KEY, 2500);
        // so making sure the checksum bytes too match it.
        conf.setInt("io.bytes.per.checksum", 512);
    ...
    @Test(timeout = 60000)
    public void testExcludedNodesForgiveness_withUpgrade60() throws IOException {
        // Forgive nodes in under 2.5s for this test case.
        conf.setLong(HdfsClientConfigKeys.Write.EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_KEY, 2500);
        // so making sure the checksum bytes too match it.
        conf.setInt("io.bytes.per.checksum", 512);
    ...
    @Test(timeout = 60000)
    public void testExcludedNodesForgiveness_withUpgrade80() throws IOException {
        // Forgive nodes in under 2.5s for this test case.
        conf.setLong(HdfsClientConfigKeys.Write.EXCLUDE_NODES_CACHE_EXPIRY_INTERVAL_KEY, 2500);
        // so making sure the checksum bytes too match it.
        conf.setInt("io.bytes.per.checksum", 512);
