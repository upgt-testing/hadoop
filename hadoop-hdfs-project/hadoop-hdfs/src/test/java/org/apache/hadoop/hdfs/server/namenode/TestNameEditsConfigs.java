...
public class TestNameEditsConfigs {
    ...
    private void writeFile(FileSystem fileSys, Path name, int repl) throws IOException {
        FSDataOutputStream stm = fileSys.create(name, true, fileSys.getConf().getInt(CommonConfigurationKeys.IO_FILE_BUFFER_SIZE_KEY, 4096), (short) repl, BLOCK_SIZE);
    ...
    void checkImageAndEditsFilesExistence(File dir, boolean shouldHaveImages, boolean shouldHaveEdits) throws IOException {
        ...
        List<FileJournalManager.EditLogFile> editlogs = FileJournalManager.matchEditLogs(new File(dir, "current").listFiles());
        if (shouldHaveEdits) {
    ...
    public void testNameEditsConfigs() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATA_NODES).manageNameDfsDirs(false).build();
        cluster.waitActive();
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(NUM_DATA_NODES).format(false).manageNameDfsDirs(false).build();
        cluster.waitActive();
        secondary = startSecondaryNameNode(conf);
        fileSys = cluster.getFileSystem();
        try {
    ...
    private FSImageTransactionalStorageInspector inspect(File storageDir) throws IOException {
        return FSImageTestUtil.inspectStorageDirectory(new File(storageDir, "current"), NameNodeDirType.IMAGE_AND_EDITS);
    }
    ...
    public void testCheckPointDirsAreTrimmed() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false).numDataNodes(3).build();
        try {
            cluster.waitActive();
            secondary = startSecondaryNameNode(conf);
            secondary.doCheckpoint();
    ...
    @Test
    public void testNameEditsConfigs_withUpgrade20() throws Exception {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsConfigs_withUpgrade40() throws Exception {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsConfigs_withUpgrade60() throws Exception {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsConfigs_withUpgrade80() throws Exception {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsRequiredConfigs_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        File nameAndEditsDir = new File(base_dir, "name_and_edits");
        File nameAndEditsDir2 = new File(base_dir, "name_and_edits2");
        File nameDir = new File(base_dir, "name");
    ...
    @Test
    public void testNameEditsRequiredConfigs_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        File nameAndEditsDir = new File(base_dir, "name_and_edits");
        File nameAndEditsDir2 = new File(base_dir, "name_and_edits2");
        File nameDir = new File(base_dir, "name");
    ...
    @Test
    public void testNameEditsRequiredConfigs_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        File nameAndEditsDir = new File(base_dir, "name_and_edits");
        File nameAndEditsDir2 = new File(base_dir, "name_and_edits2");
        File nameDir = new File(base_dir, "name");
    ...
    @Test
    public void testNameEditsRequiredConfigs_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        File nameAndEditsDir = new File(base_dir, "name_and_edits");
        File nameAndEditsDir2 = new File(base_dir, "name_and_edits2");
        File nameDir = new File(base_dir, "name");
    ...
    @Test
    public void testNameEditsConfigsFailure_withUpgrade20() throws IOException {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsConfigsFailure_withUpgrade40() throws IOException {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsConfigsFailure_withUpgrade60() throws IOException {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testNameEditsConfigsFailure_withUpgrade80() throws IOException {
        Path file1 = new Path("TestNameEditsConfigs1");
        Path file2 = new Path("TestNameEditsConfigs2");
        Path file3 = new Path("TestNameEditsConfigs3");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testCheckPointDirsAreTrimmed_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File checkpointNameDir1 = new File(base_dir, "chkptName1");
        File checkpointEditsDir1 = new File(base_dir, "chkptEdits1");
    ...
    @Test
    public void testCheckPointDirsAreTrimmed_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File checkpointNameDir1 = new File(base_dir, "chkptName1");
        File checkpointEditsDir1 = new File(base_dir, "chkptEdits1");
    ...
    @Test
    public void testCheckPointDirsAreTrimmed_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File checkpointNameDir1 = new File(base_dir, "chkptName1");
        File checkpointEditsDir1 = new File(base_dir, "chkptEdits1");
    ...
    @Test
    public void testCheckPointDirsAreTrimmed_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        SecondaryNameNode secondary = null;
        File checkpointNameDir1 = new File(base_dir, "chkptName1");
        File checkpointEditsDir1 = new File(base_dir, "chkptEdits1");
