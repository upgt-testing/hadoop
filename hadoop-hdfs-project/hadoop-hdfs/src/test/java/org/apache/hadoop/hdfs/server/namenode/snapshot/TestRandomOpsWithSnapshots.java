...
public class TestRandomOpsWithSnapshots {
    ...
    public void setUp() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(CONFIG).numDataNodes(REPL).format(true).build();
        cluster.waitActive();
   ...
   * string. */
    ...
    @Test(timeout = 900000)
    public void testRandomOperationsWithSnapshots_withUpgrade20() throws IOException, InterruptedException, TimeoutException {
        // Set
        long seed = System.currentTimeMillis();
        LOG.info("testRandomOperationsWithSnapshots, seed to be used: " + seed);
        generator = new Random(seed);
    ...
    @Test(timeout = 900000)
    public void testRandomOperationsWithSnapshots_withUpgrade40() throws IOException, InterruptedException, TimeoutException {
        // Set
        long seed = System.currentTimeMillis();
        LOG.info("testRandomOperationsWithSnapshots, seed to be used: " + seed);
        generator = new Random(seed);
    ...
    @Test(timeout = 900000)
    public void testRandomOperationsWithSnapshots_withUpgrade60() throws IOException, InterruptedException, TimeoutException {
        // Set
        long seed = System.currentTimeMillis();
        LOG.info("testRandomOperationsWithSnapshots, seed to be used: " + seed);
        generator = new Random(seed);
    ...
    @Test(timeout = 900000)
    public void testRandomOperationsWithSnapshots_withUpgrade80() throws IOException, InterruptedException, TimeoutException {
        // Set
        long seed = System.currentTimeMillis();
        LOG.info("testRandomOperationsWithSnapshots, seed to be used: " + seed);
        generator = new Random(seed);
