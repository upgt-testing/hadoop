 ...
 * and messages.
 */
public abstract class BlockReportTestBase_RestartInjected {
  ...
  public void blockReport_01() throws IOException {
    ...
    RestartFramework.at("after_file_prepare")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_block_report_sent")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void blockReport_07() throws Exception {
    ...
    RestartFramework.at("after_first_block_report_sent")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_block_report_sent")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testOneReplicaRbwReportArrivesAfterBlockCompleted() throws Exception {
    ...
    RestartFramework.at("after_block_report_processed")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testInterleavedBlockReports()
    ...
    RestartFramework.at("after_get_block_reports")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
