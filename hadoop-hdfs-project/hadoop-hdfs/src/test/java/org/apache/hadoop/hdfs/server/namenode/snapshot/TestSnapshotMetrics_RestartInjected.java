...
public class TestSnapshotMetrics_RestartInjected {
  ...
  public void testSnapshottableDirs() throws Exception {
    ...
    RestartFramework.at("after_allow_snapshot_sub1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_allow_snapshot_sub2")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_allow_snapshot_subsub1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testSnapshots() throws Exception {
    ...
    RestartFramework.at("after_create_snapshot_s11")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
