...
public class TestSnapshotMetrics {
    ...
    @Test
    public void testSnapshottableDirs_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("SnapshottableDirectories", 0, getMetrics(NS_METRICS));
        assertCounter("AllowSnapshotOps", 0L, getMetrics(NN_METRICS));
        assertCounter("DisallowSnapshotOps", 0L, getMetrics(NN_METRICS));
    ...
    @Test
    public void testSnapshottableDirs_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("SnapshottableDirectories", 0, getMetrics(NS_METRICS));
        assertCounter("AllowSnapshotOps", 0L, getMetrics(NN_METRICS));
        assertCounter("DisallowSnapshotOps", 0L, getMetrics(NN_METRICS));
    ...
    @Test
    public void testSnapshottableDirs_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("SnapshottableDirectories", 0, getMetrics(NS_METRICS));
        assertCounter("AllowSnapshotOps", 0L, getMetrics(NN_METRICS));
        assertCounter("DisallowSnapshotOps", 0L, getMetrics(NN_METRICS));
    ...
    @Test
    public void testSnapshottableDirs_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("SnapshottableDirectories", 0, getMetrics(NS_METRICS));
        assertCounter("AllowSnapshotOps", 0L, getMetrics(NN_METRICS));
        assertCounter("DisallowSnapshotOps", 0L, getMetrics(NN_METRICS));
    ...
    @Test
    public void testSnapshots_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("Snapshots", 0, getMetrics(NS_METRICS));
        assertCounter("CreateSnapshotOps", 0L, getMetrics(NN_METRICS));
        // change the metrics
    ...
    @Test
    public void testSnapshots_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("Snapshots", 0, getMetrics(NS_METRICS));
        assertCounter("CreateSnapshotOps", 0L, getMetrics(NN_METRICS));
        // change the metrics
    ...
    @Test
    public void testSnapshots_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("Snapshots", 0, getMetrics(NS_METRICS));
        assertCounter("CreateSnapshotOps", 0L, getMetrics(NN_METRICS));
        // change the metrics
    ...
    @Test
    public void testSnapshots_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        assertGauge("Snapshots", 0, getMetrics(NS_METRICS));
        assertCounter("CreateSnapshotOps", 0L, getMetrics(NN_METRICS));
        // change the metrics
