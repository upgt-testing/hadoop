...
public class TestReadStripedFileWithDNFailure {
    ...
    @Test
    public void testReadWithDNFailure_withUpgrade20() throws Exception {
        try {
            // setup a new cluster with no dead datanode
            setup();
    ...
    @Test
    public void testReadWithDNFailure_withUpgrade40() throws Exception {
        try {
            // setup a new cluster with no dead datanode
            setup();
            ReadStripedFileWithDecodingHelper.testReadWithDNFailure(cluster, dfs, fileLength, dnFailureNum);
    ...
    @Test
    public void testReadWithDNFailure_withUpgrade80() throws Exception {
        try {
            // setup a new cluster with no dead datanode
            setup();
            ReadStripedFileWithDecodingHelper.testReadWithDNFailure(cluster, dfs, fileLength, dnFailureNum);
