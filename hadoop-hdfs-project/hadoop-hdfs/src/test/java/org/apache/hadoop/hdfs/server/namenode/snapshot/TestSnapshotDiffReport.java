...
public class TestSnapshotDiffReport {
     ...
     * of directories.
     */
    static void modifyAndCreateSnapshot(Path modifyDir, Path[] snapshotDirs, DistributedFileSystem hdfs, Function<Path, String> getSnapshotName) throws Exception {
    ...
    public void testSnapRootDescendantDiffReport() throws Exception {
        ...
        try {
            ...
            GenericTestUtils.assertExceptionContains("The path " + nonSnapDir + " is neither snapshottable nor under a snapshot root!", e);
        }
        final String invalidName = "invalid";
        try {
    ...
    public void testSubtrees() throws Exception {
        ...
        final SnapshottableDirectoryStatus[] snapshottables = hdfs.getSnapshottableDirListing();
    ...
    private void assertDiff(Path root, Path foo, Path bar, String from, String to) throws Exception {
