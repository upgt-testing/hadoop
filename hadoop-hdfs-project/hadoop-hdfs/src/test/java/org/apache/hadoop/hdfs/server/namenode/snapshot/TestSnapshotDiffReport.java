...
public class TestSnapshotDiffReport {
    ...
    public void testSnapshotDiffInfo() throws Exception {
        ...
        INodeDirectoryJVMInterface snapshotRootDir = cluster.getNameNode().getNamesystem().getFSDirectory().getINode(snapshotRootDirPath.toUri().getPath()).asDirectory();
        INodeDirectoryJVMInterface snapshotRootDescendantDir = cluster.getNameNode().getNamesystem().getFSDirectory().getINode(snapshotDirDescendantPath.toUri().getPath()).asDirectory();
        INodeDirectoryJVMInterface snapshotRootNonDescendantDir = cluster.getNameNode().getNamesystem().getFSDirectory().getINode(snapshotDirNonDescendantPath.toUri().getPath()).asDirectory();
        /*
    try {
    ...
    @Test(timeout = 60000)
    public void testDiffReport_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        Path subsub1 = new Path(sub1, "subsub1");
        Path subsubsub1 = new Path(subsub1, "subsubsub1");
        hdfs.mkdirs(subsubsub1);
    ...
    @Test(timeout = 60000)
    public void testDiffReport_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        Path subsub1 = new Path(sub1, "subsub1");
        Path subsubsub1 = new Path(subsub1, "subsubsub1");
        hdfs.mkdirs(subsubsub1);
    ...
    @Test(timeout = 60000)
    public void testDiffReport_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        Path subsub1 = new Path(sub1, "subsub1");
        Path subsubsub1 = new Path(subsub1, "subsubsub1");
        hdfs.mkdirs(subsubsub1);
    ...
    @Test(timeout = 60000)
    public void testDiffReport_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        Path subsub1 = new Path(sub1, "subsub1");
        Path subsubsub1 = new Path(subsub1, "subsubsub1");
        hdfs.mkdirs(subsubsub1);
    ...
    @Test
    public void testSnapshotDiffInfo_withUpgrade20() throws Exception {
        Path snapshotRootDirPath = dir;
        Path snapshotDirDescendantPath = new Path(snapshotRootDirPath, "desc");
        Path snapshotDirNonDescendantPath = new Path("/dummy/non/snap/desc");
        hdfs.mkdirs(snapshotDirDescendantPath);
    ...
    @Test
    public void testSnapshotDiffInfo_withUpgrade40() throws Exception {
        Path snapshotRootDirPath = dir;
        Path snapshotDirDescendantPath = new Path(snapshotRootDirPath, "desc");
        Path snapshotDirNonDescendantPath = new Path("/dummy/non/snap/desc");
        hdfs.mkdirs(snapshotDirDescendantPath);
    ...
    @Test
    public void testSnapshotDiffInfo_withUpgrade60() throws Exception {
        Path snapshotRootDirPath = dir;
        Path snapshotDirDescendantPath = new Path(snapshotRootDirPath, "desc");
        Path snapshotDirNonDescendantPath = new Path("/dummy/non/snap/desc");
        hdfs.mkdirs(snapshotDirDescendantPath);
    ...
    @Test
    public void testSnapshotDiffInfo_withUpgrade80() throws Exception {
        Path snapshotRootDirPath = dir;
        Path snapshotDirDescendantPath = new Path(snapshotRootDirPath, "desc");
        Path snapshotDirNonDescendantPath = new Path("/dummy/non/snap/desc");
        hdfs.mkdirs(snapshotDirDescendantPath);
    ...
    @Test
    public void testDontCaptureAccessTimeOnlyChangeReport_withUpgrade20() throws Exception {
        final Path froot = new Path("/");
        final Path root = new Path(froot, "/testSdiffCalc");
        // items created pre enabling snapshot
        final Path filePreSS = new Path(root, "fParent/filePreSS");
    ...
    @Test
    public void testDontCaptureAccessTimeOnlyChangeReport_withUpgrade40() throws Exception {
        final Path froot = new Path("/");
        final Path root = new Path(froot, "/testSdiffCalc");
        // items created pre enabling snapshot
        final Path filePreSS = new Path(root, "fParent/filePreSS");
    ...
    @Test
    public void testDontCaptureAccessTimeOnlyChangeReport_withUpgrade60() throws Exception {
        final Path froot = new Path("/");
        final Path root = new Path(froot, "/testSdiffCalc");
        // items created pre enabling snapshot
        final Path filePreSS = new Path(root, "fParent/filePreSS");
    ...
    @Test
    public void testDontCaptureAccessTimeOnlyChangeReport_withUpgrade80() throws Exception {
        final Path froot = new Path("/");
        final Path root = new Path(froot, "/testSdiffCalc");
        // items created pre enabling snapshot
        final Path filePreSS = new Path(root, "fParent/filePreSS");
