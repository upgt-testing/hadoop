...
public class TestFileCreationClient {
    ...
    public void testClientTriggeredLeaseRecovery() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(REPLICATION).build();
        try {
    ...
    @Test
    public void testClientTriggeredLeaseRecovery_withUpgrade20() throws Exception {
        final int REPLICATION = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, REPLICATION);
    ...
    @Test
    public void testClientTriggeredLeaseRecovery_withUpgrade40() throws Exception {
        final int REPLICATION = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, REPLICATION);
    ...
    @Test
    public void testClientTriggeredLeaseRecovery_withUpgrade60() throws Exception {
        final int REPLICATION = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, REPLICATION);
    ...
    @Test
    public void testClientTriggeredLeaseRecovery_withUpgrade80() throws Exception {
        final int REPLICATION = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, REPLICATION);
