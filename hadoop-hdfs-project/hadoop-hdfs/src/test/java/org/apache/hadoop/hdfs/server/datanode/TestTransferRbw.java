...
public class TestTransferRbw {
    ...
    public void testTransferRbw() throws Exception {
        ...
        try {
            ...
            final DataNodeInterface newnode;
            final DatanodeInfoInterface newnodeinfo;
            final String bpid = cluster.getNamesystem().getBlockPoolId();
            {
                final DataNodeInterface oldnode = cluster.getDataNodes().get(0);
                ...
                final DatanodeInfoInterface oldnodeinfo;
                {
                    ...
                    int i = 0;
                    for (DatanodeRegistrationInterface dnReg = newnode.getDNRegistrationForBP(bpid); i < datatnodeinfos.length && !datatnodeinfos[i].equals(dnReg); i++) ;
