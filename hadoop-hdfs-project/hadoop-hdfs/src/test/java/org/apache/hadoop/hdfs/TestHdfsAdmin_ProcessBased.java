...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestHdfsAdmin}.
 *
 * Transformed from MiniDFSCluster to ProcessBasedMiniDFSCluster to enable
 * process-based testing and multi-version upgrade scenarios.
 *
 * @see TestHdfsAdmin Original test using MiniDFSCluster
 */
public class TestHdfsAdmin_ProcessBased {
  ...
  @Before
  public void setUpCluster() throws IOException, TimeoutException {
    conf.setLong(
  ...
  @Test
  public void testGetKeyProvider() throws IOException, TimeoutException {
    HdfsAdmin hdfsAdmin = new HdfsAdmin(FileSystem.getDefaultUri(conf), conf);
