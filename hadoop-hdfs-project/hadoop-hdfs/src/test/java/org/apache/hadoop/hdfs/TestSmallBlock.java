...
public class TestSmallBlock {
    ...
    @Test
    public void testSmallBlock_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testSmallBlock_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testSmallBlock_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testSmallBlock_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
