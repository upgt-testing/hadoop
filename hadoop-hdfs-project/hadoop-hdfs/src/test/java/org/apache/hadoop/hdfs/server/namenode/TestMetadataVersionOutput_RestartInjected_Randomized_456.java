...
public class TestMetadataVersionOutput_RestartInjected_Randomized_456 {
    ...
    public void testMetadataVersionOutput() throws IOException {
        ...
        RestartFramework.at("after_cluster_up").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
