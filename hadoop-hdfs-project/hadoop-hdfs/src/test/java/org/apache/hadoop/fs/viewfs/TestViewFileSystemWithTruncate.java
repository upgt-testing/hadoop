...
public class TestViewFileSystemWithTruncate {
    ...
    @Test(timeout = 30000)
    public void testTruncateWithViewFileSystem_withUpgrade20() throws Exception {
        Path filePath = new Path(mountOnNn1 + "/ttest");
        Path hdfFilepath = new Path("/tmp/TestViewFileSystemWithXAttrs/ttest");
        FSDataOutputStream out = fsView.create(filePath);
        out.writeBytes("drtatedasfdasfgdfas");
    ...
    @Test(timeout = 30000)
    public void testTruncateWithViewFileSystem_withUpgrade40() throws Exception {
        Path filePath = new Path(mountOnNn1 + "/ttest");
        Path hdfFilepath = new Path("/tmp/TestViewFileSystemWithXAttrs/ttest");
        FSDataOutputStream out = fsView.create(filePath);
        out.writeBytes("drtatedasfdasfgdfas");
    ...
    @Test(timeout = 30000)
    public void testTruncateWithViewFileSystem_withUpgrade60() throws Exception {
        Path filePath = new Path(mountOnNn1 + "/ttest");
        Path hdfFilepath = new Path("/tmp/TestViewFileSystemWithXAttrs/ttest");
        FSDataOutputStream out = fsView.create(filePath);
        out.writeBytes("drtatedasfdasfgdfas");
