...
public class TestRenameWhileOpen {
   ...
   */
    ...
    @Test
    public void testWhileOpenRenameParentToNonexistentDir_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameParentToNonexistentDir_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameParentToNonexistentDir_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameParentToNonexistentDir_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToExistentDirectory_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToExistentDirectory_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToExistentDirectory_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToExistentDirectory_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToNonExistentDirectory_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToNonExistentDirectory_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToNonExistentDirectory_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testWhileOpenRenameToNonExistentDirectory_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
