 ...
 */
public class TestNNHandlesCombinedBlockReport_RestartInjected_Randomized_456 extends BlockReportTestBase_RestartInjected {
    ...
    protected void sendBlockReports(DatanodeRegistration dnR, String poolId, StorageBlockReport[] reports) throws IOException {
        ...
        cluster.getNameNodeRpc().blockReport(dnR, poolId, reports, new BlockReportContext(1, 0, System.nanoTime(), 0L));
    }
}
