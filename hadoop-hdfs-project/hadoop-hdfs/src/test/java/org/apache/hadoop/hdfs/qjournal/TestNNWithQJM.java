...
public class TestNNWithQJM {
    ...
    public void testLogAndRestart() throws IOException {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).build();
        try {
    ...
    public void testNewNamenodeTakesOverWriter() throws Exception {
        File nn1Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn1");
        File nn2Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn2");
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, nn1Dir.getAbsolutePath());
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        // Start the cluster once to generate the dfs dirs
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).checkExitOnShutdown(false).build();
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).format(false).manageNameDfsDirs(false).checkExitOnShutdown(false).build();
            cluster.getFileSystem().mkdirs(TEST_PATH);
            ...
            MiniDFSClusterInJVM cluster2 = new MiniDFSClusterInJVM.Builder(conf2).numDataNodes(0).format(false).manageNameDfsDirs(false).build();
    ...
    public void testMismatchedNNIsRejected() throws Exception {
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).format(false).checkExitOnShutdown(false).build();
            fail("New NN with different namespace should have been rejected");
        } catch (ExitException ee) {
            GenericTestUtils.assertExceptionContains("Unable to start log segment 1: too few journals", ee);
            assertTrue("Didn't terminate properly ", ExitUtil.terminateCalled());
        }
    }

    @Test(timeout = 30000)
    public void testLogAndRestart_withUpgrade20() throws IOException {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).build();
        try {
    ...
    @Test(timeout = 30000)
    public void testLogAndRestart_withUpgrade40() throws IOException {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).build();
        try {
    ...
    @Test(timeout = 30000)
    public void testLogAndRestart_withUpgrade60() throws IOException {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).build();
        try {
    ...
    @Test(timeout = 30000)
    public void testLogAndRestart_withUpgrade80() throws IOException {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).manageNameDfsDirs(false).build();
        try {
    ...
    @Test(timeout = 30000)
    public void testNewNamenodeTakesOverWriter_withUpgrade20() throws Exception {
        File nn1Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn1");
        File nn2Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn2");
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, nn1Dir.getAbsolutePath());
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
    ...
    @Test(timeout = 30000)
    public void testNewNamenodeTakesOverWriter_withUpgrade40() throws Exception {
        File nn1Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn1");
        File nn2Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn2");
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, nn1Dir.getAbsolutePath());
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
    ...
    @Test(timeout = 30000)
    public void testNewNamenodeTakesOverWriter_withUpgrade60() throws Exception {
        File nn1Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn1");
        File nn2Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn2");
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, nn1Dir.getAbsolutePath());
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
    ...
    @Test(timeout = 30000)
    public void testNewNamenodeTakesOverWriter_withUpgrade80() throws Exception {
        File nn1Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn1");
        File nn2Dir = new File(MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image-nn2");
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, nn1Dir.getAbsolutePath());
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
    ...
    @Test(timeout = 30000)
    public void testMismatchedNNIsRejected_withUpgrade20() throws Exception {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        String defaultEditsDir = conf.get(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY);
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        // and QJM.
    ...
    @Test(timeout = 30000)
    public void testMismatchedNNIsRejected_withUpgrade40() throws Exception {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        String defaultEditsDir = conf.get(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY);
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        // and QJM.
    ...
    @Test(timeout = 30000)
    public void testMismatchedNNIsRejected_withUpgrade60() throws Exception {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        String defaultEditsDir = conf.get(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY);
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        // and QJM.
    ...
    @Test(timeout = 30000)
    public void testMismatchedNNIsRejected_withUpgrade80() throws Exception {
        conf.set(DFSConfigKeys.DFS_NAMENODE_NAME_DIR_KEY, MiniDFSClusterInJVM.getBaseDirectory() + "/TestNNWithQJM/image");
        String defaultEditsDir = conf.get(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY);
        conf.set(DFSConfigKeys.DFS_NAMENODE_EDITS_DIR_KEY, mjc.getQuorumJournalURI("myjournal").toString());
        // and QJM.
