...
public class TestSecureNameNode extends SaslDataTransferTestCase {
    ...
    @Test
    public void testNameNodeStatusMXBeanSecurityEnabled_withUpgrade20() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // disabling security
        UserGroupInformation.setConfiguration(simpleConf);
    ...
    @Test
    public void testNameNodeStatusMXBeanSecurityEnabled_withUpgrade40() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // disabling security
        UserGroupInformation.setConfiguration(simpleConf);
    ...
    @Test
    public void testNameNodeStatusMXBeanSecurityEnabled_withUpgrade60() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // disabling security
        UserGroupInformation.setConfiguration(simpleConf);
    ...
    @Test
    public void testNameNodeStatusMXBeanSecurityEnabled_withUpgrade80() throws Exception {
        Configuration simpleConf = new Configuration();
        Configuration secureConf = createSecureConfig("authentication");
        // disabling security
        UserGroupInformation.setConfiguration(simpleConf);
