...
public class TestFileCreation {
    ...
    public void testServerDefaults() throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(DFSConfigKeys.DFS_REPLICATION_DEFAULT + 1).build();
        cluster.waitActive();
   ...
   */
    ...
    public void checkFileCreation(String netIf, boolean useDnHostname) throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).checkDataNodeHostConfig(true).build();
        FileSystem fs = cluster.getFileSystem();
        try {
            //
            // check that / exists
   ...
   */
    ...
    public void testFileCreationNamenodeRestart() throws IOException, NoSuchFieldException, IllegalAccessException {
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).nameNodePort(nnport).format(false).build();
            cluster.waitActive();
   ...
   */
    ...
    @Test
    public void testServerDefaults_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFS_BLOCK_SIZE_KEY, DFS_BLOCK_SIZE_DEFAULT);
        conf.setInt(DFS_BYTES_PER_CHECKSUM_KEY, DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setInt(DFS_CLIENT_WRITE_PACKET_SIZE_KEY, DFS_CLIENT_WRITE_PACKET_SIZE_DEFAULT);
    ...
    @Test
    public void testServerDefaults_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFS_BLOCK_SIZE_KEY, DFS_BLOCK_SIZE_DEFAULT);
        conf.setInt(DFS_BYTES_PER_CHECKSUM_KEY, DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setInt(DFS_CLIENT_WRITE_PACKET_SIZE_KEY, DFS_CLIENT_WRITE_PACKET_SIZE_DEFAULT);
    ...
    @Test
    public void testServerDefaults_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFS_BLOCK_SIZE_KEY, DFS_BLOCK_SIZE_DEFAULT);
        conf.setInt(DFS_BYTES_PER_CHECKSUM_KEY, DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setInt(DFS_CLIENT_WRITE_PACKET_SIZE_KEY, DFS_CLIENT_WRITE_PACKET_SIZE_DEFAULT);
    ...
    @Test
    public void testServerDefaults_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFS_BLOCK_SIZE_KEY, DFS_BLOCK_SIZE_DEFAULT);
        conf.setInt(DFS_BYTES_PER_CHECKSUM_KEY, DFS_BYTES_PER_CHECKSUM_DEFAULT);
        conf.setInt(DFS_CLIENT_WRITE_PACKET_SIZE_KEY, DFS_CLIENT_WRITE_PACKET_SIZE_DEFAULT);
    ...
    @Test
    public void testDeleteOnExit_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testDeleteOnExit_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testDeleteOnExit_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testDeleteOnExit_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testOverwriteOpenForWrite_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testOverwriteOpenForWrite_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testOverwriteOpenForWrite_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testOverwriteOpenForWrite_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        SimulatedFSDataset.setFactory(conf);
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testFileCreationError1_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFS_HEARTBEAT_INTERVAL_KEY, 1);
        if (simulatedStorage) {
    ...
    @Test
    public void testFileCreationError1_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFS_HEARTBEAT_INTERVAL_KEY, 1);
        if (simulatedStorage) {
    ...
    @Test
    public void testFileCreationError1_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFS_HEARTBEAT_INTERVAL_KEY, 1);
        if (simulatedStorage) {
    ...
    @Test
    public void testFileCreationError1_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFS_HEARTBEAT_INTERVAL_KEY, 1);
        if (simulatedStorage) {
    ...
    @Test
    public void testFileCreationError2_withUpgrade20() throws IOException {
        long leasePeriod = 1000;
        System.out.println("testFileCreationError2 start");
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
    ...
    @Test
    public void testFileCreationError2_withUpgrade40() throws IOException {
        long leasePeriod = 1000;
        System.out.println("testFileCreationError2 start");
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
    ...
    @Test
    public void testFileCreationError2_withUpgrade60() throws IOException {
        long leasePeriod = 1000;
        System.out.println("testFileCreationError2 start");
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
    ...
    @Test
    public void testFileCreationError2_withUpgrade80() throws IOException {
        long leasePeriod = 1000;
        System.out.println("testFileCreationError2 start");
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
    ...
    @Test
    public void testFileCreationNamenodeRestart_withUpgrade20() throws IOException, NoSuchFieldException, IllegalAccessException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testFileCreationNamenodeRestart_withUpgrade40() throws IOException, NoSuchFieldException, IllegalAccessException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testFileCreationNamenodeRestart_withUpgrade60() throws IOException, NoSuchFieldException, IllegalAccessException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testFileCreationNamenodeRestart_withUpgrade80() throws IOException, NoSuchFieldException, IllegalAccessException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testDFSClientDeath_withUpgrade20() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        System.out.println("Testing adbornal client death.");
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
    ...
    @Test
    public void testDFSClientDeath_withUpgrade40() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        System.out.println("Testing adbornal client death.");
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
    ...
    @Test
    public void testDFSClientDeath_withUpgrade60() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        System.out.println("Testing adbornal client death.");
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
    ...
    @Test
    public void testDFSClientDeath_withUpgrade80() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        System.out.println("Testing adbornal client death.");
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
    ...
    @Test
    public void testFileCreationNonRecursive_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testFileCreationNonRecursive_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        if (simulatedStorage) {
            SimulatedFSDataset.setFactory(conf);
        }
    ...
    @Test
    public void testConcurrentFileCreation_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testConcurrentFileCreation_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testConcurrentFileCreation_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testConcurrentFileCreation_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testFileCreationSyncOnClose_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_DATANODE_SYNCONCLOSE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testFileCreationSyncOnClose_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_DATANODE_SYNCONCLOSE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testFileCreationSyncOnClose_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_DATANODE_SYNCONCLOSE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testFileCreationSyncOnClose_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFS_DATANODE_SYNCONCLOSE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
    ...
    @Test
    public void testFsClose_withUpgrade20() throws Exception {
        System.out.println("test file system close start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        // create cluster
    ...
    @Test
    public void testFsClose_withUpgrade40() throws Exception {
        System.out.println("test file system close start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        // create cluster
    ...
    @Test
    public void testFsClose_withUpgrade60() throws Exception {
        System.out.println("test file system close start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        // create cluster
    ...
    @Test
    public void testFsClose_withUpgrade80() throws Exception {
        System.out.println("test file system close start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        // create cluster
    ...
    @Test
    public void testFsCloseAfterClusterShutdown_withUpgrade20() throws IOException {
        System.out.println("test testFsCloseAfterClusterShutdown start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_REPLICATION_MIN_KEY, 3);
    ...
    @Test
    public void testFsCloseAfterClusterShutdown_withUpgrade40() throws IOException {
        System.out.println("test testFsCloseAfterClusterShutdown start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_REPLICATION_MIN_KEY, 3);
    ...
    @Test
    public void testFsCloseAfterClusterShutdown_withUpgrade60() throws IOException {
        System.out.println("test testFsCloseAfterClusterShutdown start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_REPLICATION_MIN_KEY, 3);
    ...
    @Test
    public void testFsCloseAfterClusterShutdown_withUpgrade80() throws IOException {
        System.out.println("test testFsCloseAfterClusterShutdown start");
        final int DATANODE_NUM = 3;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFS_NAMENODE_REPLICATION_MIN_KEY, 3);
