...
public class TestFavoredNodesEndToEnd {
    ...
    {
        GenericTestUtils.setLogLevel(LogFactory.getLog(BlockPlacementPolicy.class), Level.ALL);
    }
   ...
   */
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEnd_withUpgrade20() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEnd_withUpgrade40() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEnd_withUpgrade60() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEnd_withUpgrade80() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testWhenFavoredNodesNotPresent_withUpgrade20() throws Exception {
        //and three hosts for that
        InetSocketAddress[] arbitraryAddrs = new InetSocketAddress[3];
        for (int i = 0; i < 3; i++) {
            arbitraryAddrs[i] = getArbitraryLocalHostAddr();
    ...
    @Test(timeout = 180000)
    public void testWhenFavoredNodesNotPresent_withUpgrade40() throws Exception {
        //and three hosts for that
        InetSocketAddress[] arbitraryAddrs = new InetSocketAddress[3];
        for (int i = 0; i < 3; i++) {
            arbitraryAddrs[i] = getArbitraryLocalHostAddr();
    ...
    @Test(timeout = 180000)
    public void testWhenFavoredNodesNotPresent_withUpgrade60() throws Exception {
        //and three hosts for that
        InetSocketAddress[] arbitraryAddrs = new InetSocketAddress[3];
        for (int i = 0; i < 3; i++) {
            arbitraryAddrs[i] = getArbitraryLocalHostAddr();
    ...
    @Test(timeout = 180000)
    public void testWhenFavoredNodesNotPresent_withUpgrade80() throws Exception {
        //and three hosts for that
        InetSocketAddress[] arbitraryAddrs = new InetSocketAddress[3];
        for (int i = 0; i < 3; i++) {
            arbitraryAddrs[i] = getArbitraryLocalHostAddr();
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEndForAppend_withUpgrade20() throws Exception {
        // create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            // pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEndForAppend_withUpgrade40() throws Exception {
        // create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            // pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEndForAppend_withUpgrade60() throws Exception {
        // create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            // pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testFavoredNodesEndToEndForAppend_withUpgrade80() throws Exception {
        // create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            // pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testCreateStreamBuilderFavoredNodesEndToEnd_withUpgrade20() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testCreateStreamBuilderFavoredNodesEndToEnd_withUpgrade40() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testCreateStreamBuilderFavoredNodesEndToEnd_withUpgrade60() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
    ...
    @Test(timeout = 180000)
    public void testCreateStreamBuilderFavoredNodesEndToEnd_withUpgrade80() throws Exception {
        //create 10 files with random preferred nodes
        for (int i = 0; i < NUM_FILES; i++) {
            Random rand = new Random(System.currentTimeMillis() + i);
            //pass a new created rand so as to get a uniform distribution each time
