...
public class TestFavoredNodesEndToEnd {
    ...
    public void testWhenSomeNodesAreNotGood() throws Exception {
        ...
        DatanodeInfoInterface d = cluster.getNameNode().getNamesystem().getBlockManager().getDatanodeManager().getDatanodeByXferAddr(addrs[0].getAddress().getHostAddress(), addrs[0].getPort());
