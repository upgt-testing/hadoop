...
public class TestHDFSContractSeek_RestartInjected_Randomized_123 extends AbstractContractSeekTest {

    private static final Logger LOG = LoggerFactory.getLogger(TestHDFSContractSeek_RestartInjected.class);
    ...
    public void testSeekZeroByteFile() throws Throwable {
        ...
        RestartFramework.at("after_open_zero_byte_file").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testBlockReadZeroByteFile() throws Throwable {
        ...
        RestartFramework.at("after_open_for_block_read").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSeekReadClosedFile() throws Throwable {
        ...
        RestartFramework.at("after_open_before_close").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testNegativeSeek() throws Throwable {
        ...
        RestartFramework.at("after_open_for_negative_seek").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(0, instream.getPos());
    }

    @Test
    public void testSeekFile() throws Throwable {
        RestartFramework.at("mid_seek_operations").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        describe("basic seek operations");
        instream = getFileSystem().open(smallSeekFile);
        RestartFramework.at("after_open_for_seek").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(0, instream.getPos());
        instream.seek(0);
        int result = instream.read();
    ...
    public void testSeekAndReadPastEndOfFile() throws Throwable {
        ...
        instream = getFileSystem().open(smallSeekFile);
        assertEquals(0, instream.getPos());
        RestartFramework.at("after_open_before_seek_to_end").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSeekPastEndOfFileThenReseekAndRead() throws Throwable {
        ...
        RestartFramework.at("before_seek_past_eof").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        instream = getFileSystem().open(smallSeekFile);
    ...
    public void testSeekBigFile() throws Throwable {
        ...
        RestartFramework.at("after_big_file_creation").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        instream.seek(0);
        int result = instream.read();
        RestartFramework.at("mid_big_file_seeks").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(0, result);
        assertEquals(1, instream.read());
        assertEquals(2, instream.read());
        instream.seek(32768);
    ...
    public void testPositionedBulkReadDoesntChangePosition() throws Throwable {
        ...
        assertEquals(40000, instream.getPos());
        RestartFramework.at("after_file_creation_for_positioned_read").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("@40000", block[40000], (byte) instream.read());
        for (int i = 0; i < 256; i++) {
    ...
    public void testRandomSeeks() throws Throwable {
        ...
        RestartFramework.at("after_file_creation_for_random_seeks").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try (FSDataInputStream stm = getFileSystem().open(randomSeekFile)) {
            for (int i = 0; i < limit; i++) {
                ...
                if (i == limit / 2) {
                    RestartFramework.at("mid_random_seeks").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
                }
            }
    ...
    public void testReadFullyZeroByteFile() throws Throwable {
        ...
        assumeSupportsPositionedReadable();
        RestartFramework.at("after_open_zero_byte_for_readfully").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        instream = getFileSystem().open(zeroByteFile);
        assertEquals(0, instream.getPos());
        byte[] buffer = new byte[1];
    ...
    public void testReadFullyPastEOFZeroByteFile() throws Throwable {
        ...
        instream = getFileSystem().open(zeroByteFile);
        byte[] buffer = new byte[1];
        RestartFramework.at("before_readfully_past_eof_zero").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testReadFullySmallFile() throws Throwable {
        ...
        RestartFramework.at("after_open_for_readfully").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assumeSupportsPositionedReadable();
        instream = getFileSystem().open(smallSeekFile);
    ...
    public void testReadFullyPastEOF() throws Throwable {
        ...
        assumeSupportsPositionedReadable();
        RestartFramework.at("before_readfully_past_eof").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        instream = getFileSystem().open(smallSeekFile);
        byte[] buffer = new byte[256];
        try {
    ...
    public void testReadFullyZeroBytebufferPastEOF() throws Throwable {
        ...
        assumeSupportsPositionedReadable();
        RestartFramework.at("before_zero_byte_readfully_past_eof").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        instream = getFileSystem().open(smallSeekFile);
        byte[] buffer = new byte[256];
        try {
            instream.readFully(TEST_FILE_LEN + 1, buffer, 0, 0);
    ...
    public void testReadNullBuffer() throws Throwable {
        ...
        RestartFramework.at("before_null_buffer_read").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assumeSupportsPositionedReadable();
    ...
    public void testReadSmallFile() throws Throwable {
        ...
        RestartFramework.at("after_open_for_positioned_read").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assumeSupportsPositionedReadable();
        instream = getFileSystem().open(smallSeekFile);
        byte[] buffer = new byte[256];
        int r;
    ...
    public void testReadAtExactEOF() throws Throwable {
        RestartFramework.at("before_seek_to_exact_eof").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        describe("read at the end of the file");
        instream = getFileSystem().open(smallSeekFile);
        instream.seek(TEST_FILE_LEN - 1);
        assertTrue("read at last byte", instream.read() > 0);
        RestartFramework.at("after_read_at_eof").on(HDFSContract.getCluster()).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
