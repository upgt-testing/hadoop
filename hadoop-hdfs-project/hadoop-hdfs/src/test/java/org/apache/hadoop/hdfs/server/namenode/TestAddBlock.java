...
public class TestAddBlock {
    ...
    @Test
    public void testAddBlock_withUpgrade20() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        final Path file2 = new Path("/file2");
        final Path file3 = new Path("/file3");
    ...
    @Test
    public void testAddBlock_withUpgrade40() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        final Path file2 = new Path("/file2");
        final Path file3 = new Path("/file3");
    ...
    @Test
    public void testAddBlock_withUpgrade60() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        final Path file2 = new Path("/file2");
        final Path file3 = new Path("/file3");
    ...
    @Test
    public void testAddBlock_withUpgrade80() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        final Path file2 = new Path("/file2");
        final Path file3 = new Path("/file3");
    ...
    @Test
    public void testAddBlockUC_withUpgrade20() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        DFSTestUtil.createFile(fs, file1, BLOCKSIZE - 1, REPLICATION, 0L);
        FSDataOutputStream out = null;
    ...
    @Test
    public void testAddBlockUC_withUpgrade40() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        DFSTestUtil.createFile(fs, file1, BLOCKSIZE - 1, REPLICATION, 0L);
        FSDataOutputStream out = null;
    ...
    @Test
    public void testAddBlockUC_withUpgrade60() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        DFSTestUtil.createFile(fs, file1, BLOCKSIZE - 1, REPLICATION, 0L);
        FSDataOutputStream out = null;
    ...
    @Test
    public void testAddBlockUC_withUpgrade80() throws Exception {
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path file1 = new Path("/file1");
        DFSTestUtil.createFile(fs, file1, BLOCKSIZE - 1, REPLICATION, 0L);
        FSDataOutputStream out = null;
