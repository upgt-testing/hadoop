...
public class TestWebHdfsFileSystemContract extends FileSystemContractBaseTest {
    ...
    private static final MiniDFSClusterInJVM cluster;
    ...
    @Test
    public void testAccess_withUpgrade20() throws IOException, InterruptedException {
        Path p1 = new Path("/pathX");
        try {
            UserGroupInformation ugi = UserGroupInformation.createUserForTesting("alpha", new String[] { "beta" });
            WebHdfsFileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testAccess_withUpgrade40() throws IOException, InterruptedException {
        Path p1 = new Path("/pathX");
        try {
            UserGroupInformation ugi = UserGroupInformation.createUserForTesting("alpha", new String[] { "beta" });
            WebHdfsFileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testAccess_withUpgrade60() throws IOException, InterruptedException {
        Path p1 = new Path("/pathX");
        try {
            UserGroupInformation ugi = UserGroupInformation.createUserForTesting("alpha", new String[] { "beta" });
            WebHdfsFileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testAccess_withUpgrade80() throws IOException, InterruptedException {
        Path p1 = new Path("/pathX");
        try {
            UserGroupInformation ugi = UserGroupInformation.createUserForTesting("alpha", new String[] { "beta" });
            WebHdfsFileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystemAs(ugi, conf, WebHdfsConstants.WEBHDFS_SCHEME);
