...
public class TestFileAppend {
    ...
    public void testBreakHardlinksIfNeeded() throws IOException {
        ...
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf, builderBaseDir).build();
        ...
        try {
            ...
            DataNodeInterface[] dn = cluster.listDataNodes();
    ...
    public void testMultipleAppends() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        final MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf, builderBaseDir).numDataNodes(4).build();
    ...
    public void testAppendAfterSoftLimit() throws IOException, InterruptedException {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf, builderBaseDir).numDataNodes(1).build();
    ...
    public void testFailedAppendBlockRejection() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf, builderBaseDir).numDataNodes(3).build();
