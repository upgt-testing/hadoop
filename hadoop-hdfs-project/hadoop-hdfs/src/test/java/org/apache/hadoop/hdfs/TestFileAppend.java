...
public class TestFileAppend {
    ...
    static final DataChecksum DEFAULT_CHECKSUM = DataChecksum.newDataChecksum(DataChecksum.Type.CRC32C, 512);
   ...
   */
    ...
    public void testMultipleAppends() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(4).build();
    ...
    public void testAppendAfterSoftLimit() throws IOException, InterruptedException {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(1).build();
    ...
    public void testFailedAppendBlockRejection() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
   ...
   */
    @Test
    public void testSimpleFlush_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testSimpleFlush_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testSimpleFlush_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testSimpleFlush_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testComplexFlush_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testComplexFlush_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testComplexFlush_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test
    public void testComplexFlush_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
    ...
    @Test(expected = FileNotFoundException.class)
    public void testFileNotFound_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test(expected = FileNotFoundException.class)
    public void testFileNotFound_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test(expected = FileNotFoundException.class)
    public void testFileNotFound_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testAppendTwice_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final FileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppendTwice_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final FileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppendTwice_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final FileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppendTwice_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final FileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppend2Twice_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final DistributedFileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppend2Twice_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final DistributedFileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppend2Twice_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final DistributedFileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testAppend2Twice_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        final DistributedFileSystem fs1 = cluster.getFileSystem();
    ...
    @Test
    public void testMultipleAppends_withUpgrade20() throws Exception {
        final long startTime = Time.monotonicNow();
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_FILE_CLOSE_NUM_COMMITTED_ALLOWED_KEY, 1);
        conf.setBoolean(HdfsClientConfigKeys.BlockWrite.ReplaceDatanodeOnFailure.ENABLE_KEY, false);
    ...
    @Test
    public void testMultipleAppends_withUpgrade40() throws Exception {
        final long startTime = Time.monotonicNow();
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_FILE_CLOSE_NUM_COMMITTED_ALLOWED_KEY, 1);
        conf.setBoolean(HdfsClientConfigKeys.BlockWrite.ReplaceDatanodeOnFailure.ENABLE_KEY, false);
    ...
    @Test
    public void testMultipleAppends_withUpgrade80() throws Exception {
        final long startTime = Time.monotonicNow();
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_FILE_CLOSE_NUM_COMMITTED_ALLOWED_KEY, 1);
        conf.setBoolean(HdfsClientConfigKeys.BlockWrite.ReplaceDatanodeOnFailure.ENABLE_KEY, false);
    ...
    @Test
    public void testAppendAfterSoftLimit_withUpgrade20() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppendAfterSoftLimit_withUpgrade40() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppendAfterSoftLimit_withUpgrade60() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppendAfterSoftLimit_withUpgrade80() throws IOException, InterruptedException {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppend2AfterSoftLimit_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppend2AfterSoftLimit_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppend2AfterSoftLimit_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testAppend2AfterSoftLimit_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        //Set small soft-limit for lease
        final long softLimit = 1L;
    ...
    @Test
    public void testFailedAppendBlockRejection_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testFailedAppendBlockRejection_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testFailedAppendBlockRejection_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testFailedAppendBlockRejection_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testMultiAppend2_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testMultiAppend2_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testMultiAppend2_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test
    public void testMultiAppend2_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).build();
    ...
    @Test(timeout = 10000)
    public void testAppendCorruptedBlock_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test(timeout = 10000)
    public void testAppendCorruptedBlock_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test(timeout = 10000)
    public void testAppendCorruptedBlock_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test(timeout = 10000)
    public void testAppendCorruptedBlock_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
