 ...
 */
public class TestPendingInvalidateBlock_RestartInjected_Randomized_456 {
    ...
    public void testPendingDeletion() throws Exception {
        ...
        RestartFramework.at("after_first_block_report").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testPendingDeleteUnknownBlocks() throws Exception {
        ...
        RestartFramework.at("after_files_deletion").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
