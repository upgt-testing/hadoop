...
public class TestDFSShellGenericOptions {
    ...
    @Test
    public void testDFSCommand_withUpgrade20() throws IOException {
        String namenode = null;
        MiniDFSClusterInJVM cluster = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testDFSCommand_withUpgrade40() throws IOException {
        String namenode = null;
        MiniDFSClusterInJVM cluster = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testDFSCommand_withUpgrade60() throws IOException {
        String namenode = null;
        MiniDFSClusterInJVM cluster = null;
        try {
            Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testDFSCommand_withUpgrade80() throws IOException {
        String namenode = null;
        MiniDFSClusterInJVM cluster = null;
        try {
            Configuration conf = new HdfsConfiguration();
