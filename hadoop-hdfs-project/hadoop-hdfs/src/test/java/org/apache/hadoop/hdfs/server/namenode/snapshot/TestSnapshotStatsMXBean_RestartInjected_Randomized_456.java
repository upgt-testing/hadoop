...
public class TestSnapshotStatsMXBean_RestartInjected_Randomized_456 {
    ...
    public void testSnapshotStatsMXBeanInfo() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_query_directories").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
