...
public class SnapshotTestHelper {
    ...
    public static Path getSnapshotRoot(Path snapshottedDir, String snapshotName) {
        return new Path(snapshottedDir, HdfsConstants.DOT_SNAPSHOT_DIR + "/" + snapshotName);
    }
    ...
    public static void dumpTree2File(FSDirectory fsdir, File f) throws IOException {
        ...
        fsdir.getINode("/").dumpTreeRecursively(out, new StringBuilder(), Snapshot.CURRENT_STATE_ID);
        out.close();
    }
    ...
    public static void dumpTree(String message, MiniDockerDFSCluster cluster) throws UnresolvedLinkException {
