...
public class TestLargeBlock {
    ...
    public void runTest_withUpgrade20(final long blockSize) throws IOException {
        // write a file that is slightly larger than 1 block
        final long fileSize = blockSize + 1L;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    public void runTest_withUpgrade40(final long blockSize) throws IOException {
        // write a file that is slightly larger than 1 block
        final long fileSize = blockSize + 1L;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    public void runTest_withUpgrade60(final long blockSize) throws IOException {
        // write a file that is slightly larger than 1 block
        final long fileSize = blockSize + 1L;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    public void runTest_withUpgrade80(final long blockSize) throws IOException {
        // write a file that is slightly larger than 1 block
        final long fileSize = blockSize + 1L;
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 900000)
    public void testLargeBlockSize_withUpgrade20() throws IOException {
        // 2GB + 512B
        final long blockSize = 2L * 1024L * 1024L * 1024L + 512L;
        runTest_withUpgrade20(blockSize);
    }

    @Test(timeout = 900000)
    public void testLargeBlockSize_withUpgrade40() throws IOException {
        // 2GB + 512B
        final long blockSize = 2L * 1024L * 1024L * 1024L + 512L;
        runTest_withUpgrade40(blockSize);
    }

    @Test(timeout = 900000)
    public void testLargeBlockSize_withUpgrade60() throws IOException {
        // 2GB + 512B
        final long blockSize = 2L * 1024L * 1024L * 1024L + 512L;
        runTest_withUpgrade60(blockSize);
    }

    @Test(timeout = 900000)
    public void testLargeBlockSize_withUpgrade80() throws IOException {
        // 2GB + 512B
        final long blockSize = 2L * 1024L * 1024L * 1024L + 512L;
        runTest_withUpgrade80(blockSize);
    }
}
