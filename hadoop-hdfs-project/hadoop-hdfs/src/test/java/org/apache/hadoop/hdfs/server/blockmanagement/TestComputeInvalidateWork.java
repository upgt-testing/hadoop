...
public class TestComputeInvalidateWork {
    ...
    public void setup() throws Exception {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(NUM_OF_DATANODES).build();
        cluster.waitActive();
    ...
    public void testDatanodeReformat() throws Exception {
        ...
        try {
            ...
            DatanodeRegistrationInterface dnr = cluster.getDataNode(nodes[0].getIpcPort()).getDNRegistrationForBP(poolId);
    ...
    public void testDatanodeReRegistration() throws Exception {
        ...
        for (DataNodeInterface dn : cluster.getDataNodes()) {
            DatanodeIDInterface did = dn.getDatanodeId();
