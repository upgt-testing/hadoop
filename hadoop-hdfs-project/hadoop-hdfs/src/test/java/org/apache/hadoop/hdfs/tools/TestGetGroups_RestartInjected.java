 ...
 */
public class TestGetGroups_RestartInjected extends GetGroupsTestBase {
  ...
  public void testNoUserGiven() throws Exception {
    ...
    RestartFramework.at("after_get_groups_no_user")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testExistingUser() throws Exception {
    ...
    RestartFramework.at("after_get_groups_existing_user")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleExistingUsers() throws Exception {
    ...
    RestartFramework.at("after_get_groups_multiple_users")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNonExistentUser() throws Exception {
    ...
    RestartFramework.at("after_get_groups_nonexistent_user")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleNonExistingUsers() throws Exception {
    ...
    RestartFramework.at("after_get_groups_multiple_nonexistent")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testExistingInterleavedWithNonExistentUsers() throws Exception {
    ...
    RestartFramework.at("after_get_groups_interleaved_users")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
