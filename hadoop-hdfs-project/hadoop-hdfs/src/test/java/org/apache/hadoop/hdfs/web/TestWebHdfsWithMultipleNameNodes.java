...
public class TestWebHdfsWithMultipleNameNodes {
    ...
    private static void setupCluster(final int nNameNodes, final int nDataNodes) throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(nNameNodes)).numDataNodes(nDataNodes).build();
        cluster.waitActive();
    ...
    @Test
    public void testRedirect_withUpgrade20() throws Exception {
        final String dir = "/testRedirect/";
        final String filename = "file";
        final Path p = new Path(dir, filename);
        final String[] writeStrings = createStrings("write to webhdfs ", "write");
    ...
    @Test
    public void testRedirect_withUpgrade40() throws Exception {
        final String dir = "/testRedirect/";
        final String filename = "file";
        final Path p = new Path(dir, filename);
        final String[] writeStrings = createStrings("write to webhdfs ", "write");
    ...
    @Test
    public void testRedirect_withUpgrade60() throws Exception {
        final String dir = "/testRedirect/";
        final String filename = "file";
        final Path p = new Path(dir, filename);
        final String[] writeStrings = createStrings("write to webhdfs ", "write");
    ...
    @Test
    public void testRedirect_withUpgrade80() throws Exception {
        final String dir = "/testRedirect/";
        final String filename = "file";
        final Path p = new Path(dir, filename);
        final String[] writeStrings = createStrings("write to webhdfs ", "write");
