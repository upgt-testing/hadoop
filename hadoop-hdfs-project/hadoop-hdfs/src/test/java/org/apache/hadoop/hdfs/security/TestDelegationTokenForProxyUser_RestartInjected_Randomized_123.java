...
public class TestDelegationTokenForProxyUser_RestartInjected_Randomized_123 {
    ...
    public void testDelegationTokenWithRealUser() throws IOException {
        try {
            ...
            RestartFramework.at("after_token_addition").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
