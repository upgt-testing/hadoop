 ...
 */
public class TestSlowDiskTracker_RestartInjected_Randomized_456 {
    ...
    public void testDataNodeHeartbeatSlowDiskReport() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_reports_received").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
