...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestFileConcurrentReader}.
 *
 * Transformed from MiniDFSCluster to ProcessBasedMiniDFSCluster to enable
 * process-based testing and multi-version upgrade scenarios.
 *
 * This class tests the cases of concurrent reads/writes to a file;
 * ie, one writer and one or more readers can see unfinished blocks.
 *
 * @see TestFileConcurrentReader Original test using MiniDFSCluster
 */
@RunWith(Parameterized.class)
public class TestFileConcurrentReader_ProcessBased extends ProcessBasedUpgradeTestBase {
  ...
  private static final Logger LOG =
    Logger.getLogger(TestFileConcurrentReader_ProcessBased.class);
   ...
   */
  @Test (timeout = 30000)
  public void testUnfinishedBlockRead() throws Exception {
    init(conf);
    ...
    checkpoint("AFTER_FILE_WRITE_SYNC");

    // Make sure a client can read it before it is closed
    checkCanRead(fileSystem, file1, partialBlockSize);
    checkpoint("AFTER_READ_CHECK");
   ...
   */
  @Test (timeout = 30000)
  public void testUnfinishedBlockPacketBufferOverrun() throws Exception {
    init(conf);
    checkpoint(UpgradeCheckpoints.AFTER_CLUSTER_START);
  ...
  @Test (timeout = 30000)
  public void testImmediateReadOfNewFile() throws Exception {
  ...
  // so test separately
  @Test (timeout = 30000)
  public void testUnfinishedBlockCRCErrorTransferTo() throws Exception {
    runTestUnfinishedBlockCRCError(true, SyncType.SYNC, DEFAULT_WRITE_SIZE);
  }

  @Test (timeout = 30000)
  public void testUnfinishedBlockCRCErrorTransferToVerySmallWrite() throws Exception {
    runTestUnfinishedBlockCRCError(true, SyncType.SYNC, SMALL_WRITE_SIZE);
  }

  // fails due to issue w/append, disable
  @Ignore
  public void _testUnfinishedBlockCRCErrorTransferToAppend() throws Exception {
    runTestUnfinishedBlockCRCError(true, SyncType.APPEND, DEFAULT_WRITE_SIZE);
  }

  @Test (timeout = 30000)
  public void testUnfinishedBlockCRCErrorNormalTransfer() throws Exception {
    runTestUnfinishedBlockCRCError(false, SyncType.SYNC, DEFAULT_WRITE_SIZE);
  }

  @Test (timeout = 30000)
  public void testUnfinishedBlockCRCErrorNormalTransferVerySmallWrite() throws Exception {
    runTestUnfinishedBlockCRCError(false, SyncType.SYNC, SMALL_WRITE_SIZE);
  }

  // fails due to issue w/append, disable
  @Ignore
  public void _testUnfinishedBlockCRCErrorNormalTransferAppend() throws Exception {
  ...
  private void runTestUnfinishedBlockCRCError(
    ...
    runTestUnfinishedBlockCRCError(
      transferToAllowed, syncType, writeSize, new HdfsConfiguration()
    );
  }
  ...
  private void runTestUnfinishedBlockCRCError(
    ...
    testConf.setBoolean(DFSConfigKeys.DFS_DATANODE_TRANSFERTO_ALLOWED_KEY,
        transferToAllowed);
    init(testConf);
    checkpoint(UpgradeCheckpoints.AFTER_CLUSTER_START);
