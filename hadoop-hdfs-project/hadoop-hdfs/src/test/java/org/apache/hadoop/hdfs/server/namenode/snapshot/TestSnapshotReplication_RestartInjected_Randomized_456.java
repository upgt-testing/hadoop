 ...
 * snapshots.
 */
public class TestSnapshotReplication_RestartInjected_Randomized_456 {
    ...
    public void testReplicationWithoutSnapshot() throws Exception {
        ...
        RestartFramework.at("after_change_replication").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_check_replication").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testReplicationWithSnapshot() throws Exception {
        ...
        RestartFramework.at("after_final_replication_change").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        for (; fileRep < NUMDATANODE; ) {
            ...
            RestartFramework.at("after_create_snapshot_" + fileRep).on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_set_replication_" + fileRep).on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
