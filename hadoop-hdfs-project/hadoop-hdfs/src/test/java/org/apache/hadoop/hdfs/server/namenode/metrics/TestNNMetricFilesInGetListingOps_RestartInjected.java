 ...
 */
public class TestNNMetricFilesInGetListingOps_RestartInjected {
  ...
  public void testFilesInGetListingOps() throws Exception {
    ...
    RestartFramework.at("after_tmp1_files")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_tmp2_files")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_first_listing")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_listing")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
