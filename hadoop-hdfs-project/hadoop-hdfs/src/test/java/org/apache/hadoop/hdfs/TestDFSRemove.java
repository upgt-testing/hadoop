...
public class TestDFSRemove {
    ...
    @Test
    public void testRemove_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testRemove_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testRemove_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
