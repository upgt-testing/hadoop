...
public class TestDiffListBySkipList_RestartInjected {
  ...
  static void testAddFirst(int n) throws Exception {
    ...
    RestartFramework.at("after_creating_children_in_addFirst")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_initial_snapshot_in_addFirst")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_deletes_and_snapshots_in_addFirst")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  static INodeDirectory addDiff(int n, DiffList skipList, DiffList arrayList,
    ...
    RestartFramework.at("after_initial_snapshot_in_addDiff")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_all_snapshots_in_addDiff")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  static void testRemove(String name, int n,
    ...
    RestartFramework.at("after_all_deletions_in_testRemove")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
