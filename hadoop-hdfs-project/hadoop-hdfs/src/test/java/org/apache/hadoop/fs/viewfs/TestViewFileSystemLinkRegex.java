...
public class TestViewFileSystemLinkRegex extends ViewFileSystemBaseTest {
    ...
    public static void clusterSetupAtBeginning() throws IOException {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(clusterConfig).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(NAME_SPACES_COUNT)).numDataNodes(DATA_NODES_COUNT).build();
    ...
    public String buildReplaceInterceptorSettingString(String srcRegex, String replaceString) {
        return RegexMountPointInterceptorType.REPLACE_RESOLVED_DST_PATH.getConfigName() + INTERCEPTOR_INTERNAL_SEP + srcRegex + INTERCEPTOR_INTERNAL_SEP + replaceString;
    }
    ...
    private void testRegexMountpoint(Configuration config, String regexStr, String dstPathStr, String interceptorSettings, Path dirPathBeforeMountPoint, Path expectedResolveResult, int childrenFilesCnt) throws IOException, URISyntaxException {
        // Set up test env
        createDirWithChildren(fsTarget, expectedResolveResult, childrenFilesCnt);
        ConfigUtil.addLinkRegex(config, CLUSTER_NAME, regexStr, dstPathStr, interceptorSettings);
        // Asserts
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, CLUSTER_NAME, "/", null, null);
        try (FileSystem vfs = FileSystem.get(viewFsUri, config)) {
            Assert.assertEquals(expectedResolveResult.toString(), vfs.resolvePath(dirPathBeforeMountPoint).toString());
            Assert.assertTrue(vfs.getFileStatus(dirPathBeforeMountPoint).isDirectory());
            ...
            ChRootedFileSystem target1 = (ChRootedFileSystem) viewFileSystem.fsState.resolve(viewFileSystem.getUriPath(dirPathBeforeMountPoint), true).targetFileSystem;
            ChRootedFileSystem target2 = (ChRootedFileSystem) viewFileSystem.fsState.resolve(viewFileSystem.getUriPath(dirPathBeforeMountPoint), true).targetFileSystem;
    ...
    public void testConfLinkRegexIndexMapping() throws Exception {
        ...
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, null, srcPath, expectedResolveResult, 3);
        // Config:
        //   <property>
        ...
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, null, srcPath, expectedResolveResult, 4);
        // Config:
        //   <property>
        //     <name>fs.viewfs.mounttable.TestViewFileSystemLinkRegexCluster
        //     .linkRegex.^/(\w+)</name>
        ...
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, null, srcPath, expectedResolveResult, 5);
        // Config:
        //   <property>
        //     <name>fs.viewfs.mounttable.TestViewFileSystemLinkRegexCluster
        //     .linkRegex.^/(\w+)</name>
        ...
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, null, srcPath, expectedResolveResult, 6);
    }
    ...
    public void testConfLinkRegexFixedDestMapping() throws Exception {
        ...
        // Expect path: /targetTestRoot/testConfLinkRegexFixedDestMappingFile
        String regexStr = "^/\\w+";
        String dstPathStr = targetTestRoot + "testConfLinkRegexFixedDestMappingFile";
        Path expectedResolveResult = new Path(dstPathStr);
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, null, new Path("/misc1"), expectedResolveResult, 5);
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, null, new Path("/misc2"), expectedResolveResult, 6);
    }
    ...
    public void testConfLinkRegexWithSingleInterceptor() throws Exception {
        ...
        Path expectedResolveResult = new Path(targetTestRoot, "hadoop-user1/hadoop_dir1");
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, settingString, srcPath, expectedResolveResult, 2);
    }
    ...
    public void testConfLinkRegexWithInterceptors() throws Exception {
        ...
        String interceptor2 = buildReplaceInterceptorSettingString("hadoop", "hdfs");
        String interceptors = linkInterceptorSettings(Arrays.asList(interceptor1, interceptor2));
        Path srcPath = new Path("/user/hadoop_user1/hadoop_dir1");
        Path expectedResolveResult = new Path(targetTestRoot, "hdfs-user1/hadoop_dir1");
        testRegexMountpoint(new Configuration(conf), regexStr, dstPathStr, interceptors, srcPath, expectedResolveResult, 2);
    }

    @Test
    public void testConfLinkRegexIndexMapping_withUpgrade20() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexIndexMapping1
        String regexStr = "^/(\\w+)";
        String dstPathStr = targetTestRoot + "$1";
        Path srcPath = new Path("/testConfLinkRegexIndexMapping1");
    ...
    @Test
    public void testConfLinkRegexIndexMapping_withUpgrade40() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexIndexMapping1
        String regexStr = "^/(\\w+)";
        String dstPathStr = targetTestRoot + "$1";
        Path srcPath = new Path("/testConfLinkRegexIndexMapping1");
    ...
    @Test
    public void testConfLinkRegexIndexMapping_withUpgrade60() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexIndexMapping1
        String regexStr = "^/(\\w+)";
        String dstPathStr = targetTestRoot + "$1";
        Path srcPath = new Path("/testConfLinkRegexIndexMapping1");
    ...
    @Test
    public void testConfLinkRegexIndexMapping_withUpgrade80() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexIndexMapping1
        String regexStr = "^/(\\w+)";
        String dstPathStr = targetTestRoot + "$1";
        Path srcPath = new Path("/testConfLinkRegexIndexMapping1");
    ...
    @Test
    public void testConfLinkRegexNamedGroupMapping_withUpgrade20() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexNamedGroupMapping1
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, CLUSTER_NAME, "/", null, null);
        String regexStr = "^/(?<firstDir>\\w+)";
        String dstPathStr = targetTestRoot + "$firstDir";
    ...
    @Test
    public void testConfLinkRegexNamedGroupMapping_withUpgrade40() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexNamedGroupMapping1
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, CLUSTER_NAME, "/", null, null);
        String regexStr = "^/(?<firstDir>\\w+)";
        String dstPathStr = targetTestRoot + "$firstDir";
    ...
    @Test
    public void testConfLinkRegexNamedGroupMapping_withUpgrade60() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexNamedGroupMapping1
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, CLUSTER_NAME, "/", null, null);
        String regexStr = "^/(?<firstDir>\\w+)";
        String dstPathStr = targetTestRoot + "$firstDir";
    ...
    @Test
    public void testConfLinkRegexNamedGroupMapping_withUpgrade80() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexNamedGroupMapping1
        URI viewFsUri = new URI(FsConstants.VIEWFS_SCHEME, CLUSTER_NAME, "/", null, null);
        String regexStr = "^/(?<firstDir>\\w+)";
        String dstPathStr = targetTestRoot + "$firstDir";
    ...
    @Test
    public void testConfLinkRegexFixedDestMapping_withUpgrade20() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexFixedDestMappingFile
        String regexStr = "^/\\w+";
        String dstPathStr = targetTestRoot + "testConfLinkRegexFixedDestMappingFile";
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testConfLinkRegexFixedDestMapping_withUpgrade40() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexFixedDestMappingFile
        String regexStr = "^/\\w+";
        String dstPathStr = targetTestRoot + "testConfLinkRegexFixedDestMappingFile";
        Path expectedResolveResult = new Path(dstPathStr);
    ...
    @Test
    public void testConfLinkRegexFixedDestMapping_withUpgrade60() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexFixedDestMappingFile
        String regexStr = "^/\\w+";
        String dstPathStr = targetTestRoot + "testConfLinkRegexFixedDestMappingFile";
        Path expectedResolveResult = new Path(dstPathStr);
    ...
    @Test
    public void testConfLinkRegexFixedDestMapping_withUpgrade80() throws Exception {
        // Expect path: /targetTestRoot/testConfLinkRegexFixedDestMappingFile
        String regexStr = "^/\\w+";
        String dstPathStr = targetTestRoot + "testConfLinkRegexFixedDestMappingFile";
        Path expectedResolveResult = new Path(dstPathStr);
    ...
    @Test
    public void testConfLinkRegexWithSingleInterceptor_withUpgrade20() throws Exception {
        String regexStr = "^/user/(?<username>\\w+)";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
        String settingString = buildReplaceInterceptorSettingString("_", "-");
    ...
    @Test
    public void testConfLinkRegexWithSingleInterceptor_withUpgrade40() throws Exception {
        String regexStr = "^/user/(?<username>\\w+)";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
        String settingString = buildReplaceInterceptorSettingString("_", "-");
    ...
    @Test
    public void testConfLinkRegexWithSingleInterceptor_withUpgrade60() throws Exception {
        String regexStr = "^/user/(?<username>\\w+)";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
        String settingString = buildReplaceInterceptorSettingString("_", "-");
    ...
    @Test
    public void testConfLinkRegexWithSingleInterceptor_withUpgrade80() throws Exception {
        String regexStr = "^/user/(?<username>\\w+)";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
        String settingString = buildReplaceInterceptorSettingString("_", "-");
    ...
    @Test
    public void testConfLinkRegexWithInterceptors_withUpgrade20() throws Exception {
        // Expect path: /targetTestRoot/hdfs-user1/hadoop_dir1
        String regexStr = "^/user/(?<username>\\w+)/";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
    ...
    @Test
    public void testConfLinkRegexWithInterceptors_withUpgrade40() throws Exception {
        // Expect path: /targetTestRoot/hdfs-user1/hadoop_dir1
        String regexStr = "^/user/(?<username>\\w+)/";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
    ...
    @Test
    public void testConfLinkRegexWithInterceptors_withUpgrade60() throws Exception {
        // Expect path: /targetTestRoot/hdfs-user1/hadoop_dir1
        String regexStr = "^/user/(?<username>\\w+)/";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
    ...
    @Test
    public void testConfLinkRegexWithInterceptors_withUpgrade80() throws Exception {
        // Expect path: /targetTestRoot/hdfs-user1/hadoop_dir1
        String regexStr = "^/user/(?<username>\\w+)/";
        String dstPathStr = targetTestRoot + "$username";
        // Replace "_" with "-"
