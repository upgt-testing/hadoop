...
public class TestViewFileSystemLinkRegex extends ViewFileSystemBaseTest {
    ...
    public static void clusterSetupAtBeginning() throws IOException {
        ...
        cluster = new MiniDockerDFSCluster.Builder(clusterConfig).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(NAME_SPACES_COUNT)).numDataNodes(DATA_NODES_COUNT).build();
