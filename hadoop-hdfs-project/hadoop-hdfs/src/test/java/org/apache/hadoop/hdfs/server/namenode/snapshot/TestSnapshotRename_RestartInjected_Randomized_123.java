 ...
 */
public class TestSnapshotRename_RestartInjected_Randomized_123 {
    ...
    public void testSnapshotList() throws Exception {
        ...
        RestartFramework.at("after_rename_s1_to_s4").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_rename_s22_to_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        checkSnapshotList(srcRoot, new String[] { "s2", "s22", "s4" }, new String[] { "s4", "s2", "s22" });
        // Rename s22 to s0
        hdfs.renameSnapshot(sub1, "s22", "s0");
        RestartFramework.at("after_rename_s3_to_s22").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSnapshotRename() throws Exception {
        ...
        RestartFramework.at("after_rename_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testQuotaAndRenameWithSnapshot() throws Exception {
        RestartFramework.at("after_create_snapshot_snap2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        String dirr = "/dir2";
        Path dir2 = new Path(dirr);
        Path fil1 = new Path(dir2, "file1");
        hdfs.mkdirs(dir2);
        RestartFramework.at("after_rename_file").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_create_snapshot_snap1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.getFileStatus(dir2);
        Path filex = new Path(dir2, "filex");
        RestartFramework.at("after_setup_quota_and_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRenameAcrossDirWithinSnapshot() throws Exception {
        ...
        hdfs.setQuota(dir2, 3, 0);
        RestartFramework.at("after_create_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_setup_source_dir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.create(fil1);
        Path file2 = new Path(dir2, "file2");
        hdfs.rename(fil1, file2);
        RestartFramework.at("after_setup_root_dir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Path fil3 = new Path(dir2, "file3");
        hdfs.create(fil3);
        RestartFramework.at("after_rename_across_dirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_setup_dest_dir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRenameInSameDirWithSnapshotableRoot() throws Exception {
        ...
        String rootStr = "/dir";
        RestartFramework.at("after_setup_snapshottable_root").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_file").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
