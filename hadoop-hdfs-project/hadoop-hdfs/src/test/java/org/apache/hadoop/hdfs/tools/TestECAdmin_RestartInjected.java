...
public class TestECAdmin_RestartInjected {
  ...
  public void testRS63MinDN() throws Exception {
    ...
    RestartFramework.at("after_verify_cluster_setup")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testEnableNonExistentPolicyMessage() throws Exception {
    ...
    final int ret = runCommandWithParams("-enablePolicy", "-policy",
        "NonExistentPolicy");
    RestartFramework.at("after_enable_policy_attempt")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVerifyClusterSetupWithGivenPolicies() throws Exception {
    ...
    RestartFramework.at("after_verify_rs32")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    ret = runCommandWithParams("-verifyClusterSetup", "-policy",
        RS_10_4, RS_3_2);
    RestartFramework.at("after_verify_multiple_policies")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    ret = runCommandWithParams("-verifyClusterSetup", "-policy",
        "invalidPolicy");
    RestartFramework.at("after_verify_invalid_policy")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    resetOutputs();
    ret = runCommandWithParams("-verifyClusterSetup", "-policy");
    RestartFramework.at("after_verify_no_policy_arg")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
