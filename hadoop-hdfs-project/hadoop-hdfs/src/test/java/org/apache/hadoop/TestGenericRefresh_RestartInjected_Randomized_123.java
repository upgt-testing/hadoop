 ...
 */
public class TestGenericRefresh_RestartInjected_Randomized_123 {
    ...
    public void setUp() throws Exception {
        ...
        RestartFramework.at("after_handlers_registered").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testValidIdentifier() throws Exception {
        ...
        RestartFramework.at("after_refresh_execution").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testVariableArgs() throws Exception {
        ...
        RestartFramework.at("after_first_variable_args_call").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testUnregistration() throws Exception {
        ...
        DFSAdmin admin = new DFSAdmin(config);
        RestartFramework.at("after_handler_unregistration").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        String[] args = new String[] { "-refresh", "localhost:" + cluster.getNameNodePort(), "firstHandler" };
        int exitCode = admin.run(args);
    ...
    public void testMultipleRegistration() throws Exception {
        ...
        RestartFramework.at("after_multiple_handlers_registered").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMultipleReturnCodeMerging() throws Exception {
        ...
        int exitCode = admin.run(args);
        RestartFramework.at("after_return_code_handlers_registered").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testExceptionResultsInNormalError() throws Exception {
        ...
        RestartFramework.at("after_exceptional_handlers_registered").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
