 ...
 */
public class TestGenericRefresh_RestartInjected {
  ...
  public void setUp() throws Exception {
    ...
    RestartFramework.at("after_handlers_registered")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testValidIdentifier() throws Exception {
    ...
    int exitCode = admin.run(args);
    RestartFramework.at("after_refresh_execution")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testVariableArgs() throws Exception {
    ...
    RestartFramework.at("after_first_variable_args_call")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testUnregistration() throws Exception {
    RefreshRegistry.defaultRegistry().unregisterAll("firstHandler");
    RestartFramework.at("after_handler_unregistration")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleRegistration() throws Exception {
    ...
    RestartFramework.at("after_multiple_handlers_registered")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMultipleReturnCodeMerging() throws Exception {
    ...
    RestartFramework.at("after_return_code_handlers_registered")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testExceptionResultsInNormalError() throws Exception {
    ...
    RestartFramework.at("after_exceptional_handlers_registered")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
