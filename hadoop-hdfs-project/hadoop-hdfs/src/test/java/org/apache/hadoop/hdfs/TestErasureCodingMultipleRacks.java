...
public class TestErasureCodingMultipleRacks {
    ...
    public void setupCluster(final int numDatanodes, final int numRacks, final int numSingleDnRacks) throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).racks(racks).build();
    ...
    @Test
    public void testSkewedRack1_withUpgrade20() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits, 2, 1);
    ...
    @Test
    public void testSkewedRack1_withUpgrade40() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits, 2, 1);
        final int filesize = ecPolicy.getNumDataUnits() * ecPolicy.getCellSize();
    ...
    @Test
    public void testSkewedRack1_withUpgrade60() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits, 2, 1);
        final int filesize = ecPolicy.getNumDataUnits() * ecPolicy.getCellSize();
    ...
    @Test
    public void testSkewedRack1_withUpgrade80() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits, 2, 1);
        final int filesize = ecPolicy.getNumDataUnits() * ecPolicy.getCellSize();
    ...
    @Test
    public void testSkewedRack2_withUpgrade20() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits * 2, dataUnits, dataUnits - 1);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testSkewedRack2_withUpgrade40() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits * 2, dataUnits, dataUnits - 1);
        final int filesize = ecPolicy.getNumDataUnits() * ecPolicy.getCellSize();
    ...
    @Test
    public void testSkewedRack2_withUpgrade60() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits * 2, dataUnits, dataUnits - 1);
        final int filesize = ecPolicy.getNumDataUnits() * ecPolicy.getCellSize();
    ...
    @Test
    public void testSkewedRack2_withUpgrade80() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        setupCluster(dataUnits + parityUnits * 2, dataUnits, dataUnits - 1);
        final int filesize = ecPolicy.getNumDataUnits() * ecPolicy.getCellSize();
    ...
    @Test
    public void testSkewedRack3_withUpgrade20() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        // on the rest of the racks (which only have 1 DN)
        int numRacks = dataUnits - parityUnits + 2;
    ...
    @Test
    public void testSkewedRack3_withUpgrade40() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        // on the rest of the racks (which only have 1 DN)
        int numRacks = dataUnits - parityUnits + 2;
    ...
    @Test
    public void testSkewedRack3_withUpgrade60() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        // on the rest of the racks (which only have 1 DN)
        int numRacks = dataUnits - parityUnits + 2;
    ...
    @Test
    public void testSkewedRack3_withUpgrade80() throws Exception {
        final int dataUnits = ecPolicy.getNumDataUnits();
        final int parityUnits = ecPolicy.getNumParityUnits();
        // on the rest of the racks (which only have 1 DN)
        int numRacks = dataUnits - parityUnits + 2;
