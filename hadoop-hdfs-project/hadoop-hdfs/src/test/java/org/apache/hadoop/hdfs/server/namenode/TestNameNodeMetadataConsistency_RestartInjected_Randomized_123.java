...
public class TestNameNodeMetadataConsistency_RestartInjected_Randomized_123 {
    ...
    public void testGenerationStampInFuture() throws Exception {
        ...
        ostream.close();
        RestartFramework.at("after_genstamp_modification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
