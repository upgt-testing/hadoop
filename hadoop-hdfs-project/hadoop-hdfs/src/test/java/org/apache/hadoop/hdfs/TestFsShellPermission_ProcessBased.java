...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestFsShellPermission}.
 *
 * Transformed from MiniDFSCluster to ProcessBasedMiniDFSCluster to enable
 * process-based testing and multi-version upgrade scenarios.
 *
 * Tests privilege-related aspects of FsShell, specifically delete operations
 * with various permission configurations and user contexts.
 *
 * @see TestFsShellPermission Original test using MiniDFSCluster
 */
@RunWith(Parameterized.class)
public class TestFsShellPermission_ProcessBased extends ProcessBasedUpgradeTestBase {
  ...
  public void testDelete() throws Exception {
    ...
    FileSystem fileSys = FileSystem.get(URI.create(nnUri), conf);
    ...
    for(TestDeleteHelper t : ta) {
      t.execute(conf,  fileSys);
    }

    checkpoint("AFTER_DELETE_TESTS");
