 ...
 */
public class TestNNHandlesBlockReportPerStorage_RestartInjected_Randomized_456 extends BlockReportTestBase_RestartInjected {
    ...
    protected void sendBlockReports(DatanodeRegistration dnR, String poolId, StorageBlockReport[] reports) throws IOException {
        ...
        for (StorageBlockReport report : reports) {
            ...
            cluster.getNameNodeRpc().blockReport(dnR, poolId, singletonReport, new BlockReportContext(reports.length, i, System.nanoTime(), 0L));
            i++;
        }
    }
}
