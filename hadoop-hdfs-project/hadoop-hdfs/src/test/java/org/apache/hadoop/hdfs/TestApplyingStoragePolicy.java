...
public class TestApplyingStoragePolicy {
    ...
    @Test
    public void testStoragePolicyByDefault_withUpgrade20() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testStoragePolicyByDefault_withUpgrade40() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testStoragePolicyByDefault_withUpgrade60() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testStoragePolicyByDefault_withUpgrade80() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testSetAndUnsetStoragePolicy_withUpgrade20() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testSetAndUnsetStoragePolicy_withUpgrade40() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testSetAndUnsetStoragePolicy_withUpgrade60() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testSetAndUnsetStoragePolicy_withUpgrade80() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path(bar, "/fooz");
    ...
    @Test
    public void testNestedStoragePolicy_withUpgrade20() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path("/foos");
    ...
    @Test
    public void testNestedStoragePolicy_withUpgrade40() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path("/foos");
    ...
    @Test
    public void testNestedStoragePolicy_withUpgrade60() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path("/foos");
    ...
    @Test
    public void testNestedStoragePolicy_withUpgrade80() throws Exception {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path wow = new Path(bar, "wow");
        final Path fooz = new Path("/foos");
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade20() throws IOException {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path fooz = new Path("/fooz");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade40() throws IOException {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path fooz = new Path("/fooz");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade60() throws IOException {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path fooz = new Path("/fooz");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
    ...
    @Test
    public void testSetAndGetStoragePolicy_withUpgrade80() throws IOException {
        final Path foo = new Path("/foo");
        final Path bar = new Path(foo, "bar");
        final Path fooz = new Path("/fooz");
        DFSTestUtil.createFile(fs, bar, SIZE, REPL, 0);
