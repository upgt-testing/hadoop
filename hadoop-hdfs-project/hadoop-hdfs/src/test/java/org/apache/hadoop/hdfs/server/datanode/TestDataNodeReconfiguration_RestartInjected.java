...
public class TestDataNodeReconfiguration_RestartInjected {
  ...
  public void testMaxConcurrentMoversReconfiguration()
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_max_movers")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testBlockReportIntervalReconfiguration()
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_block_report")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataXceiverReconfiguration()
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_receiver_threads")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCacheReportReconfiguration()
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_cache_report")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testSlowPeerParameters() throws Exception {
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_slow_peer")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testSlowDiskParameters() throws ReconfigurationException, IOException {
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_slow_disk")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDfsUsageParameters() throws ReconfigurationException {
    ...
    for (int i = 0; i < NUM_DATA_NODE; i++) {
      ...
      RestartFramework.at("after_reconfigure_dfs_usage")
          .on(cluster)
          .restart("datanode")
          .withIndex(i)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDfsUsageKlass() throws ReconfigurationException, InterruptedException {
    ...
    RestartFramework.at("after_reconfigure_usage_class")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
