...
public class TestExtendedAcls {
    ...
    @Test
    public void testDefaultAclNewChildDirFile_withUpgrade20() throws IOException {
        Path parent = new Path("/testDefaultAclNewChildDirFile");
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
        hdfs.mkdirs(parent);
        hdfs.setAcl(parent, acls);
    ...
    @Test
    public void testDefaultAclNewChildDirFile_withUpgrade40() throws IOException {
        Path parent = new Path("/testDefaultAclNewChildDirFile");
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
        hdfs.mkdirs(parent);
        hdfs.setAcl(parent, acls);
    ...
    @Test
    public void testDefaultAclNewChildDirFile_withUpgrade60() throws IOException {
        Path parent = new Path("/testDefaultAclNewChildDirFile");
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
        hdfs.mkdirs(parent);
        hdfs.setAcl(parent, acls);
    ...
    @Test
    public void testDefaultAclNewChildDirFile_withUpgrade80() throws IOException {
        Path parent = new Path("/testDefaultAclNewChildDirFile");
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
        hdfs.mkdirs(parent);
        hdfs.setAcl(parent, acls);
    ...
    @Test
    public void testDefaultAclExistingDirFile_withUpgrade20() throws Exception {
        Path parent = new Path("/testDefaultAclExistingDirFile");
        hdfs.mkdirs(parent);
        // the old acls
        List<AclEntry> acls1 = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
    ...
    @Test
    public void testDefaultAclExistingDirFile_withUpgrade40() throws Exception {
        Path parent = new Path("/testDefaultAclExistingDirFile");
        hdfs.mkdirs(parent);
        // the old acls
        List<AclEntry> acls1 = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
    ...
    @Test
    public void testDefaultAclExistingDirFile_withUpgrade60() throws Exception {
        Path parent = new Path("/testDefaultAclExistingDirFile");
        hdfs.mkdirs(parent);
        // the old acls
        List<AclEntry> acls1 = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
    ...
    @Test
    public void testDefaultAclExistingDirFile_withUpgrade80() throws Exception {
        Path parent = new Path("/testDefaultAclExistingDirFile");
        hdfs.mkdirs(parent);
        // the old acls
        List<AclEntry> acls1 = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL));
    ...
    @Test
    public void testAccessAclNotInherited_withUpgrade20() throws IOException {
        Path parent = new Path("/testAccessAclNotInherited");
        hdfs.mkdirs(parent);
        // parent have both access acl and default acl
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE), aclEntry(ACCESS, USER, READ_WRITE), aclEntry(ACCESS, GROUP, READ), aclEntry(ACCESS, OTHER, READ), aclEntry(ACCESS, USER, "bar", ALL));
    ...
    @Test
    public void testAccessAclNotInherited_withUpgrade40() throws IOException {
        Path parent = new Path("/testAccessAclNotInherited");
        hdfs.mkdirs(parent);
        // parent have both access acl and default acl
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE), aclEntry(ACCESS, USER, READ_WRITE), aclEntry(ACCESS, GROUP, READ), aclEntry(ACCESS, OTHER, READ), aclEntry(ACCESS, USER, "bar", ALL));
    ...
    @Test
    public void testAccessAclNotInherited_withUpgrade60() throws IOException {
        Path parent = new Path("/testAccessAclNotInherited");
        hdfs.mkdirs(parent);
        // parent have both access acl and default acl
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE), aclEntry(ACCESS, USER, READ_WRITE), aclEntry(ACCESS, GROUP, READ), aclEntry(ACCESS, OTHER, READ), aclEntry(ACCESS, USER, "bar", ALL));
    ...
    @Test
    public void testAccessAclNotInherited_withUpgrade80() throws IOException {
        Path parent = new Path("/testAccessAclNotInherited");
        hdfs.mkdirs(parent);
        // parent have both access acl and default acl
        List<AclEntry> acls = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE), aclEntry(ACCESS, USER, READ_WRITE), aclEntry(ACCESS, GROUP, READ), aclEntry(ACCESS, OTHER, READ), aclEntry(ACCESS, USER, "bar", ALL));
    ...
    @Test
    public void testGradSubdirMoreAccess_withUpgrade20() throws Exception {
        Path parent = new Path("/testGradSubdirMoreAccess");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE));
        List<AclEntry> aclsChild = Lists.newArrayList(aclEntry(DEFAULT, GROUP, "bar", READ_WRITE));
    ...
    @Test
    public void testGradSubdirMoreAccess_withUpgrade40() throws Exception {
        Path parent = new Path("/testGradSubdirMoreAccess");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE));
        List<AclEntry> aclsChild = Lists.newArrayList(aclEntry(DEFAULT, GROUP, "bar", READ_WRITE));
    ...
    @Test
    public void testGradSubdirMoreAccess_withUpgrade60() throws Exception {
        Path parent = new Path("/testGradSubdirMoreAccess");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE));
        List<AclEntry> aclsChild = Lists.newArrayList(aclEntry(DEFAULT, GROUP, "bar", READ_WRITE));
    ...
    @Test
    public void testGradSubdirMoreAccess_withUpgrade80() throws Exception {
        Path parent = new Path("/testGradSubdirMoreAccess");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", READ_EXECUTE));
        List<AclEntry> aclsChild = Lists.newArrayList(aclEntry(DEFAULT, GROUP, "bar", READ_WRITE));
    ...
    @Test
    public void testRestrictAtSubDir_withUpgrade20() throws Exception {
        Path parent = new Path("/testRestrictAtSubDir");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL), aclEntry(DEFAULT, GROUP, "bar", ALL));
        hdfs.setAcl(parent, aclsParent);
    ...
    @Test
    public void testRestrictAtSubDir_withUpgrade40() throws Exception {
        Path parent = new Path("/testRestrictAtSubDir");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL), aclEntry(DEFAULT, GROUP, "bar", ALL));
        hdfs.setAcl(parent, aclsParent);
    ...
    @Test
    public void testRestrictAtSubDir_withUpgrade60() throws Exception {
        Path parent = new Path("/testRestrictAtSubDir");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL), aclEntry(DEFAULT, GROUP, "bar", ALL));
        hdfs.setAcl(parent, aclsParent);
    ...
    @Test
    public void testRestrictAtSubDir_withUpgrade80() throws Exception {
        Path parent = new Path("/testRestrictAtSubDir");
        hdfs.mkdirs(parent);
        List<AclEntry> aclsParent = Lists.newArrayList(aclEntry(DEFAULT, USER, "foo", ALL), aclEntry(DEFAULT, GROUP, "bar", ALL));
        hdfs.setAcl(parent, aclsParent);
