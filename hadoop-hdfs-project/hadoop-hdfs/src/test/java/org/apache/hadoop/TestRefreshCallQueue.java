...
public class TestRefreshCallQueue {
    ...
    private void setUp(Class<?> queueClass) throws IOException {
        ...
        for (; portRetries > 0; --portRetries) {
            ...
            try {
                cluster = new MiniDFSClusterInJVM.Builder(config).nameNodePort(nnPort).build();
                cluster.waitActive();
                break;
    ...
    @Test
    public void testRefreshCallQueueWithFairCallQueue_withUpgrade20() throws Exception {
        setUp(FairCallQueue.class);
        boolean oldValue = DefaultMetricsSystem.inMiniClusterMode();
        // throw an error when we double-initialize JvmMetrics
        DefaultMetricsSystem.setMiniClusterMode(false);
    ...
    @Test
    public void testRefreshCallQueueWithFairCallQueue_withUpgrade40() throws Exception {
        setUp(FairCallQueue.class);
        boolean oldValue = DefaultMetricsSystem.inMiniClusterMode();
        // throw an error when we double-initialize JvmMetrics
        DefaultMetricsSystem.setMiniClusterMode(false);
    ...
    @Test
    public void testRefreshCallQueueWithFairCallQueue_withUpgrade60() throws Exception {
        setUp(FairCallQueue.class);
        boolean oldValue = DefaultMetricsSystem.inMiniClusterMode();
        // throw an error when we double-initialize JvmMetrics
        DefaultMetricsSystem.setMiniClusterMode(false);
    ...
    @Test
    public void testRefreshCallQueueWithFairCallQueue_withUpgrade80() throws Exception {
        setUp(FairCallQueue.class);
        boolean oldValue = DefaultMetricsSystem.inMiniClusterMode();
        // throw an error when we double-initialize JvmMetrics
        DefaultMetricsSystem.setMiniClusterMode(false);
