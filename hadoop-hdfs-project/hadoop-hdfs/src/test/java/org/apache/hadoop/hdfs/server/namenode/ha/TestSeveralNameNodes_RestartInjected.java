...
public class TestSeveralNameNodes_RestartInjected {
  ...
  public void testCircularLinkedListWrites() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_setup_writers")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_start_threads")
          .on(cluster)
          .restart("namenode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_writers_complete")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_stop_threads")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
