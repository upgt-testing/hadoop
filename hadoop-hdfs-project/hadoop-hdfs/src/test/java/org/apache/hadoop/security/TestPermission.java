...
public class TestPermission {
    ...
    @Test
    public void testCreate_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        conf.set(FsPermission.UMASK_LABEL, "000");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testCreate_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        conf.set(FsPermission.UMASK_LABEL, "000");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testCreate_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        conf.set(FsPermission.UMASK_LABEL, "000");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testCreate_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        conf.set(FsPermission.UMASK_LABEL, "000");
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testFilePermission_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
    ...
    @Test
    public void testFilePermission_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
    ...
    @Test
    public void testFilePermission_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
    ...
    @Test
    public void testFilePermission_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
