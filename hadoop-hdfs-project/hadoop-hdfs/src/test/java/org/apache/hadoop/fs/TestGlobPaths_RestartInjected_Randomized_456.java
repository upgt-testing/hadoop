...
public class TestGlobPaths_RestartInjected_Randomized_456 {
    ...
    public void testCRInPathGlob() throws IOException {
        ...
        RestartFramework.at("after_cr_in_path_glob").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        statuses = fs.globStatus(new Path(d1, "f1*"));
        RestartFramework.at("before_cr_in_path_glob").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals("Expected both normal and CR-carrying files in result: ", 2, statuses.length);
        cleanupDFS();
    }
     ...
     */
        ...
        checkStatus(status, d11, d12, d21, d22, f31, d32, f32, d33);
        RestartFramework.at("after_test_multi_glob").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
     ...
     */
        ...
        checkStatus(status);
        status = fs.globStatus(new Path(USER_DIR, "dir*/subdir1/f1*/*"));
        RestartFramework.at("before_test_multi_glob").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        checkStatus(status);
        /*
    ...
    public void testPathFilter() throws IOException {
        RestartFramework.at("before_test_path_filter").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_path_filter").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testPathFilterWithFixedLastComponent() throws IOException {
        RestartFramework.at("before_test_path_filter_with_fixed_last_component").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_path_filter_with_fixed_last_component").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestLiteral() throws IOException {
        RestartFramework.at("before_p_test_literal").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_p_test_literal").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestEscape() throws IOException {
        RestartFramework.at("before_p_test_escape").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_p_test_escape").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void pTestAny() throws IOException {
        RestartFramework.at("after_p_test_any").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_p_test_any").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestClosure1() throws IOException {
        RestartFramework.at("after_p_test_closure1").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_p_test_closure1").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestClosure2() throws IOException {
        RestartFramework.at("before_p_test_closure2").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_p_test_closure2").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestClosure3() throws IOException {
        RestartFramework.at("after_p_test_closure3").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_p_test_closure3").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestClosure4() throws IOException {
        RestartFramework.at("before_p_test_closure4").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
        ...
        RestartFramework.at("after_p_test_closure4").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }

    @Test
    public void pTestClosure5() throws IOException {
        RestartFramework.at("after_p_test_closure5").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_p_test_closure5").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestSet() throws IOException {
        RestartFramework.at("after_p_test_set").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_p_test_set").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestRange() throws IOException {
        RestartFramework.at("before_p_test_range").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_p_test_range").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestSetExcl() throws IOException {
        RestartFramework.at("after_p_test_set_excl").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_p_test_set_excl").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void pTestCombination() throws IOException {
        ...
        RestartFramework.at("before_p_test_combination").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_p_test_combination").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void pTestCurlyBracket() throws IOException {
        ...
        RestartFramework.at("before_p_test_curly_bracket").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        try {
            // test standalone }
            RestartFramework.at("after_p_test_curly_bracket").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void pTestJavaRegexSpecialChars() throws IOException {
        ...
        RestartFramework.at("before_p_test_java_regex_special_chars").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_p_test_java_regex_special_chars").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testGlobWithSymlinksOnFS() throws Exception {
        RestartFramework.at("after_test_glob_with_symlinks_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_glob_with_symlinks_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGlobWithSymlinksOnFC() throws Exception {
        RestartFramework.at("after_test_glob_with_symlinks_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_glob_with_symlinks_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
     ...
     */
    private class TestGlobWithSymlinksToSymlinks extends FSTestWrapperGlobTest {
    ...
    public void testGlobWithSymlinksToSymlinksOnFS() throws Exception {
        RestartFramework.at("before_test_glob_with_symlinks_to_symlinks_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_glob_with_symlinks_to_symlinks_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGlobWithSymlinksToSymlinksOnFC() throws Exception {
        RestartFramework.at("after_test_glob_with_symlinks_to_symlinks_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_glob_with_symlinks_to_symlinks_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
     ...
     */
    private class TestGlobSymlinksWithCustomPathFilter extends FSTestWrapperGlobTest {
    ...
    public void testGlobSymlinksWithCustomPathFilterOnFS() throws Exception {
        RestartFramework.at("after_test_glob_symlinks_with_custom_path_filter_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_glob_symlinks_with_custom_path_filter_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGlobSymlinksWithCustomPathFilterOnFC() throws Exception {
        RestartFramework.at("before_test_glob_symlinks_with_custom_path_filter_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileContext(new TestGlobSymlinksWithCustomPathFilter(true));
        RestartFramework.at("after_test_glob_symlinks_with_custom_path_filter_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    private class TestGlobFillsInScheme extends FSTestWrapperGlobTest {
        ...
        void run() throws Exception {
            ...
            statuses = fc.util().globStatus(new Path("file:///"), new AcceptAllPathFilter());
            Assert.assertEquals(1, statuses.length);
    ...
    public void testGlobFillsInSchemeOnFS() throws Exception {
        RestartFramework.at("before_test_glob_fills_in_scheme_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_glob_fills_in_scheme_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileSystem(new TestGlobFillsInScheme(false));
    }

    @Test
    public void testGlobFillsInSchemeOnFC() throws Exception {
        RestartFramework.at("before_test_glob_fills_in_scheme_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileContext(new TestGlobFillsInScheme(true));
        RestartFramework.at("after_test_glob_fills_in_scheme_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testRelativePathOnFS() throws Exception {
        RestartFramework.at("before_test_relative_path_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileSystem(new TestRelativePath(false));
        RestartFramework.at("after_test_relative_path_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }

    @Test
    public void testRelativePathOnFC() throws Exception {
        RestartFramework.at("after_test_relative_path_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_relative_path_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGlobAccessDeniedOnFS() throws Exception {
        ...
        RestartFramework.at("before_test_glob_access_denied_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_glob_access_denied_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }

    @Test
    public void testGlobAccessDeniedOnFC() throws Exception {
        RestartFramework.at("before_test_glob_access_denied_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileContext(new TestGlobAccessDenied(true));
        RestartFramework.at("after_test_glob_access_denied_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    private class TestReservedHdfsPaths extends FSTestWrapperGlobTest {
        ...
        void run() throws Exception {
            ...
            Assert.assertEquals(reservedRoot, TestPath.mergeStatuses(wrap.globStatus(new Path(reservedRoot), new AcceptAllPathFilter())));
        }
    }

    @Test
    public void testReservedHdfsPathsOnFS() throws Exception {
        RestartFramework.at("after_test_reserved_hdfs_paths_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_reserved_hdfs_paths_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileSystem(new TestReservedHdfsPaths(false));
    }

    @Test
    public void testReservedHdfsPathsOnFC() throws Exception {
        RestartFramework.at("before_test_reserved_hdfs_paths_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_reserved_hdfs_paths_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGlobRootOnFS() throws Exception {
        RestartFramework.at("before_test_glob_root_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_glob_root_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileSystem(new TestGlobRoot(false));
    }

    @Test
    public void testGlobRootOnFC() throws Exception {
        RestartFramework.at("after_test_glob_root_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("before_test_glob_root_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testNonTerminalGlobsOnFS() throws Exception {
        RestartFramework.at("before_test_non_terminal_globs_on_fs").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_test_non_terminal_globs_on_fs").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileSystem(new TestNonTerminalGlobs(false));
    }

    @Test
    public void testNonTerminalGlobsOnFC() throws Exception {
        RestartFramework.at("before_test_non_terminal_globs_on_fc").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        testOnFileContext(new TestNonTerminalGlobs(true));
        RestartFramework.at("after_test_non_terminal_globs_on_fc").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testLocalFilesystem() throws Exception {
        ...
        RestartFramework.at("before_test_local_filesystem").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_test_local_filesystem").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
