...
public class TestFileTruncate {
    ...
    public void setUp() throws IOException {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(DATANODE_NUM).waitSafeMode(true).build();
    ...
    public void testMultipleTruncate() throws IOException {
        ...
        for (int n = data.length; n > 0; ) {
            ...
            assertEquals("Truncate is not idempotent", isReady, fs.truncate(p, newLength));
            if (!isReady) {
                checkBlockRecovery(p);
            }
    ...
    public void testTruncateTwiceTogether() throws Exception {
        ...
        LambdaTestUtils.intercept(RemoteException.class, "/testTruncateTwiceTogether/file is being truncated", () -> fs.truncate(p, data.length - 2));
   ...
   */
    ...
    static void writeContents(byte[] contents, int fileLength, Path p) throws IOException {
        FSDataOutputStream out = fs.create(p, true, BLOCK_SIZE, REPLICATION, BLOCK_SIZE);
    ...
    static void restartCluster(StartupOption o) throws IOException {
        cluster.shutdown();
        if (StartupOption.ROLLBACK == o)
            NameNode.doRollback(conf, false);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(DATANODE_NUM).format(false).startupOption(o == StartupOption.ROLLBACK ? StartupOption.REGULAR : o).dnStartupOption(o != StartupOption.ROLLBACK ? StartupOption.REGULAR : o).build();
        fs = cluster.getFileSystem();
    }
    ...
    public void testQuotaOnTruncateWithSnapshot() throws Exception {
        ...
        assertEquals(fs.getContentSummary(root).getSpaceConsumed(), fs.getQuotaUsage(root).getSpaceConsumed());
    ...
    @Test(timeout = 90000)
    public void testTruncateTwiceTogether_withUpgrade20() throws Exception {
        Path dir = new Path("/testTruncateTwiceTogether");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[100 * BLOCK_SIZE];
    ...
    @Test(timeout = 90000)
    public void testTruncateTwiceTogether_withUpgrade40() throws Exception {
        Path dir = new Path("/testTruncateTwiceTogether");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[100 * BLOCK_SIZE];
    ...
    @Test(timeout = 90000)
    public void testTruncateTwiceTogether_withUpgrade60() throws Exception {
        Path dir = new Path("/testTruncateTwiceTogether");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[100 * BLOCK_SIZE];
    ...
    @Test(timeout = 90000)
    public void testTruncateTwiceTogether_withUpgrade80() throws Exception {
        Path dir = new Path("/testTruncateTwiceTogether");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[100 * BLOCK_SIZE];
    ...
    @Test
    public void testTruncateWithOtherOperations_withUpgrade20() throws IOException {
        Path dir = new Path("/testTruncateOtherOperations");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[2 * BLOCK_SIZE];
    ...
    @Test
    public void testTruncateWithOtherOperations_withUpgrade40() throws IOException {
        Path dir = new Path("/testTruncateOtherOperations");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[2 * BLOCK_SIZE];
    ...
    @Test
    public void testTruncateWithOtherOperations_withUpgrade60() throws IOException {
        Path dir = new Path("/testTruncateOtherOperations");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[2 * BLOCK_SIZE];
    ...
    @Test
    public void testTruncateWithOtherOperations_withUpgrade80() throws IOException {
        Path dir = new Path("/testTruncateOtherOperations");
        fs.mkdirs(dir);
        final Path p = new Path(dir, "file");
        final byte[] data = new byte[2 * BLOCK_SIZE];
    ...
    @Test
    public void testTruncateFailure_withUpgrade20() throws IOException {
        int startingFileSize = 2 * BLOCK_SIZE + BLOCK_SIZE / 2;
        int toTruncate = 1;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path dir = new Path("/dir");
    ...
    @Test
    public void testTruncateFailure_withUpgrade40() throws IOException {
        int startingFileSize = 2 * BLOCK_SIZE + BLOCK_SIZE / 2;
        int toTruncate = 1;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path dir = new Path("/dir");
    ...
    @Test
    public void testTruncateFailure_withUpgrade60() throws IOException {
        int startingFileSize = 2 * BLOCK_SIZE + BLOCK_SIZE / 2;
        int toTruncate = 1;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path dir = new Path("/dir");
    ...
    @Test
    public void testTruncateFailure_withUpgrade80() throws IOException {
        int startingFileSize = 2 * BLOCK_SIZE + BLOCK_SIZE / 2;
        int toTruncate = 1;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path dir = new Path("/dir");
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestart_withUpgrade20() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestart_withUpgrade40() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestart_withUpgrade60() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestart_withUpgrade80() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testCopyOnTruncateWithDataNodesRestart_withUpgrade20() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testCopyOnTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testCopyOnTruncateWithDataNodesRestart_withUpgrade40() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testCopyOnTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testCopyOnTruncateWithDataNodesRestart_withUpgrade60() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testCopyOnTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testCopyOnTruncateWithDataNodesRestart_withUpgrade80() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testCopyOnTruncateWithDataNodesRestart");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestartImmediately_withUpgrade20() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestartImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestartImmediately_withUpgrade40() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestartImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestartImmediately_withUpgrade60() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestartImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesRestartImmediately_withUpgrade80() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesRestartImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesShutdownImmediately_withUpgrade20() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesShutdownImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesShutdownImmediately_withUpgrade40() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesShutdownImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesShutdownImmediately_withUpgrade60() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesShutdownImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test(timeout = 60000)
    public void testTruncateWithDataNodesShutdownImmediately_withUpgrade80() throws Exception {
        int startingFileSize = 3 * BLOCK_SIZE;
        byte[] contents = AppendTestUtil.initBuffer(startingFileSize);
        final Path p = new Path(parent, "testTruncateWithDataNodesShutdownImmediately");
        writeContents(contents, startingFileSize, p);
    ...
    @Test
    public void testTruncateEditLogLoad_withUpgrade20() throws IOException {
        // purge previously accumulated edits
        fs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
        fs.saveNamespace();
        fs.setSafeMode(SafeModeAction.SAFEMODE_LEAVE);
    ...
    @Test
    public void testTruncateEditLogLoad_withUpgrade40() throws IOException {
        // purge previously accumulated edits
        fs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
        fs.saveNamespace();
        fs.setSafeMode(SafeModeAction.SAFEMODE_LEAVE);
    ...
    @Test
    public void testTruncateEditLogLoad_withUpgrade60() throws IOException {
        // purge previously accumulated edits
        fs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
        fs.saveNamespace();
        fs.setSafeMode(SafeModeAction.SAFEMODE_LEAVE);
    ...
    @Test
    public void testTruncateEditLogLoad_withUpgrade80() throws IOException {
        // purge previously accumulated edits
        fs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
        fs.saveNamespace();
        fs.setSafeMode(SafeModeAction.SAFEMODE_LEAVE);
    ...
    @Test
    public void testUpgradeAndRestart_withUpgrade20() throws IOException {
        fs.mkdirs(parent);
        fs.setQuota(parent, 100, 1000);
        fs.allowSnapshot(parent);
        String truncateFile = "testUpgrade";
    ...
    @Test
    public void testUpgradeAndRestart_withUpgrade40() throws IOException {
        fs.mkdirs(parent);
        fs.setQuota(parent, 100, 1000);
        fs.allowSnapshot(parent);
        String truncateFile = "testUpgrade";
    ...
    @Test
    public void testUpgradeAndRestart_withUpgrade60() throws IOException {
        fs.mkdirs(parent);
        fs.setQuota(parent, 100, 1000);
        fs.allowSnapshot(parent);
        String truncateFile = "testUpgrade";
    ...
    @Test
    public void testUpgradeAndRestart_withUpgrade80() throws IOException {
        fs.mkdirs(parent);
        fs.setQuota(parent, 100, 1000);
        fs.allowSnapshot(parent);
        String truncateFile = "testUpgrade";
    ...
    @Test
    public void testTruncateWithRollingUpgrade_withUpgrade20() throws Exception {
        final DFSAdmin dfsadmin = new DFSAdmin(cluster.getConfiguration(0));
        DistributedFileSystem dfs = cluster.getFileSystem();
        //start rolling upgrade
        dfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
    ...
    @Test
    public void testTruncateWithRollingUpgrade_withUpgrade40() throws Exception {
        final DFSAdmin dfsadmin = new DFSAdmin(cluster.getConfiguration(0));
        DistributedFileSystem dfs = cluster.getFileSystem();
        //start rolling upgrade
        dfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
    ...
    @Test
    public void testTruncateWithRollingUpgrade_withUpgrade60() throws Exception {
        final DFSAdmin dfsadmin = new DFSAdmin(cluster.getConfiguration(0));
        DistributedFileSystem dfs = cluster.getFileSystem();
        //start rolling upgrade
        dfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
    ...
    @Test
    public void testTruncateWithRollingUpgrade_withUpgrade80() throws Exception {
        final DFSAdmin dfsadmin = new DFSAdmin(cluster.getConfiguration(0));
        DistributedFileSystem dfs = cluster.getFileSystem();
        //start rolling upgrade
        dfs.setSafeMode(SafeModeAction.SAFEMODE_ENTER);
