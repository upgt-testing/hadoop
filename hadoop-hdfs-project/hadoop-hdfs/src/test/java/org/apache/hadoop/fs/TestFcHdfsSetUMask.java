...
public class TestFcHdfsSetUMask {
    ...
    private static final FileContextTestHelper fileContextTestHelper = new FileContextTestHelper("/tmp/TestFcHdfsSetUMask");
    ...
    @Test
    public void testMkdirWithExistingDirClear_withUpgrade20() throws IOException {
        testMkdirWithExistingDir(BLANK_TEST_UMASK, BLANK_PERMISSIONS);
    ...
    @Test
    public void testMkdirWithExistingDirOpen_withUpgrade20() throws IOException {
        testMkdirWithExistingDir(WIDE_OPEN_TEST_UMASK, WIDE_OPEN_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testMkdirWithExistingDirMiddle_withUpgrade20() throws IOException {
        testMkdirWithExistingDir(USER_GROUP_OPEN_TEST_UMASK, USER_GROUP_OPEN_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testMkdirRecursiveWithNonExistingDirClear_withUpgrade20() throws IOException {
        // by default parent directories have -wx------ bits set
        testMkdirRecursiveWithNonExistingDir(BLANK_TEST_UMASK, BLANK_PERMISSIONS, PARENT_PERMS_FOR_BLANK_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testMkdirRecursiveWithNonExistingDirOpen_withUpgrade20() throws IOException {
        testMkdirRecursiveWithNonExistingDir(WIDE_OPEN_TEST_UMASK, WIDE_OPEN_PERMISSIONS, WIDE_OPEN_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testMkdirRecursiveWithNonExistingDirMiddle_withUpgrade20() throws IOException {
        testMkdirRecursiveWithNonExistingDir(USER_GROUP_OPEN_TEST_UMASK, USER_GROUP_OPEN_PERMISSIONS, USER_GROUP_OPEN_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testCreateRecursiveWithExistingDirClear_withUpgrade20() throws IOException {
        testCreateRecursiveWithExistingDir(BLANK_TEST_UMASK, BLANK_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testCreateRecursiveWithExistingDirOpen_withUpgrade20() throws IOException {
        testCreateRecursiveWithExistingDir(WIDE_OPEN_TEST_UMASK, WIDE_OPEN_FILE_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testCreateRecursiveWithExistingDirMiddle_withUpgrade20() throws IOException {
        testCreateRecursiveWithExistingDir(USER_GROUP_OPEN_TEST_UMASK, USER_GROUP_OPEN_FILE_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testCreateRecursiveWithNonExistingDirClear_withUpgrade20() throws IOException {
        // set of umask
        testCreateRecursiveWithNonExistingDir(BLANK_TEST_UMASK, WIDE_OPEN_PERMISSIONS, BLANK_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testCreateRecursiveWithNonExistingDirOpen_withUpgrade20() throws IOException {
        // set of umask
        testCreateRecursiveWithNonExistingDir(WIDE_OPEN_TEST_UMASK, WIDE_OPEN_PERMISSIONS, WIDE_OPEN_FILE_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testCreateRecursiveWithNonExistingDirMiddle_withUpgrade20() throws IOException {
        // set of umask
        testCreateRecursiveWithNonExistingDir(USER_GROUP_OPEN_TEST_UMASK, WIDE_OPEN_PERMISSIONS, USER_GROUP_OPEN_FILE_PERMISSIONS);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
