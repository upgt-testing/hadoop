...
public class TestMetadataVersionOutput {
    ...
    public void testMetadataVersionOutput() throws IOException {
        initConfig();
        dfsCluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false).numDataNodes(1).checkExitOnShutdown(false).build();
    ...
    @Test(timeout = 30000)
    public void testMetadataVersionOutput_withUpgrade20() throws IOException {
        initConfig();
        dfsCluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false).numDataNodes(1).checkExitOnShutdown(false).build();
        dfsCluster.waitClusterUp();
        dfsCluster.shutdown(false);
    ...
    @Test(timeout = 30000)
    public void testMetadataVersionOutput_withUpgrade40() throws IOException {
        initConfig();
        dfsCluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false).numDataNodes(1).checkExitOnShutdown(false).build();
        dfsCluster.waitClusterUp();
        dfsCluster.shutdown(false);
    ...
    @Test(timeout = 30000)
    public void testMetadataVersionOutput_withUpgrade60() throws IOException {
        initConfig();
        dfsCluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false).numDataNodes(1).checkExitOnShutdown(false).build();
        dfsCluster.waitClusterUp();
        dfsCluster.shutdown(false);
    ...
    @Test(timeout = 30000)
    public void testMetadataVersionOutput_withUpgrade80() throws IOException {
        initConfig();
        dfsCluster = new MiniDFSClusterInJVM.Builder(conf).manageNameDfsDirs(false).numDataNodes(1).checkExitOnShutdown(false).build();
        dfsCluster.waitClusterUp();
        dfsCluster.shutdown(false);
