...
public class TestFileAppend3 {
    ...
    private void testTC11(boolean appendToNewBlock) throws Exception {
        ...
        for (int i = 0; i < numblock; i++) {
            ...
            for (DatanodeInfo datanodeinfo : lb.getLocations()) {
                ...
                final BlockJVMInterface metainfo = DataNodeTestUtils.getFSDataset(dn).getStoredBlock(blk.getBlockPoolId(), blk.getBlockId());
    ...
    @Test
    public void testTC1_withUpgrade20() throws Exception {
        final Path p = new Path("/TC1/foo");
        System.out.println("p=" + p);
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
    ...
    @Test
    public void testTC1_withUpgrade40() throws Exception {
        final Path p = new Path("/TC1/foo");
        System.out.println("p=" + p);
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
    ...
    @Test
    public void testTC1_withUpgrade60() throws Exception {
        final Path p = new Path("/TC1/foo");
        System.out.println("p=" + p);
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
    ...
    @Test
    public void testTC1_withUpgrade80() throws Exception {
        final Path p = new Path("/TC1/foo");
        System.out.println("p=" + p);
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
    ...
    @Test
    public void testTC1ForAppend2_withUpgrade20() throws Exception {
        final Path p = new Path("/TC1/foo2");
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
        {
    ...
    @Test
    public void testTC1ForAppend2_withUpgrade40() throws Exception {
        final Path p = new Path("/TC1/foo2");
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
        {
    ...
    @Test
    public void testTC1ForAppend2_withUpgrade60() throws Exception {
        final Path p = new Path("/TC1/foo2");
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
        {
    ...
    @Test
    public void testTC1ForAppend2_withUpgrade80() throws Exception {
        final Path p = new Path("/TC1/foo2");
        //a. Create file and write one block of data. Close file.
        final int len1 = (int) BLOCK_SIZE;
        {
    ...
    @Test
    public void testTC2_withUpgrade20() throws Exception {
        final Path p = new Path("/TC2/foo");
        System.out.println("p=" + p);
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
    ...
    @Test
    public void testTC2_withUpgrade40() throws Exception {
        final Path p = new Path("/TC2/foo");
        System.out.println("p=" + p);
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
    ...
    @Test
    public void testTC2_withUpgrade60() throws Exception {
        final Path p = new Path("/TC2/foo");
        System.out.println("p=" + p);
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
    ...
    @Test
    public void testTC2_withUpgrade80() throws Exception {
        final Path p = new Path("/TC2/foo");
        System.out.println("p=" + p);
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
    ...
    @Test
    public void testTC2ForAppend2_withUpgrade20() throws Exception {
        final Path p = new Path("/TC2/foo2");
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
        {
    ...
    @Test
    public void testTC2ForAppend2_withUpgrade40() throws Exception {
        final Path p = new Path("/TC2/foo2");
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
        {
    ...
    @Test
    public void testTC2ForAppend2_withUpgrade60() throws Exception {
        final Path p = new Path("/TC2/foo2");
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
        {
    ...
    @Test
    public void testTC2ForAppend2_withUpgrade80() throws Exception {
        final Path p = new Path("/TC2/foo2");
        //a. Create file with one and a half block of data. Close file.
        final int len1 = (int) (BLOCK_SIZE + BLOCK_SIZE / 2);
        {
    ...
    @Test
    public void testTC5_withUpgrade20() throws Exception {
        final Path p = new Path("/TC5/foo");
        System.out.println("p=" + p);
        //a. Create file on Machine M1. Write half block to it. Close file.
        {
    ...
    @Test
    public void testTC5_withUpgrade40() throws Exception {
        final Path p = new Path("/TC5/foo");
        System.out.println("p=" + p);
        //a. Create file on Machine M1. Write half block to it. Close file.
        {
    ...
    @Test
    public void testTC5_withUpgrade60() throws Exception {
        final Path p = new Path("/TC5/foo");
        System.out.println("p=" + p);
        //a. Create file on Machine M1. Write half block to it. Close file.
        {
    ...
    @Test
    public void testTC5_withUpgrade80() throws Exception {
        final Path p = new Path("/TC5/foo");
        System.out.println("p=" + p);
        //a. Create file on Machine M1. Write half block to it. Close file.
        {
    ...
    @Test
    public void testTC5ForAppend2_withUpgrade20() throws Exception {
        final Path p = new Path("/TC5/foo2");
        // a. Create file on Machine M1. Write half block to it. Close file.
        {
            FSDataOutputStream out = fs.create(p, false, buffersize, REPLICATION, BLOCK_SIZE);
    ...
    @Test
    public void testTC5ForAppend2_withUpgrade40() throws Exception {
        final Path p = new Path("/TC5/foo2");
        // a. Create file on Machine M1. Write half block to it. Close file.
        {
            FSDataOutputStream out = fs.create(p, false, buffersize, REPLICATION, BLOCK_SIZE);
    ...
    @Test
    public void testTC5ForAppend2_withUpgrade60() throws Exception {
        final Path p = new Path("/TC5/foo2");
        // a. Create file on Machine M1. Write half block to it. Close file.
        {
            FSDataOutputStream out = fs.create(p, false, buffersize, REPLICATION, BLOCK_SIZE);
    ...
    @Test
    public void testTC5ForAppend2_withUpgrade80() throws Exception {
        final Path p = new Path("/TC5/foo2");
        // a. Create file on Machine M1. Write half block to it. Close file.
        {
            FSDataOutputStream out = fs.create(p, false, buffersize, REPLICATION, BLOCK_SIZE);
    ...
    @Test
    public void testTC7_withUpgrade20() throws Exception {
        testTC7(false);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testTC7ForAppend2_withUpgrade20() throws Exception {
        testTC7(true);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testTC11_withUpgrade20() throws Exception {
        testTC11(false);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testTC11ForAppend2_withUpgrade20() throws Exception {
        testTC11(true);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testTC12_withUpgrade20() throws Exception {
        testTC12(false);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testTC12ForAppend2_withUpgrade20() throws Exception {
        testTC12(true);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testSmallAppendRace_withUpgrade20() throws Exception {
        final Path file = new Path("/testSmallAppendRace");
        final String fName = file.toUri().getPath();
        // Create the file and write a small amount of data.
        FSDataOutputStream stm = fs.create(file);
    ...
    @Test
    public void testSmallAppendRace_withUpgrade60() throws Exception {
        final Path file = new Path("/testSmallAppendRace");
        final String fName = file.toUri().getPath();
        // Create the file and write a small amount of data.
        FSDataOutputStream stm = fs.create(file);
    ...
    @Test
    public void testSmallAppendRace_withUpgrade80() throws Exception {
        final Path file = new Path("/testSmallAppendRace");
        final String fName = file.toUri().getPath();
        // Create the file and write a small amount of data.
        FSDataOutputStream stm = fs.create(file);
    ...
    @Test
    public void testAppendToPartialChunk_withUpgrade20() throws IOException {
        testAppendToPartialChunk(false);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testAppendToPartialChunkforAppend2_withUpgrade20() throws IOException {
        testAppendToPartialChunk(true);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
