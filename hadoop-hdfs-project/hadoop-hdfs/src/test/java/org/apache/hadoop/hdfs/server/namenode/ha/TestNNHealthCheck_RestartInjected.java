...
public class TestNNHealthCheck_RestartInjected {
  ...
  public void testNNHealthCheck() throws IOException {
    ...
    RestartFramework.at("after_health_check_test")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNNHealthCheckWithLifelineAddress() throws IOException {
    ...
    RestartFramework.at("after_cluster_build_with_lifeline")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_health_check_test_lifeline")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNNHealthCheckWithSafemodeAsUnhealthy() throws Exception {
    ...
    RestartFramework.at("after_health_monitor_proxy")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
