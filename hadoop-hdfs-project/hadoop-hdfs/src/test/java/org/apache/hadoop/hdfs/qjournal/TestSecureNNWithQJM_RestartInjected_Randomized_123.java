...
public class TestSecureNNWithQJM_RestartInjected_Randomized_123 {
    ...
    public static void init() throws Exception {
        baseDir = GenericTestUtils.getTestDir(TestSecureNNWithQJM_RestartInjected.class.getSimpleName());
        ...
        baseConf.set(HttpServer2.FILTER_INITIALIZER_PROPERTY, AuthenticationFilterInitializer.class.getName());
        ...
        sslConfDir = KeyStoreTestUtil.getClasspathDir(TestSecureNNWithQJM_RestartInjected.class);
