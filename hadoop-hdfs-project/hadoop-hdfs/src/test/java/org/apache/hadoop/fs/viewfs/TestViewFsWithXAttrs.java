...
public class TestViewFsWithXAttrs {
    ...
    @Test
    public void testXAttrOnMountEntry_withUpgrade20() throws Exception {
        // Set XAttrs on the first namespace and verify they are correct
        fcView.setXAttr(mountOnNn1, name1, value1);
        fcView.setXAttr(mountOnNn1, name2, value2);
        assertEquals(2, fcView.getXAttrs(mountOnNn1).size());
    ...
    @Test
    public void testXAttrOnMountEntry_withUpgrade40() throws Exception {
        // Set XAttrs on the first namespace and verify they are correct
        fcView.setXAttr(mountOnNn1, name1, value1);
        fcView.setXAttr(mountOnNn1, name2, value2);
        assertEquals(2, fcView.getXAttrs(mountOnNn1).size());
    ...
    @Test
    public void testXAttrOnMountEntry_withUpgrade60() throws Exception {
        // Set XAttrs on the first namespace and verify they are correct
        fcView.setXAttr(mountOnNn1, name1, value1);
        fcView.setXAttr(mountOnNn1, name2, value2);
        assertEquals(2, fcView.getXAttrs(mountOnNn1).size());
    ...
    @Test
    public void testXAttrOnMountEntry_withUpgrade80() throws Exception {
        // Set XAttrs on the first namespace and verify they are correct
        fcView.setXAttr(mountOnNn1, name1, value1);
        fcView.setXAttr(mountOnNn1, name2, value2);
        assertEquals(2, fcView.getXAttrs(mountOnNn1).size());
