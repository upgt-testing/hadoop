...
public class TestPipelinesFailover {
    ...
    static {
        GenericTestUtils.setLogLevel(LogFactory.getLog(RetryInvocationHandler.class), Level.ALL);
        DFSTestUtil.setNameNodeLogLevel(Level.ALL);
    }

    protected static final Log LOG = LogFactory.getLog(TestPipelinesFailover.class);
   ...
   */
    ...
    private MiniDFSClusterInJVM newMiniCluster(Configuration conf, int dnCount) throws IOException {
        return new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology(NN_COUNT)).numDataNodes(dnCount).build();
    }
     ...
     * @return the index of the new active NN
     */
    private int failover(MiniDFSClusterInJVM cluster, TestScenario scenario, int activeIndex) throws IOException {
    ...
    private DistributedFileSystem createFsAsOtherUser(final MiniDFSClusterInJVM cluster, final Configuration conf) throws IOException, InterruptedException {
    ...
    @Test(timeout = 30000)
    public void testLeaseRecoveryAfterFailover_withUpgrade20() throws Exception {
        final Configuration conf = new Configuration();
        // Disable permissions so that another user can recover the lease.
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, BLOCK_SIZE);
    ...
    @Test(timeout = 30000)
    public void testLeaseRecoveryAfterFailover_withUpgrade40() throws Exception {
        final Configuration conf = new Configuration();
        // Disable permissions so that another user can recover the lease.
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, BLOCK_SIZE);
    ...
    @Test(timeout = 30000)
    public void testLeaseRecoveryAfterFailover_withUpgrade60() throws Exception {
        final Configuration conf = new Configuration();
        // Disable permissions so that another user can recover the lease.
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, BLOCK_SIZE);
    ...
    @Test(timeout = 30000)
    public void testLeaseRecoveryAfterFailover_withUpgrade80() throws Exception {
        final Configuration conf = new Configuration();
        // Disable permissions so that another user can recover the lease.
        conf.setBoolean(DFSConfigKeys.DFS_PERMISSIONS_ENABLED_KEY, false);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, BLOCK_SIZE);
    ...
    @Test(timeout = STRESS_RUNTIME * 3)
    public void testPipelineRecoveryStress_withUpgrade20() throws Exception {
        //
        LOG.info("HDFS-6694 Debug Data BEGIN");
        String[][] scmds = new String[][] { { "/bin/sh", "-c", "ulimit -a" }, { "hostname" }, { "ifconfig", "-a" } };
        for (String[] scmd : scmds) {
    ...
    @Test(timeout = STRESS_RUNTIME * 3)
    public void testPipelineRecoveryStress_withUpgrade40() throws Exception {
        //
        LOG.info("HDFS-6694 Debug Data BEGIN");
        String[][] scmds = new String[][] { { "/bin/sh", "-c", "ulimit -a" }, { "hostname" }, { "ifconfig", "-a" } };
        for (String[] scmd : scmds) {
    ...
    @Test(timeout = STRESS_RUNTIME * 3)
    public void testPipelineRecoveryStress_withUpgrade60() throws Exception {
        //
        LOG.info("HDFS-6694 Debug Data BEGIN");
        String[][] scmds = new String[][] { { "/bin/sh", "-c", "ulimit -a" }, { "hostname" }, { "ifconfig", "-a" } };
        for (String[] scmd : scmds) {
    ...
    @Test(timeout = STRESS_RUNTIME * 3)
    public void testPipelineRecoveryStress_withUpgrade80() throws Exception {
        //
        LOG.info("HDFS-6694 Debug Data BEGIN");
        String[][] scmds = new String[][] { { "/bin/sh", "-c", "ulimit -a" }, { "hostname" }, { "ifconfig", "-a" } };
        for (String[] scmd : scmds) {
