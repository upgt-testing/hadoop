...
public class TestFsVolumeList {
    ...
    public void testAddRplicaProcessorForAddingReplicaInMap() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(cnf).numDataNodes(1).storagesPerDatanode(1).build();
    ...
    public void testInstanceOfAddReplicaThreadPool() throws Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(1).build()) {
            cluster.waitActive();
            FsDatasetImpl fsDataset = (FsDatasetImpl) cluster.getDataNodes().get(0).getFSDataset();
            FsVolumeImpl vol = (FsVolumeImpl) fsDataset.getFsVolumeReferences().get(0);
    ...
    public void testExcludeSlowDiskWhenChoosingVolume() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).hosts(hostnames).numDataNodes(NUM_DATANODES).storagesPerDatanode(STORAGES_PER_DATANODE).storageCapacities(capacities).build();
        cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testAddRplicaProcessorForAddingReplicaInMap_withUpgrade20() throws Exception {
        BlockPoolSlice.reInitializeAddReplicaThreadPool();
        Configuration cnf = new Configuration();
        int poolSize = 5;
        cnf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
    ...
    @Test(timeout = 300000)
    public void testAddRplicaProcessorForAddingReplicaInMap_withUpgrade40() throws Exception {
        BlockPoolSlice.reInitializeAddReplicaThreadPool();
        Configuration cnf = new Configuration();
        int poolSize = 5;
        cnf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
    ...
    @Test(timeout = 300000)
    public void testAddRplicaProcessorForAddingReplicaInMap_withUpgrade80() throws Exception {
        BlockPoolSlice.reInitializeAddReplicaThreadPool();
        Configuration cnf = new Configuration();
        int poolSize = 5;
        cnf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
    ...
    @Test(timeout = 60000)
    public void testInstanceOfAddReplicaThreadPool_withUpgrade20() throws Exception {
        // Start cluster with multiple namespace
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(1).build()) {
            cluster.waitActive();
            cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 60000)
    public void testInstanceOfAddReplicaThreadPool_withUpgrade40() throws Exception {
        // Start cluster with multiple namespace
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(1).build()) {
            cluster.waitActive();
            FsDatasetImpl fsDataset = (FsDatasetImpl) cluster.getDataNodes().get(0).getFSDataset();
    ...
    @Test(timeout = 60000)
    public void testInstanceOfAddReplicaThreadPool_withUpgrade60() throws Exception {
        // Start cluster with multiple namespace
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(1).build()) {
            cluster.waitActive();
            FsDatasetImpl fsDataset = (FsDatasetImpl) cluster.getDataNodes().get(0).getFSDataset();
    ...
    @Test(timeout = 60000)
    public void testInstanceOfAddReplicaThreadPool_withUpgrade80() throws Exception {
        // Start cluster with multiple namespace
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(1).build()) {
            cluster.waitActive();
            FsDatasetImpl fsDataset = (FsDatasetImpl) cluster.getDataNodes().get(0).getFSDataset();
    ...
    @Test
    public void testExcludeSlowDiskWhenChoosingVolume_withUpgrade20() throws Exception {
        conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DEFAULT_BLOCK_SIZE);
        // Set datanode outliers report interval to 1s.
        conf.setStrings(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, "1s");
    ...
    @Test
    public void testExcludeSlowDiskWhenChoosingVolume_withUpgrade40() throws Exception {
        conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DEFAULT_BLOCK_SIZE);
        // Set datanode outliers report interval to 1s.
        conf.setStrings(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, "1s");
    ...
    @Test
    public void testExcludeSlowDiskWhenChoosingVolume_withUpgrade60() throws Exception {
        conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DEFAULT_BLOCK_SIZE);
        // Set datanode outliers report interval to 1s.
        conf.setStrings(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, "1s");
    ...
    @Test
    public void testExcludeSlowDiskWhenChoosingVolume_withUpgrade80() throws Exception {
        conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, DEFAULT_BLOCK_SIZE);
        // Set datanode outliers report interval to 1s.
        conf.setStrings(DFSConfigKeys.DFS_DATANODE_OUTLIERS_REPORT_INTERVAL_KEY, "1s");
