...
public class TestFileConcurrentReader {
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockRead_withUpgrade20() throws IOException {
        // create a new file in the root, write data, do no close
        Path file1 = new Path("/unfinished-block");
        FSDataOutputStream stm = TestFileCreation.createFile(fileSystem, file1, 1);
        // write partial block and sync
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockRead_withUpgrade40() throws IOException {
        // create a new file in the root, write data, do no close
        Path file1 = new Path("/unfinished-block");
        FSDataOutputStream stm = TestFileCreation.createFile(fileSystem, file1, 1);
        // write partial block and sync
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockRead_withUpgrade60() throws IOException {
        // create a new file in the root, write data, do no close
        Path file1 = new Path("/unfinished-block");
        FSDataOutputStream stm = TestFileCreation.createFile(fileSystem, file1, 1);
        // write partial block and sync
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockRead_withUpgrade80() throws IOException {
        // create a new file in the root, write data, do no close
        Path file1 = new Path("/unfinished-block");
        FSDataOutputStream stm = TestFileCreation.createFile(fileSystem, file1, 1);
        // write partial block and sync
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockPacketBufferOverrun_withUpgrade20() throws IOException {
        // check that / exists
        Path path = new Path("/");
        System.out.println("Path : \"" + path.toString() + "\"");
        // create a new file in the root, write data, do no close
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockPacketBufferOverrun_withUpgrade40() throws IOException {
        // check that / exists
        Path path = new Path("/");
        System.out.println("Path : \"" + path.toString() + "\"");
        // create a new file in the root, write data, do no close
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockPacketBufferOverrun_withUpgrade60() throws IOException {
        // check that / exists
        Path path = new Path("/");
        System.out.println("Path : \"" + path.toString() + "\"");
        // create a new file in the root, write data, do no close
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockPacketBufferOverrun_withUpgrade80() throws IOException {
        // check that / exists
        Path path = new Path("/");
        System.out.println("Path : \"" + path.toString() + "\"");
        // create a new file in the root, write data, do no close
    ...
    @Test(timeout = 30000)
    public void testImmediateReadOfNewFile_withUpgrade20() throws IOException {
        final int blockSize = 64 * 1024;
        final int writeSize = 10 * blockSize;
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testImmediateReadOfNewFile_withUpgrade40() throws IOException {
        final int blockSize = 64 * 1024;
        final int writeSize = 10 * blockSize;
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testImmediateReadOfNewFile_withUpgrade60() throws IOException {
        final int blockSize = 64 * 1024;
        final int writeSize = 10 * blockSize;
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testImmediateReadOfNewFile_withUpgrade80() throws IOException {
        final int blockSize = 64 * 1024;
        final int writeSize = 10 * blockSize;
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockCRCErrorTransferTo_withUpgrade20() throws IOException {
        runTestUnfinishedBlockCRCError(true, SyncType.SYNC, DEFAULT_WRITE_SIZE);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockCRCErrorTransferToVerySmallWrite_withUpgrade20() throws IOException {
        runTestUnfinishedBlockCRCError(true, SyncType.SYNC, SMALL_WRITE_SIZE);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockCRCErrorNormalTransfer_withUpgrade20() throws IOException {
        runTestUnfinishedBlockCRCError(false, SyncType.SYNC, DEFAULT_WRITE_SIZE);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test(timeout = 30000)
    public void testUnfinishedBlockCRCErrorNormalTransferVerySmallWrite_withUpgrade20() throws IOException {
        runTestUnfinishedBlockCRCError(false, SyncType.SYNC, SMALL_WRITE_SIZE);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
