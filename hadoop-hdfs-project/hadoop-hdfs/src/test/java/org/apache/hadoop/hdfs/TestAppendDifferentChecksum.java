...
public class TestAppendDifferentChecksum {
    ...
    @Test
    @Ignore("this is not implemented! See HDFS-2130")
    public void testSwitchChunkSize_withUpgrade20() throws IOException {
        FileSystem fsWithSmallChunk = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithBigChunk = createFsWithChecksum("CRC32", 1024);
        Path p = new Path("/testSwitchChunkSize");
    ...
    @Test
    @Ignore("this is not implemented! See HDFS-2130")
    public void testSwitchChunkSize_withUpgrade40() throws IOException {
        FileSystem fsWithSmallChunk = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithBigChunk = createFsWithChecksum("CRC32", 1024);
        Path p = new Path("/testSwitchChunkSize");
        appendWithTwoFs(p, fsWithSmallChunk, fsWithBigChunk);
    ...
    @Test
    @Ignore("this is not implemented! See HDFS-2130")
    public void testSwitchChunkSize_withUpgrade60() throws IOException {
        FileSystem fsWithSmallChunk = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithBigChunk = createFsWithChecksum("CRC32", 1024);
        Path p = new Path("/testSwitchChunkSize");
        appendWithTwoFs(p, fsWithSmallChunk, fsWithBigChunk);
    ...
    @Test
    @Ignore("this is not implemented! See HDFS-2130")
    public void testSwitchChunkSize_withUpgrade80() throws IOException {
        FileSystem fsWithSmallChunk = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithBigChunk = createFsWithChecksum("CRC32", 1024);
        Path p = new Path("/testSwitchChunkSize");
        appendWithTwoFs(p, fsWithSmallChunk, fsWithBigChunk);
    ...
    @Test
    public void testSwitchAlgorithms_withUpgrade20() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testSwitchAlgorithms");
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testSwitchAlgorithms_withUpgrade40() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testSwitchAlgorithms");
        appendWithTwoFs(p, fsWithCrc32, fsWithCrc32C);
    ...
    @Test
    public void testSwitchAlgorithms_withUpgrade60() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testSwitchAlgorithms");
        appendWithTwoFs(p, fsWithCrc32, fsWithCrc32C);
    ...
    @Test
    public void testSwitchAlgorithms_withUpgrade80() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testSwitchAlgorithms");
        appendWithTwoFs(p, fsWithCrc32, fsWithCrc32C);
    ...
    @Test(timeout = RANDOM_TEST_RUNTIME * 2)
    public void testAlgoSwitchRandomized_withUpgrade20() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testAlgoSwitchRandomized");
        long seed = Time.now();
    ...
    @Test(timeout = RANDOM_TEST_RUNTIME * 2)
    public void testAlgoSwitchRandomized_withUpgrade40() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testAlgoSwitchRandomized");
        long seed = Time.now();
    ...
    @Test(timeout = RANDOM_TEST_RUNTIME * 2)
    public void testAlgoSwitchRandomized_withUpgrade60() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testAlgoSwitchRandomized");
        long seed = Time.now();
    ...
    @Test(timeout = RANDOM_TEST_RUNTIME * 2)
    public void testAlgoSwitchRandomized_withUpgrade80() throws IOException {
        FileSystem fsWithCrc32 = createFsWithChecksum("CRC32", 512);
        FileSystem fsWithCrc32C = createFsWithChecksum("CRC32C", 512);
        Path p = new Path("/testAlgoSwitchRandomized");
        long seed = Time.now();
