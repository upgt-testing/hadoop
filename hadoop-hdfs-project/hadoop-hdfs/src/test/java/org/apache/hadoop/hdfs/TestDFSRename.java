...
public class TestDFSRename {
    ...
    public void testRename2Options() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).build()) {
            ...
            assertTrue("Rename should have both OVERWRITE and TO_TRASH " + "flags at namenode but had only " + auditOut, auditOut.contains("options=[OVERWRITE, TO_TRASH]"));
        }
    }
    ...
    @Test
    public void testRename2Options_withUpgrade20() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).build()) {
            cluster.waitActive();
            cluster.restartNodeForTesting(0);
            cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testRename2Options_withUpgrade40() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path path = new Path("/test");
    ...
    @Test
    public void testRename2Options_withUpgrade60() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path path = new Path("/test");
    ...
    @Test
    public void testRename2Options_withUpgrade80() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path path = new Path("/test");
