...
public class TestDFSRename {
    ...
    static int countLease(MiniDockerDFSCluster cluster) {
    ...
    public void testRenameWithOverwrite() throws Exception {
        ...
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(replFactor).build();
    ...
    public void testRename2Options() throws Exception {
        try (MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(new HdfsConfiguration()).build()) {
            cluster.waitActive();
