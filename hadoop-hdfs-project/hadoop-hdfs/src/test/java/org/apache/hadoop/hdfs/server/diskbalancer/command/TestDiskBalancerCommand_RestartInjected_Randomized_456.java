 ...
 */
public class TestDiskBalancerCommand_RestartInjected_Randomized_456 {
    ...
    public void setUp() throws Exception {
        ...
        cluster = new MiniDFSCluster.Builder(conf).numDataNodes(3).storagesPerDatanode(2).build();
        cluster.waitActive();
    ...
    public void testSubmitPlanInNonRegularStatus() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_cluster_creation").on(miniCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
   ...
   */
    ...
    private List<String> runCommand(final String cmdLine, MiniDFSCluster miniCluster) throws Exception {
        FileSystem.setDefaultUri(conf, miniCluster.getURI());
        return runCommandInternal(cmdLine);
    }

    private List<String> runCommand(final String cmdLine, Configuration clusterConf, MiniDFSCluster miniCluster) throws Exception {
