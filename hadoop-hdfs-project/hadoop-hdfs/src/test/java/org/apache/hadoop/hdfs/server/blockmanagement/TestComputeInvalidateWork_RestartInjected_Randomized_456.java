 ...
 */
public class TestComputeInvalidateWork_RestartInjected_Randomized_456 {
    ...
    public void setup() throws Exception {
        ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.XOR_2_1_POLICY_ID);
        conf = new HdfsConfiguration();
        RestartFramework.at("after_ec_file_create").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testComputeInvalidateReplicas() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_add_invalidates").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testComputeInvalidateStripedBlockGroups() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_add_striped_invalidates").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            verifyInvalidationWorkCounts(blockInvalidateLimit);
        } finally {
            namesystem.writeUnlock();
        }
    ...
    public void testComputeInvalidate() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_add_mixed_invalidates").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            verifyInvalidationWorkCounts(blockInvalidateLimit);
        } finally {
            namesystem.writeUnlock();
        }
    ...
    public void testDatanodeReformat() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_stop_datanode").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_add_invalidates_reformat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            bm.getDatanodeManager().registerDatanode(dnr);
            RestartFramework.at("after_register_reformatted_datanode").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDatanodeReRegistration() throws Exception {
        ...
        RestartFramework.at("after_shutdown_datanodes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_check_invalidate_blocks").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
