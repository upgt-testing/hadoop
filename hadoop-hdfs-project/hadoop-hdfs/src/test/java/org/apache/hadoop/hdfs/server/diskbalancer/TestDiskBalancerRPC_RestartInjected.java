...
public class TestDiskBalancerRPC_RestartInjected {
  ...
  public void testSubmitPlanWithInvalidVersion() throws Exception {
    ...
    int planVersion = rpcTestHelper.getPlanVersion();
    planVersion++;
    RestartFramework.at("after_version_modification")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetDiskBalancerVolumeMapping() throws Exception {
    ...
    RestartFramework.at("after_get_volume_mapping")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testgetDiskBalancerBandwidth() throws Exception {
    ...
    RestartFramework.at("after_get_bandwidth")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testQueryPlan() throws Exception {
    ...
    RestartFramework.at("after_query_plan")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMoveBlockAcrossVolume() throws Exception {
    ...
    try {
      ...
      try {
        ...
        RestartFramework.at("after_volume_setup")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        DiskBalancerTestUtil.moveAllDataToDestVolume(dnNode.getFSDataset(),
            source, dest);
        RestartFramework.at("after_move_blocks")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
