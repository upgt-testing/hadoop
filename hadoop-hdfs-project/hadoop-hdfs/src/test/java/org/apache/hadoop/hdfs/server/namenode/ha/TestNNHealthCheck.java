...
public class TestNNHealthCheck {
    ...
    @Test
    public void testNNHealthCheckWithSafemodeAsUnhealthy_withUpgrade20() throws Exception {
        conf.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        // now bring up just the NameNode.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        cluster.waitActive();
    ...
    @Test
    public void testNNHealthCheckWithSafemodeAsUnhealthy_withUpgrade40() throws Exception {
        conf.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        // now bring up just the NameNode.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        cluster.waitActive();
    ...
    @Test
    public void testNNHealthCheckWithSafemodeAsUnhealthy_withUpgrade60() throws Exception {
        conf.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        // now bring up just the NameNode.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        cluster.waitActive();
    ...
    @Test
    public void testNNHealthCheckWithSafemodeAsUnhealthy_withUpgrade80() throws Exception {
        conf.setBoolean(DFS_HA_NN_NOT_BECOME_ACTIVE_IN_SAFEMODE, true);
        // now bring up just the NameNode.
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        cluster.waitActive();
