...
public class TestPendingDataNodeMessages {
    ...
    public void testPendingDataNodeMessagesWithEC() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDn).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        try {
    ...
    @Test
    public void testPendingDataNodeMessagesWithEC_withUpgrade20() throws Exception {
        ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.XOR_2_1_POLICY_ID);
        Path dirPath = new Path("/testPendingDataNodeMessagesWithEC");
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 20 * 60000);
    ...
    @Test
    public void testPendingDataNodeMessagesWithEC_withUpgrade40() throws Exception {
        ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.XOR_2_1_POLICY_ID);
        Path dirPath = new Path("/testPendingDataNodeMessagesWithEC");
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 20 * 60000);
    ...
    @Test
    public void testPendingDataNodeMessagesWithEC_withUpgrade60() throws Exception {
        ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.XOR_2_1_POLICY_ID);
        Path dirPath = new Path("/testPendingDataNodeMessagesWithEC");
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 20 * 60000);
    ...
    @Test
    public void testPendingDataNodeMessagesWithEC_withUpgrade80() throws Exception {
        ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.XOR_2_1_POLICY_ID);
        Path dirPath = new Path("/testPendingDataNodeMessagesWithEC");
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 20 * 60000);
