...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestUnsetAndChangeDirectoryEcPolicy}.
 *
...
public class TestUnsetAndChangeDirectoryEcPolicy_ProcessBased {
  ...
  public void setup() throws Exception {
    ...
    cluster = new org.apache.hadoop.hdfs.server.process.ProcessBasedMiniDFSCluster.Builder(conf).numDataNodes(
  ...
  */
  ...
  // which performs in-process NameNode restart not available in ProcessBasedMiniDFSCluster

  /**
   * Test unsetEcPolicy is persisted correctly in edit log.
   *
   * EXCLUDED: Requires cluster.restartNameNode(true) for in-process NameNode restart
   * to verify edit log persistence, which is not available in ProcessBasedMiniDFSCluster.
   */
  /*
  @Test
