...
public class TestReadOnlySharedStorage_RestartInjected {
  ...
  public static final Logger LOG =
      LoggerFactory.getLogger(TestReadOnlySharedStorage_RestartInjected.class);
  ...
  public void testReplicaCounting() throws Exception {
    ...
    RestartFramework.at("after_setup_complete")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
  ...
  public void testNormalReplicaOffline() throws Exception {
    ...
    RestartFramework.at("after_notice_dead_datanode")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_replication_recovery")
        .on(cluster)
        .restart("datanode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testReadOnlyReplicaCorrupt() throws Exception {
    ...
    RestartFramework.at("after_report_bad_blocks")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
