...
public class TestConsistentReadsObserver {
    ...
    public void testRequeueCall() throws Exception {
        ...
        NameNodeInterface nn = dfsCluster.getNameNode(observerIdx);
    ...
    public void testMsyncFileContext() throws Exception {
        NameNodeInterface nn0 = dfsCluster.getNameNode(0);
        NameNodeInterface nn2 = dfsCluster.getNameNode(2);
        HAServiceStatusInterface st = nn0.getRpcServer().getServiceStatus();
