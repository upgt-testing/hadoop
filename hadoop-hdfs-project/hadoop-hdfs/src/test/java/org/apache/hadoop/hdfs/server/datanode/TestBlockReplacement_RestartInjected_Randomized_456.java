 ...
 */
public class TestBlockReplacement_RestartInjected_Randomized_456 {

    private static final Logger LOG = LoggerFactory.getLogger(TestBlockReplacement_RestartInjected.class);
    ...
    public void testBlockReplacement() throws Exception {
        ...
        try {
            ...
            cluster.waitActive();
            RestartFramework.at("after_add_fourth_datanode").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_identify_nodes").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_first_replace_attempt").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_second_replace_attempt").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // case 3: correct case
            ...
            RestartFramework.at("after_successful_replace").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_fourth_replace").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // after cluster has time to resolve the over-replication,
    ...
    public void testBlockReplacementWithPinnedBlocks() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_identify_destination").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_mock_pinning").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testBlockMoveAcrossStorageInSameNode() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_get_initial_blocks").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
   ...
   */
    ...
    public void testDeletedBlockWhenAddBlockIsInEdit() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_initial_heartbeat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            Path fileName = new Path("/tmp.txt");
            // create a file with one block
            ...
            RestartFramework.at("after_add_second_datanode").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_block_replacement").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_wait_for_deletion").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_ha_failover").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
            client.close();
    ...
    public static void main(String[] args) throws Exception {
        (new TestBlockReplacement_RestartInjected()).testBlockReplacement();
    }
}
