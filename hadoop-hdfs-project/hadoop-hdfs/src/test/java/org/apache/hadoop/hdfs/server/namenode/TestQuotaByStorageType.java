...
public class TestQuotaByStorageType {
    ...
    private FSDirectoryInterface fsdir;
    ...
    public void setUp() throws Exception {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(REPLICATION).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DEFAULT }).build();
        cluster.waitActive();
        refreshClusterState();
    }
    ...
    void testQuotaByStorageTypeWithFileCreateCase(String storagePolicy, StorageType storageType, short replication) throws Exception {
        ...
        INodeInterface fnode = fsdir.getINode4Write(foo.toString());
    ...
    public void testQuotaByStorageTypeWithFileCreateAppend() throws Exception {
        ...
        assertEquals(file1Len, ssdConsumed);
        ContentSummaryInterface cs = dfs.getContentSummary(foo);
    ...
    public void testQuotaByStorageTypeWithFileCreateDelete() throws Exception {
        ...
        QuotaCountsInterface counts = fnode.computeQuotaUsage(fsn.getBlockManager().getStoragePolicySuite(), true);
    ...
    public void testQuotaByStorageTypeParentOffChildOff() throws Exception {
        ...
        INodeInterface fnode = fsdir.getINode4Write("/");
        long ssdConsumed = fnode.asDirectory().getDirectoryWithQuotaFeature().getSpaceConsumed().getTypeSpaces().get(StorageType.SSD);
        assertEquals(file1Len, ssdConsumed);
    }
    ...
    public void testQuotaByStorageTypeParentOnChildOff() throws Exception {
        ...
        int bufLen = BLOCKSIZE / 16;
        DFSTestUtil.createFile(dfs, createdFile1, bufLen, file1Len, BLOCKSIZE, replication, seed);
        INodeInterface fnode = fsdir.getINode4Write(parent.toString());
        assertTrue(fnode.isDirectory());
        assertTrue(fnode.isQuotaSet());
        long currentSSDConsumed = fnode.asDirectory().getDirectoryWithQuotaFeature().getSpaceConsumed().getTypeSpaces().get(StorageType.SSD);
        assertEquals(file1Len, currentSSDConsumed);
    ...
    public void testQuotaByStorageTypeWithTraditionalQuota() throws Exception {
        ...
        QuotaCountsInterface cnt = fnode.asDirectory().getDirectoryWithQuotaFeature().getSpaceConsumed();
        assertEquals(2, cnt.getNameSpace());
        assertEquals(fileLen * REPLICATION, cnt.getStorageSpace());
        dfs.delete(createdFile, true);
        QuotaCountsInterface cntAfterDelete = fnode.asDirectory().getDirectoryWithQuotaFeature().getSpaceConsumed();
    ...
    private void testQuotaByStorageTypeOrTraditionalQuotaExceededCase(long storageSpaceQuotaInBlocks, long ssdQuotaInBlocks, long testFileLenInBlocks, short replication) throws Exception {
        ...
        INodeInterface testDirNode = fsdir.getINode4Write(testDir.toString());
        ...
        try {
            ...
            LOG.info("Got expected exception ", t);
            long currentSSDConsumed = testDirNode.asDirectory().getDirectoryWithQuotaFeature().getSpaceConsumed().getTypeSpaces().get(StorageType.SSD);
    ...
    public void testQuotaByStorageTypeWithSnapshot() throws Exception {
        ...
        INodeInterface sub1Node = fsdir.getINode4Write(sub1.toString());
        ...
        assertEquals(file1Len, ssdConsumed);
        QuotaCountsInterface counts1 = sub1Node.computeQuotaUsage(fsn.getBlockManager().getStoragePolicySuite(), true);
        assertEquals(sub1Node.dumpTreeRecursively().toString(), file1Len, counts1.getTypeSpaces().get(StorageType.SSD));
        ContentSummaryInterface cs1 = dfs.getContentSummary(sub1);
        ...
        QuotaCountsInterface counts2 = sub1Node.computeQuotaUsage(fsn.getBlockManager().getStoragePolicySuite(), true);
        assertEquals(sub1Node.dumpTreeRecursively().toString(), 0, counts2.getTypeSpaces().get(StorageType.SSD));
        ContentSummaryInterface cs2 = dfs.getContentSummary(sub1);
    ...
    public void testQuotaByStorageTypePersistenceInEditLog() throws IOException {
        ...
        refreshClusterState();
        INodeInterface testDirNodeAfterNNRestart = fsdir.getINode4Write(testDir.toString());
        // Verify quota is still set
        assertTrue(testDirNode.isDirectory());
        assertTrue(testDirNode.isQuotaSet());
        QuotaCountsInterface qc = testDirNodeAfterNNRestart.getQuotaCounts();
    ...
    public void testStorageSpaceQuotaPerQuotaClear() throws IOException {
        ...
        final INodeInterface testDirNode = fsdir.getINode4Write(testDir.toString());
        assertTrue(testDirNode.isDirectory());
        assertTrue(testDirNode.isQuotaSet());
