 ...
 */
public class TestWebHdfsWithMultipleNameNodes_RestartInjected_Randomized_123 {
    ...
    public void testRedirect() throws Exception {
        ...
        RestartFramework.at("after_first_length_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_second_length_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
