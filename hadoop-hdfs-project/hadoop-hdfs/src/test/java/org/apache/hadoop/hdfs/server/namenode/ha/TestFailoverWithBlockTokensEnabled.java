...
public class TestFailoverWithBlockTokensEnabled {
    ...
    public void startCluster() throws IOException {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology(numNNs)).numDataNodes(1).build();
    }
    ...
    public void ensureSerialNumbersNeverOverlap() {
        BlockTokenSecretManagerInterface btsm1 = cluster.getNamesystem(0).getBlockManager().getBlockTokenSecretManager();
        BlockTokenSecretManagerInterface btsm2 = cluster.getNamesystem(1).getBlockManager().getBlockTokenSecretManager();
        BlockTokenSecretManagerInterface btsm3 = cluster.getNamesystem(2).getBlockManager().getBlockTokenSecretManager();
    ...
    private static void lowerKeyUpdateIntervalAndClearKeys(MiniDockerDFSCluster cluster) {
