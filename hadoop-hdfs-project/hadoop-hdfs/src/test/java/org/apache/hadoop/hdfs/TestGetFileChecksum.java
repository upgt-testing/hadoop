...
public class TestGetFileChecksum {
    ...
    @Test
    public void testGetFileChecksumForBlocksUnderConstruction_withUpgrade20() {
        try {
            FSDataOutputStream file = dfs.create(new Path("/testFile"));
    ...
    @Test
    public void testGetFileChecksumForBlocksUnderConstruction_withUpgrade40() {
        try {
            FSDataOutputStream file = dfs.create(new Path("/testFile"));
            file.write("Performance Testing".getBytes());
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGetFileChecksumForBlocksUnderConstruction_withUpgrade60() {
        try {
            FSDataOutputStream file = dfs.create(new Path("/testFile"));
            file.write("Performance Testing".getBytes());
            dfs.getFileChecksum(new Path("/testFile"));
    ...
    @Test
    public void testGetFileChecksumForBlocksUnderConstruction_withUpgrade80() {
        try {
            FSDataOutputStream file = dfs.create(new Path("/testFile"));
            file.write("Performance Testing".getBytes());
            dfs.getFileChecksum(new Path("/testFile"));
    ...
    @Test
    public void testGetFileChecksum_withUpgrade20() throws Exception {
        testGetFileChecksum(new Path("/foo"), BLOCKSIZE / 4);
        testGetFileChecksum(new Path("/bar"), BLOCKSIZE / 4 - 1);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
