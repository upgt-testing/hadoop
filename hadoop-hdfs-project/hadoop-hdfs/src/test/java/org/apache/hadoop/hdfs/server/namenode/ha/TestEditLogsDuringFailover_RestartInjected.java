...
public class TestEditLogsDuringFailover_RestartInjected {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestEditLogsDuringFailover_RestartInjected.class);
  ...
  public void testStartup() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_first_transition_active")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_test")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_test2")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  private void testFailoverFinalizesAndReadsInProgress(
    ...
    try {
      ...
      RestartFramework.at("after_create_fake_log")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_transition_active")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
