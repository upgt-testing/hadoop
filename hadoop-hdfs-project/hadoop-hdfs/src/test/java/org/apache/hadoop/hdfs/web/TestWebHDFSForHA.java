...
public class TestWebHDFSForHA {
    ...
    public void testClientFailoverWhenStandbyNNHasStaleCredentials() throws IOException {
        ...
        try {
            ...
            cluster.transitionToActive(1);
            final DelegationTokenSecretManagerJVMInterface secretManager = NameNodeAdapter.getDtSecretManager(cluster.getNamesystem(0));
    ...
    public void testFailoverAfterOpen() throws IOException {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(topo).numDataNodes(1).build();
            HATestUtil.setFailoverConfigurations(cluster, conf, LOGICAL_NAME);
            cluster.waitActive();
            fs = FileSystem.get(WEBHDFS_URI, conf);
            cluster.transitionToActive(1);
    ...
    @Test
    public void testHA_withUpgrade20() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
    ...
    @Test
    public void testHA_withUpgrade40() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
    ...
    @Test
    public void testHA_withUpgrade60() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
    ...
    @Test
    public void testHA_withUpgrade80() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
        try {
    ...
    @Test
    public void testSecureHAToken_withUpgrade20() throws IOException, InterruptedException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testSecureHAToken_withUpgrade40() throws IOException, InterruptedException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testSecureHAToken_withUpgrade60() throws IOException, InterruptedException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testSecureHAToken_withUpgrade80() throws IOException, InterruptedException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testClientFailoverWhenStandbyNNHasStaleCredentials_withUpgrade20() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testClientFailoverWhenStandbyNNHasStaleCredentials_withUpgrade40() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testClientFailoverWhenStandbyNNHasStaleCredentials_withUpgrade60() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testClientFailoverWhenStandbyNNHasStaleCredentials_withUpgrade80() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
    ...
    @Test
    public void testFailoverAfterOpen_withUpgrade20() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.set(FS_DEFAULT_NAME_KEY, HdfsConstants.HDFS_URI_SCHEME + "://" + LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testFailoverAfterOpen_withUpgrade40() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.set(FS_DEFAULT_NAME_KEY, HdfsConstants.HDFS_URI_SCHEME + "://" + LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testFailoverAfterOpen_withUpgrade60() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.set(FS_DEFAULT_NAME_KEY, HdfsConstants.HDFS_URI_SCHEME + "://" + LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testFailoverAfterOpen_withUpgrade80() throws IOException {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        conf.set(FS_DEFAULT_NAME_KEY, HdfsConstants.HDFS_URI_SCHEME + "://" + LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fs = null;
    ...
    @Test
    public void testMultipleNamespacesConfigured_withUpgrade20() throws Exception {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
        try {
    ...
    @Test
    public void testMultipleNamespacesConfigured_withUpgrade40() throws Exception {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
        try {
    ...
    @Test
    public void testMultipleNamespacesConfigured_withUpgrade60() throws Exception {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
        try {
    ...
    @Test
    public void testMultipleNamespacesConfigured_withUpgrade80() throws Exception {
        Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        WebHdfsFileSystem fs = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testRetryWhileNNStartup_withUpgrade20() throws Exception {
        final Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        final Map<String, Boolean> resultMap = new HashMap<String, Boolean>();
        try {
    ...
    @Test(timeout = 120000)
    public void testRetryWhileNNStartup_withUpgrade80() throws Exception {
        final Configuration conf = DFSTestUtil.newHAConfiguration(LOGICAL_NAME);
        MiniDFSClusterInJVM cluster = null;
        final Map<String, Boolean> resultMap = new HashMap<String, Boolean>();
        try {
