...
public class TestDFSStorageStateRecovery {
    ...
    private MiniDFSClusterInJVM createCluster(Configuration c) throws IOException {
        return new MiniDFSClusterInJVM.Builder(c).numDataNodes(0).startupOption(StartupOption.REGULAR).format(false).manageDataDfsDirs(false).manageNameDfsDirs(false).build();
    }
    ...
    @Test
    public void testNNStorageStates_withUpgrade20() throws Exception {
        String[] baseDirs;
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1);
    ...
    @Test
    public void testNNStorageStates_withUpgrade40() throws Exception {
        String[] baseDirs;
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1);
    ...
    @Test
    public void testNNStorageStates_withUpgrade60() throws Exception {
        String[] baseDirs;
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
            conf.setInt(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1);
    ...
    @Test
    public void testDNStorageStates_withUpgrade20() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
    ...
    @Test
    public void testDNStorageStates_withUpgrade40() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
    ...
    @Test
    public void testDNStorageStates_withUpgrade60() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
    ...
    @Test
    public void testDNStorageStates_withUpgrade80() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            conf = new HdfsConfiguration();
    ...
    @Test
    public void testBlockPoolStorageStates_withUpgrade20() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        String bpid = UpgradeUtilities.getCurrentBlockPoolID(null);
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
    ...
    @Test
    public void testBlockPoolStorageStates_withUpgrade40() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        String bpid = UpgradeUtilities.getCurrentBlockPoolID(null);
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
    ...
    @Test
    public void testBlockPoolStorageStates_withUpgrade60() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        String bpid = UpgradeUtilities.getCurrentBlockPoolID(null);
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
    ...
    @Test
    public void testBlockPoolStorageStates_withUpgrade80() throws Exception {
        String[] baseDirs;
        // First setup the datanode storage directory
        String bpid = UpgradeUtilities.getCurrentBlockPoolID(null);
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
