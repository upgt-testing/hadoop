...
public class TestAppendSnapshotTruncate {
    ...
    @Test(timeout = TEST_TIMEOUT_SECOND * 1000)
    public void testAST_withUpgrade20() throws Exception {
        final String dirPathString = "/dir";
        final Path dir = new Path(dirPathString);
        dfs.mkdirs(dir);
        dfs.allowSnapshot(dir);
    ...
    @Test(timeout = TEST_TIMEOUT_SECOND * 1000)
    public void testAST_withUpgrade40() throws Exception {
        final String dirPathString = "/dir";
        final Path dir = new Path(dirPathString);
        dfs.mkdirs(dir);
        dfs.allowSnapshot(dir);
    ...
    @Test(timeout = TEST_TIMEOUT_SECOND * 1000)
    public void testAST_withUpgrade60() throws Exception {
        final String dirPathString = "/dir";
        final Path dir = new Path(dirPathString);
        dfs.mkdirs(dir);
        dfs.allowSnapshot(dir);
    ...
    @Test(timeout = TEST_TIMEOUT_SECOND * 1000)
    public void testAST_withUpgrade80() throws Exception {
        final String dirPathString = "/dir";
        final Path dir = new Path(dirPathString);
        dfs.mkdirs(dir);
        dfs.allowSnapshot(dir);
