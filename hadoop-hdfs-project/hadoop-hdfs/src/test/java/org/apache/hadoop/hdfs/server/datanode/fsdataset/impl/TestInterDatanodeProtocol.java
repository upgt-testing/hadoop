...
public class TestInterDatanodeProtocol {
    ...
    public static void checkMetaInfo(ExtendedBlock b, DataNodeInterface dn) throws IOException {
    ...
    private void checkBlockMetaDataInfo(boolean useDnHostname) throws Exception {
        ...
        try {
            cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(3).checkDataNodeHostConfig(true).build();
            cluster.waitActive();
            //create a file
            ...
            DataNodeInterface datanode = cluster.getDataNode(datanodeinfo[0].getIpcPort());
    ...
    public void testInitReplicaRecovery() throws IOException {
        ...
        }
        {
            ...
            final ReplicaRecoveryInfoInterface recoveryInfo2 = FsDatasetImpl.initReplicaRecovery(bpid, map, blocks[0], recoveryid2, DFSConfigKeys.DFS_DATANODE_XCEIVER_STOP_TIMEOUT_MILLIS_DEFAULT);
        ...
        }
        {
            ...
            ReplicaRecoveryInfoInterface r = FsDatasetImpl.initReplicaRecovery(bpid, map, b, recoveryid, DFSConfigKeys.DFS_DATANODE_XCEIVER_STOP_TIMEOUT_MILLIS_DEFAULT);
    ...
    public void testUpdateReplicaUnderRecovery() throws IOException {
        ...
        try {
            ...
            final ReplicaRecoveryInfoInterface rri = fsdataset.initReplicaRecovery(new RecoveringBlock(b, null, recoveryid));
            //check replica
    ...
    public void testInterDNProtocolTimeout() throws Throwable {
        ...
        DatanodeInfoInterface dInfo = new DatanodeInfoBuilder().setNodeID(fakeDnId).build();
