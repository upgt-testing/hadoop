...
public class TestClientProtocolForPipelineRecovery {
    ...
    public void testHeartbeatDuringFlush() throws Exception {
        ...
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
            ...
            public void delaySendingAckToUpstream(final String upstreamAddr) throws IOException {
                try {
                    // delay longer than socket timeout
                    Thread.sleep(3500);
    ...
    public void testEvictWriter() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes((int) 3).build();
            cluster.waitActive();
            FileSystem fs = cluster.getFileSystem();
    ...
    public void testPipelineRecoveryOnDatanodeUpgrade() throws Exception {
        ...
        try {
            ...
            MiniDFSClusterInJVM.DataNodeProperties dnProps = cluster.stopDataNodeForUpgrade(0);
            GenericTestUtils.waitForThreadTermination("Async datanode shutdown thread", 100, 10000);
    ...
    public void testPipelineRecoveryOnRemoteDatanodeUpgrade() throws Exception {
        ...
        try {
            ...
            for (DatanodeInfo node : pipeline) {
                ...
                final long oldGs = out.getBlock().getGenerationStamp();
                MiniDFSClusterInJVM.DataNodeProperties dnProps = cluster.stopDataNodeForUpgrade(indexToShutdown);
                GenericTestUtils.waitForThreadTermination("Async datanode shutdown thread", 100, 10000);
                cluster.restartDataNode(dnProps, true);
                cluster.waitActive();
                // wait pipeline to be recovered
   ...
   */
    @Test
    public void testPipelineRecoveryForLastBlock_withUpgrade20() throws IOException {
        DFSClientFaultInjector faultInjector = Mockito.mock(DFSClientFaultInjector.class);
        DFSClientFaultInjector oldInjector = DFSClientFaultInjector.get();
        DFSClientFaultInjector.set(faultInjector);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testPipelineRecoveryForLastBlock_withUpgrade40() throws IOException {
        DFSClientFaultInjector faultInjector = Mockito.mock(DFSClientFaultInjector.class);
        DFSClientFaultInjector oldInjector = DFSClientFaultInjector.get();
        DFSClientFaultInjector.set(faultInjector);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testPipelineRecoveryForLastBlock_withUpgrade60() throws IOException {
        DFSClientFaultInjector faultInjector = Mockito.mock(DFSClientFaultInjector.class);
        DFSClientFaultInjector oldInjector = DFSClientFaultInjector.get();
        DFSClientFaultInjector.set(faultInjector);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testPipelineRecoveryForLastBlock_withUpgrade80() throws IOException {
        DFSClientFaultInjector faultInjector = Mockito.mock(DFSClientFaultInjector.class);
        DFSClientFaultInjector oldInjector = DFSClientFaultInjector.get();
        DFSClientFaultInjector.set(faultInjector);
        Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testPacketTransmissionDelay_withUpgrade20() throws Exception {
        // Make the first datanode to not relay heartbeat packet.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testPacketTransmissionDelay_withUpgrade40() throws Exception {
        // Make the first datanode to not relay heartbeat packet.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testPacketTransmissionDelay_withUpgrade60() throws Exception {
        // Make the first datanode to not relay heartbeat packet.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testHeartbeatDuringFlush_withUpgrade20() throws Exception {
        // Delay sending acks
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testHeartbeatDuringFlush_withUpgrade40() throws Exception {
        // Delay sending acks
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testHeartbeatDuringFlush_withUpgrade60() throws Exception {
        // Delay sending acks
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testHeartbeatDuringFlush_withUpgrade80() throws Exception {
        // Delay sending acks
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testPipelineRecoveryOnOOB_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "15");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testPipelineRecoveryOnOOB_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "15");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testPipelineRecoveryOnOOB_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "15");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testPipelineRecoveryOnOOB_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "15");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testEvictWriter_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes((int) 3).build();
    ...
    @Test
    public void testEvictWriter_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes((int) 3).build();
    ...
    @Test
    public void testEvictWriter_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes((int) 3).build();
    ...
    @Test
    public void testEvictWriter_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes((int) 3).build();
    ...
    @Test
    public void testPipelineRecoveryOnRestartFailure_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "5");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testPipelineRecoveryOnRestartFailure_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "5");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testPipelineRecoveryOnRestartFailure_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "5");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testPipelineRecoveryOnRestartFailure_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(HdfsClientConfigKeys.DFS_CLIENT_DATANODE_RESTART_TIMEOUT_KEY, "5");
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 60000)
    public void testPipelineRecoveryOnDatanodeUpgrade_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 60000)
    public void testPipelineRecoveryOnDatanodeUpgrade_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 60000)
    public void testPipelineRecoveryOnDatanodeUpgrade_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 60000)
    public void testPipelineRecoveryOnDatanodeUpgrade_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testPipelineRecoveryOnRemoteDatanodeUpgrade_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(BlockWrite.ReplaceDatanodeOnFailure.BEST_EFFORT_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        DFSClientFaultInjector old = DFSClientFaultInjector.get();
    ...
    @Test
    public void testPipelineRecoveryOnRemoteDatanodeUpgrade_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(BlockWrite.ReplaceDatanodeOnFailure.BEST_EFFORT_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        DFSClientFaultInjector old = DFSClientFaultInjector.get();
    ...
    @Test
    public void testPipelineRecoveryOnRemoteDatanodeUpgrade_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(BlockWrite.ReplaceDatanodeOnFailure.BEST_EFFORT_KEY, true);
        MiniDFSClusterInJVM cluster = null;
        DFSClientFaultInjector old = DFSClientFaultInjector.get();
    ...
    @Test
    public void testZeroByteBlockRecovery_withUpgrade20() throws Exception {
        // will cause a test failure.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testZeroByteBlockRecovery_withUpgrade40() throws Exception {
        // will cause a test failure.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testZeroByteBlockRecovery_withUpgrade60() throws Exception {
        // will cause a test failure.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testZeroByteBlockRecovery_withUpgrade80() throws Exception {
        // will cause a test failure.
        DataNodeFaultInjector dnFaultInjector = new DataNodeFaultInjector() {
    ...
    @Test
    public void testPipelineRecoveryWithTransferBlock_withUpgrade20() throws Exception {
        final int chunkSize = 512;
        final int oneWriteSize = 5000;
        final int totalSize = 1024 * 1024;
        final int errorInjectionPos = 512;
    ...
    @Test
    public void testPipelineRecoveryWithTransferBlock_withUpgrade60() throws Exception {
        final int chunkSize = 512;
        final int oneWriteSize = 5000;
        final int totalSize = 1024 * 1024;
        final int errorInjectionPos = 512;
    ...
    @Test
    public void testPipelineRecoveryWithTransferBlock_withUpgrade80() throws Exception {
        final int chunkSize = 512;
        final int oneWriteSize = 5000;
        final int totalSize = 1024 * 1024;
        final int errorInjectionPos = 512;
