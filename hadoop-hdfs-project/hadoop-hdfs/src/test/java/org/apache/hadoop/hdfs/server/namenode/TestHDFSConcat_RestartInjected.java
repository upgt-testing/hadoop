...
public class TestHDFSConcat_RestartInjected {
  ...
  public void testConcat() throws IOException, InterruptedException {
    ...
    RestartFramework.at("after_target_file_creation")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_source_files_creation")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_small_file_concat")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testIllegalArg() throws IOException {
    ...
    // must be in the same dir
    {
      ...
      RestartFramework.at("after_first_src_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    // the source file's preferred block size cannot be greater than the target
    {
      ...
      RestartFramework.at("after_second_src_set_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testConcatWithQuotaDecrease() throws IOException {
    ...
    RestartFramework.at("after_target_creation")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testConcatWithQuotaIncrease() throws IOException {
    ...
    RestartFramework.at("after_quota_increase")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
