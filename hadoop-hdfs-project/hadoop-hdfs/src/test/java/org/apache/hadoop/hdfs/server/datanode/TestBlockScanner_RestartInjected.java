...
public class TestBlockScanner_RestartInjected {
  ...
  private void testVolumeIteratorImpl(int numFiles,
    ...
    try {
      ...
      RestartFramework.at("after_iterator_created")
          .on(ctx.cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  private void testScanAllBlocksImpl(final boolean rescan) throws Exception {
    ...
    RestartFramework.at("after_scanner_started")
        .on(ctx.cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCorruptBlockHandling() throws Exception {
    ...
    RestartFramework.at("after_block_corrupted")
        .on(ctx.cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeCursor() throws Exception {
    ...
    RestartFramework.at("after_first_scan_phase")
        .on(ctx.cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
