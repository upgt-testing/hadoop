...
public class TestErasureCodingCLI_RestartInjected_Randomized_456 extends CLITestHelper {
    ...
    @Override
    public void testAll() {
        RestartFramework.at("before_ec_operations").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        super.testAll();
        RestartFramework.at("after_ec_operations").on(dfsCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
}
