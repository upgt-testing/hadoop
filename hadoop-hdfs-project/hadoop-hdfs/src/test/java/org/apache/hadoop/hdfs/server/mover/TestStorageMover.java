...
public class TestStorageMover {
    ...
    class MigrationTest {
        ...
        void setupCluster() throws Exception {
            cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(clusterScheme.numDataNodes).storageTypes(clusterScheme.storageTypes).storageCapacities(clusterScheme.storageCapacities).build();
            cluster.waitActive();
    ...
    public void testNoSpaceDisk() throws Exception {
        ...
        try {
            ...
            for (DataNodeInterface dn : test.cluster.getDataNodes()) {
