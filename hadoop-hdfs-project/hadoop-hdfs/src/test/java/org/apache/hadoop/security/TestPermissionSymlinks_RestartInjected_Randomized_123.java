...
public class TestPermissionSymlinks_RestartInjected_Randomized_123 {
    ...
    public void setUp() throws Exception {
        RestartFramework.at("after_symlink_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
