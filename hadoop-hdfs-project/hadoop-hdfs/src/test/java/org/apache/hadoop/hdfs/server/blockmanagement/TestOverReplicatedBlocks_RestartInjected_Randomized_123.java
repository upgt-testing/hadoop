...
public class TestOverReplicatedBlocks_RestartInjected_Randomized_123 {
    ...
    public void testProcesOverReplicateBlock() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_corrupt_replica").on(cluster).restart("datanode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testChooseReplicaToDelete() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_fourth_datanode_start").on(cluster).restart("datanode").withIndex(3).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_heartbeat_wait").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            namesystem = cluster.getNamesystem();
            bm = cluster.getNamesystem().getBlockManager();
