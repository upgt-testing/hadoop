...
public class TestDataTransferProtocol {
     ...
     */
        ...
        try {
            ...
            if (eofExpected) {
                throw new IOException("Did not recieve IOException when an exception " + "is expected while reading from " + datanode);
            }
    ...
    void writeBlock(ExtendedBlock block, BlockConstructionStage stage, long newGS, DataChecksum checksum) throws IOException {
        sender.writeBlock(block, StorageType.DEFAULT, BlockTokenSecretManager.DUMMY_TOKEN, "cl", new DatanodeInfo[1], new StorageType[1], null, stage, 0, block.getNumBytes(), block.getNumBytes(), newGS, checksum, CachingStrategy.newDefaultStrategy(), false, false, null);
    }
    ...
    public void testReleaseVolumeRefIfExceptionThrown() throws IOException, InterruptedException {
        ...
        try {
            ...
            FsVolumeImpl volume = (FsVolumeImpl) DataNodeTestUtils.getFSDataset(dn).getVolume(blk);
    ...
    @Test
    public void testOpWrite_withUpgrade20() throws IOException {
        int numDataNodes = 1;
        final long BLOCK_ID_FUDGE = 128;
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDataNodes).build();
    ...
    @Test
    public void testOpWrite_withUpgrade40() throws IOException {
        int numDataNodes = 1;
        final long BLOCK_ID_FUDGE = 128;
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDataNodes).build();
    ...
    @Test
    public void testOpWrite_withUpgrade60() throws IOException {
        int numDataNodes = 1;
        final long BLOCK_ID_FUDGE = 128;
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDataNodes).build();
    ...
    @Test
    public void testOpWrite_withUpgrade80() throws IOException {
        int numDataNodes = 1;
        final long BLOCK_ID_FUDGE = 128;
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDataNodes).build();
    ...
    @Test
    public void testDataTransferProtocol_withUpgrade20() throws IOException {
        Random random = new Random();
        int oneMil = 1024 * 1024;
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
    ...
    @Test
    public void testDataTransferProtocol_withUpgrade40() throws IOException {
        Random random = new Random();
        int oneMil = 1024 * 1024;
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
    ...
    @Test
    public void testDataTransferProtocol_withUpgrade60() throws IOException {
        Random random = new Random();
        int oneMil = 1024 * 1024;
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
    ...
    @Test
    public void testDataTransferProtocol_withUpgrade80() throws IOException {
        Random random = new Random();
        int oneMil = 1024 * 1024;
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
