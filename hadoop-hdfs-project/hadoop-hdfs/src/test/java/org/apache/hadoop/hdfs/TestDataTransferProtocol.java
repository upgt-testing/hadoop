...
public class TestDataTransferProtocol {
    ...
    @Test(timeout = 30000)
    public void testReleaseVolumeRefIfExceptionThrown_withUpgrade20() throws IOException, InterruptedException {
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, numDataNodes);
    ...
    @Test(timeout = 30000)
    public void testReleaseVolumeRefIfExceptionThrown_withUpgrade40() throws IOException, InterruptedException {
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, numDataNodes);
    ...
    @Test(timeout = 30000)
    public void testReleaseVolumeRefIfExceptionThrown_withUpgrade60() throws IOException, InterruptedException {
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, numDataNodes);
    ...
    @Test(timeout = 30000)
    public void testReleaseVolumeRefIfExceptionThrown_withUpgrade80() throws IOException, InterruptedException {
        Path file = new Path("dataprotocol.dat");
        int numDataNodes = 1;
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, numDataNodes);
