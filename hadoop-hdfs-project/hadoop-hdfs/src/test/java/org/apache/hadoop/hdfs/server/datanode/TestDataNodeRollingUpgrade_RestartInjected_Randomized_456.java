 ...
 */
public class TestDataNodeRollingUpgrade_RestartInjected_Randomized_456 {
    ...
    public void testDatanodeRollingUpgradeWithFinalize() throws Exception {
        try {
            ...
            RestartFramework.at("after_rolling_upgrade_and_finalize").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // Do it again
            rollingUpgradeAndFinalize();
        } finally {
            shutdownCluster();
    ...
    public void testDatanodeRUwithRegularUpgrade() throws Exception {
        try {
            ...
            cluster.waitActive();
            RestartFramework.at("after_regular_upgrade").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDatanodeRollingUpgradeWithRollback() throws Exception {
        try {
            ...
            startRollingUpgrade();
            RestartFramework.at("after_start_rolling_upgrade").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_rollback").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    void testDatanodePeersXceiver() throws Exception {
        try {
            ...
            RestartFramework.at("after_create_streams").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            s3.flush();
            RestartFramework.at("after_write_flush").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testWithLayoutChangeAndFinalize() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_delete_first_file").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            finalizeRollingUpgrade();
            RestartFramework.at("after_finalize").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            dn0 = cluster.getDataNodes().get(0);
            assertFalse(isTrashRootPresent());
