...
public class TestStickyBit {
    ...
    private static void initCluster(boolean format) throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).format(format).build();
    ...
    @Test
    public void testGeneralSBBehavior_withUpgrade20() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testGeneralSBBehavior_withUpgrade40() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testGeneralSBBehavior_withUpgrade60() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testGeneralSBBehavior_withUpgrade80() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testAclGeneralSBBehavior_withUpgrade20() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testAclGeneralSBBehavior_withUpgrade40() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testAclGeneralSBBehavior_withUpgrade60() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testAclGeneralSBBehavior_withUpgrade80() throws Exception {
        Path baseDir = new Path("/mcgann");
        hdfs.mkdirs(baseDir);
        // Create a tmp directory with wide-open permissions and sticky bit
        Path p = new Path(baseDir, "tmp");
    ...
    @Test
    public void testMovingFiles_withUpgrade20() throws Exception {
        testMovingFiles(false);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testAclMovingFiles_withUpgrade20() throws Exception {
        testMovingFiles(true);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    }
    ...
    @Test
    public void testStickyBitPersistence_withUpgrade40() throws Exception {
        // A tale of three directories...
        Path sbSet = new Path("/Housemartins");
        Path sbNotSpecified = new Path("/INXS");
        Path sbSetOff = new Path("/Easyworld");
    ...
    @Test
    public void testStickyBitPersistence_withUpgrade60() throws Exception {
        // A tale of three directories...
        Path sbSet = new Path("/Housemartins");
        Path sbNotSpecified = new Path("/INXS");
        Path sbSetOff = new Path("/Easyworld");
    ...
    @Test
    public void testStickyBitPersistence_withUpgrade80() throws Exception {
        // A tale of three directories...
        Path sbSet = new Path("/Housemartins");
        Path sbNotSpecified = new Path("/INXS");
        Path sbSetOff = new Path("/Easyworld");
    ...
    @Test
    public void testStickyBitReset_withUpgrade20() throws Exception {
        Path sbExplicitTestDir = new Path("/DirToTestExplicitStickyBit");
        Path sbOmittedTestDir = new Path("/DirToTestOmittedStickyBit");
        // Creation of directories and verification of their existence
        hdfs.mkdirs(sbExplicitTestDir);
    ...
    @Test
    public void testStickyBitReset_withUpgrade40() throws Exception {
        Path sbExplicitTestDir = new Path("/DirToTestExplicitStickyBit");
        Path sbOmittedTestDir = new Path("/DirToTestOmittedStickyBit");
        // Creation of directories and verification of their existence
        hdfs.mkdirs(sbExplicitTestDir);
    ...
    @Test
    public void testStickyBitReset_withUpgrade60() throws Exception {
        Path sbExplicitTestDir = new Path("/DirToTestExplicitStickyBit");
        Path sbOmittedTestDir = new Path("/DirToTestOmittedStickyBit");
        // Creation of directories and verification of their existence
        hdfs.mkdirs(sbExplicitTestDir);
    ...
    @Test
    public void testStickyBitReset_withUpgrade80() throws Exception {
        Path sbExplicitTestDir = new Path("/DirToTestExplicitStickyBit");
        Path sbOmittedTestDir = new Path("/DirToTestOmittedStickyBit");
        // Creation of directories and verification of their existence
        hdfs.mkdirs(sbExplicitTestDir);
    ...
    @Test
    public void testAclStickyBitPersistence_withUpgrade40() throws Exception {
        // A tale of three directories...
        Path sbSet = new Path("/Housemartins");
        Path sbNotSpecified = new Path("/INXS");
        Path sbSetOff = new Path("/Easyworld");
    ...
    @Test
    public void testAclStickyBitPersistence_withUpgrade60() throws Exception {
        // A tale of three directories...
        Path sbSet = new Path("/Housemartins");
        Path sbNotSpecified = new Path("/INXS");
        Path sbSetOff = new Path("/Easyworld");
    ...
    @Test
    public void testAclStickyBitPersistence_withUpgrade80() throws Exception {
        // A tale of three directories...
        Path sbSet = new Path("/Housemartins");
        Path sbNotSpecified = new Path("/INXS");
        Path sbSetOff = new Path("/Easyworld");
    ...
    @Test
    public void testStickyBitRecursiveDeleteFile_withUpgrade20() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path file = new Path(tmp, "file");
        // Create a tmp directory with wide-open permissions and sticky bit
    ...
    @Test
    public void testStickyBitRecursiveDeleteFile_withUpgrade40() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path file = new Path(tmp, "file");
        // Create a tmp directory with wide-open permissions and sticky bit
    ...
    @Test
    public void testStickyBitRecursiveDeleteFile_withUpgrade60() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path file = new Path(tmp, "file");
        // Create a tmp directory with wide-open permissions and sticky bit
    ...
    @Test
    public void testStickyBitRecursiveDeleteFile_withUpgrade80() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path file = new Path(tmp, "file");
        // Create a tmp directory with wide-open permissions and sticky bit
    ...
    @Test
    public void testStickyBitRecursiveDeleteDir_withUpgrade20() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path dir = new Path(tmp, "dir");
        Path file = new Path(dir, "file");
    ...
    @Test
    public void testStickyBitRecursiveDeleteDir_withUpgrade40() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path dir = new Path(tmp, "dir");
        Path file = new Path(dir, "file");
    ...
    @Test
    public void testStickyBitRecursiveDeleteDir_withUpgrade60() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path dir = new Path(tmp, "dir");
        Path file = new Path(dir, "file");
    ...
    @Test
    public void testStickyBitRecursiveDeleteDir_withUpgrade80() throws Exception {
        Path root = new Path("/" + GenericTestUtils.getMethodName());
        Path tmp = new Path(root, "tmp");
        Path dir = new Path(tmp, "dir");
        Path file = new Path(dir, "file");
