...
public class TestErasureCodingPolicies {
    ...
    public void setupCluster() throws IOException {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(ecPolicy.getNumDataUnits() + ecPolicy.getNumParityUnits()).build();
        cluster.waitActive();
    ...
    @Test
    public void testBasicSetECPolicy_withUpgrade20() throws IOException, InterruptedException {
        final Path testDir = new Path("/ec");
        fs.mkdir(testDir, FsPermission.getDirDefault());
        /* Normal creation of an erasure coding directory */
        fs.setErasureCodingPolicy(testDir, ecPolicy.getName());
    ...
    @Test
    public void testBasicSetECPolicy_withUpgrade40() throws IOException, InterruptedException {
        final Path testDir = new Path("/ec");
        fs.mkdir(testDir, FsPermission.getDirDefault());
        /* Normal creation of an erasure coding directory */
        fs.setErasureCodingPolicy(testDir, ecPolicy.getName());
    ...
    @Test
    public void testBasicSetECPolicy_withUpgrade60() throws IOException, InterruptedException {
        final Path testDir = new Path("/ec");
        fs.mkdir(testDir, FsPermission.getDirDefault());
        /* Normal creation of an erasure coding directory */
        fs.setErasureCodingPolicy(testDir, ecPolicy.getName());
    ...
    @Test
    public void testBasicSetECPolicy_withUpgrade80() throws IOException, InterruptedException {
        final Path testDir = new Path("/ec");
        fs.mkdir(testDir, FsPermission.getDirDefault());
        /* Normal creation of an erasure coding directory */
        fs.setErasureCodingPolicy(testDir, ecPolicy.getName());
    ...
    @Test
    public void testGetErasureCodingPolicyOnANonExistentFile_withUpgrade20() throws Exception {
        Path path = new Path("/ecDir");
        try {
            fs.getErasureCodingPolicy(path);
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGetErasureCodingPolicyOnANonExistentFile_withUpgrade40() throws Exception {
        Path path = new Path("/ecDir");
        try {
            fs.getErasureCodingPolicy(path);
            fail("FileNotFoundException should be thrown for a non-existent" + " file path");
    ...
    @Test
    public void testGetErasureCodingPolicyOnANonExistentFile_withUpgrade60() throws Exception {
        Path path = new Path("/ecDir");
        try {
            fs.getErasureCodingPolicy(path);
            fail("FileNotFoundException should be thrown for a non-existent" + " file path");
    ...
    @Test
    public void testGetErasureCodingPolicyOnANonExistentFile_withUpgrade80() throws Exception {
        Path path = new Path("/ecDir");
        try {
            fs.getErasureCodingPolicy(path);
            fail("FileNotFoundException should be thrown for a non-existent" + " file path");
    ...
    @Test
    public void testAddErasureCodingPolicies_withUpgrade20() throws Exception {
        // Test nonexistent codec name
        ECSchema toAddSchema = new ECSchema("testcodec", 3, 2);
        ErasureCodingPolicy newPolicy = new ErasureCodingPolicy(toAddSchema, 128 * 1024);
        ErasureCodingPolicy[] policyArray = new ErasureCodingPolicy[] { newPolicy };
    ...
    @Test
    public void testAddErasureCodingPolicies_withUpgrade40() throws Exception {
        // Test nonexistent codec name
        ECSchema toAddSchema = new ECSchema("testcodec", 3, 2);
        ErasureCodingPolicy newPolicy = new ErasureCodingPolicy(toAddSchema, 128 * 1024);
        ErasureCodingPolicy[] policyArray = new ErasureCodingPolicy[] { newPolicy };
    ...
    @Test
    public void testAddErasureCodingPolicies_withUpgrade60() throws Exception {
        // Test nonexistent codec name
        ECSchema toAddSchema = new ECSchema("testcodec", 3, 2);
        ErasureCodingPolicy newPolicy = new ErasureCodingPolicy(toAddSchema, 128 * 1024);
        ErasureCodingPolicy[] policyArray = new ErasureCodingPolicy[] { newPolicy };
    ...
    @Test
    public void testAddErasureCodingPolicies_withUpgrade80() throws Exception {
        // Test nonexistent codec name
        ECSchema toAddSchema = new ECSchema("testcodec", 3, 2);
        ErasureCodingPolicy newPolicy = new ErasureCodingPolicy(toAddSchema, 128 * 1024);
        ErasureCodingPolicy[] policyArray = new ErasureCodingPolicy[] { newPolicy };
