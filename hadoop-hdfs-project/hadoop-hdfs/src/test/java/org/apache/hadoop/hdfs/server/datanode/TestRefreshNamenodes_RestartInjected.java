...
public class TestRefreshNamenodes_RestartInjected {
  ...
  public void testRefreshNamenodes() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_add_namenode_2")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_add_namenode_3")
          .on(cluster)
          .restart("namenode")
          .withIndex(2)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_add_namenode_4")
          .on(cluster)
          .restart("namenode")
          .withIndex(3)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshNameNodeDeadLock() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_fault_injector_setup")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
