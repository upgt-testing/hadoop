...
public class TestWriteRead {
    ...
    private long readUntilEnd(FSDataInputStream in, byte[] buffer, long size, String fname, long pos, long visibleLen, boolean positionReadOption) throws IOException {
        ...
        if (verboseOption)
            LOG.info("reader begin: position: " + pos + " ; currentOffset = " + currentPosition + " ; bufferSize =" + buffer.length + " ; Filename = " + fname);
        try {
        ...
        if (verboseOption)
            LOG.info("reader end:   position: " + pos + " ; currentOffset = " + currentPosition + " ; totalByteRead =" + totalByteRead + " ; Filename = " + fname);
    ...
    private long getFileLengthFromNN(Path path) throws IOException {
        FileStatus fileStatus = useFCOption ? mfc.getFileStatus(path) : mfs.getFileStatus(path);
    ...
    private Path getFullyQualifiedPath(String pathString) {
        return useFCOption ? mfc.makeQualified(new Path(ROOT_DIR, pathString)) : mfs.makeQualified(new Path(ROOT_DIR, pathString));
    }
    ...
    @Test
    public void testWriteReadSeq_withUpgrade20() throws IOException {
        useFCOption = false;
        positionReadOption = false;
        String fname = filenameOption;
    ...
    @Test
    public void testWriteReadSeq_withUpgrade40() throws IOException {
        useFCOption = false;
        positionReadOption = false;
        String fname = filenameOption;
        long rdBeginPos = 0;
    ...
    @Test
    public void testWriteReadSeq_withUpgrade60() throws IOException {
        useFCOption = false;
        positionReadOption = false;
        String fname = filenameOption;
        long rdBeginPos = 0;
    ...
    @Test
    public void testWriteReadSeq_withUpgrade80() throws IOException {
        useFCOption = false;
        positionReadOption = false;
        String fname = filenameOption;
        long rdBeginPos = 0;
    ...
    @Test
    public void testWriteReadPos_withUpgrade20() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testWriteReadPos_withUpgrade40() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        long rdBeginPos = 0;
    ...
    @Test
    public void testWriteReadPos_withUpgrade60() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        long rdBeginPos = 0;
    ...
    @Test
    public void testWriteReadPos_withUpgrade80() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        long rdBeginPos = 0;
    ...
    @Test
    public void testReadPosCurrentBlock_withUpgrade20() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        int wrChunkSize = (int) (blockSize) + (int) (blockSize / 2);
    ...
    @Test
    public void testReadPosCurrentBlock_withUpgrade40() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        int wrChunkSize = (int) (blockSize) + (int) (blockSize / 2);
    ...
    @Test
    public void testReadPosCurrentBlock_withUpgrade60() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        int wrChunkSize = (int) (blockSize) + (int) (blockSize / 2);
    ...
    @Test
    public void testReadPosCurrentBlock_withUpgrade80() throws IOException {
        String fname = filenameOption;
        // position read
        positionReadOption = true;
        int wrChunkSize = (int) (blockSize) + (int) (blockSize / 2);
