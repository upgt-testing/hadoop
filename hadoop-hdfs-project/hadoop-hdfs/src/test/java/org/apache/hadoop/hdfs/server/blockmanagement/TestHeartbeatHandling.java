...
public class TestHeartbeatHandling {
    ...
    public void testHeartbeat() throws Exception {
        ...
        try {
            ...
            final HeartbeatManagerInterface hm = namesystem.getBlockManager().getDatanodeManager().getHeartbeatManager();
    ...
    public void testHeartbeatBlockRecovery() throws Exception {
        ...
        try {
            ...
            final HeartbeatManagerInterface hm = namesystem.getBlockManager().getDatanodeManager().getHeartbeatManager();
            final String poolId = namesystem.getBlockPoolId();
            final DatanodeRegistrationInterface nodeReg1 = InternalDataNodeTestUtils.getDNRegistrationForBP(cluster.getDataNodes().get(0), poolId);
            final DatanodeDescriptorInterface dd1 = NameNodeAdapter.getDatanode(namesystem, nodeReg1);
            dd1.updateStorage(new DatanodeStorage(DatanodeStorage.generateUuid()));
            final DatanodeRegistrationInterface nodeReg2 = InternalDataNodeTestUtils.getDNRegistrationForBP(cluster.getDataNodes().get(1), poolId);
            final DatanodeDescriptorInterface dd2 = NameNodeAdapter.getDatanode(namesystem, nodeReg2);
            dd2.updateStorage(new DatanodeStorage(DatanodeStorage.generateUuid()));
            final DatanodeRegistrationInterface nodeReg3 = InternalDataNodeTestUtils.getDNRegistrationForBP(cluster.getDataNodes().get(2), poolId);
            final DatanodeDescriptorInterface dd3 = NameNodeAdapter.getDatanode(namesystem, nodeReg3);
            ...
            try {
                ...
                synchronized (hm) {
                    ...
                    BlockRecoveryCommandInterface recoveryCommand = (BlockRecoveryCommand) cmds[0];
