...
public class TestSafeMode {
    ...
    public void testManualSafeMode() throws IOException {
        ...
        assertTrue("No datanode is started. Should be in SafeMode", dfs.setSafeMode(SafeModeAction.GET));
        ...
        assertTrue("should still be in SafeMode", dfs.setSafeMode(SafeModeAction.GET));
        assertFalse("should not be in SafeMode", dfs.setSafeMode(SafeModeAction.LEAVE));
    }
   ...
   */
    ...
    public void testSafeModeExceptionText() throws Exception {
        ...
        assertTrue("Could not enter SM", dfs.setSafeMode(SafeModeAction.ENTER));
        cluster.restartNodeForTesting(0);
        try {
    ...
    public void testOperationsWhileInSafeMode() throws IOException, InterruptedException {
        ...
        cluster.restartNodeForTesting(0);
        assertFalse("Could not leave SM", dfs.setSafeMode(SafeModeAction.LEAVE));
    }
