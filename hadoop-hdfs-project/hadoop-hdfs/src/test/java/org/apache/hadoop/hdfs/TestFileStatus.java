...
public class TestFileStatus {
    ...
    public void testGetFileStatusOnFile() throws Exception {
        ...
        assertTrue(file1 + " should have erasure coding unset in " + "FileStatus#toString(): " + status, status.toString().contains("isErasureCoded=false"));
    }
    ...
    @Test
    public void testGetFileInfo_withUpgrade20() throws IOException {
        // Check that / exists
        Path path = new Path("/");
        assertTrue("/ should be a directory", fs.getFileStatus(path).isDirectory());
        ContractTestUtils.assertNotErasureCoded(fs, path);
    ...
    @Test
    public void testGetFileInfo_withUpgrade40() throws IOException {
        // Check that / exists
        Path path = new Path("/");
        assertTrue("/ should be a directory", fs.getFileStatus(path).isDirectory());
        ContractTestUtils.assertNotErasureCoded(fs, path);
    ...
    @Test
    public void testGetFileInfo_withUpgrade60() throws IOException {
        // Check that / exists
        Path path = new Path("/");
        assertTrue("/ should be a directory", fs.getFileStatus(path).isDirectory());
        ContractTestUtils.assertNotErasureCoded(fs, path);
    ...
    @Test
    public void testGetFileInfo_withUpgrade80() throws IOException {
        // Check that / exists
        Path path = new Path("/");
        assertTrue("/ should be a directory", fs.getFileStatus(path).isDirectory());
        ContractTestUtils.assertNotErasureCoded(fs, path);
    ...
    @Test
    public void testGetFileStatusOnFile_withUpgrade20() throws Exception {
        checkFile(fs, file1, 1);
        // test getFileStatus on a file
        FileStatus status = fs.getFileStatus(file1);
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testGetFileStatusOnFile_withUpgrade40() throws Exception {
        checkFile(fs, file1, 1);
        // test getFileStatus on a file
        FileStatus status = fs.getFileStatus(file1);
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testGetFileStatusOnFile_withUpgrade60() throws Exception {
        checkFile(fs, file1, 1);
        // test getFileStatus on a file
        FileStatus status = fs.getFileStatus(file1);
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testGetFileStatusOnFile_withUpgrade80() throws Exception {
        checkFile(fs, file1, 1);
        // test getFileStatus on a file
        FileStatus status = fs.getFileStatus(file1);
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testListStatusOnFile_withUpgrade20() throws IOException {
        FileStatus[] stats = fs.listStatus(file1);
        assertEquals(1, stats.length);
        FileStatus status = stats[0];
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testListStatusOnFile_withUpgrade40() throws IOException {
        FileStatus[] stats = fs.listStatus(file1);
        assertEquals(1, stats.length);
        FileStatus status = stats[0];
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testListStatusOnFile_withUpgrade60() throws IOException {
        FileStatus[] stats = fs.listStatus(file1);
        assertEquals(1, stats.length);
        FileStatus status = stats[0];
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testListStatusOnFile_withUpgrade80() throws IOException {
        FileStatus[] stats = fs.listStatus(file1);
        assertEquals(1, stats.length);
        FileStatus status = stats[0];
        assertFalse(file1 + " should be a file", status.isDirectory());
    ...
    @Test
    public void testGetFileStatusOnNonExistantFileDir_withUpgrade20() throws IOException {
        Path dir = new Path("/test/mkdirs");
        try {
            fs.listStatus(dir);
            fail("listStatus of non-existent path should fail");
    ...
    @Test
    public void testGetFileStatusOnNonExistantFileDir_withUpgrade40() throws IOException {
        Path dir = new Path("/test/mkdirs");
        try {
            fs.listStatus(dir);
            fail("listStatus of non-existent path should fail");
    ...
    @Test
    public void testGetFileStatusOnNonExistantFileDir_withUpgrade60() throws IOException {
        Path dir = new Path("/test/mkdirs");
        try {
            fs.listStatus(dir);
            fail("listStatus of non-existent path should fail");
    ...
    @Test
    public void testGetFileStatusOnNonExistantFileDir_withUpgrade80() throws IOException {
        Path dir = new Path("/test/mkdirs");
        try {
            fs.listStatus(dir);
            fail("listStatus of non-existent path should fail");
    ...
    @Test
    public void testGetFileStatusOnDir_withUpgrade20() throws Exception {
        // Create the directory
        Path dir = new Path("/test/mkdirs");
        assertTrue("mkdir failed", fs.mkdirs(dir));
        assertTrue("mkdir failed", fs.exists(dir));
    ...
    @Test
    public void testGetFileStatusOnDir_withUpgrade40() throws Exception {
        // Create the directory
        Path dir = new Path("/test/mkdirs");
        assertTrue("mkdir failed", fs.mkdirs(dir));
        assertTrue("mkdir failed", fs.exists(dir));
    ...
    @Test
    public void testGetFileStatusOnDir_withUpgrade60() throws Exception {
        // Create the directory
        Path dir = new Path("/test/mkdirs");
        assertTrue("mkdir failed", fs.mkdirs(dir));
        assertTrue("mkdir failed", fs.exists(dir));
    ...
    @Test
    public void testGetFileStatusOnDir_withUpgrade80() throws Exception {
        // Create the directory
        Path dir = new Path("/test/mkdirs");
        assertTrue("mkdir failed", fs.mkdirs(dir));
        assertTrue("mkdir failed", fs.exists(dir));
