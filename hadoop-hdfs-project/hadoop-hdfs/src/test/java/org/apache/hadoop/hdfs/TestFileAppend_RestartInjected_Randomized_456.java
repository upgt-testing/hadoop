 ...
 */
public class TestFileAppend_RestartInjected_Randomized_456 {
    ...
    public void testBreakHardlinksIfNeeded() throws IOException {
        ...
        try {
            ...
            writeFile(stm);
            stm.close();
            RestartFramework.at("after_file_write_close").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSimpleFlush() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_file_creation_simple_flush").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // write to file
            ...
            RestartFramework.at("after_second_flush").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testComplexFlush() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_file_creation_complex_flush").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            int start = 0;
    ...
    public void testAppendTwice() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_full_block_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAppend2Twice() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_full_block_creation_append2").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            //1st append does not add any data so that the last block remains full
            //and the last block in INodeFileUnderConstruction is a BlockInfo
            //but does not have a BlockUnderConstructionFeature.
    ...
    public void testMultipleAppends() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        final MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf, builderBaseDir).numDataNodes(4).build();
        ...
        try {
            ...
            RestartFramework.at("after_empty_file_creation").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            int fileLen = 0;
    ...
    public void testAppendAfterSoftLimit() throws IOException, InterruptedException {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf, builderBaseDir).numDataNodes(1).build();
        ...
        RestartFramework.at("after_file_write_soft_limit").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAppend2AfterSoftLimit() throws Exception {
        ...
        FSDataOutputStream out = fs.create(testPath);
        out.write(fileContents);
        RestartFramework.at("after_file_write_soft_limit_append2").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        //Wait for > soft-limit
        Thread.sleep(250);
        try {
    ...
    public void testFailedAppendBlockRejection() throws Exception {
        ...
        try {
            ...
            out.close();
            RestartFramework.at("after_initial_file_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // stop one datanode
    ...
    public void testMultiAppend2() throws Exception {
        ...
        try {
            ...
            out.writeBytes(hello);
            out.close();
            RestartFramework.at("after_initial_file_creation_multi_append2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // stop one datanode
            DataNodeProperties dnProp = cluster.stopDataNode(0);
            String dnAddress = dnProp.datanode.getXferAddress().toString();
            if (dnAddress.startsWith("/")) {
    ...
    public void testAppendCorruptedBlock() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_file_creation_before_corruption").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testConcurrentAppendRead() throws IOException, TimeoutException, InterruptedException {
        ...
        try {
            ...
            DFSTestUtil.waitReplication(fs, fileName, (short) 1);
            Assert.assertTrue("File not created", fs.exists(fileName));
            RestartFramework.at("after_file_creation_concurrent_append").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
