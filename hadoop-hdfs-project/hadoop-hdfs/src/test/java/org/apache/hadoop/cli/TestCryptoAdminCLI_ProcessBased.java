...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestCryptoAdminCLI}.
 *
...
public class TestCryptoAdminCLI_ProcessBased extends CLITestHelperDFS {
  ...
  private void createAKey(String keyName, Configuration conf)
    ...
    // Use client-side KeyProvider API instead of server-side NameNode access
    final KeyProvider provider = ((DistributedFileSystem) fs).getKeyProvider();
