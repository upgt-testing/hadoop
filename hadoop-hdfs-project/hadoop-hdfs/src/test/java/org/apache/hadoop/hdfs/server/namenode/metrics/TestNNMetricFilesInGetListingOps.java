...
public class TestNNMetricFilesInGetListingOps {
    ...
    @Test
    public void testFilesInGetListingOps_withUpgrade20() throws Exception {
        createFile("/tmp1/t1", 3200, (short) 3);
        createFile("/tmp1/t2", 3200, (short) 3);
        createFile("/tmp2/t1", 3200, (short) 3);
    ...
    @Test
    public void testFilesInGetListingOps_withUpgrade40() throws Exception {
        createFile("/tmp1/t1", 3200, (short) 3);
        createFile("/tmp1/t2", 3200, (short) 3);
        createFile("/tmp2/t1", 3200, (short) 3);
        createFile("/tmp2/t2", 3200, (short) 3);
    ...
    @Test
    public void testFilesInGetListingOps_withUpgrade60() throws Exception {
        createFile("/tmp1/t1", 3200, (short) 3);
        createFile("/tmp1/t2", 3200, (short) 3);
        createFile("/tmp2/t1", 3200, (short) 3);
        createFile("/tmp2/t2", 3200, (short) 3);
    ...
    @Test
    public void testFilesInGetListingOps_withUpgrade80() throws Exception {
        createFile("/tmp1/t1", 3200, (short) 3);
        createFile("/tmp1/t2", 3200, (short) 3);
        createFile("/tmp2/t1", 3200, (short) 3);
        createFile("/tmp2/t2", 3200, (short) 3);
