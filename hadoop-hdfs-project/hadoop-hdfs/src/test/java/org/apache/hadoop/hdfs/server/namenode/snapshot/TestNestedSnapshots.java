...
public class TestNestedSnapshots {
    ...
    @Test(timeout = 300000)
    public void testNestedSnapshots_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path foo = new Path("/testNestedSnapshots/foo");
        final Path bar = new Path(foo, "bar");
        final Path file1 = new Path(bar, "file1");
    ...
    @Test(timeout = 300000)
    public void testNestedSnapshots_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path foo = new Path("/testNestedSnapshots/foo");
        final Path bar = new Path(foo, "bar");
        final Path file1 = new Path(bar, "file1");
    ...
    @Test(timeout = 300000)
    public void testNestedSnapshots_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path foo = new Path("/testNestedSnapshots/foo");
        final Path bar = new Path(foo, "bar");
        final Path file1 = new Path(bar, "file1");
    ...
    @Test(timeout = 300000)
    public void testNestedSnapshots_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path foo = new Path("/testNestedSnapshots/foo");
        final Path bar = new Path(foo, "bar");
        final Path file1 = new Path(bar, "file1");
    ...
    @Test
    public void testDisallowNestedSnapshottableDir_withUpgrade20() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path dir = new Path("/dir");
        final Path sub = new Path(dir, "sub");
        hdfs.mkdirs(sub);
    ...
    @Test
    public void testDisallowNestedSnapshottableDir_withUpgrade40() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path dir = new Path("/dir");
        final Path sub = new Path(dir, "sub");
        hdfs.mkdirs(sub);
    ...
    @Test
    public void testDisallowNestedSnapshottableDir_withUpgrade60() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path dir = new Path("/dir");
        final Path sub = new Path(dir, "sub");
        hdfs.mkdirs(sub);
    ...
    @Test
    public void testDisallowNestedSnapshottableDir_withUpgrade80() throws Exception {
        cluster.getNamesystem().getSnapshotManager().setAllowNestedSnapshots(true);
        final Path dir = new Path("/dir");
        final Path sub = new Path(dir, "sub");
        hdfs.mkdirs(sub);
