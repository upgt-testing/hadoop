...
public class TestErasureCodingExerciseAPIs {
    ...
    public void setupCluster() throws IOException {
        ...
        String testRootDir = Paths.get(new FileSystemTestHelper().getTestRootDir()).toString();
        Path targetFile = new Path(new File(testRootDir).getAbsolutePath(), "test.jks");
        String keyProviderURI = JavaKeyStoreProvider.SCHEME_NAME + "://file" + targetFile.toUri();
        conf.set(CommonConfigurationKeysPublic.HADOOP_SECURITY_KEY_PROVIDER_PATH, keyProviderURI);
    ...
    @Test
    public void testEncryptionZone_withUpgrade20() throws IOException, NoSuchAlgorithmException {
        final Path zoneRoot = new Path("ecRoot");
        final Path zonePath = new Path(zoneRoot, "/ec");
        fsWrapper.mkdir(zonePath, FsPermission.getDirDefault(), true);
        final String testKey = "test_key";
    ...
    @Test
    public void testEncryptionZone_withUpgrade40() throws IOException, NoSuchAlgorithmException {
        final Path zoneRoot = new Path("ecRoot");
        final Path zonePath = new Path(zoneRoot, "/ec");
        fsWrapper.mkdir(zonePath, FsPermission.getDirDefault(), true);
        final String testKey = "test_key";
    ...
    @Test
    public void testEncryptionZone_withUpgrade60() throws IOException, NoSuchAlgorithmException {
        final Path zoneRoot = new Path("ecRoot");
        final Path zonePath = new Path(zoneRoot, "/ec");
        fsWrapper.mkdir(zonePath, FsPermission.getDirDefault(), true);
        final String testKey = "test_key";
    ...
    @Test
    public void testEncryptionZone_withUpgrade80() throws IOException, NoSuchAlgorithmException {
        final Path zoneRoot = new Path("ecRoot");
        final Path zonePath = new Path(zoneRoot, "/ec");
        fsWrapper.mkdir(zonePath, FsPermission.getDirDefault(), true);
        final String testKey = "test_key";
