...
public class TestGenericJournalConf_RestartInjected_Randomized_456 {
    ...
    public void testDummyJournalManager() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_journal_verification").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
