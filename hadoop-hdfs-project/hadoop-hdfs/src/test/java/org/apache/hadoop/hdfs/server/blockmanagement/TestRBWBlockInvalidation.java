...
public class TestRBWBlockInvalidation {
   ...
   */
    ...
    public void testRWRShouldNotAddedOnDNRestart() throws Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build()) {
    ...
    private void waitForNumTotalBlocks(final MiniDFSClusterInJVM cluster, final int numTotalBlocks) throws Exception {
    ...
    @Test(timeout = 120000)
    public void testRWRInvalidation_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // space)
        conf.setClass(DFSConfigKeys.DFS_BLOCK_REPLICATOR_CLASSNAME_KEY, RandomDeleterPolicy.class, BlockPlacementPolicy.class);
        // Speed up the test a bit with faster heartbeats.
    ...
    @Test(timeout = 120000)
    public void testRWRInvalidation_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // space)
        conf.setClass(DFSConfigKeys.DFS_BLOCK_REPLICATOR_CLASSNAME_KEY, RandomDeleterPolicy.class, BlockPlacementPolicy.class);
        // Speed up the test a bit with faster heartbeats.
    ...
    @Test(timeout = 120000)
    public void testRWRInvalidation_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // space)
        conf.setClass(DFSConfigKeys.DFS_BLOCK_REPLICATOR_CLASSNAME_KEY, RandomDeleterPolicy.class, BlockPlacementPolicy.class);
        // Speed up the test a bit with faster heartbeats.
    ...
    @Test(timeout = 120000)
    public void testRWRInvalidation_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // space)
        conf.setClass(DFSConfigKeys.DFS_BLOCK_REPLICATOR_CLASSNAME_KEY, RandomDeleterPolicy.class, BlockPlacementPolicy.class);
        // Speed up the test a bit with faster heartbeats.
    ...
    @Test
    public void testRWRShouldNotAddedOnDNRestart_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build()) {
            Path path = new Path("/testRBW");
    ...
    @Test
    public void testRWRShouldNotAddedOnDNRestart_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build()) {
            Path path = new Path("/testRBW");
    ...
    @Test
    public void testRWRShouldNotAddedOnDNRestart_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build()) {
            Path path = new Path("/testRBW");
    ...
    @Test
    public void testRWRShouldNotAddedOnDNRestart_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set("dfs.client.block.write.replace-datanode-on-failure.enable", "false");
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build()) {
            Path path = new Path("/testRBW");
