...
public class TestRBWBlockInvalidation {
    ...
    public void testRWRShouldNotAddedOnDNRestart() throws Exception {
        ...
        try (MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(2).build()) {
    ...
    private void waitForNumTotalBlocks(final MiniDockerDFSCluster cluster, final int numTotalBlocks) throws Exception {
