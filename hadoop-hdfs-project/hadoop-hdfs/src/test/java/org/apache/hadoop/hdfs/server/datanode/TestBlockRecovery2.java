...
public class TestBlockRecovery2 {
    ...
    public void testRaceBetweenReplicaRecoveryAndFinalizeBlock() throws Exception {
        ...
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(configuration).numDataNodes(1).build();
        try {
    ...
    public void testRecoveryWillIgnoreMinReplication() throws Exception {
        ...
        try {
            cluster = new MiniDockerDFSCluster.Builder(configuration).numDataNodes(5).build();
            cluster.waitActive();
            ...
            for (DatanodeInfoInterface dataNode : dataNodes.subList(0, numReplicas - 1)) {
