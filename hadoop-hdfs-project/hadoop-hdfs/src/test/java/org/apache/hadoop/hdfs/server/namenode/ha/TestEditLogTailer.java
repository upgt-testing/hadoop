...
public class TestEditLogTailer {
    ...
    public void testTailerBackoff() throws Exception {
        ...
        // seconds
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        conf.setTimeDuration(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_BACKOFF_MAX_KEY, 10, TimeUnit.SECONDS);
        ...
        List<Long> expectedDurations = Arrays.asList(2000L, 4000L, 8000L, 10000L, 10000L, 1000L);
  ...
  */
    ...
    public void testRollEditLogIOExceptionForRemoteNN() throws IOException {
        ...
        try {
            cluster = createMiniDFSCluster(conf, 3);
            cluster.transitionToActive(0);
            EditLogTailerJVMInterface tailer = Mockito.spy(cluster.getNamesystem(1).getEditLogTailer());
    ...
    public void testStandbyTriggersLogRollsWhenTailInProgressEdits() throws Exception {
        ...
        Configuration conf = getConf();
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, standbyCatchupWaitTime + noLogRollWaitTime + 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        conf.setBoolean(DFSConfigKeys.DFS_HA_TAILEDITS_INPROGRESS_KEY, true);
        MiniDFSClusterInJVM cluster = createMiniDFSCluster(conf, 2);
        if (cluster == null) {
            fail("failed to start mini cluster.");
        }
        try {
            ...
            cluster.transitionToActive(activeIndex);
            NameNodeJVMInterface active = cluster.getNameNode(activeIndex);
            NameNodeJVMInterface standby = cluster.getNameNode(standbyIndex);
    ...
    private static MiniDFSClusterInJVM createMiniDFSCluster(Configuration conf, int nnCount) throws IOException {
    ...
    @Test
    public void testTriggersLogRollsForAllStandbyNN_withUpgrade20() throws Exception {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testTriggersLogRollsForAllStandbyNN_withUpgrade40() throws Exception {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testTriggersLogRollsForAllStandbyNN_withUpgrade60() throws Exception {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testTriggersLogRollsForAllStandbyNN_withUpgrade80() throws Exception {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testRollEditLogIOExceptionForRemoteNN_withUpgrade20() throws IOException {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testRollEditLogIOExceptionForRemoteNN_withUpgrade40() throws IOException {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testRollEditLogIOExceptionForRemoteNN_withUpgrade60() throws IOException {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testRollEditLogIOExceptionForRemoteNN_withUpgrade80() throws IOException {
        Configuration conf = getConf();
        // Roll every 1s
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
    ...
    @Test
    public void testStandbyTriggersLogRollsWhenTailInProgressEdits_withUpgrade20() throws Exception {
        // Time in seconds to wait for standby to catch up to edits from active
        final int standbyCatchupWaitTime = 2;
        // expecting no edit log roll
        final int noLogRollWaitTime = 2;
    ...
    @Test
    public void testStandbyTriggersLogRollsWhenTailInProgressEdits_withUpgrade40() throws Exception {
        // Time in seconds to wait for standby to catch up to edits from active
        final int standbyCatchupWaitTime = 2;
        // expecting no edit log roll
        final int noLogRollWaitTime = 2;
    ...
    @Test
    public void testStandbyTriggersLogRollsWhenTailInProgressEdits_withUpgrade60() throws Exception {
        // Time in seconds to wait for standby to catch up to edits from active
        final int standbyCatchupWaitTime = 2;
        // expecting no edit log roll
        final int noLogRollWaitTime = 2;
    ...
    @Test
    public void testStandbyTriggersLogRollsWhenTailInProgressEdits_withUpgrade80() throws Exception {
        // Time in seconds to wait for standby to catch up to edits from active
        final int standbyCatchupWaitTime = 2;
        // expecting no edit log roll
        final int noLogRollWaitTime = 2;
