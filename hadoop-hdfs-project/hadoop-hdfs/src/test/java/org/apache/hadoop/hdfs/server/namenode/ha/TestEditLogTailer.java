...
public class TestEditLogTailer {
    ...
    private static void testStandbyTriggersLogRolls(int activeIndex) throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            try {
                cluster = createMiniDFSClusterInJVM(conf, 3);
                break;
   ...
   */
    ...
    public void testStandbyTriggersLogRollsWhenTailInProgressEdits() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = createMiniDFSClusterInJVM(conf, 2);
        if (cluster == null) {
            fail("failed to start mini cluster.");
        }
        try {
    ...
    private static MiniDFSClusterInJVM createMiniDFSClusterInJVM(Configuration conf, int nnCount) throws IOException {
