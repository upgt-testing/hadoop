...
public class TestDataNodeUUID_RestartInjected_Randomized_123 {
    ...
    public void testUUIDRegeneration() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_uuid_retrieval").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_disk_wipe").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_registration_complete").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
