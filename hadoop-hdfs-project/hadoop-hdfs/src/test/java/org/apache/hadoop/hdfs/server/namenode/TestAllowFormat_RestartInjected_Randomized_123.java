 ...
 */
public class TestAllowFormat_RestartInjected_Randomized_123 {

    public static final String NAME_NODE_HOST = "localhost:";

    public static final String NAME_NODE_HTTP_HOST = "0.0.0.0:";

    private static final Logger LOG = LoggerFactory.getLogger(TestAllowFormat_RestartInjected.class.getName());

    private static final File DFS_BASE_DIR = new File(PathUtils.getTestDir(TestAllowFormat_RestartInjected.class), "dfs");
