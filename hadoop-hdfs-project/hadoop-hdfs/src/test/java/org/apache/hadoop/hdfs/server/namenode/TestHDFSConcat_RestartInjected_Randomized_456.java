...
public class TestHDFSConcat_RestartInjected_Randomized_456 {
    ...
    public void testConcat() throws IOException, InterruptedException {
        ...
        RestartFramework.at("after_source_files_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_target_file_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        stm.readFully(0, byteFileConcat);
        stm.close();
        RestartFramework.at("after_concat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_small_file_concat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testConcatInEditLog() throws Exception {
        ...
        RestartFramework.at("before_concat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testIllegalArg() throws IOException {
        ...
        // must be in the same dir
        {
            ...
            RestartFramework.at("after_first_src_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            try {
        ...
        // the source file's preferred block size cannot be greater than the target
        {
            ...
            RestartFramework.at("after_second_src_set_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            try {
    ...
    public void testConcatWithQuotaDecrease() throws IOException {
        ...
        RestartFramework.at("after_target_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Assert.assertEquals(11, summary.getFileCount());
        RestartFramework.at("after_quota_set").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_concat").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testConcatWithQuotaIncrease() throws IOException {
        ...
        RestartFramework.at("after_quota_increase").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Assert.assertEquals(11, summary.getFileCount());
    ...
    public void testConcatRelativeTargetPath() throws IOException {
        ...
        RestartFramework.at("after_files_creation").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testConcatOnSameFile() throws Exception {
        ...
        // perform concat
        LambdaTestUtils.intercept(RemoteException.class, "concat: the src file /dir1/file1 is the same with the target" + " file /dir1/file1", () -> dfs.concat(srcs[0], srcs));
