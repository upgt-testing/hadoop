...
public class TestDeleteRace_RestartInjected {
  ...
  private void testDeleteAddBlockRace(boolean hasSnapshot) throws Exception {
    try {
      ...
      RestartFramework.at("after_delete_thread_start")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameRace() throws Exception {
    try {
      ...
      RestartFramework.at("after_rename_thread_start")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  private void testDeleteAndCommitBlockSynchronizationRace(boolean hasSnapshot)
    ...
    try {
      ...
      for(AbstractMap.SimpleImmutableEntry<String, Boolean> stest : testList) {
        ...
        RestartFramework.at("after_file_creation_in_loop")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_hflush_in_loop")
            .on(cluster)
            .restart("datanode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        if (hasSnapshot) {
          ...
          RestartFramework.at("after_snapshot_creation_in_loop")
              .on(cluster)
              .restart("namenode")
              .withIndex(0)
              .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_lease_recovery_in_loop")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_delete_in_loop")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteAndLeaseRecoveryHardLimitSnapshot() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_block_write")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDeleteOnSnapshottableDir() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_directory_snapshot_allowed")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_failed_delete")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file1_and_snapshot_s1")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file2_and_snapshot_s2")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_subdirectory_creation")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
