 ...
 */
public class TestViewFsLinkFallback_RestartInjected {
  ...
  public void testMkdirOfLinkParentWithFallbackLinkWithSameMountDirectoryTree()
    ...
    RestartFramework.at("after_mkdir_in_fallback")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
  ...
  public void testMkdirOfNewDirWithOutMatchingToMountOrFallbackDirTree()
    ...
    RestartFramework.at("after_mkdir_new_dir")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetDelegationToken() throws IOException {
    ...
    RestartFramework.at("after_get_delegation_tokens")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirWithFallbackLinkWithMountPathMatchingDirExist()
    ...
    RestartFramework.at("after_mkdir_mount_path_matching")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirOfDeepTreeWithFallbackLinkAndMountPathMatchingDirExist()
    ...
    RestartFramework.at("after_mkdir_deep_tree")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirShouldCreateParentDirInFallbackWhenMountDirExist()
    ...
    RestartFramework.at("after_mkdir_create_parent")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMkdirShouldFailWhenFallbackFSNotAvailable()
    ...
    try {
      ...
      RestartFramework.at("after_mkdir_namenode_recovery")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateFileOnInternalMountDirWithSameDirTreeExistInFallback()
    ...
    RestartFramework.at("after_create_file_in_fallback")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateNewFileWithOutMatchingToMountDirOrFallbackDirPath()
    ...
    RestartFramework.at("after_create_new_file")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCreateFileOnRootWithFallbackEnabled()
    ...
    RestartFramework.at("after_create_file_on_root")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListFiles() throws Exception {
    ...
    RestartFramework.at("before_list_files")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameOnInternalDirWithFallback() throws Exception {
    ...
    RestartFramework.at("after_fourth_rename")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_fifth_rename")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenameWhenDstOnInternalDirWithFallback() throws Exception {
    ...
    RestartFramework.at("after_rename_to_internal_dir")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
