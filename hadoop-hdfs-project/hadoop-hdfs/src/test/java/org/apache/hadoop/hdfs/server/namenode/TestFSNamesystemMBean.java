...
public class TestFSNamesystemMBean {
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            Map<String, Object> stat = (Map<String, Object>) JSON.parse(snapshotStats);
            /*
    ...
    @Test
    public void test_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void test_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void test_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void test_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testWithFSNamesystemWriteLock_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSNamesystemJVMInterface fsn = null;
        int jmxCachePeriod = 1;
    ...
    @Test
    public void testWithFSNamesystemWriteLock_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSNamesystemJVMInterface fsn = null;
        int jmxCachePeriod = 1;
    ...
    @Test
    public void testWithFSNamesystemWriteLock_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSNamesystemJVMInterface fsn = null;
        int jmxCachePeriod = 1;
    ...
    @Test
    public void testWithFSNamesystemWriteLock_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        FSNamesystemJVMInterface fsn = null;
        int jmxCachePeriod = 1;
    ...
    @Test
    public void testWithFSEditLogLock_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        int jmxCachePeriod = 1;
        new ConfigBuilder().add("namenode.period", jmxCachePeriod).save(TestMetricsConfig.getTestFilename("hadoop-metrics2-namenode"));
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testWithFSEditLogLock_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        int jmxCachePeriod = 1;
        new ConfigBuilder().add("namenode.period", jmxCachePeriod).save(TestMetricsConfig.getTestFilename("hadoop-metrics2-namenode"));
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test
    public void testWithFSEditLogLock_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        int jmxCachePeriod = 1;
        new ConfigBuilder().add("namenode.period", jmxCachePeriod).save(TestMetricsConfig.getTestFilename("hadoop-metrics2-namenode"));
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testFsEditLogMetrics_withUpgrade20() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test(timeout = 120000)
    public void testFsEditLogMetrics_withUpgrade40() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test(timeout = 120000)
    public void testFsEditLogMetrics_withUpgrade60() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
    ...
    @Test(timeout = 120000)
    public void testFsEditLogMetrics_withUpgrade80() throws Exception {
        final Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
