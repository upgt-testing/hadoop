 ...
 */
public class TestSWebHdfsFileContextMainOperations_RestartInjected
  ...
  private static final String BASEDIR = GenericTestUtils
      .getTempPath(TestSWebHdfsFileContextMainOperations_RestartInjected.class.getSimpleName());
  ...
  public static void clusterSetupAtBeginning()
    ...
    try {
      sslConfDir = KeyStoreTestUtil
          .getClasspathDir(TestSWebHdfsFileContextMainOperations_RestartInjected.class);
