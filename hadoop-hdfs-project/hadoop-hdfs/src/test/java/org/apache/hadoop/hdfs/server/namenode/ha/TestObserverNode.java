...
public class TestObserverNode {
    ...
    public void testObserverNodeSafeModeWithBlockLocations() throws Exception {
        ...
        BlockManagerInterface bmSpy = NameNodeAdapter.spyOnBlockManager(dfsCluster.getNameNode(2));
        doAnswer((invocation) -> {
    ...
    public void testMkdirsRaceWithObserverRead() throws Exception {
        ...
        FSEditLogInterface spyEditLog = NameNodeAdapter.spyDelayMkDirTransaction(dfsCluster.getNameNode(0), 100);
