...
public class TestTransferFsImage_RestartInjected_Randomized_123 {

    private static final File TEST_DIR = PathUtils.getTestDir(TestTransferFsImage_RestartInjected.class);
