...
public class TestDFSAdmin_RestartInjected {
  ...
  public void testGetDatanodeInfo() throws Exception {
    ...
    RestartFramework.at("after_get_datanode_info")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
  ...
  public void testTriggerBlockReport() throws Exception {
    ...
    RestartFramework.at("after_trigger_block_report")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetVolumeReport() throws Exception {
    ...
    RestartFramework.at("after_get_volume_report")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDFSAdminUnreachableDatanode() throws Exception {
    ...
    RestartFramework.at("after_datanode_stop")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataNodeGetReconfigurableProperties() throws IOException, InterruptedException {
    ...
    RestartFramework.at("after_get_reconfigurable_properties")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataNodeGetReconfigurationStatus() throws IOException,
    ...
    RestartFramework.at("after_get_reconfiguration_status")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testPrintTopology() throws Exception {
    ...
    try (MiniDFSCluster miniCluster = new MiniDFSCluster.Builder(dfsConf)
      ...
      RestartFramework.at("after_print_topology")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testPrintTopologyWithStatus() throws Exception {
    ...
    try (MiniDFSCluster miniCluster = new MiniDFSCluster.Builder(dfsConf)
      ...
      RestartFramework.at("after_print_topology_with_status")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testReportCommand() throws Exception {
    ...
    try(MiniDFSCluster miniCluster = new MiniDFSCluster
      ...
      RestartFramework.at("after_report_command")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testListOpenFiles() throws Exception {
    ...
    try(MiniDFSCluster miniCluster = new MiniDFSCluster
      ...
      RestartFramework.at("after_list_open_files")
          .on(miniCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRefreshProxyUser() throws Exception {
    ...
    RestartFramework.at("after_refresh_proxy_user")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAllDatanodesReconfig()
    ...
    RestartFramework.at("after_datanode_reconfig")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
