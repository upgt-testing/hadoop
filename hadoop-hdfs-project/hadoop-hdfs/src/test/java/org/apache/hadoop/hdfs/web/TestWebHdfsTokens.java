...
public class TestWebHdfsTokens {
    ...
    private static void initSecureConf(Configuration secureConf) throws Exception {
        baseDir = GenericTestUtils.getTestDir(TestWebHdfsTokens.class.getSimpleName());
        FileUtil.fullyDelete(baseDir);
    ...
    @Test
    public void testLazyTokenFetchForWebhdfs_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        UserGroupInformation ugi = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testLazyTokenFetchForWebhdfs_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        UserGroupInformation ugi = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testLazyTokenFetchForWebhdfs_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        UserGroupInformation ugi = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testLazyTokenFetchForWebhdfs_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        UserGroupInformation ugi = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testSetTokenServiceAndKind_withUpgrade20() throws Exception {
        initEnv();
        MiniDFSClusterInJVM cluster = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testSetTokenServiceAndKind_withUpgrade40() throws Exception {
        initEnv();
        MiniDFSClusterInJVM cluster = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testSetTokenServiceAndKind_withUpgrade60() throws Exception {
        initEnv();
        MiniDFSClusterInJVM cluster = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
    ...
    @Test
    public void testSetTokenServiceAndKind_withUpgrade80() throws Exception {
        initEnv();
        MiniDFSClusterInJVM cluster = null;
        try {
            final Configuration clusterConf = new HdfsConfiguration(conf);
