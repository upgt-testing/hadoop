...
public class TestStartSecureDataNode {
    ...
    public void testStreamingAddrBindException() throws Exception {
        ...
        try {
            ...
            Configuration conf = new HdfsConfiguration();
            conf.set(DFSConfigKeys.DFS_DATANODE_ADDRESS_KEY, "localhost:" + ss.getLocalPort());
    ...
    @Test
    public void testSecureNameNode_withUpgrade20() throws Exception {
        testExternalKdcRunning();
        MiniDFSClusterInJVM cluster = null;
        try {
            String nnPrincipal = System.getProperty("dfs.namenode.kerberos.principal");
    ...
    @Test
    public void testSecureNameNode_withUpgrade40() throws Exception {
        testExternalKdcRunning();
        MiniDFSClusterInJVM cluster = null;
        try {
            String nnPrincipal = System.getProperty("dfs.namenode.kerberos.principal");
    ...
    @Test
    public void testSecureNameNode_withUpgrade60() throws Exception {
        testExternalKdcRunning();
        MiniDFSClusterInJVM cluster = null;
        try {
            String nnPrincipal = System.getProperty("dfs.namenode.kerberos.principal");
    ...
    @Test
    public void testSecureNameNode_withUpgrade80() throws Exception {
        testExternalKdcRunning();
        MiniDFSClusterInJVM cluster = null;
        try {
            String nnPrincipal = System.getProperty("dfs.namenode.kerberos.principal");
