...
/**
 * This test starts a 1 NameNode 1 DataNode MiniDockerDFSCluster with
...
public class TestStartSecureDataNode {
    ...
    public void testSecureNameNode() throws Exception {
        ...
        try {
            ...
            cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(NUM_OF_DATANODES).checkDataNodeAddrConfig(true).build();
            cluster.waitActive();
