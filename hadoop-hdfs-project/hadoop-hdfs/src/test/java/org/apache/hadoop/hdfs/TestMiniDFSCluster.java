...
import org.apache.hadoop.hdfs.MiniDFSClusterInJVM.NameNodeInfo;
...
public class TestMiniDFSCluster {
    ...
    public void testClusterWithoutSystemProperties() throws Throwable {
        String oldPrp = System.getProperty(MiniDFSClusterInJVM.PROP_TEST_BUILD_DATA);
        System.clearProperty(MiniDFSClusterInJVM.PROP_TEST_BUILD_DATA);
        Configuration conf = new HdfsConfiguration();
        File testDataCluster1 = new File(testDataPath, CLUSTER_1);
        String c1Path = testDataCluster1.getAbsolutePath();
        conf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, c1Path);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            ...
            if (oldPrp != null) {
                System.setProperty(MiniDFSClusterInJVM.PROP_TEST_BUILD_DATA, oldPrp);
            }
        }
    }
    ...
    public void testClusterSetStorageCapacity() throws Throwable {
        ...
        final MiniDFSClusterInJVM cluster = newCluster(conf, numDatanodes, capacities, defaultBlockSize, fileLen);
        try {
    ...
    private void verifyStorageCapacity(final MiniDFSClusterInJVM cluster, final long[] capacities) throws IOException {
        FsVolumeImpl source = null;
        FsVolumeImpl dest = null;
        /* verify capacity */
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            final DataNodeJVMInterface dnNode = cluster.getDataNodes().get(i);
            try (FsVolumeReferencesJVMInterface refs = dnNode.getFSDataset().getFsVolumeReferences()) {
    ...
    private MiniDFSClusterInJVM newCluster(final Configuration conf, final int numDatanodes, final long[] storageCapacities, final int defaultBlockSize, final int fileLen) throws IOException, InterruptedException, TimeoutException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).storageCapacities(storageCapacities).storageTypes(new StorageType[] { StorageType.DISK, StorageType.DISK }).storagesPerDatanode(2).build();
        cluster.waitActive();
    ...
    public void testIsClusterUpAfterShutdown() throws Throwable {
        ...
        MiniDFSClusterInJVM cluster4 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster4).build();
        try {
    ...
    /**
     * MiniDFSClusterInJVM should not clobber dfs.datanode.hostname if requested
     */
    @Test(timeout = 100000)
    public void testClusterSetDatanodeHostname() throws Throwable {
        ...
        try (MiniDFSClusterInJVM cluster5 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster5).numDataNodes(1).checkDataNodeHostConfig(true).build()) {
    ...
    public void testClusterSetDatanodeDifferentStorageType() throws IOException {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(storageType).build()) {
            cluster.waitActive();
    ...
    public void testSetUpFederatedCluster() throws Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(2).build()) {
            cluster.waitActive();
    ...
    public void testStartStopWithPorts() throws Exception {
        Configuration conf = new Configuration();
        LambdaTestUtils.intercept(IllegalArgumentException.class, "Num of http ports (1) should match num of DataNodes (3)", "MiniJournalCluster port validation failed", () -> {
            new MiniDFSCluster.Builder(conf).numDataNodes(3).setDnHttpPorts(8481).build();
        });
        LambdaTestUtils.intercept(IllegalArgumentException.class, "Num of ipc ports (2) should match num of DataNodes (1)", "MiniJournalCluster port validation failed", () -> {
            new MiniDFSCluster.Builder(conf).setDnIpcPorts(8481, 8482).build();
        });
        LambdaTestUtils.intercept(IllegalArgumentException.class, "Num of ipc ports (1) should match num of DataNodes (3)", "MiniJournalCluster port validation failed", () -> {
            new MiniDFSCluster.Builder(conf).numDataNodes(3).setDnHttpPorts(800, 9000, 10000).setDnIpcPorts(8481).build();
        });
        LambdaTestUtils.intercept(IllegalArgumentException.class, "Num of http ports (4) should match num of DataNodes (3)", "MiniJournalCluster port validation failed", () -> {
            new MiniDFSCluster.Builder(conf).setDnHttpPorts(800, 9000, 1000, 2000).setDnIpcPorts(8481, 8482, 8483).numDataNodes(3).build();
        });
        ...
        try (MiniDFSCluster miniDfsCluster = new MiniDFSCluster.Builder(conf).setDnHttpPorts(httpPorts).setDnIpcPorts(ipcPorts).numDataNodes(3).build()) {
            miniDfsCluster.waitActive();
            assertEquals(httpPorts[0], miniDfsCluster.getDataNode(ipcPorts[0]).getInfoPort());
            assertEquals(httpPorts[1], miniDfsCluster.getDataNode(ipcPorts[1]).getInfoPort());
            assertEquals(httpPorts[2], miniDfsCluster.getDataNode(ipcPorts[2]).getInfoPort());
            assertEquals(ipcPorts[0], miniDfsCluster.getDataNode(ipcPorts[0]).getIpcPort());
            assertEquals(ipcPorts[1], miniDfsCluster.getDataNode(ipcPorts[1]).getIpcPort());
            assertEquals(ipcPorts[2], miniDfsCluster.getDataNode(ipcPorts[2]).getIpcPort());
        }
    }

    @Test(timeout = 100000)
    public void testClusterWithoutSystemProperties_withUpgrade20() throws Throwable {
        String oldPrp = System.getProperty(MiniDFSClusterInJVM.PROP_TEST_BUILD_DATA);
        System.clearProperty(MiniDFSClusterInJVM.PROP_TEST_BUILD_DATA);
        Configuration conf = new HdfsConfiguration();
        File testDataCluster1 = new File(testDataPath, CLUSTER_1);
    ...
    @Test(timeout = 100000)
    public void testClusterSetStorageCapacity_withUpgrade20() throws Throwable {
        final Configuration conf = new HdfsConfiguration();
        final int numDatanodes = 1;
        final int defaultBlockSize = 1024;
        final int blocks = 100;
    ...
    @Test(timeout = 100000)
    public void testClusterSetStorageCapacity_withUpgrade40() throws Throwable {
        final Configuration conf = new HdfsConfiguration();
        final int numDatanodes = 1;
        final int defaultBlockSize = 1024;
        final int blocks = 100;
    ...
    @Test(timeout = 100000)
    public void testClusterSetStorageCapacity_withUpgrade60() throws Throwable {
        final Configuration conf = new HdfsConfiguration();
        final int numDatanodes = 1;
        final int defaultBlockSize = 1024;
        final int blocks = 100;
    ...
    @Test(timeout = 100000)
    public void testClusterSetStorageCapacity_withUpgrade80() throws Throwable {
        final Configuration conf = new HdfsConfiguration();
        final int numDatanodes = 1;
        final int defaultBlockSize = 1024;
        final int blocks = 100;
    ...
    @Test(timeout = 100000)
    public void testIsClusterUpAfterShutdown_withUpgrade20() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        File testDataCluster4 = new File(testDataPath, CLUSTER_4);
        MiniDFSClusterInJVM cluster4 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster4).build();
        try {
            DistributedFileSystem dfs = cluster4.getFileSystem();
            cluster4.restartNodeForTesting(0);
            cluster4.upgradeNodeForTesting(0);
            dfs.setSafeMode(HdfsConstants.SafeModeAction.SAFEMODE_ENTER);
            cluster4.shutdown();
        } finally {
            while (cluster4.isClusterUp()) {
    ...
    @Test(timeout = 100000)
    public void testIsClusterUpAfterShutdown_withUpgrade40() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        File testDataCluster4 = new File(testDataPath, CLUSTER_4);
        MiniDFSClusterInJVM cluster4 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster4).build();
        try {
    ...
    @Test(timeout = 100000)
    public void testIsClusterUpAfterShutdown_withUpgrade60() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        File testDataCluster4 = new File(testDataPath, CLUSTER_4);
        MiniDFSClusterInJVM cluster4 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster4).build();
        try {
    ...
    @Test(timeout = 100000)
    public void testIsClusterUpAfterShutdown_withUpgrade80() throws Throwable {
        Configuration conf = new HdfsConfiguration();
        File testDataCluster4 = new File(testDataPath, CLUSTER_4);
        MiniDFSClusterInJVM cluster4 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster4).build();
        try {
    ...
    @Test(timeout = 100000)
    public void testClusterSetDatanodeHostname_withUpgrade20() throws Throwable {
        assumeTrue(System.getProperty("os.name").startsWith("Linux"));
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_DATANODE_HOST_NAME_KEY, "MYHOST");
        File testDataCluster5 = new File(testDataPath, CLUSTER_5);
        try (MiniDFSClusterInJVM cluster5 = new MiniDFSClusterInJVM.Builder(conf, testDataCluster5).numDataNodes(1).checkDataNodeHostConfig(true).build()) {
            assertEquals("DataNode hostname config not respected", "MYHOST", cluster5.getDataNodes().get(0).getDatanodeId().getHostName());
            cluster5.restartNodeForTesting(0);
            cluster5.upgradeNodeForTesting(0);
        }
    }

    @Test
    public void testClusterSetDatanodeDifferentStorageType_withUpgrade20() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        StorageType[][] storageType = new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK }, { StorageType.ARCHIVE } };
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(storageType).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testClusterSetDatanodeDifferentStorageType_withUpgrade40() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        StorageType[][] storageType = new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK }, { StorageType.ARCHIVE } };
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(storageType).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testClusterSetDatanodeDifferentStorageType_withUpgrade60() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        StorageType[][] storageType = new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK }, { StorageType.ARCHIVE } };
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(storageType).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testClusterNoStorageTypeSetForDatanodes_withUpgrade20() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
            cluster.waitActive();
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testClusterNoStorageTypeSetForDatanodes_withUpgrade40() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
            cluster.waitActive();
            ArrayList<DataNodeJVMInterface> dataNodes = cluster.getDataNodes();
    ...
    @Test
    public void testClusterNoStorageTypeSetForDatanodes_withUpgrade60() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
            cluster.waitActive();
            ArrayList<DataNodeJVMInterface> dataNodes = cluster.getDataNodes();
    ...
    @Test
    public void testSetUpFederatedCluster_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(2).build()) {
            cluster.waitActive();
            cluster.transitionToActive(1);
    ...
    @Test
    public void testSetUpFederatedCluster_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(2).build()) {
            cluster.waitActive();
            cluster.transitionToActive(1);
    ...
    @Test
    public void testSetUpFederatedCluster_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(2).build()) {
            cluster.waitActive();
            cluster.transitionToActive(1);
