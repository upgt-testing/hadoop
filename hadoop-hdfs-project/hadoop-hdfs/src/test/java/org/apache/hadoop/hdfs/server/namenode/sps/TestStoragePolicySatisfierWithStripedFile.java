...
public class TestStoragePolicySatisfierWithStripedFile {
    ...
    private void waitExpectedStorageType(MiniDockerDFSCluster cluster, final String fileName, long fileLen, final StorageType expectedStorageType, int expectedStorageCount, int expectedBlkLocationCount, int timeout) throws Exception {
