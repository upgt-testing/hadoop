 ...
 */
public class TestViewFsWithAcls_RestartInjected_Randomized_123 {
    ...
    public void testAclOnMountEntry() throws Exception {
        ...
        RestartFramework.at("after_modify_acl_nn2").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        assertArrayEquals(expected, aclEntryArray(fc2.getAclStatus(targetTestRoot2)));
