...
public class TestReadOnlySharedStorage {
    ...
    public void setup() throws IOException, InterruptedException {
        ...
        cluster = new MiniDockerDFSCluster.Builder(conf).numDataNodes(NUM_DATANODES).dataNodeConfOverlays(overlays).build();
        ...
        for (int i = 0; i < NUM_DATANODES; i++) {
            DataNodeInterface dataNode = cluster.getDataNodes().get(i);
