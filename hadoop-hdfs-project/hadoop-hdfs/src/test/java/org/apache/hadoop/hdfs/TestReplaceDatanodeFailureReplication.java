...
public class TestReplaceDatanodeFailureReplication {
    ...
    private MiniDFSClusterInJVM setupCluster(int failRF) throws IOException {
        ...
        return new MiniDFSClusterInJVM.Builder(conf).racks(racks).numDataNodes(REPLICATION).build();
    }
    ...
    @Test
    public void testLessNumberOfLiveDatanodesThanWriteReplaceDatanodeOnFailureRF_withUpgrade20() throws Exception {
        final MiniDFSClusterInJVM cluster = setupCluster(2);
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
            final Path dir = new Path(DIR);
    ...
    @Test
    public void testLessNumberOfLiveDatanodesThanWriteReplaceDatanodeOnFailureRF_withUpgrade40() throws Exception {
        final MiniDFSClusterInJVM cluster = setupCluster(2);
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
            final Path dir = new Path(DIR);
    ...
    @Test
    public void testLessNumberOfLiveDatanodesThanWriteReplaceDatanodeOnFailureRF_withUpgrade60() throws Exception {
        final MiniDFSClusterInJVM cluster = setupCluster(2);
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
            final Path dir = new Path(DIR);
    ...
    @Test
    public void testLessNumberOfLiveDatanodesThanWriteReplaceDatanodeOnFailureRF_withUpgrade80() throws Exception {
        final MiniDFSClusterInJVM cluster = setupCluster(2);
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
            final Path dir = new Path(DIR);
