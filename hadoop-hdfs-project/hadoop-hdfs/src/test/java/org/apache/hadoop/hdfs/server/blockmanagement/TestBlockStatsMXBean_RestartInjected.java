...
public class TestBlockStatsMXBean_RestartInjected {
  ...
  public void testStorageTypeStats() throws Exception {
    RestartFramework.at("after_cluster_ready")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
  ...
  public void testStorageTypeStatsWhenStorageFailed() throws Exception {
    ...
    RestartFramework.at("after_failure_injection")
        .on(cluster)
        .restart("namenode")
        .withMode(RestartMode.GRACEFUL)
        .execute();
    ...
    RestartFramework.at("after_storage_restore")
        .on(cluster)
        .restart("namenode")
        .withMode(RestartMode.CRASH)
        .execute();
  ...
  public void testStorageTypeLoad() throws Exception {
    ...
    RestartFramework.at("after_hot_file_hflush")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.CRASH)
    ...
    RestartFramework.at("after_cold_file_hflush")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.CRASH)
