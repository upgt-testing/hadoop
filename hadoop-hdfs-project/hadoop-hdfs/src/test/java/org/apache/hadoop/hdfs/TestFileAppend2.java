...
public class TestFileAppend2 {
    ...
    class Workload extends Thread {
        ...
        Workload(MiniDFSClusterInJVM cluster, int threadIndex, boolean append2) {
            id = threadIndex;
    ...
    public void testAppendLessThanChecksumChunk() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(1).build();
        cluster.waitActive();
    ...
    @Test
    public void testSimpleAppend_withUpgrade20() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend_withUpgrade40() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend_withUpgrade60() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend_withUpgrade80() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend2_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend2_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend2_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testSimpleAppend2_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_HANDLER_COUNT_KEY, 50);
        fileContents = AppendTestUtil.initBuffer(AppendTestUtil.FILE_SIZE);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testAppendLessThanChecksumChunk_withUpgrade20() throws Exception {
        final byte[] buf = new byte[1024];
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(1).build();
        cluster.waitActive();
        try (DistributedFileSystem fs = cluster.getFileSystem()) {
    ...
    @Test
    public void testAppendLessThanChecksumChunk_withUpgrade40() throws Exception {
        final byte[] buf = new byte[1024];
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(1).build();
        cluster.waitActive();
        try (DistributedFileSystem fs = cluster.getFileSystem()) {
    ...
    @Test
    public void testAppendLessThanChecksumChunk_withUpgrade60() throws Exception {
        final byte[] buf = new byte[1024];
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(1).build();
        cluster.waitActive();
        try (DistributedFileSystem fs = cluster.getFileSystem()) {
    ...
    @Test
    public void testAppendLessThanChecksumChunk_withUpgrade80() throws Exception {
        final byte[] buf = new byte[1024];
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(1).build();
        cluster.waitActive();
        try (DistributedFileSystem fs = cluster.getFileSystem()) {
