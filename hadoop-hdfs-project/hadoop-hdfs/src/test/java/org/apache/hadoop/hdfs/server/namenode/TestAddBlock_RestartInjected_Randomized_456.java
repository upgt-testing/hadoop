 ...
 */
public class TestAddBlock_RestartInjected_Randomized_456 {
    ...
    public void testAddBlockUC() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_append_hsync").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // restart NN
            cluster.restartNameNode(true);
            FSDirectory fsdir = cluster.getNamesystem().getFSDirectory();
