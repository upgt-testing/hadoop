...
public class TestBlockReportLease_RestartInjected {
  ...
  public void testCheckBlockReportLease() throws Exception {
    ...
    try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf)
      ...
      RestartFramework.at("after_heartbeat_response")
          .on(cluster)
          .restart("namenode")
          .withMode(RestartMode.GRACEFUL)
          .execute();
      ...
      delayer.waitForCall();
      RestartFramework.at("after_process_report_started")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_lease_removal")
          .on(cluster)
          .restart("namenode")
      ...
      delayer.proceed();
      RestartFramework.at("after_report_proceed")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.CRASH)
