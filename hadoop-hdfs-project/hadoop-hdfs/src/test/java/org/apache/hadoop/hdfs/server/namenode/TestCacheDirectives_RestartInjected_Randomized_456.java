...
public class TestCacheDirectives_RestartInjected_Randomized_456 {
    ...
    public void testBasicPoolOperations() throws Exception {
        ...
        RestartFramework.at("after_remove_pool").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
        ...
        dfs.addCachePool(info);
        RestartFramework.at("after_add_pool").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_modify_pool").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
    ...
    public void testAddRemoveDirectives() throws Exception {
        ...
        RestartFramework.at("after_modify_directive").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        proto.addCachePool(new CachePoolInfo("pool4").setMode(new FsPermission((short) 0)));
        RestartFramework.at("after_remove_directive").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_pools").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_directives").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCacheManagerRestart() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_remove_temp_pool").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // Restart namenode
    ...
    public void testWaitForCachedReplicas() throws Exception {
        ...
        RestartFramework.at("after_add_cache_directives").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Check that the datanodes have the right cache values
        DatanodeInfo[] live = dfs.getDataNodeStats(DatanodeReportType.LIVE);
        RestartFramework.at("after_cache_capacity_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testWaitForCachedReplicasInDirectory() throws Exception {
        ...
        RestartFramework.at("after_add_directive").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_add_pool").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Create some test files
    ...
    public void testExpiryTimeConsistency() throws Exception {
        ...
        MiniDFSCluster dfsCluster = new MiniDFSCluster.Builder(conf).numDataNodes(NUM_DATANODES).nnTopology(MiniDFSNNTopology.simpleHATopology()).build();
        ...
        RestartFramework.at("after_modify_directive").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final NameNode sbn = dfsCluster.getNameNode(1);
        RestartFramework.at("after_ha_cluster_start").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_add_directive").on(dfsCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
