...
public class TestSnapshotPathINodes {
    ...
    static private final PathInterface dir = new Path("/TestSnapshot");
    ...
    static private FSDirectoryInterface fsdir;
    ...
    public void testAllowSnapshot() throws Exception {
        ...
        final INodeInterface before = fsdir.getINode(pathStr);
        ...
        {
            final INodeInterface after = fsdir.getINode(pathStr);
    ...
    public void testNonSnapshotPathINodes() throws Exception {
        ...
        INodesInPathInterface nodesInPath = INodesInPath.resolve(fsdir.rootDir, components, false);
    ...
    public void testSnapshotPathINodes() throws Exception {
        ...
        final SnapshotInterface snapshot = getSnapshot(nodesInPath, "s1", 3);
        ...
        INodeInterface snapshotFileNode = nodesInPath.getLastINode();
    ...
    public void testSnapshotPathINodesAfterDeletion() throws Exception {
        ...
        final SnapshotInterface snapshot;
        {
            ...
            assertSnapshot(nodesInPath, true, snapshot, 3);
            // Check the INode for file1 (snapshot file)
            final INodeInterface inode = nodesInPath.getLastINode();
    ...
    public void testSnapshotPathINodesAfterModification() throws Exception {
        ...
        INodesInPathInterface ssNodesInPath = INodesInPath.resolve(fsdir.rootDir, components, false);
        // Length of ssInodes should be (components.length - 1), since we will
        // ignore ".snapshot"
        assertEquals(ssNodesInPath.length(), components.length - 1);
        final SnapshotInterface s3 = getSnapshot(ssNodesInPath, "s3", 3);
        assertSnapshot(ssNodesInPath, true, s3, 3);
        // Check the INode for snapshot of file1
        INodeInterface snapshotFileNode = ssNodesInPath.getLastINode();
        ...
        INodesInPathInterface newNodesInPath = INodesInPath.resolve(fsdir.rootDir, components, false);
    ...
    public void testShortCircuitSnapshotSearch() throws SnapshotException {
        FSNamesystemInterface fsn = cluster.getNamesystem();
        SnapshotManagerInterface sm = fsn.getSnapshotManager();
        assertEquals(0, sm.getNumSnapshottableDirs());
        INodesInPathInterface iip = Mockito.mock(INodesInPath.class);
