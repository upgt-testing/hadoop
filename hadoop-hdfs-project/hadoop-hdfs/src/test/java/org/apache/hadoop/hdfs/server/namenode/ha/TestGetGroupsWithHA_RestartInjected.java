...
public class TestGetGroupsWithHA_RestartInjected extends GetGroupsTestBase {
  ...
  public void testNoUserGiven() throws Exception {
    RestartFramework.at("before_tool_execution")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_tool_execution")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
