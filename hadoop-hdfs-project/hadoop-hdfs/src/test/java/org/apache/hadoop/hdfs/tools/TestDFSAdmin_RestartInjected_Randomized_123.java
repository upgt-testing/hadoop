 ...
 */
public class TestDFSAdmin_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestDFSAdmin_RestartInjected.class);
    ...
    public void testGetDatanodeInfo() throws Exception {
        ...
        RestartFramework.at("after_get_datanode_info").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testTriggerBlockReport() throws Exception {
        ...
        RestartFramework.at("after_trigger_block_report").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetVolumeReport() throws Exception {
        ...
        RestartFramework.at("after_get_volume_report").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testDFSAdminUnreachableDatanode() throws Exception {
        redirectStream();
        RestartFramework.at("after_datanode_stop").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
    ...
    public void testDataNodeGetReconfigurableProperties() throws IOException, InterruptedException {
        ...
        RestartFramework.at("after_get_reconfigurable_properties").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final List<String> outs = Lists.newArrayList();
    ...
    public void testDataNodeGetReconfigurationStatus() throws IOException, InterruptedException, TimeoutException {
        ...
        RestartFramework.at("after_get_reconfiguration_status").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }
    ...
    public void testNameNodeGetReconfigurableProperties() throws IOException, InterruptedException {
        ...
        RestartFramework.at("after_get_reconfigurable_properties").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testPrintTopology() throws Exception {
        ...
        try (MiniDFSCluster miniCluster = new MiniDFSCluster.Builder(dfsConf).numDataNodes(numDn).racks(racks).build()) {
            ...
            RestartFramework.at("after_print_topology").on(miniCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
    }
    ...
    public void testPrintTopologyWithStatus() throws Exception {
        ...
        try (MiniDFSCluster miniCluster = new MiniDFSCluster.Builder(dfsConf).numDataNodes(numDn).racks(racks).build()) {
            ...
            RestartFramework.at("after_print_topology_with_status").on(miniCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
    }

    @Test
    public void testNameNodeGetReconfigurationStatus() throws IOException, InterruptedException, TimeoutException {
        RestartFramework.at("after_get_reconfiguration_status").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ReconfigurationUtil ru = mock(ReconfigurationUtil.class);
    ...
    public void testReportCommand() throws Exception {
        ...
        try (MiniDFSCluster miniCluster = new MiniDFSCluster.Builder(dfsConf).numDataNodes(numDn).build()) {
            ...
            RestartFramework.at("after_file_creation").on(miniCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("after_report_command").on(miniCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        }
    }
    ...
    public void testListOpenFiles() throws Exception {
        ...
        try (MiniDFSCluster miniCluster = new MiniDFSCluster.Builder(dfsConf).numDataNodes(numDataNodes).build()) {
            ...
            RestartFramework.at("after_file_open").on(miniCluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            final DFSAdmin dfsAdmin = new DFSAdmin(dfsConf);
            assertEquals(0, ToolRunner.run(dfsAdmin, new String[] { "-listOpenFiles" }));
            verifyOpenFilesListing(closedFileSet, openFilesMap);
            RestartFramework.at("after_list_open_files").on(miniCluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSetBalancerBandwidth() throws Exception {
        ...
        resetStream();
        RestartFramework.at("after_set_balancer_bandwidth").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCheckNumOfBlocksInReportCommand() throws Exception {
        RestartFramework.at("after_report_command").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRefreshProxyUser() throws Exception {
        ...
        admin.run(args);
        RestartFramework.at("after_refresh_proxy_user").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAllDatanodesReconfig() throws IOException, InterruptedException, TimeoutException {
        ...
        List<ReconfigurationUtil.PropertyChange> changes = new ArrayList<>();
        changes.add(new ReconfigurationUtil.PropertyChange(DFS_DATANODE_PEER_STATS_ENABLED_KEY, "true", datanode.getConf().get(DFS_DATANODE_PEER_STATS_ENABLED_KEY)));
        when(reconfigurationUtil.parseChangedProperties(any(Configuration.class), any(Configuration.class))).thenReturn(changes);
        ...
        reconfigurationOutErrFormatter("startReconfiguration", "datanode", "livenodes", outsForStartReconf, errsForStartReconf);
        ...
        RestartFramework.at("after_datanode_reconfig").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
