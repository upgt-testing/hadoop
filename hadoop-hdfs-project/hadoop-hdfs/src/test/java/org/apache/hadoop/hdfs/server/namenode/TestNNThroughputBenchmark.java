...
public class TestNNThroughputBenchmark {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputAgainstRemoteNN_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputAgainstRemoteNN_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputAgainstRemoteNN_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputAgainstRemoteNN_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputRemoteAgainstNNWithFsOption_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testNNThroughputRemoteAgainstNNWithFsOption_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testNNThroughputRemoteAgainstNNWithFsOption_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testNNThroughputRemoteAgainstNNWithFsOption_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        MiniDFSClusterInJVM cluster = null;
    ...
    @Test(timeout = 120000)
    public void testNNThroughputForBlockReportOp_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputForBlockReportOp_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputForBlockReportOp_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 120000)
    public void testNNThroughputForBlockReportOp_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, 16);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 16);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
