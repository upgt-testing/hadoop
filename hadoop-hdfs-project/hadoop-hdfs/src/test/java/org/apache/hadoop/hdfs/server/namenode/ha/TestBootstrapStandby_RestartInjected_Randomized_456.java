...
public class TestBootstrapStandby_RestartInjected_Randomized_456 {
    ...
    public void testSuccessfulBaseCase() throws Exception {
        ...
        RestartFramework.at("after_bootstrap_all_standbys").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
        RestartFramework.at("after_remove_standby_dirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDownloadingLaterCheckpoint() throws Exception {
        ...
        RestartFramework.at("after_bootstrap_nns").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_make_checkpoint").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_test_file").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
    ...
    public void testSharedEditsMissingLogs() throws Exception {
        ...
        RestartFramework.at("after_delete_segment").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testStandbyDirsAlreadyExist() throws Exception {
        ...
        RestartFramework.at("after_bootstrap_check").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
        // Should pass with -force
        assertEquals(0, forceBootstrap(1));
        RestartFramework.at("after_force_bootstrap").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
    }
    ...
    public void testOtherNodeNotActive() throws Exception {
        ...
        RestartFramework.at("after_transition_standby").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
    ...
    public void testRateThrottling() throws Exception {
        ...
        RestartFramework.at("after_first_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        cluster.waitActive();
        nn0 = cluster.getNameNode(0);
        cluster.transitionToActive(0);
        nn0 = cluster.getNameNode(0);
        ...
        RestartFramework.at("after_second_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
        nn0 = cluster.getNameNode(0);
        ...
        nn0 = cluster.getNameNode(0);
        cluster.transitionToActive(0);
        RestartFramework.at("after_create_large_image").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn0 = cluster.getNameNode(0);
    ...
    private int forceBootstrap(int i) throws Exception {
        return BootstrapStandby.run(new String[] { "-force" }, cluster.getConfiguration(i));
    }
