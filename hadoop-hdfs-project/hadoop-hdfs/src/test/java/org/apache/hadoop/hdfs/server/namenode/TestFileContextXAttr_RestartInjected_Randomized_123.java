 ...
 */
public class TestFileContextXAttr_RestartInjected_Randomized_123 extends FSXAttrBaseTest {

    @BeforeClass
    public static void setupRestart() throws Exception {
        FSXAttrBaseTest.init();
    ...
    public static class FileContextFS extends DistributedFileSystem {
        ...
        @Override
        public void setXAttr(Path path, final String name, final byte[] value) throws IOException {
