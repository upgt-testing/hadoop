...
public class TestBackupNode {
    ...
    static final String BASE_DIR = MiniDockerDFSCluster.getBaseDirectory();
    ...
    void waitCheckpointDone(MiniDockerDFSCluster cluster, long txid) {
    ...
    private void testBNInSync(MiniDockerDFSCluster cluster, final BackupNode backup, int testIdx) throws Exception {
    ...
    void testCheckpoint(StartupOption op) throws Exception {
        ...
        File nnCurDir = new File(MiniDockerDFSCluster.getNameNodeDirectory(BASE_DIR, 0, 0)[0], "current/");
