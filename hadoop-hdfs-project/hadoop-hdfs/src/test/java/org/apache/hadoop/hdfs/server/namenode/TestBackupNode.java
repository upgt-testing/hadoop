...
public class TestBackupNode {
    ...
    private void testBNInSync(MiniDFSClusterInJVM cluster, final BackupNode backup, int testIdx) throws Exception {
    ...
    @Test
    public void testBackupNodeTailsEdits_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        HAUtil.setAllowStandbyReads(conf, true);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testBackupNodeTailsEdits_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        HAUtil.setAllowStandbyReads(conf, true);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testBackupNodeTailsEdits_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        HAUtil.setAllowStandbyReads(conf, true);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testBackupNodeTailsEdits_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        HAUtil.setAllowStandbyReads(conf, true);
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testCanReadData_withUpgrade20() throws IOException {
        Path file1 = new Path("/fileToRead.dat");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testCanReadData_withUpgrade40() throws IOException {
        Path file1 = new Path("/fileToRead.dat");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testCanReadData_withUpgrade60() throws IOException {
        Path file1 = new Path("/fileToRead.dat");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
    ...
    @Test
    public void testCanReadData_withUpgrade80() throws IOException {
        Path file1 = new Path("/fileToRead.dat");
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        FileSystem fileSys = null;
