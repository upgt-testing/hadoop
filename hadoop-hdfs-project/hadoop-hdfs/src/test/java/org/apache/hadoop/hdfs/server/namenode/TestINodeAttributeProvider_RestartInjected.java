...
public class TestINodeAttributeProvider_RestartInjected {
  private static final Logger LOG =
      LoggerFactory.getLogger(TestINodeAttributeProvider_RestartInjected.class);
  ...
  public void testDelegationToProvider() throws Exception {
    ...
    RestartFramework.at("after_tmp_creation")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
    ...
    ugi.doAs(new PrivilegedExceptionAction<Void>() {
      ...
      public Void run() throws Exception {
        ...
        RestartFramework.at("after_list_status")
            .on(miniDFS)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  private void testBypassProviderHelper(final String[] users,
    ...
    RestartFramework.at("after_directory_structure_creation")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAclFeature() throws Exception {
    ...
    ugi.doAs((PrivilegedExceptionAction<Object>) () -> {
      ...
      RestartFramework.at("after_acl_dir_creation")
          .on(miniDFS)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_acl_child_dir_creation")
          .on(miniDFS)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testContentSummary() throws Exception {
    ...
    RestartFramework.at("after_directory_permissions_setup")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAttrProviderWorksCorrectlyOnRenamedSnapshotPaths()
    ...
    RestartFramework.at("after_sub1_structure_creation")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_snapshot_enabled")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_s0_snapshot")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_file1_file2_creation")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_s1_s2_snapshots")
        .on(miniDFS)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
