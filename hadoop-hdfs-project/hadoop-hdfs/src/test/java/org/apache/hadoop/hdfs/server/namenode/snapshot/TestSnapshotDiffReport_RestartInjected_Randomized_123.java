 ...
 */
public class TestSnapshotDiffReport_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestSnapshotDiffReport_RestartInjected.class);
    ...
    public void setUp() throws Exception {
        ...
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_SNAPSHOT_DIFF_ALLOW_SNAP_ROOT_DESCENDANT, true);
    ...
    public void testDiffReport() throws Exception {
        ...
        RestartFramework.at("after_first_modify_and_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_second_modify_and_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        LOG.info(report.toString());
        RestartFramework.at("after_mkdir_subsubsub1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(0, report.getDiffList().size());
    ...
    public void testSnapRootDescendantDiffReport() throws Exception {
        ...
        RestartFramework.at("after_modify_sub1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        assertEquals(0, report.getDiffList().size());
        RestartFramework.at("after_modify_subsubsub").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_modify_subsub").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_mkdir_dirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertEquals(0, report.getDiffList().size());
    ...
    public void testSnapRootDescendantDiffReportWithRename() throws Exception {
        ...
        hdfs.createSnapshot(sub1, genSnapshotName(sub1));
        RestartFramework.at("after_rename_case1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        hdfs.createSnapshot(sub1, genSnapshotName(sub1));
        RestartFramework.at("after_mkdir_subsubsub2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_case2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_rename_case3").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_case2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_to_subsub").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_file30").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.createSnapshot(sub1, genSnapshotName(sub1));
        ...
        hdfs.createSnapshot(sub1, genSnapshotName(sub1));
        RestartFramework.at("after_first_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_second_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_case3").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_file20").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_case4").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_snapshot_case4_descendant").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_case1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSnapshotDiffInfo() throws Exception {
        ...
        RestartFramework.at("after_mkdir_snapshot_dirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_create_snapshots").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReport2() throws Exception {
        ...
        Path subsubsub1 = new Path(subsub1, "subsubsub1");
        hdfs.mkdirs(subsubsub1);
        RestartFramework.at("after_modify_and_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        modifyAndCreateSnapshot(subsubsub1, new Path[] { sub1 });
        // delete subsub1
        hdfs.delete(subsub1, true);
        RestartFramework.at("after_delete_subsub1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_mkdir_subsubsub1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReportWithQuota() throws Exception {
        ...
        RestartFramework.at("after_create_snapshot").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.createSnapshot(testdir, "s0");
        final SnapshotDiffReport report = hdfs.getSnapshotDiffReport(testdir, "s0", "");
        RestartFramework.at("after_mkdir_testdir").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReportWithRename() throws Exception {
        RestartFramework.at("after_snapshot_s1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_bar").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        hdfs.mkdirs(bar);
        RestartFramework.at("after_rename_foo").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_mkdir_dirs").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.mkdirs(sdir2);
        // create snapshot on root
        SnapshotTestHelper.createSnapshot(hdfs, root, "s1");
        RestartFramework.at("after_delete_sdir2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_s2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReportWithRenameOutside() throws Exception {
        final Path root = new Path("/");
        RestartFramework.at("after_create_files").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final Path dir1 = new Path(root, "dir1");
        final Path dir2 = new Path(root, "dir2");
        final Path foo = new Path(dir1, "foo");
        RestartFramework.at("after_snapshot_s1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final Path fileInFoo = new Path(foo, "file");
        RestartFramework.at("after_rename_foo_out_of_dir1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_bar_into_dir1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReportWithRenameAndDelete() throws Exception {
        final Path root = new Path("/");
        RestartFramework.at("after_create_files_in_foo_and_bar").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final Path dir1 = new Path(root, "dir1");
        final Path dir2 = new Path(root, "dir2");
        final Path foo = new Path(dir1, "foo");
        final Path fileInFoo = new Path(foo, "file");
        ...
        RestartFramework.at("after_delete_bar").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_rename_with_overwrite").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // delete bar
    ...
    public void testDiffReportWithRenameToNewDir() throws Exception {
        ...
        RestartFramework.at("after_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_mkdir_bar").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        final Path fileInFoo = new Path(foo, "file");
        DFSTestUtil.createFile(hdfs, fileInFoo, BLOCKSIZE, REPLICATION, SEED);
        RestartFramework.at("after_create_file_in_foo").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SnapshotTestHelper.createSnapshot(hdfs, root, "s0");
        RestartFramework.at("after_rename_file_to_bar").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReportWithRenameAndAppend() throws Exception {
        final Path root = new Path("/");
        final Path foo = new Path(root, "foo");
        RestartFramework.at("after_append_to_bar").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        DFSTestUtil.createFile(hdfs, foo, BLOCKSIZE, REPLICATION, SEED);
        RestartFramework.at("after_snapshot_s1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SnapshotTestHelper.createSnapshot(hdfs, root, "s0");
        final Path bar = new Path(root, "bar");
        RestartFramework.at("after_rename_foo_to_bar").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.rename(foo, bar);
        // append 10 bytes
        DFSTestUtil.appendFile(hdfs, bar, 10);
        SnapshotTestHelper.createSnapshot(hdfs, root, "s1");
        RestartFramework.at("after_create_file_foo").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testDiffReportWithRenameAndSnapshotDeletion() throws Exception {
        ...
        final Path foo = new Path(root, "foo");
        final Path bar = new Path(foo, "bar");
        RestartFramework.at("after_rename_bar_to_bar_new").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_create_file_bar").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // delete snapshot s0 so that the withNameList inside of the WithCount node
        // of foo becomes empty
        hdfs.deleteSnapshot(root, "s0");
        RestartFramework.at("after_rename_foo_to_foo2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // create snapshot s1 and rename bar again
        SnapshotTestHelper.createSnapshot(hdfs, root, "s1");
        final Path bar3 = new Path(foo2, "bar-new");
        hdfs.rename(bar2, bar3);
        RestartFramework.at("after_delete_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // we always put modification on the file before rename
        verifyDiffReport(root, "s1", "", new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes("foo2")), new DiffReportEntry(DiffType.RENAME, DFSUtil.string2Bytes("foo2/bar"), DFSUtil.string2Bytes("foo2/bar-new")));
    }

    private void createFile(final Path filePath) throws IOException {
        DFSTestUtil.createFile(hdfs, filePath, (int) BUFFERLEN, FILELEN, BLOCKSIZE, REPLICATION, SEED);
    }
    ...
    public void testDiffReportWithOpenFiles() throws Exception {
        ...
        RestartFramework.at("after_create_flume_file").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_close_flume_stream").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Create Snapshot S1
        ...
        RestartFramework.at("after_append_flume_file").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_snapshot_flume_s1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_write_to_flume_file_second").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Write more data to flume file
        flumeFileWrittenDataLength += writeToStream(flumeOutputStream, buf);
        ...
        RestartFramework.at("after_snapshot_flume_s2").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_write_to_flume_file_first").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        // Verify if Snap S2 file length is same as the live one
        ...
        Assert.assertEquals(flumeFileLengthAfterS2, hdfs.getFileStatus(flumeS2Path).getLen());
        verifyDiffReport(level0A, flumeSnap1Name, "", new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes("")), new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes(flumeFileName)));
        verifyDiffReport(level0A, flumeSnap2Name, "", new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes(flumeFileName)));
        verifyDiffReport(level0A, flumeSnap1Name, flumeSnap2Name, new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes("")), new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes(flumeFileName)));
        restartNameNode();
        verifyDiffReport(level0A, flumeSnap1Name, flumeSnap2Name, new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes("")), new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes(flumeFileName)));
    }
    ...
    public void testDontCaptureAccessTimeOnlyChangeReport() throws Exception {
        ...
        RestartFramework.at("after_set_times_first").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_modify_filePostSS").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Thread.sleep(3000);
        now = Time.now();
        // modify filePostSS, and change access time
        hdfs.setReplication(filePostSS, (short) (REPLICATION - 1));
        RestartFramework.at("after_create_post_snapshot_files").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.setTimes(filePostSS, -1, now);
        ...
        RestartFramework.at("after_set_times_second").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        cluster.waitActive();
        RestartFramework.at("after_snapshot_s3").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertAtimeEquals(filePreSS, root, "s0", "s1");
        assertAtimeEquals(dirPreSS, root, "s0", "s1");
        assertAtimeEquals(filePreSS, root, "s1", "s2");
        assertAtimeEquals(dirPreSS, root, "s1", "s2");
        assertAtimeEquals(filePostSS, root, "s1", "s2");
        assertAtimeEquals(dirPostSS, root, "s1", "s2");
        RestartFramework.at("after_create_pre_snapshot_files").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        assertAtimeNotEquals(filePostSS, root, "s2", "s3");
    }
    ...
    public void testDiffReportWithRpcLimit2() throws Exception {
        ...
        SnapshotTestHelper.createSnapshot(hdfs, root, "s0");
        RestartFramework.at("after_overwrite_files_in_dir3").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Path targetDir = new Path(root, "dir4");
        RestartFramework.at("after_mkdir_dir4").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_snapshot_s1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_move_files_to_dir4").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        //move dir2 inside dir3
        hdfs.rename(pathToRename, targetDir);
        RestartFramework.at("after_move_dir2_to_dir3").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SnapshotTestHelper.createSnapshot(hdfs, root, "s1");
    ...
    public void testDiffReportWithRpcLimit3() throws Exception {
        final Path root = new Path("/");
        hdfs.mkdirs(root);
        RestartFramework.at("after_create_initial_files").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Path path = new Path(root, "dir1");
        RestartFramework.at("after_create_new_files").on(cluster).restart("datanode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        hdfs.mkdirs(path);
        for (int j = 1; j <= 4; j++) {
            final Path file = new Path(path, "file" + j);
            DFSTestUtil.createFile(hdfs, file, BLOCKSIZE, REPLICATION, SEED);
        }
        RestartFramework.at("after_delete_files").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SnapshotTestHelper.createSnapshot(hdfs, root, "s0");
        ...
        RestartFramework.at("after_mkdir_dir1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SnapshotTestHelper.createSnapshot(hdfs, root, "s1");
        verifyDiffReport(root, "s0", "s1", new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes("")), new DiffReportEntry(DiffType.MODIFY, DFSUtil.string2Bytes("dir1")), new DiffReportEntry(DiffType.CREATE, DFSUtil.string2Bytes("dir1/file5")), new DiffReportEntry(DiffType.CREATE, DFSUtil.string2Bytes("dir1/file6")), new DiffReportEntry(DiffType.CREATE, DFSUtil.string2Bytes("dir1/file7")), new DiffReportEntry(DiffType.CREATE, DFSUtil.string2Bytes("dir1/file8")), new DiffReportEntry(DiffType.CREATE, DFSUtil.string2Bytes("dir1/file9")), new DiffReportEntry(DiffType.CREATE, DFSUtil.string2Bytes("dir1/file10")), new DiffReportEntry(DiffType.DELETE, DFSUtil.string2Bytes("dir1/file1")), new DiffReportEntry(DiffType.DELETE, DFSUtil.string2Bytes("dir1/file2")), new DiffReportEntry(DiffType.DELETE, DFSUtil.string2Bytes("dir1/file3")), new DiffReportEntry(DiffType.DELETE, DFSUtil.string2Bytes("dir1/file4")));
    }
    ...
    public void testSnapshotDiffReportRemoteIterator2() throws Exception {
        final Path root = new Path("/");
        hdfs.mkdirs(root);
        RestartFramework.at("after_mkdir_root").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        SnapshotTestHelper.createSnapshot(hdfs, root, "s0");
        RestartFramework.at("after_snapshot_s0").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        try {
