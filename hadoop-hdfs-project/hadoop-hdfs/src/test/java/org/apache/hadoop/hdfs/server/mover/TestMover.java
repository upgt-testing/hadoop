...
public class TestMover {
    ...
    static void initConf(Configuration conf) {
        ...
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
    }
    ...
    static Mover newMover(Configuration conf) throws IOException {
        ...
        final List<NameNodeConnector> nncs = NameNodeConnector.newNameNodeConnectors(nnMap, Mover.class.getSimpleName(), HdfsServerConstants.MOVER_ID_PATH, conf, NameNodeConnector.DEFAULT_MAX_IDLE_ITERATIONS);
    ...
    public void testScheduleSameBlock() throws IOException {
        ...
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        try {
            cluster.waitActive();
    ...
    private void testWithinSameNode(Configuration conf) throws Exception {
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        try {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    public void testWithFederateClusterWithinSameNode() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).build();
    ...
    public void testWithFederatedCluster() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
        try {
            cluster.waitActive();
            final String file = "/test/file";
    ...
    public void testWithFederatedHACluster() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(4).build();
    ...
    public void testMoverCli() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(0).build();
        try {
    ...
    public void testMoverCliWithHAConf() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
    ...
    public void testMoverCliWithFederation() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
        try {
    ...
    public void testMoverCliWithFederationHA() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        DFSTestUtil.setFederatedHAConfiguration(cluster, conf);
        try {
    ...
    public void testTwoReplicaSameStorageTypeShouldNotSelect() throws Exception {
        ...
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.DISK }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    public void testMoveWhenStoragePolicyNotSatisfying() throws Exception {
        ...
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
        try {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    public void testMoverFailedRetry() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    public void testBalancerMaxIterationTimeNotAffectMover() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.DISK }, { StorageType.ARCHIVE, StorageType.ARCHIVE } }).build();
        try {
            cluster.waitActive();
    ...
    public void testMoverFailedRetryWithPinnedBlocks() throws Exception {
        ...
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    public void testMoverWhenStoragePolicyUnset() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
   ...
   */
    @Test
    public void testScheduleSameBlock_withUpgrade20() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        try {
    ...
    @Test
    public void testScheduleSameBlock_withUpgrade40() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        try {
    ...
    @Test
    public void testScheduleSameBlock_withUpgrade60() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        try {
    ...
    @Test
    public void testScheduleSameBlock_withUpgrade80() throws IOException {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testWithFederateClusterWithinSameNode_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederateClusterWithinSameNode_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederateClusterWithinSameNode_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederateClusterWithinSameNode_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedCluster_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedCluster_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedCluster_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedCluster_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedHACluster_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedHAConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedHACluster_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedHAConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedHACluster_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedHAConfiguration(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testWithFederatedHACluster_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(4).build();
        DFSTestUtil.setFederatedHAConfiguration(cluster, conf);
    ...
    @Test
    public void testMoverCli_withUpgrade20() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testMoverCli_withUpgrade40() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testMoverCli_withUpgrade60() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testMoverCli_withUpgrade80() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testMoverCliWithHAConf_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        HATestUtil.setFailoverConfigurations(cluster, conf, "MyCluster");
    ...
    @Test
    public void testMoverCliWithHAConf_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        HATestUtil.setFailoverConfigurations(cluster, conf, "MyCluster");
    ...
    @Test
    public void testMoverCliWithHAConf_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        HATestUtil.setFailoverConfigurations(cluster, conf, "MyCluster");
    ...
    @Test
    public void testMoverCliWithHAConf_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        HATestUtil.setFailoverConfigurations(cluster, conf, "MyCluster");
    ...
    @Test
    public void testMoverCliWithFederation_withUpgrade20() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederation_withUpgrade40() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederation_withUpgrade60() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederation_withUpgrade80() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederationHA_withUpgrade20() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederationHA_withUpgrade40() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederationHA_withUpgrade60() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test
    public void testMoverCliWithFederationHA_withUpgrade80() throws Exception {
        final Configuration clusterConf = new HdfsConfiguration();
        clusterConf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(clusterConf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(3)).numDataNodes(0).build();
        final Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 300000)
    public void testTwoReplicaSameStorageTypeShouldNotSelect_withUpgrade20() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.DISK }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 300000)
    public void testTwoReplicaSameStorageTypeShouldNotSelect_withUpgrade40() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.DISK }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 300000)
    public void testTwoReplicaSameStorageTypeShouldNotSelect_withUpgrade60() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.DISK }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 300000)
    public void testTwoReplicaSameStorageTypeShouldNotSelect_withUpgrade80() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.DISK }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicyNotSatisfying_withUpgrade20() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicyNotSatisfying_withUpgrade40() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicyNotSatisfying_withUpgrade60() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicyNotSatisfying_withUpgrade80() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.NONE.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicySatisfierIsRunning_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicySatisfierIsRunning_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicySatisfierIsRunning_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testMoveWhenStoragePolicySatisfierIsRunning_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storageTypes(new StorageType[][] { { StorageType.DISK }, { StorageType.DISK }, { StorageType.DISK } }).build();
        try {
    ...
    @Test
    public void testMoverFailedRetry_withUpgrade20() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
    ...
    @Test
    public void testMoverFailedRetry_withUpgrade40() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
    ...
    @Test
    public void testMoverFailedRetry_withUpgrade60() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
    ...
    @Test
    public void testMoverFailedRetry_withUpgrade80() throws Exception {
        // HDFS-8147
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
    ...
    @Test(timeout = 100000)
    public void testBalancerMaxIterationTimeNotAffectMover_withUpgrade20() throws Exception {
        long blockSize = 10 * 1024 * 1024;
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.setInt(DFSConfigKeys.DFS_MOVER_MOVERTHREADS_KEY, 1);
    ...
    @Test(timeout = 100000)
    public void testBalancerMaxIterationTimeNotAffectMover_withUpgrade40() throws Exception {
        long blockSize = 10 * 1024 * 1024;
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.setInt(DFSConfigKeys.DFS_MOVER_MOVERTHREADS_KEY, 1);
    ...
    @Test(timeout = 100000)
    public void testBalancerMaxIterationTimeNotAffectMover_withUpgrade60() throws Exception {
        long blockSize = 10 * 1024 * 1024;
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.setInt(DFSConfigKeys.DFS_MOVER_MOVERTHREADS_KEY, 1);
    ...
    @Test(timeout = 100000)
    public void testBalancerMaxIterationTimeNotAffectMover_withUpgrade80() throws Exception {
        long blockSize = 10 * 1024 * 1024;
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.setInt(DFSConfigKeys.DFS_MOVER_MOVERTHREADS_KEY, 1);
    ...
    @Test(timeout = 300000)
    public void testMoverWithStripedFile_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConfWithStripe(conf);
        // start 10 datanodes
        int numOfDatanodes = 10;
    ...
    @Test(timeout = 300000)
    public void testMoverWithStripedFile_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConfWithStripe(conf);
        // start 10 datanodes
        int numOfDatanodes = 10;
    ...
    @Test(timeout = 300000)
    public void testMoverWithStripedFile_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConfWithStripe(conf);
        // start 10 datanodes
        int numOfDatanodes = 10;
    ...
    @Test(timeout = 300000)
    public void testMoverWithStripedFile_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConfWithStripe(conf);
        // start 10 datanodes
        int numOfDatanodes = 10;
    ...
    @Test(timeout = 90000)
    public void testMoverWithPinnedBlocks_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        // block pinning errors are not handled properly during block movement.
        conf.setInt(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, 10000);
    ...
    @Test(timeout = 90000)
    public void testMoverWithPinnedBlocks_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        // block pinning errors are not handled properly during block movement.
        conf.setInt(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, 10000);
    ...
    @Test(timeout = 90000)
    public void testMoverWithPinnedBlocks_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        // block pinning errors are not handled properly during block movement.
        conf.setInt(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, 10000);
    ...
    @Test(timeout = 90000)
    public void testMoverWithPinnedBlocks_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        // block pinning errors are not handled properly during block movement.
        conf.setInt(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, 10000);
    ...
    @Test(timeout = 90000)
    public void testMoverFailedRetryWithPinnedBlocks_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 90000)
    public void testMoverFailedRetryWithPinnedBlocks_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 90000)
    public void testMoverFailedRetryWithPinnedBlocks_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 90000)
    public void testMoverFailedRetryWithPinnedBlocks_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        conf.set(DFSConfigKeys.DFS_MOVER_RETRY_MAX_ATTEMPTS_KEY, "2");
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE }, { StorageType.DISK, StorageType.ARCHIVE } }).build();
    ...
    @Test(timeout = 300000)
    public void testMoverWhenStoragePolicyUnset_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testMoverWhenStoragePolicyUnset_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testMoverWhenStoragePolicyUnset_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testMoverWhenStoragePolicyUnset_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        initConf(conf);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE } }).build();
        try {
