...
public class TestDFSHAAdminMiniCluster {
    ...
    static {
        GenericTestUtils.setLogLevel(LogFactory.getLog(HAAdmin.class), Level.ALL);
    }
    ...
    @Test
    public void testGetServiceState_withUpgrade20() throws Exception {
        assertEquals(0, runTool("-getServiceState", "nn1"));
        assertEquals(0, runTool("-getServiceState", "nn2"));
        cluster.transitionToActive(0);
    ...
    @Test
    public void testGetServiceState_withUpgrade40() throws Exception {
        assertEquals(0, runTool("-getServiceState", "nn1"));
        assertEquals(0, runTool("-getServiceState", "nn2"));
        cluster.transitionToActive(0);
        assertEquals(0, runTool("-getServiceState", "nn1"));
    ...
    @Test
    public void testGetServiceState_withUpgrade60() throws Exception {
        assertEquals(0, runTool("-getServiceState", "nn1"));
        assertEquals(0, runTool("-getServiceState", "nn2"));
        cluster.transitionToActive(0);
        assertEquals(0, runTool("-getServiceState", "nn1"));
    ...
    @Test
    public void testGetServiceState_withUpgrade80() throws Exception {
        assertEquals(0, runTool("-getServiceState", "nn1"));
        assertEquals(0, runTool("-getServiceState", "nn2"));
        cluster.transitionToActive(0);
        assertEquals(0, runTool("-getServiceState", "nn1"));
    ...
    @Test
    public void testStateTransition_withUpgrade20() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testStateTransition_withUpgrade40() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testStateTransition_withUpgrade60() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testStateTransition_withUpgrade80() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testObserverTransition_withUpgrade20() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        // Should be able to transition from STANDBY to OBSERVER
        assertEquals(0, runTool("-transitionToObserver", "nn1"));
    ...
    @Test
    public void testObserverTransition_withUpgrade40() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        // Should be able to transition from STANDBY to OBSERVER
        assertEquals(0, runTool("-transitionToObserver", "nn1"));
    ...
    @Test
    public void testObserverTransition_withUpgrade60() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        // Should be able to transition from STANDBY to OBSERVER
        assertEquals(0, runTool("-transitionToObserver", "nn1"));
    ...
    @Test
    public void testObserverTransition_withUpgrade80() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        // Should be able to transition from STANDBY to OBSERVER
        assertEquals(0, runTool("-transitionToObserver", "nn1"));
    ...
    @Test
    public void testObserverIllegalTransition_withUpgrade20() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testObserverIllegalTransition_withUpgrade40() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testObserverIllegalTransition_withUpgrade60() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testObserverIllegalTransition_withUpgrade80() throws Exception {
        NameNodeJVMInterface nnode1 = cluster.getNameNode(0);
        assertTrue(nnode1.isStandbyState());
        assertEquals(0, runTool("-transitionToActive", "nn1"));
        assertFalse(nnode1.isStandbyState());
    ...
    @Test
    public void testTryFailoverToSafeMode_withUpgrade20() throws Exception {
        conf.set(DFSConfigKeys.DFS_HA_FENCE_METHODS_KEY, TestDFSHAAdmin.getFencerTrueCommand());
        tool.setConf(conf);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testTryFailoverToSafeMode_withUpgrade40() throws Exception {
        conf.set(DFSConfigKeys.DFS_HA_FENCE_METHODS_KEY, TestDFSHAAdmin.getFencerTrueCommand());
        tool.setConf(conf);
        NameNodeAdapter.enterSafeMode(cluster.getNameNode(0), false);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testTryFailoverToSafeMode_withUpgrade60() throws Exception {
        conf.set(DFSConfigKeys.DFS_HA_FENCE_METHODS_KEY, TestDFSHAAdmin.getFencerTrueCommand());
        tool.setConf(conf);
        NameNodeAdapter.enterSafeMode(cluster.getNameNode(0), false);
        assertEquals(-1, runTool("-failover", "nn2", "nn1"));
    ...
    @Test
    public void testTryFailoverToSafeMode_withUpgrade80() throws Exception {
        conf.set(DFSConfigKeys.DFS_HA_FENCE_METHODS_KEY, TestDFSHAAdmin.getFencerTrueCommand());
        tool.setConf(conf);
        NameNodeAdapter.enterSafeMode(cluster.getNameNode(0), false);
        assertEquals(-1, runTool("-failover", "nn2", "nn1"));
    ...
    @Test
    public void testTransitionToActiveWhenOtherNamenodeisActive_withUpgrade20() throws Exception {
        NameNodeJVMInterface nn1 = cluster.getNameNode(0);
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        if (nn1.getState() != null && !nn1.getState().equals(HAServiceState.STANDBY.name())) {
            cluster.transitionToStandby(0);
    ...
    @Test
    public void testTransitionToActiveWhenOtherNamenodeisActive_withUpgrade40() throws Exception {
        NameNodeJVMInterface nn1 = cluster.getNameNode(0);
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        if (nn1.getState() != null && !nn1.getState().equals(HAServiceState.STANDBY.name())) {
            cluster.transitionToStandby(0);
    ...
    @Test
    public void testTransitionToActiveWhenOtherNamenodeisActive_withUpgrade60() throws Exception {
        NameNodeJVMInterface nn1 = cluster.getNameNode(0);
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        if (nn1.getState() != null && !nn1.getState().equals(HAServiceState.STANDBY.name())) {
            cluster.transitionToStandby(0);
    ...
    @Test
    public void testTransitionToActiveWhenOtherNamenodeisActive_withUpgrade80() throws Exception {
        NameNodeJVMInterface nn1 = cluster.getNameNode(0);
        NameNodeJVMInterface nn2 = cluster.getNameNode(1);
        if (nn1.getState() != null && !nn1.getState().equals(HAServiceState.STANDBY.name())) {
            cluster.transitionToStandby(0);
