...
public class TestIncrementalBrVariations_RestartInjected {
  public static final Logger LOG =
      LoggerFactory.getLogger(TestIncrementalBrVariations_RestartInjected.class);
  ...
  public void verifyIncrementalBlockReports(boolean splitReports) throws IOException {
    ...
    try (FsDatasetSpi.FsVolumeReferences volumes
      ...
      if (splitReports) {
        RestartFramework.at("after_send_split_ibr")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
      ...
      if (!splitReports) {
        ...
        RestartFramework.at("after_send_combined_ibr")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_flush_blockops")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDataNodeDoesNotSplitReports()
    ...
    RestartFramework.at("after_delete_blocks")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_trigger_report")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNnLearnsNewStorages()
    ...
    RestartFramework.at("after_generate_report")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_send_report")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
