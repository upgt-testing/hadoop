...
public class TestDistributedFileSystem {
    ...
    HdfsConfiguration getTestConfiguration() {
        ...
        if (noXmlDefaults) {
            ...
            String namenodeDir = new File(MiniDFSClusterInJVM.getBaseDirectory(), "name").getAbsolutePath();
    ...
    public void testDFSClose() throws Exception {
        ...
        try {
            ...
            RemoteIterator<OpenFileEntry> listOpenFiles = fileSys.listOpenFiles(EnumSet.copyOf(types));
    ...
    public void testStatistics() throws IOException {
        ...
        ThreadLocal<StatisticsData> data = (ThreadLocal<StatisticsData>) Whitebox.getInternalState(FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class), "threadData");
        data.set(null);
        int lsLimit = 2;
        final Configuration conf = getTestConfiguration();
    ...
    public void testStatistics2() throws IOException, NoSuchAlgorithmException {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            ...
            // Crypto Commands.
            final KeyProviderJVMInterface provider = cluster.getNameNode().getNamesystem().getProvider();
    ...
    public void testECStatistics() throws IOException {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path dir = new Path("/test");
            dfs.mkdirs(dir);
    ...
    public void testConcurrentStatistics() throws IOException, InterruptedException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new Configuration()).build();
        cluster.waitActive();
        final FileSystem fs = cluster.getFileSystem();
    ...
    public void testInvalidScriptMappingFileReadStatistics() throws Exception {
        ...
        // MiniDFSClusterInJVM's datanode is on the local host and thus the network
        // distance is 0.
    ...
    private void testReadFileSystemStatistics(int expectedDistance, boolean useScriptMapping, boolean invalidScriptMappingFile) throws IOException {
        ...
        // MiniDFSClusterInJVM by default uses StaticMapping unless the test
        // overrides it.
        if (useScriptMapping) {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).useConfiguredTopologyMappingClass(true).build();
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).racks(new String[] { "/rackClient" }).build();
        } else if (expectedDistance == 4) {
            cluster = new MiniDFSClusterInJVM.Builder(conf).racks(new String[] { "/rackFoo" }).build();
        }
    ...
    public static void checkOpStatistics(OpType op, long count) {
        assertEquals("Op " + op.getSymbol() + " has unexpected count!", count, getOpStatistics(op));
    }

    public static long getOpStatistics(OpType op) {
        return GlobalStorageStatistics.INSTANCE.get(DFSOpsCountStatistics.NAME).getLong(op.getSymbol());
    }
    ...
    public void testFileChecksum() throws Exception {
        ...
        RAN.setSeed(seed);
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    public void testLocatedFileStatusStorageIdsTypes() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            ...
            for (DataNodeJVMInterface d : cluster.getDataNodes()) {
                try (FsVolumeReferencesJVMInterface volumes = d.getFSDataset().getFsVolumeReferences()) {
    ...
    public void testCreateWithStoragePolicy() throws Throwable {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE, StorageType.SSD }).storagesPerDatanode(3).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            ...
            outputStream.close();
            assertEquals(StorageType.ARCHIVE, DFSTestUtil.getAllBlocks(fs, file1).get(0).getStorageTypes()[0]);
            ...
            outputStream.write(1);
            outputStream.close();
            assertEquals(StorageType.SSD, DFSTestUtil.getAllBlocks(fs, file2).get(0).getStorageTypes()[0]);
            ...
            outputStream.write(1);
            outputStream.close();
            assertEquals(StorageType.DISK, DFSTestUtil.getAllBlocks(fs, new Path("/default")).get(0).getStorageTypes()[0]);
    ...
    public void testListStatusOfSnapshotDirs() throws IOException {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build();
        try {
    ...
    private void testBuilderSetters(DistributedFileSystem fs) {
        ...
        builder.append().overwrite(false).newBlock().lazyPersist().noLocalWrite().ecPolicyName("ec-policy").noLocalRack();
    ...
    public void testHdfsDataOutputStreamBuilderSetParameters() throws IOException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitActive();
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    public void testSuperUserPrivilege() throws Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            ...
            RemoteException re = LambdaTestUtils.intercept(RemoteException.class, "Superuser privilege is required", () -> userfs.listEncryptionZones().hasNext());
            assertTrue(re.unwrapRemoteException() instanceof AccessControlException);
            re = LambdaTestUtils.intercept(RemoteException.class, "Superuser privilege is required", () -> userfs.listReencryptionStatus().hasNext());
            assertTrue(re.unwrapRemoteException() instanceof AccessControlException);
            LambdaTestUtils.intercept(AccessControlException.class, "Superuser privilege is required", () -> user.doAs(new PrivilegedExceptionAction<Void>() {
    ...
    public void testEnableAndDisableErasureCodingPolicy() throws Exception {
        ...
        try {
            ...
            assertEquals(policyName, ErasureCodingPolicyManager.getInstance().getEnabledPolicyByName(policyName).getName());
            fs.disableErasureCodingPolicy(policyName);
            assertNull(ErasureCodingPolicyManager.getInstance().getEnabledPolicyByName(policyName));
    ...
    public void testStorageFavouredNodes() throws IOException, InterruptedException, TimeoutException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DISK }).numDataNodes(3).storagesPerDatanode(2).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
            fs.mkdirs(new Path("/tmp"));
            fs.setStoragePolicy(new Path("/tmp"), "ONE_SSD");
            InetSocketAddress[] addrs = { cluster.getDataNodes().get(0).getXferAddress() };
            HdfsDataOutputStream stream = fs.create(file1, FsPermission.getDefault(), false, 1024, (short) 3, 1024, null, addrs);
            stream.write("Some Bytes".getBytes());
            stream.close();
            DFSTestUtil.waitReplication(fs, file1, (short) 3);
            BlockLocation[] locations = fs.getClient().getBlockLocations(file1.toUri().getPath(), 0, Long.MAX_VALUE);
    ...
    public void testGetECTopologyResultForPolicies() throws Exception {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = DFSTestUtil.setupJVMCluster(conf, 9, 3, 0)) {
            DistributedFileSystem dfs = cluster.getFileSystem();
            ...
            result = dfs.getECTopologyResultForPolicies("XOR-2-1-1024k", "RS-3-2-1024k");
            assertTrue(result.isSupported());
            // Specify multiple policies with one policy requiring more datanodes than
            // present in the actual cluster
            result = dfs.getECTopologyResultForPolicies("RS-10-4-1024k", "RS-3-2-1024k");
            assertFalse(result.isSupported());
    ...
    @Test
    public void testEmptyDelegationToken_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testEmptyDelegationToken_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testEmptyDelegationToken_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testEmptyDelegationToken_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testFileSystemCloseAll_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        URI address = FileSystem.getDefaultUri(conf);
        try {
    ...
    @Test
    public void testFileSystemCloseAll_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        URI address = FileSystem.getDefaultUri(conf);
        try {
    ...
    @Test
    public void testFileSystemCloseAll_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        URI address = FileSystem.getDefaultUri(conf);
        try {
    ...
    @Test
    public void testFileSystemCloseAll_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        URI address = FileSystem.getDefaultUri(conf);
        try {
    ...
    // call to listOpenFiles(EnumSet<>)
    @SuppressWarnings("deprecation")
    public void testDFSClose_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    // call to listOpenFiles(EnumSet<>)
    @SuppressWarnings("deprecation")
    public void testDFSClose_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    // call to listOpenFiles(EnumSet<>)
    @SuppressWarnings("deprecation")
    public void testDFSClose_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    // call to listOpenFiles(EnumSet<>)
    @SuppressWarnings("deprecation")
    public void testDFSClose_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testDFSSeekExceptions_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testDFSSeekExceptions_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testDFSSeekExceptions_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testDFSSeekExceptions_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test
    public void testDFSClient_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        final long grace = 1000L;
        MiniDFSClusterInJVM cluster = null;
        LeaseRenewer.setLeaseRenewerGraceDefault(grace);
    ...
    @Test
    public void testDFSClient_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        final long grace = 1000L;
        MiniDFSClusterInJVM cluster = null;
        LeaseRenewer.setLeaseRenewerGraceDefault(grace);
    ...
    @Test
    public void testDFSClient_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        final long grace = 1000L;
        MiniDFSClusterInJVM cluster = null;
        LeaseRenewer.setLeaseRenewerGraceDefault(grace);
    ...
    @Test
    public void testClearStatistics_withUpgrade20() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testClearStatistics_withUpgrade40() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testClearStatistics_withUpgrade60() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testClearStatistics_withUpgrade80() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test
    public void testStatistics_withUpgrade20() throws IOException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        @SuppressWarnings("unchecked")
        ThreadLocal<StatisticsData> data = (ThreadLocal<StatisticsData>) Whitebox.getInternalState(FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class), "threadData");
        data.set(null);
    ...
    @Test
    public void testStatistics_withUpgrade40() throws IOException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        @SuppressWarnings("unchecked")
        ThreadLocal<StatisticsData> data = (ThreadLocal<StatisticsData>) Whitebox.getInternalState(FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class), "threadData");
        data.set(null);
    ...
    @Test
    public void testStatistics_withUpgrade60() throws IOException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        @SuppressWarnings("unchecked")
        ThreadLocal<StatisticsData> data = (ThreadLocal<StatisticsData>) Whitebox.getInternalState(FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class), "threadData");
        data.set(null);
    ...
    @Test
    public void testStatistics_withUpgrade80() throws IOException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        @SuppressWarnings("unchecked")
        ThreadLocal<StatisticsData> data = (ThreadLocal<StatisticsData>) Whitebox.getInternalState(FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class), "threadData");
        data.set(null);
    ...
    @Test
    public void testStatistics2_withUpgrade20() throws IOException, NoSuchAlgorithmException {
        HdfsConfiguration conf = getTestConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
    ...
    @Test
    public void testStatistics2_withUpgrade40() throws IOException, NoSuchAlgorithmException {
        HdfsConfiguration conf = getTestConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
    ...
    @Test
    public void testStatistics2_withUpgrade60() throws IOException, NoSuchAlgorithmException {
        HdfsConfiguration conf = getTestConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
    ...
    @Test
    public void testStatistics2_withUpgrade80() throws IOException, NoSuchAlgorithmException {
        HdfsConfiguration conf = getTestConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
    ...
    @Test
    public void testECStatistics_withUpgrade20() throws IOException {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path dir = new Path("/test");
    ...
    @Test
    public void testECStatistics_withUpgrade40() throws IOException {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path dir = new Path("/test");
    ...
    @Test
    public void testECStatistics_withUpgrade60() throws IOException {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path dir = new Path("/test");
    ...
    @Test
    public void testECStatistics_withUpgrade80() throws IOException {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            Path dir = new Path("/test");
    ...
    @SuppressWarnings("ThrowableResultOfMethodCallIgnored")
    @Test(timeout = 180000)
    public void testConcurrentStatistics_withUpgrade20() throws IOException, InterruptedException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new Configuration()).build();
        cluster.waitActive();
        final FileSystem fs = cluster.getFileSystem();
    ...
    @SuppressWarnings("ThrowableResultOfMethodCallIgnored")
    @Test(timeout = 180000)
    public void testConcurrentStatistics_withUpgrade40() throws IOException, InterruptedException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new Configuration()).build();
        cluster.waitActive();
        final FileSystem fs = cluster.getFileSystem();
    ...
    @SuppressWarnings("ThrowableResultOfMethodCallIgnored")
    @Test(timeout = 180000)
    public void testConcurrentStatistics_withUpgrade60() throws IOException, InterruptedException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new Configuration()).build();
        cluster.waitActive();
        final FileSystem fs = cluster.getFileSystem();
    ...
    @SuppressWarnings("ThrowableResultOfMethodCallIgnored")
    @Test(timeout = 180000)
    public void testConcurrentStatistics_withUpgrade80() throws IOException, InterruptedException {
        FileSystem.getStatistics(HdfsConstants.HDFS_URI_SCHEME, DistributedFileSystem.class).reset();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new Configuration()).build();
        cluster.waitActive();
        final FileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testFileChecksum_withUpgrade20() throws Exception {
        final long seed = RAN.nextLong();
        System.out.println("seed=" + seed);
        RAN.setSeed(seed);
        final Configuration conf = getTestConfiguration();
    ...
    @Test
    public void testFileChecksum_withUpgrade40() throws Exception {
        final long seed = RAN.nextLong();
        System.out.println("seed=" + seed);
        RAN.setSeed(seed);
        final Configuration conf = getTestConfiguration();
    ...
    @Test
    public void testFileChecksum_withUpgrade60() throws Exception {
        final long seed = RAN.nextLong();
        System.out.println("seed=" + seed);
        RAN.setSeed(seed);
        final Configuration conf = getTestConfiguration();
    ...
    @Test
    public void testFileChecksum_withUpgrade80() throws Exception {
        final long seed = RAN.nextLong();
        System.out.println("seed=" + seed);
        RAN.setSeed(seed);
        final Configuration conf = getTestConfiguration();
    ...
    @Test(timeout = 120000)
    public void testLocatedFileStatusStorageIdsTypes_withUpgrade20() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testLocatedFileStatusStorageIdsTypes_withUpgrade40() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 120000)
    public void testLocatedFileStatusStorageIdsTypes_withUpgrade60() throws Exception {
        final Configuration conf = getTestConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        try {
            final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testCreateWithCustomChecksum_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        Path testBasePath = new Path("/test/csum");
        // create args
    ...
    @Test
    public void testCreateWithCustomChecksum_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        Path testBasePath = new Path("/test/csum");
        // create args
    ...
    @Test
    public void testCreateWithCustomChecksum_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        Path testBasePath = new Path("/test/csum");
        // create args
    ...
    @Test
    public void testCreateWithCustomChecksum_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        Path testBasePath = new Path("/test/csum");
        // create args
    ...
    @Test(timeout = 60000)
    public void testFileCloseStatus_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 60000)
    public void testFileCloseStatus_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 60000)
    public void testFileCloseStatus_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 60000)
    public void testFileCloseStatus_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test
    public void testCreateWithStoragePolicy_withUpgrade20() throws Throwable {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE, StorageType.SSD }).storagesPerDatanode(3).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testCreateWithStoragePolicy_withUpgrade40() throws Throwable {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE, StorageType.SSD }).storagesPerDatanode(3).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testCreateWithStoragePolicy_withUpgrade60() throws Throwable {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE, StorageType.SSD }).storagesPerDatanode(3).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testCreateWithStoragePolicy_withUpgrade80() throws Throwable {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE, StorageType.SSD }).storagesPerDatanode(3).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test(timeout = 60000)
    public void testListFiles_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testListFiles_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testListFiles_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testListFiles_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testListStatusOfSnapshotDirs_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build();
        try {
            DistributedFileSystem dfs = cluster.getFileSystem();
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testListStatusOfSnapshotDirs_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build();
        try {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.create(new Path("/parent/test1/dfsclose/file-0"));
    ...
    @Test
    public void testListStatusOfSnapshotDirs_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build();
        try {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.create(new Path("/parent/test1/dfsclose/file-0"));
    ...
    @Test
    public void testListStatusOfSnapshotDirs_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(getTestConfiguration()).build();
        try {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.create(new Path("/parent/test1/dfsclose/file-0"));
    ...
    @Test(timeout = 10000)
    public void testDFSClientPeerReadTimeout_withUpgrade20() throws IOException {
        final int timeout = 1000;
        final Configuration conf = getTestConfiguration();
        conf.setInt(HdfsClientConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, timeout);
        // only need cluster to create a dfs client to get a peer
    ...
    @Test(timeout = 10000)
    public void testDFSClientPeerReadTimeout_withUpgrade40() throws IOException {
        final int timeout = 1000;
        final Configuration conf = getTestConfiguration();
        conf.setInt(HdfsClientConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, timeout);
        // only need cluster to create a dfs client to get a peer
    ...
    @Test(timeout = 10000)
    public void testDFSClientPeerReadTimeout_withUpgrade60() throws IOException {
        final int timeout = 1000;
        final Configuration conf = getTestConfiguration();
        conf.setInt(HdfsClientConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, timeout);
        // only need cluster to create a dfs client to get a peer
    ...
    @Test(timeout = 60000)
    public void testGetServerDefaults_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 60000)
    public void testGetServerDefaults_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 60000)
    public void testGetServerDefaults_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 10000)
    public void testDFSClientPeerWriteTimeout_withUpgrade20() throws IOException {
        final int timeout = 1000;
        final Configuration conf = getTestConfiguration();
        conf.setInt(HdfsClientConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, timeout);
        // only need cluster to create a dfs client to get a peer
    ...
    @Test(timeout = 10000)
    public void testDFSClientPeerWriteTimeout_withUpgrade40() throws IOException {
        final int timeout = 1000;
        final Configuration conf = getTestConfiguration();
        conf.setInt(HdfsClientConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, timeout);
        // only need cluster to create a dfs client to get a peer
    ...
    @Test(timeout = 10000)
    public void testDFSClientPeerWriteTimeout_withUpgrade60() throws IOException {
        final int timeout = 1000;
        final Configuration conf = getTestConfiguration();
        conf.setInt(HdfsClientConfigKeys.DFS_CLIENT_SOCKET_TIMEOUT_KEY, timeout);
        // only need cluster to create a dfs client to get a peer
    ...
    @Test(timeout = 30000)
    public void testTotalDfsUsed_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testTotalDfsUsed_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testTotalDfsUsed_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testTotalDfsUsed_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testDFSCloseFilesBeingWritten_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testDFSCloseFilesBeingWritten_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testDFSCloseFilesBeingWritten_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testDFSCloseFilesBeingWritten_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testHdfsDataOutputStreamBuilderSetParameters_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitActive();
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testHdfsDataOutputStreamBuilderSetParameters_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitActive();
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testHdfsDataOutputStreamBuilderSetParameters_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
            cluster.waitActive();
            DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForCreation_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilder";
        Path testFilePath = new Path(testFile);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForCreation_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilder";
        Path testFilePath = new Path(testFile);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForCreation_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilder";
        Path testFilePath = new Path(testFile);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForCreation_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilder";
        Path testFilePath = new Path(testFile);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build()) {
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForAppend_withUpgrade20() throws IOException {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilderForAppend";
        Path path = new Path(testFile);
        Random random = new Random();
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForAppend_withUpgrade40() throws IOException {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilderForAppend";
        Path path = new Path(testFile);
        Random random = new Random();
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForAppend_withUpgrade60() throws IOException {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilderForAppend";
        Path path = new Path(testFile);
        Random random = new Random();
    ...
    @Test
    public void testDFSDataOutputStreamBuilderForAppend_withUpgrade80() throws IOException {
        Configuration conf = getTestConfiguration();
        String testFile = "/testDFSDataOutputStreamBuilderForAppend";
        Path path = new Path(testFile);
        Random random = new Random();
    ...
    @Test
    public void testSuperUserPrivilege_withUpgrade20() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
        conf.set(CommonConfigurationKeysPublic.HADOOP_SECURITY_KEY_PROVIDER_PATH, JavaKeyStoreProvider.SCHEME_NAME + "://file" + jksPath.toUri());
    ...
    @Test
    public void testSuperUserPrivilege_withUpgrade40() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
        conf.set(CommonConfigurationKeysPublic.HADOOP_SECURITY_KEY_PROVIDER_PATH, JavaKeyStoreProvider.SCHEME_NAME + "://file" + jksPath.toUri());
    ...
    @Test
    public void testSuperUserPrivilege_withUpgrade60() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
        conf.set(CommonConfigurationKeysPublic.HADOOP_SECURITY_KEY_PROVIDER_PATH, JavaKeyStoreProvider.SCHEME_NAME + "://file" + jksPath.toUri());
    ...
    @Test
    public void testSuperUserPrivilege_withUpgrade80() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        File tmpDir = GenericTestUtils.getTestDir(UUID.randomUUID().toString());
        final Path jksPath = new Path(tmpDir.toString(), "test.jks");
        conf.set(CommonConfigurationKeysPublic.HADOOP_SECURITY_KEY_PROVIDER_PATH, JavaKeyStoreProvider.SCHEME_NAME + "://file" + jksPath.toUri());
    ...
    @Test
    public void testListingStoragePolicyNonSuperUser_withUpgrade20() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testListingStoragePolicyNonSuperUser_withUpgrade40() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testListingStoragePolicyNonSuperUser_withUpgrade60() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testListingStoragePolicyNonSuperUser_withUpgrade80() throws Exception {
        HdfsConfiguration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testRemoveErasureCodingPolicy_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testRemoveErasureCodingPolicy_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testEnableAndDisableErasureCodingPolicy_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testEnableAndDisableErasureCodingPolicy_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testEnableAndDisableErasureCodingPolicy_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test
    public void testStorageFavouredNodes_withUpgrade20() throws IOException, InterruptedException, TimeoutException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DISK }).numDataNodes(3).storagesPerDatanode(2).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testStorageFavouredNodes_withUpgrade40() throws IOException, InterruptedException, TimeoutException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DISK }).numDataNodes(3).storagesPerDatanode(2).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testStorageFavouredNodes_withUpgrade60() throws IOException, InterruptedException, TimeoutException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DISK }).numDataNodes(3).storagesPerDatanode(2).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testStorageFavouredNodes_withUpgrade80() throws IOException, InterruptedException, TimeoutException {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[] { StorageType.SSD, StorageType.DISK }).numDataNodes(3).storagesPerDatanode(2).build()) {
            DistributedFileSystem fs = cluster.getFileSystem();
            Path file1 = new Path("/tmp/file1");
    ...
    @Test
    public void testGetECTopologyResultForPolicies_withUpgrade20() throws Exception {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = DFSTestUtil.setupJVMCluster(conf, 9, 3, 0)) {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.enableErasureCodingPolicy("RS-6-3-1024k");
    ...
    @Test
    public void testGetECTopologyResultForPolicies_withUpgrade40() throws Exception {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = DFSTestUtil.setupJVMCluster(conf, 9, 3, 0)) {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.enableErasureCodingPolicy("RS-6-3-1024k");
    ...
    @Test
    public void testGetECTopologyResultForPolicies_withUpgrade60() throws Exception {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = DFSTestUtil.setupJVMCluster(conf, 9, 3, 0)) {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.enableErasureCodingPolicy("RS-6-3-1024k");
    ...
    @Test
    public void testGetECTopologyResultForPolicies_withUpgrade80() throws Exception {
        Configuration conf = getTestConfiguration();
        try (MiniDFSClusterInJVM cluster = DFSTestUtil.setupJVMCluster(conf, 9, 3, 0)) {
            DistributedFileSystem dfs = cluster.getFileSystem();
            dfs.enableErasureCodingPolicy("RS-6-3-1024k");
