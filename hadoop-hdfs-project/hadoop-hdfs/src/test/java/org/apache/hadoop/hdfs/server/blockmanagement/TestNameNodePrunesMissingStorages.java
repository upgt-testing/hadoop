...
public class TestNameNodePrunesMissingStorages {
    ...
    private static void runTest(final String testCaseName, final boolean createFiles, final int numInitialStorages, final int expectedStoragesAfterTest) throws IOException {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(numInitialStorages).build();
            cluster.waitActive();
            ...
            final DatanodeDescriptorJVMInterface dnDescriptor = cluster.getNamesystem().getBlockManager().getDatanodeManager().getDatanode(dnId);
            ...
            final StorageReportJVMInterface[] reports = dn0.getFSDataset().getStorageReports(bpid);
    ...
    public void testRemovingStorageDoesNotProduceZombies() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).storagesPerDatanode(NUM_STORAGES_PER_DN).build();
        try {
            cluster.waitActive();
    ...
    public void testRenamingStorageIds() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(1).build();
        ...
        try {
            ...
            FsVolumeReferencesJVMInterface volumeRefs = dn.getFSDataset().getFsVolumeReferences();
    ...
    public void testNameNodePrunesUnreportedStorages() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(2).build();
        try {
            cluster.waitActive();
            ...
            DatanodeDescriptorJVMInterface dnDescriptor = bm.getDatanodeManager().getDatanode(cluster.getDataNodes().get(0).getDatanodeUuid());
            DatanodeStorageInfoJVMInterface[] dnStoragesInfosBeforeRestart = dnDescriptor.getStorageInfos();
    ...
    @Test(timeout = 300000)
    public void testRemovingStorageDoesNotProduceZombies_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        final int NUM_STORAGES_PER_DN = 2;
    ...
    @Test(timeout = 300000)
    public void testRemovingStorageDoesNotProduceZombies_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        final int NUM_STORAGES_PER_DN = 2;
    ...
    @Test(timeout = 300000)
    public void testRemovingStorageDoesNotProduceZombies_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        final int NUM_STORAGES_PER_DN = 2;
    ...
    @Test(timeout = 300000)
    public void testRemovingStorageDoesNotProduceZombies_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 1);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        final int NUM_STORAGES_PER_DN = 2;
    ...
    @Test(timeout = 300000)
    public void testRenamingStorageIds_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 0);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(1).build();
        GenericTestUtils.setLogLevel(BlockManager.LOG, Level.ALL);
    ...
    @Test(timeout = 300000)
    public void testRenamingStorageIds_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 0);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(1).build();
        GenericTestUtils.setLogLevel(BlockManager.LOG, Level.ALL);
    ...
    @Test(timeout = 300000)
    public void testRenamingStorageIds_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 0);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(1).build();
        GenericTestUtils.setLogLevel(BlockManager.LOG, Level.ALL);
    ...
    @Test(timeout = 300000)
    public void testRenamingStorageIds_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_DATANODE_FAILED_VOLUMES_TOLERATED_KEY, 0);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(1).build();
        GenericTestUtils.setLogLevel(BlockManager.LOG, Level.ALL);
    ...
    @Test(timeout = 300000)
    public void testNameNodePrunesUnreportedStorages_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Create a cluster with one datanode with two storages
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(2).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testNameNodePrunesUnreportedStorages_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Create a cluster with one datanode with two storages
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(2).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testNameNodePrunesUnreportedStorages_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Create a cluster with one datanode with two storages
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(2).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testNameNodePrunesUnreportedStorages_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Create a cluster with one datanode with two storages
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).storagesPerDatanode(2).build();
        try {
