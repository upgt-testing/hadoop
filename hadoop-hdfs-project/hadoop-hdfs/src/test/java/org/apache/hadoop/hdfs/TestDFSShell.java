...
public class TestDFSShell {
    ...
    public void testMoveWithTargetPortEmpty() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(2).nameNodePort(ServerSocketUtil.waitForPort(HdfsClientConfigKeys.DFS_NAMENODE_RPC_PORT_DEFAULT, 60)).waitSafeMode(true).build();
            FileSystem srcFs = cluster.getFileSystem();
            FsShell shell = new FsShell();
            shell.setConf(conf);
            String[] argv = new String[2];
    ...
    public void testTail() throws Exception {
        ...
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    void testChmod(Configuration conf, FileSystem fs, String chmodDir) throws IOException {
        ...
        try {
            ...
            fs.delete(dir, true);
            fs.mkdirs(dir);
            confirmPermissionChange(/* Setting */
            "u+rwx,g=rw,o-rwx", /* Should give */
            "rwxrw----", fs, shell, dir);
    ...
    private static List<MaterializedReplica> getMaterializedReplicas(MiniDFSClusterInJVM cluster) throws IOException {
    ...
    public void testRemoteException() throws Exception {
        ...
        try {
            final Configuration conf = new HdfsConfiguration();
            dfs = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    public void testGet() throws IOException {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).format(true).build();
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).format(false).build();
            dfs = cluster.getFileSystem();
    ...
    public void testCopyCommandsWithRawXAttrs() throws Exception {
        final Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    public void testSetrepLow() throws Exception {
        ...
        try {
            ...
            assertEquals("Error message is not the expected error message", "setrep: Requested replication factor of 1 is less than " + "the required minimum of 2 for /tmp/TestDFSShell-" + "testSetrepLow/testFileForSetrepLow\n", bao.toString());
        } finally {
            shell.close();
            cluster.shutdown();
        }
    ...
    private void deleteFileUsingTrash(boolean serverTrash, boolean clientTrash) throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(serverConf).numDataNodes(1).format(true).build();
   ...
   */
    ...
    @Test(timeout = 30000)
    public void testZeroSizeFile_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testZeroSizeFile_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testZeroSizeFile_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testZeroSizeFile_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testRecursiveRm_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testRecursiveRm_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testRecursiveRm_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testDu_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        PrintStream psBackup = System.out;
    ...
    @Test(timeout = 30000)
    public void testDu_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        PrintStream psBackup = System.out;
    ...
    @Test(timeout = 30000)
    public void testDu_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        PrintStream psBackup = System.out;
    ...
    @Test(timeout = 30000)
    public void testDu_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        PrintStream psBackup = System.out;
    ...
    @Test(timeout = 180000)
    public void testDuSnapshots_withUpgrade20() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testDuSnapshots_withUpgrade40() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testDuSnapshots_withUpgrade60() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testDuSnapshots_withUpgrade80() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testCountSnapshots_withUpgrade20() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testCountSnapshots_withUpgrade40() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testCountSnapshots_withUpgrade60() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 180000)
    public void testCountSnapshots_withUpgrade80() throws IOException {
        final int replication = 2;
        final Configuration conf = new HdfsConfiguration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(replication).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 30000)
    public void testPut_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testPut_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testPut_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testPut_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testErrOutPut_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testErrOutPut_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testErrOutPut_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testErrOutPut_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test
    public void testMoveWithTargetPortEmpty_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(2).nameNodePort(ServerSocketUtil.waitForPort(HdfsClientConfigKeys.DFS_NAMENODE_RPC_PORT_DEFAULT, 60)).waitSafeMode(true).build();
    ...
    @Test
    public void testMoveWithTargetPortEmpty_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(2).nameNodePort(ServerSocketUtil.waitForPort(HdfsClientConfigKeys.DFS_NAMENODE_RPC_PORT_DEFAULT, 60)).waitSafeMode(true).build();
    ...
    @Test
    public void testMoveWithTargetPortEmpty_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(2).nameNodePort(ServerSocketUtil.waitForPort(HdfsClientConfigKeys.DFS_NAMENODE_RPC_PORT_DEFAULT, 60)).waitSafeMode(true).build();
    ...
    @Test
    public void testMoveWithTargetPortEmpty_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(2).nameNodePort(ServerSocketUtil.waitForPort(HdfsClientConfigKeys.DFS_NAMENODE_RPC_PORT_DEFAULT, 60)).waitSafeMode(true).build();
    ...
    @Test(timeout = 30000)
    public void testURIPaths_withUpgrade20() throws Exception {
        Configuration srcConf = new HdfsConfiguration();
        Configuration dstConf = new HdfsConfiguration();
        MiniDFSClusterInJVM srcCluster = null;
        MiniDFSClusterInJVM dstCluster = null;
        ...
        try {
            ...
            argv[1] = dstFs.getUri().toString() + "/";
            int ret = ToolRunner.run(shell, argv);
            srcCluster.restartNodeForTesting(0);
            srcCluster.upgradeNodeForTesting(0);
            assertEquals("ls works on remote uri ", 0, ret);
            //check for rm -r
            dstFs.mkdirs(new Path("/hadoopdir"));
            argv = new String[2];
    ...
    @Test(timeout = 30000)
    public void testURIPaths_withUpgrade40() throws Exception {
        Configuration srcConf = new HdfsConfiguration();
        Configuration dstConf = new HdfsConfiguration();
        MiniDFSClusterInJVM srcCluster = null;
        MiniDFSClusterInJVM dstCluster = null;
    ...
    @Test(timeout = 30000)
    public void testURIPaths_withUpgrade60() throws Exception {
        Configuration srcConf = new HdfsConfiguration();
        Configuration dstConf = new HdfsConfiguration();
        MiniDFSClusterInJVM srcCluster = null;
        MiniDFSClusterInJVM dstCluster = null;
    ...
    @Test(timeout = 30000)
    public void testURIPaths_withUpgrade80() throws Exception {
        Configuration srcConf = new HdfsConfiguration();
        Configuration dstConf = new HdfsConfiguration();
        MiniDFSClusterInJVM srcCluster = null;
        MiniDFSClusterInJVM dstCluster = null;
    ...
    @Test(timeout = 30000)
    public void testTail_withUpgrade20() throws Exception {
        final int blockSize = 1024;
        final int fileLen = 5 * blockSize;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testTail_withUpgrade40() throws Exception {
        final int blockSize = 1024;
        final int fileLen = 5 * blockSize;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testTail_withUpgrade60() throws Exception {
        final int blockSize = 1024;
        final int fileLen = 5 * blockSize;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testTail_withUpgrade80() throws Exception {
        final int blockSize = 1024;
        final int fileLen = 5 * blockSize;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
    ...
    @Test(timeout = 30000)
    public void testTailWithFresh_withUpgrade20() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testTailWithFresh_withUpgrade40() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testTailWithFresh_withUpgrade60() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testTailWithFresh_withUpgrade80() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testText_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 30000)
    public void testText_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 30000)
    public void testText_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 30000)
    public void testText_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 30000)
    public void testCopyToLocal_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testCopyToLocal_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testCopyToLocal_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        assertTrue("Not a HDFS: " + fs.getUri(), fs instanceof DistributedFileSystem);
    ...
    @Test(timeout = 30000)
    public void testCount_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testCount_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testCount_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testCount_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testTotalSizeOfAllFiles_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testTotalSizeOfAllFiles_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testTotalSizeOfAllFiles_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testTotalSizeOfAllFiles_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
    ...
    @Test(timeout = 30000)
    public void testFilePermissions_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        //test chmod on local fs
        FileSystem fs = FileSystem.getLocal(conf);
        testChmod(conf, fs, (new File(TEST_ROOT_DIR, "chmodTest")).getAbsolutePath());
    ...
    @Test(timeout = 30000)
    public void testFilePermissions_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        //test chmod on local fs
        FileSystem fs = FileSystem.getLocal(conf);
        testChmod(conf, fs, (new File(TEST_ROOT_DIR, "chmodTest")).getAbsolutePath());
    ...
    @Test(timeout = 30000)
    public void testFilePermissions_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        //test chmod on local fs
        FileSystem fs = FileSystem.getLocal(conf);
        testChmod(conf, fs, (new File(TEST_ROOT_DIR, "chmodTest")).getAbsolutePath());
    ...
    @Test(timeout = 30000)
    public void testFilePermissions_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        //test chmod on local fs
        FileSystem fs = FileSystem.getLocal(conf);
        testChmod(conf, fs, (new File(TEST_ROOT_DIR, "chmodTest")).getAbsolutePath());
    ...
    @Test(timeout = 120000)
    public void testDFSShell_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        /* This tests some properties of ChecksumFileSystem as well.
     * Make sure that we create ChecksumDFS */
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 120000)
    public void testDFSShell_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        /* This tests some properties of ChecksumFileSystem as well.
     * Make sure that we create ChecksumDFS */
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 120000)
    public void testDFSShell_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        /* This tests some properties of ChecksumFileSystem as well.
     * Make sure that we create ChecksumDFS */
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 120000)
    public void testDFSShell_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        /* This tests some properties of ChecksumFileSystem as well.
     * Make sure that we create ChecksumDFS */
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
    ...
    @Test(timeout = 30000)
    public void testRemoteException_withUpgrade20() throws Exception {
        UserGroupInformation tmpUGI = UserGroupInformation.createUserForTesting("tmpname", new String[] { "mygroup" });
        MiniDFSClusterInJVM dfs = null;
        PrintStream bak = null;
        try {
            ...
            FileSystem fs = dfs.getFileSystem();
            Path p = new Path("/foo");
            dfs.restartNodeForTesting(0);
            dfs.upgradeNodeForTesting(0);
            fs.mkdirs(p);
            fs.setPermission(p, new FsPermission((short) 0700));
            bak = System.err;
            tmpUGI.doAs(new PrivilegedExceptionAction<Object>() {
    ...
    @Test(timeout = 30000)
    public void testRemoteException_withUpgrade40() throws Exception {
        UserGroupInformation tmpUGI = UserGroupInformation.createUserForTesting("tmpname", new String[] { "mygroup" });
        MiniDFSClusterInJVM dfs = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testRemoteException_withUpgrade80() throws Exception {
        UserGroupInformation tmpUGI = UserGroupInformation.createUserForTesting("tmpname", new String[] { "mygroup" });
        MiniDFSClusterInJVM dfs = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testGet_withUpgrade20() throws IOException {
        GenericTestUtils.setLogLevel(FSInputChecker.LOG, Level.ALL);
        final String fname = "testGet.txt";
        Path root = new Path("/test/get");
        final Path remotef = new Path(root, fname);
    ...
    @Test(timeout = 30000)
    public void testGet_withUpgrade40() throws IOException {
        GenericTestUtils.setLogLevel(FSInputChecker.LOG, Level.ALL);
        final String fname = "testGet.txt";
        Path root = new Path("/test/get");
        final Path remotef = new Path(root, fname);
    ...
    @Test(timeout = 30000)
    public void testGet_withUpgrade60() throws IOException {
        GenericTestUtils.setLogLevel(FSInputChecker.LOG, Level.ALL);
        final String fname = "testGet.txt";
        Path root = new Path("/test/get");
        final Path remotef = new Path(root, fname);
    ...
    @Test(timeout = 30000)
    public void testGet_withUpgrade80() throws IOException {
        GenericTestUtils.setLogLevel(FSInputChecker.LOG, Level.ALL);
        final String fname = "testGet.txt";
        Path root = new Path("/test/get");
        final Path remotef = new Path(root, fname);
    ...
    @Test(timeout = 30000)
    public void testStat_withUpgrade20() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testStat_withUpgrade40() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testStat_withUpgrade60() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testStat_withUpgrade80() throws Exception {
        final int blockSize = 1024;
        final Configuration conf = new HdfsConfiguration();
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, blockSize);
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build()) {
    ...
    @Test(timeout = 30000)
    public void testLsr_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testLsr_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testLsr_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testLsr_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem dfs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithPreserveOption_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithPreserveOption_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithPreserveOption_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithPreserveOption_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithRawXAttrs_withUpgrade20() throws Exception {
        final Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithRawXAttrs_withUpgrade40() throws Exception {
        final Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithRawXAttrs_withUpgrade60() throws Exception {
        final Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsWithRawXAttrs_withUpgrade80() throws Exception {
        final Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsToDirectoryWithPreserveOption_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsToDirectoryWithPreserveOption_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsToDirectoryWithPreserveOption_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsToDirectoryWithPreserveOption_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_XATTRS_ENABLED_KEY, true);
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsPreserveAclAndStickyBit_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsPreserveAclAndStickyBit_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsPreserveAclAndStickyBit_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 120000)
    public void testCopyCommandsPreserveAclAndStickyBit_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
    ...
    @Test(timeout = 30000)
    public void testCopyCommandsWithForceOption_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testCopyCommandsWithForceOption_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testCopyCommandsWithForceOption_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testSetrepLow_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_MIN_KEY, 2);
        MiniDFSClusterInJVM.Builder builder = new MiniDFSClusterInJVM.Builder(conf);
        MiniDFSClusterInJVM cluster = builder.numDataNodes(2).format(true).build();
    ...
    @Test(timeout = 30000)
    public void testSetrepLow_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_MIN_KEY, 2);
        MiniDFSClusterInJVM.Builder builder = new MiniDFSClusterInJVM.Builder(conf);
        MiniDFSClusterInJVM cluster = builder.numDataNodes(2).format(true).build();
    ...
    @Test(timeout = 30000)
    public void testSetrepLow_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_MIN_KEY, 2);
        MiniDFSClusterInJVM.Builder builder = new MiniDFSClusterInJVM.Builder(conf);
        MiniDFSClusterInJVM cluster = builder.numDataNodes(2).format(true).build();
    ...
    @Test(timeout = 30000)
    public void testSetrepLow_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_REPLICATION_MIN_KEY, 2);
        MiniDFSClusterInJVM.Builder builder = new MiniDFSClusterInJVM.Builder(conf);
        MiniDFSClusterInJVM cluster = builder.numDataNodes(2).format(true).build();
    ...
    @Test(timeout = 30000)
    public void testSetrep_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testSetrep_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testSetrep_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 30000)
    public void testSetrep_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).format(true).build();
        FsShell shell = null;
        FileSystem fs = null;
    ...
    @Test(timeout = 300000)
    public void testAppendToFile_withUpgrade20() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendtoFileDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFile_withUpgrade40() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendtoFileDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFile_withUpgrade60() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendtoFileDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFile_withUpgrade80() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendtoFileDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFileBadArgs_withUpgrade20() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendToFileBadArgsDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFileBadArgs_withUpgrade40() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendToFileBadArgsDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFileBadArgs_withUpgrade60() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendToFileBadArgsDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 300000)
    public void testAppendToFileBadArgs_withUpgrade80() throws Exception {
        final int inputFileLength = 1024 * 1024;
        File testRoot = new File(TEST_ROOT_DIR, "testAppendToFileBadArgsDir");
        testRoot.mkdirs();
        File file1 = new File(testRoot, "file1");
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermission_withUpgrade20() throws Exception {
        UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermission_withUpgrade40() throws Exception {
        UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermission_withUpgrade60() throws Exception {
        UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testSetXAttrCaseSensitivity_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
            final Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSetXAttrCaseSensitivity_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
            final Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSetXAttrCaseSensitivity_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
            final Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSetXAttrCaseSensitivity_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        PrintStream bak = null;
        try {
            final Configuration conf = new HdfsConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermissionAsDifferentOwner_withUpgrade20() throws Exception {
        final String USER1 = "user1";
        final String GROUP1 = "supergroup";
        final UserGroupInformation user1 = UserGroupInformation.createUserForTesting(USER1, new String[] { GROUP1 });
        final UserGroupInformation user2 = UserGroupInformation.createUserForTesting("user2", new String[] { "mygroup2" });
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermissionAsDifferentOwner_withUpgrade40() throws Exception {
        final String USER1 = "user1";
        final String GROUP1 = "supergroup";
        final UserGroupInformation user1 = UserGroupInformation.createUserForTesting(USER1, new String[] { GROUP1 });
        final UserGroupInformation user2 = UserGroupInformation.createUserForTesting("user2", new String[] { "mygroup2" });
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermissionAsDifferentOwner_withUpgrade60() throws Exception {
        final String USER1 = "user1";
        final String GROUP1 = "supergroup";
        final UserGroupInformation user1 = UserGroupInformation.createUserForTesting(USER1, new String[] { GROUP1 });
        final UserGroupInformation user2 = UserGroupInformation.createUserForTesting("user2", new String[] { "mygroup2" });
    ...
    @Test(timeout = 30000)
    public void testSetXAttrPermissionAsDifferentOwner_withUpgrade80() throws Exception {
        final String USER1 = "user1";
        final String GROUP1 = "supergroup";
        final UserGroupInformation user1 = UserGroupInformation.createUserForTesting(USER1, new String[] { GROUP1 });
        final UserGroupInformation user2 = UserGroupInformation.createUserForTesting("user2", new String[] { "mygroup2" });
    ...
    @Test(timeout = 120000)
    public void testGetFAttrErrors_withUpgrade20() throws Exception {
        final UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bakErr = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testGetFAttrErrors_withUpgrade40() throws Exception {
        final UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bakErr = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testGetFAttrErrors_withUpgrade60() throws Exception {
        final UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bakErr = null;
        try {
    ...
    @Test(timeout = 120000)
    public void testGetFAttrErrors_withUpgrade80() throws Exception {
        final UserGroupInformation user = UserGroupInformation.createUserForTesting("user", new String[] { "mygroup" });
        MiniDFSClusterInJVM cluster = null;
        PrintStream bakErr = null;
        try {
    ...
    @Test(timeout = 30000)
    public void testListReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testListReserved_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testListReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testListReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        FsShell shell = new FsShell();
    ...
    @Test(timeout = 30000)
    public void testMkdirReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testMkdirReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testMkdirReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testRmReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testRmReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testRmReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    //(timeout = 30000)
    @Test
    public void testCopyReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        final File localFile = new File(TEST_ROOT_DIR, "testFileForPut");
    ...
    //(timeout = 30000)
    @Test
    public void testCopyReserved_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        final File localFile = new File(TEST_ROOT_DIR, "testFileForPut");
    ...
    //(timeout = 30000)
    @Test
    public void testCopyReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        final File localFile = new File(TEST_ROOT_DIR, "testFileForPut");
    ...
    //(timeout = 30000)
    @Test
    public void testCopyReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        final File localFile = new File(TEST_ROOT_DIR, "testFileForPut");
    ...
    @Test(timeout = 30000)
    public void testChmodReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChmodReserved_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChmodReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChmodReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChownReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChownReserved_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChownReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testChownReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        // runCmd prints error into System.err, thus verify from there.
    ...
    @Test(timeout = 30000)
    public void testSymLinkReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testSymLinkReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testSymLinkReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        FileSystem fs = cluster.getFileSystem();
        try {
    ...
    @Test(timeout = 30000)
    public void testSnapshotReserved_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path reserved = new Path("/.reserved");
    ...
    @Test(timeout = 30000)
    public void testSnapshotReserved_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path reserved = new Path("/.reserved");
    ...
    @Test(timeout = 30000)
    public void testSnapshotReserved_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path reserved = new Path("/.reserved");
    ...
    @Test(timeout = 30000)
    public void testSnapshotReserved_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        DistributedFileSystem fs = cluster.getFileSystem();
        final Path reserved = new Path("/.reserved");
