...
public class TestDFSShell {
    ...
    public void testErrOutPut() throws Exception {
        ...
        try {
            ...
            returned = out.toString();
            assertEquals(" -mkdir returned 1", 1, ret);
            assertTrue(" -mkdir returned there is No file or directory but has testChild in the path", (returned.lastIndexOf("testChild") == -1));
            out.reset();
            argv = new String[3];
            argv[0] = "-mv";
            argv[1] = "/testfile";
    ...
    public void testChecksum() throws Exception {
        ...
        try {
            ...
            assertTrue(out.toString().contains(StringUtils.byteToHexString(checksum.getBytes(), 0, checksum.getLength())));
        } finally {
