...
public class TestReplication {
    ...
    private static class CorruptFileSimulatedFSDataset extends SimulatedFSDataset {

        /**
         * Simulated input and output streams.
         */
        static private class CorruptFileSimulatedInputStream extends java.io.InputStream {
    ...
    public void testBadBlockReportOnTransferCorruptFile() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY, CorruptFileSimulatedFSDataset.Factory.class.getName());
   ...
   */
    ...
    public void runReplication(boolean simulated) throws IOException {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).racks(racks).build();
        cluster.waitActive();
   ...
   */
    ...
    public void testPendingReplicationRetry() throws IOException {
       ...
       */
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDataNodes * 2).format(false).build();
            cluster.waitActive();
            dfsClient = new DFSClient(new InetSocketAddress("localhost", cluster.getNameNodePort()), conf);
            waitForBlockReplication(testFile, dfsClient.getNamenode(), numDataNodes, -1);
        } finally {
    ...
    private void changeBlockLen(MiniDFSClusterInJVM cluster, int lenDelta) throws IOException, InterruptedException, TimeoutException {
   ...
   */
    @Test(timeout = 30000)
    public void testBadBlockReportOnTransferCorruptFile_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY, CorruptFileSimulatedFSDataset.Factory.class.getName());
        // Disable BlockScanner to trigger reportBadBlocks
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1L);
    ...
    @Test(timeout = 30000)
    public void testBadBlockReportOnTransferCorruptFile_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY, CorruptFileSimulatedFSDataset.Factory.class.getName());
        // Disable BlockScanner to trigger reportBadBlocks
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1L);
    ...
    @Test(timeout = 30000)
    public void testBadBlockReportOnTransferCorruptFile_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY, CorruptFileSimulatedFSDataset.Factory.class.getName());
        // Disable BlockScanner to trigger reportBadBlocks
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1L);
    ...
    @Test(timeout = 30000)
    public void testBadBlockReportOnTransferCorruptFile_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_DATANODE_FSDATASET_FACTORY_KEY, CorruptFileSimulatedFSDataset.Factory.class.getName());
        // Disable BlockScanner to trigger reportBadBlocks
        conf.setLong(DFSConfigKeys.DFS_DATANODE_SCAN_PERIOD_HOURS_KEY, -1L);
    ...
    @Test
    public void testPendingReplicationRetry_withUpgrade20() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        int numDataNodes = 4;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
    ...
    @Test
    public void testPendingReplicationRetry_withUpgrade40() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        int numDataNodes = 4;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
    ...
    @Test
    public void testPendingReplicationRetry_withUpgrade60() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        int numDataNodes = 4;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
    ...
    @Test
    public void testPendingReplicationRetry_withUpgrade80() throws IOException {
        MiniDFSClusterInJVM cluster = null;
        int numDataNodes = 4;
        String testFile = "/replication-test-file";
        Path testPath = new Path(testFile);
    ...
    @Test
    public void testReplicateLenMismatchedBlock_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(2).build();
        try {
            cluster.waitActive();
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testReplicateLenMismatchedBlock_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(2).build();
        try {
            cluster.waitActive();
            // test truncated block
    ...
    @Test
    public void testReplicateLenMismatchedBlock_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).numDataNodes(2).build();
        try {
            cluster.waitActive();
            // test truncated block
