...
public class TestDFSAdmin {
    ...
    public void setUp() throws Exception {
        ...
        conf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, GenericTestUtils.getRandomizedTempPath());
        restartCluster();
    ...
    private void getReconfigurableProperties(String nodeType, String address, final List<String> outs, final List<String> errs) throws IOException, InterruptedException {
        reconfigurationOutErrFormatter("getReconfigurableProperties", nodeType, address, outs, errs);
    }

    private void getReconfigurationStatus(String nodeType, String address, final List<String> outs, final List<String> errs) throws IOException, InterruptedException {
        reconfigurationOutErrFormatter("getReconfigurationStatus", nodeType, address, outs, errs);
    }

    private void reconfigurationOutErrFormatter(String methodName, String nodeType, String address, final List<String> outs, final List<String> errs) throws IOException, InterruptedException {
    ...
    public void testTriggerBlockReport() throws Exception {
        ...
        final String dnAddr = String.format("%s:%d", dn.getXferAddress().getHostString(), dn.getIpcPort());
        final String nnAddr = nn.getHostAndPort();
        resetStream();
        final List<String> outs = Lists.newArrayList();
        final int ret = ToolRunner.run(dfsAdmin, new String[] { "-triggerBlockReport", dnAddr, "-incremental", "-namenode", nnAddr });
        assertEquals(0, ret);
        scanIntoList(out, outs);
        assertEquals(1, outs.size());
        assertThat(outs.get(0), is(allOf(containsString("Triggering an incremental block report on "), containsString(" to namenode "))));
    }
   ...
   */
    ...
    public void testPrintTopology() throws Exception {
        ...
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(dfsConf).numDataNodes(numDn).racks(racks).build()) {
    ...
    public void testPrintTopologyWithStatus() throws Exception {
        ...
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(dfsConf).numDataNodes(numDn).racks(racks).build()) {
            miniCluster.waitActive();
            assertEquals(numDn, miniCluster.getDataNodes().size());
            DatanodeManagerJVMInterface dm = miniCluster.getNameNode().getNamesystem().getBlockManager().getDatanodeManager();
            DatanodeDescriptorJVMInterface maintenanceNode = dm.getDatanode(miniCluster.getDataNodes().get(1).getDatanodeId());
            maintenanceNode.setInMaintenance();
            DatanodeDescriptorJVMInterface demissionNode = dm.getDatanode(miniCluster.getDataNodes().get(2).getDatanodeId());
   ...
   */
    ...
    private void waitForCorruptBlock(MiniDFSClusterInJVM miniCluster, DFSClient client, Path file) throws TimeoutException, InterruptedException {
        GenericTestUtils.waitFor(new Supplier<Boolean>() {
   ...
   */
    ...
    public void testListOpenFiles() throws Exception {
        ...
        try (MiniDFSClusterInJVM miniCluster = new MiniDFSClusterInJVM.Builder(dfsConf).numDataNodes(numDataNodes).build()) {
            final short replFactor = 1;
            final long fileLength = 512L;
    ...
    @Test(timeout = 30000)
    public void testGetDatanodeInfo_withUpgrade20() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testGetDatanodeInfo_withUpgrade40() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testGetDatanodeInfo_withUpgrade60() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testGetDatanodeInfo_withUpgrade80() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testTriggerBlockReport_withUpgrade20() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
        final NameNodeJVMInterface nn = cluster.getNameNode();
    ...
    @Test(timeout = 30000)
    public void testTriggerBlockReport_withUpgrade40() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
        final NameNodeJVMInterface nn = cluster.getNameNode();
    ...
    @Test(timeout = 30000)
    public void testTriggerBlockReport_withUpgrade60() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
        final NameNodeJVMInterface nn = cluster.getNameNode();
    ...
    @Test(timeout = 30000)
    public void testTriggerBlockReport_withUpgrade80() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        final DataNodeJVMInterface dn = cluster.getDataNodes().get(0);
        final NameNodeJVMInterface nn = cluster.getNameNode();
    ...
    @Test(timeout = 30000)
    public void testGetVolumeReport_withUpgrade20() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testGetVolumeReport_withUpgrade40() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testGetVolumeReport_withUpgrade60() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testGetVolumeReport_withUpgrade80() throws Exception {
        redirectStream();
        final DFSAdmin dfsAdmin = new DFSAdmin(conf);
        for (int i = 0; i < cluster.getDataNodes().size(); i++) {
            resetStream();
    ...
    @Test(timeout = 30000)
    public void testPrintTopology_withUpgrade20() throws Exception {
        redirectStream();
        /* init conf */
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
    ...
    @Test(timeout = 30000)
    public void testPrintTopology_withUpgrade40() throws Exception {
        redirectStream();
        /* init conf */
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
    ...
    @Test(timeout = 30000)
    public void testPrintTopology_withUpgrade60() throws Exception {
        redirectStream();
        /* init conf */
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
    ...
    @Test(timeout = 30000)
    public void testPrintTopology_withUpgrade80() throws Exception {
        redirectStream();
        /* init conf */
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
    ...
    @Test(timeout = 30000)
    public void testPrintTopologyWithStatus_withUpgrade20() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
        dfsConf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, baseDir.getAbsolutePath());
    ...
    @Test(timeout = 30000)
    public void testPrintTopologyWithStatus_withUpgrade40() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
        dfsConf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, baseDir.getAbsolutePath());
    ...
    @Test(timeout = 30000)
    public void testPrintTopologyWithStatus_withUpgrade60() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
        dfsConf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, baseDir.getAbsolutePath());
    ...
    @Test(timeout = 30000)
    public void testPrintTopologyWithStatus_withUpgrade80() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        final File baseDir = new File(PathUtils.getTestDir(getClass()), GenericTestUtils.getMethodName());
        dfsConf.set(MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR, baseDir.getAbsolutePath());
    ...
    @Test(timeout = 300000L)
    public void testListOpenFiles_withUpgrade20() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        dfsConf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 500);
        dfsConf.setLong(DFS_HEARTBEAT_INTERVAL_KEY, 1);
    ...
    @Test(timeout = 300000L)
    public void testListOpenFiles_withUpgrade40() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        dfsConf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 500);
        dfsConf.setLong(DFS_HEARTBEAT_INTERVAL_KEY, 1);
    ...
    @Test(timeout = 300000L)
    public void testListOpenFiles_withUpgrade60() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        dfsConf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 500);
        dfsConf.setLong(DFS_HEARTBEAT_INTERVAL_KEY, 1);
    ...
    @Test(timeout = 300000L)
    public void testListOpenFiles_withUpgrade80() throws Exception {
        redirectStream();
        final Configuration dfsConf = new HdfsConfiguration();
        dfsConf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 500);
        dfsConf.setLong(DFS_HEARTBEAT_INTERVAL_KEY, 1);
    ...
    @Test(timeout = 300000L)
    public void testCheckNumOfBlocksInReportCommand_withUpgrade20() throws Exception {
        DistributedFileSystem dfs = cluster.getFileSystem();
        Path path = new Path("/tmp.txt");
        DatanodeInfo[] dn = dfs.getDataNodeStats();
        assertEquals(dn.length, NUM_DATANODES);
    ...
    @Test(timeout = 300000L)
    public void testCheckNumOfBlocksInReportCommand_withUpgrade40() throws Exception {
        DistributedFileSystem dfs = cluster.getFileSystem();
        Path path = new Path("/tmp.txt");
        DatanodeInfo[] dn = dfs.getDataNodeStats();
        assertEquals(dn.length, NUM_DATANODES);
    ...
    @Test(timeout = 300000L)
    public void testCheckNumOfBlocksInReportCommand_withUpgrade60() throws Exception {
        DistributedFileSystem dfs = cluster.getFileSystem();
        Path path = new Path("/tmp.txt");
        DatanodeInfo[] dn = dfs.getDataNodeStats();
        assertEquals(dn.length, NUM_DATANODES);
    ...
    @Test
    public void testRefreshProxyUser_withUpgrade20() throws Exception {
        Path dirPath = new Path("/testdir1");
        Path subDirPath = new Path("/testdir1/subdir1");
        UserGroupInformation loginUserUgi = UserGroupInformation.getLoginUser();
        String proxyUser = "fakeuser";
    ...
    @Test
    public void testRefreshProxyUser_withUpgrade40() throws Exception {
        Path dirPath = new Path("/testdir1");
        Path subDirPath = new Path("/testdir1/subdir1");
        UserGroupInformation loginUserUgi = UserGroupInformation.getLoginUser();
        String proxyUser = "fakeuser";
    ...
    @Test
    public void testRefreshProxyUser_withUpgrade60() throws Exception {
        Path dirPath = new Path("/testdir1");
        Path subDirPath = new Path("/testdir1/subdir1");
        UserGroupInformation loginUserUgi = UserGroupInformation.getLoginUser();
        String proxyUser = "fakeuser";
    ...
    @Test
    public void testRefreshProxyUser_withUpgrade80() throws Exception {
        Path dirPath = new Path("/testdir1");
        Path subDirPath = new Path("/testdir1/subdir1");
        UserGroupInformation loginUserUgi = UserGroupInformation.getLoginUser();
        String proxyUser = "fakeuser";
