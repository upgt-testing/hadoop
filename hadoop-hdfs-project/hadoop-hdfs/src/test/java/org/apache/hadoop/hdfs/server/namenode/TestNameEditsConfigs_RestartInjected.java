...
public class TestNameEditsConfigs_RestartInjected {
  ...
  public void testNameEditsConfigs() throws Exception {
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file2, FILE_SIZE, FILE_SIZE, BLOCK_SIZE,
          replication, SEED);
      RestartFramework.at("after_file2_creation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNameEditsRequiredConfigs() throws IOException {
    ...
    try {
      ...
      cluster = new MiniDFSCluster.Builder(conf)
          ...
          .manageNameDfsDirs(false)
          .build();
      RestartFramework.at("after_cluster_start_case2")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      cluster = new MiniDFSCluster.Builder(conf)
          ...
          .manageNameDfsDirs(false)
          .build();
      RestartFramework.at("after_cluster_start_case3")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNameEditsConfigsFailure() throws IOException {
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file1, FILE_SIZE, FILE_SIZE, BLOCK_SIZE,
          replication, SEED);
      RestartFramework.at("after_file1_creation_failure_test")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file2, FILE_SIZE, FILE_SIZE, BLOCK_SIZE,
          replication, SEED);
      RestartFramework.at("after_file2_creation_failure_test")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file3, FILE_SIZE, FILE_SIZE, BLOCK_SIZE,
          replication, SEED);
      RestartFramework.at("after_file3_creation_failure_test")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try {
      ...
      DFSTestUtil.createFile(fileSys, file3, FILE_SIZE, FILE_SIZE, BLOCK_SIZE,
          replication, SEED);
      RestartFramework.at("after_file3_recreation")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
