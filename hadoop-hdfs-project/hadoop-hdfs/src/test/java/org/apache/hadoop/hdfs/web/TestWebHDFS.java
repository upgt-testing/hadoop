...
public class TestWebHDFS {
    ...
    public static class MockWebHdfsServlet extends HttpServlet {
        ...
        private static final String RANDOM_EXCEPTION_MSG = "This is a random exception";
        ...
        public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if (respondTimes == 0) {
                Exception mockException = new IllegalArgumentException("Invalid value for webhdfs parameter \"op\". " + "" + "No enum constant " + param);
        ...
        private void sendResponse(HttpServletRequest request, HttpServletResponse response) throws IOException {
            ...
            LocatedBlocks locatedblocks = new LocatedBlocks(10, false, ls, l1, true, null);
            try (PrintWriter pw = response.getWriter()) {
                pw.write(JsonUtil.toJsonString(locatedblocks));
            }
        }

        private void sendException(HttpServletRequest request, HttpServletResponse response, Exception mockException) throws IOException {
    ...
    public void testGetFileBlockLocationsBackwardsCompatibility() throws Exception {
        ...
        try {
            ...
            verify(spyFs, times(2)).getFileBlockLocations(any(GetOpParam.Op.class), any(Path.class), anyLong(), anyLong());
            ...
            try {
                ...
                verify(spyFs, times(3)).getFileBlockLocations(any(GetOpParam.Op.class), any(Path.class), anyLong(), anyLong());
            }
        } finally {
            if (http != null) {
                http.stop();
