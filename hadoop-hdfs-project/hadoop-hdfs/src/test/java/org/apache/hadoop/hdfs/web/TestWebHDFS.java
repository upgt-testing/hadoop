...
public class TestWebHDFS {
    ...
    public void testExceedingFileSpaceQuota() throws Exception {
        ...
        final byte[] data = new byte[1 << 20];
        RANDOM.nextBytes(data);
        cluster.getFileSystem().setQuota(dir, HdfsConstants.QUOTA_DONT_SET, spaceQuota);
        final Path p = new Path(dir, "file");
    ...
    public void testSnapshotInContentSummary() throws Exception {
        ...
        assertEquals(dfs.getContentSummary(dirPath), webHdfs.getContentSummary(dirPath));
    }
    ...
    public void testSetQuota() throws Exception {
        ...
        LambdaTestUtils.intercept(IllegalArgumentException.class, () -> webHdfs.setQuota(path, -100, 100));
        LambdaTestUtils.intercept(IllegalArgumentException.class, () -> webHdfs.setQuota(path, 100, -100));
        LambdaTestUtils.intercept(IllegalArgumentException.class, () -> webHdfs.setQuotaByStorageType(path, StorageType.SSD, -100));
        LambdaTestUtils.intercept(IllegalArgumentException.class, () -> webHdfs.setQuotaByStorageType(path, null, 100));
        LambdaTestUtils.intercept(IllegalArgumentException.class, () -> webHdfs.setQuotaByStorageType(path, StorageType.SSD, -100));
        LambdaTestUtils.intercept(IllegalArgumentException.class, () -> webHdfs.setQuotaByStorageType(path, StorageType.RAM_DISK, 100));
    }
   ...
   */
    ...
    public void testWebHdfsSps() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).storageTypes(new StorageType[][] { { StorageType.DISK, StorageType.ARCHIVE } }).storagesPerDatanode(2).numDataNodes(1).build();
            cluster.waitActive();
            sps.init(new ExternalSPSContext(sps, DFSTestUtil.getNameNodeConnector(conf, HdfsServerConstants.MOVER_ID_PATH, 1, false)));
   ...
   */
    ...
    public void testStatistics() throws Exception {
        ...
        try {
            ...
            long opCount = getOpStatistics(DFSOpsCountStatistics.OpType.GET_STORAGE_POLICY);
            webHdfs.getStoragePolicy(dir);
            checkStatistics(webHdfs, ++readOps, writeOps, 0);
            checkOpStatistics(DFSOpsCountStatistics.OpType.GET_STORAGE_POLICY, opCount + 1);
            opCount = getOpStatistics(DFSOpsCountStatistics.OpType.GET_STORAGE_POLICIES);
            webHdfs.getAllStoragePolicies();
            checkStatistics(webHdfs, ++readOps, writeOps, 0);
            checkOpStatistics(DFSOpsCountStatistics.OpType.GET_STORAGE_POLICIES, opCount + 1);
            opCount = getOpStatistics(DFSOpsCountStatistics.OpType.SATISFY_STORAGE_POLICY);
            webHdfs.satisfyStoragePolicy(dir);
            checkStatistics(webHdfs, readOps, ++writeOps, 0);
            checkOpStatistics(DFSOpsCountStatistics.OpType.SATISFY_STORAGE_POLICY, opCount + 1);
            opCount = getOpStatistics(DFSOpsCountStatistics.OpType.GET_SNAPSHOTTABLE_DIRECTORY_LIST);
            webHdfs.getSnapshottableDirectoryList();
            checkStatistics(webHdfs, ++readOps, writeOps, 0);
            checkOpStatistics(DFSOpsCountStatistics.OpType.GET_SNAPSHOTTABLE_DIRECTORY_LIST, opCount + 1);
        } finally {
            cluster.shutdown();
        }
    }
    ...
    @Test(timeout = 300000)
    public void testLargeDirectory_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int listLimit = 2;
        // force small chunking of directory listing
        conf.setInt(DFSConfigKeys.DFS_LIST_LIMIT, listLimit);
    ...
    @Test(timeout = 300000)
    public void testLargeDirectory_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int listLimit = 2;
        // force small chunking of directory listing
        conf.setInt(DFSConfigKeys.DFS_LIST_LIMIT, listLimit);
    ...
    @Test(timeout = 300000)
    public void testLargeDirectory_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int listLimit = 2;
        // force small chunking of directory listing
        conf.setInt(DFSConfigKeys.DFS_LIST_LIMIT, listLimit);
    ...
    @Test(timeout = 300000)
    public void testLargeDirectory_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int listLimit = 2;
        // force small chunking of directory listing
        conf.setInt(DFSConfigKeys.DFS_LIST_LIMIT, listLimit);
    ...
    @Test
    public void testExceedingFileSpaceQuota_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        long spaceQuota = 50L << 20;
        long fileLength = 80L << 20;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testExceedingFileSpaceQuota_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        long spaceQuota = 50L << 20;
        long fileLength = 80L << 20;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testExceedingFileSpaceQuota_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        long spaceQuota = 50L << 20;
        long fileLength = 80L << 20;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test(timeout = 300000)
    public void testCustomizedUserAndGroupNames_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        // Modify username pattern to allow numeric usernames
        conf.set(HdfsClientConfigKeys.DFS_WEBHDFS_USER_PATTERN_KEY, "^[A-Za-z0-9_][A-Za-z0-9" + "._-]*[$]?$");
    ...
    @Test(timeout = 300000)
    public void testCustomizedUserAndGroupNames_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        // Modify username pattern to allow numeric usernames
        conf.set(HdfsClientConfigKeys.DFS_WEBHDFS_USER_PATTERN_KEY, "^[A-Za-z0-9_][A-Za-z0-9" + "._-]*[$]?$");
    ...
    @Test(timeout = 300000)
    public void testCustomizedUserAndGroupNames_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        // Modify username pattern to allow numeric usernames
        conf.set(HdfsClientConfigKeys.DFS_WEBHDFS_USER_PATTERN_KEY, "^[A-Za-z0-9_][A-Za-z0-9" + "._-]*[$]?$");
    ...
    @Test(timeout = 300000)
    public void testCustomizedUserAndGroupNames_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_ACLS_ENABLED_KEY, true);
        // Modify username pattern to allow numeric usernames
        conf.set(HdfsClientConfigKeys.DFS_WEBHDFS_USER_PATTERN_KEY, "^[A-Za-z0-9_][A-Za-z0-9" + "._-]*[$]?$");
    ...
    @Test(timeout = 300000)
    public void testCreateWithNoDN_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            cluster.restartNodeForTesting(0);
    ...
    @Test(timeout = 300000)
    public void testCreateWithNoDN_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
    ...
    @Test(timeout = 300000)
    public void testCreateWithNoDN_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
    ...
    @Test(timeout = 300000)
    public void testCreateWithNoDN_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            conf.setInt(DFSConfigKeys.DFS_REPLICATION_KEY, 1);
    ...
    @Test
    public void testWebHdfsAllowandDisallowSnapshots_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsAllowandDisallowSnapshots_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsAllowandDisallowSnapshots_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsAllowandDisallowSnapshots_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testWebHdfsErasureCodingFiles_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testWebHdfsErasureCodingFiles_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testWebHdfsErasureCodingFiles_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test(timeout = 60000)
    public void testWebHdfsErasureCodingFiles_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsCreateSnapshot_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsCreateSnapshot_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsCreateSnapshot_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsCreateSnapshot_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsDeleteSnapshot_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsDeleteSnapshot_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsDeleteSnapshot_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsDeleteSnapshot_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshotDiff_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshotDiff_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshotDiff_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshotDiff_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshottableDirectoryList_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshottableDirectoryList_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshottableDirectoryList_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSnapshottableDirectoryList_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsCreateNonRecursive_withUpgrade20() throws IOException, URISyntaxException {
        final Configuration conf = WebHdfsTestUtil.createConf();
        WebHdfsFileSystem webHdfs = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testWebHdfsCreateNonRecursive_withUpgrade40() throws IOException, URISyntaxException {
        final Configuration conf = WebHdfsTestUtil.createConf();
        WebHdfsFileSystem webHdfs = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testWebHdfsCreateNonRecursive_withUpgrade60() throws IOException, URISyntaxException {
        final Configuration conf = WebHdfsTestUtil.createConf();
        WebHdfsFileSystem webHdfs = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testWebHdfsCreateNonRecursive_withUpgrade80() throws IOException, URISyntaxException {
        final Configuration conf = WebHdfsTestUtil.createConf();
        WebHdfsFileSystem webHdfs = null;
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test
    public void testWebHdfsRenameSnapshot_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsRenameSnapshot_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsRenameSnapshot_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsRenameSnapshot_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testRaceWhileNNStartup_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final NameNodeJVMInterface namenode = cluster.getNameNode();
    ...
    @Test
    public void testRaceWhileNNStartup_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final NameNodeJVMInterface namenode = cluster.getNameNode();
    ...
    @Test
    public void testRaceWhileNNStartup_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final NameNodeJVMInterface namenode = cluster.getNameNode();
    ...
    @Test
    public void testRaceWhileNNStartup_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final NameNodeJVMInterface namenode = cluster.getNameNode();
    ...
    @Test
    public void testDTInInsecureClusterWithFallback_withUpgrade20() throws IOException, URISyntaxException {
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(CommonConfigurationKeys.IPC_CLIENT_FALLBACK_TO_SIMPLE_AUTH_ALLOWED_KEY, true);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final FileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testDTInInsecureClusterWithFallback_withUpgrade60() throws IOException, URISyntaxException {
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(CommonConfigurationKeys.IPC_CLIENT_FALLBACK_TO_SIMPLE_AUTH_ALLOWED_KEY, true);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final FileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testDTInInsecureCluster_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testDTInInsecureCluster_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            final FileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testDTInInsecureCluster_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            final FileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testDTInInsecureCluster_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
            final FileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testWebHdfsOffsetAndLength_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
        final String PATH = "/foo";
    ...
    @Test
    public void testWebHdfsOffsetAndLength_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
        final String PATH = "/foo";
    ...
    @Test
    public void testWebHdfsOffsetAndLength_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
        final String PATH = "/foo";
    ...
    @Test
    public void testWebHdfsOffsetAndLength_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
        final String PATH = "/foo";
    ...
    @Test
    public void testContentSummary_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/QuotaDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testContentSummary_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/QuotaDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testContentSummary_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/QuotaDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testContentSummary_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/QuotaDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testSnapshotInContentSummary_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        Path dirPath = new Path("/dir");
        final Path filePath = new Path("/dir/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testSnapshotInContentSummary_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        Path dirPath = new Path("/dir");
        final Path filePath = new Path("/dir/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testSnapshotInContentSummary_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        Path dirPath = new Path("/dir");
        final Path filePath = new Path("/dir/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testSnapshotInContentSummary_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        Path dirPath = new Path("/dir");
        final Path filePath = new Path("/dir/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testQuotaUsage_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testQuotaUsage_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testQuotaUsage_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testQuotaUsage_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testSetQuota_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testSetQuota_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testSetQuota_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testWebHdfsPread_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        byte[] content = new byte[1024];
        RANDOM.nextBytes(content);
    ...
    @Test
    public void testWebHdfsPread_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        byte[] content = new byte[1024];
        RANDOM.nextBytes(content);
    ...
    @Test
    public void testWebHdfsPread_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        byte[] content = new byte[1024];
        RANDOM.nextBytes(content);
    ...
    @Test
    public void testWebHdfsPread_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        byte[] content = new byte[1024];
        RANDOM.nextBytes(content);
    ...
    @Test(timeout = 30000)
    public void testGetHomeDirectory_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        cluster.waitActive();
        DistributedFileSystem hdfs = cluster.getFileSystem();
    ...
    @Test(timeout = 30000)
    public void testGetHomeDirectory_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        cluster.waitActive();
        DistributedFileSystem hdfs = cluster.getFileSystem();
    ...
    @Test(timeout = 30000)
    public void testGetHomeDirectory_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        cluster.waitActive();
        DistributedFileSystem hdfs = cluster.getFileSystem();
    ...
    @Test(timeout = 30000)
    public void testGetHomeDirectory_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).build();
        cluster.waitActive();
        DistributedFileSystem hdfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsGetBlockLocationsWithStorageType_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
        final Path PATH = new Path("/foo");
    ...
    @Test
    public void testWebHdfsGetBlockLocationsWithStorageType_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
        final Path PATH = new Path("/foo");
    ...
    @Test
    public void testWebHdfsGetBlockLocations_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int offset = 42;
        final int length = 512;
        final Path path = new Path("/foo");
    ...
    @Test
    public void testWebHdfsGetBlockLocations_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int offset = 42;
        final int length = 512;
        final Path path = new Path("/foo");
    ...
    @Test
    public void testWebHdfsGetBlockLocations_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int offset = 42;
        final int length = 512;
        final Path path = new Path("/foo");
    ...
    @Test
    public void testWebHdfsGetBlockLocations_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int offset = 42;
        final int length = 512;
        final Path path = new Path("/foo");
    ...
    @Test(timeout = 90000)
    public void testWebHdfsReadRetries_withUpgrade20() throws Exception {
        // ((Log4JLogger)DFSClient.LOG).getLogger().setLevel(Level.ALL);
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testWebHdfsReadRetries");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
    ...
    @Test(timeout = 90000)
    public void testWebHdfsReadRetries_withUpgrade40() throws Exception {
        // ((Log4JLogger)DFSClient.LOG).getLogger().setLevel(Level.ALL);
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testWebHdfsReadRetries");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
    ...
    @Test(timeout = 90000)
    public void testWebHdfsReadRetries_withUpgrade60() throws Exception {
        // ((Log4JLogger)DFSClient.LOG).getLogger().setLevel(Level.ALL);
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testWebHdfsReadRetries");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
    ...
    @Test(timeout = 90000)
    public void testWebHdfsReadRetries_withUpgrade80() throws Exception {
        // ((Log4JLogger)DFSClient.LOG).getLogger().setLevel(Level.ALL);
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testWebHdfsReadRetries");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
     ...
     * redirect) is a 200 with JSON that contains the redirected location
     */
    void testWebHdfsNoRedirect_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        LOG.info("Started cluster");
        InetSocketAddress addr = cluster.getNameNode().getHttpAddress();
     ...
     * redirect) is a 200 with JSON that contains the redirected location
     */
    void testWebHdfsNoRedirect_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        LOG.info("Started cluster");
        InetSocketAddress addr = cluster.getNameNode().getHttpAddress();
     ...
     * redirect) is a 200 with JSON that contains the redirected location
     */
    void testWebHdfsNoRedirect_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        LOG.info("Started cluster");
        InetSocketAddress addr = cluster.getNameNode().getHttpAddress();
     ...
     * redirect) is a 200 with JSON that contains the redirected location
     */
    void testWebHdfsNoRedirect_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
        LOG.info("Started cluster");
        InetSocketAddress addr = cluster.getNameNode().getHttpAddress();
    ...
    @Test
    public void testGetTrashRoot_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final String currentUser = UserGroupInformation.getCurrentUser().getShortUserName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testGetTrashRoot_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final String currentUser = UserGroupInformation.getCurrentUser().getShortUserName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testGetTrashRoot_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final String currentUser = UserGroupInformation.getCurrentUser().getShortUserName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testGetTrashRoot_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final String currentUser = UserGroupInformation.getCurrentUser().getShortUserName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testStoragePolicy_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testStoragePolicy_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testStoragePolicy_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testStoragePolicy_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/file");
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testSetStoragePolicyWhenPolicyDisabled_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testSetStoragePolicyWhenPolicyDisabled_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testSetStoragePolicyWhenPolicyDisabled_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testSetStoragePolicyWhenPolicyDisabled_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        conf.setBoolean(DFSConfigKeys.DFS_STORAGE_POLICY_ENABLED_KEY, false);
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        try {
    ...
    @Test
    public void testECPolicyCommands_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testECPolicyCommands_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testECPolicyCommands_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testECPolicyCommands_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testWebHdfsSps_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testWebHdfsSps_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testWebHdfsSps_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testWebHdfsSps_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testWebHdfsAppend_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int dnNumber = 3;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(dnNumber).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testWebHdfsAppend_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int dnNumber = 3;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(dnNumber).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testWebHdfsAppend_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int dnNumber = 3;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(dnNumber).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testWebHdfsAppend_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int dnNumber = 3;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(dnNumber).build();
        final WebHdfsFileSystem webFS = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
    ...
    @Test
    public void testFsserverDefaults_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        // doesn't pick up the default value.
        long blockSize = 256 * 1024 * 1024;
        int bytesPerChecksum = 256;
    ...
    @Test
    public void testFsserverDefaults_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        // doesn't pick up the default value.
        long blockSize = 256 * 1024 * 1024;
        int bytesPerChecksum = 256;
    ...
    @Test
    public void testFsserverDefaults_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        // doesn't pick up the default value.
        long blockSize = 256 * 1024 * 1024;
        int bytesPerChecksum = 256;
    ...
    @Test
    public void testFsserverDefaults_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        // doesn't pick up the default value.
        long blockSize = 256 * 1024 * 1024;
        int bytesPerChecksum = 256;
    ...
    @Test
    public void testExceptionPropogationInAbstractRunner_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testExceptionPropogationInAbstractRunner");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
        final short numDatanodes = 1;
    ...
    @Test
    public void testExceptionPropogationInAbstractRunner_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testExceptionPropogationInAbstractRunner");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
        final short numDatanodes = 1;
    ...
    @Test
    public void testExceptionPropogationInAbstractRunner_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testExceptionPropogationInAbstractRunner");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
        final short numDatanodes = 1;
    ...
    @Test
    public void testExceptionPropogationInAbstractRunner_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path dir = new Path("/testExceptionPropogationInAbstractRunner");
        conf.setBoolean(HdfsClientConfigKeys.Retry.POLICY_ENABLED_KEY, true);
        final short numDatanodes = 1;
    ...
    @Test(timeout = 300000)
    public void testECPolicyInFileStatus_withUpgrade20() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        final String ecPolicyName = ecPolicy.getName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(5).build();
    ...
    @Test(timeout = 300000)
    public void testECPolicyInFileStatus_withUpgrade40() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        final String ecPolicyName = ecPolicy.getName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(5).build();
    ...
    @Test(timeout = 300000)
    public void testECPolicyInFileStatus_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        final String ecPolicyName = ecPolicy.getName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(5).build();
    ...
    @Test(timeout = 300000)
    public void testECPolicyInFileStatus_withUpgrade80() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        final ErasureCodingPolicy ecPolicy = SystemErasureCodingPolicies.getByID(SystemErasureCodingPolicies.RS_3_2_POLICY_ID);
        final String ecPolicyName = ecPolicy.getName();
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(5).build();
    ...
    @Test
    public void testStatistics_withUpgrade20() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testStatistics_withUpgrade40() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testStatistics_withUpgrade60() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
    ...
    @Test
    public void testStatistics_withUpgrade80() throws Exception {
        final Configuration conf = new HdfsConfiguration();
        conf.set(DFSConfigKeys.DFS_STORAGE_POLICY_SATISFIER_MODE_KEY, StoragePolicySatisfierMode.EXTERNAL.toString());
        StoragePolicySatisfier sps = new StoragePolicySatisfier(conf);
        try {
