...
public class TestWebHDFS {
    ...
    public void testCustomizedUserAndGroupNames() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        try {
            cluster.waitActive();
            WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME).setPermission(new Path("/"), new FsPermission(FsAction.ALL, FsAction.ALL, FsAction.ALL));
    ...
    public void testWebHdfsReadRetries() throws Exception {
        ...
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDatanodes).build();
        try {
            cluster.waitActive();
            final FileSystem fs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
            //create a file
   ...
   */
    ...
    public void testECPolicyCommands() throws Exception {
        Configuration conf = new HdfsConfiguration();
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(0).build()) {
            cluster.waitActive();
            final DistributedFileSystem dfs = cluster.getFileSystem();
            final WebHdfsFileSystem webHdfs = WebHdfsTestUtil.getWebHdfsFileSystem(conf, WebHdfsConstants.WEBHDFS_SCHEME);
   ...
   */
    ...
    public void testECPolicyInFileStatus() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(5).build();
        cluster.waitActive();
        final DistributedFileSystem fs = cluster.getFileSystem();
    ...
    @Test
    public void testExceedingFileSpaceQuota_withUpgrade60() throws Exception {
        final Configuration conf = WebHdfsTestUtil.createConf();
        long spaceQuota = 50L << 20;
        long fileLength = 80L << 20;
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(3).build();
    ...
    @Test
    public void testDTInInsecureClusterWithFallback_withUpgrade80() throws IOException, URISyntaxException {
        MiniDFSClusterInJVM cluster = null;
        final Configuration conf = WebHdfsTestUtil.createConf();
        conf.setBoolean(CommonConfigurationKeys.IPC_CLIENT_FALLBACK_TO_SIMPLE_AUTH_ALLOWED_KEY, true);
        try {
    ...
    @Test
    public void testSetQuota_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final Configuration conf = WebHdfsTestUtil.createConf();
        final Path path = new Path("/TestDir");
        try {
    ...
    @Test
    public void testWebHdfsGetBlockLocationsWithStorageType_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
    ...
    @Test
    public void testWebHdfsGetBlockLocationsWithStorageType_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        final Configuration conf = WebHdfsTestUtil.createConf();
        final int OFFSET = 42;
        final int LENGTH = 512;
