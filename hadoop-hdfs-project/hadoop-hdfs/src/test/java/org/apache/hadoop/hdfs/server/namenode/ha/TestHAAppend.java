...
public class TestHAAppend {
    ...
    @Test
    public void testMultipleAppendsDuringCatchupTailing_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // control the ingest of edits by the standby for this test.
        conf.set(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, "5000");
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, -1);
    ...
    @Test
    public void testMultipleAppendsDuringCatchupTailing_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // control the ingest of edits by the standby for this test.
        conf.set(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, "5000");
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, -1);
    ...
    @Test
    public void testMultipleAppendsDuringCatchupTailing_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        // control the ingest of edits by the standby for this test.
        conf.set(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, "5000");
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, -1);
    ...
    @Test
    public void testMultipleAppendsDuringCatchupTailing_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // control the ingest of edits by the standby for this test.
        conf.set(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, "5000");
        conf.setInt(DFSConfigKeys.DFS_HA_LOGROLL_PERIOD_KEY, -1);
