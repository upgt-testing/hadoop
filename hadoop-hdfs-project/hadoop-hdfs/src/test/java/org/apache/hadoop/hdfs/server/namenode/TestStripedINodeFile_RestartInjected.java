 ...
 */
public class TestStripedINodeFile_RestartInjected {
  ...
  public void testDeleteOp() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_ec_policy_enabled")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_ec_dir_delete")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testUnsuitableStoragePoliciesWithECStripedMode()
    ...
    try {
      ...
      RestartFramework.at("after_dir_created")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_storage_policy_set")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
