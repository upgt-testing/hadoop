...
public class TestDFSZKFailoverController_RestartInjected extends ClientBaseWithFixes {
  ...
  public void testThreadDumpCaptureAfterNNStateChange() throws Exception {
    ...
    RestartFramework.at("after_resource_check_set")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_standby_transition")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFailoverAndBackOnNNShutdown() throws Exception {
    ...
    fs.mkdirs(p1);
    RestartFramework.at("after_mkdir_p1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_shutdown_nn0")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    fs.mkdirs(p2);
    RestartFramework.at("after_mkdir_p2")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_restart_nn0")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_shutdown_nn1")
        ...
        .execute();
    waitForHAState(0, HAServiceState.ACTIVE);
    RestartFramework.at("after_failback_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testManualFailover() throws Exception {
    ...
    RestartFramework.at("after_graceful_failover_nn2")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_graceful_failover_nn1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testManualFailoverWithDFSHAAdmin() throws Exception {
    ...
    RestartFramework.at("after_failover_nn2_to_nn1")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testElectionOnObserver() throws Exception{
    ...
    try {
      ...
      RestartFramework.at("after_cede_active")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
