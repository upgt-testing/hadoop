...
public class TestFileCreationDelete {
    ...
    @Test
    public void testFileCreationDeleteParent_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testFileCreationDeleteParent_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testFileCreationDeleteParent_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
    ...
    @Test
    public void testFileCreationDeleteParent_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        // 2s
        final int MAX_IDLE_TIME = 2000;
        conf.setInt("ipc.client.connection.maxidletime", MAX_IDLE_TIME);
