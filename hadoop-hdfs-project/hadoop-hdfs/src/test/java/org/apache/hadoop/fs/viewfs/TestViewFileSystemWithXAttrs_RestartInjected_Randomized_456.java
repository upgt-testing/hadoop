 ...
 */
public class TestViewFileSystemWithXAttrs_RestartInjected_Randomized_456 {
    ...
    public void testXAttrOnMountEntry() throws Exception {
        ...
        RestartFramework.at("after_set_xattrs_nn2").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_remove_xattrs_nn2").on(cluster).restart("namenode").withIndex(1).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_remove_xattrs_nn1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        RestartFramework.at("after_set_xattrs_nn1").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
