...
public class TestDNFencingWithReplication {
    ...
    private static class ReplicationToggler extends RepeatingTestThread {
        ...
        ReplicationToggler(TestContext ctx, FileSystem fs, Path p, MiniDFSClusterInJVM cluster) {
            super(ctx);
            this.fs = fs;
            this.path = p;
    ...
    @Test
    public void testFencingStress_withUpgrade20() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        harness.setNumberOfNameNodes(3);
        harness.conf.setInt(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        harness.conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1);
    ...
    @Test
    public void testFencingStress_withUpgrade40() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        harness.setNumberOfNameNodes(3);
        harness.conf.setInt(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        harness.conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1);
    ...
    @Test
    public void testFencingStress_withUpgrade60() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        harness.setNumberOfNameNodes(3);
        harness.conf.setInt(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        harness.conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1);
    ...
    @Test
    public void testFencingStress_withUpgrade80() throws Exception {
        HAStressTestHarness harness = new HAStressTestHarness();
        harness.setNumberOfNameNodes(3);
        harness.conf.setInt(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        harness.conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1);
