...
public class TestBlockTokenWithDFS {
    ...
    public void testRead() throws Exception {
        ...
        try {
            ...
            cluster = new MiniDFSCluster.Builder(conf).nameNodePort(ServerSocketUtil.getPort(19820, 100)).nameNodeHttpPort(ServerSocketUtil.getPort(19870, 100)).numDataNodes(numDataNodes).build();
            cluster.waitActive();
            assertEquals(numDataNodes, cluster.getDataNodes().size());
    ...
    @Test
    public void testWrite_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        int numDataNodes = 2;
        Configuration conf = getConf(numDataNodes);
        try {
    ...
    @Test
    public void testWrite_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        int numDataNodes = 2;
        Configuration conf = getConf(numDataNodes);
        try {
