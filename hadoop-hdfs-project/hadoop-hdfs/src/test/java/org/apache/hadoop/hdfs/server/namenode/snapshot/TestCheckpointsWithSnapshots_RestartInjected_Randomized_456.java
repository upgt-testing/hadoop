...
public class TestCheckpointsWithSnapshots_RestartInjected_Randomized_456 {
    ...
    public void testCheckpoint() throws IOException {
        ...
        try {
            ...
            RestartFramework.at("after_delete_snapshot_and_disallow").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            assertEquals(0, nnSnapshotManager.getNumSnapshots());
            assertEquals(0, nnSnapshotManager.getNumSnapshottableDirs());
