...
public class TestParallelImageWrite {
    ...
    public void testRestartDFS() throws Exception {
        ...
        try {
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(true).numDataNodes(NUM_DATANODES).build();
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).format(false).numDataNodes(NUM_DATANODES).build();
    ...
    public static String checkImages(FSNamesystem fsn, int numImageDirs) throws Exception {
        ...
        assertTrue("Not enough fsimage copies in MiniDFSClusterInJVM " + "to test parallel write", numImageDirs > 1);
