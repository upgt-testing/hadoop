...
public class TestSecureNNWithQJM_ProcessBased {
  ...
  public static void init() throws Exception {
    baseDir =
        GenericTestUtils.getTestDir(TestSecureNNWithQJM_ProcessBased.class.getSimpleName());
    ...
    sslConfDir = KeyStoreTestUtil.getClasspathDir(
      TestSecureNNWithQJM_ProcessBased.class);
   ...
   * @throws IOException if there is an I/O error
   */
  private void restartNameNode() throws IOException, TimeoutException {
    IOUtils.cleanupWithLogger(null, fs);
   ...
   * @throws IOException if there is an I/O error
   */
  private void startCluster() throws IOException, TimeoutException {
