 ...
 */
public class TestResolveHdfsSymlink_RestartInjected {
  ...
  public void testFcResolveAfs() throws IOException, InterruptedException {
    ...
    RestartFramework.at("before_resolve_symlink")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFcDelegationToken() throws UnsupportedFileSystemException,
    ...
    RestartFramework.at("after_renew_token")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testLinkTargetNonSymlink() throws UnsupportedFileSystemException,
    ...
    try {
      ...
      try {
        RestartFramework.at("before_get_link_target")
            .on(cluster)
            .restart("namenode")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
  ...
  public void testLinkTargetNonExistent() throws IOException {
    ...
    DFSClient client = new DFSClient(cluster.getFileSystem().getUri(),
        cluster.getConfiguration(0));
    try {
      RestartFramework.at("before_get_nonexistent_link")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
