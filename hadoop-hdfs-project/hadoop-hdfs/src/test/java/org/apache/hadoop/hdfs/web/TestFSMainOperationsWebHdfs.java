...
public class TestFSMainOperationsWebHdfs extends FSMainOperationsBaseTest {
    ...
    @Test
    public void testJsonParseClosesInputStream_withUpgrade20() throws Exception {
        final WebHdfsFileSystem webhdfs = (WebHdfsFileSystem) fileSystem;
        Path file = getTestRootPath(fSys, "test/hadoop/file");
        createFile(file);
        final HttpOpParam.Op op = GetOpParam.Op.GETHOMEDIRECTORY;
    ...
    @Test
    public void testJsonParseClosesInputStream_withUpgrade40() throws Exception {
        final WebHdfsFileSystem webhdfs = (WebHdfsFileSystem) fileSystem;
        Path file = getTestRootPath(fSys, "test/hadoop/file");
        createFile(file);
        final HttpOpParam.Op op = GetOpParam.Op.GETHOMEDIRECTORY;
    ...
    @Test
    public void testJsonParseClosesInputStream_withUpgrade60() throws Exception {
        final WebHdfsFileSystem webhdfs = (WebHdfsFileSystem) fileSystem;
        Path file = getTestRootPath(fSys, "test/hadoop/file");
        createFile(file);
        final HttpOpParam.Op op = GetOpParam.Op.GETHOMEDIRECTORY;
    ...
    @Test
    public void testJsonParseClosesInputStream_withUpgrade80() throws Exception {
        final WebHdfsFileSystem webhdfs = (WebHdfsFileSystem) fileSystem;
        Path file = getTestRootPath(fSys, "test/hadoop/file");
        createFile(file);
        final HttpOpParam.Op op = GetOpParam.Op.GETHOMEDIRECTORY;
    ...
    @Test
    public void testMkdirsFailsForSubdirectoryOfExistingFile_withUpgrade20() throws Exception {
        Path testDir = getTestRootPath(fSys, "test/hadoop");
        Assert.assertFalse(exists(fSys, testDir));
        fSys.mkdirs(testDir);
        Assert.assertTrue(exists(fSys, testDir));
    ...
    @Test
    public void testMkdirsFailsForSubdirectoryOfExistingFile_withUpgrade40() throws Exception {
        Path testDir = getTestRootPath(fSys, "test/hadoop");
        Assert.assertFalse(exists(fSys, testDir));
        fSys.mkdirs(testDir);
        Assert.assertTrue(exists(fSys, testDir));
    ...
    @Test
    public void testMkdirsFailsForSubdirectoryOfExistingFile_withUpgrade60() throws Exception {
        Path testDir = getTestRootPath(fSys, "test/hadoop");
        Assert.assertFalse(exists(fSys, testDir));
        fSys.mkdirs(testDir);
        Assert.assertTrue(exists(fSys, testDir));
    ...
    @Test
    public void testMkdirsFailsForSubdirectoryOfExistingFile_withUpgrade80() throws Exception {
        Path testDir = getTestRootPath(fSys, "test/hadoop");
        Assert.assertFalse(exists(fSys, testDir));
        fSys.mkdirs(testDir);
        Assert.assertTrue(exists(fSys, testDir));
