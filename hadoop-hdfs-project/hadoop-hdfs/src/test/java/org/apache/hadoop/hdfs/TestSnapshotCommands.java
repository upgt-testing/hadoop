...
public class TestSnapshotCommands {
    ...
    public void testMaxSnapshotLimit() throws Exception {
        ...
        cluster.restartNodeForTesting(0);
        DFSTestUtil.FsShellRun("-createSnapshot /sub3 sn3", 1, "Failed to create snapshot: there are already 3 snapshot(s) and " + "the per directory snapshot limit is 3", conf);
    }
