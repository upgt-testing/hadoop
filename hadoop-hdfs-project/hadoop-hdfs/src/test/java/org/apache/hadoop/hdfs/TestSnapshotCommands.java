...
public class TestSnapshotCommands {
    ...
    public void testAllowSnapshot() throws Exception {
        // Idempotent test
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub1", 0, "Allowing snapshot " + "on /sub1 succeeded", conf);
        // allow normal dir success
        DFSTestUtil.FsShellRun("-mkdir /sub2", conf);
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub2", 0, "Allowing snapshot " + "on /sub2 succeeded", conf);
    ...
    public void testDisallowSnapshot() throws Exception {
        ...
        DFSTestUtil.FsShellRun("-deleteSnapshot /sub1 sn1", conf);
        DFSTestUtil.DFSAdminRun("-disallowSnapshot /sub1", 0, "Disallowing snapshot on /sub1 succeeded", conf);
        // Idempotent test
        DFSTestUtil.DFSAdminRun("-disallowSnapshot /sub1", 0, "Disallowing snapshot on /sub1 succeeded", conf);
    ...
    @Test
    public void testAllowSnapshot_withUpgrade20() throws Exception {
        // Idempotent test
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub1", 0, "Allowing snapshot " + "on /sub1 succeeded", conf);
        // allow normal dir success
        DFSTestUtil.FsShellRun("-mkdir /sub2", conf);
    ...
    @Test
    public void testAllowSnapshot_withUpgrade40() throws Exception {
        // Idempotent test
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub1", 0, "Allowing snapshot " + "on /sub1 succeeded", conf);
        // allow normal dir success
        DFSTestUtil.FsShellRun("-mkdir /sub2", conf);
    ...
    @Test
    public void testAllowSnapshot_withUpgrade80() throws Exception {
        // Idempotent test
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub1", 0, "Allowing snapshot " + "on /sub1 succeeded", conf);
        // allow normal dir success
        DFSTestUtil.FsShellRun("-mkdir /sub2", conf);
    ...
    @Test
    public void testCreateSnapshot_withUpgrade20() throws Exception {
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 0, "Created snapshot /sub1/.snapshot/sn0", conf);
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 1, "there is already a snapshot with the same name \"sn0\"", conf);
        DFSTestUtil.FsShellRun("-rmr /sub1/sub1sub2", conf);
    ...
    @Test
    public void testCreateSnapshot_withUpgrade40() throws Exception {
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 0, "Created snapshot /sub1/.snapshot/sn0", conf);
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 1, "there is already a snapshot with the same name \"sn0\"", conf);
        DFSTestUtil.FsShellRun("-rmr /sub1/sub1sub2", conf);
    ...
    @Test
    public void testCreateSnapshot_withUpgrade60() throws Exception {
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 0, "Created snapshot /sub1/.snapshot/sn0", conf);
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 1, "there is already a snapshot with the same name \"sn0\"", conf);
        DFSTestUtil.FsShellRun("-rmr /sub1/sub1sub2", conf);
    ...
    @Test
    public void testCreateSnapshot_withUpgrade80() throws Exception {
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 0, "Created snapshot /sub1/.snapshot/sn0", conf);
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn0", 1, "there is already a snapshot with the same name \"sn0\"", conf);
        DFSTestUtil.FsShellRun("-rmr /sub1/sub1sub2", conf);
    ...
    @Test
    public void testMaxSnapshotLimit_withUpgrade20() throws Exception {
        DFSTestUtil.FsShellRun("-mkdir /sub3", conf);
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub3", 0, "Allowing snapshot " + "on /sub3 succeeded", conf);
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub3 sn0", 0, "Created snapshot /sub3/.snapshot/sn0", conf);
    ...
    @Test
    public void testMaxSnapshotLimit_withUpgrade40() throws Exception {
        DFSTestUtil.FsShellRun("-mkdir /sub3", conf);
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub3", 0, "Allowing snapshot " + "on /sub3 succeeded", conf);
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub3 sn0", 0, "Created snapshot /sub3/.snapshot/sn0", conf);
    ...
    @Test
    public void testMaxSnapshotLimit_withUpgrade60() throws Exception {
        DFSTestUtil.FsShellRun("-mkdir /sub3", conf);
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub3", 0, "Allowing snapshot " + "on /sub3 succeeded", conf);
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub3 sn0", 0, "Created snapshot /sub3/.snapshot/sn0", conf);
    ...
    @Test
    public void testMaxSnapshotLimit_withUpgrade80() throws Exception {
        DFSTestUtil.FsShellRun("-mkdir /sub3", conf);
        DFSTestUtil.DFSAdminRun("-allowSnapshot /sub3", 0, "Allowing snapshot " + "on /sub3 succeeded", conf);
        // test createSnapshot
        DFSTestUtil.FsShellRun("-createSnapshot /sub3 sn0", 0, "Created snapshot /sub3/.snapshot/sn0", conf);
    ...
    @Test
    public void testMkdirUsingReservedName_withUpgrade20() throws Exception {
        // test can not create dir with reserved name: .snapshot
        DFSTestUtil.FsShellRun("-ls /", conf);
        DFSTestUtil.FsShellRun("-mkdir /.snapshot", 1, "File exists", conf);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testMkdirUsingReservedName_withUpgrade40() throws Exception {
        // test can not create dir with reserved name: .snapshot
        DFSTestUtil.FsShellRun("-ls /", conf);
        DFSTestUtil.FsShellRun("-mkdir /.snapshot", 1, "File exists", conf);
        DFSTestUtil.FsShellRun("-mkdir /sub1/.snapshot", 1, "File exists", conf);
    ...
    @Test
    public void testMkdirUsingReservedName_withUpgrade60() throws Exception {
        // test can not create dir with reserved name: .snapshot
        DFSTestUtil.FsShellRun("-ls /", conf);
        DFSTestUtil.FsShellRun("-mkdir /.snapshot", 1, "File exists", conf);
        DFSTestUtil.FsShellRun("-mkdir /sub1/.snapshot", 1, "File exists", conf);
    ...
    @Test
    public void testMkdirUsingReservedName_withUpgrade80() throws Exception {
        // test can not create dir with reserved name: .snapshot
        DFSTestUtil.FsShellRun("-ls /", conf);
        DFSTestUtil.FsShellRun("-mkdir /.snapshot", 1, "File exists", conf);
        DFSTestUtil.FsShellRun("-mkdir /sub1/.snapshot", 1, "File exists", conf);
    ...
    @Test
    public void testRenameSnapshot_withUpgrade20() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn.orig", conf);
        DFSTestUtil.FsShellRun("-renameSnapshot /sub1 sn.orig sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot", 0, "/sub1/.snapshot/sn.rename", conf);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testRenameSnapshot_withUpgrade40() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn.orig", conf);
        DFSTestUtil.FsShellRun("-renameSnapshot /sub1 sn.orig sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot", 0, "/sub1/.snapshot/sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot/sn.rename", 0, "/sub1/.snapshot/sn.rename/sub1sub1", conf);
    ...
    @Test
    public void testRenameSnapshot_withUpgrade60() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn.orig", conf);
        DFSTestUtil.FsShellRun("-renameSnapshot /sub1 sn.orig sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot", 0, "/sub1/.snapshot/sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot/sn.rename", 0, "/sub1/.snapshot/sn.rename/sub1sub1", conf);
    ...
    @Test
    public void testRenameSnapshot_withUpgrade80() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn.orig", conf);
        DFSTestUtil.FsShellRun("-renameSnapshot /sub1 sn.orig sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot", 0, "/sub1/.snapshot/sn.rename", conf);
        DFSTestUtil.FsShellRun("-ls /sub1/.snapshot/sn.rename", 0, "/sub1/.snapshot/sn.rename/sub1sub1", conf);
    ...
    @Test
    public void testDeleteSnapshot_withUpgrade20() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn1", conf);
        DFSTestUtil.FsShellRun("-deleteSnapshot /sub1 sn1", conf);
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testDeleteSnapshot_withUpgrade60() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn1", conf);
        DFSTestUtil.FsShellRun("-deleteSnapshot /sub1 sn1", conf);
        DFSTestUtil.FsShellRun("-deleteSnapshot /sub1 sn1", 1, "deleteSnapshot: Cannot delete snapshot sn1 from path /sub1: the snapshot does not exist.", conf);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testDisallowSnapshot_withUpgrade20() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn1", conf);
        // cannot delete snapshotable dir
        DFSTestUtil.FsShellRun("-rmr /sub1", 1, "The directory /sub1 cannot be deleted since /sub1 is snapshottable and already has snapshots", conf);
        DFSTestUtil.DFSAdminRun("-disallowSnapshot /sub1", -1, "disallowSnapshot: The directory /sub1 has snapshot(s). Please redo the operation after removing all the snapshots.", conf);
    ...
    @Test
    public void testDisallowSnapshot_withUpgrade40() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn1", conf);
        // cannot delete snapshotable dir
        DFSTestUtil.FsShellRun("-rmr /sub1", 1, "The directory /sub1 cannot be deleted since /sub1 is snapshottable and already has snapshots", conf);
        DFSTestUtil.DFSAdminRun("-disallowSnapshot /sub1", -1, "disallowSnapshot: The directory /sub1 has snapshot(s). Please redo the operation after removing all the snapshots.", conf);
    ...
    @Test
    public void testDisallowSnapshot_withUpgrade60() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn1", conf);
        // cannot delete snapshotable dir
        DFSTestUtil.FsShellRun("-rmr /sub1", 1, "The directory /sub1 cannot be deleted since /sub1 is snapshottable and already has snapshots", conf);
        DFSTestUtil.DFSAdminRun("-disallowSnapshot /sub1", -1, "disallowSnapshot: The directory /sub1 has snapshot(s). Please redo the operation after removing all the snapshots.", conf);
    ...
    @Test
    public void testDisallowSnapshot_withUpgrade80() throws Exception {
        DFSTestUtil.FsShellRun("-createSnapshot /sub1 sn1", conf);
        // cannot delete snapshotable dir
        DFSTestUtil.FsShellRun("-rmr /sub1", 1, "The directory /sub1 cannot be deleted since /sub1 is snapshottable and already has snapshots", conf);
        DFSTestUtil.DFSAdminRun("-disallowSnapshot /sub1", -1, "disallowSnapshot: The directory /sub1 has snapshot(s). Please redo the operation after removing all the snapshots.", conf);
    ...
    @Test(timeout = 60000)
    public void testSnapshotCommandsWithURI_withUpgrade20() throws Exception {
        Configuration config = new HdfsConfiguration();
        //fs.defaultFS should not be used, when path is fully qualified.
        config.set("fs.defaultFS", "hdfs://127.0.0.1:1024");
        String path = fs.getUri() + "/Fully/QPath";
    ...
    @Test(timeout = 60000)
    public void testSnapshotCommandsWithURI_withUpgrade40() throws Exception {
        Configuration config = new HdfsConfiguration();
        //fs.defaultFS should not be used, when path is fully qualified.
        config.set("fs.defaultFS", "hdfs://127.0.0.1:1024");
        String path = fs.getUri() + "/Fully/QPath";
    ...
    @Test(timeout = 60000)
    public void testSnapshotCommandsWithURI_withUpgrade60() throws Exception {
        Configuration config = new HdfsConfiguration();
        //fs.defaultFS should not be used, when path is fully qualified.
        config.set("fs.defaultFS", "hdfs://127.0.0.1:1024");
        String path = fs.getUri() + "/Fully/QPath";
    ...
    @Test(timeout = 60000)
    public void testSnapshotCommandsWithURI_withUpgrade80() throws Exception {
        Configuration config = new HdfsConfiguration();
        //fs.defaultFS should not be used, when path is fully qualified.
        config.set("fs.defaultFS", "hdfs://127.0.0.1:1024");
        String path = fs.getUri() + "/Fully/QPath";
    ...
    @Test(timeout = 60000)
    public void testSnapshotDiff_withUpgrade20() throws Exception {
        Configuration config = new HdfsConfiguration();
        Path snapDirPath = new Path(fs.getUri().toString() + "/snap_dir");
        String snapDir = snapDirPath.toString();
        fs.mkdirs(snapDirPath);
    ...
    @Test(timeout = 60000)
    public void testSnapshotDiff_withUpgrade40() throws Exception {
        Configuration config = new HdfsConfiguration();
        Path snapDirPath = new Path(fs.getUri().toString() + "/snap_dir");
        String snapDir = snapDirPath.toString();
        fs.mkdirs(snapDirPath);
    ...
    @Test(timeout = 60000)
    public void testSnapshotDiff_withUpgrade60() throws Exception {
        Configuration config = new HdfsConfiguration();
        Path snapDirPath = new Path(fs.getUri().toString() + "/snap_dir");
        String snapDir = snapDirPath.toString();
        fs.mkdirs(snapDirPath);
    ...
    @Test(timeout = 60000)
    public void testSnapshotDiff_withUpgrade80() throws Exception {
        Configuration config = new HdfsConfiguration();
        Path snapDirPath = new Path(fs.getUri().toString() + "/snap_dir");
        String snapDir = snapDirPath.toString();
        fs.mkdirs(snapDirPath);
