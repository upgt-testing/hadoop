...
public class TestSnapshotCommands {
    ...
    public void testSnapshotDiff() throws Exception {
        ...
        DFSTestUtil.DFSAdminRun("-allowSnapshot " + snapDirPath, 0, "Allowing snaphot on " + snapDirPath + " succeeded", config);
        ...
        DFSTestUtil.DFSAdminRun("-disallowSnapshot " + snapDir, 0, "Disallowing snaphot on " + snapDirPath + " succeeded", config);
        fs.delete(new Path("/Fully/QPath"), true);
    }
