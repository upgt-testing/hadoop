...
public class TestFSEditLogLoader_RestartInjected {
  @Parameters
  ...
  public void testDisplayRecentEditLogOpCodes() throws IOException {
    ...
    RestartFramework.at("after_mkdir_operations")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
  ...
  public void testReplicationAdjusted() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_replication_adjustment")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testUpdateStripedBlocks() throws IOException{
    ...
    try {
      ...
      RestartFramework.at("after_block_addition")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testHasNonEcBlockUsingStripedIDForUpdateBlocks()
    ...
    try {
      ...
      RestartFramework.at("after_block_update")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testErasureCodingPolicyOperations() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("after_enable_policy")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("before_third_restart")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("before_fourth_restart")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
