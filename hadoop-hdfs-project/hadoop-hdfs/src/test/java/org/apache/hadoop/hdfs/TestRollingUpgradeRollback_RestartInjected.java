 ...
 */
public class TestRollingUpgradeRollback_RestartInjected {
  ...
  public void testRollbackCommand() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_storage_check")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollbackWithQJM() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_namenode_restart_rollback")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_rollback_verification")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testRollbackWithHAQJM() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_query_preparation")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      dfsCluster.transitionToActive(0);
      RestartFramework.at("after_second_active_transition")
          .on(dfsCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
