 ...
 */
public class TestCreateEditsLog_RestartInjected_Randomized_123 {
    ...
    public void testCanLoadCreatedEditsLog() throws Exception {
        ...
        RestartFramework.at("after_cluster_up").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
