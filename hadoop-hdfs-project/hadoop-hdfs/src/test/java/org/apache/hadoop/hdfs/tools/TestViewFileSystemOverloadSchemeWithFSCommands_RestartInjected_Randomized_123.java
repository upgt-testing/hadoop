 ...
 * links.
 */
public class TestViewFileSystemOverloadSchemeWithFSCommands_RestartInjected_Randomized_123 {
    ...
    public void testDFWithViewFsOverloadScheme() throws Exception {
        ...
        try {
            ...
            assertEquals(0, ret);
            RestartFramework.at("after_df_command").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
