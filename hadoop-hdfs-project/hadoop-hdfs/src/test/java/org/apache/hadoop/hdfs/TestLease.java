...
public class TestLease {
   ...
   */
    ...
    public void testFactory() throws Exception {
        ...
        Mockito.doReturn(new HdfsFileStatus(0, false, 1, 1024, 0, 0, new FsPermission((short) 777), "owner", "group", new byte[0], new byte[0], 1010, 0, null, (byte) 0)).when(mcp).getFileInfo(anyString());
        Mockito.doReturn(new HdfsFileStatus(0, false, 1, 1024, 0, 0, new FsPermission((short) 777), "owner", "group", new byte[0], new byte[0], 1010, 0, null, (byte) 0)).when(mcp).create(anyString(), (FsPermission) anyObject(), anyString(), (EnumSetWritable<CreateFlag>) anyObject(), anyBoolean(), anyShort(), anyLong(), (CryptoProtocolVersion[]) anyObject());
    ...
    @Test
    public void testLeaseAfterRename_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            Path p = new Path("/test-file");
            Path d = new Path("/test-d");
    ...
    @Test
    public void testLeaseAfterRename_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            Path p = new Path("/test-file");
            Path d = new Path("/test-d");
    ...
    @Test
    public void testLeaseAfterRename_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            Path p = new Path("/test-file");
            Path d = new Path("/test-d");
    ...
    @Test
    public void testLeaseAfterRename_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            Path p = new Path("/test-file");
            Path d = new Path("/test-d");
    ...
    @Test
    public void testLeaseAfterRenameAndRecreate_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            final Path path1 = new Path("/test-file");
            final String contents1 = "contents1";
    ...
    @Test
    public void testLeaseAfterRenameAndRecreate_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            final Path path1 = new Path("/test-file");
            final String contents1 = "contents1";
    ...
    @Test
    public void testLeaseAfterRenameAndRecreate_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            final Path path1 = new Path("/test-file");
            final String contents1 = "contents1";
    ...
    @Test
    public void testLeaseAfterRenameAndRecreate_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            final Path path1 = new Path("/test-file");
            final String contents1 = "contents1";
    ...
    @Test
    public void testLease_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
            Assert.assertTrue(fs.mkdirs(dir));
    ...
    @Test
    public void testLease_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
            Assert.assertTrue(fs.mkdirs(dir));
    ...
    @Test
    public void testLease_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
            Assert.assertTrue(fs.mkdirs(dir));
    ...
    @Test
    public void testLease_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(2).build();
        try {
            FileSystem fs = cluster.getFileSystem();
            Assert.assertTrue(fs.mkdirs(dir));
