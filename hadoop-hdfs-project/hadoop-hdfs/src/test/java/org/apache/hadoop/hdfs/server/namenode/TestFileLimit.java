...
public class TestFileLimit {
    ...
    private void createFile(FileSystem fileSys, Path name) throws IOException {
        FSDataOutputStream stm = fileSys.create(name, true, fileSys.getConf().getInt(CommonConfigurationKeys.IO_FILE_BUFFER_SIZE_KEY, 4096), (short) 1, blockSize);
    ...
    @Test
    public void testFileLimit_withUpgrade20() throws IOException {
        Configuration conf = new HdfsConfiguration();
        int maxObjects = 5;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MAX_OBJECTS_KEY, maxObjects);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
    ...
    @Test
    public void testFileLimit_withUpgrade40() throws IOException {
        Configuration conf = new HdfsConfiguration();
        int maxObjects = 5;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MAX_OBJECTS_KEY, maxObjects);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
    ...
    @Test
    public void testFileLimit_withUpgrade60() throws IOException {
        Configuration conf = new HdfsConfiguration();
        int maxObjects = 5;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MAX_OBJECTS_KEY, maxObjects);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
    ...
    @Test
    public void testFileLimit_withUpgrade80() throws IOException {
        Configuration conf = new HdfsConfiguration();
        int maxObjects = 5;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MAX_OBJECTS_KEY, maxObjects);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000L);
    ...
    @Test(timeout = 60000)
    public void testMaxBlocksPerFileLimit_withUpgrade20() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Make a small block size and a low limit
        final long blockSize = 4096;
        final long numBlocks = 2;
    ...
    @Test(timeout = 60000)
    public void testMaxBlocksPerFileLimit_withUpgrade40() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Make a small block size and a low limit
        final long blockSize = 4096;
        final long numBlocks = 2;
    ...
    @Test(timeout = 60000)
    public void testMaxBlocksPerFileLimit_withUpgrade60() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Make a small block size and a low limit
        final long blockSize = 4096;
        final long numBlocks = 2;
    ...
    @Test(timeout = 60000)
    public void testMaxBlocksPerFileLimit_withUpgrade80() throws Exception {
        Configuration conf = new HdfsConfiguration();
        // Make a small block size and a low limit
        final long blockSize = 4096;
        final long numBlocks = 2;
    ...
    @Test(timeout = 60000)
    public void testMinBlockSizeLimit_withUpgrade20() throws Exception {
        final long blockSize = 4096;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, blockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 60000)
    public void testMinBlockSizeLimit_withUpgrade40() throws Exception {
        final long blockSize = 4096;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, blockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
    ...
    @Test(timeout = 60000)
    public void testMinBlockSizeLimit_withUpgrade80() throws Exception {
        final long blockSize = 4096;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_MIN_BLOCK_SIZE_KEY, blockSize);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).build();
