...
public class TestHAStateTransitions {
    ...
    private void addCrmThreads(MiniDFSClusterInJVM cluster, LinkedList<Thread> crmThreads) {
     ...
     * @throws Exception
     */
    private void testManualFailoverFailback(MiniDFSClusterInJVM cluster, Configuration conf, int nsIndex) throws Exception {
    ...
    public void testManualFailoverFailbackFederationHA() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    private static void createEmptyInProgressEditLog(MiniDFSClusterInJVM cluster, NameNodeJVMInterface nn, boolean writeHeader) throws IOException {
    ...
    public void testSecretManagerState() throws Exception {
        ...
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).waitSafeMode(false).build();
        try {
            cluster.transitionToActive(0);
    ...
    public void testIsAtLeastOneActive() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testTransitionActiveToStandby_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testTransitionActiveToStandby_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testTransitionActiveToStandby_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testTransitionActiveToStandby_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testTransitionToCurrentStateIsANop_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_PATH_BASED_CACHE_REFRESH_INTERVAL_MS, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        LinkedList<Thread> crmThreads = new LinkedList<Thread>();
    ...
    @Test(timeout = 300000)
    public void testTransitionToCurrentStateIsANop_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_PATH_BASED_CACHE_REFRESH_INTERVAL_MS, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        LinkedList<Thread> crmThreads = new LinkedList<Thread>();
    ...
    @Test(timeout = 300000)
    public void testTransitionToCurrentStateIsANop_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_PATH_BASED_CACHE_REFRESH_INTERVAL_MS, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        LinkedList<Thread> crmThreads = new LinkedList<Thread>();
    ...
    @Test(timeout = 300000)
    public void testTransitionToCurrentStateIsANop_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_PATH_BASED_CACHE_REFRESH_INTERVAL_MS, 1L);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        LinkedList<Thread> crmThreads = new LinkedList<Thread>();
    ...
    @Test(timeout = 300000)
    public void testManualFailoverAndFailback_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testManualFailoverAndFailback_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testManualFailoverAndFailback_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 120000)
    public void testTransitionSynchronization_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 120000)
    public void testTransitionSynchronization_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 120000)
    public void testTransitionSynchronization_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 120000)
    public void testTransitionSynchronization_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        final MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 120000)
    public void testLeasesRenewedOnTransition_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        FSDataOutputStream stm = null;
    ...
    @Test(timeout = 120000)
    public void testLeasesRenewedOnTransition_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        FSDataOutputStream stm = null;
    ...
    @Test(timeout = 120000)
    public void testLeasesRenewedOnTransition_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        FSDataOutputStream stm = null;
    ...
    @Test(timeout = 120000)
    public void testLeasesRenewedOnTransition_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setInt(DFSConfigKeys.DFS_HA_TAILEDITS_PERIOD_KEY, 1);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(1).build();
        FSDataOutputStream stm = null;
    ...
    @Test(timeout = 300000)
    public void testDelegationTokensAfterFailover_withUpgrade20() throws IOException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testDelegationTokensAfterFailover_withUpgrade40() throws IOException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testDelegationTokensAfterFailover_withUpgrade60() throws IOException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testDelegationTokensAfterFailover_withUpgrade80() throws IOException {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
    ...
    @Test(timeout = 300000)
    public void testManualFailoverFailbackFederationHA_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testManualFailoverFailbackFederationHA_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 300000)
    public void testManualFailoverFailbackFederationHA_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHAFederatedTopology(2)).numDataNodes(1).build();
        try {
            cluster.waitActive();
    ...
    @Test(timeout = 60000)
    public void testSecretManagerState_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_DELEGATION_KEY_UPDATE_INTERVAL_KEY, 50);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
    ...
    @Test(timeout = 60000)
    public void testSecretManagerState_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_DELEGATION_KEY_UPDATE_INTERVAL_KEY, 50);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
    ...
    @Test(timeout = 60000)
    public void testSecretManagerState_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_DELEGATION_KEY_UPDATE_INTERVAL_KEY, 50);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
    ...
    @Test(timeout = 60000)
    public void testSecretManagerState_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        conf.setBoolean(DFSConfigKeys.DFS_NAMENODE_DELEGATION_TOKEN_ALWAYS_USE_KEY, true);
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_DELEGATION_KEY_UPDATE_INTERVAL_KEY, 50);
        conf.setInt(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, 1024);
    ...
    @Test(timeout = 300000)
    public void testIsAtLeastOneActive_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            Configuration conf = new HdfsConfiguration();
            HATestUtil.setFailoverConfigurations(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testIsAtLeastOneActive_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            Configuration conf = new HdfsConfiguration();
            HATestUtil.setFailoverConfigurations(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testIsAtLeastOneActive_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            Configuration conf = new HdfsConfiguration();
            HATestUtil.setFailoverConfigurations(cluster, conf);
    ...
    @Test(timeout = 300000)
    public void testIsAtLeastOneActive_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(new HdfsConfiguration()).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(0).build();
        try {
            Configuration conf = new HdfsConfiguration();
            HATestUtil.setFailoverConfigurations(cluster, conf);
