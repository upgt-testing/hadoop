...
public class TestRollingFileSystemSinkWithHdfs extends RollingFileSystemSinkTestBase {
    ...
    /**
     * Create a {@link MiniDFSClusterInJVM} instance with four nodes.  The
    ...
    /**
     * Stop the {@link MiniDFSClusterInJVM}.
     */
    @After
    ...
    @Test
    public void testWrite_withUpgrade20() throws Exception {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, true);
    ...
    @Test
    public void testWrite_withUpgrade60() throws Exception {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, true);
        assertMetricsContents(doWriteTest(ms, path, 1));
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testAppend_withUpgrade20() throws Exception {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        assertExtraContents(doAppendTest(path, false, true, 1));
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testSilentAppend_withUpgrade20() throws Exception {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        assertExtraContents(doAppendTest(path, true, true, 1));
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testNoAppend_withUpgrade20() throws Exception {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        assertMetricsContents(doAppendTest(path, false, false, 2));
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testSilentOverwrite_withUpgrade20() throws Exception {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        assertMetricsContents(doAppendTest(path, true, false, 2));
        cluster.restartNodeForTesting(0);
        cluster.upgradeNodeForTesting(0);
    ...
    @Test
    public void testFailedWrite_withUpgrade20() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, false);
        new MyMetrics1().registerWith(ms);
        shutdownHdfs();
    ...
    @Test
    public void testFailedWrite_withUpgrade40() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, false);
        new MyMetrics1().registerWith(ms);
        shutdownHdfs();
    ...
    @Test
    public void testFailedWrite_withUpgrade60() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, false);
        new MyMetrics1().registerWith(ms);
        shutdownHdfs();
    ...
    @Test
    public void testFailedClose_withUpgrade20() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testFailedClose_withUpgrade40() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testFailedClose_withUpgrade60() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, false, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testSilentFailedWrite_withUpgrade20() throws IOException, InterruptedException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        shutdownHdfs();
    ...
    @Test
    public void testSilentFailedWrite_withUpgrade40() throws IOException, InterruptedException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        shutdownHdfs();
    ...
    @Test
    public void testSilentFailedWrite_withUpgrade60() throws IOException, InterruptedException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        shutdownHdfs();
    ...
    @Test
    public void testSilentFailedClose_withUpgrade20() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testSilentFailedClose_withUpgrade40() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testSilentFailedClose_withUpgrade60() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testSilentFailedClose_withUpgrade80() throws IOException {
        final String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false);
        new MyMetrics1().registerWith(ms);
        // publish the metrics
    ...
    @Test
    public void testFlushThread_withUpgrade20() throws Exception {
        // metrics log is written
        RollingFileSystemSink.forceFlush = true;
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false, false);
    ...
    @Test
    public void testFlushThread_withUpgrade40() throws Exception {
        // metrics log is written
        RollingFileSystemSink.forceFlush = true;
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false, false);
    ...
    @Test
    public void testFlushThread_withUpgrade60() throws Exception {
        // metrics log is written
        RollingFileSystemSink.forceFlush = true;
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false, false);
    ...
    @Test
    public void testFlushThread_withUpgrade80() throws Exception {
        // metrics log is written
        RollingFileSystemSink.forceFlush = true;
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        MetricsSystem ms = initMetricsSystem(path, true, false, false);
    ...
    @Test
    public void testInitWithNoHDFS_withUpgrade20() {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        shutdownHdfs();
        MockSink.errored = false;
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testInitWithNoHDFS_withUpgrade40() {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        shutdownHdfs();
        MockSink.errored = false;
        initMetricsSystem(path, true, false);
    ...
    @Test
    public void testInitWithNoHDFS_withUpgrade60() {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        shutdownHdfs();
        MockSink.errored = false;
        initMetricsSystem(path, true, false);
    ...
    @Test
    public void testInitWithNoHDFS_withUpgrade80() {
        String path = "hdfs://" + cluster.getNameNode().getHostAndPort() + "/tmp";
        shutdownHdfs();
        MockSink.errored = false;
        initMetricsSystem(path, true, false);
