...
public class TestINodeFile_RestartInjected_Randomized_123 {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(TestINodeFile_RestartInjected.class);
    ...
    public void testConcat() throws IOException {
        ...
        try (MiniDFSCluster cluster = new MiniDFSCluster.Builder(conf).build()) {
            ...
            RestartFramework.at("after_directory_and_quota_setup").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            // Create 4 files
