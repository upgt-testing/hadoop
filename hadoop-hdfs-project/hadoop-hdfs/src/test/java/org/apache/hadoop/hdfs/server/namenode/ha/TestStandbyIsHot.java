...
public class TestStandbyIsHot {
    ...
    public void testStandbyIsHot() throws Exception {
        ...
        MiniDockerDFSCluster cluster = new MiniDockerDFSCluster.Builder(conf).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(3).build();
        try {
            cluster.waitActive();
    ...
    static void waitForBlockLocations(final MiniDockerDFSCluster cluster, final NameNode nn, final String path, final int expectedReplicas) throws Exception {
