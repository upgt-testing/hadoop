...
/**
 * ProcessBasedMiniDFSCluster version of {@link TestFSMainOperationsWebHdfs}.
 *
 * Transformed from MiniDFSCluster to ProcessBasedMiniDFSCluster to enable
 * process-based testing and multi-version upgrade scenarios.
 *
 * Note: This test extends FSMainOperationsBaseTest which provides 50+ inherited
 ...
 *
 * @see TestFSMainOperationsWebHdfs Original test using MiniDFSCluster
 */
public class TestFSMainOperationsWebHdfs_ProcessBased extends FSMainOperationsBaseTest {
  {
  ...
  public TestFSMainOperationsWebHdfs_ProcessBased() {
    super("/tmp/TestFSMainOperationsWebHdfs_ProcessBased");
  }
