...
public class TestComputeInvalidateWork_RestartInjected {
  ...
  public void setup() throws Exception {
    ...
    RestartFramework.at("after_ec_file_create")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testComputeInvalidateReplicas() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_add_invalidates")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testComputeInvalidateStripedBlockGroups() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_add_striped_invalidates")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testComputeInvalidate() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_add_mixed_invalidates")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeReformat() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_stop_datanode")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_add_invalidates_reformat")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_register_reformatted_datanode")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testDatanodeReRegistration() throws Exception {
    ...
    RestartFramework.at("after_shutdown_datanodes")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_check_invalidate_blocks")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
