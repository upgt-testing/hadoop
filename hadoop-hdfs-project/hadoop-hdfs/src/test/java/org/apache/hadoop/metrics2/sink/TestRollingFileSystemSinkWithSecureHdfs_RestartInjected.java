 ...
 * Kerberos enabled.
 */
public class TestRollingFileSystemSinkWithSecureHdfs_RestartInjected
  ...
  public void testWithSecureHDFS() throws Exception {
    ...
    RestartFramework.at("after_secure_metrics_init")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_secure_write_test")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMissingPropertiesWithSecureHDFS() throws Exception {
    ...
    RestartFramework.at("after_missing_properties_init")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
