...
public class TestUpdateBlockTailing {
    ...
    private static FSNamesystemInterface fsn0;

    private static FSNamesystemInterface fsn1;

    private static DataNodeInterface dn0;
    ...
    public void testStandbyAddBlockIBRRace() throws Exception {
        ...
        INodeFileInterface file = (INodeFile) fsn0.getFSDirectory().getINode(testFile);
