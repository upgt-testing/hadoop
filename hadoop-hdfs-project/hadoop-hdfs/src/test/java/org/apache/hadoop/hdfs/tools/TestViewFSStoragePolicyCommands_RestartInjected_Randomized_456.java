 ...
 */
public class TestViewFSStoragePolicyCommands_RestartInjected_Randomized_456 extends TestStoragePolicyCommands {
    ...
    public void testStoragePolicyCommandPathWithSchema() throws Exception {
        RestartFramework.at("after_hdfs_schema_test").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Path base1 = new Path("/user1");
