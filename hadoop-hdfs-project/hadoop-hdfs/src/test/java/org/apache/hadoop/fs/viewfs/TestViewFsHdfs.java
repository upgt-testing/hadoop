...
public class TestViewFsHdfs extends ViewFsBaseTest {
    ...
    @Test
    public void testTargetFileSystemLazyInitialization_withUpgrade20() throws Exception {
        final Map<String, FileContext> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileContext fs = FileContext.getFileContext(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testTargetFileSystemLazyInitialization_withUpgrade40() throws Exception {
        final Map<String, FileContext> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileContext fs = FileContext.getFileContext(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testTargetFileSystemLazyInitialization_withUpgrade60() throws Exception {
        final Map<String, FileContext> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileContext fs = FileContext.getFileContext(FsConstants.VIEWFS_URI, conf);
    ...
    @Test
    public void testTargetFileSystemLazyInitialization_withUpgrade80() throws Exception {
        final Map<String, FileContext> map = new HashMap<>();
        final Path user1Path = new Path("/data/user1");
        // Both mkdir and delete should be successful
        FileContext fs = FileContext.getFileContext(FsConstants.VIEWFS_URI, conf);
