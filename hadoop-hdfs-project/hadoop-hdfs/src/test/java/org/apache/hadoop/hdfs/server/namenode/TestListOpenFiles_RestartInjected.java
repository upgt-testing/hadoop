...
public class TestListOpenFiles_RestartInjected {
  ...
  public void testListOpenFilesViaNameNodeRPC() throws Exception {
    ...
    RestartFramework.at("after_closed_files")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_open_files_batch1")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_open_files_batch2")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_partial_close")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_open_files_batch3")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListOpenFilesInHA() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_ha_cluster_start")
          .on(haCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_open_files_creation")
          .on(haCluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testListOpenFilesWithFilterPath() throws IOException {
    ...
    RestartFramework.at("after_first_batch_open")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_batch_open")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testListOpenFilesWithInvalidPathServerSide() throws Exception {
    ...
    openFiles.putAll(
        DFSTestUtil.createOpenFiles(fs, new Path("/base"), "open-1", 1));
    RestartFramework.at("after_open_files")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
