...
public class TestNameNodeRpcServerMethods {
    ...
    @Test
    public void testGetDatanodeStorageReportWithNumBLocksNotZero_withUpgrade20() throws Exception {
        int buffSize = 1024;
        long blockSize = 1024 * 1024;
        String file = "/testFile";
        DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testGetDatanodeStorageReportWithNumBLocksNotZero_withUpgrade40() throws Exception {
        int buffSize = 1024;
        long blockSize = 1024 * 1024;
        String file = "/testFile";
        DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testGetDatanodeStorageReportWithNumBLocksNotZero_withUpgrade60() throws Exception {
        int buffSize = 1024;
        long blockSize = 1024 * 1024;
        String file = "/testFile";
        DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testGetDatanodeStorageReportWithNumBLocksNotZero_withUpgrade80() throws Exception {
        int buffSize = 1024;
        long blockSize = 1024 * 1024;
        String file = "/testFile";
        DistributedFileSystem dfs = cluster.getFileSystem();
