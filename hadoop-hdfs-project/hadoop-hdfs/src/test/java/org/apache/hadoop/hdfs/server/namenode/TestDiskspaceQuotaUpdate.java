...
public class TestDiskspaceQuotaUpdate {
    ...
    public void testQuotaUpdateWithFileCreate() throws Exception {
        ...
        INodeInterface fnode = getFSDirectory().getINode4Write(foo.toString());
    ...
    public void testUpdateQuotaForAppend() throws Exception {
        ...
        INodeDirectoryInterface fooNode = getFSDirectory().getINode4Write(foo.toString()).asDirectory();
        assertTrue(fooNode.isQuotaSet());
        QuotaCountsInterface quota = fooNode.getDirectoryWithQuotaFeature().getSpaceConsumed();
    ...
    public void testAppendOverStorageQuota() throws Exception {
        ...
        final INodeDirectoryInterface dirNode = getFSDirectory().getINode4Write(dir.toString()).asDirectory();
        ...
        LeaseManagerInterface lm = cluster.getNamesystem().getLeaseManager();
        // check that the file exists, isn't UC, and has no dangling lease
        INodeFileInterface inode = getFSDirectory().getINode(file.toString()).asFile();
    ...
    public void testQuotaInitialization() throws Exception {
        ...
        INodeDirectoryInterface root = getFSDirectory().getRoot();
    ...
    public void testQuotaIssuesWhileCommitting() throws Exception {
        ...
        List<MiniDockerDFSCluster.DataNodeProperties> dnprops = new ArrayList<>();
        try {
            ...
            for (MiniDockerDFSCluster.DataNodeProperties dnprop : dnprops) {
