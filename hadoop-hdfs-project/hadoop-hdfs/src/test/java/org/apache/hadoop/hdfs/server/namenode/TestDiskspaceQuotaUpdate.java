 ...
 */
   ...
   */
    ...
    @Test(timeout = 60000)
    public void testAppendOverStorageQuota_withUpgrade20() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverStorageQuota_withUpgrade40() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverStorageQuota_withUpgrade60() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverStorageQuota_withUpgrade80() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverTypeQuota_withUpgrade20() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverTypeQuota_withUpgrade40() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverTypeQuota_withUpgrade60() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testAppendOverTypeQuota_withUpgrade80() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testTruncateOverQuota_withUpgrade20() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testTruncateOverQuota_withUpgrade40() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testTruncateOverQuota_withUpgrade60() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
    ...
    @Test(timeout = 60000)
    public void testTruncateOverQuota_withUpgrade80() throws Exception {
        final Path dir = getParent(GenericTestUtils.getMethodName());
        final Path file = new Path(dir, "file");
        // create partial block file
        getDFS().mkdirs(dir);
