...
public class TestStandbyCheckpoints_RestartInjected {
  ...
  public void testSBNCheckpoints() throws Exception {
    ...
    RestartFramework.at("after_edits")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
    ...
    RestartFramework.at("after_standby_catchup")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_oiv_image_save")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_checkpoint_upload")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testNewDirInitAfterCheckpointing() throws Exception {
    File hdfsDir = new File(PathUtils.getTestDir(TestStandbyCheckpoints_RestartInjected.class),
    ...
    RestartFramework.at("after_namenode_restart_with_new_dir")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_trigger_edits")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testBothNodesInStandbyState() throws Exception {
    ...
    RestartFramework.at("after_both_checkpoints")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCheckpointCancellation() throws Exception {
    ...
    RestartFramework.at("after_nn1_restart")
        .on(cluster)
        .restart("namenode")
        .withIndex(1)
        .withMode(RestartMode.GRACEFUL)
