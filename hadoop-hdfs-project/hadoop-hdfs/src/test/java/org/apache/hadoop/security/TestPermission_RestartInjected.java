...
public class TestPermission_RestartInjected {
  ...
  public void testCreate() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_mkdir_a1")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_aa")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file_create_b1")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_mkdir_c1")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testFilePermission() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_file_create_with_permission")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_dir_create")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      assertThat("Expect 755 = 777 (default dir) - 022 (default umask)",
          status.getPermission().toString(), is("rwxr-xr-x"));
      RestartFramework.at("after_dir_create_null_perm")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_file_open_read")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      nnfs.setPermission(CHILD_FILE1, new FsPermission("700"));
      RestartFramework.at("after_execution_bit_test")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_user_switch")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
