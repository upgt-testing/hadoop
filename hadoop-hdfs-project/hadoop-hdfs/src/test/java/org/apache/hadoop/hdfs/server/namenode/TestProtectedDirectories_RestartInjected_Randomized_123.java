 ...
 */
public class TestProtectedDirectories_RestartInjected_Randomized_123 {
    ...
    public void testReconfigureProtectedPaths() throws Throwable {
        ...
        RestartFramework.at("after_reconfigure").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("after_revert").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        nn = cluster.getNameNode();
    ...
    public void testDelete() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            ...
            try {
                ...
                RestartFramework.at("after_delete_operations").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            } finally {
                cluster.shutdown();
            }
        }
    ...
    public void testMoveToTrash() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            ...
            try {
                ...
                RestartFramework.at("after_trash_operations").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            } finally {
                cluster.shutdown();
            }
        }
    ...
    public void testRename() throws Throwable {
        for (TestMatrixEntry testMatrixEntry : createTestMatrix()) {
            ...
            try {
                ...
                RestartFramework.at("after_rename_operations").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            } finally {
                cluster.shutdown();
            }
        }
