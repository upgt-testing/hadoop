...
public class TestCryptoAdminCLI_RestartInjected extends CLITestHelperDFS {
  ...
  @Override
  public void testAll () {
    RestartFramework.at("before_crypto_operations")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_crypto_operations")
        .on(dfsCluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
