...
public class TestErasureCodeBenchmarkThroughput {
    ...
    @Test
    public void testReplicaReadWrite_withUpgrade20() throws Exception {
        Integer dataSize = 10;
        Integer numClient = 3;
        String[] args = new String[] { "write", dataSize.toString(), "rep", numClient.toString() };
    ...
    @Test
    public void testReplicaReadWrite_withUpgrade40() throws Exception {
        Integer dataSize = 10;
        Integer numClient = 3;
        String[] args = new String[] { "write", dataSize.toString(), "rep", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testReplicaReadWrite_withUpgrade60() throws Exception {
        Integer dataSize = 10;
        Integer numClient = 3;
        String[] args = new String[] { "write", dataSize.toString(), "rep", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testReplicaReadWrite_withUpgrade80() throws Exception {
        Integer dataSize = 10;
        Integer numClient = 3;
        String[] args = new String[] { "write", dataSize.toString(), "rep", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testECReadWrite_withUpgrade20() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "write", dataSize.toString(), "ec", numClient.toString() };
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testECReadWrite_withUpgrade40() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "write", dataSize.toString(), "ec", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testECReadWrite_withUpgrade60() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "write", dataSize.toString(), "ec", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testECReadWrite_withUpgrade80() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "write", dataSize.toString(), "ec", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testCleanUp_withUpgrade20() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "gen", dataSize.toString(), "ec", numClient.toString() };
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testCleanUp_withUpgrade40() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "gen", dataSize.toString(), "ec", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testCleanUp_withUpgrade60() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "gen", dataSize.toString(), "ec", numClient.toString() };
        runBenchmark(args);
    ...
    @Test
    public void testCleanUp_withUpgrade80() throws Exception {
        Integer dataSize = 5;
        Integer numClient = 5;
        String[] args = new String[] { "gen", dataSize.toString(), "ec", numClient.toString() };
        runBenchmark(args);
