...
public class TestStandbyBlockManagement_RestartInjected {
  protected static final Logger LOG = LoggerFactory.getLogger(
      TestStandbyBlockManagement_RestartInjected.class);
  ...
  public void testInvalidateBlock() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_file_delete_and_pending_work")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_second_editlog_roll")
          .on(cluster)
          .restart("namenode")
          .withIndex(1)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_trigger_block_reports")
          .on(cluster)
          .restart("datanode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
