   ...
   */
    ...
    public void testAppendInsufficientLocations() throws Exception {
        ...
        try {
            ...
            List<DataNodeInterface> dnsOfCluster = cluster.getDataNodes();
            DatanodeInfo[] dnsWithLocations = lbs.getLastLocatedBlock().getLocations();
            for (DataNodeInterface dn : dnsOfCluster) {
            ...
            //final INodeFileInterface inode = INodeFile.valueOf(dir.getINode("/testAppend"), "/testAppend");
