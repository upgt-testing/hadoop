...
public class TestFileAppend4 {
   ...
   */
    private void recoverFile(final FileSystem fs) throws Exception {
        ...
        cluster.setLeasePeriod(1, conf.getLong(DFSConfigKeys.DFS_LEASE_HARDLIMIT_KEY, DFSConfigKeys.DFS_LEASE_HARDLIMIT_DEFAULT));
        // Trying recovery
        int tries = 60;
   ...
   */
    ...
    @Test(timeout = 60000)
    public void testUpdateNeededReplicationsForAppendedFile_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        DistributedFileSystem fileSystem = null;
        try {
    ...
    @Test(timeout = 60000)
    public void testUpdateNeededReplicationsForAppendedFile_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        DistributedFileSystem fileSystem = null;
        try {
    ...
    @Test(timeout = 60000)
    public void testUpdateNeededReplicationsForAppendedFile_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        DistributedFileSystem fileSystem = null;
        try {
    ...
    @Test(timeout = 60000)
    public void testUpdateNeededReplicationsForAppendedFile_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(1).build();
        DistributedFileSystem fileSystem = null;
        try {
    ...
    @Test(timeout = 60000)
    public void testAppendInsufficientLocations_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        // lower heartbeat interval for fast recognition of DN
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
    ...
    @Test(timeout = 60000)
    public void testAppendInsufficientLocations_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        // lower heartbeat interval for fast recognition of DN
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
    ...
    @Test(timeout = 60000)
    public void testAppendInsufficientLocations_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        // lower heartbeat interval for fast recognition of DN
        conf.setInt(DFSConfigKeys.DFS_NAMENODE_HEARTBEAT_RECHECK_INTERVAL_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_HEARTBEAT_INTERVAL_KEY, 1);
