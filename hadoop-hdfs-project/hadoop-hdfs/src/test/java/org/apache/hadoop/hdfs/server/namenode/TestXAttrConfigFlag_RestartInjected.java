 ...
 */
public class TestXAttrConfigFlag_RestartInjected {
  ...
  public void testEditLog() throws Exception {
    ...
    restart(false, false);
    RestartFramework.at("after_restart_with_xattrs_disabled")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testFsImage() throws Exception {
    ...
    restart(true, true);
    RestartFramework.at("after_restart_with_checkpoint")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
