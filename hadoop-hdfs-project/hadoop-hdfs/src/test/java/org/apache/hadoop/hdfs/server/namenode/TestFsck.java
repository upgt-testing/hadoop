...
import static org.apache.hadoop.hdfs.MiniDFSClusterInJVM.HDFS_MINIDFS_BASEDIR;
...
public class TestFsck {
    ...
    public void testFsck() throws Exception {
        ...
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(4).build();
    ...
    public void testFsckPermission() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(4).build();
        final MiniDFSClusterInJVM c2 = cluster;
    ...
    public void testFsckMove() throws Exception {
        ...
        FileSystem fs = null;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(numDatanodes).build();
    ...
    static private class CorruptedTestFile {
        ...
        public void removeBlocks(MiniDFSClusterInJVM cluster) throws AccessControlException, FileNotFoundException, UnresolvedLinkException, IOException {
        ...
        public void corruptBlocks(MiniDFSClusterInJVM cluster) throws IOException {
            for (int corruptIdx : blocksToCorrupt) {
                // Corrupt a block by deleting it
                ExtendedBlock block = dfsClient.getNamenode().getBlockLocations(name, blockSize * corruptIdx, Long.MAX_VALUE).get(0).getBlock();
                for (int i = 0; i < numDataNodes; i++) {
    ...
    public void testFsckOpenECFiles() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(numAllUnits + 1).build();
        String topDir = "/myDir";
        cluster.waitActive();
    ...
    public void testCorruptBlock() throws Exception {
        ...
        short factor = 1;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(1).build();
        cluster.waitActive();
        fs = cluster.getFileSystem();
    ...
    public void testUnderMinReplicatedBlock() throws Exception {
        ...
        short factor = 1;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(2).build();
        cluster.waitActive();
        fs = cluster.getFileSystem();
    ...
    public void testFsckReplicaDetails() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(numDn).hosts(hosts).racks(racks).build();
        cluster.waitClusterUp();
        ...
        final DatanodeManagerJVMInterface dnm = bm.getDatanodeManager();
        DatanodeDescriptorJVMInterface dnDesc0 = dnm.getDatanode(cluster.getDataNodes().get(0).getDatanodeId());
        /*
    ...
    public void testFsckError() throws Exception {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        ...
        INodeFile node = (INodeFile) cluster.getNamesystem().getFSDirectory().getINode(fileName, DirOp.READ);
    ...
    public void testFsckListCorruptFilesBlocks() throws Exception {
        ...
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j <= 1; j++) {
                ...
                List<File> metadataFiles = MiniDFSClusterInJVM.getAllBlockMetadataFiles(dataDir);
    ...
    public void testFsckMissingReplicas() throws IOException {
        ...
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(numReplicas).build();
    ...
    public void testBlockIdCKDecommission() throws Exception {
        ...
        FSNamesystemJVMInterface fsn = cluster.getNameNode().getNamesystem();
        BlockManagerJVMInterface bm = fsn.getBlockManager();
        ExtendedBlockJVMInterface eb = util.getFirstBlock(dfs, path);
    ...
    public void testBlockIdCKMaintenance() throws Exception {
        ...
        FSNamesystemJVMInterface fsn = cluster.getNameNode().getNamesystem();
        BlockManagerJVMInterface bm = fsn.getBlockManager();
        DatanodeManagerJVMInterface dnm = bm.getDatanodeManager();
        DatanodeDescriptorJVMInterface dn = dnm.getDatanode(cluster.getDataNodes().get(0).getDatanodeId());
        /*
    ...
    public void testStoragePoliciesCK() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
  ...
  public void testECFsck() throws Exception {
    ...
    File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir)
  ...
  private void waitForCorruptionBlocks(int corruptBlocks, String path)
    ...
    GenericTestUtils.waitFor(() -> {
      try {
        final NamenodeProtocolsJVMInterface namenode = cluster.getNameNodeRpc();
   ...
   */
    ...
    private void testUpgradeDomain(boolean defineUpgradeDomain, boolean displayUpgradeDomain) throws Exception {
        ...
        DistributedFileSystem dfs;
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(numDN).hosts(hosts).racks(racks).build();
        cluster.waitClusterUp();
        dfs = cluster.getFileSystem();
        // Configure the upgrade domain on the datanode
        if (defineUpgradeDomain) {
            DatanodeAdminProperties dnProp = new DatanodeAdminProperties();
            DatanodeIDJVMInterface datanodeID = cluster.getDataNodes().get(0).getDatanodeId();
    ...
    public void testFsckCorruptECFile() throws Exception {
        ...
        int totalSize = dataBlocks + parityBlocks;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(totalSize).build();
        fs = cluster.getFileSystem();
        fs.enableErasureCodingPolicy(StripedFileTestUtil.getDefaultECPolicy().getName());
        Map<Integer, Integer> dnIndices = new HashMap<>();
        ArrayList<DataNodeJVMInterface> dnList = cluster.getDataNodes();
        ...
        for (int i = 0; i < parityBlocks + 1; i++) {
            ...
            File blkFile = MiniDFSClusterInJVM.getBlockFile(storageDir, blks[i].getBlock());
    ...
    public void testFsckCorruptWhenOneReplicaIsCorrupt() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(2).build()) {
            cluster.waitActive();
    ...
    @Test
    public void testFsck_withUpgrade20() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        final long precision = 1L;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, precision);
    ...
    @Test
    public void testFsck_withUpgrade40() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        final long precision = 1L;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, precision);
    ...
    @Test
    public void testFsck_withUpgrade60() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        final long precision = 1L;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, precision);
    ...
    @Test
    public void testFsck_withUpgrade80() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        final long precision = 1L;
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_ACCESSTIME_PRECISION_KEY, precision);
    ...
    @Test
    public void testFsckNonExistent_withUpgrade20() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckNonExistent_withUpgrade40() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckNonExistent_withUpgrade60() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckNonExistent_withUpgrade80() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(20).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckPermission_withUpgrade20() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(20).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        // Create a cluster with the current user, write some files
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        ...
        final FileSystem fs = c2.getFileSystem();
        util.createFiles(fs, dir);
        c2.restartNodeForTesting(0);
        c2.upgradeNodeForTesting(0);
        util.waitReplication(fs, dir, (short) 3);
        fs.setPermission(dirpath, new FsPermission((short) 0700));
        // run DFSck as another user, should fail with permission issue
        UserGroupInformation fakeUGI = UserGroupInformation.createUserForTesting("ProbablyNotARealUserName", new String[] { "ShangriLa" });
    ...
    @Test
    public void testFsckPermission_withUpgrade40() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(20).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        // Create a cluster with the current user, write some files
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckPermission_withUpgrade60() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(20).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        // Create a cluster with the current user, write some files
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckPermission_withUpgrade80() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(20).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        // Create a cluster with the current user, write some files
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckMove_withUpgrade40() throws Exception {
        final int dfsBlockSize = 1024;
        final int numDatanodes = 4;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckMove_withUpgrade60() throws Exception {
        final int dfsBlockSize = 1024;
        final int numDatanodes = 4;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckMove_withUpgrade80() throws Exception {
        final int dfsBlockSize = 1024;
        final int numDatanodes = 4;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckMoveAndDelete_withUpgrade20() throws Exception {
        final int maxMoveTries = 5;
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckMoveAndDelete").setNumFiles(5).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckMoveAndDelete_withUpgrade40() throws Exception {
        final int maxMoveTries = 5;
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckMoveAndDelete").setNumFiles(5).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckMoveAndDelete_withUpgrade60() throws Exception {
        final int maxMoveTries = 5;
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckMoveAndDelete").setNumFiles(5).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckMoveAndDelete_withUpgrade80() throws Exception {
        final int maxMoveTries = 5;
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckMoveAndDelete").setNumFiles(5).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
    ...
    @Test
    public void testFsckOpenFiles_withUpgrade20() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(4).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckOpenFiles_withUpgrade40() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(4).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckOpenFiles_withUpgrade60() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(4).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckOpenFiles_withUpgrade80() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsck").setNumFiles(4).build();
        FileSystem fs = null;
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckOpenECFiles_withUpgrade20() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckECFile").setNumFiles(4).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        ErasureCodingPolicy ecPolicy = StripedFileTestUtil.getDefaultECPolicy();
        final int dataBlocks = ecPolicy.getNumDataUnits();
    ...
    @Test
    public void testFsckOpenECFiles_withUpgrade40() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckECFile").setNumFiles(4).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        ErasureCodingPolicy ecPolicy = StripedFileTestUtil.getDefaultECPolicy();
        final int dataBlocks = ecPolicy.getNumDataUnits();
    ...
    @Test
    public void testFsckOpenECFiles_withUpgrade60() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckECFile").setNumFiles(4).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        ErasureCodingPolicy ecPolicy = StripedFileTestUtil.getDefaultECPolicy();
        final int dataBlocks = ecPolicy.getNumDataUnits();
    ...
    @Test
    public void testFsckOpenECFiles_withUpgrade80() throws Exception {
        DFSTestUtil util = new DFSTestUtil.Builder().setName("TestFsckECFile").setNumFiles(4).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        ErasureCodingPolicy ecPolicy = StripedFileTestUtil.getDefaultECPolicy();
        final int dataBlocks = ecPolicy.getNumDataUnits();
    ...
    @Test
    public void testCorruptBlock_withUpgrade20() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        FileSystem fs = null;
    ...
    @Test
    public void testCorruptBlock_withUpgrade40() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        FileSystem fs = null;
    ...
    @Test
    public void testCorruptBlock_withUpgrade60() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        FileSystem fs = null;
    ...
    @Test
    public void testCorruptBlock_withUpgrade80() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        FileSystem fs = null;
    ...
    @Test
    public void testUnderMinReplicatedBlock_withUpgrade20() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        // Set minReplication to 2
    ...
    @Test
    public void testUnderMinReplicatedBlock_withUpgrade40() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        // Set minReplication to 2
    ...
    @Test
    public void testUnderMinReplicatedBlock_withUpgrade60() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        // Set minReplication to 2
    ...
    @Test
    public void testUnderMinReplicatedBlock_withUpgrade80() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        // Set short retry timeouts so this test runs faster
        conf.setInt(HdfsClientConfigKeys.Retry.WINDOW_BASE_KEY, 10);
        // Set minReplication to 2
    ...
    @Test(timeout = 90000)
    public void testFsckReplicaDetails_withUpgrade20() throws Exception {
        final short replFactor = 1;
        short numDn = 1;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test(timeout = 90000)
    public void testFsckReplicaDetails_withUpgrade40() throws Exception {
        final short replFactor = 1;
        short numDn = 1;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test(timeout = 90000)
    public void testFsckReplicaDetails_withUpgrade60() throws Exception {
        final short replFactor = 1;
        short numDn = 1;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test(timeout = 90000)
    public void testFsckReplicaDetails_withUpgrade80() throws Exception {
        final short replFactor = 1;
        short numDn = 1;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test
    public void testFsckError_withUpgrade20() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testFsckError_withUpgrade40() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testFsckError_withUpgrade60() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testFsckError_withUpgrade80() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testFsckListCorruptFilesBlocks_withUpgrade20() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_DATANODE_DIRECTORYSCAN_INTERVAL_KEY, 1);
        FileSystem fs = null;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckListCorruptFilesBlocks_withUpgrade40() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_DATANODE_DIRECTORYSCAN_INTERVAL_KEY, 1);
        FileSystem fs = null;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testFsckListCorruptFilesBlocks_withUpgrade60() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_DATANODE_DIRECTORYSCAN_INTERVAL_KEY, 1);
        FileSystem fs = null;
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
    ...
    @Test
    public void testToCheckTheFsckCommandOnIllegalArguments_withUpgrade20() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testToCheckTheFsckCommandOnIllegalArguments_withUpgrade40() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testToCheckTheFsckCommandOnIllegalArguments_withUpgrade60() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testToCheckTheFsckCommandOnIllegalArguments_withUpgrade80() throws Exception {
        // bring up a one-node cluster
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).build();
        String fileName = "/test.txt";
    ...
    @Test
    public void testFsckMissingReplicas_withUpgrade20() throws IOException {
        // Set this higher than numReplicas so it's under-replicated
        final short replFactor = 2;
        // Number of replicas to actually start
        final short numReplicas = 1;
    ...
    @Test
    public void testFsckMissingReplicas_withUpgrade40() throws IOException {
        // Set this higher than numReplicas so it's under-replicated
        final short replFactor = 2;
        // Number of replicas to actually start
        final short numReplicas = 1;
    ...
    @Test
    public void testFsckMissingReplicas_withUpgrade60() throws IOException {
        // Set this higher than numReplicas so it's under-replicated
        final short replFactor = 2;
        // Number of replicas to actually start
        final short numReplicas = 1;
    ...
    @Test
    public void testFsckMissingReplicas_withUpgrade80() throws IOException {
        // Set this higher than numReplicas so it's under-replicated
        final short replFactor = 2;
        // Number of replicas to actually start
        final short numReplicas = 1;
    ...
    @Test
    public void testFsckMisPlacedReplicas_withUpgrade20() throws IOException {
        // Desired replication factor
        final short replFactor = 2;
        // Number of replicas to actually start
        short numDn = 2;
    ...
    @Test
    public void testFsckMisPlacedReplicas_withUpgrade40() throws IOException {
        // Desired replication factor
        final short replFactor = 2;
        // Number of replicas to actually start
        short numDn = 2;
    ...
    @Test
    public void testFsckMisPlacedReplicas_withUpgrade60() throws IOException {
        // Desired replication factor
        final short replFactor = 2;
        // Number of replicas to actually start
        short numDn = 2;
    ...
    @Test
    public void testFsckMisPlacedReplicas_withUpgrade80() throws IOException {
        // Desired replication factor
        final short replFactor = 2;
        // Number of replicas to actually start
        short numDn = 2;
    ...
    @Test
    public void testFsckSymlink_withUpgrade20() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(1).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        FileSystem fs = null;
        final long precision = 1L;
    ...
    @Test
    public void testFsckSymlink_withUpgrade40() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(1).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        FileSystem fs = null;
        final long precision = 1L;
    ...
    @Test
    public void testFsckSymlink_withUpgrade60() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(1).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        FileSystem fs = null;
        final long precision = 1L;
    ...
    @Test
    public void testFsckSymlink_withUpgrade80() throws Exception {
        final DFSTestUtil util = new DFSTestUtil.Builder().setName(getClass().getSimpleName()).setNumFiles(1).build();
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 10000L);
        FileSystem fs = null;
        final long precision = 1L;
    ...
    @Test
    public void testFsckForSnapshotFiles_withUpgrade20() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(1).build();
        String runFsck = runFsck(conf, 0, true, "/", "-includeSnapshots", "-files");
        assertTrue(runFsck.contains("HEALTHY"));
    ...
    @Test
    public void testFsckForSnapshotFiles_withUpgrade40() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(1).build();
        String runFsck = runFsck(conf, 0, true, "/", "-includeSnapshots", "-files");
        assertTrue(runFsck.contains("HEALTHY"));
    ...
    @Test
    public void testFsckForSnapshotFiles_withUpgrade60() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(1).build();
        String runFsck = runFsck(conf, 0, true, "/", "-includeSnapshots", "-files");
        assertTrue(runFsck.contains("HEALTHY"));
    ...
    @Test
    public void testFsckForSnapshotFiles_withUpgrade80() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(1).build();
        String runFsck = runFsck(conf, 0, true, "/", "-includeSnapshots", "-files");
        assertTrue(runFsck.contains("HEALTHY"));
    ...
    @Test
    public void testBlockIdCK_withUpgrade20() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] racks = { "/rack1", "/rack2" };
    ...
    @Test
    public void testBlockIdCK_withUpgrade40() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] racks = { "/rack1", "/rack2" };
    ...
    @Test
    public void testBlockIdCK_withUpgrade60() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] racks = { "/rack1", "/rack2" };
    ...
    @Test
    public void testBlockIdCK_withUpgrade80() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] racks = { "/rack1", "/rack2" };
    ...
    @Test
    public void testBlockIdCKDecommission_withUpgrade20() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        boolean checkDecommissionInProgress = false;
    ...
    @Test
    public void testBlockIdCKDecommission_withUpgrade40() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        boolean checkDecommissionInProgress = false;
    ...
    @Test
    public void testBlockIdCKDecommission_withUpgrade60() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        boolean checkDecommissionInProgress = false;
    ...
    @Test
    public void testBlockIdCKDecommission_withUpgrade80() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        boolean checkDecommissionInProgress = false;
    ...
    @Test(timeout = 90000)
    public void testBlockIdCKMaintenance_withUpgrade20() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test(timeout = 90000)
    public void testBlockIdCKMaintenance_withUpgrade40() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test(timeout = 90000)
    public void testBlockIdCKMaintenance_withUpgrade60() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test(timeout = 90000)
    public void testBlockIdCKMaintenance_withUpgrade80() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test
    public void testBlockIdCKCorruption_withUpgrade20() throws Exception {
        short numDn = 1;
        final long blockSize = 512;
        Random random = new Random();
        ExtendedBlock block;
    ...
    @Test
    public void testBlockIdCKCorruption_withUpgrade40() throws Exception {
        short numDn = 1;
        final long blockSize = 512;
        Random random = new Random();
        ExtendedBlock block;
    ...
    @Test
    public void testBlockIdCKCorruption_withUpgrade60() throws Exception {
        short numDn = 1;
        final long blockSize = 512;
        Random random = new Random();
        ExtendedBlock block;
    ...
    @Test
    public void testBlockIdCKCorruption_withUpgrade80() throws Exception {
        short numDn = 1;
        final long blockSize = 512;
        Random random = new Random();
        ExtendedBlock block;
    ...
    @Test
    public void testStoragePoliciesCK_withUpgrade20() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testStoragePoliciesCK_withUpgrade40() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testStoragePoliciesCK_withUpgrade60() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testStoragePoliciesCK_withUpgrade80() throws Exception {
        File builderBaseDir = new File(GenericTestUtils.getRandomizedTempPath());
        cluster = new MiniDFSClusterInJVM.Builder(conf, builderBaseDir).numDataNodes(3).storageTypes(new StorageType[] { StorageType.DISK, StorageType.ARCHIVE }).build();
        cluster.waitActive();
        final DistributedFileSystem dfs = cluster.getFileSystem();
    ...
    @Test
    public void testFsckWithDecommissionedReplicas_withUpgrade20() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test
    public void testFsckWithDecommissionedReplicas_withUpgrade40() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test
    public void testFsckWithDecommissionedReplicas_withUpgrade60() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test
    public void testFsckWithDecommissionedReplicas_withUpgrade80() throws Exception {
        final short replFactor = 1;
        short numDn = 2;
        final long blockSize = 512;
        final long fileSize = 1024;
    ...
    @Test(timeout = 90000)
    public void testFsckWithMaintenanceReplicas_withUpgrade20() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test(timeout = 90000)
    public void testFsckWithMaintenanceReplicas_withUpgrade40() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test(timeout = 90000)
    public void testFsckWithMaintenanceReplicas_withUpgrade60() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test(timeout = 90000)
    public void testFsckWithMaintenanceReplicas_withUpgrade80() throws Exception {
        final short replFactor = 2;
        short numDn = 2;
        final long blockSize = 512;
        String[] hosts = { "host1", "host2" };
    ...
    @Test
    public void testFsckListCorruptSnapshotFiles_withUpgrade20() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_DATANODE_DIRECTORYSCAN_INTERVAL_KEY, 1);
        DistributedFileSystem hdfs = null;
        final short replFactor = 1;
    ...
    @Test
    public void testFsckListCorruptSnapshotFiles_withUpgrade40() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_DATANODE_DIRECTORYSCAN_INTERVAL_KEY, 1);
        DistributedFileSystem hdfs = null;
        final short replFactor = 1;
    ...
    @Test
    public void testFsckListCorruptSnapshotFiles_withUpgrade60() throws Exception {
        conf.setLong(DFSConfigKeys.DFS_BLOCKREPORT_INTERVAL_MSEC_KEY, 1000);
        conf.setInt(DFSConfigKeys.DFS_DATANODE_DIRECTORYSCAN_INTERVAL_KEY, 1);
        DistributedFileSystem hdfs = null;
        final short replFactor = 1;
    ...
    @Test(timeout = 300000)
    public void testFsckMoveAfterCorruption_withUpgrade20() throws Exception {
        final int dfsBlockSize = 512 * 1024;
        final int numDatanodes = 1;
        final int replication = 1;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
    ...
    @Test(timeout = 300000)
    public void testFsckMoveAfterCorruption_withUpgrade40() throws Exception {
        final int dfsBlockSize = 512 * 1024;
        final int numDatanodes = 1;
        final int replication = 1;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
    ...
    @Test(timeout = 300000)
    public void testFsckMoveAfterCorruption_withUpgrade60() throws Exception {
        final int dfsBlockSize = 512 * 1024;
        final int numDatanodes = 1;
        final int replication = 1;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
    ...
    @Test(timeout = 300000)
    public void testFsckMoveAfterCorruption_withUpgrade80() throws Exception {
        final int dfsBlockSize = 512 * 1024;
        final int numDatanodes = 1;
        final int replication = 1;
        conf.setLong(DFSConfigKeys.DFS_BLOCK_SIZE_KEY, dfsBlockSize);
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptECFile_withUpgrade20() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptECFile_withUpgrade40() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptECFile_withUpgrade60() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptECFile_withUpgrade80() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckMissingECFile_withUpgrade20() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckMissingECFile_withUpgrade40() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckMissingECFile_withUpgrade60() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckMissingECFile_withUpgrade80() throws Exception {
        DistributedFileSystem fs = null;
        int dataBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumDataUnits();
        int parityBlocks = StripedFileTestUtil.getDefaultECPolicy().getNumParityUnits();
        int cellSize = StripedFileTestUtil.getDefaultECPolicy().getCellSize();
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptWhenOneReplicaIsCorrupt_withUpgrade20() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(2).build()) {
            cluster.waitActive();
            FileSystem fs = HATestUtil.configureFailoverFs(cluster, conf);
            cluster.transitionToActive(0);
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptWhenOneReplicaIsCorrupt_withUpgrade40() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(2).build()) {
            cluster.waitActive();
            FileSystem fs = HATestUtil.configureFailoverFs(cluster, conf);
            cluster.transitionToActive(0);
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptWhenOneReplicaIsCorrupt_withUpgrade60() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(2).build()) {
            cluster.waitActive();
            FileSystem fs = HATestUtil.configureFailoverFs(cluster, conf);
            cluster.transitionToActive(0);
    ...
    @Test(timeout = 300000)
    public void testFsckCorruptWhenOneReplicaIsCorrupt_withUpgrade80() throws Exception {
        try (MiniDFSClusterInJVM cluster = new MiniDFSClusterInJVM.Builder(conf, new File(GenericTestUtils.getRandomizedTempPath())).nnTopology(MiniDFSNNTopology.simpleHATopology()).numDataNodes(2).build()) {
            cluster.waitActive();
            FileSystem fs = HATestUtil.configureFailoverFs(cluster, conf);
            cluster.transitionToActive(0);
    ...
    @Test
    public void testFsckNonPrivilegedListCorrupt_withUpgrade20() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting("systest", new String[] { "" });
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
    ...
    @Test
    public void testFsckNonPrivilegedListCorrupt_withUpgrade40() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting("systest", new String[] { "" });
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
    ...
    @Test
    public void testFsckNonPrivilegedListCorrupt_withUpgrade60() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting("systest", new String[] { "" });
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
    ...
    @Test
    public void testFsckNonPrivilegedListCorrupt_withUpgrade80() throws Exception {
        cluster = new MiniDFSClusterInJVM.Builder(conf).numDataNodes(4).build();
        UserGroupInformation ugi = UserGroupInformation.createUserForTesting("systest", new String[] { "" });
        ugi.doAs(new PrivilegedExceptionAction<Void>() {
