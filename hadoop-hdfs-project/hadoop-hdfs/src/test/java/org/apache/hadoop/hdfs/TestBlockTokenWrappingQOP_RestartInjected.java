...
public class TestBlockTokenWrappingQOP_RestartInjected extends SaslDataTransferTestCase {
  ...
  public void testAddBlockWrappingQOP() throws Exception {
    ...
    RestartFramework.at("before_add_block")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testAppendWrappingQOP() throws Exception {
    ...
    RestartFramework.at("before_append")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
