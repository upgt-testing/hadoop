 ...
 */
public class TestViewFileSystemLinkMergeSlash_RestartInjected_Randomized_123 extends ViewFileSystemBaseTest {
    ...
    private static final File TEST_DIR = GenericTestUtils.getTestDir(TestViewFileSystemLinkMergeSlash_RestartInjected.class.getSimpleName());

    private static final String TEST_TEMP_PATH = "/tmp/TestViewFileSystemLinkMergeSlash";

    private final static Logger LOG = LoggerFactory.getLogger(TestViewFileSystemLinkMergeSlash_RestartInjected.class);
    ...
    public void testChildFileSystems() throws Exception {
        ...
        RestartFramework.at("after_filesystem_get").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
