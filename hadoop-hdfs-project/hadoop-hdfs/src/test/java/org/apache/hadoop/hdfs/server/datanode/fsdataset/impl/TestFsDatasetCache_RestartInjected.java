...
public class TestFsDatasetCache_RestartInjected {
  private static final org.slf4j.Logger LOG =
      LoggerFactory.getLogger(TestFsDatasetCache_RestartInjected.class);
  ...
  private void testCacheAndUncacheBlock() throws Exception {
    ...
    RestartFramework.at("after_all_blocks_cached")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_all_blocks_uncached")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
