...
public class TestNNStorageRetentionFunctional {
    ...
    @Test
    public void testPurgingWithNameEditsDirAfterFailure_withUpgrade20() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
        File sd0 = new File(TEST_ROOT_DIR, "nn0");
    ...
    @Test
    public void testPurgingWithNameEditsDirAfterFailure_withUpgrade40() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
        File sd0 = new File(TEST_ROOT_DIR, "nn0");
    ...
    @Test
    public void testPurgingWithNameEditsDirAfterFailure_withUpgrade60() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
        File sd0 = new File(TEST_ROOT_DIR, "nn0");
    ...
    @Test
    public void testPurgingWithNameEditsDirAfterFailure_withUpgrade80() throws Exception {
        MiniDFSClusterInJVM cluster = null;
        Configuration conf = new HdfsConfiguration();
        conf.setLong(DFSConfigKeys.DFS_NAMENODE_NUM_EXTRA_EDITS_RETAINED_KEY, 0);
        File sd0 = new File(TEST_ROOT_DIR, "nn0");
