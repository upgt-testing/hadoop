 ...
 */
public class TestFSImageWithXAttr_RestartInjected_Randomized_123 {
    ...
    private void testXAttr(boolean persistNamespace) throws IOException {
        ...
        restart(fs, persistNamespace);
        RestartFramework.at("after_modify_xattr").on(cluster).restart("namenode").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        xattrs = fs.getXAttrs(path);
