...
public class TestDeleteBlockPool {
    ...
    public void testDeleteBlockPool() throws Exception {
        ...
        try {
            ...
            cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(conf.get(DFSConfigKeys.DFS_NAMESERVICES))).numDataNodes(2).build();
            cluster.waitActive();
            ...
            File finalDir1 = MiniDFSClusterInJVM.getFinalizedDir(dn2StorageDir1, bpid1);
            File finalDir2 = MiniDFSClusterInJVM.getFinalizedDir(dn2StorageDir1, bpid2);
    ...
    public void testDfsAdminDeleteBlockPool() throws Exception {
        ...
        try {
            conf.set(DFSConfigKeys.DFS_NAMESERVICES, "namesServerId1,namesServerId2");
            cluster = new MiniDFSClusterInJVM.Builder(conf).nnTopology(MiniDFSNNTopology.simpleFederatedTopology(conf.get(DFSConfigKeys.DFS_NAMESERVICES))).numDataNodes(1).build();
            cluster.waitActive();
            FileSystem fs1 = cluster.getFileSystem(0);
            FileSystem fs2 = cluster.getFileSystem(1);
    ...
    private void verifyBlockPoolDirectories(boolean shouldExist, File storageDir, String bpid) throws IOException {
        File bpDir = new File(storageDir, DataStorage.STORAGE_DIR_CURRENT + "/" + bpid);
    ...
    @Test
    public void testDeleteBlockPool_withUpgrade20() throws Exception {
        // Start cluster with a 2 NN and 2 DN
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDeleteBlockPool_withUpgrade40() throws Exception {
        // Start cluster with a 2 NN and 2 DN
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDeleteBlockPool_withUpgrade60() throws Exception {
        // Start cluster with a 2 NN and 2 DN
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDeleteBlockPool_withUpgrade80() throws Exception {
        // Start cluster with a 2 NN and 2 DN
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
    ...
    @Test
    public void testDfsAdminDeleteBlockPool_withUpgrade20() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            conf.set(DFSConfigKeys.DFS_NAMESERVICES, "namesServerId1,namesServerId2");
    ...
    @Test
    public void testDfsAdminDeleteBlockPool_withUpgrade40() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            conf.set(DFSConfigKeys.DFS_NAMESERVICES, "namesServerId1,namesServerId2");
    ...
    @Test
    public void testDfsAdminDeleteBlockPool_withUpgrade60() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            conf.set(DFSConfigKeys.DFS_NAMESERVICES, "namesServerId1,namesServerId2");
    ...
    @Test
    public void testDfsAdminDeleteBlockPool_withUpgrade80() throws Exception {
        Configuration conf = new Configuration();
        MiniDFSClusterInJVM cluster = null;
        try {
            conf.set(DFSConfigKeys.DFS_NAMESERVICES, "namesServerId1,namesServerId2");
