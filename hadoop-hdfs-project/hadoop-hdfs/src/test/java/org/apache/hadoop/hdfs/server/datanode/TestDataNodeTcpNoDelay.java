...
public class TestDataNodeTcpNoDelay {
    ...
    public void testTcpNoDelayEnabled() throws Exception {
        ...
        MiniDFSClusterInJVM dfsCluster = new MiniDFSClusterInJVM.Builder(testConf).numDataNodes(3).build();
    ...
    @Test
    public void testTcpNoDelayEnabled_withUpgrade20() throws Exception {
        Configuration testConf = new Configuration(baseConf);
        // active by default
        testConf.set(HADOOP_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY, SocketFactoryWrapper.class.getName());
        SocketFactory defaultFactory = NetUtils.getDefaultSocketFactory(testConf);
    ...
    @Test
    public void testTcpNoDelayEnabled_withUpgrade60() throws Exception {
        Configuration testConf = new Configuration(baseConf);
        // active by default
        testConf.set(HADOOP_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY, SocketFactoryWrapper.class.getName());
        SocketFactory defaultFactory = NetUtils.getDefaultSocketFactory(testConf);
    ...
    @Test
    public void testTcpNoDelayEnabled_withUpgrade80() throws Exception {
        Configuration testConf = new Configuration(baseConf);
        // active by default
        testConf.set(HADOOP_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY, SocketFactoryWrapper.class.getName());
        SocketFactory defaultFactory = NetUtils.getDefaultSocketFactory(testConf);
    ...
    @Test
    public void testTcpNoDelayDisabled_withUpgrade20() throws Exception {
        Configuration testConf = new Configuration(baseConf);
        // disable TCP_NODELAY in settings
        setTcpNoDelay(testConf, false);
        testConf.set(HADOOP_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY, SocketFactoryWrapper.class.getName());
    ...
    @Test
    public void testTcpNoDelayDisabled_withUpgrade60() throws Exception {
        Configuration testConf = new Configuration(baseConf);
        // disable TCP_NODELAY in settings
        setTcpNoDelay(testConf, false);
        testConf.set(HADOOP_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY, SocketFactoryWrapper.class.getName());
    ...
    @Test
    public void testTcpNoDelayDisabled_withUpgrade80() throws Exception {
        Configuration testConf = new Configuration(baseConf);
        // disable TCP_NODELAY in settings
        setTcpNoDelay(testConf, false);
        testConf.set(HADOOP_RPC_SOCKET_FACTORY_CLASS_DEFAULT_KEY, SocketFactoryWrapper.class.getName());
