...
public class TestSecureNameNode_RestartInjected extends SaslDataTransferTestCase {
  ...
  public void testName() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_superuser_login")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
      ...
      RestartFramework.at("after_tmp_directory_created_with_permissions")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_regular_user_login")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_directory_created_in_tmp")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testNameNodeStatusMXBeanSecurityEnabled() throws Exception {
    ...
    try (MiniDFSCluster cluster =
      ...
      RestartFramework.at("after_simple_cluster_started")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_simple_security_check")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
    ...
    try (MiniDFSCluster cluster =
      ...
      RestartFramework.at("after_secure_cluster_started")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_secure_security_check")
          .on(cluster)
          .restart("namenode")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
