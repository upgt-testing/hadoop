...
public class TestViewFsDefaultValue {
    ...
    @Test
    public void testGetContentSummary_withUpgrade20() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
    ...
    @Test
    public void testGetContentSummary_withUpgrade40() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        ContentSummary cs = vfs.getContentSummary(testFileDirPath);
    ...
    @Test
    public void testGetContentSummary_withUpgrade60() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        ContentSummary cs = vfs.getContentSummary(testFileDirPath);
    ...
    @Test
    public void testGetContentSummary_withUpgrade80() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        ContentSummary cs = vfs.getContentSummary(testFileDirPath);
    ...
    @Test
    public void testGetQuotaUsage_withUpgrade20() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGetQuotaUsage_withUpgrade40() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        QuotaUsage qu = vfs.getQuotaUsage(testFileDirPath);
    ...
    @Test
    public void testGetQuotaUsage_withUpgrade60() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        QuotaUsage qu = vfs.getQuotaUsage(testFileDirPath);
    ...
    @Test
    public void testGetQuotaUsage_withUpgrade80() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, 100, 500);
        QuotaUsage qu = vfs.getQuotaUsage(testFileDirPath);
    ...
    @Test
    public void testGetQuotaUsageWithStorageTypes_withUpgrade20() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, 500);
        cluster.restartNodeForTesting(0);
    ...
    @Test
    public void testGetQuotaUsageWithStorageTypes_withUpgrade40() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, 500);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.DISK, 600);
    ...
    @Test
    public void testGetQuotaUsageWithStorageTypes_withUpgrade60() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, 500);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.DISK, 600);
    ...
    @Test
    public void testGetQuotaUsageWithStorageTypes_withUpgrade80() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, 500);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.DISK, 600);
    ...
    @Test
    public void testGetQuotaUsageWithQuotaDefined_withUpgrade20() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, -1, -1);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, -1);
    ...
    @Test
    public void testGetQuotaUsageWithQuotaDefined_withUpgrade40() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, -1, -1);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, -1);
    ...
    @Test
    public void testGetQuotaUsageWithQuotaDefined_withUpgrade60() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, -1, -1);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, -1);
    ...
    @Test
    public void testGetQuotaUsageWithQuotaDefined_withUpgrade80() throws IOException {
        FileSystem hFs = cluster.getFileSystem(0);
        final DistributedFileSystem dfs = (DistributedFileSystem) hFs;
        dfs.setQuota(testFileDirPath, -1, -1);
        dfs.setQuotaByStorageType(testFileDirPath, StorageType.SSD, -1);
