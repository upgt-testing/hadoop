 ...
 */
public class TestOfflineImageViewerForStoragePolicy_RestartInjected {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestOfflineImageViewerForStoragePolicy_RestartInjected.class);
  ...
  public void testPBDelimitedWriterForStoragePolicy() throws Exception {
    RestartFramework.at("before_read_fsimage")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
    ...
    RestartFramework.at("after_read_fsimage")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
