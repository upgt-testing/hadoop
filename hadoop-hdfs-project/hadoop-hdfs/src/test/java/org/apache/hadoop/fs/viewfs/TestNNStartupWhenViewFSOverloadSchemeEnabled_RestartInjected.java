 ...
 */
public class TestNNStartupWhenViewFSOverloadSchemeEnabled_RestartInjected {
  ...
  public void testHANameNodeAndDataNodeStartup() throws Exception {
    ...
    RestartFramework.at("after_ha_cluster_build")
        .on(cluster)
        .restart("datanode")
        .withIndex(0)
    ...
    RestartFramework.at("after_wait_active")
        .on(cluster)
        .restart("namenode")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
