...
public class TestJobHistoryEventHandler {
    ...
    public void testTimelineEventHandling() throws Exception {
        ...
        try (MiniYARNClusterInJVM yarnCluster = new MiniYARNClusterInJVM(TestJobHistoryEventHandler.class.getSimpleName(), 1, 1, 1, 1)) {
            ...
            confJHEH.set(YarnConfiguration.TIMELINE_SERVICE_WEBAPP_ADDRESS, MiniYARNClusterInJVM.getHostname() + ":" + yarnCluster.getApplicationHistoryServer().getPort());
    ...
    // stored to the Timeline store
    @Test(timeout = 50000)
    public void testTimelineEventHandling_withUpgrade20() throws Exception {
        TestParams t = new TestParams(RunningAppContext.class, false);
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.TIMELINE_SERVICE_ENABLED, true);
        long currentTime = System.currentTimeMillis();
    ...
    // stored to the Timeline store
    @Test(timeout = 50000)
    public void testTimelineEventHandling_withUpgrade40() throws Exception {
        TestParams t = new TestParams(RunningAppContext.class, false);
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.TIMELINE_SERVICE_ENABLED, true);
        long currentTime = System.currentTimeMillis();
    ...
    // stored to the Timeline store
    @Test(timeout = 50000)
    public void testTimelineEventHandling_withUpgrade60() throws Exception {
        TestParams t = new TestParams(RunningAppContext.class, false);
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.TIMELINE_SERVICE_ENABLED, true);
        long currentTime = System.currentTimeMillis();
    ...
    // stored to the Timeline store
    @Test(timeout = 50000)
    public void testTimelineEventHandling_withUpgrade80() throws Exception {
        TestParams t = new TestParams(RunningAppContext.class, false);
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.TIMELINE_SERVICE_ENABLED, true);
        long currentTime = System.currentTimeMillis();
