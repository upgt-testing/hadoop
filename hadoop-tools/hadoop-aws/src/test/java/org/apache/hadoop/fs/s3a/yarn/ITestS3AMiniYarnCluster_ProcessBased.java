...
/**
 * ProcessBased version of {@link ITestS3AMiniYarnCluster}.
 *
 ...
 *
 * Tests that S3A is usable through a YARN application with process-based cluster.
 *
 * @see ITestS3AMiniYarnCluster Original test using MiniYARNCluster
 */
@RunWith(Parameterized.class)
public class ITestS3AMiniYarnCluster_ProcessBased extends AbstractS3ATestBase {
