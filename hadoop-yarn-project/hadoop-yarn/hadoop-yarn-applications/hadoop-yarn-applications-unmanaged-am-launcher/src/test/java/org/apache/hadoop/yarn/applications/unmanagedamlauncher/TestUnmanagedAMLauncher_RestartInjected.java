...
public class TestUnmanagedAMLauncher_RestartInjected {
  private static final Logger LOG = LoggerFactory
      .getLogger(TestUnmanagedAMLauncher_RestartInjected.class);
  ...
  public void testUMALauncher() throws Exception {
    ...
    String[] args = {
        ...
        javaHome
            + "/bin/java -Xmx512m "
            + TestUnmanagedAMLauncher_RestartInjected.class.getCanonicalName()
            + " success" };
    ...
    RestartFramework.at("after_launcher_init")
        .on(yarnCluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_launcher_run")
        .on(yarnCluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
