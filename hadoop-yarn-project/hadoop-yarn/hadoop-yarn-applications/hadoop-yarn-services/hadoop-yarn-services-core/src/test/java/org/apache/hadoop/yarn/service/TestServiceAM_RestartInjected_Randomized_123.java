...
public class TestServiceAM_RestartInjected_Randomized_123 extends ServiceTestUtils {

    private static final Logger LOG = LoggerFactory.getLogger(TestServiceAM_RestartInjected.class);
