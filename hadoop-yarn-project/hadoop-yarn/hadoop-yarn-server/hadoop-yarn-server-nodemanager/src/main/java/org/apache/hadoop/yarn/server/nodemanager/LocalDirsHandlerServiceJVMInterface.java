...
import org.apache.hadoop.yarn.server.nodemanager.health.HealthReporterJVMInterface;

public interface LocalDirsHandlerServiceJVMInterface extends AbstractServiceJVMInterface, HealthReporterJVMInterface {
