...
public abstract class NMStateStoreService extends AbstractService implements NMStateStoreServiceJVMInterface {
  ...
  public void storeContainerRestartTimes_bridge(org.apache.hadoop.yarn.api.records.ContainerIdJVMInterface arg0, java.util.List<java.lang.Long> arg1) throws java.io.IOException {
      try {
          java.lang.reflect.Method target = null;
          {
              Class<?>[] __types = new Class<?>[2];
              ...
              __types[1] = (arg1 != null ? arg1.getClass() : Object.class);
              try {
                  target = this.getClass().getMethod("storeContainerRestartTimes", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("storeContainerRestartTimes"))
                      continue;
                  if (m.getParameterCount() != 2)
                      continue;
                  if (m.getReturnType().getName().equals("void"))
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: storeContainerRestartTimes");
          target.setAccessible(true);
          target.invoke(this, arg0, arg1);
          return;
      } catch (Throwable e) {
  ...
  public void storeAssignedResources_bridge(java.lang.Object arg0, java.lang.String arg1, java.util.List<java.io.Serializable> arg2) throws java.io.IOException {
      try {
          java.lang.reflect.Method target = null;
          {
              ...
              try {
                  target = this.getClass().getMethod("storeAssignedResources", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("storeAssignedResources"))
                      continue;
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: storeAssignedResources");
          target.setAccessible(true);
  ...
  public void setNodeStatusUpdater_bridge(java.lang.Object arg0) {
      try {
          java.lang.reflect.Method target = null;
          {
              Class<?>[] __types = new Class<?>[1];
              __types[0] = (arg0 != null ? arg0.getClass() : Object.class);
              try {
                  target = this.getClass().getMethod("setNodeStatusUpdater", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("setNodeStatusUpdater"))
                      continue;
                  if (m.getParameterCount() != 1)
                      continue;
                  if (m.getReturnType().getName().equals("void"))
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: setNodeStatusUpdater");
          target.setAccessible(true);
          target.invoke(this, arg0);
          return;
      } catch (Throwable e) {
