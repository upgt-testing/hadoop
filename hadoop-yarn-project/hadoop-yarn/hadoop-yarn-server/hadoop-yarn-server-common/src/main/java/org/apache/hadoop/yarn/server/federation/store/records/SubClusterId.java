...
@Private
@Unstable
public abstract class SubClusterId implements Comparable<SubClusterId>, SubClusterIdJVMInterface {
  ...
  public int compareTo_bridge(org.apache.hadoop.yarn.server.federation.store.records.SubClusterIdJVMInterface arg0) {
      try {
