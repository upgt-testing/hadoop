...
public interface NodeHeartbeatResponseJVMInterface {
    ...
    void setTokenSequenceNo(long arg0);

    java.util.Collection getSystemCredentialsForApps();

    java.util.List getApplicationsToCleanup();

    void setSystemCredentialsForApps(java.util.Collection<org.apache.hadoop.yarn.proto.YarnServerCommonServiceProtos.SystemCredentialsForAppsProto> arg0);
