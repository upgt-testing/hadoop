...
public class ClientRMService extends AbstractService implements
  ...
  public org.apache.hadoop.yarn.api.protocolrecords.SubmitApplicationResponseJVMInterface submitApplication_bridge(org.apache.hadoop.yarn.api.protocolrecords.SubmitApplicationRequestJVMInterface arg0) throws org.apache.hadoop.yarn.exceptions.YarnException {
      try {
          java.lang.reflect.Method target = null;
          {
              Class<?>[] __types = new Class<?>[1];
