...
public class TestMiniYarnClusterNodeUtilization {
     ...
     */
    @Test(timeout = 60000)
    public void testUpdateNodeUtilization_withUpgrade20() throws InterruptedException, IOException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        // Give the heartbeat time to propagate to the RM
        verifySimulatedUtilization();
     ...
     */
    @Test(timeout = 60000)
    public void testUpdateNodeUtilization_withUpgrade40() throws InterruptedException, IOException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        // Give the heartbeat time to propagate to the RM
        verifySimulatedUtilization();
        cluster.upgradeAllNodes();
     ...
     */
    @Test(timeout = 60000)
    public void testUpdateNodeUtilization_withUpgrade60() throws InterruptedException, IOException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        // Give the heartbeat time to propagate to the RM
        verifySimulatedUtilization();
        // Alter utilization
     ...
     */
    @Test(timeout = 60000)
    public void testUpdateNodeUtilization_withUpgrade80() throws InterruptedException, IOException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        // Give the heartbeat time to propagate to the RM
        verifySimulatedUtilization();
        // Alter utilization
     ...
     */
    @Test(timeout = 60000)
    public void testMockNodeStatusHeartbeat_withUpgrade20() throws InterruptedException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        NodeStatusUpdater updater = nm.getNodeStatusUpdater();
        cluster.upgradeAllNodes();
        updater.sendOutofBandHeartBeat();
     ...
     */
    @Test(timeout = 60000)
    public void testMockNodeStatusHeartbeat_withUpgrade40() throws InterruptedException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        NodeStatusUpdater updater = nm.getNodeStatusUpdater();
        updater.sendOutofBandHeartBeat();
        cluster.upgradeAllNodes();
     ...
     */
    @Test(timeout = 60000)
    public void testMockNodeStatusHeartbeat_withUpgrade60() throws InterruptedException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        NodeStatusUpdater updater = nm.getNodeStatusUpdater();
        updater.sendOutofBandHeartBeat();
        // Give the heartbeat time to propagate to the RM
     ...
     */
    @Test(timeout = 60000)
    public void testMockNodeStatusHeartbeat_withUpgrade80() throws InterruptedException, YarnException {
        assertTrue("NMs fail to connect to the RM", cluster.waitForNodeManagersToConnect(10000));
        NodeStatusUpdater updater = nm.getNodeStatusUpdater();
        updater.sendOutofBandHeartBeat();
        // Give the heartbeat time to propagate to the RM
