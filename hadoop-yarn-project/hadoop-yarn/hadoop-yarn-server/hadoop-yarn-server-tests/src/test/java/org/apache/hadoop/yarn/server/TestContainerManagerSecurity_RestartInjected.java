...
public class TestContainerManagerSecurity_RestartInjected extends KerberosSecurityTestcase {
  ...
  private static final File testRootDir = new File("target",
    TestContainerManagerSecurity_RestartInjected.class.getName() + "-root");
  ...
  public void setUp() throws Exception {
    ...
    yarnCluster =
        new MiniYARNCluster(TestContainerManagerSecurity_RestartInjected.class.getName(), 1, 1,
            1);
  ...
  public TestContainerManagerSecurity_RestartInjected(String name, Configuration conf) {
