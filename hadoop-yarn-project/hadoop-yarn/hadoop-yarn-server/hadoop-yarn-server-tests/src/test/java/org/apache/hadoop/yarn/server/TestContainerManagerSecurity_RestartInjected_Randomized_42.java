...
public class TestContainerManagerSecurity_RestartInjected_Randomized_42 extends KerberosSecurityTestcase {
   ...
   */
    ...
    public TestContainerManagerSecurity_RestartInjected_Randomized_42(String name, Configuration conf) {
