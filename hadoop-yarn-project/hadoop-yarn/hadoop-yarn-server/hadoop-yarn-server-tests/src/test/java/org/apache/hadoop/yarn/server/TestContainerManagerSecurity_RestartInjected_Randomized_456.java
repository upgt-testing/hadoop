...
public class TestContainerManagerSecurity_RestartInjected_Randomized_456 extends KerberosSecurityTestcase {

    static Logger LOG = LoggerFactory.getLogger(TestContainerManagerSecurity_RestartInjected.class);

    static final RecordFactory recordFactory = RecordFactoryProvider.getRecordFactory(null);

    private static MiniYARNCluster yarnCluster;

    private static final File testRootDir = new File("target", TestContainerManagerSecurity_RestartInjected.class.getName() + "-root");
    ...
    public void setUp() throws Exception {
        ...
        yarnCluster = new MiniYARNCluster(TestContainerManagerSecurity_RestartInjected.class.getName(), 1, 1, 1);
   ...
   */
    ...
    public TestContainerManagerSecurity_RestartInjected_Randomized_456(String name, Configuration conf) {
