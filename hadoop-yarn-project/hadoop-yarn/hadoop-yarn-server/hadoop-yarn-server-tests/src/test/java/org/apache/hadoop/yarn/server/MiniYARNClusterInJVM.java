...
public class MiniYARNClusterInJVM extends CompositeService {
    ...
    public void serviceInit(Configuration conf) throws Exception {
        ...
        for (int i = 0; i < resourceManagers.length; i++) {
            System.out.println("array comp type  = " + resourceManagers.getClass().getComponentType()
                    + " @loader=" + resourceManagers.getClass().getComponentType().getClassLoader());
    ...
    public synchronized void restartResourceManager(int index) throws InterruptedException {
        ...
        resourceManagers[index] = resourceManagerInstance.createResourceManagerForInJVMCluster();
    ...
    protected ResourceManagerJVMInterface createResourceManager() {
        return resourceManagerInstance.createResourceManagerForInJVMCluster();
    }
