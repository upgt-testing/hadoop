 ...
 */
public class TestYarnClient_RestartInjected extends ParameterizedSchedulerTestBase {

  public TestYarnClient_RestartInjected(SchedulerType type) throws IOException {
    super(type);
  }
  ...
  public void testSubmitIncorrectQueueToCapacityScheduler() throws IOException {
    ...
    try {
      ...
      RestartFramework.at("before_app_submit")
          .on(cluster)
          .restart("resourcemanager")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testAMMRTokens() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_managed_app_submit")
          .on(cluster)
          .restart("resourcemanager")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
