...
public class TestYarnClientWithReservation_RestartInjected_Randomized_456 {
    ...
    public TestYarnClientWithReservation_RestartInjected_Randomized_456(SchedulerType scheduler) {
    ...
    public void testCreateReservation() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_reservation_submit").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
