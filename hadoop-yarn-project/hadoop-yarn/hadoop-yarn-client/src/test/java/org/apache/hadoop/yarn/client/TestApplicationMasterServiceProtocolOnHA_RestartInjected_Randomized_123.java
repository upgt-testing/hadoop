...
public class TestApplicationMasterServiceProtocolOnHA_RestartInjected_Randomized_123 extends ApplicationMasterServiceProtoTestBase {
    ...
    public void testRegisterApplicationMasterOnHA() throws YarnException, IOException {
        ...
        RestartFramework.at("after_am_register").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testFinishApplicationMasterOnHA() throws YarnException, IOException {
        RestartFramework.at("after_am_finish").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAllocateOnHA() throws YarnException, IOException {
        ...
        RestartFramework.at("after_allocate").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
