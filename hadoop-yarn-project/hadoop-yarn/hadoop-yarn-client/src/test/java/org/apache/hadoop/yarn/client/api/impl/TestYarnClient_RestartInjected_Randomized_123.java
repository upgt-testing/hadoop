 ...
 */
public class TestYarnClient_RestartInjected_Randomized_123 extends ParameterizedSchedulerTestBase {

    public TestYarnClient_RestartInjected_Randomized_123(SchedulerType type) throws IOException {
        super(type);
    }
    ...
    public void testSubmitIncorrectQueueToCapacityScheduler() throws IOException {
        ...
        try {
            ...
            rmClient.start();
            RestartFramework.at("after_cluster_start").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            ...
            RestartFramework.at("before_app_submit").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testAMMRTokens() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_managed_app_submit").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
