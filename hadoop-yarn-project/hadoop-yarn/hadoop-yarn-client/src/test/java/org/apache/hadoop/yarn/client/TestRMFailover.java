...
public class TestRMFailover extends ClientBaseWithFixes {
    ...
    private void verifyRMTransitionToStandby(final ResourceManager rm) throws InterruptedException {
        try {
    ...
    @Test
    public void testExplicitFailover_withUpgrade20() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testExplicitFailover_withUpgrade40() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testExplicitFailover_withUpgrade60() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testExplicitFailover_withUpgrade80() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testAutomaticFailover_withUpgrade20() throws YarnException, InterruptedException, IOException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        conf.setInt(YarnConfiguration.RM_ZK_TIMEOUT_MS, 2000);
        cluster.init(conf);
    ...
    @Test
    public void testAutomaticFailover_withUpgrade40() throws YarnException, InterruptedException, IOException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        conf.setInt(YarnConfiguration.RM_ZK_TIMEOUT_MS, 2000);
        cluster.init(conf);
    ...
    @Test
    public void testAutomaticFailover_withUpgrade60() throws YarnException, InterruptedException, IOException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        conf.setInt(YarnConfiguration.RM_ZK_TIMEOUT_MS, 2000);
        cluster.init(conf);
    ...
    @Test
    public void testAutomaticFailover_withUpgrade80() throws YarnException, InterruptedException, IOException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        conf.setInt(YarnConfiguration.RM_ZK_TIMEOUT_MS, 2000);
        cluster.init(conf);
    ...
    @Test
    public void testWebAppProxyInStandAloneMode_withUpgrade20() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        WebAppProxyServer webAppProxyServer = new WebAppProxyServer();
        try {
            conf.set(YarnConfiguration.PROXY_ADDRESS, "0.0.0.0:9099");
    ...
    @Test
    public void testWebAppProxyInStandAloneMode_withUpgrade40() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        WebAppProxyServer webAppProxyServer = new WebAppProxyServer();
        try {
            conf.set(YarnConfiguration.PROXY_ADDRESS, "0.0.0.0:9099");
    ...
    @Test
    public void testWebAppProxyInStandAloneMode_withUpgrade60() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        WebAppProxyServer webAppProxyServer = new WebAppProxyServer();
        try {
            conf.set(YarnConfiguration.PROXY_ADDRESS, "0.0.0.0:9099");
    ...
    @Test
    public void testWebAppProxyInStandAloneMode_withUpgrade80() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        WebAppProxyServer webAppProxyServer = new WebAppProxyServer();
        try {
            conf.set(YarnConfiguration.PROXY_ADDRESS, "0.0.0.0:9099");
    ...
    @Test
    public void testEmbeddedWebAppProxy_withUpgrade20() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testEmbeddedWebAppProxy_withUpgrade40() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testEmbeddedWebAppProxy_withUpgrade60() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testEmbeddedWebAppProxy_withUpgrade80() throws YarnException, InterruptedException, IOException {
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
        assertFalse("RM never turned active", -1 == cluster.getActiveRMIndex());
    ...
    @Test
    public void testRMWebAppRedirect_withUpgrade20() throws YarnException, InterruptedException, IOException {
        cluster = new MiniYARNClusterInJVM(TestRMFailover.class.getName(), 2, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
    ...
    @Test
    public void testRMWebAppRedirect_withUpgrade40() throws YarnException, InterruptedException, IOException {
        cluster = new MiniYARNClusterInJVM(TestRMFailover.class.getName(), 2, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
    ...
    @Test
    public void testRMWebAppRedirect_withUpgrade60() throws YarnException, InterruptedException, IOException {
        cluster = new MiniYARNClusterInJVM(TestRMFailover.class.getName(), 2, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
    ...
    @Test
    public void testRMWebAppRedirect_withUpgrade80() throws YarnException, InterruptedException, IOException {
        cluster = new MiniYARNClusterInJVM(TestRMFailover.class.getName(), 2, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        cluster.init(conf);
        cluster.start();
     ...
     */
    @Test
    public void testUncaughtExceptionHandlerWithHAEnabled_withUpgrade20() throws InterruptedException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        cluster.init(conf);
        cluster.start();
     ...
     */
    @Test
    public void testUncaughtExceptionHandlerWithHAEnabled_withUpgrade40() throws InterruptedException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        cluster.init(conf);
        cluster.start();
     ...
     */
    @Test
    public void testUncaughtExceptionHandlerWithHAEnabled_withUpgrade60() throws InterruptedException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        cluster.init(conf);
        cluster.start();
     ...
     */
    @Test
    public void testUncaughtExceptionHandlerWithHAEnabled_withUpgrade80() throws InterruptedException {
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "yarn-test-cluster");
        conf.set(YarnConfiguration.RM_ZK_ADDRESS, hostPort);
        cluster.init(conf);
        cluster.start();
