...
public class TestNoHaRMFailoverProxyProvider {
    ...
    public void testRestartedRM() throws Exception {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
     ...
     */
    @Test
    public void testRestartedRM_withUpgrade20() throws Exception {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = YarnClient.createYarnClient();
        try {
            cluster.init(conf);
     ...
     */
    @Test
    public void testRestartedRM_withUpgrade40() throws Exception {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = YarnClient.createYarnClient();
        try {
            cluster.init(conf);
     ...
     */
    @Test
    public void testRestartedRM_withUpgrade60() throws Exception {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = YarnClient.createYarnClient();
        try {
            cluster.init(conf);
     ...
     */
    @Test
    public void testRestartedRM_withUpgrade80() throws Exception {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = YarnClient.createYarnClient();
        try {
            cluster.init(conf);
     ...
     */
    @Test
    public void testConnectingToRM_withUpgrade20() throws Exception {
        conf.setClass(YarnConfiguration.CLIENT_FAILOVER_NO_HA_PROXY_PROVIDER, AutoRefreshNoHARMFailoverProxyProvider.class, RMFailoverProxyProvider.class);
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = null;
        try {
     ...
     */
    @Test
    public void testConnectingToRM_withUpgrade40() throws Exception {
        conf.setClass(YarnConfiguration.CLIENT_FAILOVER_NO_HA_PROXY_PROVIDER, AutoRefreshNoHARMFailoverProxyProvider.class, RMFailoverProxyProvider.class);
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = null;
        try {
     ...
     */
    @Test
    public void testConnectingToRM_withUpgrade60() throws Exception {
        conf.setClass(YarnConfiguration.CLIENT_FAILOVER_NO_HA_PROXY_PROVIDER, AutoRefreshNoHARMFailoverProxyProvider.class, RMFailoverProxyProvider.class);
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = null;
        try {
     ...
     */
    @Test
    public void testConnectingToRM_withUpgrade80() throws Exception {
        conf.setClass(YarnConfiguration.CLIENT_FAILOVER_NO_HA_PROXY_PROVIDER, AutoRefreshNoHARMFailoverProxyProvider.class, RMFailoverProxyProvider.class);
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testRestartedRMNegative", NUMNODEMANAGERS, 1, 1);
        YarnClient rmClient = null;
        try {
