...
public class TestYarnCLI_RestartInjected_Randomized_123 {

    private static final Logger LOG = LoggerFactory.getLogger(TestYarnCLI_RestartInjected.class);
    ...
    public void testGetQueueInfoOverrideIntraQueuePreemption() throws Exception {
        ...
        try {
            ...
            RestartFramework.at("after_queue_status_check").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
