 ...
 */
public class TestApplicationMasterServiceProtocolForTimelineV2_RestartInjected_Randomized_123 extends ApplicationMasterServiceProtoTestBase {
    ...
    public void testAllocateForTimelineV2OnHA() throws YarnException, IOException {
        RestartFramework.at("after_allocate_timeline").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
