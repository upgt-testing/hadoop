...
public class TestApplicationClientProtocolOnHA_RestartInjected extends ProtocolHATestBase {
  ...
  public void testGetApplicationReportOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_app_report")
        .on(cluster)
  ...
  public void testGetNewApplicationOnHA() throws Exception {
    ApplicationId appId =
        client.createApplication().getApplicationSubmissionContext()
            .getApplicationId();
    RestartFramework.at("after_create_app")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetApplicationsOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_applications")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetClusterNodesOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_node_reports")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetQueueInfoOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_queue_info")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetQueueUserAclsOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_queue_acls")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetApplicationAttemptReportOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_attempt_report")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetApplicationAttemptsOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_attempts")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetContainerReportOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_container_report")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetContainersOnHA() throws Exception {
    ...
    RestartFramework.at("after_get_containers")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMoveApplicationAcrossQueuesOnHA() throws Exception{
    ...
    RestartFramework.at("after_move_app_queue")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testForceKillApplicationOnHA() throws Exception {
    ...
    RestartFramework.at("after_app_kill")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testGetDelegationTokenOnHA() throws Exception {
    ...
    RestartFramework.at("after_token_generation")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testRenewDelegationTokenOnHA() throws Exception {
    ...
    RestartFramework.at("after_token_renew")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testCancelDelegationTokenOnHA() throws Exception {
    ...
    RestartFramework.at("after_token_cancel")
        .on(cluster)
        .restart("resourcemanager")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
