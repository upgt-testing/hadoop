...
public class TestYarnClient extends ParameterizedSchedulerTestBase {
    ...
    @Test(timeout = 30000)
    public void testSubmitIncorrectQueueToCapacityScheduler_withUpgrade20() throws IOException {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testMRAMTokens", 1, 1, 1);
        YarnClient rmClient = null;
        try {
            YarnConfiguration conf = new YarnConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSubmitIncorrectQueueToCapacityScheduler_withUpgrade40() throws IOException {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testMRAMTokens", 1, 1, 1);
        YarnClient rmClient = null;
        try {
            YarnConfiguration conf = new YarnConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSubmitIncorrectQueueToCapacityScheduler_withUpgrade60() throws IOException {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testMRAMTokens", 1, 1, 1);
        YarnClient rmClient = null;
        try {
            YarnConfiguration conf = new YarnConfiguration();
    ...
    @Test(timeout = 30000)
    public void testSubmitIncorrectQueueToCapacityScheduler_withUpgrade80() throws IOException {
        MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testMRAMTokens", 1, 1, 1);
        YarnClient rmClient = null;
        try {
            YarnConfiguration conf = new YarnConfiguration();
