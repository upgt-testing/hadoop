...
public class TestHedgingRequestRMFailoverProxyProvider {
    ...
    public void testHedgingRequestProxyProvider() throws Exception {
        ...
        try (MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testHedgingRequestProxyProvider", 5, 0, 1, 1)) {
    ...
    @Test
    public void testHedgingRequestProxyProvider_withUpgrade20() throws Exception {
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "cluster1");
    ...
    @Test
    public void testHedgingRequestProxyProvider_withUpgrade40() throws Exception {
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "cluster1");
    ...
    @Test
    public void testHedgingRequestProxyProvider_withUpgrade60() throws Exception {
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "cluster1");
    ...
    @Test
    public void testHedgingRequestProxyProvider_withUpgrade80() throws Exception {
        Configuration conf = new YarnConfiguration();
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
        conf.set(YarnConfiguration.RM_CLUSTER_ID, "cluster1");
