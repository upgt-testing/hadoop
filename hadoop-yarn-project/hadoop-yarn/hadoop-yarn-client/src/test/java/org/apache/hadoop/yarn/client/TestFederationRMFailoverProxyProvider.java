...
public class TestFederationRMFailoverProxyProvider {
    ...
    public void testFederationRMFailoverProxyProvider() throws Exception {
        ...
        final MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testFederationRMFailoverProxyProvider", 3, 0, 1, 1);
    ...
    private void makeRMActive(final SubClusterId subClusterId, final MiniYARNClusterInJVM cluster, final int index) {
        try {
    ...
    @Test
    public void testFederationRMFailoverProxyProvider_withUpgrade20() throws Exception {
        final SubClusterId subClusterId = SubClusterId.newInstance("SC-1");
        final MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testFederationRMFailoverProxyProvider", 3, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
    ...
    @Test
    public void testFederationRMFailoverProxyProvider_withUpgrade40() throws Exception {
        final SubClusterId subClusterId = SubClusterId.newInstance("SC-1");
        final MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testFederationRMFailoverProxyProvider", 3, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
    ...
    @Test
    public void testFederationRMFailoverProxyProvider_withUpgrade60() throws Exception {
        final SubClusterId subClusterId = SubClusterId.newInstance("SC-1");
        final MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testFederationRMFailoverProxyProvider", 3, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
    ...
    @Test
    public void testFederationRMFailoverProxyProvider_withUpgrade80() throws Exception {
        final SubClusterId subClusterId = SubClusterId.newInstance("SC-1");
        final MiniYARNClusterInJVM cluster = new MiniYARNClusterInJVM("testFederationRMFailoverProxyProvider", 3, 0, 1, 1);
        conf.setBoolean(YarnConfiguration.RM_HA_ENABLED, true);
        conf.setBoolean(YarnConfiguration.AUTO_FAILOVER_ENABLED, false);
