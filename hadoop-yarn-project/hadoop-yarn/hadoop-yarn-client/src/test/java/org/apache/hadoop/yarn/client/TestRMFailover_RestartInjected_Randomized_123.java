...
public class TestRMFailover_RestartInjected_Randomized_123 extends ClientBaseWithFixes {
    ...
    public void testExplicitFailover() throws YarnException, InterruptedException, IOException {
        ...
        RestartFramework.at("after_first_failover").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        verifyConnections();
    }
    ...
    public void testWebAppProxyInStandAloneMode() throws YarnException, InterruptedException, IOException {
        ...
        try {
            ...
            explicitFailover();
            verifyConnections();
            RestartFramework.at("after_failover").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
            proxyConn.connect();
            verifyResponse(proxyConn);
        } finally {
