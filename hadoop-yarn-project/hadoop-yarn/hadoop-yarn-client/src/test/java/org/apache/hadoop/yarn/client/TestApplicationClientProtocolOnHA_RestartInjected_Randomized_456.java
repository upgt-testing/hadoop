...
public class TestApplicationClientProtocolOnHA_RestartInjected_Randomized_456 extends ProtocolHATestBase {
    ...
    public void testGetApplicationReportOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_app_report").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetNewApplicationOnHA() throws Exception {
        ...
        RestartFramework.at("after_create_app").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetClusterMetricsOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_cluster_metrics").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetApplicationsOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_applications").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetClusterNodesOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_node_reports").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Assert.assertTrue(reports != null);
        Assert.assertFalse(reports.isEmpty());
    ...
    public void testGetQueueInfoOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_queue_info").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetQueueUserAclsOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_queue_acls").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetApplicationAttemptReportOnHA() throws Exception {
        RestartFramework.at("after_get_attempt_report").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetApplicationAttemptsOnHA() throws Exception {
        ...
        RestartFramework.at("after_get_attempts").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Assert.assertTrue(reports != null);
        Assert.assertFalse(reports.isEmpty());
    ...
    public void testGetContainerReportOnHA() throws Exception {
        ...
        Assert.assertTrue(report != null);
        RestartFramework.at("after_get_container_report").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testGetContainersOnHA() throws Exception {
        ...
        Assert.assertTrue(reports != null);
        RestartFramework.at("after_get_containers").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        Assert.assertFalse(reports.isEmpty());
    ...
    public void testSubmitApplicationOnHA() throws Exception {
        ...
        RestartFramework.at("after_app_submit").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testMoveApplicationAcrossQueuesOnHA() throws Exception {
        ...
        RestartFramework.at("after_move_app_queue").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    }

    @Test
    public void testForceKillApplicationOnHA() throws Exception {
        RestartFramework.at("after_app_kill").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        client.killApplication(cluster.createFakeAppId());
    }

    @Test
    public void testGetDelegationTokenOnHA() throws Exception {
        RestartFramework.at("after_token_generation").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testRenewDelegationTokenOnHA() throws Exception {
        ...
        RestartFramework.at("after_token_renew").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testCancelDelegationTokenOnHA() throws Exception {
        RestartFramework.at("after_token_cancel").on(cluster).restart("resourcemanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
