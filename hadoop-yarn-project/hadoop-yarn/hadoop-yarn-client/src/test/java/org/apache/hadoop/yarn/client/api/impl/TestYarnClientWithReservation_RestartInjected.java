...
public class TestYarnClientWithReservation_RestartInjected {
  ...
  public TestYarnClientWithReservation_RestartInjected(SchedulerType scheduler) {
  ...
  public void testCreateReservation() throws Exception {
    ...
    try {
      ...
      RestartFramework.at("after_reservation_submit")
          .on(cluster)
          .restart("resourcemanager")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
