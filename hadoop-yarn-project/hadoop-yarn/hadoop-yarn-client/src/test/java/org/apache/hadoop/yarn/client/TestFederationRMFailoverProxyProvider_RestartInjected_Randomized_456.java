 ...
 */
public class TestFederationRMFailoverProxyProvider_RestartInjected_Randomized_456 {
    ...
    private void testProxyProvider(boolean facadeFlushCache) throws Exception {
        ...
        verify(stateStore, times(1)).getSubClusters(any(GetSubClustersInfoRequest.class));
        threadResponse = null;
        RestartFramework.at("after_rm_active").on(cluster).restart("resourcemanager").withIndex(2).withMode(RestartMode.GRACEFUL).execute();
