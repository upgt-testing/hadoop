...
@Public
@Stable
public abstract class Container implements Comparable<Container>, ContainerJVMInterface {
  ...
  public void setId_bridge(org.apache.hadoop.yarn.api.records.ContainerIdJVMInterface arg0) {
      try {
          java.lang.reflect.Method target = null;
          {
              Class<?>[] __types = new Class<?>[1];
              __types[0] = (arg0 != null ? arg0.getClass() : Object.class);
              try {
                  target = this.getClass().getMethod("setId", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: setId");
          target.setAccessible(true);
          target.invoke(this, arg0);
          return;
      } catch (Throwable e) {
