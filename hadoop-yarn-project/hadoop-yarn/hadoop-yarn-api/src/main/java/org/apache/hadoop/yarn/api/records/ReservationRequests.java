...
@Public
@Unstable
public abstract class ReservationRequests implements ReservationRequestsJVMInterface {
  ...
  public void setInterpreter_bridge(java.lang.Object arg0) {
      try {
          java.lang.reflect.Method target = null;
          {
              ...
              try {
                  target = this.getClass().getMethod("setInterpreter", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("setInterpreter"))
                      continue;
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: setInterpreter");
