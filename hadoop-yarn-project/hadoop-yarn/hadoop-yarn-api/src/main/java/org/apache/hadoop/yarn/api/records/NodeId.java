...
@Public
@Stable
public abstract class NodeId implements Comparable<NodeId>, NodeIdJVMInterface {
  ...
  public int compareTo_bridge(org.apache.hadoop.yarn.api.records.NodeIdJVMInterface arg0) {
      try {
