 ...
 */
public class ResourceInformation implements Comparable<ResourceInformation>, ResourceInformationJVMInterface {
  ...
  public int compareTo_bridge(org.apache.hadoop.yarn.api.records.ResourceInformationJVMInterface arg0) {
      try {
  ...
  public void setResourceType_bridge(java.lang.Object arg0) {
      try {
          java.lang.reflect.Method target = null;
          {
              Class<?>[] __types = new Class<?>[1];
              __types[0] = (arg0 != null ? arg0.getClass() : Object.class);
              try {
                  target = this.getClass().getMethod("setResourceType", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("setResourceType"))
                      continue;
                  if (m.getParameterCount() != 1)
                      continue;
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: setResourceType");
          target.setAccessible(true);
