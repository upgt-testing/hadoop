...
@Public
@Unstable
public abstract class ReservationId implements Comparable<ReservationId>, ReservationIdJVMInterface {
  ...
  public int compareTo_bridge(org.apache.hadoop.yarn.api.records.ReservationIdJVMInterface arg0) {
      try {
