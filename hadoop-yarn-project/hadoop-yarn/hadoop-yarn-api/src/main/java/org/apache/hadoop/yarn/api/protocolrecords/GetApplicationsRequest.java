...
@Public
@Stable
public abstract class GetApplicationsRequest implements GetApplicationsRequestJVMInterface {
  @Public
  @Stable
  ...
  public void setScope_bridge(java.lang.Object arg0) {
      try {
          java.lang.reflect.Method target = null;
          {
              ...
              try {
                  target = this.getClass().getMethod("setScope", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("setScope"))
                      continue;
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: setScope");
