...
@Public
@Stable
public abstract class ApplicationId implements Comparable<ApplicationId>, ApplicationIdJVMInterface {
  ...
  public int compareTo_bridge(org.apache.hadoop.yarn.api.records.ApplicationIdJVMInterface arg0) {
      try {
