...
@Public
@Stable
public abstract class GetClusterMetricsResponse implements GetClusterMetricsResponseJVMInterface {
  ...
  public void setClusterMetrics_bridge(org.apache.hadoop.yarn.api.records.YarnClusterMetricsJVMInterface arg0) {
      try {
          java.lang.reflect.Method target = null;
          {
              ...
              try {
                  target = this.getClass().getMethod("setClusterMetrics", __types);
              } catch (NoSuchMethodException e) {
              }
          }
          if (target == null) {
              for (java.lang.reflect.Method m : this.getClass().getDeclaredMethods()) {
                  if (!m.getName().equals("setClusterMetrics"))
                      continue;
          ...
          if (target == null)
              throw new RuntimeException("No matching target method found: setClusterMetrics");
